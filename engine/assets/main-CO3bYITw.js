(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const a of i)if(a.type==="childList")for(const o of a.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function t(i){const a={};return i.integrity&&(a.integrity=i.integrity),i.referrerPolicy&&(a.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?a.credentials="include":i.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function s(i){if(i.ep)return;i.ep=!0;const a=t(i);fetch(i.href,a)}})();const zn=Symbol.for("yaml.alias"),Un=Symbol.for("yaml.document"),Ye=Symbol.for("yaml.map"),Ks=Symbol.for("yaml.pair"),Ue=Symbol.for("yaml.scalar"),bt=Symbol.for("yaml.seq"),Me=Symbol.for("yaml.node.type"),nt=n=>!!n&&typeof n=="object"&&n[Me]===zn,on=n=>!!n&&typeof n=="object"&&n[Me]===Un,$t=n=>!!n&&typeof n=="object"&&n[Me]===Ye,ie=n=>!!n&&typeof n=="object"&&n[Me]===Ks,Y=n=>!!n&&typeof n=="object"&&n[Me]===Ue,Ft=n=>!!n&&typeof n=="object"&&n[Me]===bt;function ne(n){if(n&&typeof n=="object")switch(n[Me]){case Ye:case bt:return!0}return!1}function se(n){if(n&&typeof n=="object")switch(n[Me]){case zn:case Ye:case Ue:case bt:return!0}return!1}const qs=n=>(Y(n)||ne(n))&&!!n.anchor,Qe=Symbol("break visit"),ga=Symbol("skip children"),Mt=Symbol("remove node");function vt(n,e){const t=ya(e);on(n)?ut(null,n.contents,t,Object.freeze([n]))===Mt&&(n.contents=null):ut(null,n,t,Object.freeze([]))}vt.BREAK=Qe;vt.SKIP=ga;vt.REMOVE=Mt;function ut(n,e,t,s){const i=ba(n,e,t,s);if(se(i)||ie(i))return va(n,s,i),ut(n,i,t,s);if(typeof i!="symbol"){if(ne(e)){s=Object.freeze(s.concat(e));for(let a=0;a<e.items.length;++a){const o=ut(a,e.items[a],t,s);if(typeof o=="number")a=o-1;else{if(o===Qe)return Qe;o===Mt&&(e.items.splice(a,1),a-=1)}}}else if(ie(e)){s=Object.freeze(s.concat(e));const a=ut("key",e.key,t,s);if(a===Qe)return Qe;a===Mt&&(e.key=null);const o=ut("value",e.value,t,s);if(o===Qe)return Qe;o===Mt&&(e.value=null)}}return i}function ya(n){return typeof n=="object"&&(n.Collection||n.Node||n.Value)?Object.assign({Alias:n.Node,Map:n.Node,Scalar:n.Node,Seq:n.Node},n.Value&&{Map:n.Value,Scalar:n.Value,Seq:n.Value},n.Collection&&{Map:n.Collection,Seq:n.Collection},n):n}function ba(n,e,t,s){var i,a,o,r,l;if(typeof t=="function")return t(n,e,s);if($t(e))return(i=t.Map)==null?void 0:i.call(t,n,e,s);if(Ft(e))return(a=t.Seq)==null?void 0:a.call(t,n,e,s);if(ie(e))return(o=t.Pair)==null?void 0:o.call(t,n,e,s);if(Y(e))return(r=t.Scalar)==null?void 0:r.call(t,n,e,s);if(nt(e))return(l=t.Alias)==null?void 0:l.call(t,n,e,s)}function va(n,e,t){const s=e[e.length-1];if(ne(s))s.items[n]=t;else if(ie(s))n==="key"?s.key=t:s.value=t;else if(on(s))s.contents=t;else{const i=nt(s)?"alias":"scalar";throw new Error(`Cannot replace node with ${i} parent`)}}const wa={"!":"%21",",":"%2C","[":"%5B","]":"%5D","{":"%7B","}":"%7D"},_a=n=>n.replace(/[!,[\]{}]/g,e=>wa[e]);class ye{constructor(e,t){this.docStart=null,this.docEnd=!1,this.yaml=Object.assign({},ye.defaultYaml,e),this.tags=Object.assign({},ye.defaultTags,t)}clone(){const e=new ye(this.yaml,this.tags);return e.docStart=this.docStart,e}atDocument(){const e=new ye(this.yaml,this.tags);switch(this.yaml.version){case"1.1":this.atNextDocument=!0;break;case"1.2":this.atNextDocument=!1,this.yaml={explicit:ye.defaultYaml.explicit,version:"1.2"},this.tags=Object.assign({},ye.defaultTags);break}return e}add(e,t){this.atNextDocument&&(this.yaml={explicit:ye.defaultYaml.explicit,version:"1.1"},this.tags=Object.assign({},ye.defaultTags),this.atNextDocument=!1);const s=e.trim().split(/[ \t]+/),i=s.shift();switch(i){case"%TAG":{if(s.length!==2&&(t(0,"%TAG directive should contain exactly two parts"),s.length<2))return!1;const[a,o]=s;return this.tags[a]=o,!0}case"%YAML":{if(this.yaml.explicit=!0,s.length!==1)return t(0,"%YAML directive should contain exactly one part"),!1;const[a]=s;if(a==="1.1"||a==="1.2")return this.yaml.version=a,!0;{const o=/^\d+\.\d+$/.test(a);return t(6,`Unsupported YAML version ${a}`,o),!1}}default:return t(0,`Unknown directive ${i}`,!0),!1}}tagName(e,t){if(e==="!")return"!";if(e[0]!=="!")return t(`Not a valid tag: ${e}`),null;if(e[1]==="<"){const o=e.slice(2,-1);return o==="!"||o==="!!"?(t(`Verbatim tags aren't resolved, so ${e} is invalid.`),null):(e[e.length-1]!==">"&&t("Verbatim tags must end with a >"),o)}const[,s,i]=e.match(/^(.*!)([^!]*)$/s);i||t(`The ${e} tag has no suffix`);const a=this.tags[s];if(a)try{return a+decodeURIComponent(i)}catch(o){return t(String(o)),null}return s==="!"?e:(t(`Could not resolve tag: ${e}`),null)}tagString(e){for(const[t,s]of Object.entries(this.tags))if(e.startsWith(s))return t+_a(e.substring(s.length));return e[0]==="!"?e:`!<${e}>`}toString(e){const t=this.yaml.explicit?[`%YAML ${this.yaml.version||"1.2"}`]:[],s=Object.entries(this.tags);let i;if(e&&s.length>0&&se(e.contents)){const a={};vt(e.contents,(o,r)=>{se(r)&&r.tag&&(a[r.tag]=!0)}),i=Object.keys(a)}else i=[];for(const[a,o]of s)a==="!!"&&o==="tag:yaml.org,2002:"||(!e||i.some(r=>r.startsWith(o)))&&t.push(`%TAG ${a} ${o}`);return t.join(`
`)}}ye.defaultYaml={explicit:!1,version:"1.2"};ye.defaultTags={"!!":"tag:yaml.org,2002:"};function Ws(n){if(/[\x00-\x19\s,[\]{}]/.test(n)){const t=`Anchor must not contain whitespace or control characters: ${JSON.stringify(n)}`;throw new Error(t)}return!0}function Ys(n){const e=new Set;return vt(n,{Value(t,s){s.anchor&&e.add(s.anchor)}}),e}function Gs(n,e){for(let t=1;;++t){const s=`${n}${t}`;if(!e.has(s))return s}}function Sa(n,e){const t=[],s=new Map;let i=null;return{onAnchor:a=>{t.push(a),i??(i=Ys(n));const o=Gs(e,i);return i.add(o),o},setAnchors:()=>{for(const a of t){const o=s.get(a);if(typeof o=="object"&&o.anchor&&(Y(o.node)||ne(o.node)))o.node.anchor=o.anchor;else{const r=new Error("Failed to resolve repeated object (this should not happen)");throw r.source=a,r}}},sourceObjects:s}}function dt(n,e,t,s){if(s&&typeof s=="object")if(Array.isArray(s))for(let i=0,a=s.length;i<a;++i){const o=s[i],r=dt(n,s,String(i),o);r===void 0?delete s[i]:r!==o&&(s[i]=r)}else if(s instanceof Map)for(const i of Array.from(s.keys())){const a=s.get(i),o=dt(n,s,i,a);o===void 0?s.delete(i):o!==a&&s.set(i,o)}else if(s instanceof Set)for(const i of Array.from(s)){const a=dt(n,s,i,i);a===void 0?s.delete(i):a!==i&&(s.delete(i),s.add(a))}else for(const[i,a]of Object.entries(s)){const o=dt(n,s,i,a);o===void 0?delete s[i]:o!==a&&(s[i]=o)}return n.call(e,t,s)}function Te(n,e,t){if(Array.isArray(n))return n.map((s,i)=>Te(s,String(i),t));if(n&&typeof n.toJSON=="function"){if(!t||!qs(n))return n.toJSON(e,t);const s={aliasCount:0,count:1,res:void 0};t.anchors.set(n,s),t.onCreate=a=>{s.res=a,delete t.onCreate};const i=n.toJSON(e,t);return t.onCreate&&t.onCreate(i),i}return typeof n=="bigint"&&!(t!=null&&t.keep)?Number(n):n}class Jn{constructor(e){Object.defineProperty(this,Me,{value:e})}clone(){const e=Object.create(Object.getPrototypeOf(this),Object.getOwnPropertyDescriptors(this));return this.range&&(e.range=this.range.slice()),e}toJS(e,{mapAsMap:t,maxAliasCount:s,onAnchor:i,reviver:a}={}){if(!on(e))throw new TypeError("A document argument is required");const o={anchors:new Map,doc:e,keep:!0,mapAsMap:t===!0,mapKeyWarned:!1,maxAliasCount:typeof s=="number"?s:100},r=Te(this,"",o);if(typeof i=="function")for(const{count:l,res:c}of o.anchors.values())i(c,l);return typeof a=="function"?dt(a,{"":r},"",r):r}}class Qn extends Jn{constructor(e){super(zn),this.source=e,Object.defineProperty(this,"tag",{set(){throw new Error("Alias nodes cannot have tags")}})}resolve(e,t){let s;t!=null&&t.aliasResolveCache?s=t.aliasResolveCache:(s=[],vt(e,{Node:(a,o)=>{(nt(o)||qs(o))&&s.push(o)}}),t&&(t.aliasResolveCache=s));let i;for(const a of s){if(a===this)break;a.anchor===this.source&&(i=a)}return i}toJSON(e,t){if(!t)return{source:this.source};const{anchors:s,doc:i,maxAliasCount:a}=t,o=this.resolve(i,t);if(!o){const l=`Unresolved alias (the anchor must be set before the alias): ${this.source}`;throw new ReferenceError(l)}let r=s.get(o);if(r||(Te(o,null,t),r=s.get(o)),(r==null?void 0:r.res)===void 0){const l="This should not happen: Alias anchor was not resolved?";throw new ReferenceError(l)}if(a>=0&&(r.count+=1,r.aliasCount===0&&(r.aliasCount=Jt(i,o,s)),r.count*r.aliasCount>a)){const l="Excessive alias count indicates a resource exhaustion attack";throw new ReferenceError(l)}return r.res}toString(e,t,s){const i=`*${this.source}`;if(e){if(Ws(this.source),e.options.verifyAliasOrder&&!e.anchors.has(this.source)){const a=`Unresolved alias (the anchor must be set before the alias): ${this.source}`;throw new Error(a)}if(e.implicitKey)return`${i} `}return i}}function Jt(n,e,t){if(nt(e)){const s=e.resolve(n),i=t&&s&&t.get(s);return i?i.count*i.aliasCount:0}else if(ne(e)){let s=0;for(const i of e.items){const a=Jt(n,i,t);a>s&&(s=a)}return s}else if(ie(e)){const s=Jt(n,e.key,t),i=Jt(n,e.value,t);return Math.max(s,i)}return 1}const zs=n=>!n||typeof n!="function"&&typeof n!="object";class P extends Jn{constructor(e){super(Ue),this.value=e}toJSON(e,t){return t!=null&&t.keep?this.value:Te(this.value,e,t)}toString(){return String(this.value)}}P.BLOCK_FOLDED="BLOCK_FOLDED";P.BLOCK_LITERAL="BLOCK_LITERAL";P.PLAIN="PLAIN";P.QUOTE_DOUBLE="QUOTE_DOUBLE";P.QUOTE_SINGLE="QUOTE_SINGLE";const ka="tag:yaml.org,2002:";function Ea(n,e,t){if(e){const s=t.filter(a=>a.tag===e),i=s.find(a=>!a.format)??s[0];if(!i)throw new Error(`Tag ${e} not found`);return i}return t.find(s=>{var i;return((i=s.identify)==null?void 0:i.call(s,n))&&!s.format})}function Pt(n,e,t){var d,p,m;if(on(n)&&(n=n.contents),se(n))return n;if(ie(n)){const b=(p=(d=t.schema[Ye]).createNode)==null?void 0:p.call(d,t.schema,null,t);return b.items.push(n),b}(n instanceof String||n instanceof Number||n instanceof Boolean||typeof BigInt<"u"&&n instanceof BigInt)&&(n=n.valueOf());const{aliasDuplicateObjects:s,onAnchor:i,onTagObj:a,schema:o,sourceObjects:r}=t;let l;if(s&&n&&typeof n=="object"){if(l=r.get(n),l)return l.anchor??(l.anchor=i(n)),new Qn(l.anchor);l={anchor:null,node:null},r.set(n,l)}e!=null&&e.startsWith("!!")&&(e=ka+e.slice(2));let c=Ea(n,e,o.tags);if(!c){if(n&&typeof n.toJSON=="function"&&(n=n.toJSON()),!n||typeof n!="object"){const b=new P(n);return l&&(l.node=b),b}c=n instanceof Map?o[Ye]:Symbol.iterator in Object(n)?o[bt]:o[Ye]}a&&(a(c),delete t.onTagObj);const u=c!=null&&c.createNode?c.createNode(t.schema,n,t):typeof((m=c==null?void 0:c.nodeClass)==null?void 0:m.from)=="function"?c.nodeClass.from(t.schema,n,t):new P(n);return e?u.tag=e:c.default||(u.tag=c.tag),l&&(l.node=u),u}function en(n,e,t){let s=t;for(let i=e.length-1;i>=0;--i){const a=e[i];if(typeof a=="number"&&Number.isInteger(a)&&a>=0){const o=[];o[a]=s,s=o}else s=new Map([[a,s]])}return Pt(s,void 0,{aliasDuplicateObjects:!1,keepUndefined:!1,onAnchor:()=>{throw new Error("This should not happen, please report a bug.")},schema:n,sourceObjects:new Map})}const Ct=n=>n==null||typeof n=="object"&&!!n[Symbol.iterator]().next().done;class Js extends Jn{constructor(e,t){super(e),Object.defineProperty(this,"schema",{value:t,configurable:!0,enumerable:!1,writable:!0})}clone(e){const t=Object.create(Object.getPrototypeOf(this),Object.getOwnPropertyDescriptors(this));return e&&(t.schema=e),t.items=t.items.map(s=>se(s)||ie(s)?s.clone(e):s),this.range&&(t.range=this.range.slice()),t}addIn(e,t){if(Ct(e))this.add(t);else{const[s,...i]=e,a=this.get(s,!0);if(ne(a))a.addIn(i,t);else if(a===void 0&&this.schema)this.set(s,en(this.schema,i,t));else throw new Error(`Expected YAML collection at ${s}. Remaining path: ${i}`)}}deleteIn(e){const[t,...s]=e;if(s.length===0)return this.delete(t);const i=this.get(t,!0);if(ne(i))return i.deleteIn(s);throw new Error(`Expected YAML collection at ${t}. Remaining path: ${s}`)}getIn(e,t){const[s,...i]=e,a=this.get(s,!0);return i.length===0?!t&&Y(a)?a.value:a:ne(a)?a.getIn(i,t):void 0}hasAllNullValues(e){return this.items.every(t=>{if(!ie(t))return!1;const s=t.value;return s==null||e&&Y(s)&&s.value==null&&!s.commentBefore&&!s.comment&&!s.tag})}hasIn(e){const[t,...s]=e;if(s.length===0)return this.has(t);const i=this.get(t,!0);return ne(i)?i.hasIn(s):!1}setIn(e,t){const[s,...i]=e;if(i.length===0)this.set(s,t);else{const a=this.get(s,!0);if(ne(a))a.setIn(i,t);else if(a===void 0&&this.schema)this.set(s,en(this.schema,i,t));else throw new Error(`Expected YAML collection at ${s}. Remaining path: ${i}`)}}}const La=n=>n.replace(/^(?!$)(?: $)?/gm,"#");function De(n,e){return/^\n+$/.test(n)?n.substring(1):e?n.replace(/^(?! *$)/gm,e):n}const Ze=(n,e,t)=>n.endsWith(`
`)?De(t,e):t.includes(`
`)?`
...
${l}`);if(o){const p=h=>{var y;return h.default&&h.tag!=="tag:yaml.org,2002:str"&&((y=h.test)==null?void 0:y.test(d))},{compat:m,tags:b}=e.doc.schema;if(b.some(p)||m!=null&&m.some(p))return ft(a,e)}return r?d:rn(d,l,Qs,ln(e,!1))}function Xn(n,e,t,s){const{implicitKey:i,inFlow:a}=e,o=typeof n.value=="string"?n:Object.assign({},n,{value:String(n.value)});let{type:r}=n;r!==P.QUOTE_DOUBLE&&/[\x00-\x08\x0b-\x1f\x7f-\x9f\u{D800}-\u{DFFF}]/u.test(o.value)&&(r=P.QUOTE_DOUBLE);const l=u=>{switch(u){case P.BLOCK_FOLDED:case P.BLOCK_LITERAL:return i||a?ft(o.value,e):Xt(o,e,t,s);case P.QUOTE_DOUBLE:return Ot(o.value,e);case P.QUOTE_SINGLE:return Hn(o.value,e);case P.PLAIN:return Ia(o,e,t,s);default:return null}};let c=l(r);if(c===null){const{defaultKeyType:u,defaultStringType:d}=e.options,p=i&&u||d;if(c=l(p),c===null)throw new Error(`Unsupported default string type ${p}`)}return c}function Xs(n,e){const t=Object.assign({blockQuote:!0,commentString:La,defaultKeyType:null,defaultStringType:"PLAIN",directives:null,doubleQuotedAsJSON:!1,doubleQuotedMinMultiLineLength:40,falseStr:"false",flowCollectionPadding:!0,indentSeq:!0,lineWidth:80,minContentWidth:20,nullStr:"null",simpleKeys:!1,singleQuote:null,trailingComma:!1,trueStr:"true",verifyAliasOrder:!0},n.schema.toStringOptions,e);let s;switch(t.collectionStyle){case"block":s=!1;break;case"flow":s=!0;break;default:s=null}return{anchors:new Set,doc:n,flowCollectionPadding:t.flowCollectionPadding?" ":"",indent:"",indentStep:typeof t.indent=="number"?" ".repeat(t.indent):"  ",inFlow:s,options:t}}function Aa(n,e){var i;if(e.tag){const a=n.filter(o=>o.tag===e.tag);if(a.length>0)return a.find(o=>o.format===e.format)??a[0]}let t,s;if(Y(e)){s=e.value;let a=n.filter(o=>{var r;return(r=o.identify)==null?void 0:r.call(o,s)});if(a.length>1){const o=a.filter(r=>r.test);o.length>0&&(a=o)}t=a.find(o=>o.format===e.format)??a.find(o=>!o.format)}else s=e,t=n.find(a=>a.nodeClass&&s instanceof a.nodeClass);if(!t){const a=((i=s==null?void 0:s.constructor)==null?void 0:i.name)??(s===null?"null":typeof s);throw new Error(`Tag not resolved for ${a} value`)}return t}function Ca(n,e,{anchors:t,doc:s}){if(!s.directives)return"";const i=[],a=(Y(n)||ne(n))&&n.anchor;a&&Ws(a)&&(t.add(a),i.push(`&${a}`));const o=n.tag??(e.default?null:e.tag);return o&&i.push(s.directives.tagString(o)),i.join(" ")}function gt(n,e,t,s){var l;if(ie(n))return n.toString(e,t,s);if(nt(n)){if(e.doc.directives)return n.toString(e);if((l=e.resolvedAliases)!=null&&l.has(n))throw new TypeError("Cannot stringify circular structure without alias nodes");e.resolvedAliases?e.resolvedAliases.add(n):e.resolvedAliases=new Set([n]),n=n.resolve(e.doc)}let i;const a=se(n)?n:e.doc.createNode(n,{onTagObj:c=>i=c});i??(i=Aa(e.doc.schema.tags,a));const o=Ca(a,i,e);o.length>0&&(e.indentAtStart=(e.indentAtStart??0)+o.length+1);const r=typeof i.stringify=="function"?i.stringify(a,e,t,s):Y(a)?Xn(a,e,t,s):a.toString(e,t,s);return o?Y(a)||r[0]==="{"||r[0]==="["?`${o} ${r}`:`${o}
${e.indent}${r}`:r}function Ta({key:n,value:e},t,s,i){const{allNullValues:a,doc:o,indent:r,indentStep:l,options:{commentString:c,indentSeq:u,simpleKeys:d}}=t;let p=se(n)&&n.comment||null;if(d){if(p)throw new Error("With simple keys, key nodes cannot have comments");if(ne(n)||!se(n)&&typeof n=="object"){const N="With simple keys, collection cannot be used as a key value";throw new Error(N)}}let m=!d&&(!n||p&&e==null&&!t.inFlow||ne(n)||(Y(n)?n.type===P.BLOCK_FOLDED||n.type===P.BLOCK_LITERAL:typeof n=="object"));t=Object.assign({},t,{allNullValues:!1,implicitKey:!m&&(d||!a),indent:r+l});let b=!1,h=!1,y=gt(n,t,()=>b=!0,()=>h=!0);if(!m&&!t.inFlow&&y.length>1024){if(d)throw new Error("With simple keys, single line scalar must not span more than 1024 characters");m=!0}if(t.inFlow){if(a||e==null)return b&&s&&s(),y===""?"?":m?`? ${y}`:y}else if(a&&!d||e==null&&m)return y=`? ${y}`,p&&!b?y+=Ze(y,t.indent,c(p)):h&&i&&i(),y;b&&(p=null),m?(p&&(y+=Ze(y,t.indent,c(p))),y=`? ${y}
${r}:`):(y=`${y}:`,p&&(y+=Ze(y,t.indent,c(p))));let S,v,L;se(e)?(S=!!e.spaceBefore,v=e.commentBefore,L=e.comment):(S=!1,v=null,L=null,e&&typeof e=="object"&&(e=o.createNode(e))),t.implicitKey=!1,!m&&!p&&Y(e)&&(t.indentAtStart=y.length+1),h=!1,!u&&l.length>=2&&!t.inFlow&&!m&&Ft(e)&&!e.flow&&!e.tag&&!e.anchor&&(t.indent=t.indent.substring(2));let k=!1;const g=gt(e,t,()=>k=!0,()=>h=!0);let w=" ";if(p||S||v){if(w=S?`
`:"",v){const N=c(v);w+=`
${De(N,t.indent)}`}g===""&&!t.inFlow?w===`
`&&L&&(w=`

`):w+=`
${t.indent}`}else if(!m&&ne(e)){const N=g[0],E=g.indexOf(`
`),T=E!==-1,R=t.inFlow??e.flow??e.items.length===0;if(T||!R){let x=!1;if(T&&(N==="&"||N==="!")){let $=g.indexOf(" ");N==="&"&&$!==-1&&$<E&&g[$+1]==="!"&&($=g.indexOf(" ",$+1)),($===-1||E<$)&&(x=!0)}x||(w=`
${t.indent}`)}}else(g===""||g[0]===`
`)&&(w="");return y+=w+g,t.inFlow?k&&s&&s():L&&!k?y+=Ze(y,t.indent,c(L)):h&&i&&i(),y}function Zs(n,e){(n==="debug"||n==="warn")&&console.warn(e)}const jt="<<",je={identify:n=>n===jt||typeof n=="symbol"&&n.description===jt,default:"key",tag:"tag:yaml.org,2002:merge",test:/^<<$/,resolve:()=>Object.assign(new P(Symbol(jt)),{addToJSMap:ei}),stringify:()=>jt},Ma=(n,e)=>(je.identify(e)||Y(e)&&(!e.type||e.type===P.PLAIN)&&je.identify(e.value))&&(n==null?void 0:n.doc.schema.tags.some(t=>t.tag===je.tag&&t.default));function ei(n,e,t){if(t=n&&nt(t)?t.resolve(n.doc):t,Ft(t))for(const s of t.items)En(n,e,s);else if(Array.isArray(t))for(const s of t)En(n,e,s);else En(n,e,t)}function En(n,e,t){const s=n&&nt(t)?t.resolve(n.doc):t;if(!$t(s))throw new Error("Merge sources must be maps or map aliases");const i=s.toJSON(null,n,Map);for(const[a,o]of i)e instanceof Map?e.has(a)||e.set(a,o):e instanceof Set?e.add(a):Object.prototype.hasOwnProperty.call(e,a)||Object.defineProperty(e,a,{value:o,writable:!0,enumerable:!0,configurable:!0});return e}function ti(n,e,{key:t,value:s}){if(se(t)&&t.addToJSMap)t.addToJSMap(n,e,s);else if(Ma(n,t))ei(n,e,s);else{const i=Te(t,"",n);if(e instanceof Map)e.set(i,Te(s,i,n));else if(e instanceof Set)e.add(i);else{const a=Oa(t,i,n),o=Te(s,a,n);a in e?Object.defineProperty(e,a,{value:o,writable:!0,enumerable:!0,configurable:!0}):e[a]=o}}return e}function Oa(n,e,t){if(e===null)return"";if(typeof e!="object")return String(e);if(se(n)&&(t!=null&&t.doc)){const s=Xs(t.doc,{});s.anchors=new Set;for(const a of t.anchors.keys())s.anchors.add(a.anchor);s.inFlow=!0,s.inStringifyKey=!0;const i=n.toString(s);if(!t.mapKeyWarned){let a=JSON.stringify(i);a.length>40&&(a=a.substring(0,36)+'..."'),Zs(t.doc.options.logLevel,`Keys with collection values will be stringified due to JS Object restrictions: ${a}. Set mapAsMap: true to use object keys.`),t.mapKeyWarned=!0}return i}return JSON.stringify(e)}function Zn(n,e,t){const s=Pt(n,void 0,t),i=Pt(e,void 0,t);return new be(s,i)}class be{constructor(e,t=null){Object.defineProperty(this,Me,{value:Ks}),this.key=e,this.value=t}clone(e){let{key:t,value:s}=this;return se(t)&&(t=t.clone(e)),se(s)&&(s=s.clone(e)),new be(t,s)}toJSON(e,t){const s=t!=null&&t.mapAsMap?new Map:{};return ti(t,s,this)}toString(e,t,s){return e!=null&&e.doc?Ta(this,e,t,s):JSON.stringify(this)}}function ni(n,e,t){return(e.inFlow??n.flow?xa:Pa)(n,e,t)}function Pa({comment:n,items:e},t,{blockItemPrefix:s,flowChars:i,itemIndent:a,onChompKeep:o,onComment:r}){const{indent:l,options:{commentString:c}}=t,u=Object.assign({},t,{indent:a,type:null});let d=!1;const p=[];for(let b=0;b<e.length;++b){const h=e[b];let y=null;if(se(h))!d&&h.spaceBefore&&p.push(""),tn(t,p,h.commentBefore,d),h.comment&&(y=h.comment);else if(ie(h)){const v=se(h.key)?h.key:null;v&&(!d&&v.spaceBefore&&p.push(""),tn(t,p,v.commentBefore,d))}d=!1;let S=gt(h,u,()=>y=null,()=>d=!0);y&&(S+=Ze(S,a,c(y))),d&&y&&(d=!1),p.push(s+S)}let m;if(p.length===0)m=i.start+i.end;else{m=p[0];for(let b=1;b<p.length;++b){const h=p[b];m+=h?`
${l}${h}`:`
`}}return n?(m+=`
`+De(c(n),l),r&&r()):d&&o&&o(),m}function xa({items:n},e,{flowChars:t,itemIndent:s}){const{indent:i,indentStep:a,flowCollectionPadding:o,options:{commentString:r}}=e;s+=a;const l=Object.assign({},e,{indent:s,inFlow:!0,type:null});let c=!1,u=0;const d=[];for(let b=0;b<n.length;++b){const h=n[b];let y=null;if(se(h))h.spaceBefore&&d.push(""),tn(e,d,h.commentBefore,!1),h.comment&&(y=h.comment);else if(ie(h)){const v=se(h.key)?h.key:null;v&&(v.spaceBefore&&d.push(""),tn(e,d,v.commentBefore,!1),v.comment&&(c=!0));const L=se(h.value)?h.value:null;L?(L.comment&&(y=L.comment),L.commentBefore&&(c=!0)):h.value==null&&(v!=null&&v.comment)&&(y=v.comment)}y&&(c=!0);let S=gt(h,l,()=>y=null);c||(c=d.length>u||S.includes(`
`)),b<n.length-1?S+=",":e.options.trailingComma&&(e.options.lineWidth>0&&(c||(c=d.reduce((v,L)=>v+L.length+2,2)+(S.length+2)>e.options.lineWidth)),c&&(S+=",")),y&&(S+=Ze(S,s,r(y))),d.push(S),u=d.length}const{start:p,end:m}=t;if(d.length===0)return p+m;if(!c){const b=d.reduce((h,y)=>h+y.length+2,2);c=e.options.lineWidth>0&&b>e.options.lineWidth}if(c){let b=p;for(const h of d)b+=h?`
${a}${i}${h}`:`
`;return`${b}
${i}${m}`}else return`${p}${o}${d.join(" ")}${o}${m}`}function tn({indent:n,options:{commentString:e}},t,s,i){if(s&&i&&(s=s.replace(/^\n+/,"")),s){const a=De(e(s),n);t.push(a.trimStart())}}function et(n,e){const t=Y(e)?e.value:e;for(const s of n)if(ie(s)&&(s.key===e||s.key===t||Y(s.key)&&s.key.value===t))return s}class Ce extends Js{static get tagName(){return"tag:yaml.org,2002:map"}constructor(e){super(Ye,e),this.items=[]}static from(e,t,s){const{keepUndefined:i,replacer:a}=s,o=new this(e),r=(l,c)=>{if(typeof a=="function")c=a.call(t,l,c);else if(Array.isArray(a)&&!a.includes(l))return;(c!==void 0||i)&&o.items.push(Zn(l,c,s))};if(t instanceof Map)for(const[l,c]of t)r(l,c);else if(t&&typeof t=="object")for(const l of Object.keys(t))r(l,t[l]);return typeof e.sortMapEntries=="function"&&o.items.sort(e.sortMapEntries),o}add(e,t){var o;let s;ie(e)?s=e:!e||typeof e!="object"||!("key"in e)?s=new be(e,e==null?void 0:e.value):s=new be(e.key,e.value);const i=et(this.items,s.key),a=(o=this.schema)==null?void 0:o.sortMapEntries;if(i){if(!t)throw new Error(`Key ${s.key} already set`);Y(i.value)&&zs(s.value)?i.value.value=s.value:i.value=s.value}else if(a){const r=this.items.findIndex(l=>a(s,l)<0);r===-1?this.items.push(s):this.items.splice(r,0,s)}else this.items.push(s)}delete(e){const t=et(this.items,e);return t?this.items.splice(this.items.indexOf(t),1).length>0:!1}get(e,t){const s=et(this.items,e),i=s==null?void 0:s.value;return(!t&&Y(i)?i.value:i)??void 0}has(e){return!!et(this.items,e)}set(e,t){this.add(new be(e,t),!0)}toJSON(e,t,s){const i=s?new s:t!=null&&t.mapAsMap?new Map:{};t!=null&&t.onCreate&&t.onCreate(i);for(const a of this.items)ti(t,i,a);return i}toString(e,t,s){if(!e)return JSON.stringify(this);for(const i of this.items)if(!ie(i))throw new Error(`Map items must all be pairs; found ${JSON.stringify(i)} instead`);return!e.allNullValues&&this.hasAllNullValues(!1)&&(e=Object.assign({},e,{allNullValues:!0})),ni(this,e,{blockItemPrefix:"",flowChars:{start:"{",end:"}"},itemIndent:e.indent||"",onChompKeep:s,onComment:t})}}const wt={collection:"map",default:!0,nodeClass:Ce,tag:"tag:yaml.org,2002:map",resolve(n,e){return $t(n)||e("Expected a mapping for this tag"),n},createNode:(n,e,t)=>Ce.from(n,e,t)};class tt extends Js{static get tagName(){return"tag:yaml.org,2002:seq"}constructor(e){super(bt,e),this.items=[]}add(e){this.items.push(e)}delete(e){const t=Kt(e);return typeof t!="number"?!1:this.items.splice(t,1).length>0}get(e,t){const s=Kt(e);if(typeof s!="number")return;const i=this.items[s];return!t&&Y(i)?i.value:i}has(e){const t=Kt(e);return typeof t=="number"&&t<this.items.length}set(e,t){const s=Kt(e);if(typeof s!="number")throw new Error(`Expected a valid index, not ${e}.`);const i=this.items[s];Y(i)&&zs(t)?i.value=t:this.items[s]=t}toJSON(e,t){const s=[];t!=null&&t.onCreate&&t.onCreate(s);let i=0;for(const a of this.items)s.push(Te(a,String(i++),t));return s}toString(e,t,s){return e?ni(this,e,{blockItemPrefix:"- ",flowChars:{start:"[",end:"]"},itemIndent:(e.indent||"")+"  ",onChompKeep:s,onComment:t}):JSON.stringify(this)}static from(e,t,s){const{replacer:i}=s,a=new this(e);if(t&&Symbol.iterator in Object(t)){let o=0;for(let r of t){if(typeof i=="function"){const l=t instanceof Set?r:String(o++);r=i.call(t,l,r)}a.items.push(Pt(r,void 0,s))}}return a}}function Kt(n){let e=Y(n)?n.value:n;return e&&typeof e=="string"&&(e=Number(e)),typeof e=="number"&&Number.isInteger(e)&&e>=0?e:null}const _t={collection:"seq",default:!0,nodeClass:tt,tag:"tag:yaml.org,2002:seq",resolve(n,e){return Ft(n)||e("Expected a sequence for this tag"),n},createNode:(n,e,t)=>tt.from(n,e,t)},un={identify:n=>typeof n=="string",default:!0,tag:"tag:yaml.org,2002:str",resolve:n=>n,stringify(n,e,t,s){return e=Object.assign({actualString:!0},e),Xn(n,e,t,s)}},dn={identify:n=>n==null,createNode:()=>new P(null),default:!0,tag:"tag:yaml.org,2002:null",test:/^(?:~|[Nn]ull|NULL)?$/,resolve:()=>new P(null),stringify:({source:n},e)=>typeof n=="string"&&dn.test.test(n)?n:e.options.nullStr},es={identify:n=>typeof n=="boolean",default:!0,tag:"tag:yaml.org,2002:bool",test:/^(?:[Tt]rue|TRUE|[Ff]alse|FALSE)$/,resolve:n=>new P(n[0]==="t"||n[0]==="T"),stringify({source:n,value:e},t){if(n&&es.test.test(n)){const s=n[0]==="t"||n[0]==="T";if(e===s)return n}return e?t.options.trueStr:t.options.falseStr}};function $e({format:n,minFractionDigits:e,tag:t,value:s}){if(typeof s=="bigint")return String(s);const i=typeof s=="number"?s:Number(s);if(!isFinite(i))return isNaN(i)?".nan":i<0?"-.inf":".inf";let a=Object.is(s,-0)?"-0":JSON.stringify(s);if(!n&&e&&(!t||t==="tag:yaml.org,2002:float")&&/^\d/.test(a)){let o=a.indexOf(".");o<0&&(o=a.length,a+=".");let r=e-(a.length-o-1);for(;r-- >0;)a+="0"}return a}const si={identify:n=>typeof n=="number",default:!0,tag:"tag:yaml.org,2002:float",test:/^(?:[-+]?\.(?:inf|Inf|INF)|\.nan|\.NaN|\.NAN)$/,resolve:n=>n.slice(-3).toLowerCase()==="nan"?NaN:n[0]==="-"?Number.NEGATIVE_INFINITY:Number.POSITIVE_INFINITY,stringify:$e},ii={identify:n=>typeof n=="number",default:!0,tag:"tag:yaml.org,2002:float",format:"EXP",test:/^[-+]?(?:\.[0-9]+|[0-9]+(?:\.[0-9]*)?)[eE][-+]?[0-9]+$/,resolve:n=>parseFloat(n),stringify(n){const e=Number(n.value);return isFinite(e)?e.toExponential():$e(n)}},ai={identify:n=>typeof n=="number",default:!0,tag:"tag:yaml.org,2002:float",test:/^[-+]?(?:\.[0-9]+|[0-9]+\.[0-9]*)$/,resolve(n){const e=new P(parseFloat(n)),t=n.indexOf(".");return t!==-1&&n[n.length-1]==="0"&&(e.minFractionDigits=n.length-t-1),e},stringify:$e},fn=n=>typeof n=="bigint"||Number.isInteger(n),ts=(n,e,t,{intAsBigInt:s})=>s?BigInt(n):parseInt(n.substring(e),t);function oi(n,e,t){const{value:s}=n;return fn(s)&&s>=0?t+s.toString(e):$e(n)}const ri={identify:n=>fn(n)&&n>=0,default:!0,tag:"tag:yaml.org,2002:int",format:"OCT",test:/^0o[0-7]+$/,resolve:(n,e,t)=>ts(n,2,8,t),stringify:n=>oi(n,8,"0o")},li={identify:fn,default:!0,tag:"tag:yaml.org,2002:int",test:/^[-+]?[0-9]+$/,resolve:(n,e,t)=>ts(n,0,10,t),stringify:$e},ci={identify:n=>fn(n)&&n>=0,default:!0,tag:"tag:yaml.org,2002:int",format:"HEX",test:/^0x[0-9a-fA-F]+$/,resolve:(n,e,t)=>ts(n,2,16,t),stringify:n=>oi(n,16,"0x")},Ra=[wt,_t,un,dn,es,ri,li,ci,si,ii,ai];function ws(n){return typeof n=="bigint"||Number.isInteger(n)}const qt=({value:n})=>JSON.stringify(n),$a=[{identify:n=>typeof n=="string",default:!0,tag:"tag:yaml.org,2002:str",resolve:n=>n,stringify:qt},{identify:n=>n==null,createNode:()=>new P(null),default:!0,tag:"tag:yaml.org,2002:null",test:/^null$/,resolve:()=>null,stringify:qt},{identify:n=>typeof n=="boolean",default:!0,tag:"tag:yaml.org,2002:bool",test:/^true$|^false$/,resolve:n=>n==="true",stringify:qt},{identify:ws,default:!0,tag:"tag:yaml.org,2002:int",test:/^-?(?:0|[1-9][0-9]*)$/,resolve:(n,e,{intAsBigInt:t})=>t?BigInt(n):parseInt(n,10),stringify:({value:n})=>ws(n)?n.toString():JSON.stringify(n)},{identify:n=>typeof n=="number",default:!0,tag:"tag:yaml.org,2002:float",test:/^-?(?:0|[1-9][0-9]*)(?:\.[0-9]*)?(?:[eE][-+]?[0-9]+)?$/,resolve:n=>parseFloat(n),stringify:qt}],Fa={default:!0,tag:"",test:/^/,resolve(n,e){return e(`Unresolved plain scalar ${JSON.stringify(n)}`),n}},Ba=[wt,_t].concat($a,Fa),ns={identify:n=>n instanceof Uint8Array,default:!1,tag:"tag:yaml.org,2002:binary",resolve(n,e){if(typeof atob=="function"){const t=atob(n.replace(/[\n\r]/g,"")),s=new Uint8Array(t.length);for(let i=0;i<t.length;++i)s[i]=t.charCodeAt(i);return s}else return e("This environment does not support reading binary tags; either Buffer or atob is required"),n},stringify({comment:n,type:e,value:t},s,i,a){if(!t)return"";const o=t;let r;if(typeof btoa=="function"){let l="";for(let c=0;c<o.length;++c)l+=String.fromCharCode(o[c]);r=btoa(l)}else throw new Error("This environment does not support writing binary tags; either Buffer or btoa is required");if(e??(e=P.BLOCK_LITERAL),e!==P.QUOTE_DOUBLE){const l=Math.max(s.options.lineWidth-s.indent.length,s.options.minContentWidth),c=Math.ceil(r.length/l),u=new Array(c);for(let d=0,p=0;d<c;++d,p+=l)u[d]=r.substr(p,l);r=u.join(e===P.BLOCK_LITERAL?`
`:" ")}return Xn({comment:n,type:e,value:r},s,i,a)}};function ui(n,e){if(Ft(n))for(let t=0;t<n.items.length;++t){let s=n.items[t];if(!ie(s)){if($t(s)){s.items.length>1&&e("Each pair must have its own sequence indicator");const i=s.items[0]||new be(new P(null));if(s.commentBefore&&(i.key.commentBefore=i.key.commentBefore?`${s.commentBefore}
${i.key.commentBefore}`:s.commentBefore),s.comment){const a=i.value??i.key;a.comment=a.comment?`${s.comment}
${a.comment}`:s.comment}s=i}n.items[t]=ie(s)?s:new be(s)}}else e("Expected a sequence for this tag");return n}function di(n,e,t){const{replacer:s}=t,i=new tt(n);i.tag="tag:yaml.org,2002:pairs";let a=0;if(e&&Symbol.iterator in Object(e))for(let o of e){typeof s=="function"&&(o=s.call(e,String(a++),o));let r,l;if(Array.isArray(o))if(o.length===2)r=o[0],l=o[1];else throw new TypeError(`Expected [key, value] tuple: ${o}`);else if(o&&o instanceof Object){const c=Object.keys(o);if(c.length===1)r=c[0],l=o[r];else throw new TypeError(`Expected tuple with one key, not ${c.length} keys`)}else r=o;i.items.push(Zn(r,l,t))}return i}const ss={collection:"seq",default:!1,tag:"tag:yaml.org,2002:pairs",resolve:ui,createNode:di};class mt extends tt{constructor(){super(),this.add=Ce.prototype.add.bind(this),this.delete=Ce.prototype.delete.bind(this),this.get=Ce.prototype.get.bind(this),this.has=Ce.prototype.has.bind(this),this.set=Ce.prototype.set.bind(this),this.tag=mt.tag}toJSON(e,t){if(!t)return super.toJSON(e);const s=new Map;t!=null&&t.onCreate&&t.onCreate(s);for(const i of this.items){let a,o;if(ie(i)?(a=Te(i.key,"",t),o=Te(i.value,a,t)):a=Te(i,"",t),s.has(a))throw new Error("Ordered maps must not include duplicate keys");s.set(a,o)}return s}static from(e,t,s){const i=di(e,t,s),a=new this;return a.items=i.items,a}}mt.tag="tag:yaml.org,2002:omap";const is={collection:"seq",identify:n=>n instanceof Map,nodeClass:mt,default:!1,tag:"tag:yaml.org,2002:omap",resolve(n,e){const t=ui(n,e),s=[];for(const{key:i}of t.items)Y(i)&&(s.includes(i.value)?e(`Ordered maps must not include duplicate keys: ${i.value}`):s.push(i.value));return Object.assign(new mt,t)},createNode:(n,e,t)=>mt.from(n,e,t)};function fi({value:n,source:e},t){return e&&(n?hi:mi).test.test(e)?e:n?t.options.trueStr:t.options.falseStr}const hi={identify:n=>n===!0,default:!0,tag:"tag:yaml.org,2002:bool",test:/^(?:Y|y|[Yy]es|YES|[Tt]rue|TRUE|[Oo]n|ON)$/,resolve:()=>new P(!0),stringify:fi},mi={identify:n=>n===!1,default:!0,tag:"tag:yaml.org,2002:bool",test:/^(?:N|n|[Nn]o|NO|[Ff]alse|FALSE|[Oo]ff|OFF)$/,resolve:()=>new P(!1),stringify:fi},Va={identify:n=>typeof n=="number",default:!0,tag:"tag:yaml.org,2002:float",test:/^(?:[-+]?\.(?:inf|Inf|INF)|\.nan|\.NaN|\.NAN)$/,resolve:n=>n.slice(-3).toLowerCase()==="nan"?NaN:n[0]==="-"?Number.NEGATIVE_INFINITY:Number.POSITIVE_INFINITY,stringify:$e},Ua={identify:n=>typeof n=="number",default:!0,tag:"tag:yaml.org,2002:float",format:"EXP",test:/^[-+]?(?:[0-9][0-9_]*)?(?:\.[0-9_]*)?[eE][-+]?[0-9]+$/,resolve:n=>parseFloat(n.replace(/_/g,"")),stringify(n){const e=Number(n.value);return isFinite(e)?e.toExponential():$e(n)}},Da={identify:n=>typeof n=="number",default:!0,tag:"tag:yaml.org,2002:float",test:/^[-+]?(?:[0-9][0-9_]*)?\.[0-9_]*$/,resolve(n){const e=new P(parseFloat(n.replace(/_/g,""))),t=n.indexOf(".");if(t!==-1){const s=n.substring(t+1).replace(/_/g,"");s[s.length-1]==="0"&&(e.minFractionDigits=s.length)}return e},stringify:$e},Bt=n=>typeof n=="bigint"||Number.isInteger(n);function hn(n,e,t,{intAsBigInt:s}){const i=n[0];if((i==="-"||i==="+")&&(e+=1),n=n.substring(e).replace(/_/g,""),s){switch(t){case 2:n=`0b${n}`;break;case 8:n=`0o${n}`;break;case 16:n=`0x${n}`;break}const o=BigInt(n);return i==="-"?BigInt(-1)*o:o}const a=parseInt(n,t);return i==="-"?-1*a:a}function as(n,e,t){const{value:s}=n;if(Bt(s)){const i=s.toString(e);return s<0?"-"+t+i.substr(1):t+i}return $e(n)}const Ha={identify:Bt,default:!0,tag:"tag:yaml.org,2002:int",format:"BIN",test:/^[-+]?0b[0-1_]+$/,resolve:(n,e,t)=>hn(n,2,2,t),stringify:n=>as(n,2,"0b")},ja={identify:Bt,default:!0,tag:"tag:yaml.org,2002:int",format:"OCT",test:/^[-+]?0[0-7_]+$/,resolve:(n,e,t)=>hn(n,1,8,t),stringify:n=>as(n,8,"0")},Ka={identify:Bt,default:!0,tag:"tag:yaml.org,2002:int",test:/^[-+]?[0-9][0-9_]*$/,resolve:(n,e,t)=>hn(n,0,10,t),stringify:$e},qa={identify:Bt,default:!0,tag:"tag:yaml.org,2002:int",format:"HEX",test:/^[-+]?0x[0-9a-fA-F_]+$/,resolve:(n,e,t)=>hn(n,2,16,t),stringify:n=>as(n,16,"0x")};class pt extends Ce{constructor(e){super(e),this.tag=pt.tag}add(e){let t;ie(e)?t=e:e&&typeof e=="object"&&"key"in e&&"value"in e&&e.value===null?t=new be(e.key,null):t=new be(e,null),et(this.items,t.key)||this.items.push(t)}get(e,t){const s=et(this.items,e);return!t&&ie(s)?Y(s.key)?s.key.value:s.key:s}set(e,t){if(typeof t!="boolean")throw new Error(`Expected boolean value for set(key, value) in a YAML set, not ${typeof t}`);const s=et(this.items,e);s&&!t?this.items.splice(this.items.indexOf(s),1):!s&&t&&this.items.push(new be(e))}toJSON(e,t){return super.toJSON(e,t,Set)}toString(e,t,s){if(!e)return JSON.stringify(this);if(this.hasAllNullValues(!0))return super.toString(Object.assign({},e,{allNullValues:!0}),t,s);throw new Error("Set items must all have null values")}static from(e,t,s){const{replacer:i}=s,a=new this(e);if(t&&Symbol.iterator in Object(t))for(let o of t)typeof i=="function"&&(o=i.call(t,o,o)),a.items.push(Zn(o,null,s));return a}}pt.tag="tag:yaml.org,2002:set";const os={collection:"map",identify:n=>n instanceof Set,nodeClass:pt,default:!1,tag:"tag:yaml.org,2002:set",createNode:(n,e,t)=>pt.from(n,e,t),resolve(n,e){if($t(n)){if(n.hasAllNullValues(!0))return Object.assign(new pt,n);e("Set items must all have null values")}else e("Expected a mapping for this tag");return n}};function rs(n,e){const t=n[0],s=t==="-"||t==="+"?n.substring(1):n,i=o=>e?BigInt(o):Number(o),a=s.replace(/_/g,"").split(":").reduce((o,r)=>o*i(60)+i(r),i(0));return t==="-"?i(-1)*a:a}function pi(n){let{value:e}=n,t=o=>o;if(typeof e=="bigint")t=o=>BigInt(o);else if(isNaN(e)||!isFinite(e))return $e(n);let s="";e<0&&(s="-",e*=t(-1));const i=t(60),a=[e%i];return e<60?a.unshift(0):(e=(e-a[0])/i,a.unshift(e%i),e>=60&&(e=(e-a[0])/i,a.unshift(e))),s+a.map(o=>String(o).padStart(2,"0")).join(":").replace(/000000\d*$/,"")}const gi={identify:n=>typeof n=="bigint"||Number.isInteger(n),default:!0,tag:"tag:yaml.org,2002:int",format:"TIME",test:/^[-+]?[0-9][0-9_]*(?::[0-5]?[0-9])+$/,resolve:(n,e,{intAsBigInt:t})=>rs(n,t),stringify:pi},yi={identify:n=>typeof n=="number",default:!0,tag:"tag:yaml.org,2002:float",format:"TIME",test:/^[-+]?[0-9][0-9_]*(?::[0-5]?[0-9])+\.[0-9_]*$/,resolve:n=>rs(n,!1),stringify:pi},mn={identify:n=>n instanceof Date,default:!0,tag:"tag:yaml.org,2002:timestamp",test:RegExp("^([0-9]{4})-([0-9]{1,2})-([0-9]{1,2})(?:(?:t|T|[ \\t]+)([0-9]{1,2}):([0-9]{1,2}):([0-9]{1,2}(\\.[0-9]+)?)(?:[ \\t]*(Z|[-+][012]?[0-9](?::[0-9]{2})?))?)?$"),resolve(n){const e=n.match(mn.test);if(!e)throw new Error("!!timestamp expects a date, starting with yyyy-mm-dd");const[,t,s,i,a,o,r]=e.map(Number),l=e[7]?Number((e[7]+"00").substr(1,3)):0;let c=Date.UTC(t,s-1,i,a||0,o||0,r||0,l);const u=e[8];if(u&&u!=="Z"){let d=rs(u,!1);Math.abs(d)<30&&(d*=60),c-=6e4*d}return new Date(c)},stringify:({value:n})=>(n==null?void 0:n.toISOString().replace(/(T00:00:00)?\.000Z$/,""))??""},_s=[wt,_t,un,dn,hi,mi,Ha,ja,Ka,qa,Va,Ua,Da,ns,je,is,ss,os,gi,yi,mn],Ss=new Map([["core",Ra],["failsafe",[wt,_t,un]],["json",Ba],["yaml11",_s],["yaml-1.1",_s]]),ks={binary:ns,bool:es,float:ai,floatExp:ii,floatNaN:si,floatTime:yi,int:li,intHex:ci,intOct:ri,intTime:gi,map:wt,merge:je,null:dn,omap:is,pairs:ss,seq:_t,set:os,timestamp:mn},Wa={"tag:yaml.org,2002:binary":ns,"tag:yaml.org,2002:merge":je,"tag:yaml.org,2002:omap":is,"tag:yaml.org,2002:pairs":ss,"tag:yaml.org,2002:set":os,"tag:yaml.org,2002:timestamp":mn};function Ln(n,e,t){const s=Ss.get(e);if(s&&!n)return t&&!s.includes(je)?s.concat(je):s.slice();let i=s;if(!i)if(Array.isArray(n))i=[];else{const a=Array.from(Ss.keys()).filter(o=>o!=="yaml11").map(o=>JSON.stringify(o)).join(", ");throw new Error(`Unknown schema "${e}"; use one of ${a} or define customTags array`)}if(Array.isArray(n))for(const a of n)i=i.concat(a);else typeof n=="function"&&(i=n(i.slice()));return t&&(i=i.concat(je)),i.reduce((a,o)=>{const r=typeof o=="string"?ks[o]:o;if(!r){const l=JSON.stringify(o),c=Object.keys(ks).map(u=>JSON.stringify(u)).join(", ");throw new Error(`Unknown custom tag ${l}; use one of ${c}`)}return a.includes(r)||a.push(r),a},[])}const Ya=(n,e)=>n.key<e.key?-1:n.key>e.key?1:0;class ls{constructor({compat:e,customTags:t,merge:s,resolveKnownTags:i,schema:a,sortMapEntries:o,toStringDefaults:r}){this.compat=Array.isArray(e)?Ln(e,"compat"):e?Ln(null,e):null,this.name=typeof a=="string"&&a||"core",this.knownTags=i?Wa:{},this.tags=Ln(t,this.name,s),this.toStringOptions=r??null,Object.defineProperty(this,Ye,{value:wt}),Object.defineProperty(this,Ue,{value:un}),Object.defineProperty(this,bt,{value:_t}),this.sortMapEntries=typeof o=="function"?o:o===!0?Ya:null}clone(){const e=Object.create(ls.prototype,Object.getOwnPropertyDescriptors(this));return e.tags=this.tags.slice(),e}}function Ga(n,e){var l;const t=[];let s=e.directives===!0;if(e.directives!==!1&&n.directives){const c=n.directives.toString(n);c?(t.push(c),s=!0):n.directives.docStart&&(s=!0)}s&&t.push("---");const i=Xs(n,e),{commentString:a}=i.options;if(n.commentBefore){t.length!==1&&t.unshift("");const c=a(n.commentBefore);t.unshift(De(c,""))}let o=!1,r=null;if(n.contents){if(se(n.contents)){if(n.contents.spaceBefore&&s&&t.push(""),n.contents.commentBefore){const d=a(n.contents.commentBefore);t.push(De(d,""))}i.forceBlockIndent=!!n.comment,r=n.contents.comment}const c=r?void 0:()=>o=!0;let u=gt(n.contents,i,()=>r=null,c);r&&(u+=Ze(u,"",a(r))),(u[0]==="|"||u[0]===">")&&t[t.length-1]==="---"?t[t.length-1]=`--- ${u}`:t.push(u)}else t.push(gt(n.contents,i));if((l=n.directives)!=null&&l.docEnd)if(n.comment){const c=a(n.comment);c.includes(`
...
`:case`\r
`:return"newline";case"-":return"seq-item-ind";case"?":return"explicit-key-ind";case":":return"map-value-ind";case"{":return"flow-map-start";case"}":return"flow-map-end";case"[":return"flow-seq-start";case"]":return"flow-seq-end";case",":return"comma"}switch(n[0]){case" ":case"	":return"space";case"#":return"comment";case"%":return"directive-line";case"*":return"alias";case"&":return"anchor";case"!":return"tag";case"'":return"single-quoted-scalar";case'"':return"double-quoted-scalar";case"|":case">":return"block-scalar-header"}return null}function Pe(n){switch(n){case void 0:case" ":case`
...
`,$s=(()=>{const n=Ke(dr),e={};for(const t of Object.values(n))for(const[s,i]of Object.entries(t))e[s]=i;return e})(),sn="#4CD98A",Gn="#E8951C",Oi="#D7372A",Pi=.2,xi=.5,Fs=2;function Ri(n){const e=Math.abs(n-1);return e<=Pi?{word:"On target",colour:sn}:e<=xi?{word:n>1?"Too high":"Too low",colour:Gn}:{word:n>1?"Way too high":"Way too low",colour:Oi}}function fr(n){const e=Math.abs(n-1),t=n>=1;return e<=Pi?t?"greenHigh":"greenLow":e<=xi?t?"amberHigh":"amberLow":t?"redHigh":"redLow"}function hr(n){return Math.min(Math.max(n,0),Fs)/Fs*100}function mr(n){return n>=85?{word:"Almost perfect",colour:sn}:n>=65?{word:"Really close",colour:sn}:n>=45?{word:"Getting there",colour:Gn}:n>=25?{word:"Not quite",colour:Gn}:{word:"Way off - try again",colour:Oi}}function pr(n,e,t){var o,r;const s=fr(t),i=((o=$s[n])==null?void 0:o[s])??((r=$s[e])==null?void 0:r[s]);return i||(Ri(t).colour===sn?`${e} is very close to the target value for this simulation.`:t<1?`${e} is below the target value for this simulation.`:`${e} is above the target value for this simulation.`)}function gr(n,e,t){return n.metadata.results.map(s=>{const i=yr(s,n,e,t);if(i===null)return null;const a=i/Math.max(s.target,1e-9),o=br(s,n,t),r=pr(s.id,o,a),l=Re($i(String(i),s),s.unit);return{id:s.id,label:o,value:a,rawValue:i,formattedValue:l,detail:r}}).filter(s=>s!==null)}function yr(n,e,t,s){var l;const i=n.id,a=e.parameters.find(c=>c.id===i);if(a)return t[i]??a.fallbackValue;const o=vr((l=s==null?void 0:s.summaryMetrics[i])==null?void 0:l.value);if(o!==null)return o;const r=s==null?void 0:s.parameterValues[i];return typeof r=="number"&&Number.isFinite(r)?r:null}function br(n,e,t){var i,a;const s=n.id;return n.label??((i=e.parameters.find(o=>o.id===s))==null?void 0:i.label)??((a=t==null?void 0:t.summaryMetrics[s])==null?void 0:a.label)??s}function vr(n){if(n===void 0)return null;const e=Number(n);return Number.isFinite(e)?e:null}function wr(n){if(n.length===0)return 0;const e=n.reduce((t,s)=>t+Math.max(0,1-Math.abs(s.value-1)),0);return Math.round(e/n.length*100)}function _r(n,e){const t=document.createElement("section");t.className="overlay overlay--summary",t.hidden=!0,t.classList.add("is-hidden");let s;const i=document.createElement("div");i.className="summary-overlay";const a=document.createElement("div"),o=document.createElement("div");a.className="summary-overlay__header",o.className="summary-overlay__content";const r=document.createElement("p");r.className="summary-overlay__title",r.textContent="Run Summary";const l=document.createElement("p");l.className="summary-overlay__hint",l.textContent="Select any card for more details",a.appendChild(r),a.appendChild(l);const c=document.createElement("div");c.className="summary-overlay__actions";const u=document.createElement("button");u.className="summary-overlay__button",u.type="button",u.textContent="Continue Visualising";const d=document.createElement("button"),p=document.createElement("button");d.className="summary-overlay__button summary-overlay__button--primary",d.type="button",d.textContent="New Parameters",p.className="summary-overlay__button",p.type="button",p.textContent="Home",p.hidden=!e.showHome,u.addEventListener("click",e.onReplay),d.addEventListener("click",e.onParameters),p.addEventListener("click",e.onHome),c.appendChild(d),c.appendChild(u),c.appendChild(p),i.appendChild(a),i.appendChild(o),i.appendChild(c),t.appendChild(i);const m=document.createElement("div");m.className="sci-modal is-hidden",m.innerHTML=`
  ...
  `,t.appendChild(m),n.appendChild(t);const b=m.querySelector(".sci-modal__title"),h=m.querySelector(".sci-modal__verdict"),y=m.querySelector(".sci-modal__body"),S=m.querySelector(".sci-modal__close"),v=new Set;let L=!1;function k(E){const T=Ri(E.value);b.textContent=E.label,h.textContent=T.word,h.style.color=T.colour,h.hidden=!1,y.textContent=E.detail,m.classList.remove("is-hidden")}function g(E,T){b.textContent=E,h.hidden=!0,y.textContent=T,m.classList.remove("is-hidden")}function w(){m.classList.add("is-hidden")}S.addEventListener("click",w),m.addEventListener("click",E=>{E.target===m&&w()}),t.addEventListener("click",E=>{E.target===t&&e.onReplay()});function N(E,T){const R=document.createElement("div");R.className=`${E.className} panel`,R.innerHTML=`<p class="sci-section__title">${E.title}</p>`;const x=document.createElement("div"),$=E.singleRow?Math.max(1,E.stats.length):Math.max(1,Math.min(E.stats.length,E.maxColumns));x.className="metric-grid",E.singleRow&&x.classList.add("metric-grid--single-row"),x.style.setProperty("--summary-grid-columns",String($)),x.style.setProperty("--summary-grid-max-width",`${E.maxWidthRem}rem`);for(const H of E.stats){const G=Sr(H,T),W=document.createElement("div"),j=document.createElement("span"),Z=document.createElement("span");W.className="res-card",j.className="res-card__label",j.textContent=G.label,Z.className="res-card__value",Z.textContent=G.value,W.appendChild(j),W.appendChild(Z),H.description&&(W.classList.add("res-card--has-info"),W.addEventListener("click",()=>{g(G.label,H.description)})),x.appendChild(W)}return R.appendChild(x),R}return{show(){s&&(window.clearTimeout(s),s=void 0),t.hidden=!1,t.classList.remove("is-hidden"),t.classList.remove("is-visible"),t.offsetWidth,requestAnimationFrame(()=>{t.classList.add("is-visible")})},hide(){t.classList.remove("is-visible"),s=window.setTimeout(()=>{t.hidden=!0,t.classList.add("is-hidden"),s=void 0,L&&(v.clear(),L=!1)},cr.HIDE_AFTER_MS)},setHomeVisible(E){p.hidden=!E},update(E,T,R,x,$){var I,M,V,B,F,de;o.innerHTML="",w();const H=ar(E,T,R,x),G=E.metadata.summaryStats,W=gr(E,T,x),j=new Set(W.map(U=>U.id));let Z;if(W.length>0)Z=wr(W);else{const U=((I=H.similarityScore)==null?void 0:I.value)??"0/100";Z=parseInt(U,10)||0}const ve=mr(Z),ke=document.createElement("div"),ue=document.createElement("div"),oe=document.createElement("div");ke.className="sci-top",ue.className="summary-main-column",oe.className="summary-side-column";const we=document.createElement("div");we.className="sci-hero panel",$?(we.classList.add("sci-hero--thumbnail"),we.innerHTML=`<img class="sci-hero__thumbnail" src="${$}" alt="Final frame of simulation" />`):we.innerHTML=`
          <div class="sci-hero__score">
            <span class="sci-hero__num">${Z}</span><span class="sci-hero__outof">/100</span>
          </div>
          <div class="sci-hero__reaction" style="color:${ve.colour}">${ve.word}</div>
          <div class="sci-hero__gauge">
            <div class="sci-hero__gauge-fill" style="width:${Z}%; background:${ve.colour}; box-shadow:0 0 12px ${ve.colour}"></div>
          </div>
        `,ue.appendChild(we);const he=G.filter(U=>(U.section??"resources")==="resources"&&!W.some(re=>re.id===String(U.id))&&U.id!=="similarityScore"),Ee=G.filter(U=>U.section==="simulationStats"&&!j.has(String(U.id)));he.length>0&&oe.appendChild(N({title:"Resources Used",className:"res-section",stats:he,maxColumns:3,maxWidthRem:48},H)),Ee.length>0&&oe.appendChild(N({title:"Simulation Stats",className:"res-section",stats:Ee,maxColumns:Ee.length,maxWidthRem:48,singleRow:!0},H)),ke.appendChild(ue),oe.childElementCount>0&&ke.appendChild(oe),o.appendChild(ke);const Q=E.metadata.morphologyChecklist;if(Q&&Q.length>0){const U=((V=(M=x==null?void 0:x.summaryMetrics)==null?void 0:M.morphology)==null?void 0:V.value)??null;U&&v.add(U.toLowerCase());const re=document.createElement("div");re.className="sci-bottom-row";const ee=document.createElement("div");ee.style.cssText="display:flex; flex-direction:column; gap:1.25rem;",ee.appendChild(Bs(E,T));const D=((B=Q.find(K=>K.id===(U??"").toLowerCase()))==null?void 0:B.label)??U;if(D){const K=document.createElement("div");K.className="sci-section panel param-section";const X=document.createElement("p");X.className="sci-section__title",X.textContent="Galaxy Morphology";const z=document.createElement("div");z.className="res-card res-card--has-info";const Fe=document.createElement("span");Fe.className="res-card__value",Fe.textContent=D,z.appendChild(Fe),z.addEventListener("click",()=>{var A;return g("Galaxy Morphology",((A=Q.find(q=>q.id===(U??"").toLowerCase()))==null?void 0:A.description)??`This galaxy is classified as "${D}".`)}),K.appendChild(X),K.appendChild(z),ee.appendChild(K)}re.appendChild(ee);const Le=document.createElement("div");Le.style.cssText="flex:1; display:flex; flex-direction:column; gap:1.25rem; min-width:0; min-height:0;";const Ie=((de=(F=x==null?void 0:x.summaryMetrics)==null?void 0:F.description)==null?void 0:de.value)??null;if(Ie){const K=document.createElement("div");K.className="sci-section panel",K.style.cssText="flex:0 1 auto; min-height:0; overflow-y:auto;";const X=document.createElement("p");X.className="sci-section__title",X.textContent="About This Galaxy";const z=document.createElement("p");z.className="galaxy-summary__desc-text",z.textContent=Ie,K.appendChild(X),K.appendChild(z),Le.appendChild(K)}const me=document.createElement("div");me.className="sci-section panel",me.style.cssText="flex:1; min-height:0;";const pe=document.createElement("p");pe.className="sci-section__title",pe.textContent="Morphology Scavenger Hunt";const _e=document.createElement("div");_e.className="galaxy-summary__checklist",_e.style.cssText="flex:1; align-items:center;";const st=v.size>=Q.length;for(const K of Q){const X=document.createElement("div");X.className="galaxy-summary__check",v.has(K.id)&&X.classList.add("is-found"),X.innerHTML=`
            <span class="galaxy-summary__check-box">
              ${v.has(K.id)?"✓":""}
            </span>
            <span class="galaxy-summary__check-label">${K.label}</span>
          `,_e.appendChild(X)}if(me.appendChild(pe),me.appendChild(_e),st){L=!0;const K=document.createElement("div");K.className="galaxy-summary__done",K.textContent="★ Well done! You've discovered all the galaxy types! ★",me.appendChild(K)}Le.appendChild(me),re.appendChild(Le),o.appendChild(re)}else if(W.length>0){const U=document.createElement("div");U.className="sci-bottom-row",U.appendChild(Bs(E,T));const re=document.createElement("div"),ee=document.createElement("div"),D=document.createElement("p"),Le=document.createElement("p");re.className="sci-section panel",ee.className="sci-section__header",D.className="sci-section__title",D.textContent="Similarity Results",Le.className="sci-section__hint",Le.textContent="Select any bar for details",ee.appendChild(D),ee.appendChild(Le);const Ie=document.createElement("div");Ie.className="sci-bars";for(const me of W){const pe=document.createElement("div");pe.className="sci-bar",pe.innerHTML=`
            <div class="sci-bar__name">${me.label}</div>
            <div class="sci-track">
              <div class="sci-pointer" style="left:${hr(me.value)}%">
                <div class="sci-pointer__needle"></div>
                <div class="sci-pointer__node"></div>
              </div>
            </div>
            <div class="sci-bar__value">${me.formattedValue}</div>
          `,pe.addEventListener("click",()=>k(me)),Ie.appendChild(pe)}re.appendChild(ee),re.appendChild(Ie),U.appendChild(re),o.appendChild(U)}}}}function Sr(n,e){const t=e[n.id]??{label:n.id,value:"--"},s=t.value!=="--"?t.value:"--",i=kr(s,n);if(i)return{label:n.label??t.label,value:i};const a=$i(s,n);return{label:n.label??t.label,value:Re(a,n.unit)}}function Bs(n,e){const t=document.createElement("div");t.className="sci-section panel param-section",t.innerHTML='<p class="sci-section__title">Input Parameters</p>';const s=document.createElement("div");s.className="param-cards";for(const i of n.parameters){const a=e[i.id]??i.fallbackValue,o=i.displayUnit??i.unit,r=document.createElement("div"),l=document.createElement("span"),c=document.createElement("span");r.className="res-card",l.className="res-card__label",l.textContent=i.label,c.className="res-card__value";const u=i.displayFormat==="qualitative"&&i.qualiLabels?i.qualiLabels[Math.round(a)]??"--":ht(a,i.step,{scale:i.valueScale,format:i.displayFormat,significantFigures:i.displaySignificantFigures});c.textContent=Re(u,o),r.appendChild(l),r.appendChild(c),s.appendChild(r)}return t.appendChild(s),t}function kr(n,e){if(e.id!=="carbonBurnt"||n==="--")return null;const t=Number(n);return Number.isFinite(t)?Math.abs(t)<1?Re(nn(n,{scale:(e.valueScale??1)*1e3,mode:"float",precision:1}),"g CO2"):Re(nn(n,{scale:e.valueScale,mode:"float",precision:e.precision??2}),e.unit):Re(n,e.unit)}function $i(n,e){if(n==="--")return n;if(e.displayFormat==="scientific"||e.displayFormat==="compact"||e.displayFormat==="float")return nn(n,{scale:e.valueScale,mode:e.displayFormat,precision:e.precision});if(e.displayFormat==="integer")return nn(n,{scale:e.valueScale,mode:"integer"});const t=Number(n);if(!Number.isFinite(t))return n;const s=e.valueScale??1,i=t*s;return Rt(i)}function Er(n,e){const t=document.createElement("div");return t.className="view-switcher is-hidden",n.appendChild(t),{update(s,i){if(t.innerHTML="",s.length<=1){t.classList.add("is-hidden");return}t.classList.remove("is-hidden");for(const a of s){const o=document.createElement("div");o.className="view-switcher__row";const r=document.createElement("button");r.className="view-switcher__button",r.type="button",r.dataset.viewId=a.id,r.classList.toggle("is-active",a.id===i),r.setAttribute("aria-pressed",String(a.id===i)),r.setAttribute("aria-label",a.label??a.id);const l=Lr(a.icon);if(l){const u=document.createElement("span");u.className="view-switcher__icon",u.setAttribute("aria-hidden","true"),u.appendChild(l),r.appendChild(u)}const c=document.createElement("span");if(c.className="view-switcher__label",c.textContent=a.label??a.id,r.appendChild(c),r.addEventListener("click",()=>e.onSelect(a.id)),o.appendChild(r),a.description){const u=document.createElement("button");u.className="view-switcher__info",u.type="button",u.setAttribute("aria-label",`Info about ${a.label??a.id}`),u.appendChild(Nr()),u.addEventListener("click",d=>{d.stopPropagation(),e.onInfo(a.id,a.label??a.id,a.description??"")}),o.appendChild(u)}t.appendChild(o)}},hide(){t.innerHTML="",t.classList.add("is-hidden")}}}function Lr(n){switch(n){case"dark-matter":return Xe(`
...
`;function Ar(){const n=Ke(Ir);if(!Array.isArray(n))return[];const e=[];for(const t of n){if(!t||typeof t!="object")continue;const s=t.text;if(typeof s!="string"||s.trim().length===0)continue;const i={text:s},a=t.url;typeof a=="string"&&a.trim().length>0&&(i.url=a);const o=t.logo;typeof o=="string"&&o.trim().length>0&&(i.logo=o),t.header===!0&&(i.header=!0),e.push(i)}return e}function Cr(n,e,t,s){const i=document.createElement("div");i.className="parameter-editor",n.appendChild(i);let a=e,o={...t};function r(u,d){a=u,o=d?{...d}:Tr(u),i.innerHTML="";const p=document.createElement("div");p.className="parameter-editor__heading",p.innerHTML=`
 ...
 Engine</h1>
  ...
  `;const Z=document.createElement("select");Z.className="advanced-settings__select",Z.appendChild(new Option("None",""));for(const A of e.availableScales)Z.appendChild(new Option(A.label,A.id));j.appendChild(Z),W.appendChild(j);const ve=document.createElement("div");ve.className="advanced-settings__field",ve.innerHTML=`
  ...
  `;const ke=document.createElement("div");ke.className="advanced-settings__options";const ue=document.createElement("label"),oe=document.createElement("input");ue.className="advanced-settings__choice",oe.type="radio",oe.name="manifest-source",oe.value="local",ue.appendChild(oe),ue.append("Local manifest");const we=document.createElement("label"),he=document.createElement("input");we.className="advanced-settings__choice",he.type="radio",he.name="manifest-source",he.value="online",we.appendChild(he),we.append("Online manifest"),ke.appendChild(ue),ke.appendChild(we),ve.appendChild(ke),W.appendChild(ve);const Ee=document.createElement("label");Ee.className="advanced-settings__field advanced-settings__field--inline";const Q=document.createElement("input"),I=document.createElement("span");Q.type="checkbox",Q.className="advanced-settings__checkbox",I.innerHTML=`
  ...
  `,Ee.appendChild(Q),Ee.appendChild(I),W.appendChild(Ee);const M=document.createElement("div");M.className="advanced-settings__field",M.innerHTML=`
  ...
  `;const V=document.createElement("div");V.className="advanced-settings__options";const B=new Map;for(const A of e.availableScales){const q=document.createElement("label"),te=document.createElement("input");q.className="advanced-settings__choice",te.type="checkbox",te.value=A.id,B.set(A.id,te),q.appendChild(te),q.append(`Show ${A.label}`),V.appendChild(q)}M.appendChild(V),W.appendChild(M),T.appendChild(W),y.appendChild(T);const F=document.createElement("section");F.className="config-overlay__section config-overlay__section--grow",F.dataset.section="credits",F.innerHTML=`
    <div class="credits-list" data-credits></div>
  `;const de=F.querySelector("[data-credits]"),U=Ar();if(de.innerHTML="",U.length===0){const A=document.createElement("div");A.className="credits-list__entry",A.textContent="To be credited...",de.appendChild(A)}else for(const A of U)if(A.header){const q=document.createElement("div");q.className="credits-list__heading",q.textContent=A.text,de.appendChild(q)}else{const q=document.createElement("div");q.className="credits-list__entry";const te=document.createElement("span");if(te.className="credits-list__text",A.url){const J=document.createElement("a");J.className="credits-list__link",J.href=A.url,J.target="_blank",J.rel="noopener noreferrer",J.textContent=A.text,te.appendChild(J)}else te.textContent=A.text;q.appendChild(te),de.appendChild(q)}const re=document.createElement("div");re.className="config-overlay__footer";const ee=document.createElement("button");ee.className="run-button",ee.type="button",ee.textContent="Run",re.appendChild(ee),r.appendChild(l),r.appendChild(b),r.appendChild(y),r.appendChild(F),r.appendChild(re),i.appendChild(a),i.appendChild(r),s.appendChild(i),t.appendChild(s),n.appendChild(t);let D=At(e.advancedSettings),Le="closed";const Ie=Cr(h,e.simClass,e.values,e.onValuesChange),me=Bo(S,e.theme,e.onThemeChange);m.addEventListener("click",e.onClose),R.addEventListener("click",()=>{if(Le==="open"){K("closed");return}K("auth"),$.focus()}),H.addEventListener("click",st),$.addEventListener("keydown",A=>{A.key==="Enter"&&st()}),Z.addEventListener("change",()=>{D.lockedScaleId=Z.value||null,_e()}),oe.addEventListener("change",()=>{oe.checked&&(D.manifestSource="local")}),he.addEventListener("change",()=>{he.checked&&(D.manifestSource="online")}),Q.addEventListener("change",()=>{D.verboseLogging=Q.checked}),k.addEventListener("change",()=>{D.audioMutedByDefault=k.checked}),N.addEventListener("input",()=>{D.defaultAudioVolume=Number(N.value)/100,Fe()});for(const[A,q]of B.entries())q.addEventListener("change",()=>{if(Array.from(B.entries()).filter(([,J])=>J.checked).map(([J])=>J).length===0&&!D.lockedScaleId){q.checked=!0;return}D.hiddenScaleIds=Array.from(B.keys()).filter(J=>{var Be;return!((Be=B.get(J))!=null&&Be.checked)&&J!==D.lockedScaleId}),_e()}),A===D.lockedScaleId&&(q.disabled=!0);pe(e.initialView??"parameters"),_e();function pe(A){r.dataset.view=A,A==="parameters"?(u.textContent=e.simClass.label,d.textContent="Shape Your Simulation",p.textContent=e.simClass.parameterSubtitle??"Adjust the parameters, inspect the setup, and press 'Run' when you're ready.",o.src=e.simClass.placeholderImage,o.alt=`${e.simClass.label} preview`):A==="settings"?(u.textContent="Interface",d.textContent="Adjust The Control Room",p.textContent="Change the interface theme and manage exhibit-level options for this installation.",o.src=ae("assets/Cluster_Stuart.webp"),o.alt="Galaxy cluster simulation preview"):(u.textContent="References",d.textContent="Project Sources And Attribution",p.textContent="Review the datasets, imagery, and supporting materials behind this experience.",o.src=ae("assets/synthetic_hst_pretty_galaxy.webp"),o.alt="Synthetic galaxy image preview"),A==="settings"?ee.textContent="Apply":A==="credits"?ee.textContent="Close":ee.textContent="Run Simulation"}function _e(){Z.value=D.lockedScaleId??"",oe.checked=D.manifestSource==="local",he.checked=D.manifestSource==="online",Q.checked=D.verboseLogging,k.checked=D.audioMutedByDefault,N.value=String(Math.round(D.defaultAudioVolume*100)),Fe();for(const[A,q]of B.entries()){const te=D.lockedScaleId===A;q.checked=te||!D.hiddenScaleIds.includes(A),q.disabled=te}}function st(){if($.value!==Mr){G.textContent="Incorrect password";return}$.value="",G.textContent="",K("open")}function K(A){Le=A,T.dataset.state=A,R.textContent=A==="open"?"Hide Advanced Settings":"Advanced Settings",A!=="auth"&&(G.textContent="")}function X(){$.value="",G.textContent="",K("closed")}function z(){D=At(e.advancedSettings),_e()}function Fe(){E.textContent=`${Math.round(Number(N.value))}%`}return ee.addEventListener("click",()=>{const A=r.dataset.view;if(A==="settings"){e.onApplySettings(At(D));return}if(A==="credits"){e.onClose();return}e.onRun()}),{show(){t.hidden=!1,t.classList.remove("is-hidden")},hide(){t.hidden=!0,t.classList.add("is-hidden"),z(),X()},setSimulation(A,q){e.simClass=A,a.dataset.simClass=A.id,Ie.setSimClass(A,q),r.dataset.view==="parameters"&&(o.src=A.placeholderImage,o.alt=`${A.label} preview`,pe("parameters"))},setTheme(A){me.setActive(A)},setView(A){pe(A),A!=="settings"&&X()},setAdvancedSettings(A){e.advancedSettings=At(A),D=At(A),_e(),X()}}}function At(n){return{lockedScaleId:n.lockedScaleId,manifestSource:n.manifestSource,verboseLogging:n.verboseLogging,hiddenScaleIds:[...n.hiddenScaleIds],audioMutedByDefault:n.audioMutedByDefault,defaultAudioVolume:n.defaultAudioVolume}}function Fr(n){const{TYPING_MS_PER_CHAR:e,MIN_TERMINAL_TIME_MS:t,FINAL_PAUSE_MS:s}=Yn,i=document.createElement("section");i.className="overlay overlay--initializing",i.hidden=!0,i.classList.add("is-hidden");const a=document.createElement("div");a.className="terminal";const o=document.createElement("div");o.className="terminal__header",o.innerHTML=`
...
`,Wr={planetary:jr,galaxy:Kr,cosmos:qr};function Yr(n){return Ke(Wr[n.id]).map(t=>({text:t}))}function Gr(n){return n.replace(/\.mp4($|\?)/,".yaml$1")}async function zr(n){try{const e=await We(n);if(!e.ok)return null;const t=await e.text(),s=Ke(t),i=ct(s.wallclockSeconds),a=ct(s.computeUsed),o=ct(s.memoryUsed),r=ct(s.carbonBurnt),l=ct(s.particlesUpdated),c=await Jr(n),u=Xr(s.summaryMetrics);return i===null||a===null||o===null||r===null||l===null?null:{wallclockSeconds:i,computeUsed:a,memoryUsed:o,carbonBurnt:r,particlesUpdated:l,parameterValues:c,summaryMetrics:u}}catch{return null}}async function Jr(n){try{const e=await We(Qr(n));if(!e.ok)return{};const t=await e.text(),s=Ke(t);return Zr(s)}catch{return{}}}function Qr(n){return n.replace(/run_summary\.yaml($|\?)/,"parameters.yaml$1")}function ct(n){const e=typeof n=="number"?n:Number(n);return Number.isFinite(e)?e:null}function Xr(n){if(!n||typeof n!="object")return{};const e=n,t={};for(const[s,i]of Object.entries(e)){if(!i||typeof i!="object")continue;const a=i,o=typeof a.label=="string"?a.label:s,r=a.value;r!=null&&(t[s]={label:o,value:String(r)})}return t}function Zr(n){if(!n||typeof n!="object")return{};const e={};for(const[t,s]of Object.entries(n)){const i=ct(s);i!==null&&(e[t]=i)}return e}const Ui="[UniverseEngine]";let Di=!1;function Us(n){Di=n}function Hi(){return Di}function ce(n,e){Hi()&&console.info(Ui,n,e??"")}function He(n,e){Hi()&&console.warn(Ui,n,e??"")}const el={local:"assets/local-manifest.json",online:Mi};function tl(n="local"){let e=n;const t=new Map;return{getSource(){return e},setSource(s){s==="online"&&t.delete("online"),Ts(),e=s,ce("Manifest source updated",{source:s})},resetCache(){t.clear()},async preloadActiveManifest(){await Ki(e,t)},async findNearestVideo(s,i,a){const o=await il(e,t,s,i,a);if(o)return o;const r=ji(s);return He("Falling back to placeholder assets",{simClassId:s,source:e,fallbackUrl:r}),{url:r,liveDataUrl:nl(s),summaryUrl:Gr(r)}}}}function ji(n){switch(n){case"planetary":return ae("assets/planet_test.mp4");case"galaxy":return ae("assets/galaxy_test.mp4");case"cosmos":return ae("assets/cosmo_test.mp4");default:return ae("assets/galaxy_test.mp4")}}function nl(n){switch(n){case"planetary":return ae("assets/planet_test_planetary_stats.csv");case"galaxy":return ae("assets/galaxy_test_galaxy_stats.csv");case"cosmos":return ae("assets/cosmo_test_cosmos_stats.csv");default:return ae("assets/galaxy_test_galaxy_stats.csv")}}async function Ki(n,e){const t=e.get(n);if(t)return t;const s=el[n],i=(n==="online"?sl(s):fetch(ae(s)).then(async a=>{if(!a.ok)throw new Error(`Failed to load manifest: ${s}`);return ce("Loaded manifest",{source:n,manifestPath:s}),await a.json()})).catch(a=>(He("Manifest unavailable",{source:n,manifestPath:s,error:a instanceof Error?a.message:String(a)}),{version:1,runs:[]}));return e.set(n,i),i}async function sl(n){const e=[n,Rn];for(const t of e)try{const s=await fetch(t);if(!s.ok)continue;const i=await s.json(),a=i.primaryBase??Ds(Mi),o=i.backupBase??Ds(Rn);return Uo(a,o),t===Rn&&Do("backup"),ce("Loaded manifest",{source:"online",manifestPath:t,primaryBase:a,backupBase:o}),i}catch{continue}throw new Error(`Failed to load manifest: ${n}`)}async function il(n,e,t,s,i){const o=(await Ki(n,e)).runs.filter(d=>d.simulationId===t);if(o.length===0)return He("No manifest runs found for simulation",{simClassId:t,source:n}),null;let r=o[0],l=Hs(r,s,i);for(const d of o.slice(1)){const p=Hs(d,s,i);p<l&&(r=d,l=p)}const c=r.defaultView??Object.keys(r.views)[0],u=r.views[c];return u?(ce("Selected manifest-backed run",{simClassId:t,source:n,runId:r.runId,selectedValues:i,distance:l,viewId:c}),{url:zt(n,u),liveDataUrl:zt(n,r.liveDataPath),summaryUrl:zt(n,r.summaryPath),viewId:c,runId:r.runId,views:Object.fromEntries(Object.entries(r.views).map(([d,p])=>[d,zt(n,p)]))}):null}function zt(n,e){return n==="local"?ae(e):Ve(e)}function Ds(n){const e=new URL(n);return`${e.protocol}//${e.host}`}function Hs(n,e,t){return e.length===0?0:e.reduce((i,a)=>{var c;const o=t[a.id]??a.fallbackValue,r=((c=n.parameters)==null?void 0:c[a.id])??a.fallbackValue,l=Math.max(a.max-a.min,1e-9);return i+Math.abs(o-r)/l},0)/e.length}const Zt={mode:"time",frames:[]};async function al(n){const e=await We(n);if(!e.ok)throw new Error(`Failed to load live stats CSV: ${n}`);const t=await e.text();return ll(t)}function ol(n,e,t=0){if(n.mode==="row")return cl(n.frames,e,t);const s=n.frames;if(s.length===0)return{};if(e<=s[0].t)return{...s[0].values};const i=s[s.length-1];if(e>=i.t)return{...i.values};const a=rl(s,e),o=s[Math.max(0,a-1)],r=s[Math.min(s.length-1,a)],l=(e-o.t)/Math.max(r.t-o.t,1e-9);return ul(o.values,r.values,l)}function rl(n,e){let t=1,s=n.length-1;for(;t<s;){const i=Math.floor((t+s)/2);n[i].t<=e?t=i+1:s=i}return t}function ll(n){const e=n.split(/\r?\n/).map(s=>s.trim()).filter(Boolean);if(e.length<2)return Zt;const t=Bn(e[0]);return t[0]==="t"?{mode:"time",frames:e.slice(1).map(s=>{const i=Bn(s),a={};for(let o=1;o<t.length;o+=1)a[t[o]]=i[o]??"";return{t:parseFloat(i[0]??"0")||0,values:a}})}:{mode:"row",frames:e.slice(1).map((s,i)=>{const a=Bn(s),o={};for(let r=0;r<t.length;r+=1)o[t[r]]=a[r]??"";return{t:i,values:o}})}}function cl(n,e,t){if(n.length===0)return{};if(!Number.isFinite(t)||t<=0)return{...n[0].values};const s=Math.max(0,Math.min(1,e/t)),i=Math.round(s*(n.length-1));return{...n[i].values}}function Bn(n){const e=[];let t="",s=!1;for(let i=0;i<n.length;i+=1){const a=n[i];if(a==='"'){s=!s;continue}if(a===","&&!s){e.push(t),t="";continue}t+=a}return e.push(t),e}function ul(n,e,t){const s=new Set([...Object.keys(n),...Object.keys(e)]),i={};for(const a of s){const o=n[a]??"",r=e[a]??o,l=parseFloat(o),c=parseFloat(r);if(Number.isFinite(l)&&Number.isFinite(c)){const u=l+(c-l)*t;i[a]=dl(u);continue}i[a]=t<.5?o:r}return i}function dl(n){return n.toFixed(2).replace(new RegExp("\\.0+$|(?<=\\..*?)0+$","g"),"").replace(/\.$/,"")}function fl(n){hl(ur,n)}function hl(n,e){if(navigator.sendBeacon){const t=new Blob([JSON.stringify(e)],{type:"application/json"});if(navigator.sendBeacon(n,t)){ce("Run selection tracking dispatched",{simulationId:e.simulationId});return}}fetch(n,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),keepalive:!0}).then(t=>{t.ok?ce("Run selection tracked",{simulationId:e.simulationId}):He("Run selection tracking rejected",{simulationId:e.simulationId,status:t.status})}).catch(t=>{He("Run selection tracking failed",{simulationId:e.simulationId,error:t instanceof Error?t.message:String(t)})})}const js=50*1024*1024,ml=8,pl=6e3,gl=8e3,yl=5e3,bl=1200,vl=100,Vn={galaxy:"tron",planetary:"matrix",cosmos:"hal"};function wl(n){const e=lt.map(f=>f.id);let t=Or(e),s=ys(t);const i=tl(t.manifestSource),a=Hr();Us(t.verboseLogging),t.manifestSource==="online"&&i.preloadActiveManifest();let o=bs(t.lockedScaleId)??s[0]??lt[0],r=t.lockedScaleId?Vn[o.id]:Fo(),l=!1,c=null,u=null,d=!1,p=t.audioMutedByDefault,m=t.defaultAudioVolume,b=0,h=null,y=0,S=Zt,v=!1;const L=Object.fromEntries(lt.map(f=>[f.id,sa(f)]));Mn(r);const k=ji(o.id),g=jo(n,k),w=document.createElement("audio");w.preload="auto",w.hidden=!0,w.setAttribute("playsinline","true"),w.muted=p,w.volume=m,n.appendChild(w);const N=document.createElement("div");N.className="display-chrome",N.classList.add("is-hidden"),n.appendChild(N);const E=document.createElement("div");E.className="orientation-overlay",E.innerHTML=`
  ...
  `,n.appendChild(T);const R=document.createElement("div");R.className="synth-logo is-hidden",R.innerHTML=`
    <img
      ...
      decoding="async"
    />
  `,n.appendChild(R);const x=document.createElement("img");x.className="app-partner-logo",x.src=ae("assets/dirac-hpc-white.webp"),x.alt="DIRAC HPC",x.decoding="async",n.appendChild(x);const $=document.createElement("div");$.className="display-chrome__top-left is-hidden",n.appendChild($);const H=Br($,{onHome(){vn()},onViewSelected(f){if(f==="credits"){Dt("credits");return}Dt(f)},showHome:!t.lockedScaleId}),G=document.createElement("div");G.className="display-chrome__left-center",N.appendChild(G);const W=Er(G,{onSelect(f){ms(f)},onInfo(f,_,C){Z.textContent=_,ve.textContent=C,j.classList.add("is-visible")}}),j=document.createElement("div");j.className="view-info-overlay",j.innerHTML=`
  ...
  `,n.appendChild(j);const Z=j.querySelector(".view-info-overlay__title"),ve=j.querySelector(".view-info-overlay__text"),ke=j.querySelector(".view-info-overlay__close");j.addEventListener("click",f=>{f.target===j&&j.classList.remove("is-visible")}),ke.addEventListener("click",()=>{j.classList.remove("is-visible")});const ue=document.createElement("div");ue.className="display-chrome__top-center is-hidden",N.appendChild(ue);const oe=document.createElement("div");oe.className="display-chrome__top-right",N.appendChild(oe);const we=zo(oe),he=document.createElement("div");he.className="display-chrome__center-status",he.innerHTML=`
  ...
  `,N.appendChild(he);const Ee=Ur();g.setPlaybackRate(Ee);const Q=document.createElement("div");Q.className="display-chrome__bottom",N.appendChild(Q);const I=qo(Q,{onChange(f){D(f)},onTogglePlay:hs,onAudioToggle:Ji,onSpeedChange:Qi,onSummaryClick:zi,onScrubStart(){st(),ee()},onScrubEnd(){K(),g.isPaused()||re()},initialSpeed:Ee});I.setPlaying(!g.isPaused()),I.setAudioVisible(!1),I.setMuted(p),w.addEventListener("loadedmetadata",()=>{at(!0),Ne()});let M=null,V=null,B=null,F=!1,de=null,U=0;function re(){if(M!==null)return;function f(){const _=g.getPlaybackFraction();I.setPosition(_),g.isPaused()?M=null:M=requestAnimationFrame(f)}M=requestAnimationFrame(f)}function ee(){M!==null&&(cancelAnimationFrame(M),M=null)}function D(f){V=f,B===null&&(B=requestAnimationFrame(()=>{if(B=null,V===null)return;const _=V;V=null,g.seekToFraction(_),at(!0)}))}function Le(){if(V===null)return;B!==null&&(cancelAnimationFrame(B),B=null);const f=V;V=null,g.seekToFraction(f),at(!0)}function Ie(){de!==null&&(window.clearTimeout(de),de=null)}function me(){if(!(h!=null&&h.views))return[];const f=Je(o,h);return Object.entries(h.views).filter(([_])=>_!==f).map(([,_])=>Ve(_)).filter(Boolean)}function pe(){Ie(),g.suspendPrewarming()}function _e(f=bl){Ie(),!(F||g.isPaused())&&(de=window.setTimeout(()=>{de=null,!(F||g.isPaused())&&(g.resumePrewarming(),g.prewarmSources(me()))},Math.max(0,f)))}function st(){F=!0,U=0,pe(),Ne()}function K(){F=!1,U=0,Le(),y=g.getPlaybackFraction()*g.getDurationSeconds(),ze(y),_e(),Ne()}g.onPlayStateChange(f=>{I.setPlaying(!f),f?(ee(),pe()):(re(),_e(0)),Ne()}),g.onTimeUpdate(f=>{if(y=f*g.getDurationSeconds(),F){const _=performance.now();if(_-U<vl)return;U=_}ze(y),at()});const X=document.createElement("div");X.className="overlay-layer",n.appendChild(X);const z=_r(X,{onReplay:Gi,onParameters:()=>Dt("parameters"),onHome:vn,showHome:!t.lockedScaleId});g.onEnded(()=>{l=!0;const f=g.captureFrame();z.update(o,Ae(),g.getDurationSeconds(),c,f),z.show(),Ne()});const Fe=ir(X,s,f=>{fs(f),Dt("parameters")}),A=$r(X,{simClass:o,values:Ae(),theme:r,advancedSettings:t,availableScales:lt,onValuesChange:qi,onThemeChange:bn,onRun:()=>{ce("Parameters submitted — starting run",{simClassId:o.id}),Xi().catch(f=>{He("Run failed to start",{simClassId:o.id,error:f instanceof Error?f.message:String(f)})})},onApplySettings:Wi,onClose:Yi,initialView:"parameters"}),q=Fr(X);I.setPosition(0),ze(),z.hide();const te=new WeakMap,J=f=>{const _=te.get(f);_&&(clearTimeout(_),te.delete(f)),f.classList.remove("side-collapsed")},Be=f=>{const _=te.get(f);_&&clearTimeout(_),te.set(f,setTimeout(()=>{f.classList.add("side-collapsed"),te.delete(f)},2500))},gn=f=>{const _=te.get(f);_&&(clearTimeout(_),te.delete(f)),f.classList.add("side-collapsed")},yn=(f,_)=>{const C=_.isCollapsible??(()=>!0);f.addEventListener("mouseenter",()=>J(f)),f.addEventListener("mouseleave",()=>{if(!C()){J(f);return}Be(f)}),f.addEventListener("focusin",()=>J(f)),f.addEventListener("focusout",O=>{if(!f.contains(O.relatedTarget)){if(!C()){J(f);return}Be(f)}}),f.addEventListener("click",()=>{if(!C()){J(f);return}if(f.classList.contains("side-collapsed")){J(f),Be(f);return}_.toggleOnClick?gn(f):Be(f)}),C()?gn(f):J(f)};yn($,{toggleOnClick:!0,isCollapsible:()=>n.dataset.mode!=="entry"}),yn(G,{toggleOnClick:!0}),yn(Q,{toggleOnClick:!1});let St=0,it=null,Ut=0;const us=()=>{it!==null&&(cancelAnimationFrame(it),it=null)},ds=()=>{if(it!==null)return;Ut=g.getPlaybackFraction();const f=()=>{if(St===0){us();return}const C=12*(1/60)/Math.max(g.getDurationSeconds(),1);Ut=Math.max(0,Math.min(1,Ut+St*C)),g.seekToFraction(Ut),it=requestAnimationFrame(f)};it=requestAnimationFrame(f)};document.addEventListener("keydown",f=>{if(n.dataset.mode==="display"&&!(f.target instanceof HTMLInputElement||f.target instanceof HTMLTextAreaElement))switch(f.key){case"Escape":f.preventDefault(),j.classList.contains("is-visible")?j.classList.remove("is-visible"):vn();break;case" ":f.preventDefault(),hs();break;case"ArrowLeft":f.preventDefault(),J(Q),Be(Q),St=-1,ds();break;case"ArrowRight":f.preventDefault(),J(Q),Be(Q),St=1,ds();break;case"ArrowUp":case"ArrowDown":{if(f.preventDefault(),J(G),Be(G),!(h!=null&&h.views)||Object.keys(h.views).length<=1)break;const _=o.views.filter(ge=>{var Se;return((Se=h==null?void 0:h.views)==null?void 0:Se[ge.id])!==void 0});if(_.length<=1)break;const C=h.viewId??Je(o,h),O=_.findIndex(ge=>ge.id===C),le=f.key==="ArrowUp"?(O-1+_.length)%_.length:(O+1)%_.length;ms(_[le].id);break}}}),document.addEventListener("keyup",f=>{(f.key==="ArrowLeft"||f.key==="ArrowRight")&&(St=0,us())}),g.hideMedia(),g.pause(),Ge(t.lockedScaleId?"config":"entry");function fs(f){f.id===o.id&&v||(o=f,Sn(),bn(Vn[f.id]),A.setSimulation(o,Ae()),I.setPosition(0),ze(),_n(),wn())}function qi(f){L[o.id]={...f},ce("Parameter values updated",{simClassId:o.id,values:L[o.id]}),ze()}function bn(f){r=f,Mn(f),A.setTheme(f)}function Dt(f){f==="parameters"&&A.setSimulation(o,Ae()),A.setView(f),Ge("config")}function Wi(f){if(pa(f),v){z.hide(),Ge("display");return}A.setSimulation(o,Ae()),A.setView("parameters")}function Yi(){if(z.hide(),!v&&t.lockedScaleId){A.setSimulation(o,Ae()),A.setView("parameters");return}Ge(v?"display":"entry")}function vn(){t.lockedScaleId||(ce("Returning to home screen",{simClassId:o.id}),Sn(),v=!1,g.hideMedia(),Ge("entry"))}function Gi(){l=!1,z.hide(),g.getPlaybackFraction()>=.999&&(g.resetPlayback(),at(!0)),Fn(g),Ne()}function zi(){l=!0,g.pause();const f=c?g.captureFrame():null;z.update(o,Ae(),g.getDurationSeconds(),c,f),z.show(),Ne()}function hs(){g.isPaused()?Fn(g):g.pause()}function Ji(){p=!p,Ne()}function Qi(f){g.setPlaybackRate(f),Dr(f),I.setSpeed(f)}async function Xi(){const f=Ae(),_=a.start();ce("Run requested",{simClassId:o.id,values:f,manifestSource:i.getSource()});const C=await i.findNearestVideo(o.id,o.parameters,f);if(!a.isCurrent(_))return;Sn({preserveRunRequest:!0}),h=C;const O=Je(o,C),le=Ho(i.getSource());fl({simulationId:o.id,parameters:f,manifestSource:i.getSource(),matchedRunId:C.runId,assetHostMode:le.mode,assetHostBase:le.base});const ge=la(C,O)??C.url,Se=Object.entries(C.views??{}).filter(([Oe])=>Oe!==O).map(([,Oe])=>Oe);aa(C.liveDataUrl,_),oa(C.summaryUrl,_),ua(C.summaryUrl,_),g.setMuted(!0),_n(O),Et(),Ge("initializing");const Ht=Zi(ge);g.resumePrewarming(),g.prewarmSources(Se);const Lt=(async()=>{const Oe=await Ht;a.isCurrent(_)&&(ce(`Prepared active video source: ${Oe.ownedObjectUrl?"FULL-FETCH":"PROGRESSIVE"}`,{selectedViewUrl:ge,waitsForBuffer:Oe.shouldWaitForBuffer}),g.setSource(Oe.src,{ownedObjectUrl:Oe.ownedObjectUrl}),g.pause(),await g.waitForLoadedData(gl),a.isCurrent(_)&&Oe.shouldWaitForBuffer&&await g.waitForBufferedAhead(ml,pl))})();await new Promise(Oe=>{q.show(Yr(o),Oe,Lt,{minTerminalTimeMs:ha()})}),a.isCurrent(_)&&(v=!0,g.showMedia(),Fn(g),Ge("display"),Ne())}async function Zi(f){const _=Ve(f),C=await ea(f);if(C!==null&&C>0&&C<=js){ce("Downloading active video behind loading overlay",{videoUrl:_,contentLength:C});try{const O=await We(f);if(!O.ok)throw new Error(`Failed to download active video: ${_}`);const le=await O.blob();return ce(`Active video full fetch complete: ${le.size} bytes`,{videoUrl:Ve(f),blobType:le.type}),{src:URL.createObjectURL(le),ownedObjectUrl:!0,shouldWaitForBuffer:!1}}catch(O){He(`Full-fetch FAILED; falling back to progressive: ${O instanceof Error?O.message:String(O)}`,{videoUrl:f})}}return C!==null?ce("Active video exceeds full-fetch threshold; using progressive load",{videoUrl:f,contentLength:C,fullFetchMaxBytes:js}):ce("Could not determine active video size; using progressive load",{videoUrl:f}),ce("Using progressive active video load",{videoUrl:f}),{src:Ve(f),ownedObjectUrl:!1,shouldWaitForBuffer:!0}}async function ea(f){try{const _=await We(f,{headers:{Range:"bytes=0-0"}});ce("Probed active video size with range request",{videoUrl:f,ok:_.ok,status:_.status,contentLength:_.headers.get("Content-Length"),contentRange:_.headers.get("Content-Range")});const C=na(_.headers.get("Content-Length"));if(C!==null)return C;const O=ta(_.headers.get("Content-Range"));return O!==null?O:null}catch(_){return He("Could not probe active video size",{videoUrl:f,error:_ instanceof Error?_.message:String(_)}),null}}function ta(f){if(!f)return null;const _=f.match(/bytes\s+\d+-\d+\/(\d+)/i);if(!_)return null;const C=Number(_[1]);return Number.isFinite(C)&&C>0?C:null}function na(f){if(!f)return null;const _=Number(f);return Number.isFinite(_)?_:null}function Ge(f){if(n.dataset.mode=f,f==="entry"?document.documentElement.setAttribute("data-theme","glass"):f==="display"&&Mn(r),kt(N,f==="display"||f==="config"),kt(T,f==="display"||f==="entry"),kt($,!t.lockedScaleId&&(f==="entry"||f==="config"||f==="display")),f==="entry"?J($):gn($),f==="entry"&&!t.lockedScaleId?Fe.show():Fe.hide(),f==="config"?(q.hide(),A.setSimulation(o,Ae()),A.show()):A.hide(),f!=="display")z.hide();else if(l){const C=g.captureFrame();z.update(o,Ae(),g.getDurationSeconds(),c,C),z.show()}!v||f==="initializing"?(g.hideMedia(),f==="initializing"&&g.pause()):g.showMedia(),f!=="initializing"&&q.hide(),wn(),Ne()}function wn(){if(n.dataset.mode==="entry"){kt(R,!0);return}const f=n.dataset.mode==="display",_=o.id==="galaxy",O=Je(o,h)==="hst";kt(R,f&&_&&O)}function ze(f=0){const _=ol(S,f,g.getDurationSeconds()),C=ra(o,c,f,g.getDurationSeconds());we.update(o,Ae(),{..._,...C})}function _n(f){const _=o.views.filter(le=>{var ge;return((ge=h==null?void 0:h.views)==null?void 0:ge[le.id])!==void 0});if(_.length<=1){W.hide(),ue.classList.add("is-hidden");return}const C=f??Je(o,h),O=_.find(le=>le.id===C);W.update(_,C),O?(ue.classList.remove("is-hidden"),ue.innerHTML=`<span class="viewport-title">${O.label??O.id}</span>`):ue.classList.add("is-hidden")}function Sn(f={}){f.preserveRunRequest||a.invalidate(),S=Zt,l=!1,c=null,h=null,y=0,F=!1,V=null,Ie(),B!==null&&(cancelAnimationFrame(B),B=null),z.hide(),W.hide(),g.pause(),w.pause(),g.clearPrewarmedSources(),g.resetPlayback(),I.setPosition(0),gs()}function ms(f){if(!(h!=null&&h.views)||f===Je(o,h))return;const _=Ve(h.views[f]);if(!_)return;h.viewId=f;const C=!g.isPaused()&&!l,O=l?0:g.getPlaybackFraction();l=!1,z.hide(),g.setSource(_,{seekFraction:O,autoplay:C}),g.prewarmSources(me()),C&&!F?_e():pe(),_n(f),Et(),Ne(),j.classList.remove("is-visible"),wn()}function Ae(){return{...L[o.id]}}function sa(f){return Object.fromEntries(f.parameters.map(_=>[_.id,ia(_)]))}function ia(f){if(f.logScale){const ge=Math.log10(f.min),Se=Math.log10(f.max);return 10**(ge+Math.random()*(Se-ge))}const _=Math.max(0,Math.round((f.max-f.min)/f.step)),C=Math.floor(Math.random()*(_+1)),O=f.min+C*f.step,le=Ti(f.step);return Number(O.toFixed(le))}async function aa(f,_){let C=Zt;try{C=await al(f)}catch(O){He("Failed to load live stats",{url:f,error:O instanceof Error?O.message:String(O)})}a.isCurrent(_)&&(S=C,ze())}async function oa(f,_){const C=await zr(f);a.isCurrent(_)&&(c=C,ze(y))}function ra(f,_,C,O){if(!_||!Number.isFinite(O)||O<=0)return{};const le=Math.max(0,Math.min(1,C/O)),ge={};for(const Se of f.metadata.liveStats){if(!Se.live||!Se.fromVideo||!Se.scaleWithTime)continue;const Ht=Se.videoKey??Se.id,Lt=_[Ht];if(typeof Lt!="number"||!Number.isFinite(Lt))continue;const kn=Lt*le;ge[Se.id]=Se.integer?String(Math.floor(kn)):String(kn)}return ge}function kt(f,_){f.hidden=!_,f.classList.toggle("is-hidden",!_)}function Je(f,_){return _!=null&&_.views?_.viewId??Object.keys(_.views)[0]:_==null?void 0:_.viewId}function la(f,_){return!_||!f.views?null:f.views[_]??null}function ps(){const f=Je(o,h);return f?o.views.some(_=>_.id===f&&_.audio):!1}function ca(f){return f.replace(/run_summary\.yaml($|\?)/,"audio_track.wav$1")}async function ua(f,_){const C=ca(f),O=++b,le=await da(C);if(!(!a.isCurrent(_)||O!==b)){if(!le){gs();return}u=Ve(C),d=!0,w.src!==u&&(w.pause(),w.src=u,w.load()),Et(),Ne()}}async function da(f){try{if((await We(f,{method:"HEAD"})).ok)return!0}catch{}try{return(await We(f,{headers:{Range:"bytes=0-0"}})).ok}catch{return!1}}function gs(){b+=1,u=null,d=!1,w.pause(),w.removeAttribute("src"),w.load(),Et()}function fa(){p=t.audioMutedByDefault,m=t.defaultAudioVolume,w.muted=p,w.volume=m,I.setMuted(p)}function Et(){I.setAudioVisible(ps()&&d&&!!u),I.setMuted(p)}function at(f=!1){if(!d||!Number.isFinite(w.duration)||w.duration<=0)return;const _=Math.max(0,Math.min(w.duration,g.getPlaybackFraction()*w.duration));(f||Math.abs(w.currentTime-_)>.35)&&(w.currentTime=_)}function Ne(){const f=ps()&&d&&!!u;if(Et(),w.muted=p,w.volume=m,!f){w.pause();return}if(at(),n.dataset.mode!=="display"||g.isPaused()||l||F){w.pause();return}w.play().catch(()=>{p=!0,w.muted=!0,I.setMuted(!0)})}function ys(f){const _=new Set(Rr(f,e));return lt.filter(C=>_.has(C.id))}function bs(f){return f?lt.find(_=>_.id===f)??null:null}function ha(){return i.getSource()!=="local"?Yn.MIN_TERMINAL_TIME_MS:ma(Yn.MIN_TERMINAL_TIME_MS,yl)}function ma(f,_){const C=Math.ceil(Math.min(f,_)),O=Math.floor(Math.max(f,_));return Math.floor(Math.random()*(O-C+1))+C}function pa(f){const _=o.id,C=t.manifestSource;t=Pr(f,e),Us(t.verboseLogging),s=ys(t),i.setSource(t.manifestSource),t.manifestSource==="online"&&i.preloadActiveManifest(),H.setHomeVisible(!t.lockedScaleId),z.setHomeVisible(!t.lockedScaleId),Fe.setSimulationClasses(s),A.setAdvancedSettings(t),ce("Advanced settings updated",t),fa(),Ne(),C!==t.manifestSource&&(h=null);const O=bs(t.lockedScaleId);O&&(fs(O),O.id!==_&&(v=!1,g.hideMedia(),A.setView("parameters")),v||(bn(Vn[O.id]),A.setSimulation(o,Ae())))}}function _l(){const n=document.getElementById("app");if(!n)throw new Error("App mount element not found.");wl(n)}_l();
//# sourceMappingURL=main-CO3bYITw.js.map
