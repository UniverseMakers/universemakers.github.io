...
$&`).replace(/(?:^|\n)([\t ].*)(?:([\n\t ]*)\n(?![\n\t ]))?/g,"$1$2").replace(/\n+/g,`$&${c}`);let I=!1;const C=En(s,!0);r!=="folded"&&e!==$.BLOCK_FOLDED&&(C.onOverflow=()=>{I=!0});const k=kn(`${v}${L}${m}`,c,ns,C);if(!I)return`>${w}
...
`:case"\r":case"	":return!0;default:return!1}}const qs=new Set("0123456789ABCDEFabcdef"),$r=new Set("0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-#;/?:@&=+$_.!~*'()"),un=new Set(",[]{}"),Fr=new Set(` ,[]{}
...
`;function se(n){if(/^[a-z]+:\/\//i.test(n)||n.startsWith("data:")||n.startsWith("blob:"))return n;const e="/engine/",t=e.endsWith("/")?e:`${e}/`,s=n.startsWith("/")?n.slice(1):n;return`${t}${s}`}function ji(n,e,t){const s=n.indexOf("#"),i=s>=0?n.slice(0,s):n,a=s>=0?n.slice(s):"",r=new RegExp(`([?&])${Yr(e)}=[^&#]*`);if(r.test(i))return`${i.replace(r,`$1${e}=${encodeURIComponent(t)}`)}${a}`;const o=i.includes("?")?"&":"?";return`${i}${o}${e}=${encodeURIComponent(t)}${a}`}function Yr(n){return n.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}const Gr=Xe(jr),zr=Xe(qr),Kn=Xe(Kr),Jr=Xe(Wr),bt=Object.entries(Gr).map(([n,e])=>{var r,o,l;const t=Qr(Kn[n]),s=(((r=Kn[n])==null?void 0:r.results)??[]).map(Xr),i=((o=Jr[n])==null?void 0:o.liveStats)??[],a=zr[n]??{};return{id:n,label:e.label,placeholderImage:se(e.placeholderImage),parameterSubtitle:e.parameterSubtitle,metadata:{results:s,summaryStats:t.map(os),liveStats:i.map(os),morphologyChecklist:(l=Kn[n])==null?void 0:l.morphologyChecklist},parameters:Object.entries(a).map(([c,u])=>{const f=u.quali_labels,h=f!==void 0&&f.length>0,m=h?0:u.min,y=h?f.length-1:u.max,p=h?1:u.step??Zr(u.min,u.max),g=h?Math.floor(f.length/2):u.log_scale?Math.sqrt(u.min*u.max):eo(u.min,u.max);return{id:c,label:u.label,unit:u.unit??"",min:m,max:y,step:p,fallbackValue:g,description:u.description,valueScale:u.value_scale,displayUnit:u.display_unit,displayFormat:u.display_format,displaySignificantFigures:u.display_significant_figures,logScale:u.log_scale,qualiLabels:f,primary:u.primary??!0}}),views:(e.views??[]).map(c=>({id:c.id,label:c.label,icon:c.icon,audio:c.audio??!1,description:c.description}))}});function Qr(n){if(!n)return[];const e=[];for(const t of n.resources??[])e.push({...t,section:"resources"});for(const t of n.simulationStats??[])e.push({...t,section:"simulationStats"});return n.similarityScore&&e.push({id:"similarityScore",value:n.similarityScore.value}),e}function os(n){return{id:n.id,label:n.label,section:n.section,value:n.value,unit:n.unit,description:n.description,live:n.live??!1,liveKey:n.live_key,fromVideo:n.from_video??!1,videoKey:n.video_key,scaleWithTime:n.scale_with_time??!1,integer:n.integer??!1,valueScale:n.value_scale,displayFormat:n.display_format,precision:n.precision}}function Xr(n){return{...os(n),target:n.target}}function Zr(n,e){const s=Math.max(e-n,1e-9)/100,i=10**Math.floor(Math.log10(s)),a=s/i;let r=1;return a<=1?r=1:a<=2?r=2:a<=5?r=5:r=10,r*i}function eo(n,e){return n+(e-n)/2}const qi="universe-engine-theme",Ki=[{id:"glass",label:"Glass",icon:"[ ]"},{id:"matrix",label:"Matrix",icon:"[#]"},{id:"hal",label:"HAL 9000",icon:"( )"},{id:"nostromo",label:"Nostromo",icon:"[=]"},{id:"tron",label:"Tron",icon:"<>"}];function to(){const n=localStorage.getItem(qi);return so(n)?n:"glass"}function Wn(n){document.documentElement.setAttribute("data-theme",n),localStorage.setItem(qi,n)}function no(n,e,t){const s=document.createElement("div");s.className="theme-picker";const i=new Map;for(const r of Ki){const o=document.createElement("button");o.className="theme-picker__option",o.type="button",o.innerHTML=`
    ...
    `,o.addEventListener("click",()=>{a(r.id),t(r.id)}),s.appendChild(o),i.set(r.id,o)}n.appendChild(s),a(e);function a(r){for(const[o,l]of i.entries()){const c=o===r;l.classList.toggle("active",c),l.setAttribute("aria-pressed",String(c))}}return{setActive:a}}function so(n){return Ki.some(e=>e.id===n)}let ye=null,Ue="primary";function io(n,e=null){ye={primaryBase:n.replace(/\/+$/,""),backupBase:e?e.replace(/\/+$/,""):null}}function ao(){ye=null,Ue="primary"}function ro(n){Ue=n}function oo(n){return n==="local"?{mode:"local",base:null}:ye?{mode:Ue,base:Wi()}:{mode:"primary",base:null}}function Ke(n){if(!ye)return n;const e=Wi();if(!e)return n;if(/^https?:\/\//i.test(n)){const t=new URL(n);return!Gs(t,ye.primaryBase)&&(!ye.backupBase||!Gs(t,ye.backupBase))?n:zs(e,`${t.pathname}${t.search}${t.hash}`)}return zs(e,n)}async function tt(n,e){const t=Ke(n),s=!!(ye!=null&&ye.backupBase)&&Ue==="primary";try{const i=await fetch(t,e);if(i.ok||!s)return i;const a=await Ys(n,e);return a.ok&&(Ue="backup"),a}catch(i){if(!s)throw i;const a=await Ys(n,e);return a.ok&&(Ue="backup"),a}}function Wi(){return ye?Ue==="backup"&&ye.backupBase?ye.backupBase:ye.primaryBase:null}async function Ys(n,e){if(!(ye!=null&&ye.backupBase))throw new Error("Backup asset host is not configured.");const t=Ue;Ue="backup";try{const s=await fetch(Ke(n),e);return s.ok||(Ue=t),s}catch(s){throw Ue=t,s}}function Gs(n,e){const t=new URL(e);return n.origin===t.origin}function zs(n,e){return`${n}${e.startsWith("/")?"":"/"}${e}`}function lo(n,e){const t=document.createElement("div");t.className="viewport";const s=document.createElement("video");s.className="viewport__media is-empty",s.crossOrigin="anonymous",s.src=e,s.loop=!1,s.muted=!0,s.playsInline=!0,s.preload="auto",s.setAttribute("aria-label","Simulation output"),t.appendChild(s),n.appendChild(t);let i,a,r,o=new Set,l=!1;const c=new Map,u=new Map,f=new Map;let h=null,m=null;const y=document.createElement("canvas"),p=y.getContext("2d");s.addEventListener("play",()=>r==null?void 0:r(!1)),s.addEventListener("pause",()=>r==null?void 0:r(!0)),s.addEventListener("ended",()=>r==null?void 0:r(!0)),s.addEventListener("timeupdate",()=>{!i||!Number.isFinite(s.duration)||s.duration<=0||i(s.currentTime/s.duration)}),s.addEventListener("ended",()=>{a==null||a()});let g=s.playbackRate;function S(){h&&(URL.revokeObjectURL(h),h=null)}function v(N,x={}){const U=u.get(N);U&&(u.delete(N),x={...x,ownedObjectUrl:!0},N=U),s.classList.add("fade-out"),window.setTimeout(()=>{if(s.src.endsWith(N)){s.classList.remove("fade-out");return}const X=s.muted,D=x.seekFraction;S(),m=null,h=x.ownedObjectUrl?N:null,s.src=N,s.load(),s.onloadeddata=()=>{if(s.muted=X,D!==void 0&&Number.isFinite(s.duration)&&s.duration>0){const we=Math.max(0,Math.min(.999,D));s.currentTime=we*s.duration}else s.currentTime=0;s.playbackRate=g,s.classList.remove("fade-out"),x.autoplay&&s.play().catch(()=>{})}},120)}function _(N){s.muted=N}async function w(){await s.play()}function L(){s.pause()}function I(){s.classList.add("is-empty")}function C(){s.classList.remove("is-empty")}function k(N){if(!Number.isFinite(s.duration)||s.duration<=0)return;const x=Math.max(0,Math.min(1,N));s.currentTime=x*s.duration}function P(){s.currentTime=0,i==null||i(0)}function O(N=8e3){return s.readyState>=HTMLMediaElement.HAVE_CURRENT_DATA?Promise.resolve():new Promise(x=>{const U=()=>{D(),x()},X=window.setTimeout(()=>{D(),x()},Math.max(0,N));function D(){window.clearTimeout(X),s.removeEventListener("loadeddata",U)}s.addEventListener("loadeddata",U,{once:!0})})}function F(N,x=8e3){const U=Math.max(0,N);return U===0||A(U)?Promise.resolve():new Promise(X=>{const D=()=>{A(U)&&(Se(),X())},we=window.setTimeout(()=>{Se(),X()},Math.max(0,x));function Se(){window.clearTimeout(we),s.removeEventListener("progress",D),s.removeEventListener("canplay",D),s.removeEventListener("loadeddata",D)}s.addEventListener("progress",D),s.addEventListener("canplay",D),s.addEventListener("loadeddata",D),D()})}function E(N=250){return!s.seeking&&s.readyState>=HTMLMediaElement.HAVE_CURRENT_DATA?Promise.resolve():new Promise(x=>{const U=()=>{s.seeking||s.readyState<HTMLMediaElement.HAVE_CURRENT_DATA||(D(),x())},X=window.setTimeout(()=>{D(),x()},Math.max(0,N));function D(){window.clearTimeout(X),s.removeEventListener("seeked",U),s.removeEventListener("canplay",U),s.removeEventListener("loadeddata",U)}s.addEventListener("seeked",U),s.addEventListener("canplay",U),s.addEventListener("loadeddata",U),U()})}function A(N){const x=s.currentTime;for(let U=0;U<s.buffered.length;U+=1){const X=s.buffered.start(U),D=s.buffered.end(U);if(!(x<X||x>D))return D-x>=N}return!1}function W(N){o=new Set(N.filter(Boolean).filter(x=>x!==s.currentSrc)),l||J()}function fe(){l=!0,Y(),ee()}function z(){if(!l){J();return}l=!1,J()}function J(){for(const[N,x]of c.entries())o.has(N)||(x.removeAttribute("src"),x.load(),c.delete(N));for(const[N,x]of f.entries())o.has(N)||(x.abort(),f.delete(N));for(const N of o){if(!c.has(N)){const x=document.createElement("video");x.preload="auto",x.crossOrigin="anonymous",x.muted=!0,x.playsInline=!0,x.src=Ke(N),x.load(),c.set(N,x)}u.has(N)||f.has(N)||be(N)}}function Y(){for(const N of c.values())N.removeAttribute("src"),N.load();c.clear()}function ee(){for(const N of f.values())N.abort();f.clear()}function be(N){const x=new AbortController;f.set(N,x);const U=ji(N,"_",`${Date.now()}`);tt(U,{signal:x.signal}).then(async X=>{if(!X.ok)return;const D=await X.blob();o.has(N)&&u.set(N,URL.createObjectURL(D))}).catch(X=>{X instanceof DOMException&&X.name}).finally(()=>{f.get(N)===x&&f.delete(N)})}function ie(){o.clear(),l=!1,Y(),ee();for(const N of u.values())URL.revokeObjectURL(N);u.clear()}function ve(N){return u.get(N)??null}function Q(){if(!(!p||s.readyState<2||s.videoWidth===0||s.videoHeight===0)){y.width=s.videoWidth,y.height=s.videoHeight;try{p.drawImage(s,0,0,y.width,y.height),m=y.toDataURL("image/jpeg",.85)}catch{m=null}}}function Ne(){return Q(),m}function he(N){i=N}function Re(N){a=N}return{setSource:v,setMuted:_,play:w,pause:L,hideMedia:I,showMedia:C,seekToFraction:k,resetPlayback:P,waitForLoadedData:O,waitForBufferedAhead:F,waitForSeekSettled:E,onTimeUpdate:he,onEnded:Re,getDurationSeconds:()=>Number.isFinite(s.duration)?s.duration:0,getCurrentTimeSeconds:()=>Number.isFinite(s.currentTime)?s.currentTime:0,getPlaybackFraction:()=>!Number.isFinite(s.duration)||s.duration<=0?0:s.currentTime/s.duration,isPaused:()=>s.paused,setPlaybackRate:N=>{g=N,s.playbackRate=N},getPlaybackRate:()=>g,onPlayStateChange:N=>{r=N},getElement:()=>t,prewarmSources:W,suspendPrewarming:fe,resumePrewarming:z,clearPrewarmedSources:ie,getPrewarmedBlobUrl:ve,captureFrame:Ne}}const co=[.25,.5,1,2];function uo(n,e={}){const{onChange:t,onTogglePlay:s,onSpeedChange:i,onSummaryClick:a,onAudioToggle:r,onScrubStart:o,onScrubEnd:l,initialSpeed:c=1}=e,u=document.createElement("div");let f=!1;u.className="timeline";const h=document.createElement("div");h.className="timeline__bar-row";const m=document.createElement("div");m.className="timeline__audio is-hidden";const y=document.createElement("button");y.className="timeline__audio-btn",y.type="button",y.setAttribute("aria-label","Toggle audio mute"),y.innerHTML=fo(),y.addEventListener("click",()=>r==null?void 0:r()),m.appendChild(y);const p=document.createElement("button");p.className="timeline__play-btn",p.type="button",p.setAttribute("aria-label","Toggle playback"),p.addEventListener("click",()=>s==null?void 0:s());const g=document.createElement("input");g.className="timeline__slider",g.type="range",g.min="0",g.max="1000",g.step="1",g.value="0",g.style.setProperty("--fill","0%"),g.setAttribute("aria-label","Simulation time");const S=document.createElement("div");S.className="timeline__speed";const v=document.createElement("button");v.className="timeline__speed-btn",v.type="button",v.setAttribute("aria-label","Playback speed"),v.addEventListener("click",()=>{S.classList.toggle("open")});const _=document.createElement("div");_.className="timeline__speed-menu";for(const k of co){const P=document.createElement("button");P.className="timeline__speed-option",P.type="button",P.textContent=Yn(k),P.addEventListener("click",()=>{S.classList.remove("open"),i==null||i(k)}),_.appendChild(P)}S.appendChild(v),S.appendChild(_);const w=document.createElement("button");w.className="timeline__summary-btn",w.type="button",w.setAttribute("aria-label","View run summary"),w.textContent="ⓘ",w.addEventListener("click",()=>a==null?void 0:a()),h.appendChild(m),h.appendChild(p),h.appendChild(g),h.appendChild(S),h.appendChild(w);let L=null,I=null;return g.addEventListener("input",()=>{const k=parseInt(g.value,10)/1e3;g.style.setProperty("--fill",`${k*100}%`),L=k,I===null&&(I=requestAnimationFrame(()=>{if(I=null,L===null)return;const P=L;L=null,t==null||t(P)}))}),g.addEventListener("pointerdown",()=>{f||(f=!0,o==null||o())}),g.addEventListener("pointerup",()=>{f&&(f=!1,l==null||l())}),g.addEventListener("change",()=>{f&&(f=!1,l==null||l())}),document.addEventListener("click",k=>{S.contains(k.target)||S.classList.remove("open")}),u.appendChild(h),n.appendChild(u),C(c),{setPosition(k){const P=Math.max(0,Math.min(1,k));g.value=String(Math.round(P*1e3)),g.style.setProperty("--fill",`${P*100}%`)},setPlaying(k){p.textContent=k?"❚❚︎":"▶︎",p.classList.toggle("is-paused",!k),p.setAttribute("aria-label",k?"Pause":"Play")},setSpeed(k){C(k)},setAudioVisible(k){m.hidden=!k,m.classList.toggle("is-hidden",!k)},setMuted(k){y.classList.toggle("is-muted",k),y.setAttribute("aria-label",k?"Unmute audio":"Mute audio")}};function C(k){v.textContent=Yn(k);for(const P of _.children)P.classList.toggle("is-active",P.textContent===Yn(k))}}function Yn(n){return`x${n}`}function fo(){return`
...
`;function Yo(){const n=Xe(Wo);if(!Array.isArray(n))return[];const e=[];for(const t of n){if(!t||typeof t!="object")continue;const s=t.text;if(typeof s!="string"||s.trim().length===0)continue;const i={text:s},a=t.url;typeof a=="string"&&a.trim().length>0&&(i.url=a);const r=t.logo;typeof r=="string"&&r.trim().length>0&&(i.logo=r),t.header===!0&&(i.header=!0),e.push(i)}return e}function Go(n,e,t,s){const i=document.createElement("div");i.className="parameter-editor",n.appendChild(i);let a=e,r={...t};function o(u,f){a=u,r=f?{...f}:zo(u),i.innerHTML="";const h=document.createElement("div");h.className="parameter-editor__heading",h.innerHTML=`
 ...
 Engine</h1>
  ...
  `;const C=document.createElement("label");C.className="advanced-settings__field advanced-settings__field--inline";const k=document.createElement("input"),P=document.createElement("span");k.type="checkbox",k.className="advanced-settings__checkbox",P.innerHTML=`
  ...
  `,C.appendChild(k),C.appendChild(P),I.appendChild(C);const O=document.createElement("label");O.className="advanced-settings__field",O.innerHTML=`
  ...
  `,x.appendChild(U),x.appendChild(X),ee.appendChild(x);const D=document.createElement("label");D.className="advanced-settings__field advanced-settings__field--inline";const we=document.createElement("input"),Se=document.createElement("span");we.type="checkbox",we.className="advanced-settings__checkbox",Se.innerHTML=`
