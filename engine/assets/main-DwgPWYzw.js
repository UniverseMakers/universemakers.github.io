...
+(?!
|$)`,"g")}catch{qn=/\n+(?!\n|$)/g}function Zt({comment:n,type:e,value:t},s,i,a){const{blockQuote:r,commentString:o,lineWidth:l}=s.options;if(!r||/\n[\t ]+$/.test(t))return ft(t,s);const c=s.indent||(s.forceBlockIndent||un(t)?"  ":""),u=r==="literal"?!0:r==="folded"||e===P.BLOCK_FOLDED?!1:e===P.BLOCK_LITERAL?!0:!Ca(t,l,c.length);if(!t)return u?`|
`:`>
...
`+S.comment:c.comment=S.comment),c.range=[s.offset,h,S.offset]}else c.range=[s.offset,h,h];return c}function In(n,e,t,s,i,a){const r=t.type==="block-map"?Qa(n,e,t,s,a):t.type==="block-seq"?Xa(n,e,t,s,a):Za(n,e,t,s,a),o=r.constructor;return i==="!"||i===o.tagName?(r.tag=o.tagName,r):(i&&(r.tag=i),r)}function er(n,e,t,s,i){var p;const a=s.tag,r=a?e.directives.tagName(a.source,m=>i(a,"TAG_RESOLVE_FAILED",m)):null;if(t.type==="block-seq"){const{anchor:m,newlineAfterProp:b}=s,h=m&&a?m.offset>a.offset?m:a:m??a;h&&(!b||b.offset<h.offset)&&i(h,"MISSING_CHAR","Missing newline after block sequence props")}const o=t.type==="block-map"?"map":t.type==="block-seq"?"seq":t.start.source==="{"?"map":"seq";if(!a||!r||r==="!"||r===Ie.tagName&&o==="map"||r===tt.tagName&&o==="seq")return In(n,e,t,i,r);let l=e.schema.tags.find(m=>m.tag===r&&m.collection===o);if(!l){const m=e.schema.knownTags[r];if((m==null?void 0:m.collection)===o)e.schema.tags.push(Object.assign({},m,{default:!1})),l=m;else return m?i(a,"BAD_COLLECTION_TYPE",`${m.tag} used for ${o} collection, but expects ${m.collection??"scalar"}`,!0):i(a,"TAG_RESOLVE_FAILED",`Unresolved tag: ${r}`,!0),In(n,e,t,i,r)}const c=In(n,e,t,i,r,l),u=((p=l.resolve)==null?void 0:p.call(l,c,m=>i(a,"TAG_RESOLVE_FAILED",m),e.options))??c,d=ee(u)?u:new P(u);return d.range=c.range,d.tag=r,l!=null&&l.format&&(d.format=l.format),d}function tr(n,e,t){const s=e.offset,i=nr(e,n.options.strict,t);if(!i)return{value:"",type:null,comment:"",range:[s,s,s]};const a=i.mode===">"?P.BLOCK_FOLDED:P.BLOCK_LITERAL,r=e.source?sr(e.source):[];let o=r.length;for(let h=r.length-1;h>=0;--h){const y=r[h][1];if(y===""||y==="\r")o=h;else break}if(o===0){const h=i.chomp==="+"&&r.length>0?`
...
`:case"\r":case"	":return!0;default:return!1}}const Is=new Set("0123456789ABCDEFabcdef"),vr=new Set("0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-#;/?:@&=+$_.!~*'()"),Yt=new Set(",[]{}"),wr=new Set(` ,[]{}
...
cosmos:
  ...
  gravity_strength:
    ...
    log_scale: true
    primary: true
`,Ar=`# Summary overlay display configuration for each simulation family.
#
...
cosmos:
  ...
  similarityScore:
    value: '--'
`,Ir=`# Live telemetry HUD display configuration for each simulation family.
#
...
`,Yo={planetary:Ko,galaxy:qo,cosmos:Wo};function Go(n){return qe(Yo[n.id]).map(t=>({text:t}))}function zo(n){return n.replace(/\.mp4($|\?)/,".yaml$1")}async function Jo(n){try{const e=await Ge(n);if(!e.ok)return null;const t=await e.text(),s=qe(t),i=ct(s.wallclockSeconds),a=ct(s.computeUsed),r=ct(s.memoryUsed),o=ct(s.carbonBurnt),l=ct(s.particlesUpdated),c=await Qo(n),u=Zo(s.summaryMetrics);return i===null||a===null||r===null||o===null||l===null?null:{wallclockSeconds:i,computeUsed:a,memoryUsed:r,carbonBurnt:o,particlesUpdated:l,parameterValues:c,summaryMetrics:u}}catch{return null}}async function Qo(n){try{const e=await Ge(Xo(n));if(!e.ok)return{};const t=await e.text(),s=qe(t);return el(s)}catch{return{}}}function Xo(n){return n.replace(/run_summary\.yaml($|\?)/,"parameters.yaml$1")}function ct(n){const e=typeof n=="number"?n:Number(n);return Number.isFinite(e)?e:null}function Zo(n){if(!n||typeof n!="object")return{};const e=n,t={};for(const[s,i]of Object.entries(e)){if(!i||typeof i!="object")continue;const a=i,r=typeof a.label=="string"?a.label:s,o=a.value;o!=null&&(t[s]={label:r,value:String(o)})}return t}function el(n){if(!n||typeof n!="object")return{};const e={};for(const[t,s]of Object.entries(n)){const i=ct(s);i!==null&&(e[t]=i)}return e}const Di="[UniverseEngine]";let Hi=!1;function Hs(n){Hi=n}function ji(){return Hi}function le(n,e){ji()&&console.info(Di,n,e??"")}function je(n,e){ji()&&console.warn(Di,n,e??"")}const tl={local:"assets/local-manifest.json",online:Oi};function nl(n="local"){let e=n;const t=new Map;return{getSource(){return e},setSource(s){s==="online"&&t.delete("online"),Os(),e=s,le("Manifest source updated",{source:s})},resetCache(){t.clear()},async preloadActiveManifest(){await qi(e,t)},async findNearestVideo(s,i,a){const r=await al(e,t,s,i,a);if(r)return r;const o=Ki(s);return je("Falling back to placeholder assets",{simClassId:s,source:e,fallbackUrl:o}),{url:o,liveDataUrl:sl(s),summaryUrl:zo(o)}}}}function Ki(n){switch(n){case"planetary":return ne("assets/planet_test.mp4");case"galaxy":return ne("assets/galaxy_test.mp4");case"cosmos":return ne("assets/cosmo_test.mp4");default:return ne("assets/galaxy_test.mp4")}}function sl(n){switch(n){case"planetary":return ne("assets/planet_test_planetary_stats.csv");case"galaxy":return ne("assets/galaxy_test_galaxy_stats.csv");case"cosmos":return ne("assets/cosmo_test_cosmos_stats.csv");default:return ne("assets/galaxy_test_galaxy_stats.csv")}}async function qi(n,e){const t=e.get(n);if(t)return t;const s=tl[n],i=(n==="online"?il(s):fetch(ne(s)).then(async a=>{if(!a.ok)throw new Error(`Failed to load manifest: ${s}`);return le("Loaded manifest",{source:n,manifestPath:s}),await a.json()})).catch(a=>(je("Manifest unavailable",{source:n,manifestPath:s,error:a instanceof Error?a.message:String(a)}),{version:1,runs:[]}));return e.set(n,i),i}async function il(n){const e=[n,Rn];for(const t of e)try{const s=await fetch(t);if(!s.ok)continue;const i=await s.json(),a=i.primaryBase??js(Oi),r=i.backupBase??js(Rn);return Ur(a,r),t===Rn&&Dr("backup"),le("Loaded manifest",{source:"online",manifestPath:t,primaryBase:a,backupBase:r}),i}catch{continue}throw new Error(`Failed to load manifest: ${n}`)}async function al(n,e,t,s,i){const r=(await qi(n,e)).runs.filter(d=>d.simulationId===t);if(r.length===0)return je("No manifest runs found for simulation",{simClassId:t,source:n}),null;const o=rl(r,s,i);if(!o)return null;const l=Rt(o,s,i),c=o.defaultView??Object.keys(o.views)[0],u=o.views[c];return u?(le("Selected manifest-backed run",{simClassId:t,source:n,runId:o.runId,selectedValues:i,distance:l,viewId:c}),{url:Jt(n,u),liveDataUrl:Jt(n,o.liveDataPath),summaryUrl:Jt(n,o.summaryPath),viewId:c,runId:o.runId,views:Object.fromEntries(Object.entries(o.views).map(([d,p])=>[d,Jt(n,p)]))}):null}function Jt(n,e){return n==="local"?ne(e):Ve(e)}function js(n){const e=new URL(n);return`${e.protocol}//${e.host}`}function Rt(n,e,t,s){if(e.length===0)return 0;const i=s?e.filter(r=>s.has(r.id)):e;return i.length===0?0:i.reduce((r,o)=>{var d;const l=t[o.id]??o.fallbackValue,c=((d=n.parameters)==null?void 0:d[o.id])??o.fallbackValue,u=Math.max(o.max-o.min,1e-9);return r+Math.abs(l-c)/u},0)/i.length}function rl(n,e,t){if(n.length===0)return null;const s=new Set(e.filter(c=>c.primary!==!1).map(c=>c.id));if(!e.some(c=>c.primary===!1))return Vn(n,e,t);const a=Vn(n,e,t,s);if(!a)return null;const r=Rt(a,e,t,s),o=1e-6,l=n.filter(c=>{const u=Rt(c,e,t,s);return Math.abs(u-r)<=o});return Vn(l,e,t)}function Vn(n,e,t,s){if(n.length===0)return null;let i=n[0],a=Rt(i,e,t,s);for(const r of n.slice(1)){const o=Rt(r,e,t,s);o<a&&(i=r,a=o)}return i}const en={mode:"time",frames:[]};async function ol(n){const e=await Ge(n);if(!e.ok)throw new Error(`Failed to load live stats CSV: ${n}`);const t=await e.text();return ul(t)}function ll(n,e,t=0){if(n.mode==="row")return dl(n.frames,e,t);const s=n.frames;if(s.length===0)return{};if(e<=s[0].t)return{...s[0].values};const i=s[s.length-1];if(e>=i.t)return{...i.values};const a=cl(s,e),r=s[Math.max(0,a-1)],o=s[Math.min(s.length-1,a)],l=(e-r.t)/Math.max(o.t-r.t,1e-9);return fl(r.values,o.values,l)}function cl(n,e){let t=1,s=n.length-1;for(;t<s;){const i=Math.floor((t+s)/2);n[i].t<=e?t=i+1:s=i}return t}function ul(n){const e=n.split(/\r?\n/).map(s=>s.trim()).filter(Boolean);if(e.length<2)return en;const t=Un(e[0]);return t[0]==="t"?{mode:"time",frames:e.slice(1).map(s=>{const i=Un(s),a={};for(let r=1;r<t.length;r+=1)a[t[r]]=i[r]??"";return{t:parseFloat(i[0]??"0")||0,values:a}})}:{mode:"row",frames:e.slice(1).map((s,i)=>{const a=Un(s),r={};for(let o=0;o<t.length;o+=1)r[t[o]]=a[o]??"";return{t:i,values:r}})}}function dl(n,e,t){if(n.length===0)return{};if(!Number.isFinite(t)||t<=0)return{...n[0].values};const s=Math.max(0,Math.min(1,e/t)),i=Math.round(s*(n.length-1));return{...n[i].values}}function Un(n){const e=[];let t="",s=!1;for(let i=0;i<n.length;i+=1){const a=n[i];if(a==='"'){s=!s;continue}if(a===","&&!s){e.push(t),t="";continue}t+=a}return e.push(t),e}function fl(n,e,t){const s=new Set([...Object.keys(n),...Object.keys(e)]),i={};for(const a of s){const r=n[a]??"",o=e[a]??r,l=parseFloat(r),c=parseFloat(o);if(Number.isFinite(l)&&Number.isFinite(c)){const u=l+(c-l)*t;i[a]=hl(u);continue}i[a]=t<.5?r:o}return i}function hl(n){return n.toFixed(2).replace(new RegExp("\\.0+$|(?<=\\..*?)0+$","g"),"").replace(/\.$/,"")}function ml(n){pl(uo,n)}function pl(n,e){if(navigator.sendBeacon){const t=new Blob([JSON.stringify(e)],{type:"application/json"});if(navigator.sendBeacon(n,t)){le("Run selection tracking dispatched",{simulationId:e.simulationId});return}}fetch(n,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),keepalive:!0}).then(t=>{t.ok?le("Run selection tracked",{simulationId:e.simulationId}):je("Run selection tracking rejected",{simulationId:e.simulationId,status:t.status})}).catch(t=>{je("Run selection tracking failed",{simulationId:e.simulationId,error:t instanceof Error?t.message:String(t)})})}const Ks=50*1024*1024,gl=8,yl=6e3,bl=8e3,vl=5e3,wl=1200,_l=100,Dn={galaxy:"tron",planetary:"matrix",cosmos:"hal"};function Sl(n){const e=lt.map(f=>f.id);let t=Po(e),s=vs(t);const i=nl(t.manifestSource),a=jo();Hs(t.verboseLogging),t.manifestSource==="online"&&i.preloadActiveManifest();let r=ws(t.lockedScaleId)??s[0]??lt[0],o=t.lockedScaleId?Dn[r.id]:Fr(),l=!1,c=null,u=null,d=!1,p=t.audioMutedByDefault,m=t.defaultAudioVolume,b=0,h=null,y=0,S=en,v=!1;const L=Object.fromEntries(lt.map(f=>[f.id,ia(f)]));On(o);const k=Ki(r.id),g=jr(n,k),w=document.createElement("audio");w.preload="auto",w.hidden=!0,w.setAttribute("playsinline","true"),w.muted=p,w.volume=m,n.appendChild(w);const N=document.createElement("div");N.className="display-chrome",N.classList.add("is-hidden"),n.appendChild(N);const E=document.createElement("div");E.className="orientation-overlay",E.innerHTML=`
  ...
  `,n.appendChild(T);const R=document.createElement("div");R.className="synth-logo is-hidden",R.innerHTML=`
    <img
      ...
      decoding="async"
    />
  `,n.appendChild(R);const x=document.createElement("img");x.className="app-partner-logo",x.src=ne("assets/dirac-hpc-white.webp"),x.alt="DIRAC HPC",x.decoding="async",n.appendChild(x);const F=document.createElement("div");F.className="display-chrome__top-left is-hidden",n.appendChild(F);const j=Vo(F,{onHome(){wn()},onViewSelected(f){if(f==="credits"){Ht("credits");return}Ht(f)},showHome:!t.lockedScaleId}),z=document.createElement("div");z.className="display-chrome__left-center",N.appendChild(z);const Y=Lo(z,{onSelect(f){gs(f)},onInfo(f,_,I){X.textContent=_,be.textContent=I,K.classList.add("is-visible")}}),K=document.createElement("div");K.className="view-info-overlay",K.innerHTML=`
  ...
  `,n.appendChild(K);const X=K.querySelector(".view-info-overlay__title"),be=K.querySelector(".view-info-overlay__text"),Se=K.querySelector(".view-info-overlay__close");K.addEventListener("click",f=>{f.target===K&&K.classList.remove("is-visible")}),Se.addEventListener("click",()=>{K.classList.remove("is-visible")});const ce=document.createElement("div");ce.className="display-chrome__top-center is-hidden",N.appendChild(ce);const se=document.createElement("div");se.className="display-chrome__top-right",N.appendChild(se);const ve=zr(se),fe=document.createElement("div");fe.className="display-chrome__center-status",fe.innerHTML=`
