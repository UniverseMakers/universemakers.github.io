...
\r	`),hn=n=>!n||Da.has(n);class Ua{constructor(){this.atEnd=!1,this.blockScalarIndent=-1,this.blockScalarKeep=!1,this.buffer="",this.flowKey=!1,this.flowLevel=0,this.indentNext=0,this.indentValue=0,this.lineEndPos=null,this.next=null,this.pos=0}*lex(e,t=!1){if(e){if(typeof e!="string")throw TypeError("source is not a string");this.buffer=this.buffer?this.buffer+e:e,this.lineEndPos=null}this.atEnd=!t;let s=this.next??"stream";for(;s&&(t||this.hasChars(1));)s=yield*this.parseNext(s)}atLineEnd(){let e=this.pos,t=this.buffer[e];for(;t===" "||t==="	";)t=this.buffer[++e];return!t||t==="#"||t===`
...
`;function wr(n,e,t){const s=Z("assets/banner-1600.webp"),i=[`${Z("assets/banner-960.webp")} 960w`,`${Z("assets/banner-1600.webp")} 1600w`].join(", "),a=document.createElement("section");a.className="overlay overlay--entry",a.hidden=!0,a.classList.add("is-hidden");const r=document.createElement("div");r.className="entry-overlay",r.innerHTML=`
  ...
  `;const o=document.createElement("div");o.className="entry-overlay__actions";function c(b){o.innerHTML="";for(const d of b){const g=document.createElement("button");g.className="entry-overlay__button",g.type="button";const y=yr[d.id]??"Explore this simulation scale.";g.innerHTML=`
      ...
      `,g.addEventListener("click",()=>t(d)),o.appendChild(g)}}c(e);const l=document.createElement("div"),u=document.createElement("button");u.className="view-switcher__info entry-overlay__info-button",u.type="button",u.setAttribute("aria-label","About this experience"),u.appendChild(_r()),l.className="sci-modal is-hidden",l.innerHTML=`
    <div class="sci-modal__card entry-info-modal">
      ...
      <div class="sci-modal__body">${br}</div>
    </div>
  `,r.appendChild(o),a.appendChild(r),a.appendChild(u),a.appendChild(l),n.appendChild(a);const f=l.querySelector(".sci-modal__close");function p(){l.classList.remove("is-hidden")}function m(){l.classList.add("is-hidden")}return u.addEventListener("click",p),f.addEventListener("click",m),l.addEventListener("click",b=>{b.target===l&&m()}),{show(){a.hidden=!1,a.classList.remove("is-hidden")},hide(){m(),a.hidden=!0,a.classList.add("is-hidden")},setSimulationClasses(b){c(b)}}}function vr(n){const e=document.createElementNS("http://www.w3.org/2000/svg","svg");return e.setAttribute("viewBox","0 0 24 24"),e.setAttribute("fill","none"),e.setAttribute("stroke","currentColor"),e.setAttribute("stroke-width","1.5"),e.setAttribute("stroke-linecap","round"),e.setAttribute("stroke-linejoin","round"),e.innerHTML=n,e}function _r(){return vr(`
    <circle cx="12" cy="12" r="10"></circle>
    <path d="M12 16.5v-6"></path>
    <circle cx="12" cy="8.5" r="1.1" fill="currentColor" stroke="none"></circle>
  `)}function Sr(n,e,t,s){const i=Object.fromEntries(n.metadata.results.map(v=>[v.id,v.target])),a=n.metadata.results.map(v=>{const k=yn(n,e,s,v.id);return k===null?null:{id:v.id,value:k,target:v.target}}).filter(v=>v!==null),r=n.parameters.filter(v=>i[v.id]!==void 0).map(v=>{const k=e[v.id]??v.fallbackValue,L=i[v.id]??v.fallbackValue;return Math.abs(k-L)/Math.max(v.max-v.min,1e-9)}),o=r.reduce((v,k)=>v+k,0)/Math.max(r.length,1),c=Ir(a),l=((s==null?void 0:s.carbonBurnt)??.8+o*4.2).toFixed(2),u=(s==null?void 0:s.computeUsed)??18+o*46,f=(s==null?void 0:s.memoryUsed)??12+o*84,p=`${gn(u,1)} CPU-hrs
${gn(f,1)} GB`,m=String(n.parameters.length),b=`${(o*100).toFixed(1)}%`,d=String(n.parameters.length+6),g="Present",y=Er((s==null?void 0:s.wallclockSeconds)??t),_=fs(hs(yn(n,e,s,"moon_iron"))),I=fs(hs(yn(n,e,s,"proto_earth_in_moon"))),E=Lr(n.id,e);return{scale:{label:"Scale",value:n.label},distinctSimulations:{label:"Distinct Sims",value:String(n.metadata.distinctSimulations)},parameters:{label:"Parameters",value:m},runtime:{label:"Total Runtime",value:y},similarityScore:{label:"Similarity Score",value:`${c}/100`},bestFitDelta:{label:"Best-Fit Delta",value:b},carbonBurnt:{label:"Carbon Burnt",value:l},computeUsed:{label:"Compute Used",value:p},memoryUsed:{label:"Memory Used",value:gn(f,1)},particlesUpdated:{label:"Particle updates",value:s?kr(s.particlesUpdated):"--"},moon_iron_percent:{label:"Iron in Moon",value:_},proto_earth_in_moon_percent:{label:"Proto-Earth in Moon",value:I},scenario_likelihood:{label:"Scenario likelihood",value:E},audioTrack:{label:"Audio Track",value:g},terminalLines:{label:"Terminal Lines",value:d},...Object.fromEntries(Object.entries((s==null?void 0:s.summaryMetrics)??{}).map(([v,k])=>[v,{label:k.label,value:k.value}]))}}function kr(n){return String(Math.max(0,n))}function Er(n){return(Math.max(0,n)/3600).toFixed(2).replace(new RegExp("\\.0+$|(?<=\\..*?)0+$","g"),"").replace(/\.$/,"")}function gn(n,e){return n.toFixed(e).replace(new RegExp("\\.0+$|(?<=\\..*?)0+$","g"),"").replace(/\.$/,"")}function yn(n,e,t,s){var c;const i=n.parameters.find(l=>l.id===s);if(i)return e[s]??i.fallbackValue;const a=t==null?void 0:t.parameterValues[s];if(typeof a=="number"&&Number.isFinite(a))return a;const r=(c=t==null?void 0:t.summaryMetrics[s])==null?void 0:c.value;if(r===void 0)return null;const o=Number(r);return Number.isFinite(o)?o:null}function fs(n){return n===null?"--":n.toFixed(1)}function hs(n){return n===null?null:Math.max(0,(1-Math.abs(n-1))*100)}function Ir(n){if(n.length===0)return 0;const e=n.reduce((t,s)=>t+Math.max(0,1-Math.abs(s.value/Math.max(s.target,1e-9)-1)),0);return Math.round(e/n.length*100)}function Lr(n,e){if(n!=="planetary")return"--";const t=e.impactor_velocity,s=e.impactor_angle;if(!Number.isFinite(t)||!Number.isFinite(s))return"--";const i=Math.abs(t-15)*6,a=Math.abs(s-45)*1.6,r=Math.max(0,Math.round(100-i-a));return String(r)}const An={TYPING_MS_PER_CHAR:3.5,MIN_TERMINAL_TIME_MS:3e3,FINAL_PAUSE_MS:500},Nr={HIDE_AFTER_MS:980},Ar="https://pub-e00201311979473b8a30e279dcc56838.r2.dev/engine/run-manifest.json",Tr="https://universe-engine.universe-engine.workers.dev/api/track-run",Cr=`# Target messages for scientific bar detail popups, shown when a bar is tapped.
...
`,ms=(()=>{const n=Oe(Cr),e={};for(const t of Object.values(n))for(const[s,i]of Object.entries(t))e[s]=i;return e})(),Dt="#4CD98A",Tn="#E8951C",oi="#D7372A",li=.2,ci=.5,ps=2;function ui(n){const e=Math.abs(n-1);return e<=li?{word:"On target",colour:Dt}:e<=ci?{word:n>1?"Too high":"Too low",colour:Tn}:{word:n>1?"Way too high":"Way too low",colour:oi}}function Mr(n){const e=Math.abs(n-1),t=n>=1;return e<=li?t?"greenHigh":"greenLow":e<=ci?t?"amberHigh":"amberLow":t?"redHigh":"redLow"}function Or(n){return Math.min(Math.max(n,0),ps)/ps*100}function Pr(n){return n>=85?{word:"Almost perfect",colour:Dt}:n>=65?{word:"Really close",colour:Dt}:n>=45?{word:"Getting there",colour:Tn}:n>=25?{word:"Not quite",colour:Tn}:{word:"Way off - try again",colour:oi}}function $r(n,e,t){var r,o;const s=Mr(t),i=((r=ms[n])==null?void 0:r[s])??((o=ms[e])==null?void 0:o[s]);return i||(ui(t).colour===Dt?`${e} is very close to the target value for this simulation.`:t<1?`${e} is below the target value for this simulation.`:`${e} is above the target value for this simulation.`)}function Rr(n,e,t){return n.metadata.results.map(s=>{const i=xr(s,n,e,t);if(i===null)return null;const a=i/Math.max(s.target,1e-9),r=Fr(s,n,t),o=$r(s.id,r,a),c=Le(di(String(i),s),s.unit);return{id:s.id,label:r,value:a,rawValue:i,formattedValue:c,detail:o}}).filter(s=>s!==null)}function xr(n,e,t,s){var l;const i=n.id,a=e.parameters.find(u=>u.id===i);if(a)return t[i]??a.fallbackValue;const r=s==null?void 0:s.parameterValues[i];if(typeof r=="number"&&Number.isFinite(r))return r;const o=gs((l=s==null?void 0:s.summaryMetrics[i])==null?void 0:l.value);return o!==null?o:gs(n.value)}function Fr(n,e,t){var i,a;const s=n.id;return n.label??((i=e.parameters.find(r=>r.id===s))==null?void 0:i.label)??((a=t==null?void 0:t.summaryMetrics[s])==null?void 0:a.label)??s}function gs(n){if(n===void 0)return null;const e=Number(n);return Number.isFinite(e)?e:null}function Br(n){if(n.length===0)return 0;const e=n.reduce((t,s)=>t+Math.max(0,1-Math.abs(s.value-1)),0);return Math.round(e/n.length*100)}function Vr(n,e){const t=document.createElement("section");t.className="overlay overlay--summary",t.hidden=!0,t.classList.add("is-hidden");let s;const i=document.createElement("div");i.className="summary-overlay";const a=document.createElement("div"),r=document.createElement("div");a.className="summary-overlay__header",r.className="summary-overlay__content";const o=document.createElement("p");o.className="summary-overlay__title",o.textContent="Run Summary";const c=document.createElement("p");c.className="summary-overlay__hint",c.textContent="Select any card for more details",a.appendChild(o),a.appendChild(c);const l=document.createElement("div");l.className="summary-overlay__actions";const u=document.createElement("button");u.className="summary-overlay__button summary-overlay__button--primary",u.type="button",u.textContent="Continue Exploring";const f=document.createElement("button"),p=document.createElement("button");f.className="summary-overlay__button",f.type="button",f.textContent="New Parameters",p.className="summary-overlay__button",p.type="button",p.textContent="Home",p.hidden=!e.showHome,u.addEventListener("click",e.onReplay),f.addEventListener("click",e.onParameters),p.addEventListener("click",e.onHome),l.appendChild(u),l.appendChild(f),l.appendChild(p),i.appendChild(a),i.appendChild(r),i.appendChild(l),t.appendChild(i);const m=document.createElement("div");m.className="sci-modal is-hidden",m.innerHTML=`
...
`,no=`# Initialization terminal script for the Galaxy simulation family.
#
# Each entry is a single line that may be selected randomly at runtime.
...
`,so=`# Initialization terminal script for the Cosmos simulation family.
#
# Each entry is a single line that may be selected randomly at runtime.
...
`,io={planetary:to,galaxy:no,cosmos:so};function ao(n){return Oe(io[n.id]).map(t=>({text:t}))}function ro(n){return n.replace(/\.mp4($|\?)/,".yaml$1")}async function oo(n){try{const e=await fetch(n);if(!e.ok)return null;const t=await e.text(),s=Oe(t),i=Xe(s.wallclockSeconds),a=Xe(s.computeUsed),r=Xe(s.memoryUsed),o=Xe(s.carbonBurnt),c=Xe(s.particlesUpdated),l=await lo(n),u=uo(s.summaryMetrics);return i===null||a===null||r===null||o===null||c===null?null:{wallclockSeconds:i,computeUsed:a,memoryUsed:r,carbonBurnt:o,particlesUpdated:c,parameterValues:l,summaryMetrics:u}}catch{return null}}async function lo(n){try{const e=await fetch(co(n));if(!e.ok)return{};const t=await e.text(),s=Oe(t);return fo(s)}catch{return{}}}function co(n){return n.replace(/run_summary\.yaml($|\?)/,"parameters.yaml$1")}function Xe(n){const e=typeof n=="number"?n:Number(n);return Number.isFinite(e)?e:null}function uo(n){if(!n||typeof n!="object")return{};const e=n,t={};for(const[s,i]of Object.entries(e)){if(!i||typeof i!="object")continue;const a=i,r=typeof a.label=="string"?a.label:s,o=a.value;o!=null&&(t[s]={label:r,value:String(o)})}return t}function fo(n){if(!n||typeof n!="object")return{};const e={};for(const[t,s]of Object.entries(n)){const i=Xe(s);i!==null&&(e[t]=i)}return e}const pi="[UniverseEngine]",ho=["planetary","galaxy","cosmos"];function gi(){return hi(ho).verboseLogging}function ae(n,e){gi()&&console.info(pi,n,e??"")}function Ce(n,e){gi()&&console.warn(pi,n,e??"")}const mo={local:"assets/local-manifest.json",online:Ar};function po(n="local"){let e=n;const t=new Map;return{getSource(){return e},setSource(s){s==="online"&&t.delete("online"),e=s,ae("Manifest source updated",{source:s})},resetCache(){t.clear()},async preloadActiveManifest(){await bi(e,t)},async findNearestVideo(s,i,a){const r=await yo(e,t,s,i,a);if(r)return r;const o=yi(s);return Ce("Falling back to placeholder assets",{simClassId:s,source:e,fallbackUrl:o}),{url:o,liveDataUrl:go(s),summaryUrl:ro(o)}}}}function yi(n){switch(n){case"planetary":return Z("assets/planet_test.mp4");case"galaxy":return Z("assets/galaxy_test.mp4");case"cosmos":return Z("assets/cosmo_test.mp4");default:return Z("assets/galaxy_test.mp4")}}function go(n){switch(n){case"planetary":return Z("assets/planet_test_planetary_stats.csv");case"galaxy":return Z("assets/galaxy_test_galaxy_stats.csv");case"cosmos":return Z("assets/cosmo_test_cosmos_stats.csv");default:return Z("assets/galaxy_test_galaxy_stats.csv")}}async function bi(n,e){const t=e.get(n);if(t)return t;const s=mo[n],i=fetch(Z(s)).then(async a=>{if(!a.ok)throw new Error(`Failed to load manifest: ${s}`);return ae("Loaded manifest",{source:n,manifestPath:s}),await a.json()}).catch(a=>(Ce("Manifest unavailable",{source:n,manifestPath:s,error:a instanceof Error?a.message:String(a)}),{version:1,runs:[]}));return e.set(n,i),i}async function yo(n,e,t,s,i){const r=(await bi(n,e)).runs.filter(f=>f.simulationId===t);if(r.length===0)return Ce("No manifest runs found for simulation",{simClassId:t,source:n}),null;let o=r[0],c=ws(o,s,i);for(const f of r.slice(1)){const p=ws(f,s,i);p<c&&(o=f,c=p)}const l=o.defaultView??Object.keys(o.views)[0],u=o.views[l];return u?(ae("Selected manifest-backed run",{simClassId:t,source:n,runId:o.runId,selectedValues:i,distance:c,viewId:l}),{url:Z(u),liveDataUrl:Z(o.liveDataPath),summaryUrl:Z(o.summaryPath),viewId:l,runId:o.runId,views:Object.fromEntries(Object.entries(o.views).map(([f,p])=>[f,Z(p)]))}):null}function ws(n,e,t){return e.length===0?0:e.reduce((i,a)=>{var l;const r=t[a.id]??a.fallbackValue,o=((l=n.parameters)==null?void 0:l[a.id])??a.fallbackValue,c=Math.max(a.max-a.min,1e-9);return i+Math.abs(r-o)/c},0)/e.length}const Ft={mode:"time",frames:[]};async function bo(n){const e=await fetch(n);if(!e.ok)throw new Error(`Failed to load live stats CSV: ${n}`);const t=await e.text();return _o(t)}function wo(n,e,t=0){if(n.mode==="row")return So(n.frames,e,t);const s=n.frames;if(s.length===0)return{};if(e<=s[0].t)return{...s[0].values};const i=s[s.length-1];if(e>=i.t)return{...i.values};const a=vo(s,e),r=s[Math.max(0,a-1)],o=s[Math.min(s.length-1,a)],c=(e-r.t)/Math.max(o.t-r.t,1e-9);return ko(r.values,o.values,c)}function vo(n,e){let t=1,s=n.length-1;for(;t<s;){const i=Math.floor((t+s)/2);n[i].t<=e?t=i+1:s=i}return t}function _o(n){const e=n.split(/\r?\n/).map(s=>s.trim()).filter(Boolean);if(e.length<2)return Ft;const t=wn(e[0]);return t[0]==="t"?{mode:"time",frames:e.slice(1).map(s=>{const i=wn(s),a={};for(let r=1;r<t.length;r+=1)a[t[r]]=i[r]??"";return{t:parseFloat(i[0]??"0")||0,values:a}})}:{mode:"row",frames:e.slice(1).map((s,i)=>{const a=wn(s),r={};for(let o=0;o<t.length;o+=1)r[t[o]]=a[o]??"";return{t:i,values:r}})}}function So(n,e,t){if(n.length===0)return{};if(!Number.isFinite(t)||t<=0)return{...n[0].values};const s=Math.max(0,Math.min(1,e/t)),i=Math.round(s*(n.length-1));return{...n[i].values}}function wn(n){const e=[];let t="",s=!1;for(let i=0;i<n.length;i+=1){const a=n[i];if(a==='"'){s=!s;continue}if(a===","&&!s){e.push(t),t="";continue}t+=a}return e.push(t),e}function ko(n,e,t){const s=new Set([...Object.keys(n),...Object.keys(e)]),i={};for(const a of s){const r=n[a]??"",o=e[a]??r,c=parseFloat(r),l=parseFloat(o);if(Number.isFinite(c)&&Number.isFinite(l)){const u=c+(l-c)*t;i[a]=Eo(u);continue}i[a]=t<.5?r:o}return i}function Eo(n){return n.toFixed(2).replace(new RegExp("\\.0+$|(?<=\\..*?)0+$","g"),"").replace(/\.$/,"")}function Io(n){Lo(Tr,n)}function Lo(n,e){if(navigator.sendBeacon){const t=new Blob([JSON.stringify(e)],{type:"application/json"});if(navigator.sendBeacon(n,t)){ae("Run selection tracking dispatched",{simulationId:e.simulationId});return}}fetch(n,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),keepalive:!0}).then(t=>{t.ok?ae("Run selection tracked",{simulationId:e.simulationId}):Ce("Run selection tracking rejected",{simulationId:e.simulationId,status:t.status})}).catch(t=>{Ce("Run selection tracking failed",{simulationId:e.simulationId,error:t instanceof Error?t.message:String(t)})})}const vs=50*1024*1024,No=8,Ao=6e3,To=8e3,Co=5e3,Mo=1200,Oo=100,vn={galaxy:"tron",planetary:"matrix",cosmos:"nostromo"};function Po(n){const e=Qe.map(h=>h.id);let t=hi(e),s=Qn(t);const i=po(t.manifestSource);t.manifestSource==="online"&&i.preloadActiveManifest();let a=Xn(t.lockedScaleId)??s[0]??Qe[0],r=t.lockedScaleId?vn[a.id]:ir(),o=!1,c=null,l=null,u=0,f=Ft,p=!1;const m=Object.fromEntries(Qe.map(h=>[h.id,Ti(h)]));mn(r);const b=yi(a.id),d=or(n,b),g=document.createElement("div");g.className="display-chrome",g.classList.add("is-hidden"),n.appendChild(g);const y=document.createElement("div");y.className="orientation-overlay",y.innerHTML=`
