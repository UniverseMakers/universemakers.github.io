...
`&&E!=="	"&&(p=f)}if(f>=d)if(p)l.push(p),d=p+c,p=void 0;else if(t===$t){for(;m===" "||m==="	";)m=I,I=n[f+=1],w=!0;const E=f>y+1?f-2:g-1;if(u[E])return n;l.push(E),u[E]=!0,d=E+c,p=void 0}else w=!0}m=I}if(w&&o&&o(),l.length===0)return n;r&&r();let S=n.slice(0,l[0]);for(let I=0;I<l.length;++I){const E=l[I],v=l[I+1]||n.length;E===0?S=`
${e}${n.slice(0,v)}`:(t===$t&&u[E]&&(S+=`${n[E]}\\`),S+=`
...
`,c+=2;r+=a,t[c+2]===" "&&(r+="\\"),c+=1,o=c+1}break;default:c+=1}return r=o?r+t.slice(o):t,s?r:jt(r,a,$t,Kt(e,!1))}function _n(n,e){if(e.options.singleQuote===!1||e.implicitKey&&n.includes(`
...
`:case"\r":case"	":return!0;default:return!1}}const ls=new Set("0123456789ABCDEFabcdef"),Ha=new Set("0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-#;/?:@&=+$_.!~*'()"),Mt=new Set(",[]{}"),Da=new Set(` ,[]{}
