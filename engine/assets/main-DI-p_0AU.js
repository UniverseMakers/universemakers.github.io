...
${r}`:s}}t?(Array.prototype.push.apply(e.errors,this.errors),Array.prototype.push.apply(e.warnings,this.warnings)):(e.errors=this.errors,e.warnings=this.warnings),this.prelude=[],this.errors=[],this.warnings=[]}streamInfo(){return{comment:Ts(this.prelude).comment,directives:this.directives,errors:this.errors,warnings:this.warnings}}*compose(e,t=!1,s=-1){for(const i of e)yield*this.next(i);yield*this.end(t,s)}*next(e){switch(e.type){case"directive":this.directives.add(e.source,(t,s,i)=>{const a=Nt(e);a[0]+=t,this.onError(a,"BAD_DIRECTIVE",s,i)}),this.prelude.push(e.source),this.atDirectives=!0;break;case"document":{const t=br(this.options,this.directives,e,this.onError);this.atDirectives&&!t.directives.docStart&&this.onError(e,"MISSING_CHAR","Missing directives-end/doc-start indicator line"),this.decorate(t,!1),this.doc&&(yield this.doc),this.doc=t,this.atDirectives=!1;break}case"byte-order-mark":case"space":break;case"comment":case"newline":this.prelude.push(e.source);break;case"error":{const t=e.source?`${e.message}: ${JSON.stringify(e.source)}`:e.message,s=new Mt(Nt(e),"UNEXPECTED_TOKEN",t);this.atDirectives||!this.doc?this.errors.push(s):this.doc.errors.push(s);break}case"doc-end":{if(!this.doc){const s="Unexpected doc-end without preceding document";this.errors.push(new Mt(Nt(e),"UNEXPECTED_TOKEN",s));break}this.doc.directives.docEnd=!0;const t=Dt(e.end,e.offset+e.source.length,this.doc.options.strict,this.onError);if(this.decorate(this.doc,!0),t.comment){const s=this.doc.comment;this.doc.comment=s?`${s}
${t.comment}`:t.comment}this.doc.range[2]=t.offset;break}default:this.errors.push(new Mt(Nt(e),"UNEXPECTED_TOKEN",`Unsupported token ${e.type}`))}}*end(e=!1,t=-1){if(this.doc)this.decorate(this.doc,!0),yield this.doc,this.doc=null;else if(e){const s=Object.assign({_directives:this.directives},this.options),i=new yn(void 0,s);this.atDirectives&&this.onError(t,"MISSING_CHAR","Missing directives-end indicator line"),i.range=[0,t,t],this.decorate(i,!1),yield i}}}const Ii="\uFEFF",Li="",Ni="",Gn="";function vr(n){switch(n){case Ii:return"byte-order-mark";case Li:return"doc-mode";case Ni:return"flow-error-end";case Gn:return"scalar";case"---":return"doc-start";case"...":return"doc-end";case"":case`
`:case`\r
...
`,Vs=(()=>{const n=We(go),e={};for(const t of Object.values(n))for(const[s,i]of Object.entries(t))e[s]=i;return e})(),rn="#4CD98A",Qn="#E8951C",$i="#D7372A",Ri=.2,Fi=.5,Us=2;function Bi(n){const e=Math.abs(n-1);return e<=Ri?{word:"On target",colour:rn}:e<=Fi?{word:n>1?"Too high":"Too low",colour:Qn}:{word:n>1?"Way too high":"Way too low",colour:$i}}function yo(n){const e=Math.abs(n-1),t=n>=1;return e<=Ri?t?"greenHigh":"greenLow":e<=Fi?t?"amberHigh":"amberLow":t?"redHigh":"redLow"}function bo(n){return Math.min(Math.max(n,0),Us)/Us*100}function wo(n){return n>=85?{word:"Almost perfect",colour:rn}:n>=65?{word:"Really close",colour:rn}:n>=45?{word:"Getting there",colour:Qn}:n>=25?{word:"Not quite",colour:Qn}:{word:"Way off - try again",colour:$i}}function vo(n,e,t){var r,o;const s=yo(t),i=((r=Vs[n])==null?void 0:r[s])??((o=Vs[e])==null?void 0:o[s]);return i||(Bi(t).colour===rn?`${e} is very close to the target value for this simulation.`:t<1?`${e} is below the target value for this simulation.`:`${e} is above the target value for this simulation.`)}function _o(n,e,t){return n.metadata.results.map(s=>{const i=So(s,n,e,t);if(i===null)return null;const a=i/Math.max(s.target,1e-9),r=ko(s,n,t),o=vo(s.id,r,a),l=Fe(Vi(String(i),s),s.unit);return{id:s.id,label:r,value:a,rawValue:i,formattedValue:l,detail:o}}).filter(s=>s!==null)}function So(n,e,t,s){var l;const i=n.id,a=e.parameters.find(c=>c.id===i);if(a)return t[i]??a.fallbackValue;const r=Eo((l=s==null?void 0:s.summaryMetrics[i])==null?void 0:l.value);if(r!==null)return r;const o=s==null?void 0:s.parameterValues[i];return typeof o=="number"&&Number.isFinite(o)?o:null}function ko(n,e,t){var i,a;const s=n.id;return n.label??((i=e.parameters.find(r=>r.id===s))==null?void 0:i.label)??((a=t==null?void 0:t.summaryMetrics[s])==null?void 0:a.label)??s}function Eo(n){if(n===void 0)return null;const e=Number(n);return Number.isFinite(e)?e:null}function Io(n){if(n.length===0)return 0;const e=n.reduce((t,s)=>t+Math.max(0,1-Math.abs(s.value-1)),0);return Math.round(e/n.length*100)}function Lo(n,e){const t=document.createElement("section");t.className="overlay overlay--summary",t.hidden=!0,t.classList.add("is-hidden");let s;const i=document.createElement("div");i.className="summary-overlay";const a=document.createElement("div"),r=document.createElement("div");a.className="summary-overlay__header",r.className="summary-overlay__content";const o=document.createElement("p");o.className="summary-overlay__title",o.textContent="Run Summary";const l=document.createElement("p");l.className="summary-overlay__hint",l.textContent="Select any card for more details",a.appendChild(o),a.appendChild(l);const c=document.createElement("div");c.className="summary-overlay__actions";const u=document.createElement("button");u.className="summary-overlay__button",u.type="button",u.textContent="Continue Visualising";const d=document.createElement("button"),m=document.createElement("button");d.className="summary-overlay__button summary-overlay__button--primary",d.type="button",d.textContent="New Parameters",m.className="summary-overlay__button",m.type="button",m.textContent="Home",m.hidden=!e.showHome,u.addEventListener("click",e.onReplay),d.addEventListener("click",e.onParameters),m.addEventListener("click",e.onHome),c.appendChild(d),c.appendChild(u),c.appendChild(m),i.appendChild(a),i.appendChild(r),i.appendChild(c),t.appendChild(i);const h=document.createElement("div");h.className="sci-modal is-hidden",h.innerHTML=`
  ...
  `,t.appendChild(h),n.appendChild(t);const b=h.querySelector(".sci-modal__title"),p=h.querySelector(".sci-modal__verdict"),g=h.querySelector(".sci-modal__body"),_=h.querySelector(".sci-modal__close"),v=new Set;let L=!1;function E(S){const M=Bi(S.value);b.textContent=S.label,p.textContent=M.word,p.style.color=M.colour,p.hidden=!1,g.textContent=S.detail,h.classList.remove("is-hidden")}function k(S,M){b.textContent=S,p.hidden=!0,g.textContent=M,h.classList.remove("is-hidden")}function y(){h.classList.add("is-hidden")}_.addEventListener("click",y),h.addEventListener("click",S=>{S.target===h&&y()}),t.addEventListener("click",S=>{S.target===t&&e.onReplay()});function I(S,M){const $=document.createElement("div");$.className=`${S.className} panel`,$.innerHTML=`<p class="sci-section__title">${S.title}</p>`;const x=document.createElement("div"),U=S.singleRow?Math.max(1,S.stats.length):Math.max(1,Math.min(S.stats.length,S.maxColumns));x.className="metric-grid",S.singleRow&&x.classList.add("metric-grid--single-row"),x.style.setProperty("--summary-grid-columns",String(U)),x.style.setProperty("--summary-grid-max-width",`${S.maxWidthRem}rem`);for(const R of S.stats){const ie=No(R,M),W=document.createElement("div"),ne=document.createElement("span"),D=document.createElement("span");W.className="res-card",ne.className="res-card__label",ne.textContent=ie.label,D.className="res-card__value",D.textContent=ie.value,W.appendChild(ne),W.appendChild(D),R.description&&(W.classList.add("res-card--has-info"),W.addEventListener("click",()=>{k(ie.label,R.description)})),x.appendChild(W)}return $.appendChild(x),$}return{show(){s&&(window.clearTimeout(s),s=void 0),t.hidden=!1,t.classList.remove("is-hidden"),t.classList.remove("is-visible"),t.offsetWidth,requestAnimationFrame(()=>{t.classList.add("is-visible")})},hide(){t.classList.remove("is-visible"),s=window.setTimeout(()=>{t.hidden=!0,t.classList.add("is-hidden"),s=void 0,L&&(v.clear(),L=!1)},mo.HIDE_AFTER_MS)},setHomeVisible(S){m.hidden=!S},update(S,M,$,x,U){var N,T,H,K,F,X;r.innerHTML="",y();const R=co(S,M,$,x),ie=S.metadata.summaryStats,W=_o(S,M,x),ne=new Set(W.map(V=>V.id));let D;if(W.length>0)D=Io(W);else{const V=((N=R.similarityScore)==null?void 0:N.value)??"0/100";D=parseInt(V,10)||0}const ue=wo(D),_e=document.createElement("div"),Le=document.createElement("div"),ae=document.createElement("div");_e.className="sci-top",Le.className="summary-main-column",ae.className="summary-side-column";const re=document.createElement("div");re.className="sci-hero panel",U?(re.classList.add("sci-hero--thumbnail"),re.innerHTML=`<img class="sci-hero__thumbnail" src="${U}" alt="Final frame of simulation" />`):re.innerHTML=`
        ...
        `,Le.appendChild(re);const Pe=ie.filter(V=>(V.section??"resources")==="resources"&&!W.some(oe=>oe.id===String(V.id))&&V.id!=="similarityScore"),de=ie.filter(V=>V.section==="simulationStats"&&!ne.has(String(V.id)));Pe.length>0&&ae.appendChild(I({title:"Resources Used",className:"res-section",stats:Pe,maxColumns:3,maxWidthRem:48},R)),de.length>0&&ae.appendChild(I({title:"Simulation Stats",className:"res-section",stats:de,maxColumns:de.length,maxWidthRem:48,singleRow:!0},R)),_e.appendChild(Le),ae.childElementCount>0&&_e.appendChild(ae),r.appendChild(_e);const fe=S.metadata.morphologyChecklist;if(fe&&fe.length>0){const V=((H=(T=x==null?void 0:x.summaryMetrics)==null?void 0:T.morphology)==null?void 0:H.value)??null,oe=(V==null?void 0:V.toLowerCase())??null,Se=new Set(fe.map(B=>B.id));oe&&Se.has(oe)&&v.add(oe);const se=document.createElement("div");se.className="sci-bottom-row";const j=document.createElement("div");j.style.cssText="display:flex; flex-direction:column; gap:1.25rem;",j.appendChild(Ds(S,M,k));const Ne=((K=fe.find(B=>B.id===oe))==null?void 0:K.label)??V;if(Ne){const B=document.createElement("div");B.className="sci-section panel param-section";const q=document.createElement("p");q.className="sci-section__title",q.textContent="Galaxy Morphology";const ge=document.createElement("div");ge.className="res-card res-card--has-info";const A=document.createElement("span");A.className="res-card__value",A.textContent=Ne,ge.appendChild(A),ge.addEventListener("click",()=>{var Y;return k("Galaxy Morphology",((Y=fe.find(J=>J.id===(V??"").toLowerCase()))==null?void 0:Y.description)??`This galaxy is classified as "${Ne}".`)}),B.appendChild(q),B.appendChild(ge),j.appendChild(B)}se.appendChild(j);const pe=document.createElement("div");pe.style.cssText="flex:1; display:flex; flex-direction:column; gap:1.25rem; min-width:0; min-height:0;";const Ae=((X=(F=x==null?void 0:x.summaryMetrics)==null?void 0:F.description)==null?void 0:X.value)??null;if(Ae){const B=document.createElement("div");B.className="sci-section panel",B.style.cssText="flex:0 1 auto; min-width:0;";const q=document.createElement("p");q.className="sci-section__title",q.textContent="About This Galaxy";const ge=document.createElement("p");ge.className="galaxy-summary__desc-text",ge.textContent=Ae,B.appendChild(q),B.appendChild(ge),pe.appendChild(B)}const we=document.createElement("div");we.className="sci-section panel",we.style.cssText="flex:1; min-height:0;";const ke=document.createElement("p");ke.className="sci-section__title",ke.textContent="Morphology Scavenger Hunt";const He=document.createElement("div");He.className="galaxy-summary__checklist",He.style.cssText="flex:1; align-items:center;";const Ye=fe.every(B=>v.has(B.id));for(const B of fe){const q=document.createElement("div");q.className="galaxy-summary__check",v.has(B.id)&&q.classList.add("is-found"),q.innerHTML=`
            <span class="galaxy-summary__check-box">
              ${v.has(B.id)?"✓":""}
            </span>
            <span class="galaxy-summary__check-label">${B.label}</span>
          `,B.hint&&(q.classList.add("res-card--has-info"),q.addEventListener("click",()=>k(B.label,B.hint))),He.appendChild(q)}if(we.appendChild(ke),we.appendChild(He),Ye){L=!0;const B=document.createElement("div");B.className="galaxy-summary__done",B.textContent="★ You've discovered all of the galaxy types. Well done! ★",we.appendChild(B)}pe.appendChild(we),se.appendChild(pe),r.appendChild(se)}else if(W.length>0){const V=document.createElement("div");V.className="sci-bottom-row",V.appendChild(Ds(S,M,k));const oe=document.createElement("div"),Se=document.createElement("div"),se=document.createElement("p"),j=document.createElement("p");oe.className="sci-section panel",Se.className="sci-section__header",se.className="sci-section__title",se.textContent="Similarity Results",j.className="sci-section__hint",j.textContent="Select any bar for details",Se.appendChild(se),Se.appendChild(j);const Ne=document.createElement("div");Ne.className="sci-bars";for(const pe of W){const Ae=document.createElement("div");Ae.className="sci-bar",Ae.innerHTML=`
...
`;function Po(){const n=We(Oo);if(!Array.isArray(n))return[];const e=[];for(const t of n){if(!t||typeof t!="object")continue;const s=t.text;if(typeof s!="string"||s.trim().length===0)continue;const i={text:s},a=t.url;typeof a=="string"&&a.trim().length>0&&(i.url=a);const r=t.logo;typeof r=="string"&&r.trim().length>0&&(i.logo=r),t.header===!0&&(i.header=!0),e.push(i)}return e}function xo(n,e,t,s){const i=document.createElement("div");i.className="parameter-editor",n.appendChild(i);let a=e,r={...t};function o(u,d){a=u,r=d?{...d}:$o(u),i.innerHTML="";const m=document.createElement("div");m.className="parameter-editor__heading",m.innerHTML=`
 ...
 Engine</h1>
  ...
  `;const v=document.createElement("div");_.appendChild(v);const L=document.createElement("section");L.className="audio-settings",L.innerHTML=`
  ...
  `,E.appendChild(k),E.appendChild(y),L.appendChild(E);const I=document.createElement("label");I.className="advanced-settings__field",I.innerHTML=`
  ...
  `,fe.appendChild(N),fe.appendChild(T),ne.appendChild(fe);const H=document.createElement("div");H.className="advanced-settings__field",H.innerHTML=`
