(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const a of i)if(a.type==="childList")for(const r of a.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function t(i){const a={};return i.integrity&&(a.integrity=i.integrity),i.referrerPolicy&&(a.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?a.credentials="include":i.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function s(i){if(i.ep)return;i.ep=!0;const a=t(i);fetch(i.href,a)}})();const Zn=Symbol.for("yaml.alias"),qn=Symbol.for("yaml.document"),et=Symbol.for("yaml.map"),Ys=Symbol.for("yaml.pair"),He=Symbol.for("yaml.scalar"),Et=Symbol.for("yaml.seq"),Pe=Symbol.for("yaml.node.type"),ot=n=>!!n&&typeof n=="object"&&n[Pe]===Zn,fn=n=>!!n&&typeof n=="object"&&n[Pe]===qn,Ht=n=>!!n&&typeof n=="object"&&n[Pe]===et,ae=n=>!!n&&typeof n=="object"&&n[Pe]===Ys,z=n=>!!n&&typeof n=="object"&&n[Pe]===He,jt=n=>!!n&&typeof n=="object"&&n[Pe]===Et;function se(n){if(n&&typeof n=="object")switch(n[Pe]){case et:case Et:return!0}return!1}function ie(n){if(n&&typeof n=="object")switch(n[Pe]){case Zn:case et:case He:case Et:return!0}return!1}const Gs=n=>(z(n)||se(n))&&!!n.anchor,st=Symbol("break visit"),_a=Symbol("skip children"),$t=Symbol("remove node");function It(n,e){const t=Sa(e);fn(n)?gt(null,n.contents,t,Object.freeze([n]))===$t&&(n.contents=null):gt(null,n,t,Object.freeze([]))}It.BREAK=st;It.SKIP=_a;It.REMOVE=$t;function gt(n,e,t,s){const i=ka(n,e,t,s);if(ie(i)||ae(i))return Ea(n,s,i),gt(n,i,t,s);if(typeof i!="symbol"){if(se(e)){s=Object.freeze(s.concat(e));for(let a=0;a<e.items.length;++a){const r=gt(a,e.items[a],t,s);if(typeof r=="number")a=r-1;else{if(r===st)return st;r===$t&&(e.items.splice(a,1),a-=1)}}}else if(ae(e)){s=Object.freeze(s.concat(e));const a=gt("key",e.key,t,s);if(a===st)return st;a===$t&&(e.key=null);const r=gt("value",e.value,t,s);if(r===st)return st;r===$t&&(e.value=null)}}return i}function Sa(n){return typeof n=="object"&&(n.Collection||n.Node||n.Value)?Object.assign({Alias:n.Node,Map:n.Node,Scalar:n.Node,Seq:n.Node},n.Value&&{Map:n.Value,Scalar:n.Value,Seq:n.Value},n.Collection&&{Map:n.Collection,Seq:n.Collection},n):n}function ka(n,e,t,s){var i,a,r,o,l;if(typeof t=="function")return t(n,e,s);if(Ht(e))return(i=t.Map)==null?void 0:i.call(t,n,e,s);if(jt(e))return(a=t.Seq)==null?void 0:a.call(t,n,e,s);if(ae(e))return(r=t.Pair)==null?void 0:r.call(t,n,e,s);if(z(e))return(o=t.Scalar)==null?void 0:o.call(t,n,e,s);if(ot(e))return(l=t.Alias)==null?void 0:l.call(t,n,e,s)}function Ea(n,e,t){const s=e[e.length-1];if(se(s))s.items[n]=t;else if(ae(s))n==="key"?s.key=t:s.value=t;else if(fn(s))s.contents=t;else{const i=ot(s)?"alias":"scalar";throw new Error(`Cannot replace node with ${i} parent`)}}const Ia={"!":"%21",",":"%2C","[":"%5B","]":"%5D","{":"%7B","}":"%7D"},Na=n=>n.replace(/[!,[\]{}]/g,e=>Ia[e]);class be{constructor(e,t){this.docStart=null,this.docEnd=!1,this.yaml=Object.assign({},be.defaultYaml,e),this.tags=Object.assign({},be.defaultTags,t)}clone(){const e=new be(this.yaml,this.tags);return e.docStart=this.docStart,e}atDocument(){const e=new be(this.yaml,this.tags);switch(this.yaml.version){case"1.1":this.atNextDocument=!0;break;case"1.2":this.atNextDocument=!1,this.yaml={explicit:be.defaultYaml.explicit,version:"1.2"},this.tags=Object.assign({},be.defaultTags);break}return e}add(e,t){this.atNextDocument&&(this.yaml={explicit:be.defaultYaml.explicit,version:"1.1"},this.tags=Object.assign({},be.defaultTags),this.atNextDocument=!1);const s=e.trim().split(/[ \t]+/),i=s.shift();switch(i){case"%TAG":{if(s.length!==2&&(t(0,"%TAG directive should contain exactly two parts"),s.length<2))return!1;const[a,r]=s;return this.tags[a]=r,!0}case"%YAML":{if(this.yaml.explicit=!0,s.length!==1)return t(0,"%YAML directive should contain exactly one part"),!1;const[a]=s;if(a==="1.1"||a==="1.2")return this.yaml.version=a,!0;{const r=/^\d+\.\d+$/.test(a);return t(6,`Unsupported YAML version ${a}`,r),!1}}default:return t(0,`Unknown directive ${i}`,!0),!1}}tagName(e,t){if(e==="!")return"!";if(e[0]!=="!")return t(`Not a valid tag: ${e}`),null;if(e[1]==="<"){const r=e.slice(2,-1);return r==="!"||r==="!!"?(t(`Verbatim tags aren't resolved, so ${e} is invalid.`),null):(e[e.length-1]!==">"&&t("Verbatim tags must end with a >"),r)}const[,s,i]=e.match(/^(.*!)([^!]*)$/s);i||t(`The ${e} tag has no suffix`);const a=this.tags[s];if(a)try{return a+decodeURIComponent(i)}catch(r){return t(String(r)),null}return s==="!"?e:(t(`Could not resolve tag: ${e}`),null)}tagString(e){for(const[t,s]of Object.entries(this.tags))if(e.startsWith(s))return t+Na(e.substring(s.length));return e[0]==="!"?e:`!<${e}>`}toString(e){const t=this.yaml.explicit?[`%YAML ${this.yaml.version||"1.2"}`]:[],s=Object.entries(this.tags);let i;if(e&&s.length>0&&ie(e.contents)){const a={};It(e.contents,(r,o)=>{ie(o)&&o.tag&&(a[o.tag]=!0)}),i=Object.keys(a)}else i=[];for(const[a,r]of s)a==="!!"&&r==="tag:yaml.org,2002:"||(!e||i.some(o=>o.startsWith(r)))&&t.push(`%TAG ${a} ${r}`);return t.join(`
`)}}be.defaultYaml={explicit:!1,version:"1.2"};be.defaultTags={"!!":"tag:yaml.org,2002:"};function zs(n){if(/[\x00-\x19\s,[\]{}]/.test(n)){const t=`Anchor must not contain whitespace or control characters: ${JSON.stringify(n)}`;throw new Error(t)}return!0}function Js(n){const e=new Set;return It(n,{Value(t,s){s.anchor&&e.add(s.anchor)}}),e}function Qs(n,e){for(let t=1;;++t){const s=`${n}${t}`;if(!e.has(s))return s}}function La(n,e){const t=[],s=new Map;let i=null;return{onAnchor:a=>{t.push(a),i??(i=Js(n));const r=Qs(e,i);return i.add(r),r},setAnchors:()=>{for(const a of t){const r=s.get(a);if(typeof r=="object"&&r.anchor&&(z(r.node)||se(r.node)))r.node.anchor=r.anchor;else{const o=new Error("Failed to resolve repeated object (this should not happen)");throw o.source=a,o}}},sourceObjects:s}}function yt(n,e,t,s){if(s&&typeof s=="object")if(Array.isArray(s))for(let i=0,a=s.length;i<a;++i){const r=s[i],o=yt(n,s,String(i),r);o===void 0?delete s[i]:o!==r&&(s[i]=o)}else if(s instanceof Map)for(const i of Array.from(s.keys())){const a=s.get(i),r=yt(n,s,i,a);r===void 0?s.delete(i):r!==a&&s.set(i,r)}else if(s instanceof Set)for(const i of Array.from(s)){const a=yt(n,s,i,i);a===void 0?s.delete(i):a!==i&&(s.delete(i),s.add(a))}else for(const[i,a]of Object.entries(s)){const r=yt(n,s,i,a);r===void 0?delete s[i]:r!==a&&(s[i]=r)}return n.call(e,t,s)}function Oe(n,e,t){if(Array.isArray(n))return n.map((s,i)=>Oe(s,String(i),t));if(n&&typeof n.toJSON=="function"){if(!t||!Gs(n))return n.toJSON(e,t);const s={aliasCount:0,count:1,res:void 0};t.anchors.set(n,s),t.onCreate=a=>{s.res=a,delete t.onCreate};const i=n.toJSON(e,t);return t.onCreate&&t.onCreate(i),i}return typeof n=="bigint"&&!(t!=null&&t.keep)?Number(n):n}class es{constructor(e){Object.defineProperty(this,Pe,{value:e})}clone(){const e=Object.create(Object.getPrototypeOf(this),Object.getOwnPropertyDescriptors(this));return this.range&&(e.range=this.range.slice()),e}toJS(e,{mapAsMap:t,maxAliasCount:s,onAnchor:i,reviver:a}={}){if(!fn(e))throw new TypeError("A document argument is required");const r={anchors:new Map,doc:e,keep:!0,mapAsMap:t===!0,mapKeyWarned:!1,maxAliasCount:typeof s=="number"?s:100},o=Oe(this,"",r);if(typeof i=="function")for(const{count:l,res:c}of r.anchors.values())i(c,l);return typeof a=="function"?yt(a,{"":o},"",o):o}}class ts extends es{constructor(e){super(Zn),this.source=e,Object.defineProperty(this,"tag",{set(){throw new Error("Alias nodes cannot have tags")}})}resolve(e,t){let s;t!=null&&t.aliasResolveCache?s=t.aliasResolveCache:(s=[],It(e,{Node:(a,r)=>{(ot(r)||Gs(r))&&s.push(r)}}),t&&(t.aliasResolveCache=s));let i;for(const a of s){if(a===this)break;a.anchor===this.source&&(i=a)}return i}toJSON(e,t){if(!t)return{source:this.source};const{anchors:s,doc:i,maxAliasCount:a}=t,r=this.resolve(i,t);if(!r){const l=`Unresolved alias (the anchor must be set before the alias): ${this.source}`;throw new ReferenceError(l)}let o=s.get(r);if(o||(Oe(r,null,t),o=s.get(r)),(o==null?void 0:o.res)===void 0){const l="This should not happen: Alias anchor was not resolved?";throw new ReferenceError(l)}if(a>=0&&(o.count+=1,o.aliasCount===0&&(o.aliasCount=nn(i,r,s)),o.count*o.aliasCount>a)){const l="Excessive alias count indicates a resource exhaustion attack";throw new ReferenceError(l)}return o.res}toString(e,t,s){const i=`*${this.source}`;if(e){if(zs(this.source),e.options.verifyAliasOrder&&!e.anchors.has(this.source)){const a=`Unresolved alias (the anchor must be set before the alias): ${this.source}`;throw new Error(a)}if(e.implicitKey)return`${i} `}return i}}function nn(n,e,t){if(ot(e)){const s=e.resolve(n),i=t&&s&&t.get(s);return i?i.count*i.aliasCount:0}else if(se(e)){let s=0;for(const i of e.items){const a=nn(n,i,t);a>s&&(s=a)}return s}else if(ae(e)){const s=nn(n,e.key,t),i=nn(n,e.value,t);return Math.max(s,i)}return 1}const Xs=n=>!n||typeof n!="function"&&typeof n!="object";class x extends es{constructor(e){super(He),this.value=e}toJSON(e,t){return t!=null&&t.keep?this.value:Oe(this.value,e,t)}toString(){return String(this.value)}}x.BLOCK_FOLDED="BLOCK_FOLDED";x.BLOCK_LITERAL="BLOCK_LITERAL";x.PLAIN="PLAIN";x.QUOTE_DOUBLE="QUOTE_DOUBLE";x.QUOTE_SINGLE="QUOTE_SINGLE";const Aa="tag:yaml.org,2002:";function Ca(n,e,t){if(e){const s=t.filter(a=>a.tag===e),i=s.find(a=>!a.format)??s[0];if(!i)throw new Error(`Tag ${e} not found`);return i}return t.find(s=>{var i;return((i=s.identify)==null?void 0:i.call(s,n))&&!s.format})}function Ft(n,e,t){var f,h,m;if(fn(n)&&(n=n.contents),ie(n))return n;if(ae(n)){const b=(h=(f=t.schema[et]).createNode)==null?void 0:h.call(f,t.schema,null,t);return b.items.push(n),b}(n instanceof String||n instanceof Number||n instanceof Boolean||typeof BigInt<"u"&&n instanceof BigInt)&&(n=n.valueOf());const{aliasDuplicateObjects:s,onAnchor:i,onTagObj:a,schema:r,sourceObjects:o}=t;let l;if(s&&n&&typeof n=="object"){if(l=o.get(n),l)return l.anchor??(l.anchor=i(n)),new ts(l.anchor);l={anchor:null,node:null},o.set(n,l)}e!=null&&e.startsWith("!!")&&(e=Aa+e.slice(2));let c=Ca(n,e,r.tags);if(!c){if(n&&typeof n.toJSON=="function"&&(n=n.toJSON()),!n||typeof n!="object"){const b=new x(n);return l&&(l.node=b),b}c=n instanceof Map?r[et]:Symbol.iterator in Object(n)?r[Et]:r[et]}a&&(a(c),delete t.onTagObj);const u=c!=null&&c.createNode?c.createNode(t.schema,n,t):typeof((m=c==null?void 0:c.nodeClass)==null?void 0:m.from)=="function"?c.nodeClass.from(t.schema,n,t):new x(n);return e?u.tag=e:c.default||(u.tag=c.tag),l&&(l.node=u),u}function on(n,e,t){let s=t;for(let i=e.length-1;i>=0;--i){const a=e[i];if(typeof a=="number"&&Number.isInteger(a)&&a>=0){const r=[];r[a]=s,s=r}else s=new Map([[a,s]])}return Ft(s,void 0,{aliasDuplicateObjects:!1,keepUndefined:!1,onAnchor:()=>{throw new Error("This should not happen, please report a bug.")},schema:n,sourceObjects:new Map})}const xt=n=>n==null||typeof n=="object"&&!!n[Symbol.iterator]().next().done;class Zs extends es{constructor(e,t){super(e),Object.defineProperty(this,"schema",{value:t,configurable:!0,enumerable:!1,writable:!0})}clone(e){const t=Object.create(Object.getPrototypeOf(this),Object.getOwnPropertyDescriptors(this));return e&&(t.schema=e),t.items=t.items.map(s=>ie(s)||ae(s)?s.clone(e):s),this.range&&(t.range=this.range.slice()),t}addIn(e,t){if(xt(e))this.add(t);else{const[s,...i]=e,a=this.get(s,!0);if(se(a))a.addIn(i,t);else if(a===void 0&&this.schema)this.set(s,on(this.schema,i,t));else throw new Error(`Expected YAML collection at ${s}. Remaining path: ${i}`)}}deleteIn(e){const[t,...s]=e;if(s.length===0)return this.delete(t);const i=this.get(t,!0);if(se(i))return i.deleteIn(s);throw new Error(`Expected YAML collection at ${t}. Remaining path: ${s}`)}getIn(e,t){const[s,...i]=e,a=this.get(s,!0);return i.length===0?!t&&z(a)?a.value:a:se(a)?a.getIn(i,t):void 0}hasAllNullValues(e){return this.items.every(t=>{if(!ae(t))return!1;const s=t.value;return s==null||e&&z(s)&&s.value==null&&!s.commentBefore&&!s.comment&&!s.tag})}hasIn(e){const[t,...s]=e;if(s.length===0)return this.has(t);const i=this.get(t,!0);return se(i)?i.hasIn(s):!1}setIn(e,t){const[s,...i]=e;if(i.length===0)this.set(s,t);else{const a=this.get(s,!0);if(se(a))a.setIn(i,t);else if(a===void 0&&this.schema)this.set(s,on(this.schema,i,t));else throw new Error(`Expected YAML collection at ${s}. Remaining path: ${i}`)}}}const Ta=n=>n.replace(/^(?!$)(?: $)?/gm,"#");function We(n,e){return/^\n+$/.test(n)?n.substring(1):e?n.replace(/^(?! *$)/gm,e):n}const it=(n,e,t)=>n.endsWith(`
`)?We(t,e):t.includes(`
`)?`
...
`&&E!=="	"&&(h=p)}if(p>=f)if(h)c.push(h),f=h+l,h=void 0;else if(t===sn){for(;m===" "||m==="	";)m=N,N=n[p+=1],b=!0;const E=p>_+1?p-2:g-1;if(u[E])return n;c.push(E),u[E]=!0,f=E+l,h=void 0}else b=!0}m=N}if(b&&o&&o(),c.length===0)return n;r&&r();let w=n.slice(0,c[0]);for(let N=0;N<c.length;++N){const E=c[N],k=c[N+1]||n.length;E===0?w=`
${e}${n.slice(0,k)}`:(t===sn&&u[E]&&(w+=`${n[E]}\\`),w+=`
${e}${n.slice(E+1,k)}`)}return w}function Es(n,e,t){let s=e,i=e+1,a=n[i];for(;a===" "||a==="	";)if(e<i+t)a=n[++e];else{do a=n[++e];while(a&&a!==`
...
`){if(a-r>s)return!0;if(r=a+1,i-r<=s)return!1}return!0}function Bt(n,e){const t=JSON.stringify(n);if(e.options.doubleQuotedAsJSON)return t;const{implicitKey:s}=e,i=e.options.doubleQuotedMinMultiLineLength,a=e.indent||(pn(n)?"  ":"");let r="",o=0;for(let l=0,c=t[l];c;c=t[++l])if(c===" "&&t[l+1]==="\\"&&t[l+2]==="n"&&(r+=t.slice(o,l)+"\\ ",l+=1,o=l,c="\\"),c==="\\")switch(t[l+1]){case"u":{r+=t.slice(o,l);const u=t.substr(l+2,4);switch(u){case"0000":r+="\\0";break;case"0007":r+="\\a";break;case"000b":r+="\\v";break;case"001b":r+="\\e";break;case"0085":r+="\\N";break;case"00a0":r+="\\_";break;case"2028":r+="\\L";break;case"2029":r+="\\P";break;default:u.substr(0,2)==="00"?r+="\\x"+u.substr(2):r+=t.substr(l,6)}l+=5,o=l+1}break;case"n":if(s||t[l+2]==='"'||t.length<i)l+=1;else{for(r+=t.slice(o,l)+`
...
`)||/[ \t]\n|\n[ \t]/.test(n))return Bt(n,e);const t=e.indent||(pn(n)?"  ":""),s="'"+n.replace(/'/g,"''").replace(/\n+/g,`$&
${t}`)+"'";return e.implicitKey?s:hn(s,t,ei,mn(e,!1))}function bt(n,e){const{singleQuote:t}=e.options;let s;if(t===!1)s=Bt;else{const i=n.includes('"'),a=n.includes("'");i&&!a?s=Wn:a&&!i?s=Bt:s=t?Wn:Bt}return s(n,e)}let Yn;try{Yn=new RegExp(`(^|(?<!
))
+(?!
...
$&`).replace(/(?:^|\n)([\t ].*)(?:([\n\t ]*)\n(?![\n\t ]))?/g,"$1$2").replace(/\n+/g,`$&${c}`);let y=!1;const I=mn(s,!0);r!=="folded"&&e!==x.BLOCK_FOLDED&&(I.onOverflow=()=>{y=!0});const S=hn(`${w}${k}${m}`,c,Kn,I);if(!y)return`>${E}
${c}${S}`}return t=t.replace(/\n+/g,`$&${c}`),`|${E}
${c}${w}${t}${m}`}function Oa(n,e,t,s){const{type:i,value:a}=n,{actualString:r,implicitKey:o,indent:l,indentStep:c,inFlow:u}=e;if(o&&a.includes(`
...
`)+`
`}class _n{constructor(e,t,s){this.commentBefore=null,this.comment=null,this.errors=[],this.warnings=[],Object.defineProperty(this,Pe,{value:qn});let i=null;typeof t=="function"||Array.isArray(t)?i=t:s===void 0&&t&&(s=t,t=void 0);const a=Object.assign({intAsBigInt:!1,keepSourceTokens:!1,logLevel:"warn",prettyErrors:!0,strict:!0,stringKeys:!1,uniqueKeys:!0,version:"1.2"},s);this.options=a;let{version:r}=a;s!=null&&s._directives?(this.directives=s._directives.atDocument(),this.directives.yaml.explicit&&(r=this.directives.yaml.version)):this.directives=new be({version:r}),this.setSchema(r,s),this.contents=e===void 0?null:this.createNode(e,i,s)}clone(){const e=Object.create(_n.prototype,{[Pe]:{value:qn}});return e.commentBefore=this.commentBefore,e.comment=this.comment,e.errors=this.errors.slice(),e.warnings=this.warnings.slice(),e.options=Object.assign({},this.options),this.directives&&(e.directives=this.directives.clone()),e.schema=this.schema.clone(),e.contents=ie(this.contents)?this.contents.clone(e.schema):this.contents,this.range&&(e.range=this.range.slice()),e}add(e){ft(this.contents)&&this.contents.add(e)}addIn(e,t){ft(this.contents)&&this.contents.addIn(e,t)}createAlias(e,t){if(!e.anchor){const s=Js(this);e.anchor=!t||s.has(t)?Qs(t||"a",s):t}return new ts(e.anchor)}createNode(e,t,s){let i;if(typeof t=="function")e=t.call({"":e},"",e),i=t;else if(Array.isArray(t)){const g=w=>typeof w=="number"||w instanceof String||w instanceof Number,_=t.filter(g).map(String);_.length>0&&(t=t.concat(_)),i=t}else s===void 0&&t&&(s=t,t=void 0);const{aliasDuplicateObjects:a,anchorPrefix:r,flow:o,keepUndefined:l,onTagObj:c,tag:u}=s??{},{onAnchor:f,setAnchors:h,sourceObjects:m}=La(this,r||"a"),b={aliasDuplicateObjects:a??!0,keepUndefined:l??!1,onAnchor:f,onTagObj:c,replacer:i,schema:this.schema,sourceObjects:m},p=Ft(e,u,b);return o&&se(p)&&(p.flow=!0),h(),p}createPair(e,t,s={}){const i=this.createNode(e,null,s),a=this.createNode(t,null,s);return new we(i,a)}delete(e){return ft(this.contents)?this.contents.delete(e):!1}deleteIn(e){return xt(e)?this.contents==null?!1:(this.contents=null,!0):ft(this.contents)?this.contents.deleteIn(e):!1}get(e,t){return se(this.contents)?this.contents.get(e,t):void 0}getIn(e,t){return xt(e)?!t&&z(this.contents)?this.contents.value:this.contents:se(this.contents)?this.contents.getIn(e,t):void 0}has(e){return se(this.contents)?this.contents.has(e):!1}hasIn(e){return xt(e)?this.contents!==void 0:se(this.contents)?this.contents.hasIn(e):!1}set(e,t){this.contents==null?this.contents=on(this.schema,[e],t):ft(this.contents)&&this.contents.set(e,t)}setIn(e,t){xt(e)?this.contents=t:this.contents==null?this.contents=on(this.schema,Array.from(e),t):ft(this.contents)&&this.contents.setIn(e,t)}setSchema(e,t={}){typeof e=="number"&&(e=String(e));let s;switch(e){case"1.1":this.directives?this.directives.yaml.version="1.1":this.directives=new be({version:"1.1"}),s={resolveKnownTags:!1,schema:"yaml-1.1"};break;case"1.2":case"next":this.directives?this.directives.yaml.version=e:this.directives=new be({version:e}),s={resolveKnownTags:!0,schema:"core"};break;case null:this.directives&&delete this.directives,s=null;break;default:{const i=JSON.stringify(e);throw new Error(`Expected '1.1', '1.2' or null as first argument, but found: ${i}`)}}if(t.schema instanceof Object)this.schema=t.schema;else if(s)this.schema=new fs(Object.assign(s,t));else throw new Error("With a null YAML version, the { schema: Schema } option is required")}toJS({json:e,jsonArg:t,mapAsMap:s,maxAliasCount:i,onAnchor:a,reviver:r}={}){const o={anchors:new Map,doc:this,keep:!e,mapAsMap:s===!0,mapKeyWarned:!1,maxAliasCount:typeof i=="number"?i:100},l=Oe(this.contents,t??"",o);if(typeof a=="function")for(const{count:c,res:u}of o.anchors.values())a(u,c);return typeof r=="function"?yt(r,{"":l},"",l):l}toJSON(e,t){return this.toJS({json:!0,jsonArg:e,mapAsMap:!1,onAnchor:t})}toString(e={}){if(this.errors.length>0)throw new Error("Document with errors cannot be stringified");if("indent"in e&&(!Number.isInteger(e.indent)||Number(e.indent)<=0)){const t=JSON.stringify(e.indent);throw new Error(`"indent" option must be a positive integer, not ${t}`)}return Za(this,e)}}function ft(n){if(se(n))return!0;throw new Error("Expected a YAML collection as document contents")}class _i extends Error{constructor(e,t,s,i){super(),this.name=e,this.code=s,this.message=i,this.pos=t}}class Rt extends _i{constructor(e,t,s){super("YAMLParseError",e,t,s)}}class er extends _i{constructor(e,t,s){super("YAMLWarning",e,t,s)}}const Cs=(n,e)=>t=>{if(t.pos[0]===-1)return;t.linePos=t.pos.map(o=>e.linePos(o));const{line:s,col:i}=t.linePos[0];t.message+=` at line ${s}, column ${i}`;let a=i-1,r=n.substring(e.lineStarts[s-1],e.lineStarts[s]).replace(/[\n\r]+$/,"");if(a>=60&&r.length>80){const o=Math.min(a-39,r.length-79);r="…"+r.substring(o),a-=o-1}if(r.length>80&&(r=r.substring(0,79)+"…"),s>1&&/^ *$/.test(r.substring(0,a))){let o=n.substring(e.lineStarts[s-2],e.lineStarts[s-1]);o.length>80&&(o=o.substring(0,79)+`…
...
`;for(let p=u;p<o;++p){let[g,_]=r[p];c+=g.length+_.length+1;const w=_[_.length-1]==="\r";if(w&&(_=_.slice(0,-1)),_&&g.length<l){const E=`Block scalar lines must not be less indented than their ${i.indent?"explicit indentation indicator":"first line"}`;t(c-_.length-(w?2:1),"BAD_INDENT",E),g=""}a===x.BLOCK_LITERAL?(f+=h+g.slice(l)+_,h=`
`):g.length>l||_[0]==="	"?(h===" "?h=`
`:!m&&h===`
`&&(h=`
...
`:case"\r":case"	":return!0;default:return!1}}const Os=new Set("0123456789ABCDEFabcdef"),kr=new Set("0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-#;/?:@&=+$_.!~*'()"),Xt=new Set(",[]{}"),Er=new Set(` ,[]{}
...
`,Us=(()=>{const n=ze(yo),e={};for(const t of Object.values(n))for(const[s,i]of Object.entries(t))e[s]=i;return e})(),un="#4CD98A",Xn="#E8951C",Bi="#D7372A",Fi=.2,Vi=.5,Ds=2;function Ui(n){const e=Math.abs(n-1);return e<=Fi?{word:"On target",colour:un}:e<=Vi?{word:n>1?"Too high":"Too low",colour:Xn}:{word:n>1?"Way too high":"Way too low",colour:Bi}}function bo(n){const e=Math.abs(n-1),t=n>=1;return e<=Fi?t?"greenHigh":"greenLow":e<=Vi?t?"amberHigh":"amberLow":t?"redHigh":"redLow"}function wo(n){return Math.min(Math.max(n,0),Ds)/Ds*100}function vo(n){return n>=85?{word:"Almost perfect",colour:un}:n>=65?{word:"Really close",colour:un}:n>=45?{word:"Getting there",colour:Xn}:n>=25?{word:"Not quite",colour:Xn}:{word:"Way off - try again",colour:Bi}}function _o(n,e,t){var r,o;const s=bo(t),i=((r=Us[n])==null?void 0:r[s])??((o=Us[e])==null?void 0:o[s]);return i||(Ui(t).colour===un?`${e} is very close to the target value for this simulation.`:t<1?`${e} is below the target value for this simulation.`:`${e} is above the target value for this simulation.`)}function So(n,e,t){return n.metadata.results.map(s=>{const i=ko(s,n,e,t);if(i===null)return null;const a=i/Math.max(s.target,1e-9),r=Eo(s,n,t),o=_o(s.id,r,a),l=Be(Di(String(i),s),s.unit);return{id:s.id,label:r,value:a,rawValue:i,formattedValue:l,detail:o}}).filter(s=>s!==null)}function ko(n,e,t,s){var l;const i=n.id,a=e.parameters.find(c=>c.id===i);if(a)return t[i]??a.fallbackValue;const r=Io((l=s==null?void 0:s.summaryMetrics[i])==null?void 0:l.value);if(r!==null)return r;const o=s==null?void 0:s.parameterValues[i];return typeof o=="number"&&Number.isFinite(o)?o:null}function Eo(n,e,t){var i,a;const s=n.id;return n.label??((i=e.parameters.find(r=>r.id===s))==null?void 0:i.label)??((a=t==null?void 0:t.summaryMetrics[s])==null?void 0:a.label)??s}function Io(n){if(n===void 0)return null;const e=Number(n);return Number.isFinite(e)?e:null}function No(n){if(n.length===0)return 0;const e=n.reduce((t,s)=>t+Math.max(0,1-Math.abs(s.value-1)),0);return Math.round(e/n.length*100)}function Lo(n,e){const t=document.createElement("section");t.className="overlay overlay--summary",t.hidden=!0,t.classList.add("is-hidden");let s;const i=document.createElement("div");i.className="summary-overlay";const a=document.createElement("div"),r=document.createElement("div");a.className="summary-overlay__header",r.className="summary-overlay__content";const o=document.createElement("p");o.className="summary-overlay__title",o.textContent="Run Summary";const l=document.createElement("p");l.className="summary-overlay__hint",l.textContent="Select any card for more details",a.appendChild(o),a.appendChild(l);const c=document.createElement("div");c.className="summary-overlay__actions";const u=document.createElement("button");u.className="summary-overlay__button",u.type="button",u.textContent="Continue Visualising";const f=document.createElement("button"),h=document.createElement("button");f.className="summary-overlay__button summary-overlay__button--primary",f.type="button",f.textContent="New Parameters",h.className="summary-overlay__button",h.type="button",h.textContent="Home",h.hidden=!e.showHome,u.addEventListener("click",e.onReplay),f.addEventListener("click",e.onParameters),h.addEventListener("click",e.onHome),c.appendChild(f),c.appendChild(u),c.appendChild(h),i.appendChild(a),i.appendChild(r),i.appendChild(c),t.appendChild(i);const m=document.createElement("div");m.className="sci-modal is-hidden",m.innerHTML=`
  ...
  `,t.appendChild(m),n.appendChild(t);const b=m.querySelector(".sci-modal__title"),p=m.querySelector(".sci-modal__verdict"),g=m.querySelector(".sci-modal__body"),_=m.querySelector(".sci-modal__close"),w=new Set;let N=!1;function E(S){const M=Ui(S.value);b.textContent=S.label,p.textContent=M.word,p.style.color=M.colour,p.hidden=!1,g.textContent=S.detail,m.classList.remove("is-hidden")}function k(S,M){b.textContent=S,p.hidden=!0,g.textContent=M,m.classList.remove("is-hidden")}function y(){m.classList.add("is-hidden")}_.addEventListener("click",y),m.addEventListener("click",S=>{S.target===m&&y()}),t.addEventListener("click",S=>{S.target===t&&e.onReplay()});function I(S,M){const B=document.createElement("div");B.className=`${S.className} panel`,B.innerHTML=`<p class="sci-section__title">${S.title}</p>`;const P=document.createElement("div"),D=S.singleRow?Math.max(1,S.stats.length):Math.max(1,Math.min(S.stats.length,S.maxColumns));P.className="metric-grid",S.singleRow&&P.classList.add("metric-grid--single-row"),P.style.setProperty("--summary-grid-columns",String(D)),P.style.setProperty("--summary-grid-max-width",`${S.maxWidthRem}rem`);for(const F of S.stats){const J=Ao(F,M),W=document.createElement("div"),te=document.createElement("span"),U=document.createElement("span");W.className="res-card",te.className="res-card__label",te.textContent=J.label,U.className="res-card__value",U.textContent=J.value,W.appendChild(te),W.appendChild(U),F.description&&(W.classList.add("res-card--has-info"),W.addEventListener("click",()=>{k(J.label,F.description)})),P.appendChild(W)}return B.appendChild(P),B}return{show(){s&&(window.clearTimeout(s),s=void 0),t.hidden=!1,t.classList.remove("is-hidden"),t.classList.remove("is-visible"),t.offsetWidth,requestAnimationFrame(()=>{t.classList.add("is-visible")})},hide(){t.classList.remove("is-visible"),s=window.setTimeout(()=>{t.hidden=!0,t.classList.add("is-hidden"),s=void 0,N&&(w.clear(),N=!1)},po.HIDE_AFTER_MS)},setHomeVisible(S){h.hidden=!S},update(S,M,B,P,D){var L,T,K,j,V,Z;r.innerHTML="",y();const F=uo(S,M,B,P),J=S.metadata.summaryStats,W=So(S,M,P),te=new Set(W.map($=>$.id));let U;if(W.length>0)U=No(W);else{const $=((L=F.similarityScore)==null?void 0:L.value)??"0/100";U=parseInt($,10)||0}const ve=vo(U),me=document.createElement("div"),Le=document.createElement("div"),Q=document.createElement("div");me.className="sci-top",Le.className="summary-main-column",Q.className="summary-side-column";const pe=document.createElement("div");pe.className="sci-hero panel",D?(pe.classList.add("sci-hero--thumbnail"),pe.innerHTML=`<img class="sci-hero__thumbnail" src="${D}" alt="Final frame of simulation" />`):pe.innerHTML=`
          ...
          <div class="sci-hero__gauge">
            <div class="sci-hero__gauge-fill" style="width:${U}%; background:${ve.colour}; box-shadow:0 0 12px ${ve.colour}"></div>
          </div>
        `,Le.appendChild(pe);const _e=J.filter($=>($.section??"resources")==="resources"&&!W.some(ne=>ne.id===String($.id))&&$.id!=="similarityScore"),Se=J.filter($=>$.section==="simulationStats"&&!te.has(String($.id)));_e.length>0&&Q.appendChild(I({title:"Resources Used",className:"res-section",stats:_e,maxColumns:3,maxWidthRem:48},F)),Se.length>0&&Q.appendChild(I({title:"Simulation Stats",className:"res-section",stats:Se,maxColumns:Se.length,maxWidthRem:48,singleRow:!0},F)),me.appendChild(Le),Q.childElementCount>0&&me.appendChild(Q),r.appendChild(me);const re=S.metadata.morphologyChecklist;if(re&&re.length>0){const $=((K=(T=P==null?void 0:P.summaryMetrics)==null?void 0:T.morphology)==null?void 0:K.value)??null,ne=($==null?void 0:$.toLowerCase())??null,Ae=new Set(re.map(R=>R.id));ne&&Ae.has(ne)&&w.add(ne);const ge=document.createElement("div");ge.className="sci-bottom-row";const oe=document.createElement("div");oe.style.cssText="display:flex; flex-direction:column; gap:1.25rem;",oe.appendChild(Hs(S,M,k));const q=((j=re.find(R=>R.id===ne))==null?void 0:j.label)??$;if(q){const R=document.createElement("div");R.className="sci-section panel param-section";const G=document.createElement("p");G.className="sci-section__title",G.textContent="Galaxy Morphology";const Y=document.createElement("div");Y.className="res-card res-card--has-info";const Ke=document.createElement("span");Ke.className="res-card__value",Ke.textContent=q,Y.appendChild(Ke),Y.addEventListener("click",()=>{var ee;return k("Galaxy Morphology",((ee=re.find(Je=>Je.id===($??"").toLowerCase()))==null?void 0:ee.description)??`This galaxy is classified as "${q}".`)}),R.appendChild(G),R.appendChild(Y),oe.appendChild(R)}ge.appendChild(oe);const ye=document.createElement("div");ye.style.cssText="flex:1; display:flex; flex-direction:column; gap:1.25rem; min-width:0; min-height:0;";const ke=((Z=(V=P==null?void 0:P.summaryMetrics)==null?void 0:V.description)==null?void 0:Z.value)??null;if(ke){const R=document.createElement("div");R.className="sci-section panel",R.style.cssText="flex:0 1 auto; min-width:0;";const G=document.createElement("p");G.className="sci-section__title",G.textContent="About This Galaxy";const Y=document.createElement("p");Y.className="galaxy-summary__desc-text",Y.textContent=ke,R.appendChild(G),R.appendChild(Y),ye.appendChild(R)}const Ce=document.createElement("div");Ce.className="sci-section panel",Ce.style.cssText="flex:1; min-height:0;";const je=document.createElement("p");je.className="sci-section__title",je.textContent="Morphology Scavenger Hunt";const Ve=document.createElement("div");Ve.className="galaxy-summary__checklist",Ve.style.cssText="flex:1; align-items:center;";const qe=re.every(R=>w.has(R.id));for(const R of re){const G=document.createElement("div");G.className="galaxy-summary__check",w.has(R.id)&&G.classList.add("is-found"),G.innerHTML=`
            <span class="galaxy-summary__check-box">
              ${w.has(R.id)?"✓":""}
            </span>
            <span class="galaxy-summary__check-label">${R.label}</span>
          `,R.hint&&(G.classList.add("res-card--has-info"),G.addEventListener("click",()=>k(R.label,R.hint))),Ve.appendChild(G)}if(Ce.appendChild(je),Ce.appendChild(Ve),qe){N=!0;const R=document.createElement("div");R.className="galaxy-summary__done",R.textContent="★ You've discovered all of the galaxy types. Well done! ★",Ce.appendChild(R)}ye.appendChild(Ce),ge.appendChild(ye),r.appendChild(ge)}else if(W.length>0){const $=document.createElement("div");$.className="sci-bottom-row",$.appendChild(Hs(S,M,k));const ne=document.createElement("div"),Ae=document.createElement("div"),ge=document.createElement("p"),oe=document.createElement("p");ne.className="sci-section panel",Ae.className="sci-section__header",ge.className="sci-section__title",ge.textContent="Similarity Results",oe.className="sci-section__hint",oe.textContent="Select any bar for details",Ae.appendChild(ge),Ae.appendChild(oe);const q=document.createElement("div");q.className="sci-bars";for(const ye of W){const ke=document.createElement("div");ke.className="sci-bar",ke.innerHTML=`
...
`;function xo(){const n=ze(Po);if(!Array.isArray(n))return[];const e=[];for(const t of n){if(!t||typeof t!="object")continue;const s=t.text;if(typeof s!="string"||s.trim().length===0)continue;const i={text:s},a=t.url;typeof a=="string"&&a.trim().length>0&&(i.url=a);const r=t.logo;typeof r=="string"&&r.trim().length>0&&(i.logo=r),t.header===!0&&(i.header=!0),e.push(i)}return e}function Ro(n,e,t,s){const i=document.createElement("div");i.className="parameter-editor",n.appendChild(i);let a=e,r={...t};function o(u,f){a=u,r=f?{...f}:$o(u),i.innerHTML="";const h=document.createElement("div");h.className="parameter-editor__heading",h.innerHTML=`
 ...
 Engine</h1>
  ...
  `;const N=document.createElement("div");w.appendChild(N);const E=document.createElement("section");E.className="audio-settings",E.innerHTML=`
  ...
  `;const M=document.createElement("input"),B=document.createElement("span");M.type="range",M.min="0",M.max="100",M.step="1",M.className="audio-settings__slider",B.className="audio-settings__value",S.appendChild(M),S.appendChild(B),E.appendChild(S),w.appendChild(E);const P=document.createElement("section");P.className="advanced-settings",P.dataset.state="closed",P.innerHTML=`
  ...
  `;const me=document.createElement("select");me.className="advanced-settings__select",me.appendChild(new Option("None",""));for(const A of e.availableScales)me.appendChild(new Option(A.label,A.id));ve.appendChild(me),U.appendChild(ve);const Le=document.createElement("div");Le.className="advanced-settings__field",Le.innerHTML=`
  ...
  `;const Q=document.createElement("div");Q.className="advanced-settings__options";const pe=document.createElement("label"),_e=document.createElement("input");pe.className="advanced-settings__choice",_e.type="radio",_e.name="manifest-source",_e.value="local",pe.appendChild(_e),pe.append("Local manifest");const Se=document.createElement("label"),re=document.createElement("input");Se.className="advanced-settings__choice",re.type="radio",re.name="manifest-source",re.value="online",Se.appendChild(re),Se.append("Online manifest"),Q.appendChild(pe),Q.appendChild(Se),Le.appendChild(Q),U.appendChild(Le);const L=document.createElement("label");L.className="advanced-settings__field advanced-settings__field--inline";const T=document.createElement("input"),K=document.createElement("span");T.type="checkbox",T.className="advanced-settings__checkbox",K.innerHTML=`
...
`,Xo={planetary:zo,galaxy:Jo,cosmos:Qo};function Zo(n){return ze(Xo[n.id]).map(t=>({text:t}))}function Dt(n,e,t,s){if(e.length===0)return 0;const i=s?e.filter(r=>s.has(r.id)):e;return i.length===0?0:i.reduce((r,o)=>{var f;const l=t[o.id]??o.fallbackValue,c=((f=n.parameters)==null?void 0:f[o.id])??o.fallbackValue,u=Math.max(o.max-o.min,1e-9);return r+Math.abs(l-c)/u},0)/i.length}function el(n,e,t){if(n.length===0)return null;const s=new Set(e.filter(u=>u.primary!==!1).map(u=>u.id)),i=new Set(e.filter(u=>u.primary===!1).map(u=>u.id));if(!e.some(u=>u.primary===!1))return Dn(n,e,t);const r=Dn(n,e,t,s);if(!r)return null;const o=Dt(r,e,t,s),l=1e-6,c=n.filter(u=>{const f=Dt(u,e,t,s);return Math.abs(f-o)<=l});return Dn(c,e,t,i)}function Dn(n,e,t,s){if(n.length===0)return null;let i=n[0],a=Dt(i,e,t,s);for(const r of n.slice(1)){const o=Dt(r,e,t,s);o<a&&(i=r,a=o)}return i}function tl(n){return n.replace(/\.mp4($|\?)/,".yaml$1")}async function nl(n){try{const e=await Ze(n);if(!e.ok)return null;const t=await e.text(),s=ze(t),i=pt(s.wallclockSeconds),a=pt(s.computeUsed),r=pt(s.memoryUsed),o=pt(s.carbonBurnt),l=pt(s.particlesUpdated),c=await sl(n),u=al(s.summaryMetrics);return i===null||a===null||r===null||o===null||l===null?null:{wallclockSeconds:i,computeUsed:a,memoryUsed:r,carbonBurnt:o,particlesUpdated:l,parameterValues:c,summaryMetrics:u}}catch{return null}}async function sl(n){try{const e=await Ze(il(n));if(!e.ok)return{};const t=await e.text(),s=ze(t);return rl(s)}catch{return{}}}function il(n){return n.replace(/run_summary\.yaml($|\?)/,"parameters.yaml$1")}function pt(n){const e=typeof n=="number"?n:Number(n);return Number.isFinite(e)?e:null}function al(n){if(!n||typeof n!="object")return{};const e=n,t={};for(const[s,i]of Object.entries(e)){if(!i||typeof i!="object")continue;const a=i,r=typeof a.label=="string"?a.label:s,o=a.value;o!=null&&(t[s]={label:r,value:String(o)})}return t}function rl(n){if(!n||typeof n!="object")return{};const e={};for(const[t,s]of Object.entries(n)){const i=pt(s);i!==null&&(e[t]=i)}return e}const Ki="[UniverseEngine]";let Wi=!1;function qs(n){Wi=n}function Yi(){return Wi}function ce(n,e){Yi()&&console.info(Ki,n,e??"")}function Ye(n,e){Yi()&&console.warn(Ki,n,e??"")}const ol={local:"assets/local-manifest.json",online:$i};function ll(n="local"){let e=n;const t=new Map,s=new Map;return{getSource(){return e},setSource(i){t.delete(i),s.delete(i),Wr(),e=i,ce("Manifest source updated",{source:i})},async preloadActiveManifest(){await zi(e,t,s)},async findNearestVideo(i,a,r){const o=await dl(e,t,s,i,a,r);if(o)return o;const l=Gi(i);return Ye("Falling back to placeholder assets",{simClassId:i,source:e,fallbackUrl:l}),{url:l,liveDataUrl:cl(i),summaryUrl:tl(l)}}}}function Gi(n){switch(n){case"planetary":return X("assets/planet_test.mp4");case"galaxy":return X("assets/galaxy_test.mp4");case"cosmos":return X("assets/cosmo_test.mp4");default:return X("assets/galaxy_test.mp4")}}function cl(n){switch(n){case"planetary":return X("assets/planet_test_planetary_stats.csv");case"galaxy":return X("assets/galaxy_test_galaxy_stats.csv");case"cosmos":return X("assets/cosmo_test_cosmos_stats.csv");default:return X("assets/galaxy_test_galaxy_stats.csv")}}async function zi(n,e,t){const s=e.get(n);if(s)return s;const i=ol[n],a=(n==="online"?ul(i):fetch(X(i),{cache:"no-store"}).then(async r=>{if(!r.ok)throw new Error(`Failed to load manifest: ${i}`);return ce("Loaded manifest",{source:n,manifestPath:i}),await r.json()})).then(r=>(t.set(n,fl()),r)).catch(r=>(t.delete(n),Ye("Manifest unavailable",{source:n,manifestPath:i,error:r instanceof Error?r.message:String(r)}),{version:1,runs:[]}));return e.set(n,a),a}async function ul(n){const e=[n,Fn];for(const t of e)try{const s=await fetch(t,{cache:"no-store"});if(!s.ok)continue;const i=await s.json(),a=i.primaryBase??Ks($i),r=i.backupBase??Ks(Fn);return Kr(a,r),t===Fn&&Yr("backup"),ce("Loaded manifest",{source:"online",manifestPath:t,primaryBase:a,backupBase:r}),i}catch{continue}throw new Error(`Failed to load manifest: ${n}`)}async function dl(n,e,t,s,i,a){const o=(await zi(n,e,t)).runs.filter(h=>h.simulationId===s);if(o.length===0)return Ye("No manifest runs found for simulation",{simClassId:s,source:n}),null;const l=el(o,i,a);if(!l)return null;const c=Dt(l,i,a),u=l.defaultView??Object.keys(l.views)[0],f=l.views[u];return f?(ce("Selected manifest-backed run",{simClassId:s,source:n,runId:l.runId,selectedValues:a,distance:c,viewId:u}),{url:tn(n,f,t),liveDataUrl:tn(n,l.liveDataPath,t),summaryUrl:tn(n,l.summaryPath,t),viewId:u,runId:l.runId,views:Object.fromEntries(Object.entries(l.views).map(([h,m])=>[h,tn(n,m,t)]))}):null}function tn(n,e,t){const s=n==="local"?X(e):De(e),i=t.get(n);return i?Ti(s,"_manifest",i):s}function fl(){return`${Date.now()}`}function Ks(n){const e=new URL(n);return`${e.protocol}//${e.host}`}const rn={mode:"time",frames:[]};async function hl(n){const e=await Ze(n);if(!e.ok)throw new Error(`Failed to load live stats CSV: ${n}`);const t=await e.text();return gl(t)}function ml(n,e,t=0){if(n.mode==="row")return yl(n.frames,e,t);const s=n.frames;if(s.length===0)return{};if(e<=s[0].t)return{...s[0].values};const i=s[s.length-1];if(e>=i.t)return{...i.values};const a=pl(s,e),r=s[Math.max(0,a-1)],o=s[Math.min(s.length-1,a)],l=(e-r.t)/Math.max(o.t-r.t,1e-9);return bl(r.values,o.values,l)}function pl(n,e){let t=1,s=n.length-1;for(;t<s;){const i=Math.floor((t+s)/2);n[i].t<=e?t=i+1:s=i}return t}function gl(n){const e=n.split(/\r?\n/).map(s=>s.trim()).filter(Boolean);if(e.length<2)return rn;const t=Hn(e[0]);return t[0]==="t"?{mode:"time",frames:e.slice(1).map(s=>{const i=Hn(s),a={};for(let r=1;r<t.length;r+=1)a[t[r]]=i[r]??"";return{t:parseFloat(i[0]??"0")||0,values:a}})}:{mode:"row",frames:e.slice(1).map((s,i)=>{const a=Hn(s),r={};for(let o=0;o<t.length;o+=1)r[t[o]]=a[o]??"";return{t:i,values:r}})}}function yl(n,e,t){if(n.length===0)return{};if(!Number.isFinite(t)||t<=0)return{...n[0].values};const s=Math.max(0,Math.min(1,e/t)),i=Math.round(s*(n.length-1));return{...n[i].values}}function Hn(n){const e=[];let t="",s=!1;for(let i=0;i<n.length;i+=1){const a=n[i];if(a==='"'){s=!s;continue}if(a===","&&!s){e.push(t),t="";continue}t+=a}return e.push(t),e}function bl(n,e,t){const s=new Set([...Object.keys(n),...Object.keys(e)]),i={};for(const a of s){const r=n[a]??"",o=e[a]??r,l=parseFloat(r),c=parseFloat(o);if(Number.isFinite(l)&&Number.isFinite(c)){const u=l+(c-l)*t;i[a]=wl(u);continue}i[a]=t<.5?r:o}return i}function wl(n){return n.toFixed(2).replace(new RegExp("\\.0+$|(?<=\\..*?)0+$","g"),"").replace(/\.$/,"")}function vl(n){_l(go,n)}function _l(n,e){if(navigator.sendBeacon){const t=new Blob([JSON.stringify(e)],{type:"application/json"});if(navigator.sendBeacon(n,t)){ce("Run selection tracking dispatched",{simulationId:e.simulationId});return}}fetch(n,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),keepalive:!0}).then(t=>{t.ok?ce("Run selection tracked",{simulationId:e.simulationId}):Ye("Run selection tracking rejected",{simulationId:e.simulationId,status:t.status})}).catch(t=>{Ye("Run selection tracking failed",{simulationId:e.simulationId,error:t instanceof Error?t.message:String(t)})})}const Ws=50*1024*1024,Sl=8,kl=6e3,El=8e3,Il=7e3,Nl=1200,Ll=100,jn={galaxy:"tron",planetary:"matrix",cosmos:"hal"};function Al(n){const e=mt.map(d=>d.id);let t=Fo(e),s=Ss(t);const i=ll(t.manifestSource),a=Go();qs(t.verboseLogging),t.manifestSource==="online"&&i.preloadActiveManifest();let r=ks(t.lockedScaleId)??s[0]??mt[0],o=t.lockedScaleId?jn[r.id]:Hr(),l=!1,c=null,u=null,f=!1,h=t.audioMutedByDefault,m=t.defaultAudioVolume,b=0;const p=new Set;let g=null,_=0,w=rn,N=!1;const E=Object.fromEntries(mt.map(d=>[d.id,la(d)]));xn(o);const k=Gi(r.id),y=zr(n,k),I=document.createElement("audio");I.preload="auto",I.hidden=!0,I.setAttribute("playsinline","true"),I.muted=h,I.volume=m,n.appendChild(I);const S=document.createElement("div");S.className="display-chrome",S.classList.add("is-hidden"),n.appendChild(S);const M=document.createElement("div");M.className="orientation-overlay",M.innerHTML=`
  ...
  `,n.appendChild(M);const B=document.createElement("div");B.className="swift-logo",B.innerHTML=`
    ...
    <img
      ...
      decoding="async"
    />
  `,n.appendChild(B);const P=document.createElement("div");P.className="synth-logo is-hidden",P.innerHTML=`
    <img
    ...
    <img
      ...
      decoding="async"
    />
  `,n.appendChild(P);const D=document.createElement("img");D.className="app-partner-logo",D.src=X("assets/dirac-hpc-white.webp"),D.alt="DIRAC HPC",D.decoding="async",n.appendChild(D);const F=document.createElement("div");F.className="display-chrome__top-left is-hidden",n.appendChild(F);const J=qo(F,{onHome(){kn()},onParameters(){At("parameters")},onViewSelected(d){if(d==="credits"){At("credits");return}At(d)},showHome:!t.lockedScaleId}),W=document.createElement("div");W.className="display-chrome__left-center",S.appendChild(W);const te=To(W,{onSelect(d){bs(d)},onInfo(d,v,C){ve.textContent=v,me.textContent=C,U.classList.add("is-visible")}}),U=document.createElement("div");U.className="view-info-overlay",U.innerHTML=`
  ...
  `,n.appendChild(U);const ve=U.querySelector(".view-info-overlay__title"),me=U.querySelector(".view-info-overlay__text"),Le=U.querySelector(".view-info-overlay__close");U.addEventListener("click",d=>{d.target===U&&U.classList.remove("is-visible")}),Le.addEventListener("click",()=>{U.classList.remove("is-visible")});const Q=document.createElement("div");Q.className="display-chrome__top-center is-hidden",S.appendChild(Q);const pe=document.createElement("div");pe.className="display-chrome__top-right",S.appendChild(pe);const _e=to(pe),Se=document.createElement("div");Se.className="display-chrome__center-status",Se.innerHTML=`
  ...
  `,S.appendChild(Se);const re=Wo();y.setPlaybackRate(re);const L=document.createElement("div");L.className="display-chrome__bottom",S.appendChild(L);const T=Qr(L,{onChange(d){oe(d)},onTogglePlay:ys,onAudioToggle:ta,onSpeedChange:na,onSummaryClick:ea,onScrubStart(){Ve(),ge()},onScrubEnd(){qe(),y.isPaused()||Ae()},initialSpeed:re});T.setPlaying(!y.isPaused()),T.setAudioVisible(!1),T.setMuted(h),I.addEventListener("loadedmetadata",()=>{dt(!0),Ie()});let K=null,j=null,V=null,Z=!1,$=null,ne=0;function Ae(){if(K!==null)return;function d(){const v=y.getPlaybackFraction();T.setPosition(v),y.isPaused()?K=null:K=requestAnimationFrame(d)}K=requestAnimationFrame(d)}function ge(){K!==null&&(cancelAnimationFrame(K),K=null)}function oe(d){j=d,V===null&&(V=requestAnimationFrame(()=>{if(V=null,j===null)return;const v=j;j=null,y.seekToFraction(v),dt(!0)}))}function q(){if(j===null)return;V!==null&&(cancelAnimationFrame(V),V=null);const d=j;j=null,y.seekToFraction(d),dt(!0)}function ye(){$!==null&&(window.clearTimeout($),$=null)}function ke(){if(!(g!=null&&g.views))return[];const d=ut(r,g);return Object.entries(g.views).filter(([v])=>v!==d).map(([,v])=>De(v)).filter(Boolean)}function Ce(){ye(),y.suspendPrewarming()}function je(d=Nl){ye(),!(Z||y.isPaused())&&($=window.setTimeout(()=>{$=null,!(Z||y.isPaused())&&(y.resumePrewarming(),y.prewarmSources(ke()))},Math.max(0,d)))}function Ve(){Z=!0,ne=0,Ce(),Ie()}function qe(){Z=!1,ne=0,q(),_=y.getPlaybackFraction()*y.getDurationSeconds(),nt(_),je(),Ie()}y.onPlayStateChange(d=>{T.setPlaying(!d),d?(ge(),Ce()):(Ae(),je(0)),Ie()}),y.onTimeUpdate(d=>{if(_=d*y.getDurationSeconds(),Z){const v=performance.now();if(v-ne<Ll)return;ne=v}nt(_),dt()});const R=document.createElement("div");R.className="overlay-layer",n.appendChild(R);const G=Ri();G.infoButton.classList.add("is-hidden"),G.infoButton.hidden=!0,n.appendChild(G.infoButton),n.appendChild(G.infoModal);const Y=Lo(R,{onReplay:Zi,onParameters:()=>At("parameters"),onHome:kn,showHome:!t.lockedScaleId});y.onEnded(()=>{l=!0;const d=y.captureFrame();Y.update(r,Te(),y.getDurationSeconds(),c,d),Y.show(),Ie()});const Ke=co(R,s,d=>{gs(d),At("parameters")}),ee=Ho(R,{simClass:r,values:Te(),theme:o,advancedSettings:t,availableScales:mt,onValuesChange:Ji,onThemeChange:Sn,onRun:()=>{ce("Parameters submitted — starting run",{simClassId:r.id}),sa().catch(d=>{Ye("Run failed to start",{simClassId:r.id,error:d instanceof Error?d.message:String(d)})})},onApplySettings:Qi,onClose:Xi,initialView:"parameters"});ee.setBackVisible(!t.lockedScaleId);const Je=jo(R);T.setPosition(0),nt(),Y.hide();const Ue=new WeakMap,A=d=>{const v=Ue.get(d);v&&(clearTimeout(v),Ue.delete(d)),d.classList.remove("side-collapsed")},H=d=>{const v=Ue.get(d);v&&clearTimeout(v),Ue.set(d,setTimeout(()=>{d.classList.add("side-collapsed"),Ue.delete(d)},2500))},ue=d=>{const v=Ue.get(d);v&&(clearTimeout(v),Ue.delete(d)),d.classList.add("side-collapsed")},de=(d,v)=>{const C=v.isCollapsible??(()=>!0);d.addEventListener("mouseenter",()=>A(d)),d.addEventListener("mouseleave",()=>{if(!C()){A(d);return}H(d)}),d.addEventListener("focusin",()=>A(d)),d.addEventListener("focusout",O=>{if(!d.contains(O.relatedTarget)){if(!C()){A(d);return}H(d)}}),d.addEventListener("click",()=>{if(!C()){A(d);return}if(d.classList.contains("side-collapsed")){A(d),H(d);return}v.toggleOnClick?ue(d):H(d)}),C()?ue(d):A(d)};de(F,{toggleOnClick:!0,isCollapsible:()=>n.dataset.mode==="display"}),de(W,{toggleOnClick:!0}),de(L,{toggleOnClick:!1});let Qe=0,lt=null,Wt=0;const ms=()=>{lt!==null&&(cancelAnimationFrame(lt),lt=null)},ps=()=>{if(lt!==null)return;Wt=y.getPlaybackFraction();const d=()=>{if(Qe===0){ms();return}const C=12*(1/60)/Math.max(y.getDurationSeconds(),1);Wt=Math.max(0,Math.min(1,Wt+Qe*C)),y.seekToFraction(Wt),lt=requestAnimationFrame(d)};lt=requestAnimationFrame(d)};document.addEventListener("keydown",d=>{if(n.dataset.mode==="display"&&!(d.target instanceof HTMLInputElement||d.target instanceof HTMLTextAreaElement))switch(d.key){case"Escape":d.preventDefault(),U.classList.contains("is-visible")?U.classList.remove("is-visible"):kn();break;case" ":d.preventDefault(),ys();break;case"ArrowLeft":d.preventDefault(),A(L),H(L),Qe=-1,ps();break;case"ArrowRight":d.preventDefault(),A(L),H(L),Qe=1,ps();break;case"ArrowUp":case"ArrowDown":{if(d.preventDefault(),A(W),H(W),!(g!=null&&g.views)||Object.keys(g.views).length<=1)break;const v=r.views.filter(fe=>{var Ee;return((Ee=g==null?void 0:g.views)==null?void 0:Ee[fe.id])!==void 0});if(v.length<=1)break;const C=g.viewId??ut(r,g),O=v.findIndex(fe=>fe.id===C),le=d.key==="ArrowUp"?(O-1+v.length)%v.length:(O+1)%v.length;bs(v[le].id);break}}}),document.addEventListener("keyup",d=>{(d.key==="ArrowLeft"||d.key==="ArrowRight")&&(Qe=0,ms())}),y.hideMedia(),y.pause(),tt(t.lockedScaleId?"config":"entry");function gs(d){d.id===r.id&&N||(r=d,In(),Sn(jn[d.id]),ee.setSimulation(r,Te()),T.setPosition(0),nt(),Yt(),En())}function Ji(d){E[r.id]={...d},ce("Parameter values updated",{simClassId:r.id,values:E[r.id]}),nt()}function Sn(d){o=d,xn(d),ee.setTheme(d)}function At(d){d==="parameters"&&ee.setSimulation(r,Te()),ee.setView(d),tt("config")}function Qi(d){if(va(d),N){Y.hide(),tt("display");return}ee.setSimulation(r,Te()),ee.setView("parameters")}function Xi(){if(Y.hide(),!N&&t.lockedScaleId){ee.setSimulation(r,Te()),ee.setView("parameters");return}tt(N?"display":"entry")}function kn(){t.lockedScaleId||(ce("Returning to home screen",{simClassId:r.id}),In(),N=!1,y.hideMedia(),tt("entry"))}function Zi(){l=!1,Y.hide(),y.getPlaybackFraction()>=.999&&(y.resetPlayback(),dt(!0)),Un(y),Ie()}function ea(){l=!0,y.pause();const d=c?y.captureFrame():null;Y.update(r,Te(),y.getDurationSeconds(),c,d),Y.show(),Ie()}function ys(){y.isPaused()?Un(y):y.pause()}function ta(){h=!h,Ie()}function na(d){y.setPlaybackRate(d),Yo(d),T.setSpeed(d)}async function sa(){const d=Te(),v=a.start();ce("Run requested",{simClassId:r.id,values:d,manifestSource:i.getSource()});const C=await i.findNearestVideo(r.id,r.parameters,d);if(!a.isCurrent(v))return;In({preserveRunRequest:!0}),g=C;const O=ut(r,C),le=Gr(i.getSource());vl({simulationId:r.id,parameters:d,manifestSource:i.getSource(),matchedRunId:C.runId,assetHostMode:le.mode,assetHostBase:le.base});const fe=ha(C,O)??C.url,Ee=Object.entries(C.views??{}).filter(([xe])=>xe!==O).map(([,xe])=>xe);ua(C.liveDataUrl,v),da(C.summaryUrl,v),pa(C.summaryUrl,v),y.setMuted(!0),Yt(O),Ct(),tt("initializing");const Gt=ia(fe);y.resumePrewarming(),y.prewarmSources(Ee);const Tt=(async()=>{const xe=await Gt;a.isCurrent(v)&&(ce(`Prepared active video source: ${xe.ownedObjectUrl?"FULL-FETCH":"PROGRESSIVE"}`,{selectedViewUrl:fe,waitsForBuffer:xe.shouldWaitForBuffer}),y.setSource(xe.src,{ownedObjectUrl:xe.ownedObjectUrl}),y.pause(),await y.waitForLoadedData(El),a.isCurrent(v)&&xe.shouldWaitForBuffer&&await y.waitForBufferedAhead(Sl,kl))})();await new Promise(xe=>{Je.show(Zo(r),xe,Tt,{minTerminalTimeMs:ba()})}),a.isCurrent(v)&&(N=!0,y.showMedia(),Un(y),tt("display"),Ie())}async function ia(d){const v=De(d),C=await aa(d);if(C!==null&&C>0&&C<=Ws){ce("Downloading active video behind loading overlay",{videoUrl:v,contentLength:C});try{const O=await Ze(d);if(!O.ok)throw new Error(`Failed to download active video: ${v}`);const le=await O.blob();return ce(`Active video full fetch complete: ${le.size} bytes`,{videoUrl:De(d),blobType:le.type}),{src:URL.createObjectURL(le),ownedObjectUrl:!0,shouldWaitForBuffer:!1}}catch(O){Ye(`Full-fetch FAILED; falling back to progressive: ${O instanceof Error?O.message:String(O)}`,{videoUrl:d})}}return C!==null?ce("Active video exceeds full-fetch threshold; using progressive load",{videoUrl:d,contentLength:C,fullFetchMaxBytes:Ws}):ce("Could not determine active video size; using progressive load",{videoUrl:d}),ce("Using progressive active video load",{videoUrl:d}),{src:De(d),ownedObjectUrl:!1,shouldWaitForBuffer:!0}}async function aa(d){try{const v=await Ze(d,{headers:{Range:"bytes=0-0"}});ce("Probed active video size with range request",{videoUrl:d,ok:v.ok,status:v.status,contentLength:v.headers.get("Content-Length"),contentRange:v.headers.get("Content-Range")});const C=oa(v.headers.get("Content-Length"));if(C!==null)return C;const O=ra(v.headers.get("Content-Range"));return O!==null?O:null}catch(v){return Ye("Could not probe active video size",{videoUrl:d,error:v instanceof Error?v.message:String(v)}),null}}function ra(d){if(!d)return null;const v=d.match(/bytes\s+\d+-\d+\/(\d+)/i);if(!v)return null;const C=Number(v[1]);return Number.isFinite(C)&&C>0?C:null}function oa(d){if(!d)return null;const v=Number(d);return Number.isFinite(v)?v:null}function tt(d){if(n.dataset.mode=d,d==="entry"?document.documentElement.setAttribute("data-theme","glass"):d==="display"&&xn(o),ct(S,d==="display"||d==="config"),ct(B,d==="display"||d==="entry"),ct(F,d==="entry"||d==="config"||d==="display"),ct(G.infoButton,d==="config"&&!!t.lockedScaleId),(d!=="config"||!t.lockedScaleId)&&G.close(),d!=="display"?A(F):ue(F),d==="entry"&&!t.lockedScaleId?Ke.show():Ke.hide(),d==="config"?(Je.hide(),ee.setSimulation(r,Te()),ee.show()):ee.hide(),d!=="display")Y.hide(),te.hide(),Q.classList.add("is-hidden"),Q.innerHTML="";else if(l){const C=y.captureFrame();Y.update(r,Te(),y.getDurationSeconds(),c,C),Y.show()}else Yt();!N||d==="initializing"?(y.hideMedia(),d==="initializing"&&y.pause()):y.showMedia(),d!=="initializing"&&Je.hide(),En(),Ie()}function En(){if(n.dataset.mode==="entry"){ct(P,!0);return}const d=n.dataset.mode==="display",v=r.id==="galaxy";ct(P,d&&v)}function nt(d=0){const v=ml(w,d,y.getDurationSeconds()),C=fa(r,c,d,y.getDurationSeconds());_e.update(r,Te(),{...v,...C})}function Yt(d){const v=r.views.filter(le=>{var fe;return((fe=g==null?void 0:g.views)==null?void 0:fe[le.id])!==void 0});if(v.length<=1){te.hide(),Q.classList.add("is-hidden");return}const C=d??ut(r,g),O=v.find(le=>le.id===C);te.update(v,C),O?(Q.classList.remove("is-hidden"),Q.innerHTML=`<span class="viewport-title">${O.label??O.id}</span>`):Q.classList.add("is-hidden")}function In(d={}){d.preserveRunRequest||a.invalidate(),w=rn,l=!1,c=null,g=null,_=0,Z=!1,j=null,ye(),V!==null&&(cancelAnimationFrame(V),V=null),Y.hide(),te.hide(),Q.classList.add("is-hidden"),Q.innerHTML="",y.pause(),I.pause(),y.clearPrewarmedSources(),y.resetPlayback(),T.setPosition(0),_s()}function bs(d){if(!(g!=null&&g.views)||d===ut(r,g))return;const v=De(g.views[d]);if(!v)return;g.viewId=d;const C=!y.isPaused()&&!l,O=l?0:y.getPlaybackFraction();l=!1,Y.hide(),y.setSource(v,{seekFraction:O,autoplay:C}),y.prewarmSources(ke()),C&&!Z?je():Ce(),Yt(d),Ct(),Ie(),U.classList.remove("is-visible"),En()}function Te(){return{...E[r.id]}}function la(d){return Object.fromEntries(d.parameters.map(v=>[v.id,ca(v)]))}function ca(d){if(d.logScale){const fe=Math.log10(d.min),Ee=Math.log10(d.max);return 10**(fe+Math.random()*(Ee-fe))}const v=Math.max(0,Math.round((d.max-d.min)/d.step)),C=Math.floor(Math.random()*(v+1)),O=d.min+C*d.step,le=xi(d.step);return Number(O.toFixed(le))}async function ua(d,v){let C=rn;try{C=await hl(d)}catch(O){Ye("Failed to load live stats",{url:d,error:O instanceof Error?O.message:String(O)})}a.isCurrent(v)&&(w=C,nt())}async function da(d,v){const C=await nl(d);a.isCurrent(v)&&(c=C,nt(_))}function fa(d,v,C,O){if(!v||!Number.isFinite(O)||O<=0)return{};const le=Math.max(0,Math.min(1,C/O)),fe={};for(const Ee of d.metadata.liveStats){if(!Ee.live||!Ee.fromVideo||!Ee.scaleWithTime)continue;const Gt=Ee.videoKey??Ee.id,Tt=v[Gt];if(typeof Tt!="number"||!Number.isFinite(Tt))continue;const Nn=Tt*le;fe[Ee.id]=Ee.integer?String(Math.floor(Nn)):String(Nn)}return fe}function ct(d,v){d.hidden=!v,d.classList.toggle("is-hidden",!v)}function ut(d,v){return v!=null&&v.views?v.viewId??Object.keys(v.views)[0]:v==null?void 0:v.viewId}function ha(d,v){return!v||!d.views?null:d.views[v]??null}function ws(){const d=ut(r,g);return d?r.views.some(v=>v.id===d&&v.audio):!1}function ma(d){return d.replace(/run_summary\.yaml($|\?)/,"audio_track.wav$1")}async function pa(d,v){const C=ma(d),O=De(C);if(p.has(O)){vs(O);return}const le=++b,fe=await ga(C);if(!(!a.isCurrent(v)||le!==b)){if(!fe){_s();return}p.add(O),vs(O)}}function vs(d){u=d,f=!0,I.src!==u&&(I.pause(),I.src=u,I.load()),Ct(),Ie()}async function ga(d){try{if((await Ze(d,{method:"HEAD"})).ok)return!0}catch{}try{return(await Ze(d,{headers:{Range:"bytes=0-0"}})).ok}catch{return!1}}function _s(){b+=1,u=null,f=!1,I.pause(),I.removeAttribute("src"),I.load(),Ct()}function ya(){h=t.audioMutedByDefault,m=t.defaultAudioVolume,I.muted=h,I.volume=m,T.setMuted(h)}function Ct(){T.setAudioVisible(ws()&&f&&!!u),T.setMuted(h)}function dt(d=!1){if(!f||!Number.isFinite(I.duration)||I.duration<=0)return;const v=Math.max(0,Math.min(I.duration,y.getPlaybackFraction()*I.duration));(d||Math.abs(I.currentTime-v)>.35)&&(I.currentTime=v)}function Ie(){const d=ws()&&f&&!!u;if(Ct(),I.muted=h,I.volume=m,!d){I.pause();return}if(dt(),n.dataset.mode!=="display"||y.isPaused()||l||Z){I.pause();return}I.play().catch(()=>{h=!0,I.muted=!0,T.setMuted(!0)})}function Ss(d){const v=new Set(Do(d,e));return mt.filter(C=>v.has(C.id))}function ks(d){return d?mt.find(v=>v.id===d)??null:null}function ba(){return i.getSource()!=="local"?Qn.MIN_TERMINAL_TIME_MS:wa(Qn.MIN_TERMINAL_TIME_MS,Il)}function wa(d,v){const C=Math.ceil(Math.min(d,v)),O=Math.floor(Math.max(d,v));return Math.floor(Math.random()*(O-C+1))+C}function va(d){const v=r.id,C=t.manifestSource;t=Vo(d,e),qs(t.verboseLogging),s=Ss(t),i.setSource(t.manifestSource),t.manifestSource==="online"&&i.preloadActiveManifest(),J.setHomeVisible(!t.lockedScaleId),Y.setHomeVisible(!t.lockedScaleId),Ke.setSimulationClasses(s),ee.setAdvancedSettings(t),ee.setBackVisible(!t.lockedScaleId),ce("Advanced settings updated",t),ya(),Ie(),C!==t.manifestSource&&(g=null);const O=ks(t.lockedScaleId);O&&(gs(O),O.id!==v&&(N=!1,y.hideMedia(),ee.setView("parameters")),N||(Sn(jn[O.id]),ee.setSimulation(r,Te())))}}function Cl(){const n=document.getElementById("app");if(!n)throw new Error("App mount element not found.");Al(n)}Cl();
//# sourceMappingURL=main-DkpzDRhl.js.map
