...
`);s=e,i=e+1,a=n[i]}return s}const ln=(n,e)=>({indentAtStart:e?n.indent.length:n.indentAtStart,lineWidth:n.options.lineWidth,minContentWidth:n.options.minContentWidth}),cn=n=>/^(%|---|\.\.\.)/m.test(n);function Na(n,e,t){if(!e||e<0)return!1;const s=e-t,i=n.length;if(i<=s)return!1;for(let a=0,r=0;a<i;++a)if(n[a]===`
`){if(a-r>s)return!0;if(r=a+1,i-r<=s)return!1}return!0}function Ot(n,e){const t=JSON.stringify(n);if(e.options.doubleQuotedAsJSON)return t;const{implicitKey:s}=e,i=e.options.doubleQuotedMinMultiLineLength,a=e.indent||(cn(n)?"  ":"");let r="",o=0;for(let l=0,c=t[l];c;c=t[++l])if(c===" "&&t[l+1]==="\\"&&t[l+2]==="n"&&(r+=t.slice(o,l)+"\\ ",l+=1,o=l,c="\\"),c==="\\")switch(t[l+1]){case"u":{r+=t.slice(o,l);const u=t.substr(l+2,4);switch(u){case"0000":r+="\\0";break;case"0007":r+="\\a";break;case"000b":r+="\\v";break;case"001b":r+="\\e";break;case"0085":r+="\\N";break;case"00a0":r+="\\_";break;case"2028":r+="\\L";break;case"2029":r+="\\P";break;default:u.substr(0,2)==="00"?r+="\\x"+u.substr(2):r+=t.substr(l,6)}l+=5,o=l+1}break;case"n":if(s||t[l+2]==='"'||t.length<i)l+=1;else{for(r+=t.slice(o,l)+`

`;t[l+2]==="\\"&&t[l+3]==="n"&&t[l+4]!=='"';)r+=`
`,l+=2;r+=a,t[l+2]===" "&&(r+="\\"),l+=1,o=l+1}break;default:l+=1}return r=o?r+t.slice(o):t,s?r:on(r,a,Qt,ln(e,!1))}function Hn(n,e){if(e.options.singleQuote===!1||e.implicitKey&&n.includes(`
`)||/[ \t]\n|\n[ \t]/.test(n))return Ot(n,e);const t=e.indent||(cn(n)?"  ":""),s="'"+n.replace(/'/g,"''").replace(/\n+/g,`$&
${t}`)+"'";return e.implicitKey?s:on(s,t,Qs,ln(e,!1))}function ft(n,e){const{singleQuote:t}=e.options;let s;if(t===!1)s=Ot;else{const i=n.includes('"'),a=n.includes("'");i&&!a?s=Hn:a&&!i?s=Ot:s=t?Hn:Ot}return s(n,e)}let jn;try{jn=new RegExp(`(^|(?<!
))
+(?!
|$)`,"g")}catch{jn=/\n+(?!\n|$)/g}function Xt({comment:n,type:e,value:t},s,i,a){const{blockQuote:r,commentString:o,lineWidth:l}=s.options;if(!r||/\n[\t ]+$/.test(t))return ft(t,s);const c=s.indent||(s.forceBlockIndent||cn(t)?"  ":""),u=r==="literal"?!0:r==="folded"||e===P.BLOCK_FOLDED?!1:e===P.BLOCK_LITERAL?!0:!Na(t,l,c.length);if(!t)return u?`|
`:`>
...
`+E:T.comment=E,N.comment=N.comment.substring(E.length+1)}}if(!r&&!g&&!N.found){const E=w?n(t,w,N,i):e(t,N.end,g,null,N,i);c.items.push(E),d=E.range[2],Cn(w)&&i(E.range,"BLOCK_IN_FLOW",Nn)}else{t.atKey=!0;const E=N.end,T=k?n(t,k,N,i):e(t,E,L,null,N,i);Cn(k)&&i(T.range,"BLOCK_IN_FLOW",Nn),t.atKey=!1;const R=yt(g??[],{flow:o,indicator:"map-value-ind",next:w,offset:T.range[2],onError:i,parentIndent:s.indent,startOnNewline:!1});if(R.found){if(!r&&!N.found&&t.options.strict){if(g)for(const j of g){if(j===R.found)break;if(j.type==="newline"){i(j,"MULTILINE_IMPLICIT_KEY","Implicit keys of flow sequence pairs need to be on a single line");break}}N.start<R.found.offset-1024&&i(R.found,"KEY_OVER_1024_CHARS","The : indicator must be at most 1024 chars after the start of an implicit flow sequence key")}}else w&&("source"in w&&((y=w.source)==null?void 0:y[0])===":"?i(w,"MISSING_CHAR",`Missing space after : in ${o}`):i(R.start,"MISSING_CHAR",`Missing , or : between ${o} items`));const x=w?n(t,w,R,i):R.found?e(t,R.end,g,null,R,i):null;x?Cn(w)&&i(x.range,"BLOCK_IN_FLOW",Nn):R.comment&&(T.comment?T.comment+=`
`+R.comment:T.comment=R.comment);const F=new ye(T,x);if(t.options.keepSourceTokens&&(F.srcToken=v),r){const j=c;vi(t,j.items,T)&&i(E,"DUPLICATE_KEY","Map keys must be unique"),j.items.push(F)}else{const j=new Ie(t.schema);j.flow=!0,j.items.push(F);const z=(x??T).range;j.range=[T.range[0],z[1],z[2]],c.items.push(j)}d=x?x.range[2]:R.end}}const p=r?"}":"]",[m,...b]=s.end;let h=d;if((m==null?void 0:m.source)===p)h=m.offset+m.source.length;else{const S=o[0].toUpperCase()+o.substring(1),v=u?`${S} must end with a ${p}`:`${S} in block collection must be sufficiently indented and end with a ${p}`;i(d,u?"MISSING_CHAR":"BAD_INDENT",v),m&&m.source.length!==1&&b.unshift(m)}if(b.length>0){const S=Vt(b,h,t.options.strict,i);S.comment&&(c.comment?c.comment+=`
`+S.comment:c.comment=S.comment),c.range=[s.offset,h,S.offset]}else c.range=[s.offset,h,h];return c}function An(n,e,t,s,i,a){const r=t.type==="block-map"?Ja(n,e,t,s,a):t.type==="block-seq"?Qa(n,e,t,s,a):Xa(n,e,t,s,a),o=r.constructor;return i==="!"||i===o.tagName?(r.tag=o.tagName,r):(i&&(r.tag=i),r)}function Za(n,e,t,s,i){var p;const a=s.tag,r=a?e.directives.tagName(a.source,m=>i(a,"TAG_RESOLVE_FAILED",m)):null;if(t.type==="block-seq"){const{anchor:m,newlineAfterProp:b}=s,h=m&&a?m.offset>a.offset?m:a:m??a;h&&(!b||b.offset<h.offset)&&i(h,"MISSING_CHAR","Missing newline after block sequence props")}const o=t.type==="block-map"?"map":t.type==="block-seq"?"seq":t.start.source==="{"?"map":"seq";if(!a||!r||r==="!"||r===Ie.tagName&&o==="map"||r===tt.tagName&&o==="seq")return An(n,e,t,i,r);let l=e.schema.tags.find(m=>m.tag===r&&m.collection===o);if(!l){const m=e.schema.knownTags[r];if((m==null?void 0:m.collection)===o)e.schema.tags.push(Object.assign({},m,{default:!1})),l=m;else return m?i(a,"BAD_COLLECTION_TYPE",`${m.tag} used for ${o} collection, but expects ${m.collection??"scalar"}`,!0):i(a,"TAG_RESOLVE_FAILED",`Unresolved tag: ${r}`,!0),An(n,e,t,i,r)}const c=An(n,e,t,i,r,l),u=((p=l.resolve)==null?void 0:p.call(l,c,m=>i(a,"TAG_RESOLVE_FAILED",m),e.options))??c,d=ee(u)?u:new P(u);return d.range=c.range,d.tag=r,l!=null&&l.format&&(d.format=l.format),d}function er(n,e,t){const s=e.offset,i=tr(e,n.options.strict,t);if(!i)return{value:"",type:null,comment:"",range:[s,s,s]};const a=i.mode===">"?P.BLOCK_FOLDED:P.BLOCK_LITERAL,r=e.source?nr(e.source):[];let o=r.length;for(let h=r.length-1;h>=0;--h){const y=r[h][1];if(y===""||y==="\r")o=h;else break}if(o===0){const h=i.chomp==="+"&&r.length>0?`
...
`;for(let h=u;h<o;++h){let[y,S]=r[h];c+=y.length+S.length+1;const v=S[S.length-1]==="\r";if(v&&(S=S.slice(0,-1)),S&&y.length<l){const k=`Block scalar lines must not be less indented than their ${i.indent?"explicit indentation indicator":"first line"}`;t(c-S.length-(v?2:1),"BAD_INDENT",k),y=""}a===P.BLOCK_LITERAL?(d+=p+y.slice(l)+S,p=`
`):y.length>l||S[0]==="	"?(p===" "?p=`
`:!m&&p===`
`&&(p=`
...
`,r:"\r",t:"	",v:"\v",N:"",_:" ",L:"\u2028",P:"\u2029"," ":" ",'"':'"',"/":"/","\\":"\\","	":"	"};function cr(n,e,t,s){const i=n.substr(e,t),r=i.length===t&&/^[0-9a-fA-F]+$/.test(i)?parseInt(i,16):NaN;if(isNaN(r)){const o=n.substr(e-2,t+2);return s(e-2,"BAD_DQ_ESCAPE",`Invalid escape sequence ${o}`),o}return String.fromCodePoint(r)}function _i(n,e,t,s){const{value:i,type:a,comment:r,range:o}=e.type==="block-scalar"?er(n,e,s):sr(e,n.options.strict,s),l=t?n.directives.tagName(t.source,d=>s(t,"TAG_RESOLVE_FAILED",d)):null;let c;n.options.stringKeys&&n.atKey?c=n.schema[Ue]:l?c=ur(n.schema,i,l,t,s):e.type==="scalar"?c=dr(n,i,e,s):c=n.schema[Ue];let u;try{const d=c.resolve(i,p=>s(t??e,"TAG_RESOLVE_FAILED",p),n.options);u=G(d)?d:new P(d)}catch(d){const p=d instanceof Error?d.message:String(d);s(t??e,"TAG_RESOLVE_FAILED",p),u=new P(i)}return u.range=o,u.source=i,a&&(u.type=a),l&&(u.tag=l),c.format&&(u.format=c.format),r&&(u.comment=r),u}function ur(n,e,t,s,i){var o;if(t==="!")return n[Ue];const a=[];for(const l of n.tags)if(!l.collection&&l.tag===t)if(l.default&&l.test)a.push(l);else return l;for(const l of a)if((o=l.test)!=null&&o.test(e))return l;const r=n.knownTags[t];return r&&!r.collection?(n.tags.push(Object.assign({},r,{default:!1,test:void 0})),r):(i(s,"TAG_RESOLVE_FAILED",`Unresolved tag: ${t}`,t!=="tag:yaml.org,2002:str"),n[Ue])}function dr({atKey:n,directives:e,schema:t},s,i,a){const r=t.tags.find(o=>{var l;return(o.default===!0||n&&o.default==="key")&&((l=o.test)==null?void 0:l.test(s))})||t[Ue];if(t.compat){const o=t.compat.find(l=>{var c;return l.default&&((c=l.test)==null?void 0:c.test(s))})??t[Ue];if(r.tag!==o.tag){const l=e.tagString(r.tag),c=e.tagString(o.tag),u=`Value may be parsed as either ${l} or ${c}`;a(i,"TAG_RESOLVE_FAILED",u,!0)}}return r}function fr(n,e,t){if(e){t??(t=e.length);for(let s=t-1;s>=0;--s){let i=e[s];switch(i.type){case"space":case"comment":case"newline":n-=i.source.length;continue}for(i=e[++s];(i==null?void 0:i.type)==="space";)n+=i.source.length,i=e[++s];break}}return n}const hr={composeNode:Si,composeEmptyNode:cs};function Si(n,e,t,s){const i=n.atKey,{spaceBefore:a,comment:r,anchor:o,tag:l}=t;let c,u=!0;switch(e.type){case"alias":c=mr(n,e,s),(o||l)&&s(e,"ALIAS_PROPS","An alias node must not specify any properties");break;case"scalar":case"single-quoted-scalar":case"double-quoted-scalar":case"block-scalar":c=_i(n,e,l,s),o&&(c.anchor=o.source.substring(1));break;case"block-map":case"block-seq":case"flow-collection":try{c=Za(hr,n,e,t,s),o&&(c.anchor=o.source.substring(1))}catch(d){const p=d instanceof Error?d.message:String(d);s(e,"RESOURCE_EXHAUSTION",p)}break;default:{const d=e.type==="error"?e.message:`Unsupported token (type: ${e.type})`;s(e,"UNEXPECTED_TOKEN",d),u=!1}}return c??(c=cs(n,e.offset,void 0,null,t,s)),o&&c.anchor===""&&s(o,"BAD_ALIAS","Anchor cannot be an empty string"),i&&n.options.stringKeys&&(!G(c)||typeof c.value!="string"||c.tag&&c.tag!=="tag:yaml.org,2002:str")&&s(l??e,"NON_STRING_KEY","With stringKeys, all keys must be strings"),a&&(c.spaceBefore=!0),r&&(e.type==="scalar"&&e.source===""?c.comment=r:c.commentBefore=r),n.options.keepSourceTokens&&u&&(c.srcToken=e),c}function cs(n,e,t,s,{spaceBefore:i,comment:a,anchor:r,tag:o,end:l},c){const u={type:"scalar",offset:fr(e,t,s),indent:-1,source:""},d=_i(n,u,o,c);return r&&(d.anchor=r.source.substring(1),d.anchor===""&&c(r,"BAD_ALIAS","Anchor cannot be an empty string")),i&&(d.spaceBefore=!0),a&&(d.comment=a,d.range[2]=l),d}function mr({options:n},{offset:e,source:t,end:s},i){const a=new Qn(t.substring(1));a.source===""&&i(e,"BAD_ALIAS","Alias cannot be an empty string"),a.source.endsWith(":")&&i(e+t.length-1,"BAD_ALIAS","Alias ending in : is ambiguous",!0);const r=e+t.length,o=Vt(s,r,n.strict,i);return a.range=[e,r,o.offset],o.comment&&(a.comment=o.comment),a}function pr(n,e,{offset:t,start:s,value:i,end:a},r){const o=Object.assign({_directives:e},n),l=new pn(void 0,o),c={atKey:!1,atRoot:!0,directives:l.directives,options:l.options,schema:l.schema},u=yt(s,{indicator:"doc-start",next:i??(a==null?void 0:a[0]),offset:t,onError:r,parentIndent:0,startOnNewline:!0});u.found&&(l.directives.docStart=!0,i&&(i.type==="block-map"||i.type==="block-seq")&&!u.hasNewline&&r(u.end,"MISSING_CHAR","Block collection cannot start on same line with directives-end marker")),l.contents=i?Si(c,i,u,r):cs(c,u.end,s,null,u,r);const d=l.contents.range[2],p=Vt(a,d,!1,r);return p.comment&&(l.comment=p.comment),l.range=[t,d,p.offset],l}function Nt(n){if(typeof n=="number")return[n,n+1];if(Array.isArray(n))return n.length===2?n:[n[0],n[1]];const{offset:e,source:t}=n;return[e,e+(typeof t=="string"?t.length:1)]}function Ns(n){var i;let e="",t=!1,s=!1;for(let a=0;a<n.length;++a){const r=n[a];switch(r[0]){case"#":e+=(e===""?"":s?`

`:`
`)+(r.substring(1)||" "),t=!0,s=!1;break;case"%":((i=n[a+1])==null?void 0:i[0])!=="#"&&(a+=1),t=!1;break;default:t||(s=!0),t=!1}}return{comment:e,afterEmptyLine:s}}class gr{constructor(e={}){this.doc=null,this.atDirectives=!1,this.prelude=[],this.errors=[],this.warnings=[],this.onError=(t,s,i,a)=>{const r=Nt(t);a?this.warnings.push(new za(r,s,i)):this.errors.push(new Tt(r,s,i))},this.directives=new ge({version:e.version||"1.2"}),this.options=e}decorate(e,t){const{comment:s,afterEmptyLine:i}=Ns(this.prelude);if(s){const a=e.contents;if(t)e.comment=e.comment?`${e.comment}
...
`:case"\r":case"	":return!0;default:return!1}}const Cs=new Set("0123456789ABCDEFabcdef"),br=new Set("0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-#;/?:@&=+$_.!~*'()"),Wt=new Set(",[]{}"),vr=new Set(` ,[]{}
\r	`),In=n=>!n||vr.has(n);class wr{constructor(){this.atEnd=!1,this.blockScalarIndent=-1,this.blockScalarKeep=!1,this.buffer="",this.flowKey=!1,this.flowLevel=0,this.indentNext=0,this.indentValue=0,this.lineEndPos=null,this.next=null,this.pos=0}*lex(e,t=!1){if(e){if(typeof e!="string")throw TypeError("source is not a string");this.buffer=this.buffer?this.buffer+e:e,this.lineEndPos=null}this.atEnd=!t;let s=this.next??"stream";for(;s&&(t||this.hasChars(1));)s=yield*this.parseNext(s)}atLineEnd(){let e=this.pos,t=this.buffer[e];for(;t===" "||t==="	";)t=this.buffer[++e];return!t||t==="#"||t===`
...
`,Nr=`# Parameter definitions for each simulation family.
#
...
`;function ne(n){if(/^[a-z]+:\/\//i.test(n)||n.startsWith("data:")||n.startsWith("blob:"))return n;const e="/engine/",t=e.endsWith("/")?e:`${e}/`,s=n.startsWith("/")?n.slice(1):n;return`${t}${s}`}const Ir=qe(Lr),Tr=qe(Nr),Tn=qe(Cr),Mr=qe(Ar),lt=Object.entries(Ir).map(([n,e])=>{var r,o,l;const t=Or(Tn[n]),s=(((r=Tn[n])==null?void 0:r.results)??[]).map(Pr),i=((o=Mr[n])==null?void 0:o.liveStats)??[],a=Tr[n]??{};return{id:n,label:e.label,placeholderImage:ne(e.placeholderImage),parameterSubtitle:e.parameterSubtitle,metadata:{results:s,summaryStats:t.map(Wn),liveStats:i.map(Wn),morphologyChecklist:(l=Tn[n])==null?void 0:l.morphologyChecklist},parameters:Object.entries(a).map(([c,u])=>{const d=u.quali_labels,p=d!==void 0&&d.length>0,m=p?0:u.min,b=p?d.length-1:u.max,h=p?1:u.step??xr(u.min,u.max),y=p?Math.floor(d.length/2):u.log_scale?Math.sqrt(u.min*u.max):$r(u.min,u.max);return{id:c,label:u.label,unit:u.unit??"",min:m,max:b,step:h,fallbackValue:y,description:u.description,valueScale:u.value_scale,displayUnit:u.display_unit,displayFormat:u.display_format,displaySignificantFigures:u.display_significant_figures,logScale:u.log_scale,qualiLabels:d}}),views:(e.views??[]).map(c=>({id:c.id,label:c.label,icon:c.icon,audio:c.audio??!1,description:c.description}))}});function Or(n){if(!n)return[];const e=[];for(const t of n.resources??[])e.push({...t,section:"resources"});for(const t of n.simulationStats??[])e.push({...t,section:"simulationStats"});return n.similarityScore&&e.push({id:"similarityScore",value:n.similarityScore.value}),e}function Wn(n){return{id:n.id,label:n.label,section:n.section,value:n.value,unit:n.unit,description:n.description,live:n.live??!1,liveKey:n.live_key,fromVideo:n.from_video??!1,videoKey:n.video_key,scaleWithTime:n.scale_with_time??!1,integer:n.integer??!1,valueScale:n.value_scale,displayFormat:n.display_format,precision:n.precision}}function Pr(n){return{...Wn(n),target:n.target}}function xr(n,e){const s=Math.max(e-n,1e-9)/100,i=10**Math.floor(Math.log10(s)),a=s/i;let r=1;return a<=1?r=1:a<=2?r=2:a<=5?r=5:r=10,r*i}function $r(n,e){return n+(e-n)/2}const Ci="universe-engine-theme",Ai=[{id:"glass",label:"Glass",icon:"[ ]"},{id:"matrix",label:"Matrix",icon:"[#]"},{id:"hal",label:"HAL 9000",icon:"( )"},{id:"nostromo",label:"Nostromo",icon:"[=]"},{id:"tron",label:"Tron",icon:"<>"}];function Rr(){const n=localStorage.getItem(Ci);return Br(n)?n:"glass"}function Mn(n){document.documentElement.setAttribute("data-theme",n),localStorage.setItem(Ci,n)}function Fr(n,e,t){const s=document.createElement("div");s.className="theme-picker";const i=new Map;for(const r of Ai){const o=document.createElement("button");o.className="theme-picker__option",o.type="button",o.innerHTML=`
    ...
    </svg>`}function Wr(n,e){const t=Math.min(Ti(e),2);return n.toFixed(t)}function Re(n,e){return e?`${n} ${e}`:n}function $t(n){const e=Math.abs(n),t=n<0?"−":"";return Number.isFinite(n)?e<1e3?Ct(n):e<1e6?`${t}${Ct(n/1e3)}K`:e<1e9?`${t}${Ct(n/1e6)}M`:e<1e12?`${t}${Ct(n/1e9)}B`:`${t}${Ct(n/1e12)}T`:String(n)}function Ct(n){return n.toFixed(1).replace(new RegExp("\\.0+$|(?<=\\..*?)0+$","g"),"").replace(/\.$/,"")}function Yr(n,e={}){const t=n.trim();if(t.length===0)return n;const s=Number(t);if(!Number.isFinite(s))return n;const i=s*(e.scale??1);return e.integer?Math.max(0,Math.round(i)).toLocaleString(void 0):i.toFixed(2).replace(new RegExp("\\.0+$|(?<=\\..*?)0+$","g"),"").replace(/\.$/,"")}function nn(n,e={}){const t=n.trim();if(t.length===0)return n;const s=Number(t);if(!Number.isFinite(s))return n;const i=e.mode??"float",a=s*(e.scale??1);if(i==="integer")return Math.round(a).toLocaleString(void 0);if(i==="scientific"||i==="compact")return $t(a);const r=Math.max(0,e.precision??2);return a.toFixed(r).replace(new RegExp("\\.0+$|(?<=\\..*?)0+$","g"),"").replace(/\.$/,"")}function ht(n,e,t={}){const s=t.scale??1,i=n*s,a=e*s;return t.format==="qualitative"?String(Math.round(n)):t.format==="compact"||t.format==="scientific"?$t(i):Wr(i,a)}function Ti(n){const e=String(n),t=e.indexOf(".");return t===-1?0:e.length-t-1}function Gr(n){const e=document.createElement("aside");e.className="data-panel";const t=document.createElement("div");return t.className="data-panel__metrics",e.appendChild(t),n.appendChild(e),{update(s,i,a={}){t.innerHTML="";const r=zr(s,i,a);for(const o of s.metadata.liveStats){const l=Qr(o,r),c=document.createElement("div");c.className="data-panel__metric",c.innerHTML=`
          <span class="data-panel__metric-label">${l.label}</span>
          <span class="data-panel__metric-value">${l.value}</span>
        `,t.appendChild(c)}}}}function zr(n,e,t){const s=Object.fromEntries(n.parameters.map(a=>[a.id,{label:a.label,value:a.displayFormat==="qualitative"&&a.qualiLabels?a.qualiLabels[Math.round(e[a.id]??a.fallbackValue)]??"--":ht(e[a.id]??a.fallbackValue,a.step,{scale:a.valueScale,format:a.displayFormat,significantFigures:a.displaySignificantFigures})}])),i={scale:{label:"Scale",value:n.label},parameters:{label:"Parameters",value:String(n.parameters.length)}};return{...s,...i,...Object.fromEntries(Object.entries(t).map(([a,r])=>[a,{label:Jr(a),value:r}]))}}function Jr(n){return n.replace(/_/g," ").replace(/([a-z0-9])([A-Z])/g,"$1 $2")}function Qr(n,e){const t=e[n.id]??{label:n.id,value:"--"},s=n.liveKey??n.id,i=e[s],a=Xr((i==null?void 0:i.value)??t.value??"--",n,!!i);return{label:n.label??(i==null?void 0:i.label)??t.label,value:Re(a,n.unit)}}function Xr(n,e,t){if(n==="--")return n;const s=Number(n);if(!Number.isFinite(s))return n;const i=e.valueScale??1,a=s*i;return t?e.integer?$t(Math.round(a)):$t(a):e.integer?Math.max(0,Math.round(a)).toLocaleString(void 0):Yr(n,{integer:e.integer})}function Zr(){const n=ne("assets/2-McAlpine.webp"),e=document.createElement("div"),t=document.createElement("button");t.className="view-switcher__info entry-overlay__info-button",t.type="button",t.setAttribute("aria-label","About this experience"),t.appendChild(to()),e.className="sci-modal is-hidden",e.innerHTML=`
  ...
  `;const o=document.createElement("div");o.className="entry-overlay__actions";function l(p){o.innerHTML="";for(const m of p){const b=document.createElement("button");b.className="entry-overlay__button",b.type="button";const h=no[m.id]??"Explore this simulation scale.";b.innerHTML=`
        <span class="entry-overlay__button-label">${m.label}</span>
        <span class="entry-overlay__button-description">${h}</span>
      `,b.addEventListener("click",()=>t(m)),o.appendChild(b)}}l(e);const{infoButton:c,infoModal:u,close:d}=Zr();return r.appendChild(o),a.appendChild(r),a.appendChild(c),a.appendChild(u),n.appendChild(a),{show(){a.hidden=!1,a.classList.remove("is-hidden")},hide(){d(),a.hidden=!0,a.classList.add("is-hidden")},setSimulationClasses(p){l(p)}}}function io(n,e,t,s){const i=Object.fromEntries(n.metadata.results.map(k=>[k.id,k.target])),a=n.metadata.results.map(k=>{const g=xn(n,e,s,k.id);return g===null?null:{id:k.id,value:g,target:k.target}}).filter(k=>k!==null),r=n.parameters.filter(k=>i[k.id]!==void 0).map(k=>{const g=e[k.id]??k.fallbackValue,w=i[k.id]??k.fallbackValue;return Math.abs(g-w)/Math.max(k.max-k.min,1e-9)}),o=r.reduce((k,g)=>k+g,0)/Math.max(r.length,1),l=oo(a),c=((s==null?void 0:s.carbonBurnt)??.8+o*4.2).toFixed(2),u=(s==null?void 0:s.computeUsed)??18+o*46,d=(s==null?void 0:s.memoryUsed)??12+o*84,p=`${Pn(u,1)} CPU-hrs
${Pn(d,1)} GB`,m=String(n.parameters.length),b=`${(o*100).toFixed(1)}%`,h=String(n.parameters.length+6),y="Present",S=ro((s==null?void 0:s.wallclockSeconds)??t),v=xs($s(xn(n,e,s,"moon_iron"))),L=xs($s(xn(n,e,s,"proto_earth_in_moon")));return{scale:{label:"Scale",value:n.label},parameters:{label:"Parameters",value:m},runtime:{label:"Total Runtime",value:S},similarityScore:{label:"Similarity Score",value:`${l}/100`},bestFitDelta:{label:"Best-Fit Delta",value:b},carbonBurnt:{label:"Carbon Burnt",value:c},computeUsed:{label:"Compute Used",value:p},memoryUsed:{label:"Memory Used",value:Pn(d,1)},particlesUpdated:{label:"Particle updates",value:s?ao(s.particlesUpdated):"--"},moon_iron_percent:{label:"Iron in Moon",value:v},proto_earth_in_moon_percent:{label:"Proto-Earth in Moon",value:L},audioTrack:{label:"Audio Track",value:y},terminalLines:{label:"Terminal Lines",value:h},...Object.fromEntries(Object.entries((s==null?void 0:s.summaryMetrics)??{}).map(([k,g])=>[k,{label:g.label,value:g.value}]))}}function ao(n){return String(Math.max(0,n))}function ro(n){return(Math.max(0,n)/3600).toFixed(2).replace(new RegExp("\\.0+$|(?<=\\..*?)0+$","g"),"").replace(/\.$/,"")}function Pn(n,e){return n.toFixed(e).replace(new RegExp("\\.0+$|(?<=\\..*?)0+$","g"),"").replace(/\.$/,"")}function xn(n,e,t,s){var o;const i=n.parameters.find(l=>l.id===s);if(i)return e[s]??i.fallbackValue;const a=(o=t==null?void 0:t.summaryMetrics[s])==null?void 0:o.value;if(a!==void 0){const l=Number(a);if(Number.isFinite(l))return l}const r=t==null?void 0:t.parameterValues[s];return typeof r=="number"&&Number.isFinite(r)?r:null}function xs(n){return n===null?"--":n.toFixed(1)}function $s(n){return n===null?null:Math.max(0,(1-Math.abs(n-1))*100)}function oo(n){if(n.length===0)return 0;const e=n.reduce((t,s)=>t+Math.max(0,1-Math.abs(s.value/Math.max(s.target,1e-9)-1)),0);return Math.round(e/n.length*100)}const Yn={TYPING_MS_PER_CHAR:3.5,MIN_TERMINAL_TIME_MS:3e3,FINAL_PAUSE_MS:500},lo={HIDE_AFTER_MS:980},Mi="https://media.universemakers.org/engine/run-manifest.json",$n="https://pub-e00201311979473b8a30e279dcc56838.r2.dev/engine/run-manifest.json",co="https://universe-engine.universe-engine.workers.dev/api/track-run",uo=`# Target messages for scientific bar detail popups, shown when a bar is tapped.
...
`,Rs=(()=>{const n=qe(uo),e={};for(const t of Object.values(n))for(const[s,i]of Object.entries(t))e[s]=i;return e})(),sn="#4CD98A",Gn="#E8951C",Oi="#D7372A",Pi=.2,xi=.5,Fs=2;function $i(n){const e=Math.abs(n-1);return e<=Pi?{word:"On target",colour:sn}:e<=xi?{word:n>1?"Too high":"Too low",colour:Gn}:{word:n>1?"Way too high":"Way too low",colour:Oi}}function fo(n){const e=Math.abs(n-1),t=n>=1;return e<=Pi?t?"greenHigh":"greenLow":e<=xi?t?"amberHigh":"amberLow":t?"redHigh":"redLow"}function ho(n){return Math.min(Math.max(n,0),Fs)/Fs*100}function mo(n){return n>=85?{word:"Almost perfect",colour:sn}:n>=65?{word:"Really close",colour:sn}:n>=45?{word:"Getting there",colour:Gn}:n>=25?{word:"Not quite",colour:Gn}:{word:"Way off - try again",colour:Oi}}function po(n,e,t){var r,o;const s=fo(t),i=((r=Rs[n])==null?void 0:r[s])??((o=Rs[e])==null?void 0:o[s]);return i||($i(t).colour===sn?`${e} is very close to the target value for this simulation.`:t<1?`${e} is below the target value for this simulation.`:`${e} is above the target value for this simulation.`)}function go(n,e,t){return n.metadata.results.map(s=>{const i=yo(s,n,e,t);if(i===null)return null;const a=i/Math.max(s.target,1e-9),r=bo(s,n,t),o=po(s.id,r,a),l=Re(Ri(String(i),s),s.unit);return{id:s.id,label:r,value:a,rawValue:i,formattedValue:l,detail:o}}).filter(s=>s!==null)}function yo(n,e,t,s){var l;const i=n.id,a=e.parameters.find(c=>c.id===i);if(a)return t[i]??a.fallbackValue;const r=vo((l=s==null?void 0:s.summaryMetrics[i])==null?void 0:l.value);if(r!==null)return r;const o=s==null?void 0:s.parameterValues[i];return typeof o=="number"&&Number.isFinite(o)?o:null}function bo(n,e,t){var i,a;const s=n.id;return n.label??((i=e.parameters.find(r=>r.id===s))==null?void 0:i.label)??((a=t==null?void 0:t.summaryMetrics[s])==null?void 0:a.label)??s}function vo(n){if(n===void 0)return null;const e=Number(n);return Number.isFinite(e)?e:null}function wo(n){if(n.length===0)return 0;const e=n.reduce((t,s)=>t+Math.max(0,1-Math.abs(s.value-1)),0);return Math.round(e/n.length*100)}function _o(n,e){const t=document.createElement("section");t.className="overlay overlay--summary",t.hidden=!0,t.classList.add("is-hidden");let s;const i=document.createElement("div");i.className="summary-overlay";const a=document.createElement("div"),r=document.createElement("div");a.className="summary-overlay__header",r.className="summary-overlay__content";const o=document.createElement("p");o.className="summary-overlay__title",o.textContent="Run Summary";const l=document.createElement("p");l.className="summary-overlay__hint",l.textContent="Select any card for more details",a.appendChild(o),a.appendChild(l);const c=document.createElement("div");c.className="summary-overlay__actions";const u=document.createElement("button");u.className="summary-overlay__button",u.type="button",u.textContent="Continue Visualising";const d=document.createElement("button"),p=document.createElement("button");d.className="summary-overlay__button summary-overlay__button--primary",d.type="button",d.textContent="New Parameters",p.className="summary-overlay__button",p.type="button",p.textContent="Home",p.hidden=!e.showHome,u.addEventListener("click",e.onReplay),d.addEventListener("click",e.onParameters),p.addEventListener("click",e.onHome),c.appendChild(d),c.appendChild(u),c.appendChild(p),i.appendChild(a),i.appendChild(r),i.appendChild(c),t.appendChild(i);const m=document.createElement("div");m.className="sci-modal is-hidden",m.innerHTML=`
  ...
  `,t.appendChild(m),n.appendChild(t);const b=m.querySelector(".sci-modal__title"),h=m.querySelector(".sci-modal__verdict"),y=m.querySelector(".sci-modal__body"),S=m.querySelector(".sci-modal__close"),v=new Set;let L=!1;function k(E){const T=$i(E.value);b.textContent=E.label,h.textContent=T.word,h.style.color=T.colour,h.hidden=!1,y.textContent=E.detail,m.classList.remove("is-hidden")}function g(E,T){b.textContent=E,h.hidden=!0,y.textContent=T,m.classList.remove("is-hidden")}function w(){m.classList.add("is-hidden")}S.addEventListener("click",w),m.addEventListener("click",E=>{E.target===m&&w()}),t.addEventListener("click",E=>{E.target===t&&e.onReplay()});function N(E,T){const R=document.createElement("div");R.className=`${E.className} panel`,R.innerHTML=`<p class="sci-section__title">${E.title}</p>`;const x=document.createElement("div"),F=E.singleRow?Math.max(1,E.stats.length):Math.max(1,Math.min(E.stats.length,E.maxColumns));x.className="metric-grid",E.singleRow&&x.classList.add("metric-grid--single-row"),x.style.setProperty("--summary-grid-columns",String(F)),x.style.setProperty("--summary-grid-max-width",`${E.maxWidthRem}rem`);for(const j of E.stats){const z=So(j,T),Y=document.createElement("div"),K=document.createElement("span"),X=document.createElement("span");Y.className="res-card",K.className="res-card__label",K.textContent=z.label,X.className="res-card__value",X.textContent=z.value,Y.appendChild(K),Y.appendChild(X),j.description&&(Y.classList.add("res-card--has-info"),Y.addEventListener("click",()=>{g(z.label,j.description)})),x.appendChild(Y)}return R.appendChild(x),R}return{show(){s&&(window.clearTimeout(s),s=void 0),t.hidden=!1,t.classList.remove("is-hidden"),t.classList.remove("is-visible"),t.offsetWidth,requestAnimationFrame(()=>{t.classList.add("is-visible")})},hide(){t.classList.remove("is-visible"),s=window.setTimeout(()=>{t.hidden=!0,t.classList.add("is-hidden"),s=void 0,L&&(v.clear(),L=!1)},lo.HIDE_AFTER_MS)},setHomeVisible(E){p.hidden=!E},update(E,T,R,x,F){var C,M,U,V,B,ue;r.innerHTML="",w();const j=io(E,T,R,x),z=E.metadata.summaryStats,Y=go(E,T,x),K=new Set(Y.map(D=>D.id));let X;if(Y.length>0)X=wo(Y);else{const D=((C=j.similarityScore)==null?void 0:C.value)??"0/100";X=parseInt(D,10)||0}const be=mo(X),Se=document.createElement("div"),ce=document.createElement("div"),se=document.createElement("div");Se.className="sci-top",ce.className="summary-main-column",se.className="summary-side-column";const ve=document.createElement("div");ve.className="sci-hero panel",F?(ve.classList.add("sci-hero--thumbnail"),ve.innerHTML=`<img class="sci-hero__thumbnail" src="${F}" alt="Final frame of simulation" />`):ve.innerHTML=`
        ...
        `,ce.appendChild(ve);const fe=z.filter(D=>(D.section??"resources")==="resources"&&!Y.some(ae=>ae.id===String(D.id))&&D.id!=="similarityScore"),ke=z.filter(D=>D.section==="simulationStats"&&!K.has(String(D.id)));fe.length>0&&se.appendChild(N({title:"Resources Used",className:"res-section",stats:fe,maxColumns:3,maxWidthRem:48},j)),ke.length>0&&se.appendChild(N({title:"Simulation Stats",className:"res-section",stats:ke,maxColumns:ke.length,maxWidthRem:48,singleRow:!0},j)),Se.appendChild(ce),se.childElementCount>0&&Se.appendChild(se),r.appendChild(Se);const J=E.metadata.morphologyChecklist;if(J&&J.length>0){const D=((U=(M=x==null?void 0:x.summaryMetrics)==null?void 0:M.morphology)==null?void 0:U.value)??null,ae=(D==null?void 0:D.toLowerCase())??null,re=new Set(J.map($=>$.id));ae&&re.has(ae)&&v.add(ae);const H=document.createElement("div");H.className="sci-bottom-row";const Ee=document.createElement("div");Ee.style.cssText="display:flex; flex-direction:column; gap:1.25rem;",Ee.appendChild(Bs(E,T,g));const Le=((V=J.find($=>$.id===ae))==null?void 0:V.label)??D;if(Le){const $=document.createElement("div");$.className="sci-section panel param-section";const ie=document.createElement("p");ie.className="sci-section__title",ie.textContent="Galaxy Morphology";const A=document.createElement("div");A.className="res-card res-card--has-info";const q=document.createElement("span");q.className="res-card__value",q.textContent=Le,A.appendChild(q),A.addEventListener("click",()=>{var Q;return g("Galaxy Morphology",((Q=J.find(W=>W.id===(D??"").toLowerCase()))==null?void 0:Q.description)??`This galaxy is classified as "${Le}".`)}),$.appendChild(ie),$.appendChild(A),Ee.appendChild($)}H.appendChild(Ee);const we=document.createElement("div");we.style.cssText="flex:1; display:flex; flex-direction:column; gap:1.25rem; min-width:0; min-height:0;";const me=((ue=(B=x==null?void 0:x.summaryMetrics)==null?void 0:B.description)==null?void 0:ue.value)??null;if(me){const $=document.createElement("div");$.className="sci-section panel",$.style.cssText="flex:0 1 auto; min-height:0; overflow-y:auto;";const ie=document.createElement("p");ie.className="sci-section__title",ie.textContent="About This Galaxy";const A=document.createElement("p");A.className="galaxy-summary__desc-text",A.textContent=me,$.appendChild(ie),$.appendChild(A),we.appendChild($)}const he=document.createElement("div");he.className="sci-section panel",he.style.cssText="flex:1; min-height:0;";const We=document.createElement("p");We.className="sci-section__title",We.textContent="Morphology Scavenger Hunt";const Oe=document.createElement("div");Oe.className="galaxy-summary__checklist",Oe.style.cssText="flex:1; align-items:center;";const Ce=J.every($=>v.has($.id));for(const $ of J){const ie=document.createElement("div");ie.className="galaxy-summary__check",v.has($.id)&&ie.classList.add("is-found"),ie.innerHTML=`
            <span class="galaxy-summary__check-box">
              ${v.has($.id)?"✓":""}
            </span>
            <span class="galaxy-summary__check-label">${$.label}</span>
          `,Oe.appendChild(ie)}if(he.appendChild(We),he.appendChild(Oe),Ce){L=!0;const $=document.createElement("div");$.className="galaxy-summary__done",$.textContent="★ Well done! You've discovered all the galaxy types! ★",he.appendChild($)}we.appendChild(he),H.appendChild(we),r.appendChild(H)}else if(Y.length>0){const D=document.createElement("div");D.className="sci-bottom-row",D.appendChild(Bs(E,T,g));const ae=document.createElement("div"),re=document.createElement("div"),H=document.createElement("p"),Ee=document.createElement("p");ae.className="sci-section panel",re.className="sci-section__header",H.className="sci-section__title",H.textContent="Similarity Results",Ee.className="sci-section__hint",Ee.textContent="Select any bar for details",re.appendChild(H),re.appendChild(Ee);const Le=document.createElement("div");Le.className="sci-bars";for(const we of Y){const me=document.createElement("div");me.className="sci-bar",me.innerHTML=`
            <div class="sci-bar__name">${we.label}</div>
            <div class="sci-track">
              <div class="sci-pointer" style="left:${ho(we.value)}%">
                <div class="sci-pointer__needle"></div>
                <div class="sci-pointer__node"></div>
              </div>
            </div>
            <div class="sci-bar__value">${we.formattedValue}</div>
          `,me.addEventListener("click",()=>k(we)),Le.appendChild(me)}ae.appendChild(re),ae.appendChild(Le),D.appendChild(ae),r.appendChild(D)}}}}function So(n,e){const t=e[n.id]??{label:n.id,value:"--"},s=t.value!=="--"?t.value:"--",i=ko(s,n);if(i)return{label:n.label??t.label,value:i};const a=Ri(s,n);return{label:n.label??t.label,value:Re(a,n.unit)}}function Bs(n,e,t){const s=document.createElement("div");s.className="sci-section panel param-section",s.innerHTML='<p class="sci-section__title">Input Parameters</p>';const i=document.createElement("div");i.className="param-cards";for(const a of n.parameters){const r=e[a.id]??a.fallbackValue,o=a.displayUnit??a.unit,l=document.createElement("div"),c=document.createElement("span"),u=document.createElement("span");l.className="res-card",a.description&&t&&(l.classList.add("res-card--has-info"),l.addEventListener("click",()=>t(a.label,a.description))),c.className="res-card__label",c.textContent=a.label,u.className="res-card__value";const d=a.displayFormat==="qualitative"&&a.qualiLabels?a.qualiLabels[Math.round(r)]??"--":ht(r,a.step,{scale:a.valueScale,format:a.displayFormat,significantFigures:a.displaySignificantFigures});u.textContent=Re(d,o),l.appendChild(c),l.appendChild(u),i.appendChild(l)}return s.appendChild(i),s}function ko(n,e){if(e.id!=="carbonBurnt"||n==="--")return null;const t=Number(n);return Number.isFinite(t)?Math.abs(t)<1?Re(nn(n,{scale:(e.valueScale??1)*1e3,mode:"float",precision:1}),"g CO2"):Re(nn(n,{scale:e.valueScale,mode:"float",precision:e.precision??2}),e.unit):Re(n,e.unit)}function Ri(n,e){if(n==="--")return n;if(e.displayFormat==="scientific"||e.displayFormat==="compact"||e.displayFormat==="float")return nn(n,{scale:e.valueScale,mode:e.displayFormat,precision:e.precision});if(e.displayFormat==="integer")return nn(n,{scale:e.valueScale,mode:"integer"});const t=Number(n);if(!Number.isFinite(t))return n;const s=e.valueScale??1,i=t*s;return $t(i)}function Eo(n,e){const t=document.createElement("div");return t.className="view-switcher is-hidden",n.appendChild(t),{update(s,i){if(t.innerHTML="",s.length<=1){t.classList.add("is-hidden");return}t.classList.remove("is-hidden");for(const a of s){const r=document.createElement("div");r.className="view-switcher__row";const o=document.createElement("button");o.className="view-switcher__button",o.type="button",o.dataset.viewId=a.id,o.classList.toggle("is-active",a.id===i),o.setAttribute("aria-pressed",String(a.id===i)),o.setAttribute("aria-label",a.label??a.id);const l=Lo(a.icon);if(l){const u=document.createElement("span");u.className="view-switcher__icon",u.setAttribute("aria-hidden","true"),u.appendChild(l),o.appendChild(u)}const c=document.createElement("span");if(c.className="view-switcher__label",c.textContent=a.label??a.id,o.appendChild(c),o.addEventListener("click",()=>e.onSelect(a.id)),r.appendChild(o),a.description){const u=document.createElement("button");u.className="view-switcher__info",u.type="button",u.setAttribute("aria-label",`Info about ${a.label??a.id}`),u.appendChild(No()),u.addEventListener("click",d=>{d.stopPropagation(),e.onInfo(a.id,a.label??a.id,a.description??"")}),r.appendChild(u)}t.appendChild(r)}},hide(){t.innerHTML="",t.classList.add("is-hidden")}}}function Lo(n){switch(n){case"dark-matter":return De(`
...
`;function Ao(){const n=qe(Co);if(!Array.isArray(n))return[];const e=[];for(const t of n){if(!t||typeof t!="object")continue;const s=t.text;if(typeof s!="string"||s.trim().length===0)continue;const i={text:s},a=t.url;typeof a=="string"&&a.trim().length>0&&(i.url=a);const r=t.logo;typeof r=="string"&&r.trim().length>0&&(i.logo=r),t.header===!0&&(i.header=!0),e.push(i)}return e}function Io(n,e,t,s){const i=document.createElement("div");i.className="parameter-editor",n.appendChild(i);let a=e,r={...t};function o(u,d){a=u,r=d?{...d}:To(u),i.innerHTML="";const p=document.createElement("div");p.className="parameter-editor__heading",p.innerHTML=`
 ...
 Engine</h1>
  ...
  `;const ue=B.querySelector("[data-credits]"),D=Ao();if(ue.innerHTML="",D.length===0){const A=document.createElement("div");A.className="credits-list__entry",A.textContent="To be credited...",ue.appendChild(A)}else for(const A of D)if(A.header){const q=document.createElement("div");q.className="credits-list__heading",q.textContent=A.text,ue.appendChild(q)}else{const q=document.createElement("div");q.className="credits-list__entry";const Q=document.createElement("span");if(Q.className="credits-list__text",A.url){const W=document.createElement("a");W.className="credits-list__link",W.href=A.url,W.target="_blank",W.rel="noopener noreferrer",W.textContent=A.text,Q.appendChild(W)}else Q.textContent=A.text;q.appendChild(Q),ue.appendChild(q)}const ae=document.createElement("div");ae.className="config-overlay__footer";const re=document.createElement("button");re.className="run-button",re.type="button",re.textContent="Run",ae.appendChild(re),o.appendChild(l),o.appendChild(b),o.appendChild(y),o.appendChild(B),o.appendChild(ae),i.appendChild(a),i.appendChild(o),s.appendChild(i),t.appendChild(s),n.appendChild(t);let H=At(e.advancedSettings),Ee="closed";const Le=Io(h,e.simClass,e.values,e.onValuesChange),we=Fr(S,e.theme,e.onThemeChange);m.addEventListener("click",e.onClose),R.addEventListener("click",()=>{if(Ee==="open"){Oe("closed");return}Oe("auth"),F.focus()}),j.addEventListener("click",We),F.addEventListener("keydown",A=>{A.key==="Enter"&&We()}),X.addEventListener("change",()=>{H.lockedScaleId=X.value||null,he()}),se.addEventListener("change",()=>{se.checked&&(H.manifestSource="local")}),fe.addEventListener("change",()=>{fe.checked&&(H.manifestSource="online")}),J.addEventListener("change",()=>{H.verboseLogging=J.checked}),k.addEventListener("change",()=>{H.audioMutedByDefault=k.checked}),N.addEventListener("input",()=>{H.defaultAudioVolume=Number(N.value)/100,ie()});for(const[A,q]of V.entries())q.addEventListener("change",()=>{if(Array.from(V.entries()).filter(([,W])=>W.checked).map(([W])=>W).length===0&&!H.lockedScaleId){q.checked=!0;return}H.hiddenScaleIds=Array.from(V.keys()).filter(W=>{var Be;return!((Be=V.get(W))!=null&&Be.checked)&&W!==H.lockedScaleId}),he()}),A===H.lockedScaleId&&(q.disabled=!0);me(e.initialView??"parameters"),he();function me(A){o.dataset.view=A,A==="parameters"?(u.textContent=e.simClass.label,d.textContent="Shape Your Simulation",p.textContent=e.simClass.parameterSubtitle??"Adjust the parameters, inspect the setup, and press 'Run' when you're ready.",r.src=e.simClass.placeholderImage,r.alt=`${e.simClass.label} preview`):A==="settings"?(u.textContent="Interface",d.textContent="Adjust The Control Room",p.textContent="Change the interface theme and manage exhibit-level options for this installation.",r.src=ne("assets/Cluster_Stuart.webp"),r.alt="Galaxy cluster simulation preview"):(u.textContent="References",d.textContent="Project Sources And Attribution",p.textContent="Review the datasets, imagery, and supporting materials behind this experience.",r.src=ne("assets/synthetic_hst_pretty_galaxy.webp"),r.alt="Synthetic galaxy image preview"),A==="settings"?re.textContent="Apply":A==="credits"?re.textContent="Close":re.textContent="Run Simulation"}function he(){X.value=H.lockedScaleId??"",se.checked=H.manifestSource==="local",fe.checked=H.manifestSource==="online",J.checked=H.verboseLogging,k.checked=H.audioMutedByDefault,N.value=String(Math.round(H.defaultAudioVolume*100)),ie();for(const[A,q]of V.entries()){const Q=H.lockedScaleId===A;q.checked=Q||!H.hiddenScaleIds.includes(A),q.disabled=Q}}function We(){if(F.value!==Mo){z.textContent="Incorrect password";return}F.value="",z.textContent="",Oe("open")}function Oe(A){Ee=A,T.dataset.state=A,R.textContent=A==="open"?"Hide Advanced Settings":"Advanced Settings",A!=="auth"&&(z.textContent="")}function Ce(){F.value="",z.textContent="",Oe("closed")}function $(){H=At(e.advancedSettings),he()}function ie(){E.textContent=`${Math.round(Number(N.value))}%`}return re.addEventListener("click",()=>{const A=o.dataset.view;if(A==="settings"){e.onApplySettings(At(H));return}if(A==="credits"){e.onClose();return}e.onRun()}),{show(){t.hidden=!1,t.classList.remove("is-hidden")},hide(){t.hidden=!0,t.classList.add("is-hidden"),$(),Ce()},setSimulation(A,q){e.simClass=A,a.dataset.simClass=A.id,Le.setSimClass(A,q),o.dataset.view==="parameters"&&(r.src=A.placeholderImage,r.alt=`${A.label} preview`,me("parameters"))},setTheme(A){we.setActive(A)},setView(A){me(A),A!=="settings"&&Ce()},setAdvancedSettings(A){e.advancedSettings=At(A),H=At(A),he(),Ce()}}}function At(n){return{lockedScaleId:n.lockedScaleId,manifestSource:n.manifestSource,verboseLogging:n.verboseLogging,hiddenScaleIds:[...n.hiddenScaleIds],audioMutedByDefault:n.audioMutedByDefault,defaultAudioVolume:n.defaultAudioVolume}}function Fo(n){const{TYPING_MS_PER_CHAR:e,MIN_TERMINAL_TIME_MS:t,FINAL_PAUSE_MS:s}=Yn,i=document.createElement("section");i.className="overlay overlay--initializing",i.hidden=!0,i.classList.add("is-hidden");const a=document.createElement("div");a.className="terminal";const r=document.createElement("div");r.className="terminal__header",r.innerHTML=`
    <div class="terminal__header-left">
      <span class="terminal__dot"></span>
      <span class="terminal__header-label">UNIVERSE_ENGINE_v9.5.1</span>
    </div>
  `;const o=document.createElement("div");o.className="terminal__log",a.appendChild(r),a.appendChild(o),i.appendChild(a),n.appendChild(i);let l=[],c=0;function u(){for(const b of l)window.clearTimeout(b);l=[]}function d(b,h){return new Promise(y=>{const S=window.setTimeout(()=>{h===c&&y()},Math.max(0,b));l.push(S)})}async function p(b,h){const y=document.createElement("div");y.className="terminal__line";const S=m();y.appendChild(S),o.appendChild(y);for(let v=0;v<b.length;v+=1){if(h!==c)return;const L=b[v];y.insertBefore(document.createTextNode(L),S),o.scrollTop=o.scrollHeight,await d(e,h)}S.remove()}function m(){const b=document.createElement("span");return b.className="terminal__cursor",b.textContent="█",b}return{async show(b,h,y,S){u(),c+=1;const v=c;i.hidden=!1,i.classList.remove("is-hidden");const L=performance.now(),k=(S==null?void 0:S.minTerminalTimeMs)??t;let g=!y,w=[...b];y&&y.then(()=>{g=!0});let N=0;for(;v===c;){w.length===0&&(w=[...b]);const T=Math.floor(Math.random()*w.length),[R]=w.splice(T,1),x=`${Vs(N)} ${R.text}`;if(N+=1,await p(x,v),v!==c)return;if(performance.now()-L>=k&&g)break}if(v!==c)return;const E=document.createElement("div");E.className="terminal__line terminal__line--syncing",E.textContent=`${Vs(N)} STARTING SIMULATION...`,o.appendChild(E),o.scrollTop=o.scrollHeight,await d(s,v),v===c&&h()},hide(){u(),c+=1,i.hidden=!0,i.classList.add("is-hidden"),o.innerHTML=""}}}function Vs(n){const e=Math.max(0,Math.floor(n)),t=Math.floor(e/3600),s=Math.floor(e%3600/60),i=e%60;return`[${Rn(t)}:${Rn(s)}:${Rn(i)}]`}function Rn(n){return String(n).padStart(2,"0")}function Bo(n,e){const t=document.createElement("button");t.className="display-button",t.type="button",t.innerHTML="<span></span><span></span><span></span>",t.setAttribute("aria-label","Open configuration overlay"),n.appendChild(t);const s=document.createElement("div");s.className="display-menu";const i=document.createElement("div");i.className="display-menu__header",i.textContent="Menu",s.appendChild(i);const a=l("Home",()=>{c(),e.onHome()});s.appendChild(a),s.appendChild(l("Settings",()=>{c(),e.onViewSelected("settings")})),s.appendChild(l("Credits",()=>{c(),e.onViewSelected("credits")}));const r=l("Fullscreen",()=>{var d;c(),document.fullscreenElement?document.exitFullscreen():(d=document.getElementById("app"))==null||d.requestFullscreen()});s.appendChild(r),n.appendChild(s);function o(){const d=r.querySelector(".display-menu__item-label");d&&(d.textContent=document.fullscreenElement?"Exit Fullscreen":"Fullscreen");const p=document.getElementById("app");p&&p.classList.toggle("is-fullscreen",!!document.fullscreenElement)}return document.addEventListener("fullscreenchange",o),t.addEventListener("click",()=>{n.classList.toggle("open")}),document.addEventListener("click",d=>{n.contains(d.target)||c()}),u(e.showHome??!0),{close:c,setHomeVisible:u};function l(d,p){const m=document.createElement("button");return m.className="display-menu__item",m.type="button",m.innerHTML=`
      <span class="display-menu__item-mark"></span>
      <span class="display-menu__item-label">${d}</span>
    `,m.addEventListener("click",p),m}function c(){n.classList.remove("open")}function u(d){a.hidden=!d,a.classList.toggle("is-hidden",!d)}}const Vi="universe-engine-playback-speed",Vo=new Set([.25,.5,1,2]);function Uo(){const n=localStorage.getItem(Vi),e=n?Number(n):NaN;return Vo.has(e)?e:1}function Do(n){localStorage.setItem(Vi,String(n))}async function Fn(n){try{await n.play()}catch{n.setMuted(!0);try{await n.play()}catch{}}}function Ho(){let n=0;return{start(){return n+=1,n},invalidate(){n+=1},isCurrent(e){return e===n}}}const jo=`# Initialization terminal script for the Planetary simulation family.
#
...
`,Ko=`# Initialization terminal script for the Galaxy simulation family.
#
# Each entry is a single line that may be selected randomly at runtime.
...
`,Wo={planetary:jo,galaxy:Ko,cosmos:qo};function Yo(n){return qe(Wo[n.id]).map(t=>({text:t}))}function Go(n){return n.replace(/\.mp4($|\?)/,".yaml$1")}async function zo(n){try{const e=await Ge(n);if(!e.ok)return null;const t=await e.text(),s=qe(t),i=ct(s.wallclockSeconds),a=ct(s.computeUsed),r=ct(s.memoryUsed),o=ct(s.carbonBurnt),l=ct(s.particlesUpdated),c=await Jo(n),u=Xo(s.summaryMetrics);return i===null||a===null||r===null||o===null||l===null?null:{wallclockSeconds:i,computeUsed:a,memoryUsed:r,carbonBurnt:o,particlesUpdated:l,parameterValues:c,summaryMetrics:u}}catch{return null}}async function Jo(n){try{const e=await Ge(Qo(n));if(!e.ok)return{};const t=await e.text(),s=qe(t);return Zo(s)}catch{return{}}}function Qo(n){return n.replace(/run_summary\.yaml($|\?)/,"parameters.yaml$1")}function ct(n){const e=typeof n=="number"?n:Number(n);return Number.isFinite(e)?e:null}function Xo(n){if(!n||typeof n!="object")return{};const e=n,t={};for(const[s,i]of Object.entries(e)){if(!i||typeof i!="object")continue;const a=i,r=typeof a.label=="string"?a.label:s,o=a.value;o!=null&&(t[s]={label:r,value:String(o)})}return t}function Zo(n){if(!n||typeof n!="object")return{};const e={};for(const[t,s]of Object.entries(n)){const i=ct(s);i!==null&&(e[t]=i)}return e}const Ui="[UniverseEngine]";let Di=!1;function Us(n){Di=n}function Hi(){return Di}function le(n,e){Hi()&&console.info(Ui,n,e??"")}function je(n,e){Hi()&&console.warn(Ui,n,e??"")}const el={local:"assets/local-manifest.json",online:Mi};function tl(n="local"){let e=n;const t=new Map;return{getSource(){return e},setSource(s){s==="online"&&t.delete("online"),Ts(),e=s,le("Manifest source updated",{source:s})},resetCache(){t.clear()},async preloadActiveManifest(){await Ki(e,t)},async findNearestVideo(s,i,a){const r=await il(e,t,s,i,a);if(r)return r;const o=ji(s);return je("Falling back to placeholder assets",{simClassId:s,source:e,fallbackUrl:o}),{url:o,liveDataUrl:nl(s),summaryUrl:Go(o)}}}}function ji(n){switch(n){case"planetary":return ne("assets/planet_test.mp4");case"galaxy":return ne("assets/galaxy_test.mp4");case"cosmos":return ne("assets/cosmo_test.mp4");default:return ne("assets/galaxy_test.mp4")}}function nl(n){switch(n){case"planetary":return ne("assets/planet_test_planetary_stats.csv");case"galaxy":return ne("assets/galaxy_test_galaxy_stats.csv");case"cosmos":return ne("assets/cosmo_test_cosmos_stats.csv");default:return ne("assets/galaxy_test_galaxy_stats.csv")}}async function Ki(n,e){const t=e.get(n);if(t)return t;const s=el[n],i=(n==="online"?sl(s):fetch(ne(s)).then(async a=>{if(!a.ok)throw new Error(`Failed to load manifest: ${s}`);return le("Loaded manifest",{source:n,manifestPath:s}),await a.json()})).catch(a=>(je("Manifest unavailable",{source:n,manifestPath:s,error:a instanceof Error?a.message:String(a)}),{version:1,runs:[]}));return e.set(n,i),i}async function sl(n){const e=[n,$n];for(const t of e)try{const s=await fetch(t);if(!s.ok)continue;const i=await s.json(),a=i.primaryBase??Ds(Mi),r=i.backupBase??Ds($n);return Vr(a,r),t===$n&&Ur("backup"),le("Loaded manifest",{source:"online",manifestPath:t,primaryBase:a,backupBase:r}),i}catch{continue}throw new Error(`Failed to load manifest: ${n}`)}async function il(n,e,t,s,i){const r=(await Ki(n,e)).runs.filter(d=>d.simulationId===t);if(r.length===0)return je("No manifest runs found for simulation",{simClassId:t,source:n}),null;let o=r[0],l=Hs(o,s,i);for(const d of r.slice(1)){const p=Hs(d,s,i);p<l&&(o=d,l=p)}const c=o.defaultView??Object.keys(o.views)[0],u=o.views[c];return u?(le("Selected manifest-backed run",{simClassId:t,source:n,runId:o.runId,selectedValues:i,distance:l,viewId:c}),{url:zt(n,u),liveDataUrl:zt(n,o.liveDataPath),summaryUrl:zt(n,o.summaryPath),viewId:c,runId:o.runId,views:Object.fromEntries(Object.entries(o.views).map(([d,p])=>[d,zt(n,p)]))}):null}function zt(n,e){return n==="local"?ne(e):Ve(e)}function Ds(n){const e=new URL(n);return`${e.protocol}//${e.host}`}function Hs(n,e,t){return e.length===0?0:e.reduce((i,a)=>{var c;const r=t[a.id]??a.fallbackValue,o=((c=n.parameters)==null?void 0:c[a.id])??a.fallbackValue,l=Math.max(a.max-a.min,1e-9);return i+Math.abs(r-o)/l},0)/e.length}const Zt={mode:"time",frames:[]};async function al(n){const e=await Ge(n);if(!e.ok)throw new Error(`Failed to load live stats CSV: ${n}`);const t=await e.text();return ll(t)}function rl(n,e,t=0){if(n.mode==="row")return cl(n.frames,e,t);const s=n.frames;if(s.length===0)return{};if(e<=s[0].t)return{...s[0].values};const i=s[s.length-1];if(e>=i.t)return{...i.values};const a=ol(s,e),r=s[Math.max(0,a-1)],o=s[Math.min(s.length-1,a)],l=(e-r.t)/Math.max(o.t-r.t,1e-9);return ul(r.values,o.values,l)}function ol(n,e){let t=1,s=n.length-1;for(;t<s;){const i=Math.floor((t+s)/2);n[i].t<=e?t=i+1:s=i}return t}function ll(n){const e=n.split(/\r?\n/).map(s=>s.trim()).filter(Boolean);if(e.length<2)return Zt;const t=Bn(e[0]);return t[0]==="t"?{mode:"time",frames:e.slice(1).map(s=>{const i=Bn(s),a={};for(let r=1;r<t.length;r+=1)a[t[r]]=i[r]??"";return{t:parseFloat(i[0]??"0")||0,values:a}})}:{mode:"row",frames:e.slice(1).map((s,i)=>{const a=Bn(s),r={};for(let o=0;o<t.length;o+=1)r[t[o]]=a[o]??"";return{t:i,values:r}})}}function cl(n,e,t){if(n.length===0)return{};if(!Number.isFinite(t)||t<=0)return{...n[0].values};const s=Math.max(0,Math.min(1,e/t)),i=Math.round(s*(n.length-1));return{...n[i].values}}function Bn(n){const e=[];let t="",s=!1;for(let i=0;i<n.length;i+=1){const a=n[i];if(a==='"'){s=!s;continue}if(a===","&&!s){e.push(t),t="";continue}t+=a}return e.push(t),e}function ul(n,e,t){const s=new Set([...Object.keys(n),...Object.keys(e)]),i={};for(const a of s){const r=n[a]??"",o=e[a]??r,l=parseFloat(r),c=parseFloat(o);if(Number.isFinite(l)&&Number.isFinite(c)){const u=l+(c-l)*t;i[a]=dl(u);continue}i[a]=t<.5?r:o}return i}function dl(n){return n.toFixed(2).replace(new RegExp("\\.0+$|(?<=\\..*?)0+$","g"),"").replace(/\.$/,"")}function fl(n){hl(co,n)}function hl(n,e){if(navigator.sendBeacon){const t=new Blob([JSON.stringify(e)],{type:"application/json"});if(navigator.sendBeacon(n,t)){le("Run selection tracking dispatched",{simulationId:e.simulationId});return}}fetch(n,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),keepalive:!0}).then(t=>{t.ok?le("Run selection tracked",{simulationId:e.simulationId}):je("Run selection tracking rejected",{simulationId:e.simulationId,status:t.status})}).catch(t=>{je("Run selection tracking failed",{simulationId:e.simulationId,error:t instanceof Error?t.message:String(t)})})}const js=50*1024*1024,ml=8,pl=6e3,gl=8e3,yl=5e3,bl=1200,vl=100,Vn={galaxy:"tron",planetary:"matrix",cosmos:"hal"};function wl(n){const e=lt.map(f=>f.id);let t=Oo(e),s=ys(t);const i=tl(t.manifestSource),a=Ho();Us(t.verboseLogging),t.manifestSource==="online"&&i.preloadActiveManifest();let r=bs(t.lockedScaleId)??s[0]??lt[0],o=t.lockedScaleId?Vn[r.id]:Rr(),l=!1,c=null,u=null,d=!1,p=t.audioMutedByDefault,m=t.defaultAudioVolume,b=0,h=null,y=0,S=Zt,v=!1;const L=Object.fromEntries(lt.map(f=>[f.id,sa(f)]));Mn(o);const k=ji(r.id),g=Hr(n,k),w=document.createElement("audio");w.preload="auto",w.hidden=!0,w.setAttribute("playsinline","true"),w.muted=p,w.volume=m,n.appendChild(w);const N=document.createElement("div");N.className="display-chrome",N.classList.add("is-hidden"),n.appendChild(N);const E=document.createElement("div");E.className="orientation-overlay",E.innerHTML=`
  ...
  `,n.appendChild(T);const R=document.createElement("div");R.className="synth-logo is-hidden",R.innerHTML=`
    <img
      ...
      decoding="async"
    />
  `,n.appendChild(R);const x=document.createElement("img");x.className="app-partner-logo",x.src=ne("assets/dirac-hpc-white.webp"),x.alt="DIRAC HPC",x.decoding="async",n.appendChild(x);const F=document.createElement("div");F.className="display-chrome__top-left is-hidden",n.appendChild(F);const j=Bo(F,{onHome(){vn()},onViewSelected(f){if(f==="credits"){Dt("credits");return}Dt(f)},showHome:!t.lockedScaleId}),z=document.createElement("div");z.className="display-chrome__left-center",N.appendChild(z);const Y=Eo(z,{onSelect(f){ms(f)},onInfo(f,_,I){X.textContent=_,be.textContent=I,K.classList.add("is-visible")}}),K=document.createElement("div");K.className="view-info-overlay",K.innerHTML=`
  ...
  `,n.appendChild(K);const X=K.querySelector(".view-info-overlay__title"),be=K.querySelector(".view-info-overlay__text"),Se=K.querySelector(".view-info-overlay__close");K.addEventListener("click",f=>{f.target===K&&K.classList.remove("is-visible")}),Se.addEventListener("click",()=>{K.classList.remove("is-visible")});const ce=document.createElement("div");ce.className="display-chrome__top-center is-hidden",N.appendChild(ce);const se=document.createElement("div");se.className="display-chrome__top-right",N.appendChild(se);const ve=Gr(se),fe=document.createElement("div");fe.className="display-chrome__center-status",fe.innerHTML=`
  ...
  `,N.appendChild(fe);const ke=Uo();g.setPlaybackRate(ke);const J=document.createElement("div");J.className="display-chrome__bottom",N.appendChild(J);const C=Kr(J,{onChange(f){H(f)},onTogglePlay:hs,onAudioToggle:Ji,onSpeedChange:Qi,onSummaryClick:zi,onScrubStart(){We(),re()},onScrubEnd(){Oe(),g.isPaused()||ae()},initialSpeed:ke});C.setPlaying(!g.isPaused()),C.setAudioVisible(!1),C.setMuted(p),w.addEventListener("loadedmetadata",()=>{at(!0),Ne()});let M=null,U=null,V=null,B=!1,ue=null,D=0;function ae(){if(M!==null)return;function f(){const _=g.getPlaybackFraction();C.setPosition(_),g.isPaused()?M=null:M=requestAnimationFrame(f)}M=requestAnimationFrame(f)}function re(){M!==null&&(cancelAnimationFrame(M),M=null)}function H(f){U=f,V===null&&(V=requestAnimationFrame(()=>{if(V=null,U===null)return;const _=U;U=null,g.seekToFraction(_),at(!0)}))}function Ee(){if(U===null)return;V!==null&&(cancelAnimationFrame(V),V=null);const f=U;U=null,g.seekToFraction(f),at(!0)}function Le(){ue!==null&&(window.clearTimeout(ue),ue=null)}function we(){if(!(h!=null&&h.views))return[];const f=it(r,h);return Object.entries(h.views).filter(([_])=>_!==f).map(([,_])=>Ve(_)).filter(Boolean)}function me(){Le(),g.suspendPrewarming()}function he(f=bl){Le(),!(B||g.isPaused())&&(ue=window.setTimeout(()=>{ue=null,!(B||g.isPaused())&&(g.resumePrewarming(),g.prewarmSources(we()))},Math.max(0,f)))}function We(){B=!0,D=0,me(),Ne()}function Oe(){B=!1,D=0,Ee(),y=g.getPlaybackFraction()*g.getDurationSeconds(),Qe(y),he(),Ne()}g.onPlayStateChange(f=>{C.setPlaying(!f),f?(re(),me()):(ae(),he(0)),Ne()}),g.onTimeUpdate(f=>{if(y=f*g.getDurationSeconds(),B){const _=performance.now();if(_-D<vl)return;D=_}Qe(y),at()});const Ce=document.createElement("div");Ce.className="overlay-layer",n.appendChild(Ce);const $=_o(Ce,{onReplay:Gi,onParameters:()=>Dt("parameters"),onHome:vn,showHome:!t.lockedScaleId});g.onEnded(()=>{l=!0;const f=g.captureFrame();$.update(r,Ae(),g.getDurationSeconds(),c,f),$.show(),Ne()});const ie=so(Ce,s,f=>{fs(f),Dt("parameters")}),A=Ro(Ce,{simClass:r,values:Ae(),theme:o,advancedSettings:t,availableScales:lt,onValuesChange:qi,onThemeChange:bn,onRun:()=>{le("Parameters submitted — starting run",{simClassId:r.id}),Xi().catch(f=>{je("Run failed to start",{simClassId:r.id,error:f instanceof Error?f.message:String(f)})})},onApplySettings:Wi,onClose:Yi,initialView:"parameters"}),q=Fo(Ce);C.setPosition(0),Qe(),$.hide();const Q=new WeakMap,W=f=>{const _=Q.get(f);_&&(clearTimeout(_),Q.delete(f)),f.classList.remove("side-collapsed")},Be=f=>{const _=Q.get(f);_&&clearTimeout(_),Q.set(f,setTimeout(()=>{f.classList.add("side-collapsed"),Q.delete(f)},2500))},gn=f=>{const _=Q.get(f);_&&(clearTimeout(_),Q.delete(f)),f.classList.add("side-collapsed")},yn=(f,_)=>{const I=_.isCollapsible??(()=>!0);f.addEventListener("mouseenter",()=>W(f)),f.addEventListener("mouseleave",()=>{if(!I()){W(f);return}Be(f)}),f.addEventListener("focusin",()=>W(f)),f.addEventListener("focusout",O=>{if(!f.contains(O.relatedTarget)){if(!I()){W(f);return}Be(f)}}),f.addEventListener("click",()=>{if(!I()){W(f);return}if(f.classList.contains("side-collapsed")){W(f),Be(f);return}_.toggleOnClick?gn(f):Be(f)}),I()?gn(f):W(f)};yn(F,{toggleOnClick:!0,isCollapsible:()=>n.dataset.mode!=="entry"}),yn(z,{toggleOnClick:!0}),yn(J,{toggleOnClick:!1});let St=0,st=null,Ut=0;const us=()=>{st!==null&&(cancelAnimationFrame(st),st=null)},ds=()=>{if(st!==null)return;Ut=g.getPlaybackFraction();const f=()=>{if(St===0){us();return}const I=12*(1/60)/Math.max(g.getDurationSeconds(),1);Ut=Math.max(0,Math.min(1,Ut+St*I)),g.seekToFraction(Ut),st=requestAnimationFrame(f)};st=requestAnimationFrame(f)};document.addEventListener("keydown",f=>{if(n.dataset.mode==="display"&&!(f.target instanceof HTMLInputElement||f.target instanceof HTMLTextAreaElement))switch(f.key){case"Escape":f.preventDefault(),K.classList.contains("is-visible")?K.classList.remove("is-visible"):vn();break;case" ":f.preventDefault(),hs();break;case"ArrowLeft":f.preventDefault(),W(J),Be(J),St=-1,ds();break;case"ArrowRight":f.preventDefault(),W(J),Be(J),St=1,ds();break;case"ArrowUp":case"ArrowDown":{if(f.preventDefault(),W(z),Be(z),!(h!=null&&h.views)||Object.keys(h.views).length<=1)break;const _=r.views.filter(pe=>{var _e;return((_e=h==null?void 0:h.views)==null?void 0:_e[pe.id])!==void 0});if(_.length<=1)break;const I=h.viewId??it(r,h),O=_.findIndex(pe=>pe.id===I),oe=f.key==="ArrowUp"?(O-1+_.length)%_.length:(O+1)%_.length;ms(_[oe].id);break}}}),document.addEventListener("keyup",f=>{(f.key==="ArrowLeft"||f.key==="ArrowRight")&&(St=0,us())}),g.hideMedia(),g.pause(),Je(t.lockedScaleId?"config":"entry");function fs(f){f.id===r.id&&v||(r=f,Sn(),bn(Vn[f.id]),A.setSimulation(r,Ae()),C.setPosition(0),Qe(),_n(),wn())}function qi(f){L[r.id]={...f},le("Parameter values updated",{simClassId:r.id,values:L[r.id]}),Qe()}function bn(f){o=f,Mn(f),A.setTheme(f)}function Dt(f){f==="parameters"&&A.setSimulation(r,Ae()),A.setView(f),Je("config")}function Wi(f){if(pa(f),v){$.hide(),Je("display");return}A.setSimulation(r,Ae()),A.setView("parameters")}function Yi(){if($.hide(),!v&&t.lockedScaleId){A.setSimulation(r,Ae()),A.setView("parameters");return}Je(v?"display":"entry")}function vn(){t.lockedScaleId||(le("Returning to home screen",{simClassId:r.id}),Sn(),v=!1,g.hideMedia(),Je("entry"))}function Gi(){l=!1,$.hide(),g.getPlaybackFraction()>=.999&&(g.resetPlayback(),at(!0)),Fn(g),Ne()}function zi(){l=!0,g.pause();const f=c?g.captureFrame():null;$.update(r,Ae(),g.getDurationSeconds(),c,f),$.show(),Ne()}function hs(){g.isPaused()?Fn(g):g.pause()}function Ji(){p=!p,Ne()}function Qi(f){g.setPlaybackRate(f),Do(f),C.setSpeed(f)}async function Xi(){const f=Ae(),_=a.start();le("Run requested",{simClassId:r.id,values:f,manifestSource:i.getSource()});const I=await i.findNearestVideo(r.id,r.parameters,f);if(!a.isCurrent(_))return;Sn({preserveRunRequest:!0}),h=I;const O=it(r,I),oe=Dr(i.getSource());fl({simulationId:r.id,parameters:f,manifestSource:i.getSource(),matchedRunId:I.runId,assetHostMode:oe.mode,assetHostBase:oe.base});const pe=la(I,O)??I.url,_e=Object.entries(I.views??{}).filter(([Pe])=>Pe!==O).map(([,Pe])=>Pe);aa(I.liveDataUrl,_),ra(I.summaryUrl,_),ua(I.summaryUrl,_),g.setMuted(!0),_n(O),Et(),Je("initializing");const Ht=Zi(pe);g.resumePrewarming(),g.prewarmSources(_e);const Lt=(async()=>{const Pe=await Ht;a.isCurrent(_)&&(le(`Prepared active video source: ${Pe.ownedObjectUrl?"FULL-FETCH":"PROGRESSIVE"}`,{selectedViewUrl:pe,waitsForBuffer:Pe.shouldWaitForBuffer}),g.setSource(Pe.src,{ownedObjectUrl:Pe.ownedObjectUrl}),g.pause(),await g.waitForLoadedData(gl),a.isCurrent(_)&&Pe.shouldWaitForBuffer&&await g.waitForBufferedAhead(ml,pl))})();await new Promise(Pe=>{q.show(Yo(r),Pe,Lt,{minTerminalTimeMs:ha()})}),a.isCurrent(_)&&(v=!0,g.showMedia(),Fn(g),Je("display"),Ne())}async function Zi(f){const _=Ve(f),I=await ea(f);if(I!==null&&I>0&&I<=js){le("Downloading active video behind loading overlay",{videoUrl:_,contentLength:I});try{const O=await Ge(f);if(!O.ok)throw new Error(`Failed to download active video: ${_}`);const oe=await O.blob();return le(`Active video full fetch complete: ${oe.size} bytes`,{videoUrl:Ve(f),blobType:oe.type}),{src:URL.createObjectURL(oe),ownedObjectUrl:!0,shouldWaitForBuffer:!1}}catch(O){je(`Full-fetch FAILED; falling back to progressive: ${O instanceof Error?O.message:String(O)}`,{videoUrl:f})}}return I!==null?le("Active video exceeds full-fetch threshold; using progressive load",{videoUrl:f,contentLength:I,fullFetchMaxBytes:js}):le("Could not determine active video size; using progressive load",{videoUrl:f}),le("Using progressive active video load",{videoUrl:f}),{src:Ve(f),ownedObjectUrl:!1,shouldWaitForBuffer:!0}}async function ea(f){try{const _=await Ge(f,{headers:{Range:"bytes=0-0"}});le("Probed active video size with range request",{videoUrl:f,ok:_.ok,status:_.status,contentLength:_.headers.get("Content-Length"),contentRange:_.headers.get("Content-Range")});const I=na(_.headers.get("Content-Length"));if(I!==null)return I;const O=ta(_.headers.get("Content-Range"));return O!==null?O:null}catch(_){return je("Could not probe active video size",{videoUrl:f,error:_ instanceof Error?_.message:String(_)}),null}}function ta(f){if(!f)return null;const _=f.match(/bytes\s+\d+-\d+\/(\d+)/i);if(!_)return null;const I=Number(_[1]);return Number.isFinite(I)&&I>0?I:null}function na(f){if(!f)return null;const _=Number(f);return Number.isFinite(_)?_:null}function Je(f){if(n.dataset.mode=f,f==="entry"?document.documentElement.setAttribute("data-theme","glass"):f==="display"&&Mn(o),kt(N,f==="display"||f==="config"),kt(T,f==="display"||f==="entry"),kt(F,!t.lockedScaleId&&(f==="entry"||f==="config"||f==="display")),f==="entry"?W(F):gn(F),f==="entry"&&!t.lockedScaleId?ie.show():ie.hide(),f==="config"?(q.hide(),A.setSimulation(r,Ae()),A.show()):A.hide(),f!=="display")$.hide();else if(l){const I=g.captureFrame();$.update(r,Ae(),g.getDurationSeconds(),c,I),$.show()}!v||f==="initializing"?(g.hideMedia(),f==="initializing"&&g.pause()):g.showMedia(),f!=="initializing"&&q.hide(),wn(),Ne()}function wn(){if(n.dataset.mode==="entry"){kt(R,!0);return}const f=n.dataset.mode==="display",_=r.id==="galaxy";kt(R,f&&_)}function Qe(f=0){const _=rl(S,f,g.getDurationSeconds()),I=oa(r,c,f,g.getDurationSeconds());ve.update(r,Ae(),{..._,...I})}function _n(f){const _=r.views.filter(oe=>{var pe;return((pe=h==null?void 0:h.views)==null?void 0:pe[oe.id])!==void 0});if(_.length<=1){Y.hide(),ce.classList.add("is-hidden");return}const I=f??it(r,h),O=_.find(oe=>oe.id===I);Y.update(_,I),O?(ce.classList.remove("is-hidden"),ce.innerHTML=`<span class="viewport-title">${O.label??O.id}</span>`):ce.classList.add("is-hidden")}function Sn(f={}){f.preserveRunRequest||a.invalidate(),S=Zt,l=!1,c=null,h=null,y=0,B=!1,U=null,Le(),V!==null&&(cancelAnimationFrame(V),V=null),$.hide(),Y.hide(),g.pause(),w.pause(),g.clearPrewarmedSources(),g.resetPlayback(),C.setPosition(0),gs()}function ms(f){if(!(h!=null&&h.views)||f===it(r,h))return;const _=Ve(h.views[f]);if(!_)return;h.viewId=f;const I=!g.isPaused()&&!l,O=l?0:g.getPlaybackFraction();l=!1,$.hide(),g.setSource(_,{seekFraction:O,autoplay:I}),g.prewarmSources(we()),I&&!B?he():me(),_n(f),Et(),Ne(),K.classList.remove("is-visible"),wn()}function Ae(){return{...L[r.id]}}function sa(f){return Object.fromEntries(f.parameters.map(_=>[_.id,ia(_)]))}function ia(f){if(f.logScale){const pe=Math.log10(f.min),_e=Math.log10(f.max);return 10**(pe+Math.random()*(_e-pe))}const _=Math.max(0,Math.round((f.max-f.min)/f.step)),I=Math.floor(Math.random()*(_+1)),O=f.min+I*f.step,oe=Ti(f.step);return Number(O.toFixed(oe))}async function aa(f,_){let I=Zt;try{I=await al(f)}catch(O){je("Failed to load live stats",{url:f,error:O instanceof Error?O.message:String(O)})}a.isCurrent(_)&&(S=I,Qe())}async function ra(f,_){const I=await zo(f);a.isCurrent(_)&&(c=I,Qe(y))}function oa(f,_,I,O){if(!_||!Number.isFinite(O)||O<=0)return{};const oe=Math.max(0,Math.min(1,I/O)),pe={};for(const _e of f.metadata.liveStats){if(!_e.live||!_e.fromVideo||!_e.scaleWithTime)continue;const Ht=_e.videoKey??_e.id,Lt=_[Ht];if(typeof Lt!="number"||!Number.isFinite(Lt))continue;const kn=Lt*oe;pe[_e.id]=_e.integer?String(Math.floor(kn)):String(kn)}return pe}function kt(f,_){f.hidden=!_,f.classList.toggle("is-hidden",!_)}function it(f,_){return _!=null&&_.views?_.viewId??Object.keys(_.views)[0]:_==null?void 0:_.viewId}function la(f,_){return!_||!f.views?null:f.views[_]??null}function ps(){const f=it(r,h);return f?r.views.some(_=>_.id===f&&_.audio):!1}function ca(f){return f.replace(/run_summary\.yaml($|\?)/,"audio_track.wav$1")}async function ua(f,_){const I=ca(f),O=++b,oe=await da(I);if(!(!a.isCurrent(_)||O!==b)){if(!oe){gs();return}u=Ve(I),d=!0,w.src!==u&&(w.pause(),w.src=u,w.load()),Et(),Ne()}}async function da(f){try{if((await Ge(f,{method:"HEAD"})).ok)return!0}catch{}try{return(await Ge(f,{headers:{Range:"bytes=0-0"}})).ok}catch{return!1}}function gs(){b+=1,u=null,d=!1,w.pause(),w.removeAttribute("src"),w.load(),Et()}function fa(){p=t.audioMutedByDefault,m=t.defaultAudioVolume,w.muted=p,w.volume=m,C.setMuted(p)}function Et(){C.setAudioVisible(ps()&&d&&!!u),C.setMuted(p)}function at(f=!1){if(!d||!Number.isFinite(w.duration)||w.duration<=0)return;const _=Math.max(0,Math.min(w.duration,g.getPlaybackFraction()*w.duration));(f||Math.abs(w.currentTime-_)>.35)&&(w.currentTime=_)}function Ne(){const f=ps()&&d&&!!u;if(Et(),w.muted=p,w.volume=m,!f){w.pause();return}if(at(),n.dataset.mode!=="display"||g.isPaused()||l||B){w.pause();return}w.play().catch(()=>{p=!0,w.muted=!0,C.setMuted(!0)})}function ys(f){const _=new Set($o(f,e));return lt.filter(I=>_.has(I.id))}function bs(f){return f?lt.find(_=>_.id===f)??null:null}function ha(){return i.getSource()!=="local"?Yn.MIN_TERMINAL_TIME_MS:ma(Yn.MIN_TERMINAL_TIME_MS,yl)}function ma(f,_){const I=Math.ceil(Math.min(f,_)),O=Math.floor(Math.max(f,_));return Math.floor(Math.random()*(O-I+1))+I}function pa(f){const _=r.id,I=t.manifestSource;t=Po(f,e),Us(t.verboseLogging),s=ys(t),i.setSource(t.manifestSource),t.manifestSource==="online"&&i.preloadActiveManifest(),j.setHomeVisible(!t.lockedScaleId),$.setHomeVisible(!t.lockedScaleId),ie.setSimulationClasses(s),A.setAdvancedSettings(t),le("Advanced settings updated",t),fa(),Ne(),I!==t.manifestSource&&(h=null);const O=bs(t.lockedScaleId);O&&(fs(O),O.id!==_&&(v=!1,g.hideMedia(),A.setView("parameters")),v||(bn(Vn[O.id]),A.setSimulation(r,Ae())))}}function _l(){const n=document.getElementById("app");if(!n)throw new Error("App mount element not found.");wl(n)}_l();
//# sourceMappingURL=main-DYzrRlT6.js.map
