...
${t}`)+"'";return e.implicitKey?s:kn(s,t,fi,En(e,!1))}function St(n,e){const{singleQuote:t}=e.options;let s;if(t===!1)s=Wt;else{const i=n.includes('"'),a=n.includes("'");i&&!a?s=ss:a&&!i?s=Wt:s=t?ss:Wt}return s(n,e)}let is;try{is=new RegExp(`(^|(?<!
))
+(?!
|$)`,"g")}catch{is=/\n+(?!\n|$)/g}function gn({comment:n,type:e,value:t},s,i,a){const{blockQuote:r,commentString:o,lineWidth:l}=s.options;if(!r||/\n[\t ]+$/.test(t))return St(t,s);const c=s.indent||(s.forceBlockIndent||In(t)?"  ":""),u=r==="literal"?!0:r==="folded"||e===$.BLOCK_FOLDED?!1:e===$.BLOCK_LITERAL?!0:!ja(t,l,c.length);if(!t)return u?`|
`:`>
...
`)k=g;else break}let v=t.substring(0,k<g?k+1:g);v&&(t=t.substring(v.length),v=v.replace(/\n+/g,`$&${c}`));let _=(p?c?"2":"1":"")+f;if(n&&(_+=" "+o(n.replace(/ ?[\r\n]+/g," ")),i&&i()),!u){const L=t.replace(/\n+/g,`
$&`).replace(/(?:^|\n)([\t ].*)(?:([\n\t ]*)\n(?![\n\t ]))?/g,"$1$2").replace(/\n+/g,`$&${c}`);let w=!1;const I=En(s,!0);r!=="folded"&&e!==$.BLOCK_FOLDED&&(I.onOverflow=()=>{w=!0});const C=kn(`${v}${L}${m}`,c,ns,I);if(!w)return`>${_}
...
${r}
${c}
`}};function Nt(n,{flow:e,indicator:t,next:s,offset:i,onError:a,parentIndent:r,startOnNewline:o}){let l=!1,c=o,u=o,f="",h="",m=!1,y=!1,p=null,g=null,k=null,v=null,S=null,_=null,L=null;for(const C of n)switch(y&&(C.type!=="space"&&C.type!=="newline"&&C.type!=="comma"&&a(C.offset,"MISSING_CHAR","Tags and anchors must be separated from the next token by white space"),y=!1),p&&(c&&C.type!=="comment"&&C.type!=="newline"&&a(p,"TAB_AS_INDENT","Tabs are not allowed as indentation"),p=null),C.type){case"space":!e&&(t!=="doc-start"||(s==null?void 0:s.type)!=="flow-collection")&&C.source.includes("	")&&(p=C),u=!0;break;case"comment":{u||a(C,"MISSING_CHAR","Comments must be separated from other tokens by white space characters");const x=C.source.substring(1)||" ";f?f+=h+x:f=x,h="",c=!1;break}case"newline":c?f?f+=C.source:(!_||t!=="seq-item-ind")&&(l=!0):h+=C.source,c=!0,m=!0,(g||k)&&(v=C),u=!0;break;case"anchor":g&&a(C,"MULTIPLE_ANCHORS","A node can have at most one anchor"),C.source.endsWith(":")&&a(C.offset+C.source.length-1,"BAD_ALIAS","Anchor ending in : is ambiguous",!0),g=C,L??(L=C.offset),c=!1,u=!1,y=!0;break;case"tag":{k&&a(C,"MULTIPLE_TAGS","A node can have at most one tag"),k=C,L??(L=C.offset),c=!1,u=!1,y=!0;break}case t:(g||k)&&a(C,"BAD_PROP_ORDER",`Anchors and tags must be after the ${C.source} indicator`),_&&a(C,"UNEXPECTED_TOKEN",`Unexpected ${C.source} in ${e??"collection"}`),_=C,c=t==="seq-item-ind"||t==="explicit-key-ind",u=!1;break;case"comma":if(e){S&&a(C,"UNEXPECTED_TOKEN",`Unexpected , in ${e}`),S=C,c=!1,u=!1;break}default:a(C,"UNEXPECTED_TOKEN",`Unexpected ${C.type} token`),c=!1,u=!1}const w=n[n.length-1],I=w?w.offset+w.source.length:i;return y&&s&&s.type!=="space"&&s.type!=="newline"&&s.type!=="comma"&&(s.type!=="scalar"||s.source!=="")&&a(s.offset,"MISSING_CHAR","Tags and anchors must be separated from the next token by white space"),p&&(c&&p.indent<=r||(s==null?void 0:s.type)==="block-map"||(s==null?void 0:s.type)==="block-seq")&&a(p,"TAB_AS_INDENT","Tabs are not allowed as indentation"),{comma:S,found:_,spaceBefore:l,comment:f,hasNewline:m,anchor:g,tag:k,newlineAfterProp:v,end:I,start:L??I}}function Gt(n){if(!n)return null;switch(n.type){case"alias":case"scalar":case"double-quoted-scalar":case"single-quoted-scalar":if(n.source.includes(`
...
`+g.comment:o.comment=g.comment);continue}(g.newlineAfterProp||Gt(m))&&i(m??h[h.length-1],"MULTILINE_IMPLICIT_KEY","Implicit keys need to be on a single line")}else((u=g.found)==null?void 0:u.indent)!==s.indent&&i(l,"BAD_INDENT",Hs);t.atKey=!0;const v=g.end,S=m?n(t,m,g,i):e(t,v,h,null,g,i);t.schema.compat&&as(s.indent,m,i),t.atKey=!1,xi(t,o.items,S)&&i(v,"DUPLICATE_KEY","Map keys must be unique");const _=Nt(y??[],{indicator:"map-value-ind",next:p,offset:S.range[2],onError:i,parentIndent:s.indent,startOnNewline:!m||m.type==="block-scalar"});if(l=_.end,_.found){k&&((p==null?void 0:p.type)==="block-map"&&!_.hasNewline&&i(l,"BLOCK_AS_IMPLICIT_KEY","Nested mappings are not allowed in compact mappings"),t.options.strict&&g.start<_.found.offset-1024&&i(S.range,"KEY_OVER_1024_CHARS","The : indicator must be at most 1024 chars after the start of an implicit block mapping key"));const L=p?n(t,p,_,i):e(t,l,y,null,_,i);t.schema.compat&&as(s.indent,p,i),l=L.range[2];const w=new Le(S,L);t.options.keepSourceTokens&&(w.srcToken=f),o.items.push(w)}else{k&&i(S.range,"MISSING_CHAR","Implicit map keys need to be followed by map values"),_.comment&&(S.comment?S.comment+=`
`+_.comment:S.comment=_.comment);const L=new Le(S);t.options.keepSourceTokens&&(L.srcToken=f),o.items.push(L)}}return c&&c<l&&i(c,"IMPOSSIBLE","Map comment with trailing content"),o.range=[s.offset,l,c??l],o}function mr({composeNode:n,composeEmptyNode:e},t,s,i,a){const r=(a==null?void 0:a.nodeClass)??ut,o=new r(t.schema);t.atRoot&&(t.atRoot=!1),t.atKey&&(t.atKey=!1);let l=s.offset,c=null;for(const{start:u,value:f}of s.items){const h=Nt(u,{indicator:"seq-item-ind",next:f,offset:l,onError:i,parentIndent:s.indent,startOnNewline:!0});if(!h.found)if(h.anchor||h.tag||f)(f==null?void 0:f.type)==="block-seq"?i(h.end,"BAD_INDENT","All sequence items must start at the same column"):i(l,"MISSING_CHAR","Sequence item without - indicator");else{c=h.end,h.comment&&(o.comment=h.comment);continue}const m=f?n(t,f,h,i):e(t,h.end,u,null,h,i);t.schema.compat&&as(s.indent,f,i),l=m.range[2],o.items.push(m)}return o.range=[s.offset,l,c??l],o}function Zt(n,e,t,s){let i="";if(n){let a=!1,r="";for(const o of n){const{source:l,type:c}=o;switch(c){case"space":a=!0;break;case"comment":{t&&!a&&s(o,"MISSING_CHAR","Comments must be separated from other tokens by white space characters");const u=l.substring(1)||" ";i?i+=r+u:i=u,r="";break}case"newline":i&&(r+=l),a=!0;break;default:s(o,"UNEXPECTED_TOKEN",`Unexpected ${c} at node end`)}e+=l.length}}return{comment:i,offset:e}}const Dn="Block collections are not allowed within flow collections",Hn=n=>n&&(n.type==="block-map"||n.type==="block-seq");function pr({composeNode:n,composeEmptyNode:e},t,s,i,a){var g;const r=s.start.source==="{",o=r?"flow map":"flow sequence",l=(a==null?void 0:a.nodeClass)??(r?Oe:ut),c=new l(t.schema);c.flow=!0;const u=t.atRoot;u&&(t.atRoot=!1),t.atKey&&(t.atKey=!1);let f=s.offset+s.start.source.length;for(let k=0;k<s.items.length;++k){const v=s.items[k],{start:S,key:_,sep:L,value:w}=v,I=Nt(S,{flow:o,indicator:"explicit-key-ind",next:_??(L==null?void 0:L[0]),offset:f,onError:i,parentIndent:s.indent,startOnNewline:!1});if(!I.found){if(!I.anchor&&!I.tag&&!L&&!w){k===0&&I.comma?i(I.comma,"UNEXPECTED_TOKEN",`Unexpected , in ${o}`):k<s.items.length-1&&i(I.start,"UNEXPECTED_TOKEN",`Unexpected empty item in ${o}`),I.comment&&(c.comment?c.comment+=`
`+I.comment:c.comment=I.comment),f=I.end;continue}!r&&t.options.strict&&Gt(_)&&i(_,"MULTILINE_IMPLICIT_KEY","Implicit keys of flow sequence pairs need to be on a single line")}if(k===0)I.comma&&i(I.comma,"UNEXPECTED_TOKEN",`Unexpected , in ${o}`);else if(I.comma||i(I.start,"MISSING_CHAR",`Missing , between ${o} items`),I.comment){let C="";e:for(const x of S)switch(x.type){case"comma":case"space":break;case"comment":C=x.source.substring(1);break e;default:break e}if(C){let x=c.items[c.items.length-1];ue(x)&&(x=x.value??x.key),x.comment?x.comment+=`
`+C:x.comment=C,I.comment=I.comment.substring(C.length+1)}}if(!r&&!L&&!I.found){const C=w?n(t,w,I,i):e(t,I.end,L,null,I,i);c.items.push(C),f=C.range[2],Hn(w)&&i(C.range,"BLOCK_IN_FLOW",Dn)}else{t.atKey=!0;const C=I.end,x=_?n(t,_,I,i):e(t,C,S,null,I,i);Hn(_)&&i(x.range,"BLOCK_IN_FLOW",Dn),t.atKey=!1;const M=Nt(L??[],{flow:o,indicator:"map-value-ind",next:w,offset:x.range[2],onError:i,parentIndent:s.indent,startOnNewline:!1});if(M.found){if(!r&&!I.found&&t.options.strict){if(L)for(const A of L){if(A===M.found)break;if(A.type==="newline"){i(A,"MULTILINE_IMPLICIT_KEY","Implicit keys of flow sequence pairs need to be on a single line");break}}I.start<M.found.offset-1024&&i(M.found,"KEY_OVER_1024_CHARS","The : indicator must be at most 1024 chars after the start of an implicit flow sequence key")}}else w&&("source"in w&&((g=w.source)==null?void 0:g[0])===":"?i(w,"MISSING_CHAR",`Missing space after : in ${o}`):i(M.start,"MISSING_CHAR",`Missing , or : between ${o} items`));const F=w?n(t,w,M,i):M.found?e(t,M.end,L,null,M,i):null;F?Hn(w)&&i(F.range,"BLOCK_IN_FLOW",Dn):M.comment&&(x.comment?x.comment+=`
`+M.comment:x.comment=M.comment);const E=new Le(x,F);if(t.options.keepSourceTokens&&(E.srcToken=v),r){const A=c;xi(t,A.items,x)&&i(C,"DUPLICATE_KEY","Map keys must be unique"),A.items.push(E)}else{const A=new Oe(t.schema);A.flow=!0,A.items.push(E);const W=(F??x).range;A.range=[x.range[0],W[1],W[2]],c.items.push(A)}f=F?F.range[2]:M.end}}const h=r?"}":"]",[m,...y]=s.end;let p=f;if((m==null?void 0:m.source)===h)p=m.offset+m.source.length;else{const k=o[0].toUpperCase()+o.substring(1),v=u?`${k} must end with a ${h}`:`${k} in block collection must be sufficiently indented and end with a ${h}`;i(f,u?"MISSING_CHAR":"BAD_INDENT",v),m&&m.source.length!==1&&y.unshift(m)}if(y.length>0){const k=Zt(y,p,t.options.strict,i);k.comment&&(c.comment?c.comment+=`
...
`;for(let p=u;p<o;++p){let[g,k]=r[p];c+=g.length+k.length+1;const v=k[k.length-1]==="\r";if(v&&(k=k.slice(0,-1)),k&&g.length<l){const _=`Block scalar lines must not be less indented than their ${i.indent?"explicit indentation indicator":"first line"}`;t(c-k.length-(v?2:1),"BAD_INDENT",_),g=""}a===$.BLOCK_LITERAL?(f+=h+g.slice(l)+k,h=`
`):g.length>l||k[0]==="	"?(h===" "?h=`
`:!m&&h===`
`&&(h=`
...
`,Xs=(()=>{const n=Xe(To),e={};for(const t of Object.values(n))for(const[s,i]of Object.entries(t))e[s]=i;return e})(),wn="#4CD98A",cs="#E8951C",zi="#D7372A",Ji=.2,Qi=.5,Zs=2;function Xi(n){const e=Math.abs(n-1);return e<=Ji?{word:"On target",colour:wn}:e<=Qi?{word:n>1?"Too high":"Too low",colour:cs}:{word:n>1?"Way too high":"Way too low",colour:zi}}function Mo(n){const e=Math.abs(n-1),t=n>=1;return e<=Ji?t?"greenHigh":"greenLow":e<=Qi?t?"amberHigh":"amberLow":t?"redHigh":"redLow"}function Oo(n){return Math.min(Math.max(n,0),Zs)/Zs*100}function Po(n){return n>=85?{word:"Almost perfect",colour:wn}:n>=65?{word:"Really close",colour:wn}:n>=45?{word:"Getting there",colour:cs}:n>=25?{word:"Not quite",colour:cs}:{word:"Way off - try again",colour:zi}}function xo(n,e,t){var r,o;const s=Mo(t),i=((r=Xs[n])==null?void 0:r[s])??((o=Xs[e])==null?void 0:o[s]);return i||(Xi(t).colour===wn?`${e} is very close to the target value for this simulation.`:t<1?`${e} is below the target value for this simulation.`:`${e} is above the target value for this simulation.`)}function Ro(n,e,t){return n.metadata.results.map(s=>{const i=$o(s,n,e,t);if(i===null)return null;const a=i/Math.max(s.target,1e-9),r=Fo(s,n,t),o=xo(s.id,r,a),l=De(Zi(String(i),s),s.unit);return{id:s.id,label:r,value:a,rawValue:i,formattedValue:l,detail:o}}).filter(s=>s!==null)}function $o(n,e,t,s){var l;const i=n.id,a=e.parameters.find(c=>c.id===i);if(a)return t[i]??a.fallbackValue;const r=Bo((l=s==null?void 0:s.summaryMetrics[i])==null?void 0:l.value);if(r!==null)return r;const o=s==null?void 0:s.parameterValues[i];return typeof o=="number"&&Number.isFinite(o)?o:null}function Fo(n,e,t){var i,a;const s=n.id;return n.label??((i=e.parameters.find(r=>r.id===s))==null?void 0:i.label)??((a=t==null?void 0:t.summaryMetrics[s])==null?void 0:a.label)??s}function Bo(n){if(n===void 0)return null;const e=Number(n);return Number.isFinite(e)?e:null}function Vo(n){if(n.length===0)return 0;const e=n.reduce((t,s)=>t+Math.max(0,1-Math.abs(s.value-1)),0);return Math.round(e/n.length*100)}function Uo(n,e){const t=document.createElement("section");t.className="overlay overlay--summary",t.hidden=!0,t.classList.add("is-hidden");let s;const i=document.createElement("div");i.className="summary-overlay";const a=document.createElement("div"),r=document.createElement("div");a.className="summary-overlay__header",r.className="summary-overlay__content";const o=document.createElement("p");o.className="summary-overlay__title",o.textContent="Run Summary";const l=document.createElement("p");l.className="summary-overlay__hint",l.textContent="Select any card for more details",a.appendChild(o),a.appendChild(l);const c=document.createElement("div");c.className="summary-overlay__actions";const u=document.createElement("button");u.className="summary-overlay__button",u.type="button",u.innerHTML='<span class="long-label">Continue Visualising</span><span class="short-label">Continue</span>';const f=document.createElement("button"),h=document.createElement("button");f.className="summary-overlay__button summary-overlay__button--primary",f.type="button",f.innerHTML='<span class="long-label">New Parameters</span><span class="short-label">New</span>',h.className="summary-overlay__button",h.type="button",h.textContent="Home",h.hidden=!e.showHome,u.addEventListener("click",e.onReplay),f.addEventListener("click",e.onParameters),h.addEventListener("click",e.onHome),c.appendChild(f),c.appendChild(u),c.appendChild(h),i.appendChild(a),i.appendChild(r),i.appendChild(c),t.appendChild(i);const m=document.createElement("div");m.className="sci-modal is-hidden",m.innerHTML=`
  ...
  `,t.appendChild(m),n.appendChild(t);const y=m.querySelector(".sci-modal__title"),p=m.querySelector(".sci-modal__verdict"),g=m.querySelector(".sci-modal__body"),k=m.querySelector(".sci-modal__close"),v=new Set;let S=!1,_=null,L=null;function w(M){const F=Xi(M.value);y.textContent=M.label,p.textContent=F.word,p.style.color=F.colour,p.hidden=!1,g.textContent=M.detail,m.classList.remove("is-hidden")}function I(M,F){y.textContent=M,p.hidden=!0,g.textContent=F,m.classList.remove("is-hidden")}function C(){m.classList.add("is-hidden")}k.addEventListener("click",C),m.addEventListener("click",M=>{M.target===m&&C()}),t.addEventListener("click",M=>{M.target===t&&e.onReplay()});function x(M,F){const E=document.createElement("div");E.className=`${M.className} panel`,E.innerHTML=`<p class="sci-section__title">${M.title}</p>`;const A=document.createElement("div"),W=M.singleRow?Math.max(1,M.stats.length):Math.max(1,Math.min(M.stats.length,M.maxColumns));A.className="metric-grid",M.singleRow&&A.classList.add("metric-grid--single-row"),A.style.setProperty("--summary-grid-columns",String(W)),A.style.setProperty("--summary-grid-max-width",`${M.maxWidthRem}rem`);for(const fe of M.stats){const z=Do(fe,F),J=document.createElement("div"),Y=document.createElement("span"),ee=document.createElement("span");J.className="res-card",Y.className="res-card__label",Y.textContent=z.label,ee.className="res-card__value",ee.textContent=z.value,J.appendChild(Y),J.appendChild(ee),fe.description&&(J.classList.add("res-card--has-info"),J.addEventListener("click",()=>{I(z.label,fe.description)})),A.appendChild(J)}return E.appendChild(A),E}return{show(){s&&(window.clearTimeout(s),s=void 0),t.hidden=!1,t.classList.remove("is-hidden"),t.classList.remove("is-visible"),t.offsetWidth,requestAnimationFrame(()=>{t.classList.add("is-visible")})},hide(){t.classList.remove("is-visible"),s=window.setTimeout(()=>{t.hidden=!0,t.classList.add("is-hidden"),s=void 0,S&&(v.clear(),S=!1)},Co.HIDE_AFTER_MS)},resetGalaxyChecklist(){var M;v.clear(),S=!1,L=_;for(const F of r.querySelectorAll(".galaxy-summary__check")){F.classList.remove("is-found");const E=F.querySelector(".galaxy-summary__check-box");E&&(E.textContent="")}(M=r.querySelector(".galaxy-summary__done"))==null||M.remove()},setHomeVisible(M){h.hidden=!M},update(M,F,E,A,W,fe){var U,X,D,we,Se,oe;r.innerHTML="",C();const z=Eo(M,F,E,A),J=M.metadata.summaryStats,Y=Ro(M,F,A),ee=new Set(Y.map(H=>H.id));let be;if(Y.length>0)be=Vo(Y);else{const H=((U=z.similarityScore)==null?void 0:U.value)??"0/100";be=parseInt(H,10)||0}const ie=Po(be),ve=document.createElement("div"),Q=document.createElement("div"),Ne=document.createElement("div");ve.className="sci-top",Q.className="summary-main-column",Ne.className="summary-side-column";const he=document.createElement("div");he.className="sci-hero panel",W?(he.classList.add("sci-hero--thumbnail"),he.innerHTML=`<img class="sci-hero__thumbnail" src="${W}" alt="Final frame of simulation" />`):he.innerHTML=`
          <div class="sci-hero__score">
            <span class="sci-hero__num">${be}</span><span class="sci-hero__outof">/100</span>
          </div>
          <div class="sci-hero__reaction" style="color:${ie.colour}">${ie.word}</div>
          <div class="sci-hero__gauge">
            <div class="sci-hero__gauge-fill" style="width:${be}%; background:${ie.colour}; box-shadow:0 0 12px ${ie.colour}"></div>
          </div>
        `,Q.appendChild(he);const Re=J.filter(H=>(H.section??"resources")==="resources"&&!Y.some(K=>K.id===String(H.id))&&H.id!=="similarityScore"),N=J.filter(H=>H.section==="simulationStats"&&!ee.has(String(H.id)));Re.length>0&&Ne.appendChild(x({title:"Resources Used",className:"res-section",stats:Re,maxColumns:3,maxWidthRem:48},z)),N.length>0&&Ne.appendChild(x({title:"Simulation Stats",className:"res-section",stats:N,maxColumns:N.length,maxWidthRem:48,singleRow:!0},z)),ve.appendChild(Q),Ne.childElementCount>0&&ve.appendChild(Ne),r.appendChild(ve);const P=M.metadata.morphologyChecklist;if(P&&P.length>0){const H=((D=(X=A==null?void 0:A.summaryMetrics)==null?void 0:X.morphology)==null?void 0:D.value)??null,K=(H==null?void 0:H.toLowerCase())??null,ae=new Set(P.map(j=>j.id));_=fe??null,K&&ae.has(K)&&_!==L&&v.add(K),_!==L&&(L=null);const Z=document.createElement("div");Z.className="sci-bottom-row";const ke=document.createElement("div");ke.style.cssText="display:flex; flex-direction:column; gap:1.25rem;",ke.appendChild(ei(M,F,I));const me=((we=P.find(j=>j.id===K))==null?void 0:we.label)??H;if(me){const j=document.createElement("div");j.className="sci-section panel param-section";const re=document.createElement("p");re.className="sci-section__title",re.textContent="Galaxy Morphology";const Ee=document.createElement("div");Ee.className="res-card res-card--has-info";const $e=document.createElement("span");$e.className="res-card__value",$e.textContent=me,Ee.appendChild($e),Ee.addEventListener("click",()=>{var qe;return I("Galaxy Morphology",((qe=P.find(st=>st.id===(H??"").toLowerCase()))==null?void 0:qe.description)??`This galaxy is classified as "${me}".`)}),j.appendChild(re),j.appendChild(Ee),ke.appendChild(j)}Z.appendChild(ke);const ne=document.createElement("div");ne.style.cssText="flex:1; display:flex; flex-direction:column; gap:1.25rem; min-width:0; min-height:0;";const V=((oe=(Se=A==null?void 0:A.summaryMetrics)==null?void 0:Se.description)==null?void 0:oe.value)??null;if(V){const j=document.createElement("div");j.className="sci-section panel",j.style.cssText="flex:0 1 auto; min-width:0;";const re=document.createElement("p");re.className="sci-section__title",re.textContent="About This Galaxy";const Ee=document.createElement("p");Ee.className="galaxy-summary__desc-text",Ee.textContent=V,j.appendChild(re),j.appendChild(Ee),ne.appendChild(j)}const Ce=document.createElement("div");Ce.className="sci-section panel",Ce.style.cssText="flex:1; min-height:0;";const je=document.createElement("p");je.className="sci-section__title",je.textContent="Morphology Scavenger Hunt";const Ye=document.createElement("div");Ye.className="galaxy-summary__checklist",Ye.style.cssText="flex:1; align-items:center;";const ft=P.every(j=>v.has(j.id));for(const j of P){const re=document.createElement("div");re.className="galaxy-summary__check",v.has(j.id)&&re.classList.add("is-found"),re.innerHTML=`
            <span class="galaxy-summary__check-box">
              ${v.has(j.id)?"✓":""}
            </span>
            <span class="galaxy-summary__check-label">${j.label}</span>
          `,j.hint&&(re.classList.add("res-card--has-info"),re.addEventListener("click",()=>I(j.label,j.hint))),Ye.appendChild(re)}if(Ce.appendChild(je),Ce.appendChild(Ye),ft){S=!0;const j=document.createElement("div");j.className="galaxy-summary__done",j.textContent="★ You've discovered all of the galaxy types. Well done! ★",Ce.appendChild(j)}ne.appendChild(Ce),Z.appendChild(ne),r.appendChild(Z)}else if(Y.length>0){const H=document.createElement("div");H.className="sci-bottom-row",H.appendChild(ei(M,F,I));const K=document.createElement("div"),ae=document.createElement("div"),Z=document.createElement("p"),ke=document.createElement("p");K.className="sci-section panel",ae.className="sci-section__header",Z.className="sci-section__title",Z.textContent="Similarity Results",ke.className="sci-section__hint",ke.textContent="Select any bar for details",ae.appendChild(Z),ae.appendChild(ke);const me=document.createElement("div");me.className="sci-bars";for(const ne of Y){const V=document.createElement("div");V.className="sci-bar",V.innerHTML=`
...
`;function Yo(){const n=Xe(Wo);if(!Array.isArray(n))return[];const e=[];for(const t of n){if(!t||typeof t!="object")continue;const s=t.text;if(typeof s!="string"||s.trim().length===0)continue;const i={text:s},a=t.url;typeof a=="string"&&a.trim().length>0&&(i.url=a);const r=t.logo;typeof r=="string"&&r.trim().length>0&&(i.logo=r),t.header===!0&&(i.header=!0),e.push(i)}return e}function Go(n,e,t,s){const i=document.createElement("div");i.className="parameter-editor",n.appendChild(i);let a=e,r={...t};function o(u,f){a=u,r=f?{...f}:zo(u),i.innerHTML="";const h=document.createElement("div");h.className="parameter-editor__heading",h.innerHTML=`
 ...
 Engine</h1>
  ...
  `;const h=f.querySelector(".config-overlay__eyebrow"),m=f.querySelector(".config-overlay__title"),y=f.querySelector(".config-overlay__subtitle"),p=document.createElement("button");p.className="config-overlay__close",p.type="button",p.setAttribute("aria-label","Back"),p.textContent="←",u.appendChild(f),u.appendChild(p);const g=document.createElement("section");g.className="config-overlay__section config-overlay__section--grow",g.dataset.section="parameters";const k=document.createElement("div");g.appendChild(k);const v=document.createElement("section");v.className="config-overlay__section config-overlay__section--grow",v.dataset.section="settings";const S=document.createElement("div");S.className="config-overlay__settings-block",S.innerHTML=`
  ...
  `;const L=document.createElement("button");L.className="advanced-settings__access",L.type="button",L.textContent="Reset Galaxy Checkboxes",L.addEventListener("click",()=>{e.onResetGalaxyChecklist()}),_.appendChild(L),v.appendChild(S),v.prepend(_);const w=document.createElement("section");w.className="audio-settings config-overlay__settings-block",w.innerHTML=`
  ...
  `,I.appendChild(C),I.appendChild(x),w.appendChild(I);const M=document.createElement("label");M.className="advanced-settings__field",M.innerHTML=`
  ...
  `;const F=document.createElement("input"),E=document.createElement("span");F.type="range",F.min="0",F.max="100",F.step="1",F.className="audio-settings__slider",E.className="audio-settings__value",M.appendChild(F),M.appendChild(E),w.appendChild(M),v.appendChild(w);const A=document.createElement("section");A.className="advanced-settings config-overlay__settings-block",A.dataset.state="closed",A.innerHTML=`
  ...
  `;const ie=document.createElement("select");ie.className="advanced-settings__select",ie.appendChild(new Option("None",""));for(const O of e.availableScales)ie.appendChild(new Option(O.label,O.id));be.appendChild(ie),ee.appendChild(be);const ve=document.createElement("div");ve.className="advanced-settings__field",ve.innerHTML=`
  ...
  `,P.appendChild(U),P.appendChild(X),ee.appendChild(P);const D=document.createElement("label");D.className="advanced-settings__field advanced-settings__field--inline";const we=document.createElement("input"),Se=document.createElement("span");we.type="checkbox",we.className="advanced-settings__checkbox",Se.innerHTML=`
  ...
  `,D.appendChild(we),D.appendChild(Se),ee.appendChild(D);const oe=document.createElement("div");oe.className="advanced-settings__field",oe.innerHTML=`
  ...
  `;const H=document.createElement("div");H.className="advanced-settings__options";const K=new Map;for(const O of e.availableScales){const B=document.createElement("label"),pe=document.createElement("input");B.className="advanced-settings__choice",pe.type="checkbox",pe.value=O.id,K.set(O.id,pe),B.appendChild(pe),B.append(`Show ${O.label}`),H.appendChild(B)}oe.appendChild(H),ee.appendChild(oe),A.appendChild(ee),v.appendChild(A);const ae=document.createElement("section");ae.className="config-overlay__section config-overlay__section--grow",ae.dataset.section="credits",ae.innerHTML=`
    <div class="credits-list" data-credits></div>
  `;const Z=ae.querySelector("[data-credits]"),ke=Yo();if(Z.innerHTML="",ke.length===0){const O=document.createElement("div");O.className="credits-list__entry",O.textContent="To be credited...",Z.appendChild(O)}else for(const O of ke)if(O.header){const B=document.createElement("div");B.className="credits-list__heading",B.textContent=O.text,Z.appendChild(B)}else{const B=document.createElement("div");B.className="credits-list__entry";const pe=document.createElement("span");if(pe.className="credits-list__text",O.url){const q=document.createElement("a");q.className="credits-list__link",q.href=O.url,q.target="_blank",q.rel="noopener noreferrer",q.textContent=O.text,pe.appendChild(q)}else pe.textContent=O.text;B.appendChild(pe),Z.appendChild(B)}const me=document.createElement("div");me.className="config-overlay__footer";const ne=document.createElement("button");ne.className="run-button",ne.type="button",ne.textContent="Run",me.appendChild(ne),c.appendChild(u),c.appendChild(g),c.appendChild(v),c.appendChild(ae),c.appendChild(me),i.appendChild(a),i.appendChild(c),s.appendChild(i),t.appendChild(s),n.appendChild(t);let V=Ut(e.advancedSettings),Ce="closed",je=!e.advancedSettings.lockedScaleId;const Ye=Go(k,e.simClass,e.values,e.onValuesChange),ft=to(S,e.theme,e.onThemeChange);p.addEventListener("click",e.onClose),W.addEventListener("click",()=>{if(Ce==="open"){$e("closed");return}$e("auth"),z.focus()}),J.addEventListener("click",Ee),z.addEventListener("keydown",O=>{O.key==="Enter"&&Ee()}),ie.addEventListener("change",()=>{V.lockedScaleId=ie.value||null,re()}),he.addEventListener("change",()=>{he.checked&&(V.manifestSource="local")}),N.addEventListener("change",()=>{N.checked&&(V.manifestSource="online")}),U.addEventListener("change",()=>{V.verboseLogging=U.checked}),C.addEventListener("change",()=>{V.audioMutedByDefault=C.checked}),F.addEventListener("input",()=>{V.defaultAudioVolume=Number(F.value)/100,en()}),we.addEventListener("change",()=>{V.lockFullscreen=we.checked});for(const[O,B]of K.entries())B.addEventListener("change",()=>{if(Array.from(K.entries()).filter(([,q])=>q.checked).map(([q])=>q).length===0&&!V.lockedScaleId){B.checked=!0;return}V.hiddenScaleIds=Array.from(K.keys()).filter(q=>{var ht;return!((ht=K.get(q))!=null&&ht.checked)&&q!==V.lockedScaleId}),re()}),O===V.lockedScaleId&&(B.disabled=!0);j(e.initialView??"parameters"),re(),Ge(je);function j(O){c.dataset.view=O,O==="parameters"?(h.textContent=e.simClass.label,m.textContent="Shape Your Simulation",y.textContent=e.simClass.parameterSubtitle??"Adjust the parameters, inspect the setup, and press 'Run' when you're ready.",o.textContent=e.simClass.label,o.hidden=!1,r.src=e.simClass.placeholderImage,r.alt=`${e.simClass.label} preview`):O==="settings"?(h.textContent="Interface",m.textContent="Adjust The Control Room",y.textContent="Change the interface theme and manage exhibit-level options for this installation.",o.textContent="",o.hidden=!0,r.src=se("assets/Cluster_Stuart.webp"),r.alt="Galaxy cluster simulation preview"):(h.textContent="References",m.textContent="Project Sources And Attribution",y.textContent="Review the datasets, imagery, and supporting materials behind this experience.",o.textContent="",o.hidden=!0,r.src=se("assets/synthetic_hst_pretty_galaxy.webp"),r.alt="Synthetic galaxy image preview"),O==="settings"?ne.textContent="Apply":ne.textContent="Run Simulation",me.hidden=O==="credits",tn()}function re(){ie.value=V.lockedScaleId??"",he.checked=V.manifestSource==="local",N.checked=V.manifestSource==="online",U.checked=V.verboseLogging,C.checked=V.audioMutedByDefault,we.checked=V.lockFullscreen,F.value=String(Math.round(V.defaultAudioVolume*100)),en();for(const[O,B]of K.entries()){const pe=V.lockedScaleId===O;B.checked=pe||!V.hiddenScaleIds.includes(O),B.disabled=pe}}function Ee(){if(z.value!==Jo){Y.textContent="Incorrect password";return}z.value="",Y.textContent="",$e("open")}function $e(O){Ce=O,A.dataset.state=O,W.textContent=O==="open"?"Hide Advanced Settings":"Advanced Settings",O!=="auth"&&(Y.textContent="")}function qe(){z.value="",Y.textContent="",$e("closed")}function st(){V=Ut(e.advancedSettings),re()}function en(){E.textContent=`${Math.round(Number(F.value))}%`}function tn(){const O=c.dataset.view,B=O==="settings"||O==="credits"||je;p.hidden=!B,p.classList.toggle("is-hidden",!B),p.setAttribute("aria-label",O==="parameters"?"Back":"Close"),p.textContent=O==="parameters"?"←":"×"}function Ge(O){je=O,tn()}return ne.addEventListener("click",()=>{if(c.dataset.view==="settings"){e.onApplySettings(Ut(V));return}e.onRun()}),{show(){t.hidden=!1,t.classList.remove("is-hidden")},hide(){t.hidden=!0,t.classList.add("is-hidden"),st(),qe()},setSimulation(O,B){e.simClass=O,a.dataset.simClass=O.id,Ye.setSimClass(O,B),c.dataset.view==="parameters"&&(r.src=O.placeholderImage,r.alt=`${O.label} preview`,j("parameters"))},setTheme(O){ft.setActive(O)},setView(O){j(O),O!=="settings"&&qe()},setAdvancedSettings(O){e.advancedSettings=Ut(O),V=Ut(O),re(),qe()},setBackVisible:Ge}}function Ut(n){return{lockedScaleId:n.lockedScaleId,manifestSource:n.manifestSource,verboseLogging:n.verboseLogging,hiddenScaleIds:[...n.hiddenScaleIds],audioMutedByDefault:n.audioMutedByDefault,defaultAudioVolume:n.defaultAudioVolume,lockFullscreen:n.lockFullscreen}}function nl(n){const{TYPING_MS_PER_CHAR:e,MIN_TERMINAL_TIME_MS:t,FINAL_PAUSE_MS:s}=ls,i=document.createElement("section");i.className="overlay overlay--initializing",i.hidden=!0,i.classList.add("is-hidden");const a=document.createElement("div");a.className="terminal";const r=document.createElement("div");r.className="terminal__header",r.innerHTML=`
    <div class="terminal__header-left">
      <span class="terminal__dot"></span>
      <span class="terminal__header-label">UNIVERSE_ENGINE_v9.5.1</span>
    </div>
  `;const o=document.createElement("div");o.className="terminal__log",a.appendChild(r),a.appendChild(o),i.appendChild(a),n.appendChild(i);let l=[],c=0;function u(){for(const y of l)window.clearTimeout(y);l=[]}function f(y,p){return new Promise(g=>{const k=window.setTimeout(()=>{p===c&&g()},Math.max(0,y));l.push(k)})}async function h(y,p){const g=document.createElement("div");g.className="terminal__line";const k=m();g.appendChild(k),o.appendChild(g);for(let v=0;v<y.length;v+=1){if(p!==c)return;const S=y[v];g.insertBefore(document.createTextNode(S),k),o.scrollTop=o.scrollHeight,await f(e,p)}k.remove()}function m(){const y=document.createElement("span");return y.className="terminal__cursor",y.textContent="█",y}return{async show(y,p,g,k){u(),c+=1;const v=c;i.hidden=!1,i.classList.remove("is-hidden");const S=performance.now(),_=(k==null?void 0:k.minTerminalTimeMs)??t;let L=!g,w=[...y];g&&g.then(()=>{L=!0});let I=0;for(;v===c;){w.length===0&&(w=[...y]);const x=Math.floor(Math.random()*w.length),[M]=w.splice(x,1),F=`${ti(I)} ${M.text}`;if(I+=1,await h(F,v),v!==c)return;if(performance.now()-S>=_&&L)break}if(v!==c)return;const C=document.createElement("div");C.className="terminal__line terminal__line--syncing",C.textContent=`${ti(I)} STARTING SIMULATION...`,o.appendChild(C),o.scrollTop=o.scrollHeight,await f(s,v),v===c&&p()},hide(){u(),c+=1,i.hidden=!0,i.classList.add("is-hidden"),o.innerHTML=""}}}function ti(n){const e=Math.max(0,Math.floor(n)),t=Math.floor(e/3600),s=Math.floor(e%3600/60),i=e%60;return`[${Qn(t)}:${Qn(s)}:${Qn(i)}]`}function Qn(n){return String(n).padStart(2,"0")}function sl(n,e){const t=document.createElement("button");t.className="display-button",t.type="button",t.innerHTML="<span></span><span></span><span></span>",t.setAttribute("aria-label","Open configuration overlay"),n.appendChild(t);const s=document.createElement("div");s.className="display-menu";const i=document.createElement("div");i.className="display-menu__header",i.textContent="Menu",s.appendChild(i);const a=c("Home",()=>{u(),e.onHome()}),r=c("Select Parameters",()=>{u(),e.onParameters()});s.appendChild(a),s.appendChild(r),s.appendChild(c("Settings",()=>{u(),e.onViewSelected("settings")})),s.appendChild(c("Credits",()=>{u(),e.onViewSelected("credits")}));const o=c("Fullscreen",()=>{var h;u(),document.fullscreenElement?document.exitFullscreen():(h=document.getElementById("app"))==null||h.requestFullscreen()});o.classList.add("display-menu__fullscreen"),s.appendChild(o),n.appendChild(s);function l(){const h=o.querySelector(".display-menu__item-label");h&&(h.textContent=document.fullscreenElement?"Exit Fullscreen":"Fullscreen");const m=document.getElementById("app");m&&m.classList.toggle("is-fullscreen",!!document.fullscreenElement)}return document.addEventListener("fullscreenchange",l),t.addEventListener("click",()=>{n.classList.toggle("open")}),document.addEventListener("click",h=>{n.contains(h.target)||u()}),f(e.showHome??!0),{close:u,setHomeVisible:f,setFullscreenVisible(h){o.hidden=!h,o.classList.toggle("is-hidden",!h)}};function c(h,m){const y=document.createElement("button");return y.className="display-menu__item",y.type="button",y.innerHTML=`
...
`,dl={planetary:ll,galaxy:cl,cosmos:ul};function fl(n){return Xe(dl[n.id]).map(t=>({text:t}))}function zt(n,e,t,s){if(e.length===0)return 0;const i=s?e.filter(r=>s.has(r.id)):e;return i.length===0?0:i.reduce((r,o)=>{var f;const l=t[o.id]??o.fallbackValue,c=((f=n.parameters)==null?void 0:f[o.id])??o.fallbackValue,u=Math.max(o.max-o.min,1e-9);return r+Math.abs(l-c)/u},0)/i.length}function hl(n,e,t){if(n.length===0)return null;const s=new Set(e.filter(u=>u.primary!==!1).map(u=>u.id)),i=new Set(e.filter(u=>u.primary===!1).map(u=>u.id));if(!e.some(u=>u.primary===!1))return Xn(n,e,t);const r=Xn(n,e,t,s);if(!r)return null;const o=zt(r,e,t,s),l=1e-6,c=n.filter(u=>{const f=zt(u,e,t,s);return Math.abs(f-o)<=l});return Xn(c,e,t,i)}function Xn(n,e,t,s){if(n.length===0)return null;let i=n[0],a=zt(i,e,t,s);for(const r of n.slice(1)){const o=zt(r,e,t,s);o<a&&(i=r,a=o)}return i}function ml(n){return n.replace(/\.mp4($|\?)/,".yaml$1")}async function pl(n){try{const e=await tt(n);if(!e.ok)return null;const t=await e.text(),s=Xe(t),i=vt(s.wallclockSeconds),a=vt(s.computeUsed),r=vt(s.memoryUsed),o=vt(s.carbonBurnt),l=vt(s.particlesUpdated),c=await gl(n),u=bl(s.summaryMetrics);return i===null||a===null||r===null||o===null||l===null?null:{wallclockSeconds:i,computeUsed:a,memoryUsed:r,carbonBurnt:o,particlesUpdated:l,parameterValues:c,summaryMetrics:u}}catch{return null}}async function gl(n){try{const e=await tt(yl(n));if(!e.ok)return{};const t=await e.text(),s=Xe(t);return vl(s)}catch{return{}}}function yl(n){return n.replace(/run_summary\.yaml($|\?)/,"parameters.yaml$1")}function vt(n){const e=typeof n=="number"?n:Number(n);return Number.isFinite(e)?e:null}function bl(n){if(!n||typeof n!="object")return{};const e=n,t={};for(const[s,i]of Object.entries(e)){if(!i||typeof i!="object")continue;const a=i,r=typeof a.label=="string"?a.label:s,o=a.value;o!=null&&(t[s]={label:r,value:String(o)})}return t}function vl(n){if(!n||typeof n!="object")return{};const e={};for(const[t,s]of Object.entries(n)){const i=vt(s);i!==null&&(e[t]=i)}return e}const sa="[UniverseEngine]";let ia=!1;function ni(n){ia=n}function aa(){return ia}function de(n,e){aa()&&console.info(sa,n,e??"")}function Je(n,e){aa()&&console.warn(sa,n,e??"")}const wl={local:"assets/local-manifest.json",online:Gi};function _l(n="local"){let e=n;const t=new Map,s=new Map;return{getSource(){return e},setSource(i){t.delete(i),s.delete(i),io(),e=i,de("Manifest source updated",{source:i})},async preloadActiveManifest(){await oa(e,t,s)},async findNearestVideo(i,a,r){const o=await El(e,t,s,i,a,r);if(o)return o;const l=ra(i);return Je("Falling back to placeholder assets",{simClassId:i,source:e,fallbackUrl:l}),{url:l,liveDataUrl:Sl(i),summaryUrl:ml(l)}}}}function ra(n){switch(n){case"planetary":return se("assets/planet_test.mp4");case"galaxy":return se("assets/galaxy_test.mp4");case"cosmos":return se("assets/cosmo_test.mp4");default:return se("assets/galaxy_test.mp4")}}function Sl(n){switch(n){case"planetary":return se("assets/planet_test_planetary_stats.csv");case"galaxy":return se("assets/galaxy_test_galaxy_stats.csv");case"cosmos":return se("assets/cosmo_test_cosmos_stats.csv");default:return se("assets/galaxy_test_galaxy_stats.csv")}}async function oa(n,e,t){const s=e.get(n);if(s)return s;const i=wl[n],a=(n==="online"?kl(i):fetch(se(i),{cache:"no-store"}).then(async r=>{if(!r.ok)throw new Error(`Failed to load manifest: ${i}`);return de("Loaded manifest",{source:n,manifestPath:i}),await r.json()})).then(r=>(t.set(n,Il()),r)).catch(r=>(t.delete(n),Je("Manifest unavailable",{source:n,manifestPath:i,error:r instanceof Error?r.message:String(r)}),{version:1,runs:[]}));return e.set(n,a),a}async function kl(n){const e=[n,Jn];for(const t of e)try{const s=await fetch(t,{cache:"no-store"});if(!s.ok)continue;const i=await s.json(),a=i.primaryBase??si(Gi),r=i.backupBase??si(Jn);return so(a,r),t===Jn&&ao("backup"),de("Loaded manifest",{source:"online",manifestPath:t,primaryBase:a,backupBase:r}),i}catch{continue}throw new Error(`Failed to load manifest: ${n}`)}async function El(n,e,t,s,i,a){const o=(await oa(n,e,t)).runs.filter(h=>h.simulationId===s);if(o.length===0)return Je("No manifest runs found for simulation",{simClassId:s,source:n}),null;const l=hl(o,i,a);if(!l)return null;const c=zt(l,i,a),u=l.defaultView??Object.keys(l.views)[0],f=l.views[u];return f?(de("Selected manifest-backed run",{simClassId:s,source:n,runId:l.runId,selectedValues:a,distance:c,viewId:u}),{url:Dt(n,f,t),liveDataUrl:Dt(n,l.liveDataPath,t),summaryUrl:Dt(n,l.summaryPath,t),audioUrl:l.audioPath?Dt(n,l.audioPath,t):void 0,viewId:u,runId:l.runId,views:Object.fromEntries(Object.entries(l.views).map(([h,m])=>[h,Dt(n,m,t)]))}):null}function Dt(n,e,t){const s=n==="local"?se(e):Ke(e),i=t.get(n);return i?Hi(s,"_manifest",i):s}function Il(){return`${Date.now()}`}function si(n){const e=new URL(n);return`${e.protocol}//${e.host}`}const qt={mode:"time",frames:[]};async function Ll(n){const e=await tt(n);if(!e.ok)throw new Error(`Failed to load live stats CSV: ${n}`);const t=await e.text();return Al(t)}function Nl(n,e,t=0){if(n.mode==="row")return Tl(n.frames,e,t);const s=n.frames;if(s.length===0)return{};if(e<=s[0].t)return{...s[0].values};const i=s[s.length-1];if(e>=i.t)return{...i.values};const a=Cl(s,e),r=s[Math.max(0,a-1)],o=s[Math.min(s.length-1,a)],l=(e-r.t)/Math.max(o.t-r.t,1e-9);return Ml(r.values,o.values,l)}function Cl(n,e){let t=1,s=n.length-1;for(;t<s;){const i=Math.floor((t+s)/2);n[i].t<=e?t=i+1:s=i}return t}function Al(n){const e=n.split(/\r?\n/).map(s=>s.trim()).filter(Boolean);if(e.length<2)return qt;const t=Zn(e[0]);return t[0]==="t"?{mode:"time",frames:e.slice(1).map(s=>{const i=Zn(s),a={};for(let r=1;r<t.length;r+=1)a[t[r]]=i[r]??"";return{t:parseFloat(i[0]??"0")||0,values:a}})}:{mode:"row",frames:e.slice(1).map((s,i)=>{const a=Zn(s),r={};for(let o=0;o<t.length;o+=1)r[t[o]]=a[o]??"";return{t:i,values:r}})}}function Tl(n,e,t){if(n.length===0)return{};if(!Number.isFinite(t)||t<=0)return{...n[0].values};const s=Math.max(0,Math.min(1,e/t)),i=Math.round(s*(n.length-1));return{...n[i].values}}function Zn(n){const e=[];let t="",s=!1;for(let i=0;i<n.length;i+=1){const a=n[i];if(a==='"'){s=!s;continue}if(a===","&&!s){e.push(t),t="";continue}t+=a}return e.push(t),e}function Ml(n,e,t){const s=new Set([...Object.keys(n),...Object.keys(e)]),i={};for(const a of s){const r=n[a]??"",o=e[a]??r,l=parseFloat(r),c=parseFloat(o);if(Number.isFinite(l)&&Number.isFinite(c)){const u=l+(c-l)*t;i[a]=Ol(u);continue}i[a]=t<.5?r:o}return i}function Ol(n){return n.toFixed(2).replace(new RegExp("\\.0+$|(?<=\\..*?)0+$","g"),"").replace(/\.$/,"")}function Pl(n){xl(Ao,n)}function xl(n,e){if(navigator.sendBeacon){const t=new Blob([JSON.stringify(e)],{type:"application/json"});if(navigator.sendBeacon(n,t)){de("Run selection tracking dispatched",{simulationId:e.simulationId});return}}fetch(n,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),keepalive:!0}).then(t=>{t.ok?de("Run selection tracked",{simulationId:e.simulationId}):Je("Run selection tracking rejected",{simulationId:e.simulationId,status:t.status})}).catch(t=>{Je("Run selection tracking failed",{simulationId:e.simulationId,error:t instanceof Error?t.message:String(t)})})}const ii=50*1024*1024,Rl=8,$l=6e3,Fl=8e3,Bl=7e3,Vl=1200,Ul=100,Dl="(max-width: 768px), (max-height: 450px)",Hl="(hover: none), (pointer: coarse)",jl=2e3,ql=250,Kl=1,Wl=1500,es={galaxy:"tron",planetary:"matrix",cosmos:"hal"};function Yl(n){const e=bt.map(d=>d.id);let t=Qo(e),s=xs(t);const i=_l(t.manifestSource),a=ol(),r=window.matchMedia(Dl),o=window.matchMedia(Hl);ni(t.verboseLogging),t.manifestSource==="online"&&i.preloadActiveManifest();let l=Rs(t.lockedScaleId)??s[0]??bt[0],c=t.lockedScaleId?es[l.id]:eo(),u=!1,f=0,h=null,m=null,y=!1,p=t.audioMutedByDefault,g=t.defaultAudioVolume,k=0;const v=new Set;let S=null,_=0,L=qt,w=null,I=0,C=!r.matches,x=!1;const M=Object.fromEntries(bt.map(d=>[d.id,_a(d)]));Wn(c);const F=ra(l.id),E=oo(n,F),A=document.createElement("audio");A.preload="auto",A.hidden=!0,A.setAttribute("playsinline","true"),A.muted=p,A.volume=g,n.appendChild(A);const W=document.createElement("div");W.className="display-chrome",W.classList.add("is-hidden"),n.appendChild(W);const fe=document.createElement("div");fe.className="orientation-overlay",fe.innerHTML=`
  ...
  `,n.appendChild(z);const J=document.createElement("div");J.className="synth-logo is-hidden",J.innerHTML=`
    ...
    <img
      ...
      decoding="async"
    />
  `,n.appendChild(J);const Y=document.createElement("img");Y.className="app-partner-logo",Y.src=se("assets/dirac-hpc-white.webp"),Y.alt="DIRAC HPC",Y.decoding="async",n.appendChild(Y);const ee=document.createElement("div");ee.className="display-chrome__top-left is-hidden",n.appendChild(ee);const be=sl(ee,{onHome(){Rn()},onParameters(){xt("parameters")},onViewSelected(d){if(d==="credits"){xt("credits");return}xt(d)},showHome:!t.lockedScaleId});be.setFullscreenVisible(!t.lockFullscreen);const ie=document.createElement("div");ie.className="display-chrome__left-center",W.appendChild(ie);const ve=jo(ie,{onSelect(d){As(d)},onInfo(d,b,T){Ne.textContent=b,he.textContent=T,Q.classList.add("is-visible")}}),Q=document.createElement("div");Q.className="view-info-overlay",Q.innerHTML=`
  ...
  `,W.appendChild(D);const we=al();E.setPlaybackRate(we);const Se=document.createElement("div");Se.className="display-chrome__bottom",W.appendChild(Se);const oe=co(Se,{onChange(d){j(d)},onTogglePlay:Cs,onAudioToggle:ma,onSpeedChange:pa,onSummaryClick:ha,onScrubStart(){en(),ft()},onScrubEnd(){tn(),E.isPaused()||Ye()},initialSpeed:we});oe.setPlaying(!E.isPaused()),oe.setAudioVisible(!1),oe.setMuted(p),A.addEventListener("loadedmetadata",()=>{A.playbackRate=E.getPlaybackRate(),$t({force:!0}),Ae()});let H=null,K=null,ae=null,Z=!1,ke=!1,me=0,ne=!1,V=null,Ce=0,je=Number.NEGATIVE_INFINITY;function Ye(){if(H!==null)return;function d(){const b=E.getPlaybackFraction();oe.setPosition(b),E.isPaused()?H=null:H=requestAnimationFrame(d)}H=requestAnimationFrame(d)}function ft(){H!==null&&(cancelAnimationFrame(H),H=null)}function j(d){K=d,ae===null&&(ae=requestAnimationFrame(()=>{if(ae=null,K===null)return;const b=K;K=null,E.seekToFraction(b)}))}function re(){if(K===null)return;ae!==null&&(cancelAnimationFrame(ae),ae=null);const d=K;K=null,E.seekToFraction(d)}function Ee(){V!==null&&(window.clearTimeout(V),V=null)}function $e(){if(!(S!=null&&S.views))return[];const d=pt(l,S);return Object.entries(S.views).filter(([b])=>b!==d).map(([,b])=>Ke(b)).filter(Boolean)}function qe(){Ee(),E.suspendPrewarming()}function st(d=Vl){Ee(),!(Z||E.isPaused())&&(V=window.setTimeout(()=>{V=null,!(Z||E.isPaused())&&(E.resumePrewarming(),E.prewarmSources($e()))},Math.max(0,d)))}function en(){Z||(me+=1,ne=!1,ke=!E.isPaused(),Z=!0,Ce=0,qe(),E.pause(),Ae())}async function tn(){if(!Z)return;const d=++me;Z=!1,Ce=0,re(),await E.waitForSeekSettled(ql),d===me&&($t({force:!0}),_=E.getCurrentTimeSeconds(),Ze(_),ke&&(ne=!0,hn(E)),st(),Ae({forceAudioSync:!1}))}E.onPlayStateChange(d=>{if(oe.setPlaying(!d),d?(ft(),qe()):(Ye(),st(0)),!d&&ne){ne=!1;return}Ae()}),E.onTimeUpdate(d=>{if(_=d*E.getDurationSeconds(),Z){const b=performance.now();if(b-Ce<Ul)return;Ce=b}Ze(_),!Z&&$t()});const Ge=document.createElement("div");Ge.className="overlay-layer",n.appendChild(Ge);const O=Yi();O.infoButton.classList.add("is-hidden"),O.infoButton.hidden=!0,n.appendChild(O.infoButton),n.appendChild(O.infoModal);const B=Uo(Ge,{onReplay:fa,onParameters:()=>xt("parameters"),onHome:Rn,showHome:!t.lockedScaleId});E.onEnded(()=>{u=!0,f+=1;const d=E.captureFrame();B.update(l,Me(),E.getDurationSeconds(),h,d,f),B.show(),Ae()});const pe=ko(Ge,s,d=>{Ns(d),xt("parameters")}),q=tl(Ge,{simClass:l,values:Me(),theme:c,advancedSettings:t,availableScales:bt,onValuesChange:ca,onThemeChange:xn,onRun:()=>{de("Parameters submitted — starting run",{simClassId:l.id}),ga().catch(d=>{Je("Run failed to start",{simClassId:l.id,error:d instanceof Error?d.message:String(d)})})},onResetGalaxyChecklist:()=>{B.resetGalaxyChecklist()},onApplySettings:ua,onClose:da,initialView:"parameters"});q.setBackVisible(!t.lockedScaleId);const ht=nl(Ge);oe.setPosition(0),Ze(),B.hide();const it=new WeakMap,Fe=d=>{const b=it.get(d);b&&(clearTimeout(b),it.delete(d)),d.classList.remove("side-collapsed")},Ot=d=>{const b=it.get(d);b&&clearTimeout(b),it.set(d,setTimeout(()=>{d.classList.add("side-collapsed"),it.delete(d)},jl))},nn=d=>{const b=it.get(d);b&&(clearTimeout(b),it.delete(d)),d.classList.add("side-collapsed")},Pn=(d,b)=>{const T=b.isCollapsible??(()=>!0);d.addEventListener("mouseenter",()=>Fe(d)),d.addEventListener("mouseleave",()=>{if(!T()){Fe(d);return}Ot(d)}),d.addEventListener("focusin",()=>Fe(d)),d.addEventListener("focusout",R=>{if(!d.contains(R.relatedTarget)){if(!T()){Fe(d);return}Ot(d)}}),d.addEventListener("click",()=>{if(!T()){Fe(d);return}if(d.classList.contains("side-collapsed")){Fe(d),Ot(d);return}b.toggleOnClick?nn(d):Ot(d)}),T()?nn(d):Fe(d)};function la(){return o.matches}Pn(ee,{toggleOnClick:!0,isCollapsible:()=>n.dataset.mode==="display"}),Pn(ie,{toggleOnClick:!0}),Pn(Se,{toggleOnClick:!1,isCollapsible:()=>!1});let Pt=0,mt=null,sn=0;const Is=()=>{mt!==null&&(cancelAnimationFrame(mt),mt=null)},Ls=()=>{if(mt!==null)return;sn=E.getPlaybackFraction();const d=()=>{if(Pt===0){Is();return}const T=12*(1/60)/Math.max(E.getDurationSeconds(),1);sn=Math.max(0,Math.min(1,sn+Pt*T)),E.seekToFraction(sn),mt=requestAnimationFrame(d)};mt=requestAnimationFrame(d)};document.addEventListener("keydown",d=>{if(n.dataset.mode==="display"&&!(d.target instanceof HTMLInputElement||d.target instanceof HTMLTextAreaElement))switch(d.key){case"Escape":d.preventDefault(),Q.classList.contains("is-visible")?Q.classList.remove("is-visible"):Rn();break;case" ":d.preventDefault(),Cs();break;case"ArrowLeft":d.preventDefault(),Fe(Se),Pt=-1,Ls();break;case"ArrowRight":d.preventDefault(),Fe(Se),Pt=1,Ls();break;case"ArrowUp":case"ArrowDown":{if(d.preventDefault(),Fe(ie),Ot(ie),!(S!=null&&S.views)||Object.keys(S.views).length<=1)break;const b=l.views.filter(ge=>{var _e;return((_e=S==null?void 0:S.views)==null?void 0:_e[ge.id])!==void 0});if(b.length<=1)break;const T=S.viewId??pt(l,S),R=b.findIndex(ge=>ge.id===T),te=d.key==="ArrowUp"?(R-1+b.length)%b.length:(R+1)%b.length;As(b[te].id);break}}}),document.addEventListener("keyup",d=>{(d.key==="ArrowLeft"||d.key==="ArrowRight")&&(Pt=0,Is())}),E.hideMedia(),E.pause(),at(t.lockedScaleId?"config":"entry");function Ns(d){d.id===l.id&&x||(l=d,Fn(),xn(es[d.id]),q.setSimulation(l,Me()),oe.setPosition(0),Ze(),an(),$n())}function ca(d){M[l.id]={...d},de("Parameter values updated",{simClassId:l.id,values:M[l.id]}),Ze()}function xn(d){c=d,Wn(d),q.setTheme(d)}function xt(d){d==="parameters"&&q.setSimulation(l,Me()),q.setView(d),at("config")}function ua(d){if(Oa(d),x){B.hide(),at("display");return}q.setSimulation(l,Me()),q.setView("parameters")}function da(){if(B.hide(),!x&&t.lockedScaleId){q.setSimulation(l,Me()),q.setView("parameters");return}at(x?"display":"entry")}function Rn(){t.lockedScaleId||(de("Returning to home screen",{simClassId:l.id}),Fn(),x=!1,E.hideMedia(),at("entry"))}function fa(){u=!1,B.hide(),E.getPlaybackFraction()>=.999&&(E.resetPlayback(),$t({force:!0})),hn(E),Ae()}function ha(){u=!0,f+=1,E.pause();const d=h?E.captureFrame():null;B.update(l,Me(),E.getDurationSeconds(),h,d,f),B.show(),Ae()}function Cs(){E.isPaused()?hn(E):E.pause()}function ma(){p=!p,Ae()}function pa(d){E.setPlaybackRate(d),A.playbackRate=d,rl(d),oe.setSpeed(d)}async function ga(){const d=Me(),b=a.start();I=b,de("Run requested",{simClassId:l.id,values:d,manifestSource:i.getSource()});const T=await i.findNearestVideo(l.id,l.parameters,d);if(!a.isCurrent(b))return;Fn({preserveRunRequest:!0}),S=T;const R=pt(l,T),te=ro(i.getSource());Pl({simulationId:l.id,parameters:d,manifestSource:i.getSource(),matchedRunId:T.runId,assetHostMode:te.mode,assetHostBase:te.base});const ge=Ia(T,R)??T.url,_e=Object.entries(T.views??{}).filter(([Be])=>Be!==R).map(([,Be])=>Be);w=T.liveDataUrl,Ts(T.liveDataUrl,b),ka(T.summaryUrl,b),Na(T.summaryUrl,b,T.audioUrl),E.setMuted(!0),an(R),Rt(),at("initializing");const rn=ya(ge);E.resumePrewarming(),E.prewarmSources(_e);const Ft=(async()=>{const Be=await rn;a.isCurrent(b)&&(de(`Prepared active video source: ${Be.ownedObjectUrl?"FULL-FETCH":"PROGRESSIVE"}`,{selectedViewUrl:ge,waitsForBuffer:Be.shouldWaitForBuffer}),E.setSource(Be.src,{ownedObjectUrl:Be.ownedObjectUrl}),E.pause(),await E.waitForLoadedData(Fl),a.isCurrent(b)&&Be.shouldWaitForBuffer&&await E.waitForBufferedAhead(Rl,$l))})();await new Promise(Be=>{ht.show(fl(l),Be,Ft,{minTerminalTimeMs:Ta()})}),a.isCurrent(b)&&(x=!0,E.showMedia(),hn(E),at("display"),Ae())}async function ya(d){const b=Ke(d),T=await ba(d);if(T!==null&&T>0&&T<=ii){de("Downloading active video behind loading overlay",{videoUrl:b,contentLength:T});try{const R=await tt(d);if(!R.ok)throw new Error(`Failed to download active video: ${b}`);const te=await R.blob();return de(`Active video full fetch complete: ${te.size} bytes`,{videoUrl:Ke(d),blobType:te.type}),{src:URL.createObjectURL(te),ownedObjectUrl:!0,shouldWaitForBuffer:!1}}catch(R){Je(`Full-fetch FAILED; falling back to progressive: ${R instanceof Error?R.message:String(R)}`,{videoUrl:d})}}return T!==null?de("Active video exceeds full-fetch threshold; using progressive load",{videoUrl:d,contentLength:T,fullFetchMaxBytes:ii}):de("Could not determine active video size; using progressive load",{videoUrl:d}),de("Using progressive active video load",{videoUrl:d}),{src:Ke(d),ownedObjectUrl:!1,shouldWaitForBuffer:!0}}async function ba(d){try{const b=await tt(d,{headers:{Range:"bytes=0-0"}});de("Probed active video size with range request",{videoUrl:d,ok:b.ok,status:b.status,contentLength:b.headers.get("Content-Length"),contentRange:b.headers.get("Content-Range")});const T=wa(b.headers.get("Content-Length"));if(T!==null)return T;const R=va(b.headers.get("Content-Range"));return R!==null?R:null}catch(b){return Je("Could not probe active video size",{videoUrl:d,error:b instanceof Error?b.message:String(b)}),null}}function va(d){if(!d)return null;const b=d.match(/bytes\s+\d+-\d+\/(\d+)/i);if(!b)return null;const T=Number(b[1]);return Number.isFinite(T)&&T>0?T:null}function wa(d){if(!d)return null;const b=Number(d);return Number.isFinite(b)?b:null}function at(d){if(n.dataset.mode=d,d==="entry"?document.documentElement.setAttribute("data-theme","glass"):d==="display"&&Wn(c),rt(W,d==="display"||d==="config"),rt(z,d==="display"||d==="entry"),rt(ee,d==="entry"||d==="config"||d==="display"),rt(O.infoButton,d==="config"&&!!t.lockedScaleId),(d!=="config"||!t.lockedScaleId)&&O.close(),d!=="display"?Fe(ee):nn(ee),d==="entry"&&!t.lockedScaleId?pe.show():pe.hide(),d==="config"?(ht.hide(),q.setSimulation(l,Me()),q.show()):q.hide(),d!=="display")B.hide(),ve.hide(),N.classList.add("is-hidden"),N.innerHTML="";else if(u){const T=E.captureFrame();B.update(l,Me(),E.getDurationSeconds(),h,T,f),B.show()}else an();!x||d==="initializing"?(E.hideMedia(),d==="initializing"&&E.pause()):E.showMedia(),d!=="initializing"&&ht.hide(),$n(),Ae()}function $n(){if(n.dataset.mode==="entry"){rt(J,!0);return}const d=n.dataset.mode==="display",b=l.id==="galaxy";rt(J,d&&b)}function Ze(d=0){if(!C)return;const b=Nl(L,d,E.getDurationSeconds()),T=Ea(l,h,d,E.getDurationSeconds());U.update(l,Me(),{...b,...T})}function an(d){const b=l.views.filter(te=>{var ge;return((ge=S==null?void 0:S.views)==null?void 0:ge[te.id])!==void 0});if(b.length<=1){ve.hide(),N.classList.add("is-hidden");return}const T=d??pt(l,S),R=b.find(te=>te.id===T);ve.update(b,T),R?(N.classList.remove("is-hidden"),N.innerHTML=`<span class="viewport-title">${R.label??R.id}</span>`):N.classList.add("is-hidden")}function Fn(d={}){d.preserveRunRequest||(a.invalidate(),I=0),L=qt,w=null,u=!1,h=null,S=null,_=0,Z=!1,ke=!1,me+=1,ne=!1,K=null,Ee(),ae!==null&&(cancelAnimationFrame(ae),ae=null),B.hide(),ve.hide(),N.classList.add("is-hidden"),N.innerHTML="",E.pause(),A.pause(),E.clearPrewarmedSources(),E.resetPlayback(),oe.setPosition(0),Ps()}function As(d){if(la()&&nn(ie),!(S!=null&&S.views)||d===pt(l,S))return;const b=Ke(S.views[d]);if(!b)return;S.viewId=d;const T=!E.isPaused()&&!u,R=u?0:E.getPlaybackFraction();u=!1,B.hide(),E.setSource(b,{seekFraction:R,autoplay:T}),E.prewarmSources($e()),T&&!Z?st():qe(),an(d),Rt(),Ae(),Q.classList.remove("is-visible"),$n()}function Me(){return{...M[l.id]}}function _a(d){return Object.fromEntries(d.parameters.map(b=>[b.id,Sa(b)]))}function Sa(d){if(d.logScale){const ge=Math.log10(d.min),_e=Math.log10(d.max);return 10**(ge+Math.random()*(_e-ge))}const b=Math.max(0,Math.round((d.max-d.min)/d.step)),T=Math.floor(Math.random()*(b+1)),R=d.min+T*d.step,te=Wi(d.step);return Number(R.toFixed(te))}async function Ts(d,b){if(!C){L=qt;return}let T=qt;try{T=await Ll(d)}catch(R){Je("Failed to load live stats",{url:d,error:R instanceof Error?R.message:String(R)})}a.isCurrent(b)&&(L=T,Ze())}async function ka(d,b){const T=await pl(d);a.isCurrent(b)&&(h=T,Ze(_))}function Ea(d,b,T,R){if(!b||!Number.isFinite(R)||R<=0)return{};const te=Math.max(0,Math.min(1,T/R)),ge={};for(const _e of d.metadata.liveStats){if(!_e.live||!_e.fromVideo||!_e.scaleWithTime)continue;const rn=_e.videoKey??_e.id,Ft=b[rn];if(typeof Ft!="number"||!Number.isFinite(Ft))continue;const Bn=Ft*te;ge[_e.id]=_e.integer?String(Math.floor(Bn)):String(Bn)}return ge}function rt(d,b){d.hidden=!b,d.classList.toggle("is-hidden",!b)}function pt(d,b){return b!=null&&b.views?b.viewId??Object.keys(b.views)[0]:b==null?void 0:b.viewId}function Ia(d,b){return!b||!d.views?null:d.views[b]??null}function Ms(){const d=pt(l,S);return d?l.views.some(b=>b.id===d&&b.audio):!1}function La(d,b){return b||d.replace(/run_summary\.yaml($|\?)/,"audio_track.wav$1")}async function Na(d,b,T){const R=La(d,T),te=Ke(R);if(v.has(te)){Os(te);return}const ge=++k,_e=await Ca(R);if(!(!a.isCurrent(b)||ge!==k)){if(!_e){Ps();return}v.add(te),Os(te)}}function Os(d){m=d,y=!0,A.playbackRate=E.getPlaybackRate(),A.src!==m&&(A.pause(),A.src=m,A.load()),Rt(),Ae()}async function Ca(d){try{if((await tt(d,{method:"HEAD"})).ok)return!0}catch{}try{return(await tt(d,{headers:{Range:"bytes=0-0"}})).ok}catch{return!1}}function Ps(){k+=1,m=null,y=!1,A.pause(),A.removeAttribute("src"),A.load(),Rt()}function Aa(){p=t.audioMutedByDefault,g=t.defaultAudioVolume,A.muted=p,A.volume=g,oe.setMuted(p)}function Rt(){oe.setAudioVisible(Ms()&&y&&!!m),oe.setMuted(p)}function $t(d={}){if(!y||!Number.isFinite(A.duration)||A.duration<=0)return;const b=d.force??!1,T=Math.max(0,Math.min(A.duration,E.getCurrentTimeSeconds())),R=Math.abs(A.currentTime-T);if(!b&&R<=(d.driftThresholdSeconds??Kl))return;const te=performance.now();!b&&te-je<Wl||(A.currentTime=T,je=te)}function Ae(d={}){const b=Ms()&&y&&!!m;if(Rt(),A.muted=p,A.volume=g,A.playbackRate=E.getPlaybackRate(),!b){A.pause();return}if($t({force:d.forceAudioSync??A.paused}),n.dataset.mode!=="display"||E.isPaused()||u||Z){A.pause();return}A.play().catch(()=>{p=!0,A.muted=!0,oe.setMuted(!0)})}function xs(d){const b=new Set(el(d,e));return bt.filter(T=>b.has(T.id))}function Rs(d){return d?bt.find(b=>b.id===d)??null:null}function Ta(){return i.getSource()!=="local"?ls.MIN_TERMINAL_TIME_MS:Ma(ls.MIN_TERMINAL_TIME_MS,Bl)}function Ma(d,b){const T=Math.ceil(Math.min(d,b)),R=Math.floor(Math.max(d,b));return Math.floor(Math.random()*(R-T+1))+T}function Oa(d){const b=l.id,T=t.manifestSource;t=Xo(d,e),ni(t.verboseLogging),s=xs(t),i.setSource(t.manifestSource),t.manifestSource==="online"&&i.preloadActiveManifest(),be.setHomeVisible(!t.lockedScaleId),be.setFullscreenVisible(!t.lockFullscreen),B.setHomeVisible(!t.lockedScaleId),pe.setSimulationClasses(s),q.setAdvancedSettings(t),q.setBackVisible(!t.lockedScaleId),de("Advanced settings updated",t),Aa(),Ae(),T!==t.manifestSource&&(S=null);const R=Rs(t.lockedScaleId);R&&(Ns(R),R.id!==b&&(x=!1,E.hideMedia(),q.setView("parameters")),x||(xn(es[R.id]),q.setSimulation(l,Me())))}}function Gl(){const n=document.getElementById("app");if(!n)throw new Error("App mount element not found.");Yl(n)}Gl();
//# sourceMappingURL=main-CPKBynZJ.js.map
