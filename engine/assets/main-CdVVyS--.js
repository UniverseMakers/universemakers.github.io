import{f as Te,w as ke,a as at,b as At,c as Se,p as rt,d as Tt,A as kt,I as Ge,l as K,e as we,T as Pt,S as Ee,g as Nt,h as Mt,i as xt,j as $e,k as Rt,m as Ot,n as Ft,o as Vt,s as Ht,q as Ut}from"./placeholder-assets-B910zYeR.js";function Bt(s,i){const a=document.createElement("div");a.className="viewport";const t=document.createElement("video");t.className="viewport__media is-empty",t.src=i,t.loop=!1,t.muted=!0,t.playsInline=!0,t.preload="auto",t.setAttribute("aria-label","Simulation output"),a.appendChild(t),s.appendChild(a);let l,n,u,m=new Set,w=!1;const d=new Map,r=new Map,h=new Map;let b=null,v=null;const S=document.createElement("canvas"),c=S.getContext("2d");t.addEventListener("play",()=>u==null?void 0:u(!1)),t.addEventListener("pause",()=>u==null?void 0:u(!0)),t.addEventListener("ended",()=>u==null?void 0:u(!0)),t.addEventListener("timeupdate",()=>{!l||!Number.isFinite(t.duration)||t.duration<=0||l(t.currentTime/t.duration)}),t.addEventListener("ended",()=>{n==null||n()});let f=t.playbackRate;function y(){b&&(URL.revokeObjectURL(b),b=null)}function L(p,E={}){const I=r.get(p);I&&(r.delete(p),E={...E,ownedObjectUrl:!0},p=I),t.classList.add("fade-out"),window.setTimeout(()=>{if(t.src.endsWith(p)){t.classList.remove("fade-out");return}const F=t.muted,R=E.seekFraction;y(),v=null,b=E.ownedObjectUrl?p:null,t.src=p,t.load(),t.onloadeddata=()=>{if(t.muted=F,R!==void 0&&Number.isFinite(t.duration)&&t.duration>0){const ue=Math.max(0,Math.min(.999,R));t.currentTime=ue*t.duration}else t.currentTime=0;t.playbackRate=f,t.classList.remove("fade-out"),E.autoplay&&t.play().catch(()=>{})}},120)}function N(p){t.muted=p}async function P(){await t.play()}function A(){t.pause()}function U(){t.classList.add("is-empty")}function O(){t.classList.remove("is-empty")}function T(p){if(!Number.isFinite(t.duration)||t.duration<=0)return;const E=Math.max(0,Math.min(1,p));t.currentTime=E*t.duration}function M(){t.currentTime=0,l==null||l(0)}function J(p=8e3){return t.readyState>=HTMLMediaElement.HAVE_CURRENT_DATA?Promise.resolve():new Promise(E=>{const I=()=>{R(),E()},F=window.setTimeout(()=>{R(),E()},Math.max(0,p));function R(){window.clearTimeout(F),t.removeEventListener("loadeddata",I)}t.addEventListener("loadeddata",I,{once:!0})})}function ae(p,E=8e3){const I=Math.max(0,p);return I===0||ie(I)?Promise.resolve():new Promise(F=>{const R=()=>{ie(I)&&(ce(),F())},ue=window.setTimeout(()=>{ce(),F()},Math.max(0,E));function ce(){window.clearTimeout(ue),t.removeEventListener("progress",R),t.removeEventListener("canplay",R),t.removeEventListener("loadeddata",R)}t.addEventListener("progress",R),t.addEventListener("canplay",R),t.addEventListener("loadeddata",R),R()})}function ie(p){const E=t.currentTime;for(let I=0;I<t.buffered.length;I+=1){const F=t.buffered.start(I),R=t.buffered.end(I);if(!(E<F||E>R))return R-E>=p}return!1}function Z(p){m=new Set(p.filter(Boolean).filter(E=>E!==t.currentSrc)),w||D()}function X(){w=!0,se(),Q()}function le(){if(!w){D();return}w=!1,D()}function D(){for(const[p,E]of d.entries())m.has(p)||(E.removeAttribute("src"),E.load(),d.delete(p));for(const[p,E]of h.entries())m.has(p)||(E.abort(),h.delete(p));for(const p of m){if(!d.has(p)){const E=document.createElement("video");E.preload="auto",E.muted=!0,E.playsInline=!0,E.src=p,E.load(),d.set(p,E)}r.has(p)||h.has(p)||ye(p)}}function se(){for(const p of d.values())p.removeAttribute("src"),p.load();d.clear()}function Q(){for(const p of h.values())p.abort();h.clear()}function ye(p){const E=new AbortController;h.set(p,E);const I=`${p}?_=${Date.now()}`;fetch(I,{signal:E.signal}).then(async F=>{if(!F.ok)return;const R=await F.blob();m.has(p)&&r.set(p,URL.createObjectURL(R))}).catch(F=>{F instanceof DOMException&&F.name}).finally(()=>{h.get(p)===E&&h.delete(p)})}function oe(){m.clear(),w=!1,se(),Q();for(const p of r.values())URL.revokeObjectURL(p);r.clear()}function q(p){return r.get(p)??null}function B(){!c||t.readyState<2||t.videoWidth===0||t.videoHeight===0||(S.width=t.videoWidth,S.height=t.videoHeight,c.drawImage(t,0,0,S.width,S.height),v=S.toDataURL("image/jpeg",.85))}function j(){return v||B(),v}function $(p){l=p}function z(p){n=p}return{setSource:L,setMuted:N,play:P,pause:A,hideMedia:U,showMedia:O,seekToFraction:T,resetPlayback:M,waitForLoadedData:J,waitForBufferedAhead:ae,onTimeUpdate:$,onEnded:z,getDurationSeconds:()=>Number.isFinite(t.duration)?t.duration:0,getPlaybackFraction:()=>!Number.isFinite(t.duration)||t.duration<=0?0:t.currentTime/t.duration,isPaused:()=>t.paused,setPlaybackRate:p=>{f=p,t.playbackRate=p},getPlaybackRate:()=>f,onPlayStateChange:p=>{u=p},getElement:()=>a,prewarmSources:Z,suspendPrewarming:X,resumePrewarming:le,clearPrewarmedSources:oe,getPrewarmedBlobUrl:q,captureFrame:j}}const Dt=[.25,.5,1,2];function jt(s,i={}){const{onChange:a,onTogglePlay:t,onSpeedChange:l,onScrubStart:n,onScrubEnd:u,initialSpeed:m=1}=i,w=document.createElement("div");w.className="timeline";const d=document.createElement("div");d.className="timeline__bar-row";const r=document.createElement("button");r.className="timeline__play-btn",r.type="button",r.setAttribute("aria-label","Toggle playback"),r.addEventListener("click",()=>t==null?void 0:t());const h=document.createElement("input");h.className="timeline__slider",h.type="range",h.min="0",h.max="1000",h.step="1",h.value="0",h.style.setProperty("--fill","0%"),h.setAttribute("aria-label","Simulation time");const b=document.createElement("div");b.className="timeline__speed";const v=document.createElement("button");v.className="timeline__speed-btn",v.type="button",v.setAttribute("aria-label","Playback speed"),v.addEventListener("click",()=>{b.classList.toggle("open")});const S=document.createElement("div");S.className="timeline__speed-menu";for(const f of Dt){const y=document.createElement("button");y.className="timeline__speed-option",y.type="button",y.textContent=We(f),y.addEventListener("click",()=>{b.classList.remove("open"),l==null||l(f)}),S.appendChild(y)}return b.appendChild(v),b.appendChild(S),d.appendChild(r),d.appendChild(h),d.appendChild(b),h.addEventListener("input",()=>{const f=parseInt(h.value,10)/1e3;h.style.setProperty("--fill",`${f*100}%`),a==null||a(f)}),h.addEventListener("pointerdown",()=>n==null?void 0:n()),h.addEventListener("pointerup",()=>u==null?void 0:u()),h.addEventListener("change",()=>u==null?void 0:u()),document.addEventListener("click",f=>{b.contains(f.target)||b.classList.remove("open")}),w.appendChild(d),s.appendChild(w),c(m),{setPosition(f){const y=Math.max(0,Math.min(1,f));h.value=String(Math.round(y*1e3)),h.style.setProperty("--fill",`${y*100}%`)},setPlaying(f){r.textContent=f?"⏸":"▶",r.classList.toggle("is-paused",!f),r.setAttribute("aria-label",f?"Pause":"Play")},setSpeed(f){c(f)}};function c(f){v.textContent=We(f);for(const y of S.children)y.classList.toggle("is-active",y.textContent===We(f))}}function We(s){return`x${s}`}function $t(s){const i=document.createElement("aside");i.className="data-panel";const a=document.createElement("div");return a.className="data-panel__metrics",i.appendChild(a),s.appendChild(i),{update(t,l,n={}){a.innerHTML="";const u=Wt(t,l,n);for(const m of t.metadata.liveStats){const w=zt(m,u),d=document.createElement("div");d.className="data-panel__metric",d.innerHTML=`
  ...
  `)}function Xt(s,i){const a=document.createElement("div");return a.className="view-switcher is-hidden",s.appendChild(a),{update(t,l){if(a.innerHTML="",t.length<=1){a.classList.add("is-hidden");return}a.classList.remove("is-hidden");for(const n of t){const u=document.createElement("div");u.className="view-switcher__row";const m=document.createElement("button");m.className="view-switcher__button",m.type="button",m.dataset.viewId=n.id,m.classList.toggle("is-active",n.id===l),m.setAttribute("aria-pressed",String(n.id===l)),m.setAttribute("aria-label",n.label??n.id);const w=Qt(n.icon);if(w){const r=document.createElement("span");r.className="view-switcher__icon",r.setAttribute("aria-hidden","true"),r.appendChild(w),m.appendChild(r)}const d=document.createElement("span");if(d.className="view-switcher__label",d.textContent=n.label??n.id,m.appendChild(d),m.addEventListener("click",()=>i.onSelect(n.id)),u.appendChild(m),n.description){const r=document.createElement("button");r.className="view-switcher__info",r.type="button",r.setAttribute("aria-label",`Info about ${n.label??n.id}`),r.appendChild(en()),r.addEventListener("click",h=>{h.stopPropagation(),i.onInfo(n.id,n.label??n.id,n.description??"")}),u.appendChild(r)}a.appendChild(u)}},hide(){a.innerHTML="",a.classList.add("is-hidden")}}}function Qt(s){switch(s){case"dark-matter":return ve(`
      ...
      `);default:return null}}function ve(s){const i=document.createElementNS("http://www.w3.org/2000/svg","svg");return i.setAttribute("viewBox","0 0 24 24"),i.setAttribute("fill","none"),i.setAttribute("stroke","currentColor"),i.setAttribute("stroke-width","1.5"),i.setAttribute("stroke-linecap","round"),i.setAttribute("stroke-linejoin","round"),i.innerHTML=s,i}function en(){return ve(`
    <circle cx="12" cy="12" r="10"></circle>
    <path d="M12 16.5v-6"></path>
    <circle cx="12" cy="8.5" r="1.1" fill="currentColor" stroke="none"></circle>
...
`;function nn(){const s=rt(tn);if(!Array.isArray(s))return[];const i=[];for(const a of s){if(!a||typeof a!="object")continue;const t=a.text;if(typeof t!="string"||t.trim().length===0)continue;const l={text:t},n=a.url;typeof n=="string"&&n.trim().length>0&&(l.url=n);const u=a.logo;typeof u=="string"&&u.trim().length>0&&(l.logo=u),a.header===!0&&(l.header=!0),i.push(l)}return i}function an(s,i,a,t){const l=document.createElement("div");l.className="parameter-editor",s.appendChild(l);let n=i,u={...a};function m(r,h){n=r,u=h?{...h}:sn(r),l.innerHTML="";const b=document.createElement("div");b.className="parameter-editor__heading",b.innerHTML=`
...
`,mn={planetary:cn,galaxy:dn,cosmos:un};function pn(s){return rt(mn[s.id]).map(a=>({text:a}))}const Me={mode:"time",frames:[]};async function hn(s){const i=await fetch(s);if(!i.ok)throw new Error(`Failed to load live stats CSV: ${s}`);const a=await i.text();return vn(a)}function fn(s,i,a=0){if(s.mode==="row")return yn(s.frames,i,a);const t=s.frames;if(t.length===0)return{};if(i<=t[0].t)return{...t[0].values};const l=t[t.length-1];if(i>=l.t)return{...l.values};const n=gn(t,i),u=t[Math.max(0,n-1)],m=t[Math.min(t.length-1,n)],w=(i-u.t)/Math.max(m.t-u.t,1e-9);return _n(u.values,m.values,w)}function gn(s,i){let a=1,t=s.length-1;for(;a<t;){const l=Math.floor((a+t)/2);s[l].t<=i?a=l+1:t=l}return a}function vn(s){const i=s.split(/\r?\n/).map(t=>t.trim()).filter(Boolean);if(i.length<2)return Me;const a=ze(i[0]);return a[0]==="t"?{mode:"time",frames:i.slice(1).map(t=>{const l=ze(t),n={};for(let u=1;u<a.length;u+=1)n[a[u]]=l[u]??"";return{t:parseFloat(l[0]??"0")||0,values:n}})}:{mode:"row",frames:i.slice(1).map((t,l)=>{const n=ze(t),u={};for(let m=0;m<a.length;m+=1)u[a[m]]=n[m]??"";return{t:l,values:u}})}}function yn(s,i,a){if(s.length===0)return{};if(!Number.isFinite(a)||a<=0)return{...s[0].values};const t=Math.max(0,Math.min(1,i/a)),l=Math.round(t*(s.length-1));return{...s[l].values}}function ze(s){const i=[];let a="",t=!1;for(let l=0;l<s.length;l+=1){const n=s[l];if(n==='"'){t=!t;continue}if(n===","&&!t){i.push(a),a="";continue}a+=n}return i.push(a),i}function _n(s,i,a){const t=new Set([...Object.keys(s),...Object.keys(i)]),l={};for(const n of t){const u=s[n]??"",m=i[n]??u,w=parseFloat(u),d=parseFloat(m);if(Number.isFinite(w)&&Number.isFinite(d)){const r=w+(d-w)*a;l[n]=bn(r);continue}l[n]=a<.5?u:m}return l}function bn(s){return s.toFixed(2).replace(new RegExp("\\.0+$|(?<=\\..*?)0+$","g"),"").replace(/\.$/,"")}function En(s){wn(Pt,s)}function wn(s,i){if(navigator.sendBeacon){const a=new Blob([JSON.stringify(i)],{type:"application/json"});if(navigator.sendBeacon(s,a)){K("Run selection tracking dispatched",{simulationId:i.simulationId});return}}fetch(s,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(i),keepalive:!0}).then(a=>{a.ok?K("Run selection tracked",{simulationId:i.simulationId}):we("Run selection tracking rejected",{simulationId:i.simulationId,status:a.status})}).catch(a=>{we("Run selection tracking failed",{simulationId:i.simulationId,error:a instanceof Error?a.message:String(a)})})}const ot=50*1024*1024,Sn=8,In=6e3,Cn=8e3,Ln=5e3,An=1200,Tn=100,Ye={galaxy:"tron",planetary:"matrix",cosmos:"nostromo"};function kn(s){const i=Ee.map(e=>e.id);let a=Nt(i),t=et(a);const l=Mt(a.manifestSource);a.manifestSource==="online"&&l.preloadActiveManifest();let n=tt(a.lockedScaleId)??t[0]??Ee[0],u=a.lockedScaleId?Ye[n.id]:xt(),m=!1,w=null,d=null,r=0,h=Me,b=!1;const v=Object.fromEntries(Ee.map(e=>[e.id,yt(e)]));$e(u);const S=Rt(n.id),c=Bt(s,S),f=document.createElement("div");f.className="display-chrome",f.classList.add("is-hidden"),s.appendChild(f);const y=document.createElement("div");y.className="orientation-overlay",y.innerHTML=`
  ...
  `,s.appendChild(y);const L=document.createElement("div");L.className="swift-logo",L.innerHTML=`
    <img
  ...
  `,s.appendChild(L);const N=document.createElement("div");N.className="synth-logo is-hidden",N.innerHTML=`
    <img
      ...
      decoding="async"
    />
  `,s.appendChild(N);const P=document.createElement("img");P.className="app-partner-logo",P.src=Se("assets/dirac-hpc-white.webp"),P.alt="DIRAC HPC",P.decoding="async",s.appendChild(P);const A=document.createElement("div");A.className="display-chrome__top-left is-hidden",s.appendChild(A);const U=ln(A,{onHome(){He()},onViewSelected(e){if(e==="credits"){Ne("credits");return}Ne(e)},showHome:!a.lockedScaleId}),O=document.createElement("div");O.className="display-chrome__left-center",f.appendChild(O);const T=Xt(O,{onSelect(e){Qe(e)},onInfo(e,o,_){J.textContent=o,ae.textContent=_,M.classList.add("is-visible")}}),M=document.createElement("div");M.className="view-info-overlay",M.innerHTML=`
  ...
  `,f.appendChild(D);const se="universe-engine-playback-speed",Q=()=>{const e=localStorage.getItem(se),o=e?Number(e):NaN;return[.25,.5,1,2].includes(o)?o:1},ye=e=>{localStorage.setItem(se,String(e))},oe=Q();c.setPlaybackRate(oe);const q=document.createElement("div");q.className="display-chrome__bottom",f.appendChild(q);const B=jt(q,{onChange(e){ue(e)},onTogglePlay:Xe,onSpeedChange:mt,onScrubStart(){xe(),R()},onScrubEnd(){g(),c.isPaused()||F()},initialSpeed:oe});B.setPlaying(!c.isPaused());let j=null,$=null,z=null,p=!1,E=null,I=0;function F(){if(j!==null)return;function e(){const o=c.getPlaybackFraction();B.setPosition(o),c.isPaused()?j=null:j=requestAnimationFrame(e)}j=requestAnimationFrame(e)}function R(){j!==null&&(cancelAnimationFrame(j),j=null)}function ue(e){$=e,z===null&&(z=requestAnimationFrame(()=>{if(z=null,$===null)return;const o=$;$=null,c.seekToFraction(o)}))}function ce(){if($===null)return;z!==null&&(cancelAnimationFrame(z),z=null);const e=$;$=null,c.seekToFraction(e)}function re(){E!==null&&(window.clearTimeout(E),E=null)}function Ie(){if(!(d!=null&&d.views))return[];const e=be(n,d);return Object.entries(d.views).filter(([o])=>o!==e).map(([,o])=>o).filter(Boolean)}function de(){re(),c.suspendPrewarming()}function me(e=An){re(),!(p||c.isPaused())&&(E=window.setTimeout(()=>{E=null,!(p||c.isPaused())&&(c.resumePrewarming(),c.prewarmSources(Ie()))},Math.max(0,e)))}function xe(){p=!0,I=0,de()}function g(){p=!1,I=0,ce(),r=c.getPlaybackFraction()*c.getDurationSeconds(),ge(r),me()}c.onPlayStateChange(e=>{B.setPlaying(!e),e?(R(),de()):(F(),me(0))}),c.onTimeUpdate(e=>{if(r=e*c.getDurationSeconds(),p){const o=performance.now();if(o-I<Tn)return;I=o}ge(r)});const k=document.createElement("div");k.className="overlay-layer",s.appendChild(k);const x=Ot(k,{onReplay:ut,onParameters:()=>Ne("parameters"),onHome:He,showHome:!a.lockedScaleId});c.onEnded(()=>{m=!0;const e=c.captureFrame();x.update(n,te(),c.getDurationSeconds(),w,e),x.show()});const V=Kt(k,t,e=>{Ze(e),Ne("parameters")}),H=on(k,{simClass:n,values:te(),theme:u,advancedSettings:a,availableScales:Ee,onValuesChange:lt,onThemeChange:Ve,onRun:()=>{K("Parameters submitted — starting run",{simClassId:n.id}),pt().catch(e=>{we("Run failed to start",{simClassId:n.id,error:e instanceof Error?e.message:String(e)})})},onApplySettings:ct,onClose:dt,initialView:"parameters"}),Re=rn(k);B.setPosition(0),ge(),x.hide();const pe=new WeakMap,ee=e=>{const o=pe.get(e);o&&(clearTimeout(o),pe.delete(e)),e.classList.remove("side-collapsed")},he=e=>{const o=pe.get(e);o&&clearTimeout(o),pe.set(e,setTimeout(()=>{e.classList.add("side-collapsed"),pe.delete(e)},2500))},Oe=e=>{const o=pe.get(e);o&&(clearTimeout(o),pe.delete(e)),e.classList.add("side-collapsed")},Fe=(e,o)=>{const _=o.isCollapsible??(()=>!0);e.addEventListener("mouseenter",()=>ee(e)),e.addEventListener("mouseleave",()=>{if(!_()){ee(e);return}he(e)}),e.addEventListener("focusin",()=>ee(e)),e.addEventListener("focusout",C=>{if(!e.contains(C.relatedTarget)){if(!_()){ee(e);return}he(e)}}),e.addEventListener("click",()=>{if(!_()){ee(e);return}if(e.classList.contains("side-collapsed")){ee(e),he(e);return}o.toggleOnClick?Oe(e):he(e)}),_()?Oe(e):ee(e)};Fe(A,{toggleOnClick:!0,isCollapsible:()=>s.dataset.mode!=="entry"}),Fe(O,{toggleOnClick:!0}),Fe(q,{toggleOnClick:!1});let Ce=0,_e=null,Pe=0;const Ke=()=>{_e!==null&&(cancelAnimationFrame(_e),_e=null)},Je=()=>{if(_e!==null)return;Pe=c.getPlaybackFraction();const e=()=>{if(Ce===0){Ke();return}const _=12*(1/60)/Math.max(c.getDurationSeconds(),1);Pe=Math.max(0,Math.min(1,Pe+Ce*_)),c.seekToFraction(Pe),_e=requestAnimationFrame(e)};_e=requestAnimationFrame(e)};document.addEventListener("keydown",e=>{if(s.dataset.mode==="display"&&!(e.target instanceof HTMLInputElement||e.target instanceof HTMLTextAreaElement))switch(e.key){case"Escape":e.preventDefault(),M.classList.contains("is-visible")?M.classList.remove("is-visible"):He();break;case" ":e.preventDefault(),Xe();break;case"ArrowLeft":e.preventDefault(),ee(q),he(q),Ce=-1,Je();break;case"ArrowRight":e.preventDefault(),ee(q),he(q),Ce=1,Je();break;case"ArrowUp":case"ArrowDown":{if(e.preventDefault(),ee(O),he(O),!(d!=null&&d.views)||Object.keys(d.views).length<=1)break;const o=n.views.filter(Y=>{var G;return((G=d==null?void 0:d.views)==null?void 0:G[Y.id])!==void 0});if(o.length<=1)break;const _=d.viewId??be(n,d),C=o.findIndex(Y=>Y.id===_),ne=e.key==="ArrowUp"?(C-1+o.length)%o.length:(C+1)%o.length;Qe(o[ne].id);break}}}),document.addEventListener("keyup",e=>{(e.key==="ArrowLeft"||e.key==="ArrowRight")&&(Ce=0,Ke())}),c.hideMedia(),c.pause(),fe(a.lockedScaleId?"config":"entry");function Ze(e){e.id===n.id&&b||(n=e,De(),Ve(Ye[e.id]),H.setSimulation(n,te()),B.setPosition(0),ge(),Be(),Ue())}function lt(e){v[n.id]={...e},K("Parameter values updated",{simClassId:n.id,values:v[n.id]}),ge()}function Ve(e){u=e,$e(e),H.setTheme(e)}function Ne(e){e==="parameters"&&H.setSimulation(n,te()),H.setView(e),fe("config")}function ct(e){if(Lt(e),b){x.hide(),fe("display");return}H.setSimulation(n,te()),H.setView("parameters")}function dt(){if(x.hide(),!b&&a.lockedScaleId){H.setSimulation(n,te()),H.setView("parameters");return}fe(b?"display":"entry")}function He(){a.lockedScaleId||(K("Returning to home screen",{simClassId:n.id}),De(),b=!1,c.hideMedia(),fe("entry"))}function ut(){m=!1,x.hide(),c.resetPlayback(),c.play().catch(()=>{c.setMuted(!0),c.play()})}function Xe(){c.isPaused()?c.play().catch(()=>{c.setMuted(!0),c.play()}):c.pause()}function mt(e){c.setPlaybackRate(e),ye(e),B.setSpeed(e)}async function pt(){const e=te();K("Run requested",{simClassId:n.id,values:e,manifestSource:l.getSource()});const o=await l.findNearestVideo(n.id,n.parameters,e);De(),d=o;const _=be(n,o);En({simulationId:n.id,parameters:e,manifestSource:l.getSource(),matchedRunId:o.runId});const C=St(o,_)??o.url,ne=Object.entries(o.views??{}).filter(([W])=>W!==_).map(([,W])=>W);bt(o.liveDataUrl),Et(o.summaryUrl),c.setMuted(!1),Be(_),fe("initializing");const Y=ht(C);c.resumePrewarming(),c.prewarmSources(ne);const G=(async()=>{const W=await Y;K(`Prepared active video source: ${W.ownedObjectUrl?"FULL-FETCH":"PROGRESSIVE"}`,{selectedViewUrl:C,waitsForBuffer:W.shouldWaitForBuffer}),c.setSource(W.src,{ownedObjectUrl:W.ownedObjectUrl}),c.pause(),await c.waitForLoadedData(Cn),W.shouldWaitForBuffer&&await c.waitForBufferedAhead(Sn,In)})();await new Promise(W=>{Re.show(pn(n),W,G,{minTerminalTimeMs:It()})}),b=!0,c.showMedia(),c.play().catch(()=>{c.setMuted(!0),c.play().catch(()=>{})}),fe("display")}async function ht(e){const o=await ft(e);if(o!==null&&o>0&&o<=ot){K("Downloading active video behind loading overlay",{videoUrl:e,contentLength:o});try{const _=await fetch(e);if(!_.ok)throw new Error(`Failed to download active video: ${e}`);const C=await _.blob();return K(`Active video full fetch complete: ${C.size} bytes`,{videoUrl:e,blobType:C.type}),{src:URL.createObjectURL(C),ownedObjectUrl:!0,shouldWaitForBuffer:!1}}catch(_){we(`Full-fetch FAILED; falling back to progressive: ${_ instanceof Error?_.message:String(_)}`,{videoUrl:e})}}return o!==null?K("Active video exceeds full-fetch threshold; using progressive load",{videoUrl:e,contentLength:o,fullFetchMaxBytes:ot}):K("Could not determine active video size; using progressive load",{videoUrl:e}),K("Using progressive active video load",{videoUrl:e}),{src:e,ownedObjectUrl:!1,shouldWaitForBuffer:!0}}async function ft(e){try{const o=await fetch(e,{headers:{Range:"bytes=0-0"}});K("Probed active video size with range request",{videoUrl:e,ok:o.ok,status:o.status,contentLength:o.headers.get("Content-Length"),contentRange:o.headers.get("Content-Range")});const _=vt(o.headers.get("Content-Length"));if(_!==null)return _;const C=gt(o.headers.get("Content-Range"));return C!==null?C:null}catch(o){return we("Could not probe active video size",{videoUrl:e,error:o instanceof Error?o.message:String(o)}),null}}function gt(e){if(!e)return null;const o=e.match(/bytes\s+\d+-\d+\/(\d+)/i);if(!o)return null;const _=Number(o[1]);return Number.isFinite(_)&&_>0?_:null}function vt(e){if(!e)return null;const o=Number(e);return Number.isFinite(o)?o:null}function fe(e){if(s.dataset.mode=e,e==="entry"?document.documentElement.setAttribute("data-theme","glass"):e==="display"&&$e(u),Le(f,e==="display"||e==="config"),Le(L,e==="display"||e==="entry"),Le(A,!a.lockedScaleId&&(e==="entry"||e==="config"||e==="display")),e==="entry"?ee(A):Oe(A),e==="entry"&&!a.lockedScaleId?V.show():V.hide(),e==="config"?(Re.hide(),H.setSimulation(n,te()),H.show()):H.hide(),e!=="display")x.hide();else if(m){const _=c.captureFrame();x.update(n,te(),c.getDurationSeconds(),w,_),x.show()}!b||e==="initializing"?(c.hideMedia(),e==="initializing"&&c.pause()):c.showMedia(),e!=="initializing"&&Re.hide(),Ue()}function Ue(){if(s.dataset.mode==="entry"){Le(N,!0);return}const e=s.dataset.mode==="display",o=n.id==="galaxy",C=be(n,d)==="hst";Le(N,e&&o&&C)}function ge(e=0){const o=fn(h,e,c.getDurationSeconds()),_=wt(n,w,e,c.getDurationSeconds());le.update(n,te(),{...o,..._})}function Be(e){const o=n.views.filter(ne=>{var Y;return((Y=d==null?void 0:d.views)==null?void 0:Y[ne.id])!==void 0});if(o.length<=1){T.hide(),Z.classList.add("is-hidden");return}const _=e??be(n,d),C=o.find(ne=>ne.id===_);T.update(o,_),C?(Z.classList.remove("is-hidden"),Z.innerHTML=`<span class="viewport-title">${C.label??C.id}</span>`):Z.classList.add("is-hidden")}function De(){h=Me,m=!1,w=null,d=null,r=0,p=!1,$=null,re(),z!==null&&(cancelAnimationFrame(z),z=null),x.hide(),T.hide(),c.pause(),c.clearPrewarmedSources(),c.resetPlayback(),B.setPosition(0)}function Qe(e){if(!(d!=null&&d.views)||e===be(n,d))return;const o=d.views[e];if(!o)return;d.viewId=e;const _=!c.isPaused()&&!m,C=m?0:c.getPlaybackFraction();m=!1,x.hide(),c.setSource(o,{seekFraction:C,autoplay:_}),c.prewarmSources(Ie()),_&&!p?me():de(),Be(e),M.classList.remove("is-visible"),Ue()}function te(){return{...v[n.id]}}function yt(e){return Object.fromEntries(e.parameters.map(o=>[o.id,_t(o)]))}function _t(e){if(e.logScale){const Y=Math.log10(e.min),G=Math.log10(e.max);return 10**(Y+Math.random()*(G-Y))}const o=Math.max(0,Math.round((e.max-e.min)/e.step)),_=Math.floor(Math.random()*(o+1)),C=e.min+_*e.step,ne=Ft(e.step);return Number(C.toFixed(ne))}async function bt(e){try{h=await hn(e)}catch(o){h=Me,we("Failed to load live stats",{url:e,error:o instanceof Error?o.message:String(o)})}ge()}async function Et(e){w=await Ut(e),ge(r)}function wt(e,o,_,C){if(!o||!Number.isFinite(C)||C<=0)return{};const ne=Math.max(0,Math.min(1,_/C)),Y={};for(const G of e.metadata.liveStats){if(!G.live||!G.fromVideo||!G.scaleWithTime)continue;const je=G.videoKey??G.id,W=o[je];if(typeof W!="number"||!Number.isFinite(W))continue;const nt=W*ne;Y[G.id]=G.integer?String(Math.floor(nt)):String(nt)}return Y}function Le(e,o){e.hidden=!o,e.classList.toggle("is-hidden",!o)}function be(e,o){return o!=null&&o.views?o.viewId??Object.keys(o.views)[0]:o==null?void 0:o.viewId}function St(e,o){return!o||!e.views?null:e.views[o]??null}function et(e){const o=new Set(Vt(e,i));return Ee.filter(_=>o.has(_.id))}function tt(e){return e?Ee.find(o=>o.id===e)??null:null}function It(){return l.getSource()!=="local"?Ge.MIN_TERMINAL_TIME_MS:Ct(Ge.MIN_TERMINAL_TIME_MS,Ln)}function Ct(e,o){const _=Math.ceil(Math.min(e,o)),C=Math.floor(Math.max(e,o));return Math.floor(Math.random()*(C-_+1))+_}function Lt(e){const o=n.id,_=a.manifestSource;a=Ht(e,i),t=et(a),l.setSource(a.manifestSource),a.manifestSource==="online"&&l.preloadActiveManifest(),U.setHomeVisible(!a.lockedScaleId),x.setHomeVisible(!a.lockedScaleId),V.setSimulationClasses(t),H.setAdvancedSettings(a),K("Advanced settings updated",a),_!==a.manifestSource&&(d=null);const C=tt(a.lockedScaleId);C&&(Ze(C),C.id!==o&&(b=!1,c.hideMedia(),H.setView("parameters")),b||(Ve(Ye[C.id]),H.setSimulation(n,te())))}}function Pn(){const s=document.getElementById("app");if(!s)throw new Error("App mount element not found.");kn(s)}Pn();
//# sourceMappingURL=main-CdVVyS--.js.map
