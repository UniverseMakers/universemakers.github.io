...
`){if(a-r>s)return!0;if(r=a+1,i-r<=s)return!1}return!0}function ct(n,e){const t=JSON.stringify(n);if(e.options.doubleQuotedAsJSON)return t;const{implicitKey:s}=e,i=e.options.doubleQuotedMinMultiLineLength,a=e.indent||($t(n)?"  ":"");let r="",o=0;for(let c=0,l=t[c];l;l=t[++c])if(l===" "&&t[c+1]==="\\"&&t[c+2]==="n"&&(r+=t.slice(o,c)+"\\ ",c+=1,o=c,l="\\"),l==="\\")switch(t[c+1]){case"u":{r+=t.slice(o,c);const d=t.substr(c+2,4);switch(d){case"0000":r+="\\0";break;case"0007":r+="\\a";break;case"000b":r+="\\v";break;case"001b":r+="\\e";break;case"0085":r+="\\N";break;case"00a0":r+="\\_";break;case"2028":r+="\\L";break;case"2029":r+="\\P";break;default:d.substr(0,2)==="00"?r+="\\x"+d.substr(2):r+=t.substr(c,6)}c+=5,o=c+1}break;case"n":if(s||t[c+2]==='"'||t.length<i)c+=1;else{for(r+=t.slice(o,c)+`

`;t[c+2]==="\\"&&t[c+3]==="n"&&t[c+4]!=='"';)r+=`
`,c+=2;r+=a,t[c+2]===" "&&(r+="\\"),c+=1,o=c+1}break;default:c+=1}return r=o?r+t.slice(o):t,s?r:Pt(r,a,Lt,xt(e,!1))}function on(n,e){if(e.options.singleQuote===!1||e.implicitKey&&n.includes(`
`)||/[ \t]\n|\n[ \t]/.test(n))return ct(n,e);const t=e.indent||($t(n)?"  ":""),s="'"+n.replace(/'/g,"''").replace(/\n+/g,`$&
${t}`)+"'";return e.implicitKey?s:Pt(s,t,is,xt(e,!1))}function Ge(n,e){const{singleQuote:t}=e.options;let s;if(t===!1)s=ct;else{const i=n.includes('"'),a=n.includes("'");i&&!a?s=on:a&&!i?s=ct:s=t?on:ct}return s(n,e)}let ln;try{ln=new RegExp(`(^|(?<!
))
+(?!
|$)`,"g")}catch{ln=/\n+(?!\n|$)/g}function It({comment:n,type:e,value:t},s,i,a){const{blockQuote:r,commentString:o,lineWidth:c}=s.options;if(!r||/\n[\t ]+$/.test(t))return Ge(t,s);const l=s.indent||(s.forceBlockIndent||$t(t)?"  ":""),d=r==="literal"?!0:r==="folded"||e===O.BLOCK_FOLDED?!1:e===O.BLOCK_LITERAL?!0:!vi(t,c,l.length);if(!t)return d?`|
`:`>
`;let u,p;for(p=t.length;p>0;--p){const _=t[p-1];if(_!==`
`&&_!=="	"&&_!==" ")break}let g=t.substring(p);const b=g.indexOf(`
`);b===-1?u="-":t===g||b!==g.length-1?(u="+",a&&a()):u="",g&&(t=t.slice(0,-g.length),g[g.length-1]===`
`&&(g=g.slice(0,-1)),g=g.replace(ln,`$&${l}`));let f=!1,h,y=-1;for(h=0;h<t.length;++h){const _=t[h];if(_===" ")f=!0;else if(_===`
`)y=h;else break}let k=t.substring(0,y<h?y+1:h);k&&(t=t.substring(k.length),k=k.replace(/\n+/g,`$&${l}`));let v=(f?l?"2":"1":"")+u;if(n&&(v+=" "+o(n.replace(/ ?[\r\n]+/g," ")),i&&i()),!d){const _=t.replace(/\n+/g,`
$&`).replace(/(?:^|\n)([\t ].*)(?:([\n\t ]*)\n(?![\n\t ]))?/g,"$1$2").replace(/\n+/g,`$&${l}`);let I=!1;const L=xt(s,!0);r!=="folded"&&e!==O.BLOCK_FOLDED&&(L.onOverflow=()=>{I=!0});const E=Pt(`${k}${_}${g}`,l,rn,L);if(!I)return`>${v}
${l}${E}`}return t=t.replace(/\n+/g,`$&${l}`),`|${v}
${l}${k}${t}${g}`}function Si(n,e,t,s){const{type:i,value:a}=n,{actualString:r,implicitKey:o,indent:c,indentStep:l,inFlow:d}=e;if(o&&a.includes(`
`)||d&&/[[\]{},]/.test(a))return Ge(a,e);if(/^[\n\t ,[\]{}#&*!|>'"%@`]|^[?-]$|^[?-][ \t]|[\n:][ \t]|[ \t]\n|[\n\t ]#|[\n\t :]$/.test(a))return o||d||!a.includes(`
`)?Ge(a,e):It(n,e,t,s);if(!o&&!d&&i!==O.PLAIN&&a.includes(`
`))return It(n,e,t,s);if($t(a)){if(c==="")return e.forceBlockIndent=!0,It(n,e,t,s);if(o&&c===l)return Ge(a,e)}const u=a.replace(/\n+/g,`$&
${c}`);if(r){const p=f=>{var h;return f.default&&f.tag!=="tag:yaml.org,2002:str"&&((h=f.test)==null?void 0:h.test(u))},{compat:g,tags:b}=e.doc.schema;if(b.some(p)||g!=null&&g.some(p))return Ge(a,e)}return o?u:Pt(u,c,is,xt(e,!1))}function yn(n,e,t,s){const{implicitKey:i,inFlow:a}=e,r=typeof n.value=="string"?n:Object.assign({},n,{value:String(n.value)});let{type:o}=n;o!==O.QUOTE_DOUBLE&&/[\x00-\x08\x0b-\x1f\x7f-\x9f\u{D800}-\u{DFFF}]/u.test(r.value)&&(o=O.QUOTE_DOUBLE);const c=d=>{switch(d){case O.BLOCK_FOLDED:case O.BLOCK_LITERAL:return i||a?Ge(r.value,e):It(r,e,t,s);case O.QUOTE_DOUBLE:return ct(r.value,e);case O.QUOTE_SINGLE:return on(r.value,e);case O.PLAIN:return Si(r,e,t,s);default:return null}};let l=c(o);if(l===null){const{defaultKeyType:d,defaultStringType:u}=e.options,p=i&&d||u;if(l=c(p),l===null)throw new Error(`Unsupported default string type ${p}`)}return l}function as(n,e){const t=Object.assign({blockQuote:!0,commentString:wi,defaultKeyType:null,defaultStringType:"PLAIN",directives:null,doubleQuotedAsJSON:!1,doubleQuotedMinMultiLineLength:40,falseStr:"false",flowCollectionPadding:!0,indentSeq:!0,lineWidth:80,minContentWidth:20,nullStr:"null",simpleKeys:!1,singleQuote:null,trailingComma:!1,trueStr:"true",verifyAliasOrder:!0},n.schema.toStringOptions,e);let s;switch(t.collectionStyle){case"block":s=!1;break;case"flow":s=!0;break;default:s=null}return{anchors:new Set,doc:n,flowCollectionPadding:t.flowCollectionPadding?" ":"",indent:"",indentStep:typeof t.indent=="number"?" ".repeat(t.indent):"  ",inFlow:s,options:t}}function _i(n,e){var i;if(e.tag){const a=n.filter(r=>r.tag===e.tag);if(a.length>0)return a.find(r=>r.format===e.format)??a[0]}let t,s;if(W(e)){s=e.value;let a=n.filter(r=>{var o;return(o=r.identify)==null?void 0:o.call(r,s)});if(a.length>1){const r=a.filter(o=>o.test);r.length>0&&(a=r)}t=a.find(r=>r.format===e.format)??a.find(r=>!r.format)}else s=e,t=n.find(a=>a.nodeClass&&s instanceof a.nodeClass);if(!t){const a=((i=s==null?void 0:s.constructor)==null?void 0:i.name)??(s===null?"null":typeof s);throw new Error(`Tag not resolved for ${a} value`)}return t}function ki(n,e,{anchors:t,doc:s}){if(!s.directives)return"";const i=[],a=(W(n)||Y(n))&&n.anchor;a&&Zn(a)&&(t.add(a),i.push(`&${a}`));const r=n.tag??(e.default?null:e.tag);return r&&i.push(s.directives.tagString(r)),i.join(" ")}function ze(n,e,t,s){var c;if(z(n))return n.toString(e,t,s);if(Fe(n)){if(e.doc.directives)return n.toString(e);if((c=e.resolvedAliases)!=null&&c.has(n))throw new TypeError("Cannot stringify circular structure without alias nodes");e.resolvedAliases?e.resolvedAliases.add(n):e.resolvedAliases=new Set([n]),n=n.resolve(e.doc)}let i;const a=J(n)?n:e.doc.createNode(n,{onTagObj:l=>i=l});i??(i=_i(e.doc.schema.tags,a));const r=ki(a,i,e);r.length>0&&(e.indentAtStart=(e.indentAtStart??0)+r.length+1);const o=typeof i.stringify=="function"?i.stringify(a,e,t,s):W(a)?yn(a,e,t,s):a.toString(e,t,s);return r?W(a)||o[0]==="{"||o[0]==="["?`${r} ${o}`:`${r}
${e.indent}${o}`:o}function Ei({key:n,value:e},t,s,i){const{allNullValues:a,doc:r,indent:o,indentStep:c,options:{commentString:l,indentSeq:d,simpleKeys:u}}=t;let p=J(n)&&n.comment||null;if(u){if(p)throw new Error("With simple keys, key nodes cannot have comments");if(Y(n)||!J(n)&&typeof n=="object"){const L="With simple keys, collection cannot be used as a key value";throw new Error(L)}}let g=!u&&(!n||p&&e==null&&!t.inFlow||Y(n)||(W(n)?n.type===O.BLOCK_FOLDED||n.type===O.BLOCK_LITERAL:typeof n=="object"));t=Object.assign({},t,{allNullValues:!1,implicitKey:!g&&(u||!a),indent:o+c});let b=!1,f=!1,h=ze(n,t,()=>b=!0,()=>f=!0);if(!g&&!t.inFlow&&h.length>1024){if(u)throw new Error("With simple keys, single line scalar must not span more than 1024 characters");g=!0}if(t.inFlow){if(a||e==null)return b&&s&&s(),h===""?"?":g?`? ${h}`:h}else if(a&&!u||e==null&&g)return h=`? ${h}`,p&&!b?h+=xe(h,t.indent,l(p)):f&&i&&i(),h;b&&(p=null),g?(p&&(h+=xe(h,t.indent,l(p))),h=`? ${h}
${o}:`):(h=`${h}:`,p&&(h+=xe(h,t.indent,l(p))));let y,k,S;J(e)?(y=!!e.spaceBefore,k=e.commentBefore,S=e.comment):(y=!1,k=null,S=null,e&&typeof e=="object"&&(e=r.createNode(e))),t.implicitKey=!1,!g&&!p&&W(e)&&(t.indentAtStart=h.length+1),f=!1,!d&&c.length>=2&&!t.inFlow&&!g&&mt(e)&&!e.flow&&!e.tag&&!e.anchor&&(t.indent=t.indent.substring(2));let v=!1;const _=ze(e,t,()=>v=!0,()=>f=!0);let I=" ";if(p||y||k){if(I=y?`
`:"",k){const L=l(k);I+=`
${_e(L,t.indent)}`}_===""&&!t.inFlow?I===`
`&&S&&(I=`

`):I+=`
${t.indent}`}else if(!g&&Y(e)){const L=_[0],E=_.indexOf(`
`),T=E!==-1,$=t.inFlow??e.flow??e.items.length===0;if(T||!$){let R=!1;if(T&&(L==="&"||L==="!")){let B=_.indexOf(" ");L==="&"&&B!==-1&&B<E&&_[B+1]==="!"&&(B=_.indexOf(" ",B+1)),(B===-1||E<B)&&(R=!0)}R||(I=`
${t.indent}`)}}else(_===""||_[0]===`
`)&&(I="");return h+=I+_,t.inFlow?v&&s&&s():S&&!v?h+=xe(h,t.indent,l(S)):f&&i&&i(),h}function rs(n,e){(n==="debug"||n==="warn")&&console.warn(e)}const bt="<<",Ee={identify:n=>n===bt||typeof n=="symbol"&&n.description===bt,default:"key",tag:"tag:yaml.org,2002:merge",test:/^<<$/,resolve:()=>Object.assign(new O(Symbol(bt)),{addToJSMap:os}),stringify:()=>bt},Li=(n,e)=>(Ee.identify(e)||W(e)&&(!e.type||e.type===O.PLAIN)&&Ee.identify(e.value))&&(n==null?void 0:n.doc.schema.tags.some(t=>t.tag===Ee.tag&&t.default));function os(n,e,t){if(t=n&&Fe(t)?t.resolve(n.doc):t,mt(t))for(const s of t.items)Wt(n,e,s);else if(Array.isArray(t))for(const s of t)Wt(n,e,s);else Wt(n,e,t)}function Wt(n,e,t){const s=n&&Fe(t)?t.resolve(n.doc):t;if(!ht(s))throw new Error("Merge sources must be maps or map aliases");const i=s.toJSON(null,n,Map);for(const[a,r]of i)e instanceof Map?e.has(a)||e.set(a,r):e instanceof Set?e.add(a):Object.prototype.hasOwnProperty.call(e,a)||Object.defineProperty(e,a,{value:r,writable:!0,enumerable:!0,configurable:!0});return e}function ls(n,e,{key:t,value:s}){if(J(t)&&t.addToJSMap)t.addToJSMap(n,e,s);else if(Li(n,t))os(n,e,s);else{const i=de(t,"",n);if(e instanceof Map)e.set(i,de(s,i,n));else if(e instanceof Set)e.add(i);else{const a=Ii(t,i,n),r=de(s,a,n);a in e?Object.defineProperty(e,a,{value:r,writable:!0,enumerable:!0,configurable:!0}):e[a]=r}}return e}function Ii(n,e,t){if(e===null)return"";if(typeof e!="object")return String(e);if(J(n)&&(t!=null&&t.doc)){const s=as(t.doc,{});s.anchors=new Set;for(const a of t.anchors.keys())s.anchors.add(a.anchor);s.inFlow=!0,s.inStringifyKey=!0;const i=n.toString(s);if(!t.mapKeyWarned){let a=JSON.stringify(i);a.length>40&&(a=a.substring(0,36)+'..."'),rs(t.doc.options.logLevel,`Keys with collection values will be stringified due to JS Object restrictions: ${a}. Set mapAsMap: true to use object keys.`),t.mapKeyWarned=!0}return i}return JSON.stringify(e)}function bn(n,e,t){const s=dt(n,void 0,t),i=dt(e,void 0,t);return new re(s,i)}class re{constructor(e,t=null){Object.defineProperty(this,fe,{value:Qn}),this.key=e,this.value=t}clone(e){let{key:t,value:s}=this;return J(t)&&(t=t.clone(e)),J(s)&&(s=s.clone(e)),new re(t,s)}toJSON(e,t){const s=t!=null&&t.mapAsMap?new Map:{};return ls(t,s,this)}toString(e,t,s){return e!=null&&e.doc?Ei(this,e,t,s):JSON.stringify(this)}}function cs(n,e,t){return(e.inFlow??n.flow?Ai:Ni)(n,e,t)}function Ni({comment:n,items:e},t,{blockItemPrefix:s,flowChars:i,itemIndent:a,onChompKeep:r,onComment:o}){const{indent:c,options:{commentString:l}}=t,d=Object.assign({},t,{indent:a,type:null});let u=!1;const p=[];for(let b=0;b<e.length;++b){const f=e[b];let h=null;if(J(f))!u&&f.spaceBefore&&p.push(""),Tt(t,p,f.commentBefore,u),f.comment&&(h=f.comment);else if(z(f)){const k=J(f.key)?f.key:null;k&&(!u&&k.spaceBefore&&p.push(""),Tt(t,p,k.commentBefore,u))}u=!1;let y=ze(f,d,()=>h=null,()=>u=!0);h&&(y+=xe(y,a,l(h))),u&&h&&(u=!1),p.push(s+y)}let g;if(p.length===0)g=i.start+i.end;else{g=p[0];for(let b=1;b<p.length;++b){const f=p[b];g+=f?`
${c}${f}`:`
`}}return n?(g+=`
`+_e(l(n),c),o&&o()):u&&r&&r(),g}function Ai({items:n},e,{flowChars:t,itemIndent:s}){const{indent:i,indentStep:a,flowCollectionPadding:r,options:{commentString:o}}=e;s+=a;const c=Object.assign({},e,{indent:s,inFlow:!0,type:null});let l=!1,d=0;const u=[];for(let b=0;b<n.length;++b){const f=n[b];let h=null;if(J(f))f.spaceBefore&&u.push(""),Tt(e,u,f.commentBefore,!1),f.comment&&(h=f.comment);else if(z(f)){const k=J(f.key)?f.key:null;k&&(k.spaceBefore&&u.push(""),Tt(e,u,k.commentBefore,!1),k.comment&&(l=!0));const S=J(f.value)?f.value:null;S?(S.comment&&(h=S.comment),S.commentBefore&&(l=!0)):f.value==null&&(k!=null&&k.comment)&&(h=k.comment)}h&&(l=!0);let y=ze(f,c,()=>h=null);l||(l=u.length>d||y.includes(`
`)),b<n.length-1?y+=",":e.options.trailingComma&&(e.options.lineWidth>0&&(l||(l=u.reduce((k,S)=>k+S.length+2,2)+(y.length+2)>e.options.lineWidth)),l&&(y+=",")),h&&(y+=xe(y,s,o(h))),u.push(y),d=u.length}const{start:p,end:g}=t;if(u.length===0)return p+g;if(!l){const b=u.reduce((f,h)=>f+h.length+2,2);l=e.options.lineWidth>0&&b>e.options.lineWidth}if(l){let b=p;for(const f of u)b+=f?`
${a}${i}${f}`:`
`;return`${b}
${i}${g}`}else return`${p}${r}${u.join(" ")}${r}${g}`}function Tt({indent:n,options:{commentString:e}},t,s,i){if(s&&i&&(s=s.replace(/^\n+/,"")),s){const a=_e(e(s),n);t.push(a.trimStart())}}function $e(n,e){const t=W(e)?e.value:e;for(const s of n)if(z(s)&&(s.key===e||s.key===t||W(s.key)&&s.key.value===t))return s}class ue extends ss{static get tagName(){return"tag:yaml.org,2002:map"}constructor(e){super(Ce,e),this.items=[]}static from(e,t,s){const{keepUndefined:i,replacer:a}=s,r=new this(e),o=(c,l)=>{if(typeof a=="function")l=a.call(t,c,l);else if(Array.isArray(a)&&!a.includes(c))return;(l!==void 0||i)&&r.items.push(bn(c,l,s))};if(t instanceof Map)for(const[c,l]of t)o(c,l);else if(t&&typeof t=="object")for(const c of Object.keys(t))o(c,t[c]);return typeof e.sortMapEntries=="function"&&r.items.sort(e.sortMapEntries),r}add(e,t){var r;let s;z(e)?s=e:!e||typeof e!="object"||!("key"in e)?s=new re(e,e==null?void 0:e.value):s=new re(e.key,e.value);const i=$e(this.items,s.key),a=(r=this.schema)==null?void 0:r.sortMapEntries;if(i){if(!t)throw new Error(`Key ${s.key} already set`);W(i.value)&&ns(s.value)?i.value.value=s.value:i.value=s.value}else if(a){const o=this.items.findIndex(c=>a(s,c)<0);o===-1?this.items.push(s):this.items.splice(o,0,s)}else this.items.push(s)}delete(e){const t=$e(this.items,e);return t?this.items.splice(this.items.indexOf(t),1).length>0:!1}get(e,t){const s=$e(this.items,e),i=s==null?void 0:s.value;return(!t&&W(i)?i.value:i)??void 0}has(e){return!!$e(this.items,e)}set(e,t){this.add(new re(e,t),!0)}toJSON(e,t,s){const i=s?new s:t!=null&&t.mapAsMap?new Map:{};t!=null&&t.onCreate&&t.onCreate(i);for(const a of this.items)ls(t,i,a);return i}toString(e,t,s){if(!e)return JSON.stringify(this);for(const i of this.items)if(!z(i))throw new Error(`Map items must all be pairs; found ${JSON.stringify(i)} instead`);return!e.allNullValues&&this.hasAllNullValues(!1)&&(e=Object.assign({},e,{allNullValues:!0})),cs(this,e,{blockItemPrefix:"",flowChars:{start:"{",end:"}"},itemIndent:e.indent||"",onChompKeep:s,onComment:t})}}const et={collection:"map",default:!0,nodeClass:ue,tag:"tag:yaml.org,2002:map",resolve(n,e){return ht(n)||e("Expected a mapping for this tag"),n},createNode:(n,e,t)=>ue.from(n,e,t)};class Re extends ss{static get tagName(){return"tag:yaml.org,2002:seq"}constructor(e){super(Xe,e),this.items=[]}add(e){this.items.push(e)}delete(e){const t=wt(e);return typeof t!="number"?!1:this.items.splice(t,1).length>0}get(e,t){const s=wt(e);if(typeof s!="number")return;const i=this.items[s];return!t&&W(i)?i.value:i}has(e){const t=wt(e);return typeof t=="number"&&t<this.items.length}set(e,t){const s=wt(e);if(typeof s!="number")throw new Error(`Expected a valid index, not ${e}.`);const i=this.items[s];W(i)&&ns(t)?i.value=t:this.items[s]=t}toJSON(e,t){const s=[];t!=null&&t.onCreate&&t.onCreate(s);let i=0;for(const a of this.items)s.push(de(a,String(i++),t));return s}toString(e,t,s){return e?cs(this,e,{blockItemPrefix:"- ",flowChars:{start:"[",end:"]"},itemIndent:(e.indent||"")+"  ",onChompKeep:s,onComment:t}):JSON.stringify(this)}static from(e,t,s){const{replacer:i}=s,a=new this(e);if(t&&Symbol.iterator in Object(t)){let r=0;for(let o of t){if(typeof i=="function"){const c=t instanceof Set?o:String(r++);o=i.call(t,c,o)}a.items.push(dt(o,void 0,s))}}return a}}function wt(n){let e=W(n)?n.value:n;return e&&typeof e=="string"&&(e=Number(e)),typeof e=="number"&&Number.isInteger(e)&&e>=0?e:null}const tt={collection:"seq",default:!0,nodeClass:Re,tag:"tag:yaml.org,2002:seq",resolve(n,e){return mt(n)||e("Expected a sequence for this tag"),n},createNode:(n,e,t)=>Re.from(n,e,t)},Rt={identify:n=>typeof n=="string",default:!0,tag:"tag:yaml.org,2002:str",resolve:n=>n,stringify(n,e,t,s){return e=Object.assign({actualString:!0},e),yn(n,e,t,s)}},Ft={identify:n=>n==null,createNode:()=>new O(null),default:!0,tag:"tag:yaml.org,2002:null",test:/^(?:~|[Nn]ull|NULL)?$/,resolve:()=>new O(null),stringify:({source:n},e)=>typeof n=="string"&&Ft.test.test(n)?n:e.options.nullStr},wn={identify:n=>typeof n=="boolean",default:!0,tag:"tag:yaml.org,2002:bool",test:/^(?:[Tt]rue|TRUE|[Ff]alse|FALSE)$/,resolve:n=>new O(n[0]==="t"||n[0]==="T"),stringify({source:n,value:e},t){if(n&&wn.test.test(n)){const s=n[0]==="t"||n[0]==="T";if(e===s)return n}return e?t.options.trueStr:t.options.falseStr}};function ye({format:n,minFractionDigits:e,tag:t,value:s}){if(typeof s=="bigint")return String(s);const i=typeof s=="number"?s:Number(s);if(!isFinite(i))return isNaN(i)?".nan":i<0?"-.inf":".inf";let a=Object.is(s,-0)?"-0":JSON.stringify(s);if(!n&&e&&(!t||t==="tag:yaml.org,2002:float")&&/^\d/.test(a)){let r=a.indexOf(".");r<0&&(r=a.length,a+=".");let o=e-(a.length-r-1);for(;o-- >0;)a+="0"}return a}const us={identify:n=>typeof n=="number",default:!0,tag:"tag:yaml.org,2002:float",test:/^(?:[-+]?\.(?:inf|Inf|INF)|\.nan|\.NaN|\.NAN)$/,resolve:n=>n.slice(-3).toLowerCase()==="nan"?NaN:n[0]==="-"?Number.NEGATIVE_INFINITY:Number.POSITIVE_INFINITY,stringify:ye},ds={identify:n=>typeof n=="number",default:!0,tag:"tag:yaml.org,2002:float",format:"EXP",test:/^[-+]?(?:\.[0-9]+|[0-9]+(?:\.[0-9]*)?)[eE][-+]?[0-9]+$/,resolve:n=>parseFloat(n),stringify(n){const e=Number(n.value);return isFinite(e)?e.toExponential():ye(n)}},fs={identify:n=>typeof n=="number",default:!0,tag:"tag:yaml.org,2002:float",test:/^[-+]?(?:\.[0-9]+|[0-9]+\.[0-9]*)$/,resolve(n){const e=new O(parseFloat(n)),t=n.indexOf(".");return t!==-1&&n[n.length-1]==="0"&&(e.minFractionDigits=n.length-t-1),e},stringify:ye},Bt=n=>typeof n=="bigint"||Number.isInteger(n),vn=(n,e,t,{intAsBigInt:s})=>s?BigInt(n):parseInt(n.substring(e),t);function hs(n,e,t){const{value:s}=n;return Bt(s)&&s>=0?t+s.toString(e):ye(n)}const ms={identify:n=>Bt(n)&&n>=0,default:!0,tag:"tag:yaml.org,2002:int",format:"OCT",test:/^0o[0-7]+$/,resolve:(n,e,t)=>vn(n,2,8,t),stringify:n=>hs(n,8,"0o")},ps={identify:Bt,default:!0,tag:"tag:yaml.org,2002:int",test:/^[-+]?[0-9]+$/,resolve:(n,e,t)=>vn(n,0,10,t),stringify:ye},gs={identify:n=>Bt(n)&&n>=0,default:!0,tag:"tag:yaml.org,2002:int",format:"HEX",test:/^0x[0-9a-fA-F]+$/,resolve:(n,e,t)=>vn(n,2,16,t),stringify:n=>hs(n,16,"0x")},Ti=[et,tt,Rt,Ft,wn,ms,ps,gs,us,ds,fs];function Rn(n){return typeof n=="bigint"||Number.isInteger(n)}const vt=({value:n})=>JSON.stringify(n),Ci=[{identify:n=>typeof n=="string",default:!0,tag:"tag:yaml.org,2002:str",resolve:n=>n,stringify:vt},{identify:n=>n==null,createNode:()=>new O(null),default:!0,tag:"tag:yaml.org,2002:null",test:/^null$/,resolve:()=>null,stringify:vt},{identify:n=>typeof n=="boolean",default:!0,tag:"tag:yaml.org,2002:bool",test:/^true$|^false$/,resolve:n=>n==="true",stringify:vt},{identify:Rn,default:!0,tag:"tag:yaml.org,2002:int",test:/^-?(?:0|[1-9][0-9]*)$/,resolve:(n,e,{intAsBigInt:t})=>t?BigInt(n):parseInt(n,10),stringify:({value:n})=>Rn(n)?n.toString():JSON.stringify(n)},{identify:n=>typeof n=="number",default:!0,tag:"tag:yaml.org,2002:float",test:/^-?(?:0|[1-9][0-9]*)(?:\.[0-9]*)?(?:[eE][-+]?[0-9]+)?$/,resolve:n=>parseFloat(n),stringify:vt}],Oi={default:!0,tag:"",test:/^/,resolve(n,e){return e(`Unresolved plain scalar ${JSON.stringify(n)}`),n}},Mi=[et,tt].concat(Ci,Oi),Sn={identify:n=>n instanceof Uint8Array,default:!1,tag:"tag:yaml.org,2002:binary",resolve(n,e){if(typeof atob=="function"){const t=atob(n.replace(/[\n\r]/g,"")),s=new Uint8Array(t.length);for(let i=0;i<t.length;++i)s[i]=t.charCodeAt(i);return s}else return e("This environment does not support reading binary tags; either Buffer or atob is required"),n},stringify({comment:n,type:e,value:t},s,i,a){if(!t)return"";const r=t;let o;if(typeof btoa=="function"){let c="";for(let l=0;l<r.length;++l)c+=String.fromCharCode(r[l]);o=btoa(c)}else throw new Error("This environment does not support writing binary tags; either Buffer or btoa is required");if(e??(e=O.BLOCK_LITERAL),e!==O.QUOTE_DOUBLE){const c=Math.max(s.options.lineWidth-s.indent.length,s.options.minContentWidth),l=Math.ceil(o.length/c),d=new Array(l);for(let u=0,p=0;u<l;++u,p+=c)d[u]=o.substr(p,c);o=d.join(e===O.BLOCK_LITERAL?`
`:" ")}return yn({comment:n,type:e,value:o},s,i,a)}};function ys(n,e){if(mt(n))for(let t=0;t<n.items.length;++t){let s=n.items[t];if(!z(s)){if(ht(s)){s.items.length>1&&e("Each pair must have its own sequence indicator");const i=s.items[0]||new re(new O(null));if(s.commentBefore&&(i.key.commentBefore=i.key.commentBefore?`${s.commentBefore}
${i.key.commentBefore}`:s.commentBefore),s.comment){const a=i.value??i.key;a.comment=a.comment?`${s.comment}
${a.comment}`:s.comment}s=i}n.items[t]=z(s)?s:new re(s)}}else e("Expected a sequence for this tag");return n}function bs(n,e,t){const{replacer:s}=t,i=new Re(n);i.tag="tag:yaml.org,2002:pairs";let a=0;if(e&&Symbol.iterator in Object(e))for(let r of e){typeof s=="function"&&(r=s.call(e,String(a++),r));let o,c;if(Array.isArray(r))if(r.length===2)o=r[0],c=r[1];else throw new TypeError(`Expected [key, value] tuple: ${r}`);else if(r&&r instanceof Object){const l=Object.keys(r);if(l.length===1)o=l[0],c=r[o];else throw new TypeError(`Expected tuple with one key, not ${l.length} keys`)}else o=r;i.items.push(bn(o,c,t))}return i}const _n={collection:"seq",default:!1,tag:"tag:yaml.org,2002:pairs",resolve:ys,createNode:bs};class Ye extends Re{constructor(){super(),this.add=ue.prototype.add.bind(this),this.delete=ue.prototype.delete.bind(this),this.get=ue.prototype.get.bind(this),this.has=ue.prototype.has.bind(this),this.set=ue.prototype.set.bind(this),this.tag=Ye.tag}toJSON(e,t){if(!t)return super.toJSON(e);const s=new Map;t!=null&&t.onCreate&&t.onCreate(s);for(const i of this.items){let a,r;if(z(i)?(a=de(i.key,"",t),r=de(i.value,a,t)):a=de(i,"",t),s.has(a))throw new Error("Ordered maps must not include duplicate keys");s.set(a,r)}return s}static from(e,t,s){const i=bs(e,t,s),a=new this;return a.items=i.items,a}}Ye.tag="tag:yaml.org,2002:omap";const kn={collection:"seq",identify:n=>n instanceof Map,nodeClass:Ye,default:!1,tag:"tag:yaml.org,2002:omap",resolve(n,e){const t=ys(n,e),s=[];for(const{key:i}of t.items)W(i)&&(s.includes(i.value)?e(`Ordered maps must not include duplicate keys: ${i.value}`):s.push(i.value));return Object.assign(new Ye,t)},createNode:(n,e,t)=>Ye.from(n,e,t)};function ws({value:n,source:e},t){return e&&(n?vs:Ss).test.test(e)?e:n?t.options.trueStr:t.options.falseStr}const vs={identify:n=>n===!0,default:!0,tag:"tag:yaml.org,2002:bool",test:/^(?:Y|y|[Yy]es|YES|[Tt]rue|TRUE|[Oo]n|ON)$/,resolve:()=>new O(!0),stringify:ws},Ss={identify:n=>n===!1,default:!0,tag:"tag:yaml.org,2002:bool",test:/^(?:N|n|[Nn]o|NO|[Ff]alse|FALSE|[Oo]ff|OFF)$/,resolve:()=>new O(!1),stringify:ws},Pi={identify:n=>typeof n=="number",default:!0,tag:"tag:yaml.org,2002:float",test:/^(?:[-+]?\.(?:inf|Inf|INF)|\.nan|\.NaN|\.NAN)$/,resolve:n=>n.slice(-3).toLowerCase()==="nan"?NaN:n[0]==="-"?Number.NEGATIVE_INFINITY:Number.POSITIVE_INFINITY,stringify:ye},xi={identify:n=>typeof n=="number",default:!0,tag:"tag:yaml.org,2002:float",format:"EXP",test:/^[-+]?(?:[0-9][0-9_]*)?(?:\.[0-9_]*)?[eE][-+]?[0-9]+$/,resolve:n=>parseFloat(n.replace(/_/g,"")),stringify(n){const e=Number(n.value);return isFinite(e)?e.toExponential():ye(n)}},$i={identify:n=>typeof n=="number",default:!0,tag:"tag:yaml.org,2002:float",test:/^[-+]?(?:[0-9][0-9_]*)?\.[0-9_]*$/,resolve(n){const e=new O(parseFloat(n.replace(/_/g,""))),t=n.indexOf(".");if(t!==-1){const s=n.substring(t+1).replace(/_/g,"");s[s.length-1]==="0"&&(e.minFractionDigits=s.length)}return e},stringify:ye},pt=n=>typeof n=="bigint"||Number.isInteger(n);function Vt(n,e,t,{intAsBigInt:s}){const i=n[0];if((i==="-"||i==="+")&&(e+=1),n=n.substring(e).replace(/_/g,""),s){switch(t){case 2:n=`0b${n}`;break;case 8:n=`0o${n}`;break;case 16:n=`0x${n}`;break}const r=BigInt(n);return i==="-"?BigInt(-1)*r:r}const a=parseInt(n,t);return i==="-"?-1*a:a}function En(n,e,t){const{value:s}=n;if(pt(s)){const i=s.toString(e);return s<0?"-"+t+i.substr(1):t+i}return ye(n)}const Ri={identify:pt,default:!0,tag:"tag:yaml.org,2002:int",format:"BIN",test:/^[-+]?0b[0-1_]+$/,resolve:(n,e,t)=>Vt(n,2,2,t),stringify:n=>En(n,2,"0b")},Fi={identify:pt,default:!0,tag:"tag:yaml.org,2002:int",format:"OCT",test:/^[-+]?0[0-7_]+$/,resolve:(n,e,t)=>Vt(n,1,8,t),stringify:n=>En(n,8,"0")},Bi={identify:pt,default:!0,tag:"tag:yaml.org,2002:int",test:/^[-+]?[0-9][0-9_]*$/,resolve:(n,e,t)=>Vt(n,0,10,t),stringify:ye},Vi={identify:pt,default:!0,tag:"tag:yaml.org,2002:int",format:"HEX",test:/^[-+]?0x[0-9a-fA-F_]+$/,resolve:(n,e,t)=>Vt(n,2,16,t),stringify:n=>En(n,16,"0x")};class Je extends ue{constructor(e){super(e),this.tag=Je.tag}add(e){let t;z(e)?t=e:e&&typeof e=="object"&&"key"in e&&"value"in e&&e.value===null?t=new re(e.key,null):t=new re(e,null),$e(this.items,t.key)||this.items.push(t)}get(e,t){const s=$e(this.items,e);return!t&&z(s)?W(s.key)?s.key.value:s.key:s}set(e,t){if(typeof t!="boolean")throw new Error(`Expected boolean value for set(key, value) in a YAML set, not ${typeof t}`);const s=$e(this.items,e);s&&!t?this.items.splice(this.items.indexOf(s),1):!s&&t&&this.items.push(new re(e))}toJSON(e,t){return super.toJSON(e,t,Set)}toString(e,t,s){if(!e)return JSON.stringify(this);if(this.hasAllNullValues(!0))return super.toString(Object.assign({},e,{allNullValues:!0}),t,s);throw new Error("Set items must all have null values")}static from(e,t,s){const{replacer:i}=s,a=new this(e);if(t&&Symbol.iterator in Object(t))for(let r of t)typeof i=="function"&&(r=i.call(t,r,r)),a.items.push(bn(r,null,s));return a}}Je.tag="tag:yaml.org,2002:set";const Ln={collection:"map",identify:n=>n instanceof Set,nodeClass:Je,default:!1,tag:"tag:yaml.org,2002:set",createNode:(n,e,t)=>Je.from(n,e,t),resolve(n,e){if(ht(n)){if(n.hasAllNullValues(!0))return Object.assign(new Je,n);e("Set items must all have null values")}else e("Expected a mapping for this tag");return n}};function In(n,e){const t=n[0],s=t==="-"||t==="+"?n.substring(1):n,i=r=>e?BigInt(r):Number(r),a=s.replace(/_/g,"").split(":").reduce((r,o)=>r*i(60)+i(o),i(0));return t==="-"?i(-1)*a:a}function _s(n){let{value:e}=n,t=r=>r;if(typeof e=="bigint")t=r=>BigInt(r);else if(isNaN(e)||!isFinite(e))return ye(n);let s="";e<0&&(s="-",e*=t(-1));const i=t(60),a=[e%i];return e<60?a.unshift(0):(e=(e-a[0])/i,a.unshift(e%i),e>=60&&(e=(e-a[0])/i,a.unshift(e))),s+a.map(r=>String(r).padStart(2,"0")).join(":").replace(/000000\d*$/,"")}const ks={identify:n=>typeof n=="bigint"||Number.isInteger(n),default:!0,tag:"tag:yaml.org,2002:int",format:"TIME",test:/^[-+]?[0-9][0-9_]*(?::[0-5]?[0-9])+$/,resolve:(n,e,{intAsBigInt:t})=>In(n,t),stringify:_s},Es={identify:n=>typeof n=="number",default:!0,tag:"tag:yaml.org,2002:float",format:"TIME",test:/^[-+]?[0-9][0-9_]*(?::[0-5]?[0-9])+\.[0-9_]*$/,resolve:n=>In(n,!1),stringify:_s},Dt={identify:n=>n instanceof Date,default:!0,tag:"tag:yaml.org,2002:timestamp",test:RegExp("^([0-9]{4})-([0-9]{1,2})-([0-9]{1,2})(?:(?:t|T|[ \\t]+)([0-9]{1,2}):([0-9]{1,2}):([0-9]{1,2}(\\.[0-9]+)?)(?:[ \\t]*(Z|[-+][012]?[0-9](?::[0-9]{2})?))?)?$"),resolve(n){const e=n.match(Dt.test);if(!e)throw new Error("!!timestamp expects a date, starting with yyyy-mm-dd");const[,t,s,i,a,r,o]=e.map(Number),c=e[7]?Number((e[7]+"00").substr(1,3)):0;let l=Date.UTC(t,s-1,i,a||0,r||0,o||0,c);const d=e[8];if(d&&d!=="Z"){let u=In(d,!1);Math.abs(u)<30&&(u*=60),l-=6e4*u}return new Date(l)},stringify:({value:n})=>(n==null?void 0:n.toISOString().replace(/(T00:00:00)?\.000Z$/,""))??""},Fn=[et,tt,Rt,Ft,vs,Ss,Ri,Fi,Bi,Vi,Pi,xi,$i,Sn,Ee,kn,_n,Ln,ks,Es,Dt],Bn=new Map([["core",Ti],["failsafe",[et,tt,Rt]],["json",Mi],["yaml11",Fn],["yaml-1.1",Fn]]),Vn={binary:Sn,bool:wn,float:fs,floatExp:ds,floatNaN:us,floatTime:Es,int:ps,intHex:gs,intOct:ms,intTime:ks,map:et,merge:Ee,null:Ft,omap:kn,pairs:_n,seq:tt,set:Ln,timestamp:Dt},Di={"tag:yaml.org,2002:binary":Sn,"tag:yaml.org,2002:merge":Ee,"tag:yaml.org,2002:omap":kn,"tag:yaml.org,2002:pairs":_n,"tag:yaml.org,2002:set":Ln,"tag:yaml.org,2002:timestamp":Dt};function Gt(n,e,t){const s=Bn.get(e);if(s&&!n)return t&&!s.includes(Ee)?s.concat(Ee):s.slice();let i=s;if(!i)if(Array.isArray(n))i=[];else{const a=Array.from(Bn.keys()).filter(r=>r!=="yaml11").map(r=>JSON.stringify(r)).join(", ");throw new Error(`Unknown schema "${e}"; use one of ${a} or define customTags array`)}if(Array.isArray(n))for(const a of n)i=i.concat(a);else typeof n=="function"&&(i=n(i.slice()));return t&&(i=i.concat(Ee)),i.reduce((a,r)=>{const o=typeof r=="string"?Vn[r]:r;if(!o){const c=JSON.stringify(r),l=Object.keys(Vn).map(d=>JSON.stringify(d)).join(", ");throw new Error(`Unknown custom tag ${c}; use one of ${l}`)}return a.includes(o)||a.push(o),a},[])}const Ui=(n,e)=>n.key<e.key?-1:n.key>e.key?1:0;class Nn{constructor({compat:e,customTags:t,merge:s,resolveKnownTags:i,schema:a,sortMapEntries:r,toStringDefaults:o}){this.compat=Array.isArray(e)?Gt(e,"compat"):e?Gt(null,e):null,this.name=typeof a=="string"&&a||"core",this.knownTags=i?Di:{},this.tags=Gt(t,this.name,s),this.toStringOptions=o??null,Object.defineProperty(this,Ce,{value:et}),Object.defineProperty(this,ve,{value:Rt}),Object.defineProperty(this,Xe,{value:tt}),this.sortMapEntries=typeof r=="function"?r:r===!0?Ui:null}clone(){const e=Object.create(Nn.prototype,Object.getOwnPropertyDescriptors(this));return e.tags=this.tags.slice(),e}}function Hi(n,e){var c;const t=[];let s=e.directives===!0;if(e.directives!==!1&&n.directives){const l=n.directives.toString(n);l?(t.push(l),s=!0):n.directives.docStart&&(s=!0)}s&&t.push("---");const i=as(n,e),{commentString:a}=i.options;if(n.commentBefore){t.length!==1&&t.unshift("");const l=a(n.commentBefore);t.unshift(_e(l,""))}let r=!1,o=null;if(n.contents){if(J(n.contents)){if(n.contents.spaceBefore&&s&&t.push(""),n.contents.commentBefore){const u=a(n.contents.commentBefore);t.push(_e(u,""))}i.forceBlockIndent=!!n.comment,o=n.contents.comment}const l=o?void 0:()=>r=!0;let d=ze(n.contents,i,()=>o=null,l);o&&(d+=xe(d,"",a(o))),(d[0]==="|"||d[0]===">")&&t[t.length-1]==="---"?t[t.length-1]=`--- ${d}`:t.push(d)}else t.push(ze(n.contents,i));if((c=n.directives)!=null&&c.docEnd)if(n.comment){const l=a(n.comment);l.includes(`
`)?(t.push("..."),t.push(_e(l,""))):t.push(`... ${l}`)}else t.push("...");else{let l=n.comment;l&&r&&(l=l.replace(/^\n+/,"")),l&&((!r||o)&&t[t.length-1]!==""&&t.push(""),t.push(_e(a(l),"")))}return t.join(`
`)+`
`}class Ut{constructor(e,t,s){this.commentBefore=null,this.comment=null,this.errors=[],this.warnings=[],Object.defineProperty(this,fe,{value:an});let i=null;typeof t=="function"||Array.isArray(t)?i=t:s===void 0&&t&&(s=t,t=void 0);const a=Object.assign({intAsBigInt:!1,keepSourceTokens:!1,logLevel:"warn",prettyErrors:!0,strict:!0,stringKeys:!1,uniqueKeys:!0,version:"1.2"},s);this.options=a;let{version:r}=a;s!=null&&s._directives?(this.directives=s._directives.atDocument(),this.directives.yaml.explicit&&(r=this.directives.yaml.version)):this.directives=new ae({version:r}),this.setSchema(r,s),this.contents=e===void 0?null:this.createNode(e,i,s)}clone(){const e=Object.create(Ut.prototype,{[fe]:{value:an}});return e.commentBefore=this.commentBefore,e.comment=this.comment,e.errors=this.errors.slice(),e.warnings=this.warnings.slice(),e.options=Object.assign({},this.options),this.directives&&(e.directives=this.directives.clone()),e.schema=this.schema.clone(),e.contents=J(this.contents)?this.contents.clone(e.schema):this.contents,this.range&&(e.range=this.range.slice()),e}add(e){De(this.contents)&&this.contents.add(e)}addIn(e,t){De(this.contents)&&this.contents.addIn(e,t)}createAlias(e,t){if(!e.anchor){const s=es(this);e.anchor=!t||s.has(t)?ts(t||"a",s):t}return new gn(e.anchor)}createNode(e,t,s){let i;if(typeof t=="function")e=t.call({"":e},"",e),i=t;else if(Array.isArray(t)){const h=k=>typeof k=="number"||k instanceof String||k instanceof Number,y=t.filter(h).map(String);y.length>0&&(t=t.concat(y)),i=t}else s===void 0&&t&&(s=t,t=void 0);const{aliasDuplicateObjects:a,anchorPrefix:r,flow:o,keepUndefined:c,onTagObj:l,tag:d}=s??{},{onAnchor:u,setAnchors:p,sourceObjects:g}=gi(this,r||"a"),b={aliasDuplicateObjects:a??!0,keepUndefined:c??!1,onAnchor:u,onTagObj:l,replacer:i,schema:this.schema,sourceObjects:g},f=dt(e,d,b);return o&&Y(f)&&(f.flow=!0),p(),f}createPair(e,t,s={}){const i=this.createNode(e,null,s),a=this.createNode(t,null,s);return new re(i,a)}delete(e){return De(this.contents)?this.contents.delete(e):!1}deleteIn(e){return at(e)?this.contents==null?!1:(this.contents=null,!0):De(this.contents)?this.contents.deleteIn(e):!1}get(e,t){return Y(this.contents)?this.contents.get(e,t):void 0}getIn(e,t){return at(e)?!t&&W(this.contents)?this.contents.value:this.contents:Y(this.contents)?this.contents.getIn(e,t):void 0}has(e){return Y(this.contents)?this.contents.has(e):!1}hasIn(e){return at(e)?this.contents!==void 0:Y(this.contents)?this.contents.hasIn(e):!1}set(e,t){this.contents==null?this.contents=At(this.schema,[e],t):De(this.contents)&&this.contents.set(e,t)}setIn(e,t){at(e)?this.contents=t:this.contents==null?this.contents=At(this.schema,Array.from(e),t):De(this.contents)&&this.contents.setIn(e,t)}setSchema(e,t={}){typeof e=="number"&&(e=String(e));let s;switch(e){case"1.1":this.directives?this.directives.yaml.version="1.1":this.directives=new ae({version:"1.1"}),s={resolveKnownTags:!1,schema:"yaml-1.1"};break;case"1.2":case"next":this.directives?this.directives.yaml.version=e:this.directives=new ae({version:e}),s={resolveKnownTags:!0,schema:"core"};break;case null:this.directives&&delete this.directives,s=null;break;default:{const i=JSON.stringify(e);throw new Error(`Expected '1.1', '1.2' or null as first argument, but found: ${i}`)}}if(t.schema instanceof Object)this.schema=t.schema;else if(s)this.schema=new Nn(Object.assign(s,t));else throw new Error("With a null YAML version, the { schema: Schema } option is required")}toJS({json:e,jsonArg:t,mapAsMap:s,maxAliasCount:i,onAnchor:a,reviver:r}={}){const o={anchors:new Map,doc:this,keep:!e,mapAsMap:s===!0,mapKeyWarned:!1,maxAliasCount:typeof i=="number"?i:100},c=de(this.contents,t??"",o);if(typeof a=="function")for(const{count:l,res:d}of o.anchors.values())a(d,l);return typeof r=="function"?We(r,{"":c},"",c):c}toJSON(e,t){return this.toJS({json:!0,jsonArg:e,mapAsMap:!1,onAnchor:t})}toString(e={}){if(this.errors.length>0)throw new Error("Document with errors cannot be stringified");if("indent"in e&&(!Number.isInteger(e.indent)||Number(e.indent)<=0)){const t=JSON.stringify(e.indent);throw new Error(`"indent" option must be a positive integer, not ${t}`)}return Hi(this,e)}}function De(n){if(Y(n))return!0;throw new Error("Expected a YAML collection as document contents")}class Ls extends Error{constructor(e,t,s,i){super(),this.name=e,this.code=s,this.message=i,this.pos=t}}class rt extends Ls{constructor(e,t,s){super("YAMLParseError",e,t,s)}}class ji extends Ls{constructor(e,t,s){super("YAMLWarning",e,t,s)}}const Dn=(n,e)=>t=>{if(t.pos[0]===-1)return;t.linePos=t.pos.map(o=>e.linePos(o));const{line:s,col:i}=t.linePos[0];t.message+=` at line ${s}, column ${i}`;let a=i-1,r=n.substring(e.lineStarts[s-1],e.lineStarts[s]).replace(/[\n\r]+$/,"");if(a>=60&&r.length>80){const o=Math.min(a-39,r.length-79);r="…"+r.substring(o),a-=o-1}if(r.length>80&&(r=r.substring(0,79)+"…"),s>1&&/^ *$/.test(r.substring(0,a))){let o=n.substring(e.lineStarts[s-2],e.lineStarts[s-1]);o.length>80&&(o=o.substring(0,79)+`…
...
${r}
${l}
`}};function Qe(n,{flow:e,indicator:t,next:s,offset:i,onError:a,parentIndent:r,startOnNewline:o}){let c=!1,l=o,d=o,u="",p="",g=!1,b=!1,f=null,h=null,y=null,k=null,S=null,v=null,_=null;for(const E of n)switch(b&&(E.type!=="space"&&E.type!=="newline"&&E.type!=="comma"&&a(E.offset,"MISSING_CHAR","Tags and anchors must be separated from the next token by white space"),b=!1),f&&(l&&E.type!=="comment"&&E.type!=="newline"&&a(f,"TAB_AS_INDENT","Tabs are not allowed as indentation"),f=null),E.type){case"space":!e&&(t!=="doc-start"||(s==null?void 0:s.type)!=="flow-collection")&&E.source.includes("	")&&(f=E),d=!0;break;case"comment":{d||a(E,"MISSING_CHAR","Comments must be separated from other tokens by white space characters");const T=E.source.substring(1)||" ";u?u+=p+T:u=T,p="",l=!1;break}case"newline":l?u?u+=E.source:(!v||t!=="seq-item-ind")&&(c=!0):p+=E.source,l=!0,g=!0,(h||y)&&(k=E),d=!0;break;case"anchor":h&&a(E,"MULTIPLE_ANCHORS","A node can have at most one anchor"),E.source.endsWith(":")&&a(E.offset+E.source.length-1,"BAD_ALIAS","Anchor ending in : is ambiguous",!0),h=E,_??(_=E.offset),l=!1,d=!1,b=!0;break;case"tag":{y&&a(E,"MULTIPLE_TAGS","A node can have at most one tag"),y=E,_??(_=E.offset),l=!1,d=!1,b=!0;break}case t:(h||y)&&a(E,"BAD_PROP_ORDER",`Anchors and tags must be after the ${E.source} indicator`),v&&a(E,"UNEXPECTED_TOKEN",`Unexpected ${E.source} in ${e??"collection"}`),v=E,l=t==="seq-item-ind"||t==="explicit-key-ind",d=!1;break;case"comma":if(e){S&&a(E,"UNEXPECTED_TOKEN",`Unexpected , in ${e}`),S=E,l=!1,d=!1;break}default:a(E,"UNEXPECTED_TOKEN",`Unexpected ${E.type} token`),l=!1,d=!1}const I=n[n.length-1],L=I?I.offset+I.source.length:i;return b&&s&&s.type!=="space"&&s.type!=="newline"&&s.type!=="comma"&&(s.type!=="scalar"||s.source!=="")&&a(s.offset,"MISSING_CHAR","Tags and anchors must be separated from the next token by white space"),f&&(l&&f.indent<=r||(s==null?void 0:s.type)==="block-map"||(s==null?void 0:s.type)==="block-seq")&&a(f,"TAB_AS_INDENT","Tabs are not allowed as indentation"),{comma:S,found:v,spaceBefore:c,comment:u,hasNewline:g,anchor:h,tag:y,newlineAfterProp:k,end:L,start:_??L}}function ft(n){if(!n)return null;switch(n.type){case"alias":case"scalar":case"double-quoted-scalar":case"single-quoted-scalar":if(n.source.includes(`
`))return!0;if(n.end){for(const e of n.end)if(e.type==="newline")return!0}return!1;case"flow-collection":for(const e of n.items){for(const t of e.start)if(t.type==="newline")return!0;if(e.sep){for(const t of e.sep)if(t.type==="newline")return!0}if(ft(e.key)||ft(e.value))return!0}return!1;default:return!0}}function cn(n,e,t){if((e==null?void 0:e.type)==="flow-collection"){const s=e.end[0];s.indent===n&&(s.source==="]"||s.source==="}")&&ft(e)&&t(s,"BAD_INDENT","Flow end indicator should be more indented than parent",!0)}}function Is(n,e,t){const{uniqueKeys:s}=n.options;if(s===!1)return!1;const i=typeof s=="function"?s:(a,r)=>a===r||W(a)&&W(r)&&a.value===r.value;return e.some(a=>i(a.key,t))}const Un="All mapping items must start at the same column";function Ki({composeNode:n,composeEmptyNode:e},t,s,i,a){var d;const r=(a==null?void 0:a.nodeClass)??ue,o=new r(t.schema);t.atRoot&&(t.atRoot=!1);let c=s.offset,l=null;for(const u of s.items){const{start:p,key:g,sep:b,value:f}=u,h=Qe(p,{indicator:"explicit-key-ind",next:g??(b==null?void 0:b[0]),offset:c,onError:i,parentIndent:s.indent,startOnNewline:!0}),y=!h.found;if(y){if(g&&(g.type==="block-seq"?i(c,"BLOCK_AS_IMPLICIT_KEY","A block sequence may not be used as an implicit map key"):"indent"in g&&g.indent!==s.indent&&i(c,"BAD_INDENT",Un)),!h.anchor&&!h.tag&&!b){l=h.end,h.comment&&(o.comment?o.comment+=`
`+h.comment:o.comment=h.comment);continue}(h.newlineAfterProp||ft(g))&&i(g??p[p.length-1],"MULTILINE_IMPLICIT_KEY","Implicit keys need to be on a single line")}else((d=h.found)==null?void 0:d.indent)!==s.indent&&i(c,"BAD_INDENT",Un);t.atKey=!0;const k=h.end,S=g?n(t,g,h,i):e(t,k,p,null,h,i);t.schema.compat&&cn(s.indent,g,i),t.atKey=!1,Is(t,o.items,S)&&i(k,"DUPLICATE_KEY","Map keys must be unique");const v=Qe(b??[],{indicator:"map-value-ind",next:f,offset:S.range[2],onError:i,parentIndent:s.indent,startOnNewline:!g||g.type==="block-scalar"});if(c=v.end,v.found){y&&((f==null?void 0:f.type)==="block-map"&&!v.hasNewline&&i(c,"BLOCK_AS_IMPLICIT_KEY","Nested mappings are not allowed in compact mappings"),t.options.strict&&h.start<v.found.offset-1024&&i(S.range,"KEY_OVER_1024_CHARS","The : indicator must be at most 1024 chars after the start of an implicit block mapping key"));const _=f?n(t,f,v,i):e(t,c,b,null,v,i);t.schema.compat&&cn(s.indent,f,i),c=_.range[2];const I=new re(S,_);t.options.keepSourceTokens&&(I.srcToken=u),o.items.push(I)}else{y&&i(S.range,"MISSING_CHAR","Implicit map keys need to be followed by map values"),v.comment&&(S.comment?S.comment+=`
`+v.comment:S.comment=v.comment);const _=new re(S);t.options.keepSourceTokens&&(_.srcToken=u),o.items.push(_)}}return l&&l<c&&i(l,"IMPOSSIBLE","Map comment with trailing content"),o.range=[s.offset,c,l??c],o}function qi({composeNode:n,composeEmptyNode:e},t,s,i,a){const r=(a==null?void 0:a.nodeClass)??Re,o=new r(t.schema);t.atRoot&&(t.atRoot=!1),t.atKey&&(t.atKey=!1);let c=s.offset,l=null;for(const{start:d,value:u}of s.items){const p=Qe(d,{indicator:"seq-item-ind",next:u,offset:c,onError:i,parentIndent:s.indent,startOnNewline:!0});if(!p.found)if(p.anchor||p.tag||u)(u==null?void 0:u.type)==="block-seq"?i(p.end,"BAD_INDENT","All sequence items must start at the same column"):i(c,"MISSING_CHAR","Sequence item without - indicator");else{l=p.end,p.comment&&(o.comment=p.comment);continue}const g=u?n(t,u,p,i):e(t,p.end,d,null,p,i);t.schema.compat&&cn(s.indent,u,i),c=g.range[2],o.items.push(g)}return o.range=[s.offset,c,l??c],o}function gt(n,e,t,s){let i="";if(n){let a=!1,r="";for(const o of n){const{source:c,type:l}=o;switch(l){case"space":a=!0;break;case"comment":{t&&!a&&s(o,"MISSING_CHAR","Comments must be separated from other tokens by white space characters");const d=c.substring(1)||" ";i?i+=r+d:i=d,r="";break}case"newline":i&&(r+=c),a=!0;break;default:s(o,"UNEXPECTED_TOKEN",`Unexpected ${l} at node end`)}e+=c.length}}return{comment:i,offset:e}}const Yt="Block collections are not allowed within flow collections",Jt=n=>n&&(n.type==="block-map"||n.type==="block-seq");function Wi({composeNode:n,composeEmptyNode:e},t,s,i,a){var h;const r=s.start.source==="{",o=r?"flow map":"flow sequence",c=(a==null?void 0:a.nodeClass)??(r?ue:Re),l=new c(t.schema);l.flow=!0;const d=t.atRoot;d&&(t.atRoot=!1),t.atKey&&(t.atKey=!1);let u=s.offset+s.start.source.length;for(let y=0;y<s.items.length;++y){const k=s.items[y],{start:S,key:v,sep:_,value:I}=k,L=Qe(S,{flow:o,indicator:"explicit-key-ind",next:v??(_==null?void 0:_[0]),offset:u,onError:i,parentIndent:s.indent,startOnNewline:!1});if(!L.found){if(!L.anchor&&!L.tag&&!_&&!I){y===0&&L.comma?i(L.comma,"UNEXPECTED_TOKEN",`Unexpected , in ${o}`):y<s.items.length-1&&i(L.start,"UNEXPECTED_TOKEN",`Unexpected empty item in ${o}`),L.comment&&(l.comment?l.comment+=`
`+L.comment:l.comment=L.comment),u=L.end;continue}!r&&t.options.strict&&ft(v)&&i(v,"MULTILINE_IMPLICIT_KEY","Implicit keys of flow sequence pairs need to be on a single line")}if(y===0)L.comma&&i(L.comma,"UNEXPECTED_TOKEN",`Unexpected , in ${o}`);else if(L.comma||i(L.start,"MISSING_CHAR",`Missing , between ${o} items`),L.comment){let E="";e:for(const T of S)switch(T.type){case"comma":case"space":break;case"comment":E=T.source.substring(1);break e;default:break e}if(E){let T=l.items[l.items.length-1];z(T)&&(T=T.value??T.key),T.comment?T.comment+=`
`+E:T.comment=E,L.comment=L.comment.substring(E.length+1)}}if(!r&&!_&&!L.found){const E=I?n(t,I,L,i):e(t,L.end,_,null,L,i);l.items.push(E),u=E.range[2],Jt(I)&&i(E.range,"BLOCK_IN_FLOW",Yt)}else{t.atKey=!0;const E=L.end,T=v?n(t,v,L,i):e(t,E,S,null,L,i);Jt(v)&&i(T.range,"BLOCK_IN_FLOW",Yt),t.atKey=!1;const $=Qe(_??[],{flow:o,indicator:"map-value-ind",next:I,offset:T.range[2],onError:i,parentIndent:s.indent,startOnNewline:!1});if($.found){if(!r&&!L.found&&t.options.strict){if(_)for(const D of _){if(D===$.found)break;if(D.type==="newline"){i(D,"MULTILINE_IMPLICIT_KEY","Implicit keys of flow sequence pairs need to be on a single line");break}}L.start<$.found.offset-1024&&i($.found,"KEY_OVER_1024_CHARS","The : indicator must be at most 1024 chars after the start of an implicit flow sequence key")}}else I&&("source"in I&&((h=I.source)==null?void 0:h[0])===":"?i(I,"MISSING_CHAR",`Missing space after : in ${o}`):i($.start,"MISSING_CHAR",`Missing , or : between ${o} items`));const R=I?n(t,I,$,i):$.found?e(t,$.end,_,null,$,i):null;R?Jt(I)&&i(R.range,"BLOCK_IN_FLOW",Yt):$.comment&&(T.comment?T.comment+=`
`+$.comment:T.comment=$.comment);const B=new re(T,R);if(t.options.keepSourceTokens&&(B.srcToken=k),r){const D=l;Is(t,D.items,T)&&i(E,"DUPLICATE_KEY","Map keys must be unique"),D.items.push(B)}else{const D=new ue(t.schema);D.flow=!0,D.items.push(B);const G=(R??T).range;D.range=[T.range[0],G[1],G[2]],l.items.push(D)}u=R?R.range[2]:$.end}}const p=r?"}":"]",[g,...b]=s.end;let f=u;if((g==null?void 0:g.source)===p)f=g.offset+g.source.length;else{const y=o[0].toUpperCase()+o.substring(1),k=d?`${y} must end with a ${p}`:`${y} in block collection must be sufficiently indented and end with a ${p}`;i(u,d?"MISSING_CHAR":"BAD_INDENT",k),g&&g.source.length!==1&&b.unshift(g)}if(b.length>0){const y=gt(b,f,t.options.strict,i);y.comment&&(l.comment?l.comment+=`
`+y.comment:l.comment=y.comment),l.range=[s.offset,f,y.offset]}else l.range=[s.offset,f,f];return l}function zt(n,e,t,s,i,a){const r=t.type==="block-map"?Ki(n,e,t,s,a):t.type==="block-seq"?qi(n,e,t,s,a):Wi(n,e,t,s,a),o=r.constructor;return i==="!"||i===o.tagName?(r.tag=o.tagName,r):(i&&(r.tag=i),r)}function Gi(n,e,t,s,i){var p;const a=s.tag,r=a?e.directives.tagName(a.source,g=>i(a,"TAG_RESOLVE_FAILED",g)):null;if(t.type==="block-seq"){const{anchor:g,newlineAfterProp:b}=s,f=g&&a?g.offset>a.offset?g:a:g??a;f&&(!b||b.offset<f.offset)&&i(f,"MISSING_CHAR","Missing newline after block sequence props")}const o=t.type==="block-map"?"map":t.type==="block-seq"?"seq":t.start.source==="{"?"map":"seq";if(!a||!r||r==="!"||r===ue.tagName&&o==="map"||r===Re.tagName&&o==="seq")return zt(n,e,t,i,r);let c=e.schema.tags.find(g=>g.tag===r&&g.collection===o);if(!c){const g=e.schema.knownTags[r];if((g==null?void 0:g.collection)===o)e.schema.tags.push(Object.assign({},g,{default:!1})),c=g;else return g?i(a,"BAD_COLLECTION_TYPE",`${g.tag} used for ${o} collection, but expects ${g.collection??"scalar"}`,!0):i(a,"TAG_RESOLVE_FAILED",`Unresolved tag: ${r}`,!0),zt(n,e,t,i,r)}const l=zt(n,e,t,i,r,c),d=((p=c.resolve)==null?void 0:p.call(c,l,g=>i(a,"TAG_RESOLVE_FAILED",g),e.options))??l,u=J(d)?d:new O(d);return u.range=l.range,u.tag=r,c!=null&&c.format&&(u.format=c.format),u}function Yi(n,e,t){const s=e.offset,i=Ji(e,n.options.strict,t);if(!i)return{value:"",type:null,comment:"",range:[s,s,s]};const a=i.mode===">"?O.BLOCK_FOLDED:O.BLOCK_LITERAL,r=e.source?zi(e.source):[];let o=r.length;for(let f=r.length-1;f>=0;--f){const h=r[f][1];if(h===""||h==="\r")o=f;else break}if(o===0){const f=i.chomp==="+"&&r.length>0?`
`.repeat(Math.max(1,r.length-1)):"";let h=s+i.length;return e.source&&(h+=e.source.length),{value:f,type:a,comment:i.comment,range:[s,h,h]}}let c=e.indent+i.indent,l=e.offset+i.length,d=0;for(let f=0;f<o;++f){const[h,y]=r[f];if(y===""||y==="\r")i.indent===0&&h.length>c&&(c=h.length);else{h.length<c&&t(l+h.length,"MISSING_CHAR","Block scalars with more-indented leading empty lines must use an explicit indentation indicator"),i.indent===0&&(c=h.length),d=f,c===0&&!n.atRoot&&t(l,"BAD_INDENT","Block scalar values in collections must be indented");break}l+=h.length+y.length+1}for(let f=r.length-1;f>=o;--f)r[f][0].length>c&&(o=f+1);let u="",p="",g=!1;for(let f=0;f<d;++f)u+=r[f][0].slice(c)+`
`;for(let f=d;f<o;++f){let[h,y]=r[f];l+=h.length+y.length+1;const k=y[y.length-1]==="\r";if(k&&(y=y.slice(0,-1)),y&&h.length<c){const v=`Block scalar lines must not be less indented than their ${i.indent?"explicit indentation indicator":"first line"}`;t(l-y.length-(k?2:1),"BAD_INDENT",v),h=""}a===O.BLOCK_LITERAL?(u+=p+h.slice(c)+y,p=`
`):h.length>c||y[0]==="	"?(p===" "?p=`
`:!g&&p===`
`&&(p=`
...
`?u+=`
`:p=`
`:(u+=p+y,p=" ",g=!1)}switch(i.chomp){case"-":break;case"+":for(let f=o;f<r.length;++f)u+=`
`+r[f][0].slice(c);u[u.length-1]!==`
`&&(u+=`
`);break;default:u+=`
`}const b=s+i.length+e.source.length;return{value:u,type:a,comment:i.comment,range:[s,b,b]}}function Ji({offset:n,props:e},t,s){if(e[0].type!=="block-scalar-header")return s(e[0],"IMPOSSIBLE","Block scalar header not found"),null;const{source:i}=e[0],a=i[0];let r=0,o="",c=-1;for(let p=1;p<i.length;++p){const g=i[p];if(!o&&(g==="-"||g==="+"))o=g;else{const b=Number(g);!r&&b?r=b:c===-1&&(c=n+p)}}c!==-1&&s(c,"UNEXPECTED_TOKEN",`Block scalar header includes extra characters: ${i}`);let l=!1,d="",u=i.length;for(let p=1;p<e.length;++p){const g=e[p];switch(g.type){case"space":l=!0;case"newline":u+=g.source.length;break;case"comment":t&&!l&&s(g,"MISSING_CHAR","Comments must be separated from other tokens by white space characters"),u+=g.source.length,d=g.source.substring(1);break;case"error":s(g,"UNEXPECTED_TOKEN",g.message),u+=g.source.length;break;default:{const b=`Unexpected token in block scalar header: ${g.type}`;s(g,"UNEXPECTED_TOKEN",b);const f=g.source;f&&typeof f=="string"&&(u+=f.length)}}}return{mode:a,indent:r,chomp:o,comment:d,length:u}}function zi(n){const e=n.split(/\n( *)/),t=e[0],s=t.match(/^( *)/),a=[s!=null&&s[1]?[s[1],t.slice(s[1].length)]:["",t]];for(let r=1;r<e.length;r+=2)a.push([e[r],e[r+1]]);return a}function Qi(n,e,t){const{offset:s,type:i,source:a,end:r}=n;let o,c;const l=(p,g,b)=>t(s+p,g,b);switch(i){case"scalar":o=O.PLAIN,c=Xi(a,l);break;case"single-quoted-scalar":o=O.QUOTE_SINGLE,c=Zi(a,l);break;case"double-quoted-scalar":o=O.QUOTE_DOUBLE,c=ea(a,l);break;default:return t(n,"UNEXPECTED_TOKEN",`Expected a flow scalar value, but found: ${i}`),{value:"",type:null,comment:"",range:[s,s+a.length,s+a.length]}}const d=s+a.length,u=gt(r,d,e,t);return{value:c,type:o,comment:u.comment,range:[s,d,u.offset]}}function Xi(n,e){let t="";switch(n[0]){case"	":t="a tab character";break;case",":t="flow indicator character ,";break;case"%":t="directive indicator character %";break;case"|":case">":{t=`block scalar indicator ${n[0]}`;break}case"@":case"`":{t=`reserved character ${n[0]}`;break}}return t&&e(0,"BAD_SCALAR_START",`Plain value cannot start with ${t}`),Ns(n)}function Zi(n,e){return(n[n.length-1]!=="'"||n.length===1)&&e(n.length,"MISSING_CHAR","Missing closing 'quote"),Ns(n.slice(1,-1)).replace(/''/g,"'")}function Ns(n){let e,t;try{e=new RegExp(`(.*?)(?<![ 	])[ 	]*\r?
`,"sy"),t=new RegExp(`[ 	]*(.*?)(?:(?<![ 	])[ 	]*)?\r?
...
`,r:"\r",t:"	",v:"\v",N:"",_:" ",L:"\u2028",P:"\u2029"," ":" ",'"':'"',"/":"/","\\":"\\","	":"	"};function sa(n,e,t,s){const i=n.substr(e,t),r=i.length===t&&/^[0-9a-fA-F]+$/.test(i)?parseInt(i,16):NaN;if(isNaN(r)){const o=n.substr(e-2,t+2);return s(e-2,"BAD_DQ_ESCAPE",`Invalid escape sequence ${o}`),o}return String.fromCodePoint(r)}function As(n,e,t,s){const{value:i,type:a,comment:r,range:o}=e.type==="block-scalar"?Yi(n,e,s):Qi(e,n.options.strict,s),c=t?n.directives.tagName(t.source,u=>s(t,"TAG_RESOLVE_FAILED",u)):null;let l;n.options.stringKeys&&n.atKey?l=n.schema[ve]:c?l=ia(n.schema,i,c,t,s):e.type==="scalar"?l=aa(n,i,e,s):l=n.schema[ve];let d;try{const u=l.resolve(i,p=>s(t??e,"TAG_RESOLVE_FAILED",p),n.options);d=W(u)?u:new O(u)}catch(u){const p=u instanceof Error?u.message:String(u);s(t??e,"TAG_RESOLVE_FAILED",p),d=new O(i)}return d.range=o,d.source=i,a&&(d.type=a),c&&(d.tag=c),l.format&&(d.format=l.format),r&&(d.comment=r),d}function ia(n,e,t,s,i){var o;if(t==="!")return n[ve];const a=[];for(const c of n.tags)if(!c.collection&&c.tag===t)if(c.default&&c.test)a.push(c);else return c;for(const c of a)if((o=c.test)!=null&&o.test(e))return c;const r=n.knownTags[t];return r&&!r.collection?(n.tags.push(Object.assign({},r,{default:!1,test:void 0})),r):(i(s,"TAG_RESOLVE_FAILED",`Unresolved tag: ${t}`,t!=="tag:yaml.org,2002:str"),n[ve])}function aa({atKey:n,directives:e,schema:t},s,i,a){const r=t.tags.find(o=>{var c;return(o.default===!0||n&&o.default==="key")&&((c=o.test)==null?void 0:c.test(s))})||t[ve];if(t.compat){const o=t.compat.find(c=>{var l;return c.default&&((l=c.test)==null?void 0:l.test(s))})??t[ve];if(r.tag!==o.tag){const c=e.tagString(r.tag),l=e.tagString(o.tag),d=`Value may be parsed as either ${c} or ${l}`;a(i,"TAG_RESOLVE_FAILED",d,!0)}}return r}function ra(n,e,t){if(e){t??(t=e.length);for(let s=t-1;s>=0;--s){let i=e[s];switch(i.type){case"space":case"comment":case"newline":n-=i.source.length;continue}for(i=e[++s];(i==null?void 0:i.type)==="space";)n+=i.source.length,i=e[++s];break}}return n}const oa={composeNode:Ts,composeEmptyNode:An};function Ts(n,e,t,s){const i=n.atKey,{spaceBefore:a,comment:r,anchor:o,tag:c}=t;let l,d=!0;switch(e.type){case"alias":l=la(n,e,s),(o||c)&&s(e,"ALIAS_PROPS","An alias node must not specify any properties");break;case"scalar":case"single-quoted-scalar":case"double-quoted-scalar":case"block-scalar":l=As(n,e,c,s),o&&(l.anchor=o.source.substring(1));break;case"block-map":case"block-seq":case"flow-collection":try{l=Gi(oa,n,e,t,s),o&&(l.anchor=o.source.substring(1))}catch(u){const p=u instanceof Error?u.message:String(u);s(e,"RESOURCE_EXHAUSTION",p)}break;default:{const u=e.type==="error"?e.message:`Unsupported token (type: ${e.type})`;s(e,"UNEXPECTED_TOKEN",u),d=!1}}return l??(l=An(n,e.offset,void 0,null,t,s)),o&&l.anchor===""&&s(o,"BAD_ALIAS","Anchor cannot be an empty string"),i&&n.options.stringKeys&&(!W(l)||typeof l.value!="string"||l.tag&&l.tag!=="tag:yaml.org,2002:str")&&s(c??e,"NON_STRING_KEY","With stringKeys, all keys must be strings"),a&&(l.spaceBefore=!0),r&&(e.type==="scalar"&&e.source===""?l.comment=r:l.commentBefore=r),n.options.keepSourceTokens&&d&&(l.srcToken=e),l}function An(n,e,t,s,{spaceBefore:i,comment:a,anchor:r,tag:o,end:c},l){const d={type:"scalar",offset:ra(e,t,s),indent:-1,source:""},u=As(n,d,o,l);return r&&(u.anchor=r.source.substring(1),u.anchor===""&&l(r,"BAD_ALIAS","Anchor cannot be an empty string")),i&&(u.spaceBefore=!0),a&&(u.comment=a,u.range[2]=c),u}function la({options:n},{offset:e,source:t,end:s},i){const a=new gn(t.substring(1));a.source===""&&i(e,"BAD_ALIAS","Alias cannot be an empty string"),a.source.endsWith(":")&&i(e+t.length-1,"BAD_ALIAS","Alias ending in : is ambiguous",!0);const r=e+t.length,o=gt(s,r,n.strict,i);return a.range=[e,r,o.offset],o.comment&&(a.comment=o.comment),a}function ca(n,e,{offset:t,start:s,value:i,end:a},r){const o=Object.assign({_directives:e},n),c=new Ut(void 0,o),l={atKey:!1,atRoot:!0,directives:c.directives,options:c.options,schema:c.schema},d=Qe(s,{indicator:"doc-start",next:i??(a==null?void 0:a[0]),offset:t,onError:r,parentIndent:0,startOnNewline:!0});d.found&&(c.directives.docStart=!0,i&&(i.type==="block-map"||i.type==="block-seq")&&!d.hasNewline&&r(d.end,"MISSING_CHAR","Block collection cannot start on same line with directives-end marker")),c.contents=i?Ts(l,i,d,r):An(l,d.end,s,null,d,r);const u=c.contents.range[2],p=gt(a,u,!1,r);return p.comment&&(c.comment=p.comment),c.range=[t,u,p.offset],c}function nt(n){if(typeof n=="number")return[n,n+1];if(Array.isArray(n))return n.length===2?n:[n[0],n[1]];const{offset:e,source:t}=n;return[e,e+(typeof t=="string"?t.length:1)]}function Hn(n){var i;let e="",t=!1,s=!1;for(let a=0;a<n.length;++a){const r=n[a];switch(r[0]){case"#":e+=(e===""?"":s?`
...
${t.comment}`:t.comment}this.doc.range[2]=t.offset;break}default:this.errors.push(new rt(nt(e),"UNEXPECTED_TOKEN",`Unsupported token ${e.type}`))}}*end(e=!1,t=-1){if(this.doc)this.decorate(this.doc,!0),yield this.doc,this.doc=null;else if(e){const s=Object.assign({_directives:this.directives},this.options),i=new Ut(void 0,s);this.atDirectives&&this.onError(t,"MISSING_CHAR","Missing directives-end indicator line"),i.range=[0,t,t],this.decorate(i,!1),yield i}}}const Cs="\uFEFF",Os="",Ms="",un="";function da(n){switch(n){case Cs:return"byte-order-mark";case Os:return"doc-mode";case Ms:return"flow-error-end";case un:return"scalar";case"---":return"doc-start";case"...":return"doc-end";case"":case`
`:case`\r
`:return"newline";case"-":return"seq-item-ind";case"?":return"explicit-key-ind";case":":return"map-value-ind";case"{":return"flow-map-start";case"}":return"flow-map-end";case"[":return"flow-seq-start";case"]":return"flow-seq-end";case",":return"comma"}switch(n[0]){case" ":case"	":return"space";case"#":return"comment";case"%":return"directive-line";case"*":return"alias";case"&":return"anchor";case"!":return"tag";case"'":return"single-quoted-scalar";case'"':return"double-quoted-scalar";case"|":case">":return"block-scalar-header"}return null}function ge(n){switch(n){case void 0:case" ":case`
...
\r	`),Qt=n=>!n||ha.has(n);class ma{constructor(){this.atEnd=!1,this.blockScalarIndent=-1,this.blockScalarKeep=!1,this.buffer="",this.flowKey=!1,this.flowLevel=0,this.indentNext=0,this.indentValue=0,this.lineEndPos=null,this.next=null,this.pos=0}*lex(e,t=!1){if(e){if(typeof e!="string")throw TypeError("source is not a string");this.buffer=this.buffer?this.buffer+e:e,this.lineEndPos=null}this.atEnd=!t;let s=this.next??"stream";for(;s&&(t||this.hasChars(1));)s=yield*this.parseNext(s)}atLineEnd(){let e=this.pos,t=this.buffer[e];for(;t===" "||t==="	";)t=this.buffer[++e];return!t||t==="#"||t===`
...
`||s>=this.indentNext||!t&&!this.atEnd?e+s:-1}if(t==="-"||t==="."){const s=this.buffer.substr(e,3);if((s==="---"||s==="...")&&ge(this.buffer[e+3]))return-1}return e}getLine(){let e=this.lineEndPos;return(typeof e!="number"||e!==-1&&e<this.pos)&&(e=this.buffer.indexOf(`
`,this.pos),this.lineEndPos=e),e===-1?this.atEnd?this.buffer.substring(this.pos):null:(this.buffer[e-1]==="\r"&&(e-=1),this.buffer.substring(this.pos,e))}hasChars(e){return this.pos+e<=this.buffer.length}setNext(e){return this.buffer=this.buffer.substring(this.pos),this.pos=0,this.lineEndPos=null,this.next=e,null}peek(e){return this.buffer.substr(this.pos,e)}*parseNext(e){switch(e){case"stream":return yield*this.parseStream();case"line-start":return yield*this.parseLineStart();case"block-start":return yield*this.parseBlockStart();case"doc":return yield*this.parseDocument();case"flow":return yield*this.parseFlowCollection();case"quoted-scalar":return yield*this.parseQuotedScalar();case"block-scalar":return yield*this.parseBlockScalar();case"plain-scalar":return yield*this.parsePlainScalar()}}*parseStream(){let e=this.getLine();if(e===null)return this.setNext("stream");if(e[0]===Cs&&(yield*this.pushCount(1),e=e.substring(1)),e[0]==="%"){let t=e.length,s=e.indexOf("#");for(;s!==-1;){const a=e[s-1];if(a===" "||a==="	"){t=s-1;break}else s=e.indexOf("#",s+1)}for(;;){const a=e[t-1];if(a===" "||a==="	")t-=1;else break}const i=(yield*this.pushCount(t))+(yield*this.pushSpaces(!0));return yield*this.pushCount(e.length-i),this.pushNewline(),"stream"}if(this.atLineEnd()){const t=yield*this.pushSpaces(!0);return yield*this.pushCount(e.length-t),yield*this.pushNewline(),"stream"}return yield Os,yield*this.parseLineStart()}*parseLineStart(){const e=this.charAt(0);if(!e&&!this.atEnd)return this.setNext("line-start");if(e==="-"||e==="."){if(!this.atEnd&&!this.hasChars(4))return this.setNext("line-start");const t=this.peek(3);if((t==="---"||t==="...")&&ge(this.charAt(3)))return yield*this.pushCount(3),this.indentValue=0,this.indentNext=0,t==="---"?"doc":"stream"}return this.indentValue=yield*this.pushSpaces(!1),this.indentNext>this.indentValue&&!ge(this.charAt(1))&&(this.indentNext=this.indentValue),yield*this.parseBlockStart()}*parseBlockStart(){const[e,t]=this.peek(2);if(!t&&!this.atEnd)return this.setNext("block-start");if((e==="-"||e==="?"||e===":")&&ge(t)){const s=(yield*this.pushCount(1))+(yield*this.pushSpaces(!0));return this.indentNext=this.indentValue+1,this.indentValue+=s,yield*this.parseBlockStart()}return"doc"}*parseDocument(){yield*this.pushSpaces(!0);const e=this.getLine();if(e===null)return this.setNext("doc");let t=yield*this.pushIndicators();switch(e[t]){case"#":yield*this.pushCount(e.length-t);case void 0:return yield*this.pushNewline(),yield*this.parseLineStart();case"{":case"[":return yield*this.pushCount(1),this.flowKey=!1,this.flowLevel=1,"flow";case"}":case"]":return yield*this.pushCount(1),"doc";case"*":return yield*this.pushUntil(Qt),"doc";case'"':case"'":return yield*this.parseQuotedScalar();case"|":case">":return t+=yield*this.parseBlockScalarHeader(),t+=yield*this.pushSpaces(!0),yield*this.pushCount(e.length-t),yield*this.pushNewline(),yield*this.parseBlockScalar();default:return yield*this.parsePlainScalar()}}*parseFlowCollection(){let e,t,s=-1;do e=yield*this.pushNewline(),e>0?(t=yield*this.pushSpaces(!1),this.indentValue=s=t):t=0,t+=yield*this.pushSpaces(!0);while(e+t>0);const i=this.getLine();if(i===null)return this.setNext("flow");if((s!==-1&&s<this.indentNext&&i[0]!=="#"||s===0&&(i.startsWith("---")||i.startsWith("..."))&&ge(i[3]))&&!(s===this.indentNext-1&&this.flowLevel===1&&(i[0]==="]"||i[0]==="}")))return this.flowLevel=0,yield Ms,yield*this.parseLineStart();let a=0;for(;i[a]===",";)a+=yield*this.pushCount(1),a+=yield*this.pushSpaces(!0),this.flowKey=!1;switch(a+=yield*this.pushIndicators(),i[a]){case void 0:return"flow";case"#":return yield*this.pushCount(i.length-a),"flow";case"{":case"[":return yield*this.pushCount(1),this.flowKey=!1,this.flowLevel+=1,"flow";case"}":case"]":return yield*this.pushCount(1),this.flowKey=!0,this.flowLevel-=1,this.flowLevel?"flow":"doc";case"*":return yield*this.pushUntil(Qt),"flow";case'"':case"'":return this.flowKey=!0,yield*this.parseQuotedScalar();case":":{const r=this.charAt(1);if(this.flowKey||ge(r)||r===",")return this.flowKey=!1,yield*this.pushCount(1),yield*this.pushSpaces(!0),"flow"}default:return this.flowKey=!1,yield*this.parsePlainScalar()}}*parseQuotedScalar(){const e=this.charAt(0);let t=this.buffer.indexOf(e,this.pos+1);if(e==="'")for(;t!==-1&&this.buffer[t+1]==="'";)t=this.buffer.indexOf("'",t+2);else for(;t!==-1;){let a=0;for(;this.buffer[t-1-a]==="\\";)a+=1;if(a%2===0)break;t=this.buffer.indexOf('"',t+1)}const s=this.buffer.substring(0,t);let i=s.indexOf(`
`,this.pos);if(i!==-1){for(;i!==-1;){const a=this.continueScalar(i+1);if(a===-1)break;i=s.indexOf(`
`,a)}i!==-1&&(t=i-(s[i-1]==="\r"?2:1))}if(t===-1){if(!this.atEnd)return this.setNext("quoted-scalar");t=this.buffer.length}return yield*this.pushToIndex(t+1,!1),this.flowLevel?"flow":"doc"}*parseBlockScalarHeader(){this.blockScalarIndent=-1,this.blockScalarKeep=!1;let e=this.pos;for(;;){const t=this.buffer[++e];if(t==="+")this.blockScalarKeep=!0;else if(t>"0"&&t<="9")this.blockScalarIndent=Number(t)-1;else if(t!=="-")break}return yield*this.pushUntil(t=>ge(t)||t==="#")}*parseBlockScalar(){let e=this.pos-1,t=0,s;e:for(let a=this.pos;s=this.buffer[a];++a)switch(s){case" ":t+=1;break;case`
...
cosmos:
  liveStats:
    ...
    - id: g_updates_total
      ...
      live: true
      integer: true
`;function Q(n){if(/^[a-z]+:\/\//i.test(n)||n.startsWith("data:")||n.startsWith("blob:"))return n;const e="/engine/",t=e.endsWith("/")?e:`${e}/`,s=n.startsWith("/")?n.slice(1):n;return`${t}${s}`}const ka=Le(wa),Ea=Le(va),La=Le(Sa),Ia=Le(_a),He=Object.entries(ka).map(([n,e])=>{var a;const t=Na(La[n]),s=((a=Ia[n])==null?void 0:a.liveStats)??[],i=Ea[n]??{};return{id:n,label:e.label,placeholderImage:Q(e.placeholderImage),metadata:{distinctSimulations:e.metadata.distinctSimulations,correctValues:e.metadata.correctValues,summaryStats:t.map(ut),liveStats:s.map(ut)},parameters:Object.entries(i).map(([r,o])=>{const c=o.step??Aa(o.min,o.max),l=Ta(o.min,o.max);return{id:r,label:o.label,unit:o.unit??"",min:o.min,max:o.max,step:c,fallbackValue:l,description:o.description,valueScale:o.value_scale,displayUnit:o.display_unit,displayFormat:o.display_format,displaySignificantFigures:o.display_significant_figures}}),views:(e.views??[]).map(r=>({id:r.id,label:r.label,icon:r.icon}))}});function Na(n){if(!n)return[];const e=[];for(const t of n.resources??[])e.push(ut({...t,section:"resources"}));for(const t of n.simulationStats??[])e.push(ut({...t,section:"simulationStats"}));return n.similarityScore&&e.push(ut({id:"similarityScore",value:n.similarityScore.value})),e}function ut(n){return{id:n.id,label:n.label,section:n.section,value:n.value,unit:n.unit,description:n.description,live:n.live??!1,liveKey:n.live_key,fromVideo:n.from_video??!1,videoKey:n.video_key,scaleWithTime:n.scale_with_time??!1,integer:n.integer??!1,valueScale:n.value_scale,displayFormat:n.display_format,precision:n.precision}}function Aa(n,e){const s=Math.max(e-n,1e-9)/100,i=10**Math.floor(Math.log10(s)),a=s/i;let r=1;return a<=1?r=1:a<=2?r=2:a<=5?r=5:r=10,r*i}function Ta(n,e){return n+(e-n)/2}const xs="universe-engine-theme",$s=[{id:"glass",label:"Glass",icon:"[ ]"},{id:"matrix",label:"Matrix",icon:"[#]"},{id:"hal",label:"HAL 9000",icon:"( )"},{id:"nostromo",label:"Nostromo",icon:"[=]"},{id:"tron",label:"Tron",icon:"<>"}];function Ca(){const n=localStorage.getItem(xs);return Ma(n)?n:"glass"}function Xt(n){document.documentElement.setAttribute("data-theme",n),localStorage.setItem(xs,n)}function Oa(n,e,t){const s=document.createElement("div");s.className="theme-picker";const i=new Map;for(const r of $s){const o=document.createElement("button");o.className="theme-picker__option",o.type="button",o.innerHTML=`
      <span class="theme-picker__icon">${r.icon}</span>
      <span class="theme-picker__label">${r.label}</span>
    `,o.addEventListener("click",()=>{a(r.id),t(r.id)}),s.appendChild(o),i.set(r.id,o)}n.appendChild(s),a(e);function a(r){for(const[o,c]of i.entries()){const l=o===r;c.classList.toggle("active",l),c.setAttribute("aria-pressed",String(l))}}return{setActive:a}}function Ma(n){return $s.some(e=>e.id===n)}function Pa(n,e){const t=document.createElement("div");t.className="viewport";const s=document.createElement("video");s.className="viewport__media is-empty",s.src=e,s.loop=!1,s.muted=!0,s.playsInline=!0,s.preload="auto",s.setAttribute("aria-label","Simulation output"),t.appendChild(s),n.appendChild(t);let i,a,r;const o=new Map,c=new Map;let l=null,d=null;s.addEventListener("play",()=>r==null?void 0:r(!1)),s.addEventListener("pause",()=>r==null?void 0:r(!0)),s.addEventListener("ended",()=>r==null?void 0:r(!0)),s.addEventListener("timeupdate",()=>{R(),!(!i||!Number.isFinite(s.duration)||s.duration<=0)&&i(s.currentTime/s.duration)}),s.addEventListener("ended",()=>{a==null||a()});let u=s.playbackRate;function p(){l&&(URL.revokeObjectURL(l),l=null)}function g(N,C={}){const P=c.get(N);P&&(c.delete(N),C={...C,ownedObjectUrl:!0},N=P),s.classList.add("fade-out"),window.setTimeout(()=>{if(s.src.endsWith(N)){s.classList.remove("fade-out");return}const V=s.muted,F=C.seekFraction;p(),l=C.ownedObjectUrl?N:null,s.src=N,s.load(),s.onloadeddata=()=>{if(s.muted=V,F!==void 0&&Number.isFinite(s.duration)&&s.duration>0){const U=Math.max(0,Math.min(.999,F));s.currentTime=U*s.duration}else s.currentTime=0;s.playbackRate=u,s.classList.remove("fade-out"),C.autoplay&&s.play().catch(()=>{})}},120)}function b(N){s.muted=N}async function f(){await s.play()}function h(){s.pause()}function y(){s.classList.add("is-empty")}function k(){s.classList.remove("is-empty")}function S(N){if(!Number.isFinite(s.duration)||s.duration<=0)return;const C=Math.max(0,Math.min(1,N));s.currentTime=C*s.duration}function v(){s.currentTime=0,i==null||i(0)}function _(N=8e3){return s.readyState>=HTMLMediaElement.HAVE_CURRENT_DATA?Promise.resolve():new Promise(C=>{const P=()=>{F(),C()},V=window.setTimeout(()=>{F(),C()},Math.max(0,N));function F(){window.clearTimeout(V),s.removeEventListener("loadeddata",P)}s.addEventListener("loadeddata",P,{once:!0})})}function I(N,C=8e3){const P=Math.max(0,N);return P===0||L(P)?Promise.resolve():new Promise(V=>{const F=()=>{L(P)&&(j(),V())},U=window.setTimeout(()=>{j(),V()},Math.max(0,C));function j(){window.clearTimeout(U),s.removeEventListener("progress",F),s.removeEventListener("canplay",F),s.removeEventListener("loadeddata",F)}s.addEventListener("progress",F),s.addEventListener("canplay",F),s.addEventListener("loadeddata",F),F()})}function L(N){const C=s.currentTime;for(let P=0;P<s.buffered.length;P+=1){const V=s.buffered.start(P),F=s.buffered.end(P);if(!(C<V||C>F))return F-C>=N}return!1}function E(N){const C=new Set(N.filter(Boolean).filter(P=>P!==s.currentSrc));for(const[P,V]of o.entries())C.has(P)||(V.removeAttribute("src"),V.load(),o.delete(P));for(const P of C){if(o.has(P))continue;const V=document.createElement("video");V.preload="auto",V.muted=!0,V.playsInline=!0,V.src=P,V.load(),o.set(P,V)}for(const P of C){if(c.has(P))continue;const V=`${P}?_=${Date.now()}`;fetch(V).then(async F=>{if(!F.ok)return;const U=await F.blob();c.set(P,URL.createObjectURL(U))}).catch(()=>{})}}function T(){for(const N of o.values())N.removeAttribute("src"),N.load();o.clear();for(const N of c.values())URL.revokeObjectURL(N);c.clear()}function $(N){return c.get(N)??null}function R(){if(s.readyState<2||s.videoWidth===0||s.videoHeight===0)return;const N=document.createElement("canvas");N.width=s.videoWidth,N.height=s.videoHeight;const C=N.getContext("2d");C&&(C.drawImage(s,0,0,N.width,N.height),d=N.toDataURL("image/jpeg",.85))}function B(){return d||R(),d}function D(N){i=N}function G(N){a=N}return{setSource:g,setMuted:b,play:f,pause:h,hideMedia:y,showMedia:k,seekToFraction:S,resetPlayback:v,waitForLoadedData:_,waitForBufferedAhead:I,onTimeUpdate:D,onEnded:G,getDurationSeconds:()=>Number.isFinite(s.duration)?s.duration:0,getPlaybackFraction:()=>!Number.isFinite(s.duration)||s.duration<=0?0:s.currentTime/s.duration,isPaused:()=>s.paused,setPlaybackRate:N=>{u=N,s.playbackRate=N},getPlaybackRate:()=>u,onPlayStateChange:N=>{r=N},getElement:()=>t,prewarmSources:E,clearPrewarmedSources:T,getPrewarmedBlobUrl:$,captureFrame:B}}const xa=[.25,.5,1,2];function $a(n,e={}){const{onChange:t,onTogglePlay:s,onSpeedChange:i,onScrubStart:a,onScrubEnd:r,initialSpeed:o=1}=e,c=document.createElement("div");c.className="timeline";const l=document.createElement("div");l.className="timeline__bar-row";const d=document.createElement("button");d.className="timeline__play-btn",d.type="button",d.setAttribute("aria-label","Toggle playback"),d.addEventListener("click",()=>s==null?void 0:s());const u=document.createElement("input");u.className="timeline__slider",u.type="range",u.min="0",u.max="1000",u.step="1",u.value="0",u.style.setProperty("--fill","0%"),u.setAttribute("aria-label","Simulation time");const p=document.createElement("div");p.className="timeline__speed";const g=document.createElement("button");g.className="timeline__speed-btn",g.type="button",g.setAttribute("aria-label","Playback speed"),g.addEventListener("click",()=>{p.classList.toggle("open")});const b=document.createElement("div");b.className="timeline__speed-menu";for(const h of xa){const y=document.createElement("button");y.className="timeline__speed-option",y.type="button",y.textContent=Zt(h),y.addEventListener("click",()=>{p.classList.remove("open"),i==null||i(h)}),b.appendChild(y)}return p.appendChild(g),p.appendChild(b),l.appendChild(d),l.appendChild(u),l.appendChild(p),u.addEventListener("input",()=>{const h=parseInt(u.value,10)/1e3;u.style.setProperty("--fill",`${h*100}%`),t==null||t(h)}),u.addEventListener("pointerdown",()=>a==null?void 0:a()),u.addEventListener("pointerup",()=>r==null?void 0:r()),u.addEventListener("change",()=>r==null?void 0:r()),document.addEventListener("click",h=>{p.contains(h.target)||p.classList.remove("open")}),c.appendChild(l),n.appendChild(c),f(o),{setPosition(h){const y=Math.max(0,Math.min(1,h));u.value=String(Math.round(y*1e3)),u.style.setProperty("--fill",`${y*100}%`)},setPlaying(h){d.textContent=h?"⏸":"▶",d.classList.toggle("is-paused",!h),d.setAttribute("aria-label",h?"Pause":"Play")},setSpeed(h){f(h)}};function f(h){g.textContent=Zt(h);for(const y of b.children)y.classList.toggle("is-active",y.textContent===Zt(h))}}function Zt(n){return`x${n}`}function Ra(n,e){const t=Math.min(Fs(e),2);return n.toFixed(t)}function Te(n,e){return e?`${n} ${e}`:n}function Ct(n){const e=Math.abs(n),t=n<0?"−":"";return Number.isFinite(n)?e<1e3?st(n):e<1e6?`${t}${st(n/1e3)}K`:e<1e9?`${t}${st(n/1e6)}M`:e<1e12?`${t}${st(n/1e9)}B`:`${t}${st(n/1e12)}T`:String(n)}function st(n){return n.toFixed(1).replace(new RegExp("\\.0+$|(?<=\\..*?)0+$","g"),"").replace(/\.$/,"")}function Fa(n,e={}){const t=n.trim();if(t.length===0)return n;const s=Number(t);if(!Number.isFinite(s))return n;const i=s*(e.scale??1);return e.integer?Math.max(0,Math.round(i)).toLocaleString(void 0):i.toFixed(2).replace(new RegExp("\\.0+$|(?<=\\..*?)0+$","g"),"").replace(/\.$/,"")}function Rs(n,e={}){const t=n.trim();if(t.length===0)return n;const s=Number(t);if(!Number.isFinite(s))return n;const i=e.mode??"float",a=s*(e.scale??1);if(i==="integer")return Math.round(a).toLocaleString(void 0);if(i==="scientific"){const o=Math.max(1,e.precision??3);return a.toExponential(o-1).replace("e+","e").replace(/\.0+e/,"e")}const r=Math.max(0,e.precision??2);return a.toFixed(r).replace(new RegExp("\\.0+$|(?<=\\..*?)0+$","g"),"").replace(/\.$/,"")}function ot(n,e,t={}){const s=t.scale??1,i=n*s,a=e*s;if(t.format==="scientific"){const r=Math.max(1,t.significantFigures??3);return i.toExponential(r-1).replace("e+","e").replace(/\.0+e/,"e")}return Ra(i,a)}function Fs(n){const e=String(n),t=e.indexOf(".");return t===-1?0:e.length-t-1}function Ba(n){const e=document.createElement("aside");e.className="data-panel";const t=document.createElement("div");return t.className="data-panel__metrics",e.appendChild(t),n.appendChild(e),{update(s,i,a={}){t.innerHTML="";const r=Va(s,i,a);for(const o of s.metadata.liveStats){const c=Ua(o,r),l=document.createElement("div");l.className="data-panel__metric",l.innerHTML=`
...
`,Bs=(()=>{const n=Le(Qa),e={};for(const t of Object.values(n))for(const[s,i]of Object.entries(t))e[s]=i;return e})(),Ot="#4CD98A",dn="#E8951C",Vs="#D7372A",Ds=.2,Us=.5,Wn=2;function fn(n){const e=Math.abs(n-1);return e<=Ds?{word:"On target",colour:Ot}:e<=Us?{word:n>1?"Too high":"Too low",colour:dn}:{word:n>1?"Way too high":"Way too low",colour:Vs}}function Hs(n){const e=Math.abs(n-1),t=n>=1;return e<=Ds?t?"greenHigh":"greenLow":e<=Us?t?"amberHigh":"amberLow":t?"redHigh":"redLow"}function Xa(n){return Math.min(Math.max(n,0),Wn)/Wn*100}function Za(n){return n>=85?{word:"Almost perfect",colour:Ot}:n>=65?{word:"Really close",colour:Ot}:n>=45?{word:"Getting there",colour:dn}:n>=25?{word:"Not quite",colour:dn}:{word:"Way off - try again",colour:Vs}}function er(n,e){var s;const t=Hs(e);return((s=Bs[n])==null?void 0:s[t])??""}function tr(n,e,t){var r;const s=Hs(t),i=(r=Bs[n])==null?void 0:r[s];return i||(fn(t).colour===Ot?`${e} is very close to the target value for this simulation.`:t<1?`${e} is below the target value for this simulation.`:`${e} is above the target value for this simulation.`)}function nr(n,e,t){return Object.entries(n.metadata.correctValues).map(([s,i])=>{const a=sr(s,n,e,t);if(a===null)return null;const r=a/Math.max(i,1e-9),o=ir(s,n,t),c=ar(s,n),l=er(o,r)||tr(s,o,r);return{id:s,label:o,value:r,rawValue:a,unit:c,detail:l}}).filter(s=>s!==null)}function sr(n,e,t,s){var c,l;const i=e.parameters.find(d=>d.id===n);if(i)return t[n]??i.fallbackValue;const a=s==null?void 0:s.parameterValues[n];if(typeof a=="number"&&Number.isFinite(a))return a;const r=Gn((c=s==null?void 0:s.summaryMetrics[n])==null?void 0:c.value);return r!==null?r:Gn((l=e.metadata.summaryStats.find(d=>d.id===n))==null?void 0:l.value)}function ir(n,e,t){var s,i,a;return((s=e.parameters.find(r=>r.id===n))==null?void 0:s.label)??((i=e.metadata.summaryStats.find(r=>r.id===n))==null?void 0:i.label)??((a=t==null?void 0:t.summaryMetrics[n])==null?void 0:a.label)??n}function ar(n,e){var t,s;return((t=e.parameters.find(i=>i.id===n))==null?void 0:t.unit)??((s=e.metadata.summaryStats.find(i=>i.id===n))==null?void 0:s.unit)}function Gn(n){if(n===void 0)return null;const e=Number(n);return Number.isFinite(e)?e:null}function rr(n){if(n.length===0)return 0;const e=n.reduce((t,s)=>t+Math.max(0,1-Math.abs(s.value-1)),0);return Math.round(e/n.length*100)}function or(n,e){const t=document.createElement("section");t.className="overlay overlay--summary",t.hidden=!0,t.classList.add("is-hidden");let s;const i=document.createElement("div");i.className="summary-overlay";const a=document.createElement("div");a.className="summary-overlay__content";const r=document.createElement("div");r.className="summary-overlay__actions";const o=document.createElement("button");o.className="summary-overlay__button summary-overlay__button--primary",o.type="button",o.textContent="Continue Exploring";const c=document.createElement("button"),l=document.createElement("button");c.className="summary-overlay__button",c.type="button",c.textContent="New Parameters",l.className="summary-overlay__button",l.type="button",l.textContent="Home",l.hidden=!e.showHome,o.addEventListener("click",e.onReplay),c.addEventListener("click",e.onParameters),l.addEventListener("click",e.onHome),r.appendChild(o),r.appendChild(c),r.appendChild(l),i.appendChild(a),i.appendChild(r),t.appendChild(i);const d=document.createElement("div");d.className="sci-modal is-hidden",d.innerHTML=`
  ...
  `,t.appendChild(d),n.appendChild(t);const u=d.querySelector(".sci-modal__title"),p=d.querySelector(".sci-modal__verdict"),g=d.querySelector(".sci-modal__body"),b=d.querySelector(".sci-modal__close");function f(v){const _=fn(v.value);u.textContent=v.label,p.textContent=_.word,p.style.color=_.colour,p.hidden=!1,g.textContent=v.detail,d.classList.remove("is-hidden")}function h(v,_){u.textContent=v,p.hidden=!0,g.textContent=_,d.classList.remove("is-hidden")}function y(){d.classList.add("is-hidden")}b.addEventListener("click",y),d.addEventListener("click",v=>{v.target===d&&y()});function k(v,_){const I=document.createElement("div");I.className=`${v.className} panel`,I.innerHTML=`<p class="sci-section__title">${v.title}</p>`;const L=document.createElement("div"),E=v.singleRow?Math.max(1,v.stats.length):Math.max(1,Math.min(v.stats.length,v.maxColumns));L.className="metric-grid",v.singleRow&&L.classList.add("metric-grid--single-row"),L.style.setProperty("--summary-grid-columns",String(E)),L.style.setProperty("--summary-grid-max-width",`${v.maxWidthRem}rem`);for(const T of v.stats){const $=lr(T,_),R=document.createElement("div"),B=document.createElement("span"),D=document.createElement("span");R.className="res-card",B.className="res-card__label",B.textContent=$.label,D.className="res-card__value",D.textContent=$.value,R.appendChild(B),R.appendChild(D),T.description&&(R.classList.add("res-card--has-info"),R.addEventListener("click",()=>{h($.label,T.description)})),L.appendChild(R)}return I.appendChild(L),I}function S(v){const _=document.createElement("div");_.className="res-section panel",_.innerHTML='<p class="sci-section__title">Simulation Stats</p>';const I=document.createElement("div");I.className="metric-grid",I.style.setProperty("--summary-grid-columns",String(Math.max(1,v.length))),I.style.setProperty("--summary-grid-max-width","48rem");for(const L of v){const E=document.createElement("div"),T=document.createElement("span"),$=document.createElement("span");E.className="res-card res-card--has-info",T.className="res-card__label",T.textContent=L.label,$.className="res-card__value",$.textContent=Number.isFinite(L.rawValue)?Te(Number(L.rawValue.toPrecision(4)).toString(),L.unit):"--",E.appendChild(T),E.appendChild($),E.addEventListener("click",()=>h(L.label,L.detail)),I.appendChild(E)}return _.appendChild(I),_}return{show(){s&&(window.clearTimeout(s),s=void 0),t.hidden=!1,t.classList.remove("is-hidden"),t.classList.remove("is-visible"),t.offsetWidth,requestAnimationFrame(()=>{t.classList.add("is-visible")})},hide(){t.classList.remove("is-visible"),s=window.setTimeout(()=>{t.hidden=!0,t.classList.add("is-hidden"),s=void 0},Ya.HIDE_AFTER_MS)},setHomeVisible(v){l.hidden=!v},update(v,_,I,L,E){var U;a.innerHTML="",y();const T=Ka(v,_,I,L),$=v.metadata.summaryStats,R=nr(v,_,L);let B;if(R.length>0)B=rr(R);else{const j=((U=T.similarityScore)==null?void 0:U.value)??"0/100";B=parseInt(j,10)||0}const D=Za(B),G=document.createElement("div"),N=document.createElement("div"),C=document.createElement("div");G.className="sci-top",N.className="summary-main-column",C.className="summary-side-column";const P=document.createElement("div");P.className="sci-hero panel",E?(P.classList.add("sci-hero--thumbnail"),P.innerHTML=`<img class="sci-hero__thumbnail" src="${E}" alt="Final frame of simulation" />`):P.innerHTML=`
...
`;function hr(){const n=Le(fr);if(!Array.isArray(n))return[];const e=[];for(const t of n){if(!t||typeof t!="object")continue;const s=t.text;if(typeof s!="string"||s.trim().length===0)continue;const i={text:s},a=t.url;typeof a=="string"&&a.trim().length>0&&(i.url=a);const r=t.logo;typeof r=="string"&&r.trim().length>0&&(i.logo=r),t.header===!0&&(i.header=!0),e.push(i)}return e}function mr(n,e,t,s){const i=document.createElement("div");i.className="parameter-editor",n.appendChild(i);let a=e,r={...t};function o(d,u){a=d,r=u?{...u}:pr(d),i.innerHTML="";const p=document.createElement("div");p.className="parameter-editor__heading",p.innerHTML=`
      <p class="parameter-editor__eyebrow">Parameter matrix</p>
      <h2 class="parameter-editor__title">${d.label} Controls</h2>
    `,i.appendChild(p);const g=document.createElement("div");g.className="parameter-editor__list";for(const b of d.parameters)g.appendChild(c(b));i.appendChild(g),l()}function c(d){const u=document.createElement("section");u.className="param";const p=document.createElement("div");p.className="param__label";const g=d.displayUnit??d.unit,b=document.createElement("div");b.innerHTML=`
      <span class="param__name">${d.label}</span>
      <span class="param__range">${Te(ot(d.min,d.step,{scale:d.valueScale,format:d.displayFormat,significantFigures:d.displaySignificantFigures}),g)} - ${Te(ot(d.max,d.step,{scale:d.valueScale,format:d.displayFormat,significantFigures:d.displaySignificantFigures}),g)}</span>
    `;const f=document.createElement("div");f.className="param__readout";const h=document.createElement("div");h.className="param__controls";const y=document.createElement("input");y.className="param__slider",y.type="range",y.min=String(d.min),y.max=String(d.max),y.step=String(d.step),y.value=String(r[d.id]??d.fallbackValue),y.setAttribute("aria-label",d.label);function k(S){r[d.id]=S,y.value=String(S),y.style.setProperty("--fill",`${Yn(S,d.min,d.max)}%`),f.textContent=Te(ot(S,d.step,{scale:d.valueScale,format:d.displayFormat,significantFigures:d.displaySignificantFigures}),g),l()}if(y.addEventListener("input",()=>{k(parseFloat(y.value))}),y.style.setProperty("--fill",`${Yn(r[d.id]??d.fallbackValue,d.min,d.max)}%`),f.textContent=Te(ot(r[d.id]??d.fallbackValue,d.step,{scale:d.valueScale,format:d.displayFormat,significantFigures:d.displaySignificantFigures}),g),p.appendChild(b),p.appendChild(f),d.description){b.classList.add("param__name--has-info"),b.setAttribute("title",d.description);const S=document.createElement("div");S.className="param__popover",S.textContent=d.description,u.appendChild(S),b.addEventListener("click",()=>{u.classList.toggle("param--info-open")}),document.addEventListener("click",v=>{u.contains(v.target)||u.classList.remove("param--info-open")})}return h.appendChild(y),u.appendChild(p),u.appendChild(h),u}function l(){s({...r})}return o(e,t),{setSimClass(d,u){o(d,u)},setValues(d){o(a,d)},getValues(){return{...r}}}}function pr(n){return Object.fromEntries(n.parameters.map(e=>[e.id,e.fallbackValue]))}function Yn(n,e,t){return t===e?0:(n-e)/(t-e)*100}const js="universe-engine-advanced-settings",gr="RSSSE26UM_Engine";function hn(){return{lockedScaleId:null,manifestSource:"online",verboseLogging:!1,hiddenScaleIds:[]}}function Ks(n){const e=localStorage.getItem(js);if(!e)return hn();try{const t=JSON.parse(e);return qs(t,n)}catch{return hn()}}function yr(n,e){const t=qs(n,e);return localStorage.setItem(js,JSON.stringify({lockedScaleId:t.lockedScaleId,verboseLogging:t.verboseLogging,hiddenScaleIds:t.hiddenScaleIds})),t}function qs(n,e){const t=hn(),s=new Set(e),i=n.manifestSource==="online"||n.manifestSource==="local"?n.manifestSource:t.manifestSource,a=typeof n.lockedScaleId=="string"&&s.has(n.lockedScaleId)?n.lockedScaleId:null,r=Array.isArray(n.hiddenScaleIds)?n.hiddenScaleIds.filter((o,c,l)=>typeof o=="string"&&s.has(o)&&l.indexOf(o)===c&&o!==a):t.hiddenScaleIds;return!a&&r.length>=e.length&&e.length>0&&r.pop(),{lockedScaleId:a,manifestSource:i,verboseLogging:!!n.verboseLogging,hiddenScaleIds:r}}function br(n,e){if(n.lockedScaleId)return[n.lockedScaleId];const t=new Set(n.hiddenScaleIds),s=e.filter(i=>!t.has(i));return s.length>0?s:e.slice(0,1)}function wr(n,e){const t=document.createElement("section");t.className="overlay overlay--config",t.hidden=!0,t.classList.add("is-hidden");const s=document.createElement("div");s.className="config-overlay";const i=document.createElement("div");i.className="config-overlay__shell";const a=document.createElement("div");a.className="config-overlay__media";const r=document.createElement("img");r.className="config-overlay__media-image",r.src=e.simClass.placeholderImage,r.alt=`${e.simClass.label} preview`,a.innerHTML=`
 ...
 Engine</h1>
  ...
  `;const d=document.createElement("button");d.className="config-overlay__close",d.type="button",d.setAttribute("aria-label","Close overlay"),d.textContent="×";const u=document.createElement("div");u.className="config-overlay__section-indicator",u.textContent="Parameters",c.appendChild(u),c.appendChild(l),c.appendChild(d);const p=document.createElement("section");p.className="config-overlay__section config-overlay__section--grow",p.dataset.section="parameters";const g=document.createElement("div");p.appendChild(g);const b=document.createElement("section");b.className="config-overlay__section config-overlay__section--grow",b.dataset.section="settings",b.innerHTML=`
  ...
  `;const E=document.createElement("select");E.className="advanced-settings__select",E.appendChild(new Option("None",""));for(const A of e.availableScales)E.appendChild(new Option(A.label,A.id));L.appendChild(E),I.appendChild(L);const T=document.createElement("div");T.className="advanced-settings__field",T.innerHTML=`
  ...
  `,N.appendChild(C),N.appendChild(P),I.appendChild(N);const V=document.createElement("div");V.className="advanced-settings__field",V.innerHTML=`
  ...
  `;const F=document.createElement("div");F.className="advanced-settings__options";const U=new Map;for(const A of e.availableScales){const q=document.createElement("label"),ne=document.createElement("input");q.className="advanced-settings__choice",ne.type="checkbox",ne.value=A.id,U.set(A.id,ne),q.appendChild(ne),q.append(`Show ${A.label}`),F.appendChild(q)}V.appendChild(F),I.appendChild(V),h.appendChild(I),b.appendChild(h);const j=document.createElement("section");j.className="config-overlay__section config-overlay__section--grow",j.dataset.section="credits",j.innerHTML=`
    <div class="credits-list" data-credits></div>
  `;const K=j.querySelector("[data-credits]"),be=hr();if(K.innerHTML="",be.length===0){const A=document.createElement("div");A.className="credits-list__entry",A.textContent="To be credited...",K.appendChild(A)}else for(const A of be)if(A.header){const q=document.createElement("div");q.className="credits-list__heading",q.textContent=A.text,K.appendChild(q)}else{const q=document.createElement("div");q.className="credits-list__entry";const ne=document.createElement("span");if(ne.className="credits-list__text",A.url){const se=document.createElement("a");se.className="credits-list__link",se.href=A.url,se.target="_blank",se.rel="noopener noreferrer",se.textContent=A.text,ne.appendChild(se)}else ne.textContent=A.text;q.appendChild(ne),K.appendChild(q)}const ee=document.createElement("div");ee.className="config-overlay__footer";const te=document.createElement("button");te.className="run-button",te.type="button",te.textContent="Run",ee.appendChild(te),o.appendChild(c),o.appendChild(p),o.appendChild(b),o.appendChild(j),o.appendChild(ee),i.appendChild(a),i.appendChild(o),s.appendChild(i),t.appendChild(s),n.appendChild(t);let M=it(e.advancedSettings),we="closed";const oe=mr(g,e.simClass,e.values,e.onValuesChange),he=Oa(f,e.theme,e.onThemeChange);d.addEventListener("click",e.onClose),y.addEventListener("click",()=>{if(we==="open"){me("closed");return}me("auth"),S.focus()}),v.addEventListener("click",Se),S.addEventListener("keydown",A=>{A.key==="Enter"&&Se()}),E.addEventListener("change",()=>{M.lockedScaleId=E.value||null,X()}),B.addEventListener("change",()=>{B.checked&&(M.manifestSource="local")}),G.addEventListener("change",()=>{G.checked&&(M.manifestSource="online")}),C.addEventListener("change",()=>{M.verboseLogging=C.checked});for(const[A,q]of U.entries())q.addEventListener("change",()=>{if(Array.from(U.entries()).filter(([,se])=>se.checked).map(([se])=>se).length===0&&!M.lockedScaleId){q.checked=!0;return}M.hiddenScaleIds=Array.from(U.keys()).filter(se=>{var Be;return!((Be=U.get(se))!=null&&Be.checked)&&se!==M.lockedScaleId}),X()}),A===M.lockedScaleId&&(q.disabled=!0);le(e.initialView??"parameters"),X();function le(A){o.dataset.view=A,u.textContent=A==="parameters"?"Parameters":A==="settings"?"Settings":"Credits",A==="settings"?te.textContent="Apply":A==="credits"?te.textContent="Close":te.textContent="Run"}function X(){E.value=M.lockedScaleId??"",B.checked=M.manifestSource==="local",G.checked=M.manifestSource==="online",C.checked=M.verboseLogging;for(const[A,q]of U.entries()){const ne=M.lockedScaleId===A;q.checked=ne||!M.hiddenScaleIds.includes(A),q.disabled=ne}}function Se(){if(S.value!==gr){_.textContent="Incorrect password";return}S.value="",_.textContent="",me("open")}function me(A){we=A,h.dataset.state=A,y.textContent=A==="open"?"Hide Advanced Settings":"Advanced Settings",A!=="auth"&&(_.textContent="")}function Ie(){S.value="",_.textContent="",me("closed")}function Ht(){M=it(e.advancedSettings),X()}return te.addEventListener("click",()=>{const A=o.dataset.view;if(A==="settings"){e.onApplySettings(it(M));return}if(A==="credits"){e.onClose();return}e.onRun()}),{show(){t.hidden=!1,t.classList.remove("is-hidden")},hide(){t.hidden=!0,t.classList.add("is-hidden"),Ht(),Ie()},setSimulation(A,q){oe.setSimClass(A,q),r.src=A.placeholderImage,r.alt=`${A.label} preview`},setTheme(A){he.setActive(A)},setView(A){le(A),A!=="settings"&&Ie()},setAdvancedSettings(A){e.advancedSettings=it(A),M=it(A),X(),Ie()}}}function it(n){return{lockedScaleId:n.lockedScaleId,manifestSource:n.manifestSource,verboseLogging:n.verboseLogging,hiddenScaleIds:[...n.hiddenScaleIds]}}function vr(n){const{TYPING_MS_PER_CHAR:e,FINAL_PAUSE_MS:t}=Ga,s=document.createElement("section");s.className="overlay overlay--initializing",s.hidden=!0,s.classList.add("is-hidden");const i=document.createElement("div");i.className="terminal";const a=document.createElement("div");a.className="terminal__header",a.innerHTML=`
    <div class="terminal__header-left">
      <span class="terminal__dot"></span>
      <span class="terminal__header-label">UNIVERSE_ENGINE_v9.5.1</span>
    </div>
  `;const r=document.createElement("div");r.className="terminal__log";const o=document.createElement("button");o.className="terminal__fast-forward",o.type="button",o.textContent=">>",o.setAttribute("aria-label","Fast forward terminal output"),o.setAttribute("aria-pressed","false"),i.appendChild(a),i.appendChild(r),i.appendChild(o),s.appendChild(i),n.appendChild(s);let c=[],l=0,d=!1;function u(h){d=h,o.classList.toggle("is-active",d),o.setAttribute("aria-pressed",String(d))}o.addEventListener("pointerdown",()=>{u(!0)}),o.addEventListener("pointerup",()=>{u(!1)}),o.addEventListener("pointerleave",()=>{u(!1)}),o.addEventListener("pointercancel",()=>{u(!1)}),o.addEventListener("blur",()=>{u(!1)}),o.addEventListener("keydown",h=>{(h.key===" "||h.key==="Enter")&&u(!0)}),o.addEventListener("keyup",h=>{(h.key===" "||h.key==="Enter")&&u(!1)});function p(){for(const h of c)window.clearTimeout(h);c=[]}function g(h,y){return new Promise(k=>{const S=window.setTimeout(()=>{y===l&&k()},d?0:Math.max(0,h));c.push(S)})}async function b(h,y){const k=document.createElement("div");k.className="terminal__line";const S=f();k.appendChild(S),r.appendChild(k);const v=d?2:1;for(let _=0;_<h.length;_+=v){if(y!==l)return;const I=h.slice(_,_+v);k.insertBefore(document.createTextNode(I),S),r.scrollTop=r.scrollHeight,await g(e,y)}S.remove()}function f(){const h=document.createElement("span");return h.className="terminal__cursor",h.textContent="█",h}return{async show(h,y,k){p(),l+=1;const S=l;u(!1),r.innerHTML="",s.hidden=!1,s.classList.remove("is-hidden");for(const[v,_]of h.entries()){if(S!==l)return;const I=`${kt(v)} ${_.text}`;await b(I,S)}if(k){const v=document.createElement("div");v.className="terminal__line terminal__line--syncing",v.textContent=`${kt(h.length)} STARTING SIMULATION`,r.appendChild(v);let _=0;const I=window.setInterval(()=>{_=(_+1)%4;const L=".".repeat(_);v.textContent=`${kt(h.length)} STARTING SIMULATION${L}`,r.scrollTop=r.scrollHeight},400);c.push(I);try{await k}catch{}window.clearInterval(I),v.textContent=`${kt(h.length)} STARTING SIMULATION...`,r.scrollTop=r.scrollHeight}S===l&&(await g(t,S),y())},hide(){p(),l+=1,u(!1),s.hidden=!0,s.classList.add("is-hidden"),r.innerHTML=""}}}function kt(n){const e=Math.max(0,Math.floor(n)),t=Math.floor(e/3600),s=Math.floor(e%3600/60),i=e%60;return`[${tn(t)}:${tn(s)}:${tn(i)}]`}function tn(n){return String(n).padStart(2,"0")}function Sr(n,e){const t=document.createElement("button");t.className="display-button",t.type="button",t.innerHTML="<span></span><span></span><span></span>",t.setAttribute("aria-label","Open configuration overlay"),n.appendChild(t);const s=document.createElement("div");s.className="display-menu";const i=document.createElement("div");i.className="display-menu__header",i.textContent="Menu",s.appendChild(i);const a=c("Home",()=>{l(),e.onHome()});s.appendChild(a),s.appendChild(c("Settings",()=>{l(),e.onViewSelected("settings")})),s.appendChild(c("Credits",()=>{l(),e.onViewSelected("credits")}));const r=c("Fullscreen",()=>{var u;l(),document.fullscreenElement?document.exitFullscreen():(u=document.getElementById("app"))==null||u.requestFullscreen()});s.appendChild(r),n.appendChild(s);function o(){const u=r.querySelector(".display-menu__item-label");u&&(u.textContent=document.fullscreenElement?"Exit Fullscreen":"Fullscreen");const p=document.getElementById("app");p&&p.classList.toggle("is-fullscreen",!!document.fullscreenElement)}return document.addEventListener("fullscreenchange",o),t.addEventListener("click",()=>{n.classList.toggle("open")}),document.addEventListener("click",u=>{n.contains(u.target)||l()}),d(e.showHome??!0),{close:l,setHomeVisible:d};function c(u,p){const g=document.createElement("button");return g.className="display-menu__item",g.type="button",g.innerHTML=`
      <span class="display-menu__item-mark"></span>
      <span class="display-menu__item-label">${u}</span>
    `,g.addEventListener("click",p),g}function l(){n.classList.remove("open")}function d(u){a.hidden=!u,a.classList.toggle("is-hidden",!u)}}const _r=`# Initialization terminal script for the Planetary simulation family.
#
# Schema:
...
`,Lr={planetary:_r,galaxy:kr,cosmos:Er};function Ir(n){return Le(Lr[n.id]).flatMap((t,s)=>{var a;if(!((a=t.options)!=null&&a.length))throw new Error(`Initialization YAML entry ${s} for ${n.id} has no options.`);const i=Nr(2,Math.min(4,t.options.length));return Ar(t.options,i).map(r=>({text:r.text}))})}function Nr(n,e){return Math.floor(Math.random()*(e-n+1))+n}function Ar(n,e){const t=[...n];for(let s=t.length-1;s>0;s-=1){const i=Math.floor(Math.random()*(s+1));[t[s],t[i]]=[t[i],t[s]]}return t.slice(0,e)}function Tr(n){return n.replace(/\.mp4($|\?)/,".yaml$1")}async function Cr(n){try{const e=await fetch(n);if(!e.ok)return null;const t=await e.text(),s=Le(t),i=Ke(s.wallclockSeconds),a=Ke(s.computeUsed),r=Ke(s.memoryUsed),o=Ke(s.carbonBurnt),c=Ke(s.particlesUpdated),l=await Or(n),d=Pr(s.summaryMetrics);return i===null||a===null||r===null||o===null||c===null?null:{wallclockSeconds:i,computeUsed:a,memoryUsed:r,carbonBurnt:o,particlesUpdated:c,parameterValues:l,summaryMetrics:d}}catch{return null}}async function Or(n){try{const e=await fetch(Mr(n));if(!e.ok)return{};const t=await e.text(),s=Le(t);return xr(s)}catch{return{}}}function Mr(n){return n.replace(/run_summary\.yaml($|\?)/,"parameters.yaml$1")}function Ke(n){const e=typeof n=="number"?n:Number(n);return Number.isFinite(e)?e:null}function Pr(n){if(!n||typeof n!="object")return{};const e=n,t={};for(const[s,i]of Object.entries(e)){if(!i||typeof i!="object")continue;const a=i,r=typeof a.label=="string"?a.label:s,o=a.value;o!=null&&(t[s]={label:r,value:String(o)})}return t}function xr(n){if(!n||typeof n!="object")return{};const e={};for(const[t,s]of Object.entries(n)){const i=Ke(s);i!==null&&(e[t]=i)}return e}const Ws="[UniverseEngine]",$r=["planetary","galaxy","cosmos"];function Gs(){return Ks($r).verboseLogging}function Z(n,e){Gs()&&console.info(Ws,n,e??"")}function ke(n,e){Gs()&&console.warn(Ws,n,e??"")}const Rr={local:"assets/local-manifest.json",online:Ja};function Fr(n="local"){let e=n;const t=new Map;return{getSource(){return e},setSource(s){s==="online"&&t.delete("online"),e=s,Z("Manifest source updated",{source:s})},resetCache(){t.clear()},async preloadActiveManifest(){await Js(e,t)},async findNearestVideo(s,i,a){const r=await Vr(e,t,s,i,a);if(r)return r;const o=Ys(s);return ke("Falling back to placeholder assets",{simClassId:s,source:e,fallbackUrl:o}),{url:o,liveDataUrl:Br(s),summaryUrl:Tr(o)}}}}function Ys(n){switch(n){case"planetary":return Q("assets/planet_test.mp4");case"galaxy":return Q("assets/galaxy_test.mp4");case"cosmos":return Q("assets/cosmo_test.mp4");default:return Q("assets/galaxy_test.mp4")}}function Br(n){switch(n){case"planetary":return Q("assets/planet_test_planetary_stats.csv");case"galaxy":return Q("assets/galaxy_test_galaxy_stats.csv");case"cosmos":return Q("assets/cosmo_test_cosmos_stats.csv");default:return Q("assets/galaxy_test_galaxy_stats.csv")}}async function Js(n,e){const t=e.get(n);if(t)return t;const s=Rr[n],i=fetch(Q(s)).then(async a=>{if(!a.ok)throw new Error(`Failed to load manifest: ${s}`);return Z("Loaded manifest",{source:n,manifestPath:s}),await a.json()}).catch(a=>(ke("Manifest unavailable",{source:n,manifestPath:s,error:a instanceof Error?a.message:String(a)}),{version:1,runs:[]}));return e.set(n,i),i}async function Vr(n,e,t,s,i){const r=(await Js(n,e)).runs.filter(u=>u.simulationId===t);if(r.length===0)return ke("No manifest runs found for simulation",{simClassId:t,source:n}),null;let o=r[0],c=Jn(o,s,i);for(const u of r.slice(1)){const p=Jn(u,s,i);p<c&&(o=u,c=p)}const l=o.defaultView??Object.keys(o.views)[0],d=o.views[l];return d?(Z("Selected manifest-backed run",{simClassId:t,source:n,runId:o.runId,selectedValues:i,distance:c,viewId:l}),{url:Q(d),liveDataUrl:Q(o.liveDataPath),summaryUrl:Q(o.summaryPath),viewId:l,runId:o.runId,views:Object.fromEntries(Object.entries(o.views).map(([u,p])=>[u,Q(p)]))}):null}function Jn(n,e,t){return e.length===0?0:e.reduce((i,a)=>{var l;const r=t[a.id]??a.fallbackValue,o=((l=n.parameters)==null?void 0:l[a.id])??a.fallbackValue,c=Math.max(a.max-a.min,1e-9);return i+Math.abs(r-o)/c},0)/e.length}const Nt={mode:"time",frames:[]};async function Dr(n){const e=await fetch(n);if(!e.ok)throw new Error(`Failed to load live stats CSV: ${n}`);const t=await e.text();return Hr(t)}function Ur(n,e,t=0){if(n.mode==="row")return jr(n.frames,e,t);const s=n.frames;if(s.length===0)return{};if(e<=s[0].t)return{...s[0].values};const i=s[s.length-1];if(e>=i.t)return{...i.values};for(let a=0;a<s.length-1;a+=1){const r=s[a],o=s[a+1];if(e<r.t||e>o.t)continue;const c=(e-r.t)/Math.max(o.t-r.t,1e-9);return Kr(r.values,o.values,c)}return{...i.values}}function Hr(n){const e=n.split(/\r?\n/).map(s=>s.trim()).filter(Boolean);if(e.length<2)return Nt;const t=nn(e[0]);return t[0]==="t"?{mode:"time",frames:e.slice(1).map(s=>{const i=nn(s),a={};for(let r=1;r<t.length;r+=1)a[t[r]]=i[r]??"";return{t:parseFloat(i[0]??"0")||0,values:a}})}:{mode:"row",frames:e.slice(1).map((s,i)=>{const a=nn(s),r={};for(let o=0;o<t.length;o+=1)r[t[o]]=a[o]??"";return{t:i,values:r}})}}function jr(n,e,t){if(n.length===0)return{};if(!Number.isFinite(t)||t<=0)return{...n[0].values};const s=Math.max(0,Math.min(1,e/t)),i=Math.round(s*(n.length-1));return{...n[i].values}}function nn(n){const e=[];let t="",s=!1;for(let i=0;i<n.length;i+=1){const a=n[i];if(a==='"'){s=!s;continue}if(a===","&&!s){e.push(t),t="";continue}t+=a}return e.push(t),e}function Kr(n,e,t){const s=new Set([...Object.keys(n),...Object.keys(e)]),i={};for(const a of s){const r=n[a]??"",o=e[a]??r,c=parseFloat(r),l=parseFloat(o);if(Number.isFinite(c)&&Number.isFinite(l)){const d=c+(l-c)*t;i[a]=qr(d);continue}i[a]=t<.5?r:o}return i}function qr(n){return n.toFixed(2).replace(new RegExp("\\.0+$|(?<=\\..*?)0+$","g"),"").replace(/\.$/,"")}function Wr(n){Gr(za,n)}function Gr(n,e){if(navigator.sendBeacon){const t=new Blob([JSON.stringify(e)],{type:"application/json"});if(navigator.sendBeacon(n,t)){Z("Run selection tracking dispatched",{simulationId:e.simulationId});return}}fetch(n,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),keepalive:!0}).then(t=>{t.ok?Z("Run selection tracked",{simulationId:e.simulationId}):ke("Run selection tracking rejected",{simulationId:e.simulationId,status:t.status})}).catch(t=>{ke("Run selection tracking failed",{simulationId:e.simulationId,error:t instanceof Error?t.message:String(t)})})}const zn=50*1024*1024,Yr=8,Jr=6e3,zr=8e3,sn={galaxy:"tron",planetary:"matrix",cosmos:"nostromo"};function Qr(n){const e=He.map(m=>m.id);let t=Ks(e),s=On(t);const i=Fr(t.manifestSource);t.manifestSource==="online"&&i.preloadActiveManifest();let a=Mn(t.lockedScaleId)??s[0]??He[0],r=t.lockedScaleId?sn[a.id]:Ca(),o=!1,c=null,l=null,d=0,u=Nt,p=!1;const g=Object.fromEntries(He.map(m=>[m.id,si(m)]));Xt(r);const b=Ys(a.id),f=Pa(n,b),h=document.createElement("div");h.className="display-chrome",h.classList.add("is-hidden"),n.appendChild(h);const y=document.createElement("div");y.className="orientation-overlay",y.innerHTML=`
  ...
  `,n.appendChild(y);const k=document.createElement("div");k.className="swift-logo",k.innerHTML=`
    <img
      ...
      decoding="async"
    />
  `,n.appendChild(k);const S=document.createElement("div");S.className="display-chrome__top-left is-hidden",n.appendChild(S);const v=Sr(S,{onHome(){Be()},onViewSelected(m){if(m==="credits"){q("credits");return}q(m)},showHome:!t.lockedScaleId}),_=document.createElement("div");_.className="display-chrome__left-center",h.appendChild(_);const I=ur(_,{onSelect(m){Cn(m)}}),L=document.createElement("div");L.className="display-chrome__top-right",h.appendChild(L);const E=Ba(L),T=document.createElement("div");T.className="display-chrome__center-status",T.innerHTML=`
  ...
  `,h.appendChild(T);const $="universe-engine-playback-speed",R=()=>{const m=localStorage.getItem($),w=m?Number(m):NaN;return[.25,.5,1,2].includes(w)?w:1},B=m=>{localStorage.setItem($,String(m))},D=R();f.setPlaybackRate(D);const G=document.createElement("div");G.className="display-chrome__bottom",h.appendChild(G);const N=$a(G,{onChange(m){f.seekToFraction(m)},onTogglePlay:Tn,onSpeedChange:Qs,onScrubStart(){V()},onScrubEnd(){f.isPaused()||P()},initialSpeed:D});N.setPlaying(!f.isPaused());let C=null;function P(){if(C!==null)return;function m(){const w=f.getPlaybackFraction();N.setPosition(w),f.isPaused()?C=null:C=requestAnimationFrame(m)}C=requestAnimationFrame(m)}function V(){C!==null&&(cancelAnimationFrame(C),C=null)}f.onPlayStateChange(m=>{N.setPlaying(!m),m?V():P()}),f.onTimeUpdate(m=>{d=m*f.getDurationSeconds(),Ve(d)});const F=document.createElement("div");F.className="overlay-layer",n.appendChild(F);const U=or(F,{onReplay:zs,onParameters:()=>q("parameters"),onHome:Be,showHome:!t.lockedScaleId});f.onEnded(()=>{o=!0;const m=f.captureFrame();U.update(a,pe(),f.getDurationSeconds(),c,m),U.show()});const j=ja(F,s,m=>{Ie(m),q("parameters")}),K=wr(F,{simClass:a,values:pe(),theme:r,advancedSettings:t,availableScales:He,onValuesChange:Ht,onThemeChange:A,onRun:()=>{Z("Parameters submitted — starting run",{simClassId:a.id}),Xs().catch(m=>{ke("Run failed to start",{simClassId:a.id,error:m instanceof Error?m.message:String(m)})})},onApplySettings:ne,onClose:se,initialView:"parameters"}),be=vr(F);N.setPosition(0),Ve(),U.hide();const ee=new WeakMap,te=m=>{const w=ee.get(m);w&&(clearTimeout(w),ee.delete(m)),m.classList.remove("side-collapsed")},M=m=>{const w=ee.get(m);w&&clearTimeout(w),ee.set(m,setTimeout(()=>{m.classList.add("side-collapsed"),ee.delete(m)},2500))},we=m=>{const w=ee.get(m);w&&(clearTimeout(w),ee.delete(m)),m.classList.add("side-collapsed")},oe=(m,w)=>{m.addEventListener("mouseenter",()=>te(m)),m.addEventListener("mouseleave",()=>M(m)),m.addEventListener("focusin",()=>te(m)),m.addEventListener("focusout",x=>{m.contains(x.relatedTarget)||M(m)}),m.addEventListener("click",()=>{if(m.classList.contains("side-collapsed")){te(m),M(m);return}w.toggleOnClick?we(m):M(m)}),we(m)};oe(S,{toggleOnClick:!0}),oe(_,{toggleOnClick:!0}),oe(G,{toggleOnClick:!1});let he=0,le=null,X=0;const Se=()=>{le!==null&&(cancelAnimationFrame(le),le=null)},me=()=>{if(le!==null)return;X=f.getPlaybackFraction();const m=()=>{if(he===0){Se();return}const x=12*(1/60)/Math.max(f.getDurationSeconds(),1);X=Math.max(0,Math.min(1,X+he*x)),f.seekToFraction(X),le=requestAnimationFrame(m)};le=requestAnimationFrame(m)};document.addEventListener("keydown",m=>{if(n.dataset.mode==="display"&&!(m.target instanceof HTMLInputElement||m.target instanceof HTMLTextAreaElement))switch(m.key){case"Escape":m.preventDefault(),Be();break;case" ":m.preventDefault(),Tn();break;case"ArrowLeft":m.preventDefault(),he=-1,me();break;case"ArrowRight":m.preventDefault(),he=1,me();break;case"ArrowUp":case"ArrowDown":{if(m.preventDefault(),!(l!=null&&l.views)||Object.keys(l.views).length<=1)break;const w=a.views.filter(Ne=>{var ce;return((ce=l==null?void 0:l.views)==null?void 0:ce[Ne.id])!==void 0});if(w.length<=1)break;const x=l.viewId??yt(a,l),H=w.findIndex(Ne=>Ne.id===x),Me=m.key==="ArrowUp"?(H-1+w.length)%w.length:(H+1)%w.length;Cn(w[Me].id);break}}}),document.addEventListener("keyup",m=>{(m.key==="ArrowLeft"||m.key==="ArrowRight")&&(he=0,Se())}),f.hideMedia(),f.pause(),Oe(t.lockedScaleId?"config":"entry");function Ie(m){m.id===a.id&&p||(a=m,Kt(),A(sn[m.id]),K.setSimulation(a,pe()),N.setPosition(0),Ve(),jt())}function Ht(m){g[a.id]={...m},Z("Parameter values updated",{simClassId:a.id,values:g[a.id]}),Ve()}function A(m){r=m,Xt(m),K.setTheme(m)}function q(m){m==="parameters"&&K.setSimulation(a,pe()),K.setView(m),Oe("config")}function ne(m){if(ci(m),p){U.hide(),Oe("display");return}K.setSimulation(a,pe()),K.setView("parameters")}function se(){if(U.hide(),!p&&t.lockedScaleId){K.setSimulation(a,pe()),K.setView("parameters");return}Oe(p?"display":"entry")}function Be(){t.lockedScaleId||(Z("Returning to home screen",{simClassId:a.id}),Kt(),p=!1,f.hideMedia(),Oe("entry"))}function zs(){o=!1,U.hide(),f.resetPlayback(),f.play().catch(()=>{f.setMuted(!0),f.play()})}function Tn(){f.isPaused()?f.play().catch(()=>{f.setMuted(!0),f.play()}):f.pause()}function Qs(m){f.setPlaybackRate(m),B(m),N.setSpeed(m)}async function Xs(){const m=pe();Z("Run requested",{simClassId:a.id,values:m,manifestSource:i.getSource()});const w=await i.findNearestVideo(a.id,a.parameters,m);Kt(),l=w;const x=yt(a,w);Wr({simulationId:a.id,parameters:m,manifestSource:i.getSource(),matchedRunId:w.runId});const H=li(w,x)??w.url,Me=Object.entries(w.views??{}).filter(([ie])=>ie!==x).map(([,ie])=>ie);ai(w.liveDataUrl),ri(w.summaryUrl),f.setMuted(!1),jt(x),Oe("initializing");const Ne=Zs(H);f.prewarmSources(Me);const ce=(async()=>{const ie=await Ne;Z(`Prepared active video source: ${ie.ownedObjectUrl?"FULL-FETCH":"PROGRESSIVE"}`,{selectedViewUrl:H,waitsForBuffer:ie.shouldWaitForBuffer}),f.setSource(ie.src,{ownedObjectUrl:ie.ownedObjectUrl}),f.pause(),await f.waitForLoadedData(zr),ie.shouldWaitForBuffer&&await f.waitForBufferedAhead(Yr,Jr)})();await new Promise(ie=>{be.show(Ir(a),ie,ce)}),p=!0,f.showMedia(),f.play().catch(()=>{f.setMuted(!0),f.play().catch(()=>{})}),Oe("display")}async function Zs(m){const w=await ei(m);if(w!==null&&w>0&&w<=zn){Z("Downloading active video behind loading overlay",{videoUrl:m,contentLength:w});try{const x=await fetch(m);if(!x.ok)throw new Error(`Failed to download active video: ${m}`);const H=await x.blob();return Z(`Active video full fetch complete: ${H.size} bytes`,{videoUrl:m,blobType:H.type}),{src:URL.createObjectURL(H),ownedObjectUrl:!0,shouldWaitForBuffer:!1}}catch(x){ke(`Full-fetch FAILED; falling back to progressive: ${x instanceof Error?x.message:String(x)}`,{videoUrl:m})}}return w!==null?Z("Active video exceeds full-fetch threshold; using progressive load",{videoUrl:m,contentLength:w,fullFetchMaxBytes:zn}):Z("Could not determine active video size; using progressive load",{videoUrl:m}),Z("Using progressive active video load",{videoUrl:m}),{src:m,ownedObjectUrl:!1,shouldWaitForBuffer:!0}}async function ei(m){try{const w=await fetch(m,{headers:{Range:"bytes=0-0"}});Z("Probed active video size with range request",{videoUrl:m,ok:w.ok,status:w.status,contentLength:w.headers.get("Content-Length"),contentRange:w.headers.get("Content-Range")});const x=ni(w.headers.get("Content-Length"));if(x!==null)return x;const H=ti(w.headers.get("Content-Range"));return H!==null?H:null}catch(w){return ke("Could not probe active video size",{videoUrl:m,error:w instanceof Error?w.message:String(w)}),null}}function ti(m){if(!m)return null;const w=m.match(/bytes\s+\d+-\d+\/(\d+)/i);if(!w)return null;const x=Number(w[1]);return Number.isFinite(x)&&x>0?x:null}function ni(m){if(!m)return null;const w=Number(m);return Number.isFinite(w)?w:null}function Oe(m){if(n.dataset.mode=m,m==="entry"?document.documentElement.setAttribute("data-theme","glass"):m==="display"&&Xt(r),qt(h,m==="display"||m==="config"),qt(k,m==="display"),qt(S,!t.lockedScaleId&&(m==="entry"||m==="config"||m==="display")),m==="entry"&&!t.lockedScaleId?j.show():j.hide(),m==="config"?(be.hide(),K.setSimulation(a,pe()),K.show()):K.hide(),m!=="display")U.hide();else if(o){const x=f.captureFrame();U.update(a,pe(),f.getDurationSeconds(),c,x),U.show()}!p||m==="initializing"?(f.hideMedia(),m==="initializing"&&f.pause()):f.showMedia(),m!=="initializing"&&be.hide()}function Ve(m=0){const w=Ur(u,m,f.getDurationSeconds()),x=oi(a,c,m,f.getDurationSeconds());E.update(a,pe(),{...w,...x})}function jt(m){const w=a.views.filter(x=>{var H;return((H=l==null?void 0:l.views)==null?void 0:H[x.id])!==void 0});if(w.length<=1){I.hide();return}I.update(w,m??yt(a,l))}function Kt(){u=Nt,o=!1,c=null,l=null,d=0,U.hide(),I.hide(),f.pause(),f.clearPrewarmedSources(),f.resetPlayback(),N.setPosition(0)}function Cn(m){if(!(l!=null&&l.views)||m===yt(a,l))return;const w=l.views[m];if(!w)return;l.viewId=m;const x=!f.isPaused()&&!o,H=o?0:f.getPlaybackFraction();o=!1,U.hide(),f.setSource(w,{seekFraction:H,autoplay:x}),jt(m)}function pe(){return{...g[a.id]}}function si(m){return Object.fromEntries(m.parameters.map(w=>[w.id,ii(w)]))}function ii(m){const w=Math.max(0,Math.round((m.max-m.min)/m.step)),x=Math.floor(Math.random()*(w+1)),H=m.min+x*m.step,Me=Fs(m.step);return Number(H.toFixed(Me))}async function ai(m){try{u=await Dr(m)}catch(w){u=Nt,ke("Failed to load live stats",{url:m,error:w instanceof Error?w.message:String(w)})}Ve()}async function ri(m){c=await Cr(m),Ve(d)}function oi(m,w,x,H){if(!w||!Number.isFinite(H)||H<=0)return{};const Me=Math.max(0,Math.min(1,x/H)),Ne={};for(const ce of m.metadata.liveStats){if(!ce.live||!ce.fromVideo||!ce.scaleWithTime)continue;const Pn=ce.videoKey??ce.id,ie=w[Pn];if(typeof ie!="number"||!Number.isFinite(ie))continue;const xn=ie*Me;Ne[ce.id]=ce.integer?String(Math.floor(xn)):String(xn)}return Ne}function qt(m,w){m.hidden=!w,m.classList.toggle("is-hidden",!w)}function yt(m,w){return w!=null&&w.views?w.viewId??Object.keys(w.views)[0]:w==null?void 0:w.viewId}function li(m,w){return!w||!m.views?null:m.views[w]??null}function On(m){const w=new Set(br(m,e));return He.filter(x=>w.has(x.id))}function Mn(m){return m?He.find(w=>w.id===m)??null:null}function ci(m){const w=a.id,x=t.manifestSource;t=yr(m,e),s=On(t),i.setSource(t.manifestSource),t.manifestSource==="online"&&i.preloadActiveManifest(),v.setHomeVisible(!t.lockedScaleId),U.setHomeVisible(!t.lockedScaleId),j.setSimulationClasses(s),K.setAdvancedSettings(t),Z("Advanced settings updated",t),x!==t.manifestSource&&(l=null);const H=Mn(t.lockedScaleId);H&&(Ie(H),H.id!==w&&(p=!1,f.hideMedia(),K.setView("parameters")),p||(A(sn[H.id]),K.setSimulation(a,pe())))}}function Xr(){const n=document.getElementById("app");if(!n)throw new Error("App mount element not found.");Qr(n)}Xr();
//# sourceMappingURL=index-B7MpZkFN.js.map
