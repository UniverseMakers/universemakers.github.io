(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const a of i)if(a.type==="childList")for(const r of a.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function t(i){const a={};return i.integrity&&(a.integrity=i.integrity),i.referrerPolicy&&(a.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?a.credentials="include":i.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function s(i){if(i.ep)return;i.ep=!0;const a=t(i);fetch(i.href,a)}})();const Qn=Symbol.for("yaml.alias"),Hn=Symbol.for("yaml.document"),ze=Symbol.for("yaml.map"),qs=Symbol.for("yaml.pair"),De=Symbol.for("yaml.scalar"),bt=Symbol.for("yaml.seq"),Oe=Symbol.for("yaml.node.type"),nt=n=>!!n&&typeof n=="object"&&n[Oe]===Qn,on=n=>!!n&&typeof n=="object"&&n[Oe]===Hn,Ft=n=>!!n&&typeof n=="object"&&n[Oe]===ze,se=n=>!!n&&typeof n=="object"&&n[Oe]===qs,G=n=>!!n&&typeof n=="object"&&n[Oe]===De,Bt=n=>!!n&&typeof n=="object"&&n[Oe]===bt;function te(n){if(n&&typeof n=="object")switch(n[Oe]){case ze:case bt:return!0}return!1}function ne(n){if(n&&typeof n=="object")switch(n[Oe]){case Qn:case ze:case De:case bt:return!0}return!1}const Ks=n=>(G(n)||te(n))&&!!n.anchor,Xe=Symbol("break visit"),ya=Symbol("skip children"),Mt=Symbol("remove node");function wt(n,e){const t=ba(e);on(n)?ut(null,n.contents,t,Object.freeze([n]))===Mt&&(n.contents=null):ut(null,n,t,Object.freeze([]))}wt.BREAK=Xe;wt.SKIP=ya;wt.REMOVE=Mt;function ut(n,e,t,s){const i=wa(n,e,t,s);if(ne(i)||se(i))return va(n,s,i),ut(n,i,t,s);if(typeof i!="symbol"){if(te(e)){s=Object.freeze(s.concat(e));for(let a=0;a<e.items.length;++a){const r=ut(a,e.items[a],t,s);if(typeof r=="number")a=r-1;else{if(r===Xe)return Xe;r===Mt&&(e.items.splice(a,1),a-=1)}}}else if(se(e)){s=Object.freeze(s.concat(e));const a=ut("key",e.key,t,s);if(a===Xe)return Xe;a===Mt&&(e.key=null);const r=ut("value",e.value,t,s);if(r===Xe)return Xe;r===Mt&&(e.value=null)}}return i}function ba(n){return typeof n=="object"&&(n.Collection||n.Node||n.Value)?Object.assign({Alias:n.Node,Map:n.Node,Scalar:n.Node,Seq:n.Node},n.Value&&{Map:n.Value,Scalar:n.Value,Seq:n.Value},n.Collection&&{Map:n.Collection,Seq:n.Collection},n):n}function wa(n,e,t,s){var i,a,r,o,l;if(typeof t=="function")return t(n,e,s);if(Ft(e))return(i=t.Map)==null?void 0:i.call(t,n,e,s);if(Bt(e))return(a=t.Seq)==null?void 0:a.call(t,n,e,s);if(se(e))return(r=t.Pair)==null?void 0:r.call(t,n,e,s);if(G(e))return(o=t.Scalar)==null?void 0:o.call(t,n,e,s);if(nt(e))return(l=t.Alias)==null?void 0:l.call(t,n,e,s)}function va(n,e,t){const s=e[e.length-1];if(te(s))s.items[n]=t;else if(se(s))n==="key"?s.key=t:s.value=t;else if(on(s))s.contents=t;else{const i=nt(s)?"alias":"scalar";throw new Error(`Cannot replace node with ${i} parent`)}}const _a={"!":"%21",",":"%2C","[":"%5B","]":"%5D","{":"%7B","}":"%7D"},Sa=n=>n.replace(/[!,[\]{}]/g,e=>_a[e]);class ge{constructor(e,t){this.docStart=null,this.docEnd=!1,this.yaml=Object.assign({},ge.defaultYaml,e),this.tags=Object.assign({},ge.defaultTags,t)}clone(){const e=new ge(this.yaml,this.tags);return e.docStart=this.docStart,e}atDocument(){const e=new ge(this.yaml,this.tags);switch(this.yaml.version){case"1.1":this.atNextDocument=!0;break;case"1.2":this.atNextDocument=!1,this.yaml={explicit:ge.defaultYaml.explicit,version:"1.2"},this.tags=Object.assign({},ge.defaultTags);break}return e}add(e,t){this.atNextDocument&&(this.yaml={explicit:ge.defaultYaml.explicit,version:"1.1"},this.tags=Object.assign({},ge.defaultTags),this.atNextDocument=!1);const s=e.trim().split(/[ \t]+/),i=s.shift();switch(i){case"%TAG":{if(s.length!==2&&(t(0,"%TAG directive should contain exactly two parts"),s.length<2))return!1;const[a,r]=s;return this.tags[a]=r,!0}case"%YAML":{if(this.yaml.explicit=!0,s.length!==1)return t(0,"%YAML directive should contain exactly one part"),!1;const[a]=s;if(a==="1.1"||a==="1.2")return this.yaml.version=a,!0;{const r=/^\d+\.\d+$/.test(a);return t(6,`Unsupported YAML version ${a}`,r),!1}}default:return t(0,`Unknown directive ${i}`,!0),!1}}tagName(e,t){if(e==="!")return"!";if(e[0]!=="!")return t(`Not a valid tag: ${e}`),null;if(e[1]==="<"){const r=e.slice(2,-1);return r==="!"||r==="!!"?(t(`Verbatim tags aren't resolved, so ${e} is invalid.`),null):(e[e.length-1]!==">"&&t("Verbatim tags must end with a >"),r)}const[,s,i]=e.match(/^(.*!)([^!]*)$/s);i||t(`The ${e} tag has no suffix`);const a=this.tags[s];if(a)try{return a+decodeURIComponent(i)}catch(r){return t(String(r)),null}return s==="!"?e:(t(`Could not resolve tag: ${e}`),null)}tagString(e){for(const[t,s]of Object.entries(this.tags))if(e.startsWith(s))return t+Sa(e.substring(s.length));return e[0]==="!"?e:`!<${e}>`}toString(e){const t=this.yaml.explicit?[`%YAML ${this.yaml.version||"1.2"}`]:[],s=Object.entries(this.tags);let i;if(e&&s.length>0&&ne(e.contents)){const a={};wt(e.contents,(r,o)=>{ne(o)&&o.tag&&(a[o.tag]=!0)}),i=Object.keys(a)}else i=[];for(const[a,r]of s)a==="!!"&&r==="tag:yaml.org,2002:"||(!e||i.some(o=>o.startsWith(r)))&&t.push(`%TAG ${a} ${r}`);return t.join(`
`)}}ge.defaultYaml={explicit:!1,version:"1.2"};ge.defaultTags={"!!":"tag:yaml.org,2002:"};function Ws(n){if(/[\x00-\x19\s,[\]{}]/.test(n)){const t=`Anchor must not contain whitespace or control characters: ${JSON.stringify(n)}`;throw new Error(t)}return!0}function Ys(n){const e=new Set;return wt(n,{Value(t,s){s.anchor&&e.add(s.anchor)}}),e}function Gs(n,e){for(let t=1;;++t){const s=`${n}${t}`;if(!e.has(s))return s}}function ka(n,e){const t=[],s=new Map;let i=null;return{onAnchor:a=>{t.push(a),i??(i=Ys(n));const r=Gs(e,i);return i.add(r),r},setAnchors:()=>{for(const a of t){const r=s.get(a);if(typeof r=="object"&&r.anchor&&(G(r.node)||te(r.node)))r.node.anchor=r.anchor;else{const o=new Error("Failed to resolve repeated object (this should not happen)");throw o.source=a,o}}},sourceObjects:s}}function dt(n,e,t,s){if(s&&typeof s=="object")if(Array.isArray(s))for(let i=0,a=s.length;i<a;++i){const r=s[i],o=dt(n,s,String(i),r);o===void 0?delete s[i]:o!==r&&(s[i]=o)}else if(s instanceof Map)for(const i of Array.from(s.keys())){const a=s.get(i),r=dt(n,s,i,a);r===void 0?s.delete(i):r!==a&&s.set(i,r)}else if(s instanceof Set)for(const i of Array.from(s)){const a=dt(n,s,i,i);a===void 0?s.delete(i):a!==i&&(s.delete(i),s.add(a))}else for(const[i,a]of Object.entries(s)){const r=dt(n,s,i,a);r===void 0?delete s[i]:r!==a&&(s[i]=r)}return n.call(e,t,s)}function Me(n,e,t){if(Array.isArray(n))return n.map((s,i)=>Me(s,String(i),t));if(n&&typeof n.toJSON=="function"){if(!t||!Ks(n))return n.toJSON(e,t);const s={aliasCount:0,count:1,res:void 0};t.anchors.set(n,s),t.onCreate=a=>{s.res=a,delete t.onCreate};const i=n.toJSON(e,t);return t.onCreate&&t.onCreate(i),i}return typeof n=="bigint"&&!(t!=null&&t.keep)?Number(n):n}class Xn{constructor(e){Object.defineProperty(this,Oe,{value:e})}clone(){const e=Object.create(Object.getPrototypeOf(this),Object.getOwnPropertyDescriptors(this));return this.range&&(e.range=this.range.slice()),e}toJS(e,{mapAsMap:t,maxAliasCount:s,onAnchor:i,reviver:a}={}){if(!on(e))throw new TypeError("A document argument is required");const r={anchors:new Map,doc:e,keep:!0,mapAsMap:t===!0,mapKeyWarned:!1,maxAliasCount:typeof s=="number"?s:100},o=Me(this,"",r);if(typeof i=="function")for(const{count:l,res:c}of r.anchors.values())i(c,l);return typeof a=="function"?dt(a,{"":o},"",o):o}}class Zn extends Xn{constructor(e){super(Qn),this.source=e,Object.defineProperty(this,"tag",{set(){throw new Error("Alias nodes cannot have tags")}})}resolve(e,t){let s;t!=null&&t.aliasResolveCache?s=t.aliasResolveCache:(s=[],wt(e,{Node:(a,r)=>{(nt(r)||Ks(r))&&s.push(r)}}),t&&(t.aliasResolveCache=s));let i;for(const a of s){if(a===this)break;a.anchor===this.source&&(i=a)}return i}toJSON(e,t){if(!t)return{source:this.source};const{anchors:s,doc:i,maxAliasCount:a}=t,r=this.resolve(i,t);if(!r){const l=`Unresolved alias (the anchor must be set before the alias): ${this.source}`;throw new ReferenceError(l)}let o=s.get(r);if(o||(Me(r,null,t),o=s.get(r)),(o==null?void 0:o.res)===void 0){const l="This should not happen: Alias anchor was not resolved?";throw new ReferenceError(l)}if(a>=0&&(o.count+=1,o.aliasCount===0&&(o.aliasCount=Qt(i,r,s)),o.count*o.aliasCount>a)){const l="Excessive alias count indicates a resource exhaustion attack";throw new ReferenceError(l)}return o.res}toString(e,t,s){const i=`*${this.source}`;if(e){if(Ws(this.source),e.options.verifyAliasOrder&&!e.anchors.has(this.source)){const a=`Unresolved alias (the anchor must be set before the alias): ${this.source}`;throw new Error(a)}if(e.implicitKey)return`${i} `}return i}}function Qt(n,e,t){if(nt(e)){const s=e.resolve(n),i=t&&s&&t.get(s);return i?i.count*i.aliasCount:0}else if(te(e)){let s=0;for(const i of e.items){const a=Qt(n,i,t);a>s&&(s=a)}return s}else if(se(e)){const s=Qt(n,e.key,t),i=Qt(n,e.value,t);return Math.max(s,i)}return 1}const zs=n=>!n||typeof n!="function"&&typeof n!="object";class x extends Xn{constructor(e){super(De),this.value=e}toJSON(e,t){return t!=null&&t.keep?this.value:Me(this.value,e,t)}toString(){return String(this.value)}}x.BLOCK_FOLDED="BLOCK_FOLDED";x.BLOCK_LITERAL="BLOCK_LITERAL";x.PLAIN="PLAIN";x.QUOTE_DOUBLE="QUOTE_DOUBLE";x.QUOTE_SINGLE="QUOTE_SINGLE";const Ea="tag:yaml.org,2002:";function La(n,e,t){if(e){const s=t.filter(a=>a.tag===e),i=s.find(a=>!a.format)??s[0];if(!i)throw new Error(`Tag ${e} not found`);return i}return t.find(s=>{var i;return((i=s.identify)==null?void 0:i.call(s,n))&&!s.format})}function Pt(n,e,t){var d,p,m;if(on(n)&&(n=n.contents),ne(n))return n;if(se(n)){const b=(p=(d=t.schema[ze]).createNode)==null?void 0:p.call(d,t.schema,null,t);return b.items.push(n),b}(n instanceof String||n instanceof Number||n instanceof Boolean||typeof BigInt<"u"&&n instanceof BigInt)&&(n=n.valueOf());const{aliasDuplicateObjects:s,onAnchor:i,onTagObj:a,schema:r,sourceObjects:o}=t;let l;if(s&&n&&typeof n=="object"){if(l=o.get(n),l)return l.anchor??(l.anchor=i(n)),new Zn(l.anchor);l={anchor:null,node:null},o.set(n,l)}e!=null&&e.startsWith("!!")&&(e=Ea+e.slice(2));let c=La(n,e,r.tags);if(!c){if(n&&typeof n.toJSON=="function"&&(n=n.toJSON()),!n||typeof n!="object"){const b=new x(n);return l&&(l.node=b),b}c=n instanceof Map?r[ze]:Symbol.iterator in Object(n)?r[bt]:r[ze]}a&&(a(c),delete t.onTagObj);const u=c!=null&&c.createNode?c.createNode(t.schema,n,t):typeof((m=c==null?void 0:c.nodeClass)==null?void 0:m.from)=="function"?c.nodeClass.from(t.schema,n,t):new x(n);return e?u.tag=e:c.default||(u.tag=c.tag),l&&(l.node=u),u}function tn(n,e,t){let s=t;for(let i=e.length-1;i>=0;--i){const a=e[i];if(typeof a=="number"&&Number.isInteger(a)&&a>=0){const r=[];r[a]=s,s=r}else s=new Map([[a,s]])}return Pt(s,void 0,{aliasDuplicateObjects:!1,keepUndefined:!1,onAnchor:()=>{throw new Error("This should not happen, please report a bug.")},schema:n,sourceObjects:new Map})}const At=n=>n==null||typeof n=="object"&&!!n[Symbol.iterator]().next().done;class Js extends Xn{constructor(e,t){super(e),Object.defineProperty(this,"schema",{value:t,configurable:!0,enumerable:!1,writable:!0})}clone(e){const t=Object.create(Object.getPrototypeOf(this),Object.getOwnPropertyDescriptors(this));return e&&(t.schema=e),t.items=t.items.map(s=>ne(s)||se(s)?s.clone(e):s),this.range&&(t.range=this.range.slice()),t}addIn(e,t){if(At(e))this.add(t);else{const[s,...i]=e,a=this.get(s,!0);if(te(a))a.addIn(i,t);else if(a===void 0&&this.schema)this.set(s,tn(this.schema,i,t));else throw new Error(`Expected YAML collection at ${s}. Remaining path: ${i}`)}}deleteIn(e){const[t,...s]=e;if(s.length===0)return this.delete(t);const i=this.get(t,!0);if(te(i))return i.deleteIn(s);throw new Error(`Expected YAML collection at ${t}. Remaining path: ${s}`)}getIn(e,t){const[s,...i]=e,a=this.get(s,!0);return i.length===0?!t&&G(a)?a.value:a:te(a)?a.getIn(i,t):void 0}hasAllNullValues(e){return this.items.every(t=>{if(!se(t))return!1;const s=t.value;return s==null||e&&G(s)&&s.value==null&&!s.commentBefore&&!s.comment&&!s.tag})}hasIn(e){const[t,...s]=e;if(s.length===0)return this.has(t);const i=this.get(t,!0);return te(i)?i.hasIn(s):!1}setIn(e,t){const[s,...i]=e;if(i.length===0)this.set(s,t);else{const a=this.get(s,!0);if(te(a))a.setIn(i,t);else if(a===void 0&&this.schema)this.set(s,tn(this.schema,i,t));else throw new Error(`Expected YAML collection at ${s}. Remaining path: ${i}`)}}}const Na=n=>n.replace(/^(?!$)(?: $)?/gm,"#");function He(n,e){return/^\n+$/.test(n)?n.substring(1):e?n.replace(/^(?! *$)/gm,e):n}const Ze=(n,e,t)=>n.endsWith(`
`)?He(t,e):t.includes(`
`)?`
`+He(t,e):(n.endsWith(" ")?"":" ")+t,Qs="flow",jn="block",Xt="quoted";function ln(n,e,t="flow",{indentAtStart:s,lineWidth:i=80,minContentWidth:a=20,onFold:r,onOverflow:o}={}){if(!i||i<0)return n;i<a&&(a=0);const l=Math.max(1+a,1+i-e.length);if(n.length<=l)return n;const c=[],u={};let d=i-e.length;typeof s=="number"&&(s>i-Math.max(2,a)?c.push(0):d=i-s);let p,m,b=!1,h=-1,y=-1,S=-1;t===jn&&(h=_s(n,h,e.length),h!==-1&&(d=h+l));for(let L;L=n[h+=1];){if(t===Xt&&L==="\\"){switch(y=h,n[h+1]){case"x":h+=3;break;case"u":h+=5;break;case"U":h+=9;break;default:h+=1}S=h}if(L===`
`)t===jn&&(h=_s(n,h,e.length)),d=h+e.length+l,p=void 0;else{if(L===" "&&m&&m!==" "&&m!==`
`&&m!=="	"){const k=n[h+1];k&&k!==" "&&k!==`
`&&k!=="	"&&(p=h)}if(h>=d)if(p)c.push(p),d=p+l,p=void 0;else if(t===Xt){for(;m===" "||m==="	";)m=L,L=n[h+=1],b=!0;const k=h>S+1?h-2:y-1;if(u[k])return n;c.push(k),u[k]=!0,d=k+l,p=void 0}else b=!0}m=L}if(b&&o&&o(),c.length===0)return n;r&&r();let w=n.slice(0,c[0]);for(let L=0;L<c.length;++L){const k=c[L],g=c[L+1]||n.length;k===0?w=`
${e}${n.slice(0,g)}`:(t===Xt&&u[k]&&(w+=`${n[k]}\\`),w+=`
${e}${n.slice(k+1,g)}`)}return w}function _s(n,e,t){let s=e,i=e+1,a=n[i];for(;a===" "||a==="	";)if(e<i+t)a=n[++e];else{do a=n[++e];while(a&&a!==`
`);s=e,i=e+1,a=n[i]}return s}const cn=(n,e)=>({indentAtStart:e?n.indent.length:n.indentAtStart,lineWidth:n.options.lineWidth,minContentWidth:n.options.minContentWidth}),un=n=>/^(%|---|\.\.\.)/m.test(n);function Ia(n,e,t){if(!e||e<0)return!1;const s=e-t,i=n.length;if(i<=s)return!1;for(let a=0,r=0;a<i;++a)if(n[a]===`
...
`,l+=2;r+=a,t[l+2]===" "&&(r+="\\"),l+=1,o=l+1}break;default:l+=1}return r=o?r+t.slice(o):t,s?r:ln(r,a,Xt,cn(e,!1))}function qn(n,e){if(e.options.singleQuote===!1||e.implicitKey&&n.includes(`
`)||/[ \t]\n|\n[ \t]/.test(n))return Ot(n,e);const t=e.indent||(un(n)?"  ":""),s="'"+n.replace(/'/g,"''").replace(/\n+/g,`$&
${t}`)+"'";return e.implicitKey?s:ln(s,t,Qs,cn(e,!1))}function ft(n,e){const{singleQuote:t}=e.options;let s;if(t===!1)s=Ot;else{const i=n.includes('"'),a=n.includes("'");i&&!a?s=qn:a&&!i?s=Ot:s=t?qn:Ot}return s(n,e)}let Kn;try{Kn=new RegExp(`(^|(?<!
))
+(?!
|$)`,"g")}catch{Kn=/\n+(?!\n|$)/g}function Zt({comment:n,type:e,value:t},s,i,a){const{blockQuote:r,commentString:o,lineWidth:l}=s.options;if(!r||/\n[\t ]+$/.test(t))return ft(t,s);const c=s.indent||(s.forceBlockIndent||un(t)?"  ":""),u=r==="literal"?!0:r==="folded"||e===x.BLOCK_FOLDED?!1:e===x.BLOCK_LITERAL?!0:!Ia(t,l,c.length);if(!t)return u?`|
`:`>
...
`&&(m=m.slice(0,-1)),m=m.replace(Kn,`$&${c}`));let h=!1,y,S=-1;for(y=0;y<t.length;++y){const g=t[y];if(g===" ")h=!0;else if(g===`
...
$&`).replace(/(?:^|\n)([\t ].*)(?:([\n\t ]*)\n(?![\n\t ]))?/g,"$1$2").replace(/\n+/g,`$&${c}`);let v=!1;const N=cn(s,!0);r!=="folded"&&e!==x.BLOCK_FOLDED&&(N.onOverflow=()=>{v=!0});const E=ln(`${w}${g}${m}`,c,jn,N);if(!v)return`>${k}
${c}${E}`}return t=t.replace(/\n+/g,`$&${c}`),`|${k}
${c}${w}${t}${m}`}function Ca(n,e,t,s){const{type:i,value:a}=n,{actualString:r,implicitKey:o,indent:l,indentStep:c,inFlow:u}=e;if(o&&a.includes(`
...
${l}`);if(r){const p=h=>{var y;return h.default&&h.tag!=="tag:yaml.org,2002:str"&&((y=h.test)==null?void 0:y.test(d))},{compat:m,tags:b}=e.doc.schema;if(b.some(p)||m!=null&&m.some(p))return ft(a,e)}return o?d:ln(d,l,Qs,cn(e,!1))}function es(n,e,t,s){const{implicitKey:i,inFlow:a}=e,r=typeof n.value=="string"?n:Object.assign({},n,{value:String(n.value)});let{type:o}=n;o!==x.QUOTE_DOUBLE&&/[\x00-\x08\x0b-\x1f\x7f-\x9f\u{D800}-\u{DFFF}]/u.test(r.value)&&(o=x.QUOTE_DOUBLE);const l=u=>{switch(u){case x.BLOCK_FOLDED:case x.BLOCK_LITERAL:return i||a?ft(r.value,e):Zt(r,e,t,s);case x.QUOTE_DOUBLE:return Ot(r.value,e);case x.QUOTE_SINGLE:return qn(r.value,e);case x.PLAIN:return Ca(r,e,t,s);default:return null}};let c=l(o);if(c===null){const{defaultKeyType:u,defaultStringType:d}=e.options,p=i&&u||d;if(c=l(p),c===null)throw new Error(`Unsupported default string type ${p}`)}return c}function Xs(n,e){const t=Object.assign({blockQuote:!0,commentString:Na,defaultKeyType:null,defaultStringType:"PLAIN",directives:null,doubleQuotedAsJSON:!1,doubleQuotedMinMultiLineLength:40,falseStr:"false",flowCollectionPadding:!0,indentSeq:!0,lineWidth:80,minContentWidth:20,nullStr:"null",simpleKeys:!1,singleQuote:null,trailingComma:!1,trueStr:"true",verifyAliasOrder:!0},n.schema.toStringOptions,e);let s;switch(t.collectionStyle){case"block":s=!1;break;case"flow":s=!0;break;default:s=null}return{anchors:new Set,doc:n,flowCollectionPadding:t.flowCollectionPadding?" ":"",indent:"",indentStep:typeof t.indent=="number"?" ".repeat(t.indent):"  ",inFlow:s,options:t}}function Aa(n,e){var i;if(e.tag){const a=n.filter(r=>r.tag===e.tag);if(a.length>0)return a.find(r=>r.format===e.format)??a[0]}let t,s;if(G(e)){s=e.value;let a=n.filter(r=>{var o;return(o=r.identify)==null?void 0:o.call(r,s)});if(a.length>1){const r=a.filter(o=>o.test);r.length>0&&(a=r)}t=a.find(r=>r.format===e.format)??a.find(r=>!r.format)}else s=e,t=n.find(a=>a.nodeClass&&s instanceof a.nodeClass);if(!t){const a=((i=s==null?void 0:s.constructor)==null?void 0:i.name)??(s===null?"null":typeof s);throw new Error(`Tag not resolved for ${a} value`)}return t}function Ta(n,e,{anchors:t,doc:s}){if(!s.directives)return"";const i=[],a=(G(n)||te(n))&&n.anchor;a&&Ws(a)&&(t.add(a),i.push(`&${a}`));const r=n.tag??(e.default?null:e.tag);return r&&i.push(s.directives.tagString(r)),i.join(" ")}function gt(n,e,t,s){var l;if(se(n))return n.toString(e,t,s);if(nt(n)){if(e.doc.directives)return n.toString(e);if((l=e.resolvedAliases)!=null&&l.has(n))throw new TypeError("Cannot stringify circular structure without alias nodes");e.resolvedAliases?e.resolvedAliases.add(n):e.resolvedAliases=new Set([n]),n=n.resolve(e.doc)}let i;const a=ne(n)?n:e.doc.createNode(n,{onTagObj:c=>i=c});i??(i=Aa(e.doc.schema.tags,a));const r=Ta(a,i,e);r.length>0&&(e.indentAtStart=(e.indentAtStart??0)+r.length+1);const o=typeof i.stringify=="function"?i.stringify(a,e,t,s):G(a)?es(a,e,t,s):a.toString(e,t,s);return r?G(a)||o[0]==="{"||o[0]==="["?`${r} ${o}`:`${r}
${e.indent}${o}`:o}function Ma({key:n,value:e},t,s,i){const{allNullValues:a,doc:r,indent:o,indentStep:l,options:{commentString:c,indentSeq:u,simpleKeys:d}}=t;let p=ne(n)&&n.comment||null;if(d){if(p)throw new Error("With simple keys, key nodes cannot have comments");if(te(n)||!ne(n)&&typeof n=="object"){const N="With simple keys, collection cannot be used as a key value";throw new Error(N)}}let m=!d&&(!n||p&&e==null&&!t.inFlow||te(n)||(G(n)?n.type===x.BLOCK_FOLDED||n.type===x.BLOCK_LITERAL:typeof n=="object"));t=Object.assign({},t,{allNullValues:!1,implicitKey:!m&&(d||!a),indent:o+l});let b=!1,h=!1,y=gt(n,t,()=>b=!0,()=>h=!0);if(!m&&!t.inFlow&&y.length>1024){if(d)throw new Error("With simple keys, single line scalar must not span more than 1024 characters");m=!0}if(t.inFlow){if(a||e==null)return b&&s&&s(),y===""?"?":m?`? ${y}`:y}else if(a&&!d||e==null&&m)return y=`? ${y}`,p&&!b?y+=Ze(y,t.indent,c(p)):h&&i&&i(),y;b&&(p=null),m?(p&&(y+=Ze(y,t.indent,c(p))),y=`? ${y}
${o}:`):(y=`${y}:`,p&&(y+=Ze(y,t.indent,c(p))));let S,w,L;ne(e)?(S=!!e.spaceBefore,w=e.commentBefore,L=e.comment):(S=!1,w=null,L=null,e&&typeof e=="object"&&(e=r.createNode(e))),t.implicitKey=!1,!m&&!p&&G(e)&&(t.indentAtStart=y.length+1),h=!1,!u&&l.length>=2&&!t.inFlow&&!m&&Bt(e)&&!e.flow&&!e.tag&&!e.anchor&&(t.indent=t.indent.substring(2));let k=!1;const g=gt(e,t,()=>k=!0,()=>h=!0);let v=" ";if(p||S||w){if(v=S?`
`:"",w){const N=c(w);v+=`
${He(N,t.indent)}`}g===""&&!t.inFlow?v===`
`&&L&&(v=`

`):v+=`
${t.indent}`}else if(!m&&te(e)){const N=g[0],E=g.indexOf(`
`),T=E!==-1,R=t.inFlow??e.flow??e.items.length===0;if(T||!R){let $=!1;if(T&&(N==="&"||N==="!")){let F=g.indexOf(" ");N==="&"&&F!==-1&&F<E&&g[F+1]==="!"&&(F=g.indexOf(" ",F+1)),(F===-1||E<F)&&($=!0)}$||(v=`
${t.indent}`)}}else(g===""||g[0]===`
`)&&(v="");return y+=v+g,t.inFlow?k&&s&&s():L&&!k?y+=Ze(y,t.indent,c(L)):h&&i&&i(),y}function Zs(n,e){(n==="debug"||n==="warn")&&console.warn(e)}const qt="<<",qe={identify:n=>n===qt||typeof n=="symbol"&&n.description===qt,default:"key",tag:"tag:yaml.org,2002:merge",test:/^<<$/,resolve:()=>Object.assign(new x(Symbol(qt)),{addToJSMap:ei}),stringify:()=>qt},Oa=(n,e)=>(qe.identify(e)||G(e)&&(!e.type||e.type===x.PLAIN)&&qe.identify(e.value))&&(n==null?void 0:n.doc.schema.tags.some(t=>t.tag===qe.tag&&t.default));function ei(n,e,t){if(t=n&&nt(t)?t.resolve(n.doc):t,Bt(t))for(const s of t.items)Ln(n,e,s);else if(Array.isArray(t))for(const s of t)Ln(n,e,s);else Ln(n,e,t)}function Ln(n,e,t){const s=n&&nt(t)?t.resolve(n.doc):t;if(!Ft(s))throw new Error("Merge sources must be maps or map aliases");const i=s.toJSON(null,n,Map);for(const[a,r]of i)e instanceof Map?e.has(a)||e.set(a,r):e instanceof Set?e.add(a):Object.prototype.hasOwnProperty.call(e,a)||Object.defineProperty(e,a,{value:r,writable:!0,enumerable:!0,configurable:!0});return e}function ti(n,e,{key:t,value:s}){if(ne(t)&&t.addToJSMap)t.addToJSMap(n,e,s);else if(Oa(n,t))ei(n,e,s);else{const i=Me(t,"",n);if(e instanceof Map)e.set(i,Me(s,i,n));else if(e instanceof Set)e.add(i);else{const a=Pa(t,i,n),r=Me(s,a,n);a in e?Object.defineProperty(e,a,{value:r,writable:!0,enumerable:!0,configurable:!0}):e[a]=r}}return e}function Pa(n,e,t){if(e===null)return"";if(typeof e!="object")return String(e);if(ne(n)&&(t!=null&&t.doc)){const s=Xs(t.doc,{});s.anchors=new Set;for(const a of t.anchors.keys())s.anchors.add(a.anchor);s.inFlow=!0,s.inStringifyKey=!0;const i=n.toString(s);if(!t.mapKeyWarned){let a=JSON.stringify(i);a.length>40&&(a=a.substring(0,36)+'..."'),Zs(t.doc.options.logLevel,`Keys with collection values will be stringified due to JS Object restrictions: ${a}. Set mapAsMap: true to use object keys.`),t.mapKeyWarned=!0}return i}return JSON.stringify(e)}function ts(n,e,t){const s=Pt(n,void 0,t),i=Pt(e,void 0,t);return new ye(s,i)}class ye{constructor(e,t=null){Object.defineProperty(this,Oe,{value:qs}),this.key=e,this.value=t}clone(e){let{key:t,value:s}=this;return ne(t)&&(t=t.clone(e)),ne(s)&&(s=s.clone(e)),new ye(t,s)}toJSON(e,t){const s=t!=null&&t.mapAsMap?new Map:{};return ti(t,s,this)}toString(e,t,s){return e!=null&&e.doc?Ma(this,e,t,s):JSON.stringify(this)}}function ni(n,e,t){return(e.inFlow??n.flow?$a:xa)(n,e,t)}function xa({comment:n,items:e},t,{blockItemPrefix:s,flowChars:i,itemIndent:a,onChompKeep:r,onComment:o}){const{indent:l,options:{commentString:c}}=t,u=Object.assign({},t,{indent:a,type:null});let d=!1;const p=[];for(let b=0;b<e.length;++b){const h=e[b];let y=null;if(ne(h))!d&&h.spaceBefore&&p.push(""),nn(t,p,h.commentBefore,d),h.comment&&(y=h.comment);else if(se(h)){const w=ne(h.key)?h.key:null;w&&(!d&&w.spaceBefore&&p.push(""),nn(t,p,w.commentBefore,d))}d=!1;let S=gt(h,u,()=>y=null,()=>d=!0);y&&(S+=Ze(S,a,c(y))),d&&y&&(d=!1),p.push(s+S)}let m;if(p.length===0)m=i.start+i.end;else{m=p[0];for(let b=1;b<p.length;++b){const h=p[b];m+=h?`
${l}${h}`:`
`}}return n?(m+=`
`+He(c(n),l),o&&o()):d&&r&&r(),m}function $a({items:n},e,{flowChars:t,itemIndent:s}){const{indent:i,indentStep:a,flowCollectionPadding:r,options:{commentString:o}}=e;s+=a;const l=Object.assign({},e,{indent:s,inFlow:!0,type:null});let c=!1,u=0;const d=[];for(let b=0;b<n.length;++b){const h=n[b];let y=null;if(ne(h))h.spaceBefore&&d.push(""),nn(e,d,h.commentBefore,!1),h.comment&&(y=h.comment);else if(se(h)){const w=ne(h.key)?h.key:null;w&&(w.spaceBefore&&d.push(""),nn(e,d,w.commentBefore,!1),w.comment&&(c=!0));const L=ne(h.value)?h.value:null;L?(L.comment&&(y=L.comment),L.commentBefore&&(c=!0)):h.value==null&&(w!=null&&w.comment)&&(y=w.comment)}y&&(c=!0);let S=gt(h,l,()=>y=null);c||(c=d.length>u||S.includes(`
`)),b<n.length-1?S+=",":e.options.trailingComma&&(e.options.lineWidth>0&&(c||(c=d.reduce((w,L)=>w+L.length+2,2)+(S.length+2)>e.options.lineWidth)),c&&(S+=",")),y&&(S+=Ze(S,s,o(y))),d.push(S),u=d.length}const{start:p,end:m}=t;if(d.length===0)return p+m;if(!c){const b=d.reduce((h,y)=>h+y.length+2,2);c=e.options.lineWidth>0&&b>e.options.lineWidth}if(c){let b=p;for(const h of d)b+=h?`
${a}${i}${h}`:`
`;return`${b}
${i}${m}`}else return`${p}${r}${d.join(" ")}${r}${m}`}function nn({indent:n,options:{commentString:e}},t,s,i){if(s&&i&&(s=s.replace(/^\n+/,"")),s){const a=He(e(s),n);t.push(a.trimStart())}}function et(n,e){const t=G(e)?e.value:e;for(const s of n)if(se(s)&&(s.key===e||s.key===t||G(s.key)&&s.key.value===t))return s}class Te extends Js{static get tagName(){return"tag:yaml.org,2002:map"}constructor(e){super(ze,e),this.items=[]}static from(e,t,s){const{keepUndefined:i,replacer:a}=s,r=new this(e),o=(l,c)=>{if(typeof a=="function")c=a.call(t,l,c);else if(Array.isArray(a)&&!a.includes(l))return;(c!==void 0||i)&&r.items.push(ts(l,c,s))};if(t instanceof Map)for(const[l,c]of t)o(l,c);else if(t&&typeof t=="object")for(const l of Object.keys(t))o(l,t[l]);return typeof e.sortMapEntries=="function"&&r.items.sort(e.sortMapEntries),r}add(e,t){var r;let s;se(e)?s=e:!e||typeof e!="object"||!("key"in e)?s=new ye(e,e==null?void 0:e.value):s=new ye(e.key,e.value);const i=et(this.items,s.key),a=(r=this.schema)==null?void 0:r.sortMapEntries;if(i){if(!t)throw new Error(`Key ${s.key} already set`);G(i.value)&&zs(s.value)?i.value.value=s.value:i.value=s.value}else if(a){const o=this.items.findIndex(l=>a(s,l)<0);o===-1?this.items.push(s):this.items.splice(o,0,s)}else this.items.push(s)}delete(e){const t=et(this.items,e);return t?this.items.splice(this.items.indexOf(t),1).length>0:!1}get(e,t){const s=et(this.items,e),i=s==null?void 0:s.value;return(!t&&G(i)?i.value:i)??void 0}has(e){return!!et(this.items,e)}set(e,t){this.add(new ye(e,t),!0)}toJSON(e,t,s){const i=s?new s:t!=null&&t.mapAsMap?new Map:{};t!=null&&t.onCreate&&t.onCreate(i);for(const a of this.items)ti(t,i,a);return i}toString(e,t,s){if(!e)return JSON.stringify(this);for(const i of this.items)if(!se(i))throw new Error(`Map items must all be pairs; found ${JSON.stringify(i)} instead`);return!e.allNullValues&&this.hasAllNullValues(!1)&&(e=Object.assign({},e,{allNullValues:!0})),ni(this,e,{blockItemPrefix:"",flowChars:{start:"{",end:"}"},itemIndent:e.indent||"",onChompKeep:s,onComment:t})}}const vt={collection:"map",default:!0,nodeClass:Te,tag:"tag:yaml.org,2002:map",resolve(n,e){return Ft(n)||e("Expected a mapping for this tag"),n},createNode:(n,e,t)=>Te.from(n,e,t)};class tt extends Js{static get tagName(){return"tag:yaml.org,2002:seq"}constructor(e){super(bt,e),this.items=[]}add(e){this.items.push(e)}delete(e){const t=Kt(e);return typeof t!="number"?!1:this.items.splice(t,1).length>0}get(e,t){const s=Kt(e);if(typeof s!="number")return;const i=this.items[s];return!t&&G(i)?i.value:i}has(e){const t=Kt(e);return typeof t=="number"&&t<this.items.length}set(e,t){const s=Kt(e);if(typeof s!="number")throw new Error(`Expected a valid index, not ${e}.`);const i=this.items[s];G(i)&&zs(t)?i.value=t:this.items[s]=t}toJSON(e,t){const s=[];t!=null&&t.onCreate&&t.onCreate(s);let i=0;for(const a of this.items)s.push(Me(a,String(i++),t));return s}toString(e,t,s){return e?ni(this,e,{blockItemPrefix:"- ",flowChars:{start:"[",end:"]"},itemIndent:(e.indent||"")+"  ",onChompKeep:s,onComment:t}):JSON.stringify(this)}static from(e,t,s){const{replacer:i}=s,a=new this(e);if(t&&Symbol.iterator in Object(t)){let r=0;for(let o of t){if(typeof i=="function"){const l=t instanceof Set?o:String(r++);o=i.call(t,l,o)}a.items.push(Pt(o,void 0,s))}}return a}}function Kt(n){let e=G(n)?n.value:n;return e&&typeof e=="string"&&(e=Number(e)),typeof e=="number"&&Number.isInteger(e)&&e>=0?e:null}const _t={collection:"seq",default:!0,nodeClass:tt,tag:"tag:yaml.org,2002:seq",resolve(n,e){return Bt(n)||e("Expected a sequence for this tag"),n},createNode:(n,e,t)=>tt.from(n,e,t)},dn={identify:n=>typeof n=="string",default:!0,tag:"tag:yaml.org,2002:str",resolve:n=>n,stringify(n,e,t,s){return e=Object.assign({actualString:!0},e),es(n,e,t,s)}},fn={identify:n=>n==null,createNode:()=>new x(null),default:!0,tag:"tag:yaml.org,2002:null",test:/^(?:~|[Nn]ull|NULL)?$/,resolve:()=>new x(null),stringify:({source:n},e)=>typeof n=="string"&&fn.test.test(n)?n:e.options.nullStr},ns={identify:n=>typeof n=="boolean",default:!0,tag:"tag:yaml.org,2002:bool",test:/^(?:[Tt]rue|TRUE|[Ff]alse|FALSE)$/,resolve:n=>new x(n[0]==="t"||n[0]==="T"),stringify({source:n,value:e},t){if(n&&ns.test.test(n)){const s=n[0]==="t"||n[0]==="T";if(e===s)return n}return e?t.options.trueStr:t.options.falseStr}};function Be({format:n,minFractionDigits:e,tag:t,value:s}){if(typeof s=="bigint")return String(s);const i=typeof s=="number"?s:Number(s);if(!isFinite(i))return isNaN(i)?".nan":i<0?"-.inf":".inf";let a=Object.is(s,-0)?"-0":JSON.stringify(s);if(!n&&e&&(!t||t==="tag:yaml.org,2002:float")&&/^\d/.test(a)){let r=a.indexOf(".");r<0&&(r=a.length,a+=".");let o=e-(a.length-r-1);for(;o-- >0;)a+="0"}return a}const si={identify:n=>typeof n=="number",default:!0,tag:"tag:yaml.org,2002:float",test:/^(?:[-+]?\.(?:inf|Inf|INF)|\.nan|\.NaN|\.NAN)$/,resolve:n=>n.slice(-3).toLowerCase()==="nan"?NaN:n[0]==="-"?Number.NEGATIVE_INFINITY:Number.POSITIVE_INFINITY,stringify:Be},ii={identify:n=>typeof n=="number",default:!0,tag:"tag:yaml.org,2002:float",format:"EXP",test:/^[-+]?(?:\.[0-9]+|[0-9]+(?:\.[0-9]*)?)[eE][-+]?[0-9]+$/,resolve:n=>parseFloat(n),stringify(n){const e=Number(n.value);return isFinite(e)?e.toExponential():Be(n)}},ai={identify:n=>typeof n=="number",default:!0,tag:"tag:yaml.org,2002:float",test:/^[-+]?(?:\.[0-9]+|[0-9]+\.[0-9]*)$/,resolve(n){const e=new x(parseFloat(n)),t=n.indexOf(".");return t!==-1&&n[n.length-1]==="0"&&(e.minFractionDigits=n.length-t-1),e},stringify:Be},hn=n=>typeof n=="bigint"||Number.isInteger(n),ss=(n,e,t,{intAsBigInt:s})=>s?BigInt(n):parseInt(n.substring(e),t);function ri(n,e,t){const{value:s}=n;return hn(s)&&s>=0?t+s.toString(e):Be(n)}const oi={identify:n=>hn(n)&&n>=0,default:!0,tag:"tag:yaml.org,2002:int",format:"OCT",test:/^0o[0-7]+$/,resolve:(n,e,t)=>ss(n,2,8,t),stringify:n=>ri(n,8,"0o")},li={identify:hn,default:!0,tag:"tag:yaml.org,2002:int",test:/^[-+]?[0-9]+$/,resolve:(n,e,t)=>ss(n,0,10,t),stringify:Be},ci={identify:n=>hn(n)&&n>=0,default:!0,tag:"tag:yaml.org,2002:int",format:"HEX",test:/^0x[0-9a-fA-F]+$/,resolve:(n,e,t)=>ss(n,2,16,t),stringify:n=>ri(n,16,"0x")},Ra=[vt,_t,dn,fn,ns,oi,li,ci,si,ii,ai];function Ss(n){return typeof n=="bigint"||Number.isInteger(n)}const Wt=({value:n})=>JSON.stringify(n),Fa=[{identify:n=>typeof n=="string",default:!0,tag:"tag:yaml.org,2002:str",resolve:n=>n,stringify:Wt},{identify:n=>n==null,createNode:()=>new x(null),default:!0,tag:"tag:yaml.org,2002:null",test:/^null$/,resolve:()=>null,stringify:Wt},{identify:n=>typeof n=="boolean",default:!0,tag:"tag:yaml.org,2002:bool",test:/^true$|^false$/,resolve:n=>n==="true",stringify:Wt},{identify:Ss,default:!0,tag:"tag:yaml.org,2002:int",test:/^-?(?:0|[1-9][0-9]*)$/,resolve:(n,e,{intAsBigInt:t})=>t?BigInt(n):parseInt(n,10),stringify:({value:n})=>Ss(n)?n.toString():JSON.stringify(n)},{identify:n=>typeof n=="number",default:!0,tag:"tag:yaml.org,2002:float",test:/^-?(?:0|[1-9][0-9]*)(?:\.[0-9]*)?(?:[eE][-+]?[0-9]+)?$/,resolve:n=>parseFloat(n),stringify:Wt}],Ba={default:!0,tag:"",test:/^/,resolve(n,e){return e(`Unresolved plain scalar ${JSON.stringify(n)}`),n}},Va=[vt,_t].concat(Fa,Ba),is={identify:n=>n instanceof Uint8Array,default:!1,tag:"tag:yaml.org,2002:binary",resolve(n,e){if(typeof atob=="function"){const t=atob(n.replace(/[\n\r]/g,"")),s=new Uint8Array(t.length);for(let i=0;i<t.length;++i)s[i]=t.charCodeAt(i);return s}else return e("This environment does not support reading binary tags; either Buffer or atob is required"),n},stringify({comment:n,type:e,value:t},s,i,a){if(!t)return"";const r=t;let o;if(typeof btoa=="function"){let l="";for(let c=0;c<r.length;++c)l+=String.fromCharCode(r[c]);o=btoa(l)}else throw new Error("This environment does not support writing binary tags; either Buffer or btoa is required");if(e??(e=x.BLOCK_LITERAL),e!==x.QUOTE_DOUBLE){const l=Math.max(s.options.lineWidth-s.indent.length,s.options.minContentWidth),c=Math.ceil(o.length/l),u=new Array(c);for(let d=0,p=0;d<c;++d,p+=l)u[d]=o.substr(p,l);o=u.join(e===x.BLOCK_LITERAL?`
`:" ")}return es({comment:n,type:e,value:o},s,i,a)}};function ui(n,e){if(Bt(n))for(let t=0;t<n.items.length;++t){let s=n.items[t];if(!se(s)){if(Ft(s)){s.items.length>1&&e("Each pair must have its own sequence indicator");const i=s.items[0]||new ye(new x(null));if(s.commentBefore&&(i.key.commentBefore=i.key.commentBefore?`${s.commentBefore}
${i.key.commentBefore}`:s.commentBefore),s.comment){const a=i.value??i.key;a.comment=a.comment?`${s.comment}
${a.comment}`:s.comment}s=i}n.items[t]=se(s)?s:new ye(s)}}else e("Expected a sequence for this tag");return n}function di(n,e,t){const{replacer:s}=t,i=new tt(n);i.tag="tag:yaml.org,2002:pairs";let a=0;if(e&&Symbol.iterator in Object(e))for(let r of e){typeof s=="function"&&(r=s.call(e,String(a++),r));let o,l;if(Array.isArray(r))if(r.length===2)o=r[0],l=r[1];else throw new TypeError(`Expected [key, value] tuple: ${r}`);else if(r&&r instanceof Object){const c=Object.keys(r);if(c.length===1)o=c[0],l=r[o];else throw new TypeError(`Expected tuple with one key, not ${c.length} keys`)}else o=r;i.items.push(ts(o,l,t))}return i}const as={collection:"seq",default:!1,tag:"tag:yaml.org,2002:pairs",resolve:ui,createNode:di};class mt extends tt{constructor(){super(),this.add=Te.prototype.add.bind(this),this.delete=Te.prototype.delete.bind(this),this.get=Te.prototype.get.bind(this),this.has=Te.prototype.has.bind(this),this.set=Te.prototype.set.bind(this),this.tag=mt.tag}toJSON(e,t){if(!t)return super.toJSON(e);const s=new Map;t!=null&&t.onCreate&&t.onCreate(s);for(const i of this.items){let a,r;if(se(i)?(a=Me(i.key,"",t),r=Me(i.value,a,t)):a=Me(i,"",t),s.has(a))throw new Error("Ordered maps must not include duplicate keys");s.set(a,r)}return s}static from(e,t,s){const i=di(e,t,s),a=new this;return a.items=i.items,a}}mt.tag="tag:yaml.org,2002:omap";const rs={collection:"seq",identify:n=>n instanceof Map,nodeClass:mt,default:!1,tag:"tag:yaml.org,2002:omap",resolve(n,e){const t=ui(n,e),s=[];for(const{key:i}of t.items)G(i)&&(s.includes(i.value)?e(`Ordered maps must not include duplicate keys: ${i.value}`):s.push(i.value));return Object.assign(new mt,t)},createNode:(n,e,t)=>mt.from(n,e,t)};function fi({value:n,source:e},t){return e&&(n?hi:mi).test.test(e)?e:n?t.options.trueStr:t.options.falseStr}const hi={identify:n=>n===!0,default:!0,tag:"tag:yaml.org,2002:bool",test:/^(?:Y|y|[Yy]es|YES|[Tt]rue|TRUE|[Oo]n|ON)$/,resolve:()=>new x(!0),stringify:fi},mi={identify:n=>n===!1,default:!0,tag:"tag:yaml.org,2002:bool",test:/^(?:N|n|[Nn]o|NO|[Ff]alse|FALSE|[Oo]ff|OFF)$/,resolve:()=>new x(!1),stringify:fi},Ua={identify:n=>typeof n=="number",default:!0,tag:"tag:yaml.org,2002:float",test:/^(?:[-+]?\.(?:inf|Inf|INF)|\.nan|\.NaN|\.NAN)$/,resolve:n=>n.slice(-3).toLowerCase()==="nan"?NaN:n[0]==="-"?Number.NEGATIVE_INFINITY:Number.POSITIVE_INFINITY,stringify:Be},Da={identify:n=>typeof n=="number",default:!0,tag:"tag:yaml.org,2002:float",format:"EXP",test:/^[-+]?(?:[0-9][0-9_]*)?(?:\.[0-9_]*)?[eE][-+]?[0-9]+$/,resolve:n=>parseFloat(n.replace(/_/g,"")),stringify(n){const e=Number(n.value);return isFinite(e)?e.toExponential():Be(n)}},Ha={identify:n=>typeof n=="number",default:!0,tag:"tag:yaml.org,2002:float",test:/^[-+]?(?:[0-9][0-9_]*)?\.[0-9_]*$/,resolve(n){const e=new x(parseFloat(n.replace(/_/g,""))),t=n.indexOf(".");if(t!==-1){const s=n.substring(t+1).replace(/_/g,"");s[s.length-1]==="0"&&(e.minFractionDigits=s.length)}return e},stringify:Be},Vt=n=>typeof n=="bigint"||Number.isInteger(n);function mn(n,e,t,{intAsBigInt:s}){const i=n[0];if((i==="-"||i==="+")&&(e+=1),n=n.substring(e).replace(/_/g,""),s){switch(t){case 2:n=`0b${n}`;break;case 8:n=`0o${n}`;break;case 16:n=`0x${n}`;break}const r=BigInt(n);return i==="-"?BigInt(-1)*r:r}const a=parseInt(n,t);return i==="-"?-1*a:a}function os(n,e,t){const{value:s}=n;if(Vt(s)){const i=s.toString(e);return s<0?"-"+t+i.substr(1):t+i}return Be(n)}const ja={identify:Vt,default:!0,tag:"tag:yaml.org,2002:int",format:"BIN",test:/^[-+]?0b[0-1_]+$/,resolve:(n,e,t)=>mn(n,2,2,t),stringify:n=>os(n,2,"0b")},qa={identify:Vt,default:!0,tag:"tag:yaml.org,2002:int",format:"OCT",test:/^[-+]?0[0-7_]+$/,resolve:(n,e,t)=>mn(n,1,8,t),stringify:n=>os(n,8,"0")},Ka={identify:Vt,default:!0,tag:"tag:yaml.org,2002:int",test:/^[-+]?[0-9][0-9_]*$/,resolve:(n,e,t)=>mn(n,0,10,t),stringify:Be},Wa={identify:Vt,default:!0,tag:"tag:yaml.org,2002:int",format:"HEX",test:/^[-+]?0x[0-9a-fA-F_]+$/,resolve:(n,e,t)=>mn(n,2,16,t),stringify:n=>os(n,16,"0x")};class pt extends Te{constructor(e){super(e),this.tag=pt.tag}add(e){let t;se(e)?t=e:e&&typeof e=="object"&&"key"in e&&"value"in e&&e.value===null?t=new ye(e.key,null):t=new ye(e,null),et(this.items,t.key)||this.items.push(t)}get(e,t){const s=et(this.items,e);return!t&&se(s)?G(s.key)?s.key.value:s.key:s}set(e,t){if(typeof t!="boolean")throw new Error(`Expected boolean value for set(key, value) in a YAML set, not ${typeof t}`);const s=et(this.items,e);s&&!t?this.items.splice(this.items.indexOf(s),1):!s&&t&&this.items.push(new ye(e))}toJSON(e,t){return super.toJSON(e,t,Set)}toString(e,t,s){if(!e)return JSON.stringify(this);if(this.hasAllNullValues(!0))return super.toString(Object.assign({},e,{allNullValues:!0}),t,s);throw new Error("Set items must all have null values")}static from(e,t,s){const{replacer:i}=s,a=new this(e);if(t&&Symbol.iterator in Object(t))for(let r of t)typeof i=="function"&&(r=i.call(t,r,r)),a.items.push(ts(r,null,s));return a}}pt.tag="tag:yaml.org,2002:set";const ls={collection:"map",identify:n=>n instanceof Set,nodeClass:pt,default:!1,tag:"tag:yaml.org,2002:set",createNode:(n,e,t)=>pt.from(n,e,t),resolve(n,e){if(Ft(n)){if(n.hasAllNullValues(!0))return Object.assign(new pt,n);e("Set items must all have null values")}else e("Expected a mapping for this tag");return n}};function cs(n,e){const t=n[0],s=t==="-"||t==="+"?n.substring(1):n,i=r=>e?BigInt(r):Number(r),a=s.replace(/_/g,"").split(":").reduce((r,o)=>r*i(60)+i(o),i(0));return t==="-"?i(-1)*a:a}function pi(n){let{value:e}=n,t=r=>r;if(typeof e=="bigint")t=r=>BigInt(r);else if(isNaN(e)||!isFinite(e))return Be(n);let s="";e<0&&(s="-",e*=t(-1));const i=t(60),a=[e%i];return e<60?a.unshift(0):(e=(e-a[0])/i,a.unshift(e%i),e>=60&&(e=(e-a[0])/i,a.unshift(e))),s+a.map(r=>String(r).padStart(2,"0")).join(":").replace(/000000\d*$/,"")}const gi={identify:n=>typeof n=="bigint"||Number.isInteger(n),default:!0,tag:"tag:yaml.org,2002:int",format:"TIME",test:/^[-+]?[0-9][0-9_]*(?::[0-5]?[0-9])+$/,resolve:(n,e,{intAsBigInt:t})=>cs(n,t),stringify:pi},yi={identify:n=>typeof n=="number",default:!0,tag:"tag:yaml.org,2002:float",format:"TIME",test:/^[-+]?[0-9][0-9_]*(?::[0-5]?[0-9])+\.[0-9_]*$/,resolve:n=>cs(n,!1),stringify:pi},pn={identify:n=>n instanceof Date,default:!0,tag:"tag:yaml.org,2002:timestamp",test:RegExp("^([0-9]{4})-([0-9]{1,2})-([0-9]{1,2})(?:(?:t|T|[ \\t]+)([0-9]{1,2}):([0-9]{1,2}):([0-9]{1,2}(\\.[0-9]+)?)(?:[ \\t]*(Z|[-+][012]?[0-9](?::[0-9]{2})?))?)?$"),resolve(n){const e=n.match(pn.test);if(!e)throw new Error("!!timestamp expects a date, starting with yyyy-mm-dd");const[,t,s,i,a,r,o]=e.map(Number),l=e[7]?Number((e[7]+"00").substr(1,3)):0;let c=Date.UTC(t,s-1,i,a||0,r||0,o||0,l);const u=e[8];if(u&&u!=="Z"){let d=cs(u,!1);Math.abs(d)<30&&(d*=60),c-=6e4*d}return new Date(c)},stringify:({value:n})=>(n==null?void 0:n.toISOString().replace(/(T00:00:00)?\.000Z$/,""))??""},ks=[vt,_t,dn,fn,hi,mi,ja,qa,Ka,Wa,Ua,Da,Ha,is,qe,rs,as,ls,gi,yi,pn],Es=new Map([["core",Ra],["failsafe",[vt,_t,dn]],["json",Va],["yaml11",ks],["yaml-1.1",ks]]),Ls={binary:is,bool:ns,float:ai,floatExp:ii,floatNaN:si,floatTime:yi,int:li,intHex:ci,intOct:oi,intTime:gi,map:vt,merge:qe,null:fn,omap:rs,pairs:as,seq:_t,set:ls,timestamp:pn},Ya={"tag:yaml.org,2002:binary":is,"tag:yaml.org,2002:merge":qe,"tag:yaml.org,2002:omap":rs,"tag:yaml.org,2002:pairs":as,"tag:yaml.org,2002:set":ls,"tag:yaml.org,2002:timestamp":pn};function Nn(n,e,t){const s=Es.get(e);if(s&&!n)return t&&!s.includes(qe)?s.concat(qe):s.slice();let i=s;if(!i)if(Array.isArray(n))i=[];else{const a=Array.from(Es.keys()).filter(r=>r!=="yaml11").map(r=>JSON.stringify(r)).join(", ");throw new Error(`Unknown schema "${e}"; use one of ${a} or define customTags array`)}if(Array.isArray(n))for(const a of n)i=i.concat(a);else typeof n=="function"&&(i=n(i.slice()));return t&&(i=i.concat(qe)),i.reduce((a,r)=>{const o=typeof r=="string"?Ls[r]:r;if(!o){const l=JSON.stringify(r),c=Object.keys(Ls).map(u=>JSON.stringify(u)).join(", ");throw new Error(`Unknown custom tag ${l}; use one of ${c}`)}return a.includes(o)||a.push(o),a},[])}const Ga=(n,e)=>n.key<e.key?-1:n.key>e.key?1:0;class us{constructor({compat:e,customTags:t,merge:s,resolveKnownTags:i,schema:a,sortMapEntries:r,toStringDefaults:o}){this.compat=Array.isArray(e)?Nn(e,"compat"):e?Nn(null,e):null,this.name=typeof a=="string"&&a||"core",this.knownTags=i?Ya:{},this.tags=Nn(t,this.name,s),this.toStringOptions=o??null,Object.defineProperty(this,ze,{value:vt}),Object.defineProperty(this,De,{value:dn}),Object.defineProperty(this,bt,{value:_t}),this.sortMapEntries=typeof r=="function"?r:r===!0?Ga:null}clone(){const e=Object.create(us.prototype,Object.getOwnPropertyDescriptors(this));return e.tags=this.tags.slice(),e}}function za(n,e){var l;const t=[];let s=e.directives===!0;if(e.directives!==!1&&n.directives){const c=n.directives.toString(n);c?(t.push(c),s=!0):n.directives.docStart&&(s=!0)}s&&t.push("---");const i=Xs(n,e),{commentString:a}=i.options;if(n.commentBefore){t.length!==1&&t.unshift("");const c=a(n.commentBefore);t.unshift(He(c,""))}let r=!1,o=null;if(n.contents){if(ne(n.contents)){if(n.contents.spaceBefore&&s&&t.push(""),n.contents.commentBefore){const d=a(n.contents.commentBefore);t.push(He(d,""))}i.forceBlockIndent=!!n.comment,o=n.contents.comment}const c=o?void 0:()=>r=!0;let u=gt(n.contents,i,()=>o=null,c);o&&(u+=Ze(u,"",a(o))),(u[0]==="|"||u[0]===">")&&t[t.length-1]==="---"?t[t.length-1]=`--- ${u}`:t.push(u)}else t.push(gt(n.contents,i));if((l=n.directives)!=null&&l.docEnd)if(n.comment){const c=a(n.comment);c.includes(`
...
`;for(let h=u;h<o;++h){let[y,S]=r[h];c+=y.length+S.length+1;const w=S[S.length-1]==="\r";if(w&&(S=S.slice(0,-1)),S&&y.length<l){const k=`Block scalar lines must not be less indented than their ${i.indent?"explicit indentation indicator":"first line"}`;t(c-S.length-(w?2:1),"BAD_INDENT",k),y=""}a===x.BLOCK_LITERAL?(d+=p+y.slice(l)+S,p=`
`):y.length>l||S[0]==="	"?(p===" "?p=`
`:!m&&p===`
`&&(p=`
...
`,r:"\r",t:"	",v:"\v",N:"",_:" ",L:"\u2028",P:"\u2029"," ":" ",'"':'"',"/":"/","\\":"\\","	":"	"};function ur(n,e,t,s){const i=n.substr(e,t),r=i.length===t&&/^[0-9a-fA-F]+$/.test(i)?parseInt(i,16):NaN;if(isNaN(r)){const o=n.substr(e-2,t+2);return s(e-2,"BAD_DQ_ESCAPE",`Invalid escape sequence ${o}`),o}return String.fromCodePoint(r)}function _i(n,e,t,s){const{value:i,type:a,comment:r,range:o}=e.type==="block-scalar"?tr(n,e,s):ir(e,n.options.strict,s),l=t?n.directives.tagName(t.source,d=>s(t,"TAG_RESOLVE_FAILED",d)):null;let c;n.options.stringKeys&&n.atKey?c=n.schema[De]:l?c=dr(n.schema,i,l,t,s):e.type==="scalar"?c=fr(n,i,e,s):c=n.schema[De];let u;try{const d=c.resolve(i,p=>s(t??e,"TAG_RESOLVE_FAILED",p),n.options);u=G(d)?d:new x(d)}catch(d){const p=d instanceof Error?d.message:String(d);s(t??e,"TAG_RESOLVE_FAILED",p),u=new x(i)}return u.range=o,u.source=i,a&&(u.type=a),l&&(u.tag=l),c.format&&(u.format=c.format),r&&(u.comment=r),u}function dr(n,e,t,s,i){var o;if(t==="!")return n[De];const a=[];for(const l of n.tags)if(!l.collection&&l.tag===t)if(l.default&&l.test)a.push(l);else return l;for(const l of a)if((o=l.test)!=null&&o.test(e))return l;const r=n.knownTags[t];return r&&!r.collection?(n.tags.push(Object.assign({},r,{default:!1,test:void 0})),r):(i(s,"TAG_RESOLVE_FAILED",`Unresolved tag: ${t}`,t!=="tag:yaml.org,2002:str"),n[De])}function fr({atKey:n,directives:e,schema:t},s,i,a){const r=t.tags.find(o=>{var l;return(o.default===!0||n&&o.default==="key")&&((l=o.test)==null?void 0:l.test(s))})||t[De];if(t.compat){const o=t.compat.find(l=>{var c;return l.default&&((c=l.test)==null?void 0:c.test(s))})??t[De];if(r.tag!==o.tag){const l=e.tagString(r.tag),c=e.tagString(o.tag),u=`Value may be parsed as either ${l} or ${c}`;a(i,"TAG_RESOLVE_FAILED",u,!0)}}return r}function hr(n,e,t){if(e){t??(t=e.length);for(let s=t-1;s>=0;--s){let i=e[s];switch(i.type){case"space":case"comment":case"newline":n-=i.source.length;continue}for(i=e[++s];(i==null?void 0:i.type)==="space";)n+=i.source.length,i=e[++s];break}}return n}const mr={composeNode:Si,composeEmptyNode:ds};function Si(n,e,t,s){const i=n.atKey,{spaceBefore:a,comment:r,anchor:o,tag:l}=t;let c,u=!0;switch(e.type){case"alias":c=pr(n,e,s),(o||l)&&s(e,"ALIAS_PROPS","An alias node must not specify any properties");break;case"scalar":case"single-quoted-scalar":case"double-quoted-scalar":case"block-scalar":c=_i(n,e,l,s),o&&(c.anchor=o.source.substring(1));break;case"block-map":case"block-seq":case"flow-collection":try{c=er(mr,n,e,t,s),o&&(c.anchor=o.source.substring(1))}catch(d){const p=d instanceof Error?d.message:String(d);s(e,"RESOURCE_EXHAUSTION",p)}break;default:{const d=e.type==="error"?e.message:`Unsupported token (type: ${e.type})`;s(e,"UNEXPECTED_TOKEN",d),u=!1}}return c??(c=ds(n,e.offset,void 0,null,t,s)),o&&c.anchor===""&&s(o,"BAD_ALIAS","Anchor cannot be an empty string"),i&&n.options.stringKeys&&(!G(c)||typeof c.value!="string"||c.tag&&c.tag!=="tag:yaml.org,2002:str")&&s(l??e,"NON_STRING_KEY","With stringKeys, all keys must be strings"),a&&(c.spaceBefore=!0),r&&(e.type==="scalar"&&e.source===""?c.comment=r:c.commentBefore=r),n.options.keepSourceTokens&&u&&(c.srcToken=e),c}function ds(n,e,t,s,{spaceBefore:i,comment:a,anchor:r,tag:o,end:l},c){const u={type:"scalar",offset:hr(e,t,s),indent:-1,source:""},d=_i(n,u,o,c);return r&&(d.anchor=r.source.substring(1),d.anchor===""&&c(r,"BAD_ALIAS","Anchor cannot be an empty string")),i&&(d.spaceBefore=!0),a&&(d.comment=a,d.range[2]=l),d}function pr({options:n},{offset:e,source:t,end:s},i){const a=new Zn(t.substring(1));a.source===""&&i(e,"BAD_ALIAS","Alias cannot be an empty string"),a.source.endsWith(":")&&i(e+t.length-1,"BAD_ALIAS","Alias ending in : is ambiguous",!0);const r=e+t.length,o=Ut(s,r,n.strict,i);return a.range=[e,r,o.offset],o.comment&&(a.comment=o.comment),a}function gr(n,e,{offset:t,start:s,value:i,end:a},r){const o=Object.assign({_directives:e},n),l=new gn(void 0,o),c={atKey:!1,atRoot:!0,directives:l.directives,options:l.options,schema:l.schema},u=yt(s,{indicator:"doc-start",next:i??(a==null?void 0:a[0]),offset:t,onError:r,parentIndent:0,startOnNewline:!0});u.found&&(l.directives.docStart=!0,i&&(i.type==="block-map"||i.type==="block-seq")&&!u.hasNewline&&r(u.end,"MISSING_CHAR","Block collection cannot start on same line with directives-end marker")),l.contents=i?Si(c,i,u,r):ds(c,u.end,s,null,u,r);const d=l.contents.range[2],p=Ut(a,d,!1,r);return p.comment&&(l.comment=p.comment),l.range=[t,d,p.offset],l}function Nt(n){if(typeof n=="number")return[n,n+1];if(Array.isArray(n))return n.length===2?n:[n[0],n[1]];const{offset:e,source:t}=n;return[e,e+(typeof t=="string"?t.length:1)]}function Cs(n){var i;let e="",t=!1,s=!1;for(let a=0;a<n.length;++a){const r=n[a];switch(r[0]){case"#":e+=(e===""?"":s?`

`:`
`)+(r.substring(1)||" "),t=!0,s=!1;break;case"%":((i=n[a+1])==null?void 0:i[0])!=="#"&&(a+=1),t=!1;break;default:t||(s=!0),t=!1}}return{comment:e,afterEmptyLine:s}}class yr{constructor(e={}){this.doc=null,this.atDirectives=!1,this.prelude=[],this.errors=[],this.warnings=[],this.onError=(t,s,i,a)=>{const r=Nt(t);a?this.warnings.push(new Ja(r,s,i)):this.errors.push(new Tt(r,s,i))},this.directives=new ge({version:e.version||"1.2"}),this.options=e}decorate(e,t){const{comment:s,afterEmptyLine:i}=Cs(this.prelude);if(s){const a=e.contents;if(t)e.comment=e.comment?`${e.comment}
${s}`:s;else if(i||e.directives.docStart||!a)e.commentBefore=s;else if(te(a)&&!a.flow&&a.items.length>0){let r=a.items[0];se(r)&&(r=r.key);const o=r.commentBefore;r.commentBefore=o?`${s}
...
${t.comment}`:t.comment}this.doc.range[2]=t.offset;break}default:this.errors.push(new Tt(Nt(e),"UNEXPECTED_TOKEN",`Unsupported token ${e.type}`))}}*end(e=!1,t=-1){if(this.doc)this.decorate(this.doc,!0),yield this.doc,this.doc=null;else if(e){const s=Object.assign({_directives:this.directives},this.options),i=new gn(void 0,s);this.atDirectives&&this.onError(t,"MISSING_CHAR","Missing directives-end indicator line"),i.range=[0,t,t],this.decorate(i,!1),yield i}}}const ki="\uFEFF",Ei="",Li="",Yn="";function br(n){switch(n){case ki:return"byte-order-mark";case Ei:return"doc-mode";case Li:return"flow-error-end";case Yn:return"scalar";case"---":return"doc-start";case"...":return"doc-end";case"":case`
`:case`\r
...
`:case"\r":case"	":return!0;default:return!1}}const As=new Set("0123456789ABCDEFabcdef"),wr=new Set("0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-#;/?:@&=+$_.!~*'()"),Yt=new Set(",[]{}"),vr=new Set(` ,[]{}
\r	`),Tn=n=>!n||vr.has(n);class _r{constructor(){this.atEnd=!1,this.blockScalarIndent=-1,this.blockScalarKeep=!1,this.buffer="",this.flowKey=!1,this.flowLevel=0,this.indentNext=0,this.indentValue=0,this.lineEndPos=null,this.next=null,this.pos=0}*lex(e,t=!1){if(e){if(typeof e!="string")throw TypeError("source is not a string");this.buffer=this.buffer?this.buffer+e:e,this.lineEndPos=null}this.atEnd=!t;let s=this.next??"stream";for(;s&&(t||this.hasChars(1));)s=yield*this.parseNext(s)}atLineEnd(){let e=this.pos,t=this.buffer[e];for(;t===" "||t==="	";)t=this.buffer[++e];return!t||t==="#"||t===`
...
planetary:
  ...
  views:
    - id: houdini
      ...
      icon: icon_houdini
      description: View the data of your simulated impact, rendered in 3D perspective, as rock and iron material gets pushed and shocked by immense pressure, and pulled and disrupted by strong gravity.  \\n\\nThe colour, glow, and opacity of the visualised material are set directly by the simulation data.  Although, if we could see a real impact this close up, there would be a lot more thick dust that blocks the view than shown here.
    - id: material
      label: Material
      icon: icon_material
    ...
    - id: temperature
      ...
      description: See how hot a planet gets when shocked and rocked by a giant impact, with a cut-away view of your impact simulation, with the material coloured to show the temperature.  \\n\\nThe main panel shows a top-down view, with a zoomed-out panel in the upper left.  The lower left panel shows a side-on view.
    - id: pressure
      label: Pressure
      icon: icon_pressure
      description: Inspect the collosal pressures reached inside a planet and how the shock wave travels through from a giant impact, with a cut-away view of your impact simulation, with the material coloured to show the pressure.  \\n\\nThe main panel shows a top-down view, with a zoomed-out panel in the upper left.  The lower left panel shows a side-on view.
...
`,Ir=`# Parameter definitions for each simulation family.
#
...
cosmos:
  ...
  gravity_strength:
    ...
    log_scale: true
    primary: true
`,Cr=`# Summary overlay display configuration for each simulation family.
#
...
cosmos:
  liveStats:
    ...
    - id: g_updates_total
      ...
      live: true
      integer: true
`;function Z(n){if(/^[a-z]+:\/\//i.test(n)||n.startsWith("data:")||n.startsWith("blob:"))return n;const e="/engine/",t=e.endsWith("/")?e:`${e}/`,s=n.startsWith("/")?n.slice(1):n;return`${t}${s}`}function Ii(n,e,t){const s=n.indexOf("#"),i=s>=0?n.slice(0,s):n,a=s>=0?n.slice(s):"",r=new RegExp(`([?&])${Tr(e)}=[^&#]*`);if(r.test(i))return`${i.replace(r,`$1${e}=${encodeURIComponent(t)}`)}${a}`;const o=i.includes("?")?"&":"?";return`${i}${o}${e}=${encodeURIComponent(t)}${a}`}function Tr(n){return n.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}const Mr=Ke(Nr),Or=Ke(Ir),Mn=Ke(Cr),Pr=Ke(Ar),lt=Object.entries(Mr).map(([n,e])=>{var r,o,l;const t=xr(Mn[n]),s=(((r=Mn[n])==null?void 0:r.results)??[]).map($r),i=((o=Pr[n])==null?void 0:o.liveStats)??[],a=Or[n]??{};return{id:n,label:e.label,placeholderImage:Z(e.placeholderImage),parameterSubtitle:e.parameterSubtitle,metadata:{results:s,summaryStats:t.map(Gn),liveStats:i.map(Gn),morphologyChecklist:(l=Mn[n])==null?void 0:l.morphologyChecklist},parameters:Object.entries(a).map(([c,u])=>{const d=u.quali_labels,p=d!==void 0&&d.length>0,m=p?0:u.min,b=p?d.length-1:u.max,h=p?1:u.step??Rr(u.min,u.max),y=p?Math.floor(d.length/2):u.log_scale?Math.sqrt(u.min*u.max):Fr(u.min,u.max);return{id:c,label:u.label,unit:u.unit??"",min:m,max:b,step:h,fallbackValue:y,description:u.description,valueScale:u.value_scale,displayUnit:u.display_unit,displayFormat:u.display_format,displaySignificantFigures:u.display_significant_figures,logScale:u.log_scale,qualiLabels:d,primary:u.primary??!0}}),views:(e.views??[]).map(c=>({id:c.id,label:c.label,icon:c.icon,audio:c.audio??!1,description:c.description}))}});function xr(n){if(!n)return[];const e=[];for(const t of n.resources??[])e.push({...t,section:"resources"});for(const t of n.simulationStats??[])e.push({...t,section:"simulationStats"});return n.similarityScore&&e.push({id:"similarityScore",value:n.similarityScore.value}),e}function Gn(n){return{id:n.id,label:n.label,section:n.section,value:n.value,unit:n.unit,description:n.description,live:n.live??!1,liveKey:n.live_key,fromVideo:n.from_video??!1,videoKey:n.video_key,scaleWithTime:n.scale_with_time??!1,integer:n.integer??!1,valueScale:n.value_scale,displayFormat:n.display_format,precision:n.precision}}function $r(n){return{...Gn(n),target:n.target}}function Rr(n,e){const s=Math.max(e-n,1e-9)/100,i=10**Math.floor(Math.log10(s)),a=s/i;let r=1;return a<=1?r=1:a<=2?r=2:a<=5?r=5:r=10,r*i}function Fr(n,e){return n+(e-n)/2}const Ci="universe-engine-theme",Ai=[{id:"glass",label:"Glass",icon:"[ ]"},{id:"matrix",label:"Matrix",icon:"[#]"},{id:"hal",label:"HAL 9000",icon:"( )"},{id:"nostromo",label:"Nostromo",icon:"[=]"},{id:"tron",label:"Tron",icon:"<>"}];function Br(){const n=localStorage.getItem(Ci);return Ur(n)?n:"glass"}function On(n){document.documentElement.setAttribute("data-theme",n),localStorage.setItem(Ci,n)}function Vr(n,e,t){const s=document.createElement("div");s.className="theme-picker";const i=new Map;for(const r of Ai){const o=document.createElement("button");o.className="theme-picker__option",o.type="button",o.innerHTML=`
      <span class="theme-picker__icon">${r.icon}</span>
      <span class="theme-picker__label">${r.label}</span>
    `,o.addEventListener("click",()=>{a(r.id),t(r.id)}),s.appendChild(o),i.set(r.id,o)}n.appendChild(s),a(e);function a(r){for(const[o,l]of i.entries()){const c=o===r;l.classList.toggle("active",c),l.setAttribute("aria-pressed",String(c))}}return{setActive:a}}function Ur(n){return Ai.some(e=>e.id===n)}let de=null,Re="primary";function Dr(n,e=null){de={primaryBase:n.replace(/\/+$/,""),backupBase:e?e.replace(/\/+$/,""):null}}function Hr(){de=null,Re="primary"}function jr(n){Re=n}function qr(n){return n==="local"?{mode:"local",base:null}:de?{mode:Re,base:Ti()}:{mode:"primary",base:null}}function Ue(n){if(!de)return n;const e=Ti();if(!e)return n;if(/^https?:\/\//i.test(n)){const t=new URL(n);return!Ps(t,de.primaryBase)&&(!de.backupBase||!Ps(t,de.backupBase))?n:xs(e,`${t.pathname}${t.search}${t.hash}`)}return xs(e,n)}async function Ge(n,e){const t=Ue(n),s=!!(de!=null&&de.backupBase)&&Re==="primary";try{const i=await fetch(t,e);if(i.ok||!s)return i;const a=await Os(n,e);return a.ok&&(Re="backup"),a}catch(i){if(!s)throw i;const a=await Os(n,e);return a.ok&&(Re="backup"),a}}function Ti(){return de?Re==="backup"&&de.backupBase?de.backupBase:de.primaryBase:null}async function Os(n,e){if(!(de!=null&&de.backupBase))throw new Error("Backup asset host is not configured.");const t=Re;Re="backup";try{const s=await fetch(Ue(n),e);return s.ok||(Re=t),s}catch(s){throw Re=t,s}}function Ps(n,e){const t=new URL(e);return n.origin===t.origin}function xs(n,e){return`${n}${e.startsWith("/")?"":"/"}${e}`}function Kr(n,e){const t=document.createElement("div");t.className="viewport";const s=document.createElement("video");s.className="viewport__media is-empty",s.src=e,s.loop=!1,s.muted=!0,s.playsInline=!0,s.preload="auto",s.setAttribute("aria-label","Simulation output"),t.appendChild(s),n.appendChild(t);let i,a,r,o=new Set,l=!1;const c=new Map,u=new Map,d=new Map;let p=null,m=null;const b=document.createElement("canvas"),h=b.getContext("2d");s.addEventListener("play",()=>r==null?void 0:r(!1)),s.addEventListener("pause",()=>r==null?void 0:r(!0)),s.addEventListener("ended",()=>r==null?void 0:r(!0)),s.addEventListener("timeupdate",()=>{!i||!Number.isFinite(s.duration)||s.duration<=0||i(s.currentTime/s.duration)}),s.addEventListener("ended",()=>{a==null||a()});let y=s.playbackRate;function S(){p&&(URL.revokeObjectURL(p),p=null)}function w(I,M={}){const U=u.get(I);U&&(u.delete(I),M={...M,ownedObjectUrl:!0},I=U),s.classList.add("fade-out"),window.setTimeout(()=>{if(s.src.endsWith(I)){s.classList.remove("fade-out");return}const V=s.muted,B=M.seekFraction;S(),m=null,p=M.ownedObjectUrl?I:null,s.src=I,s.load(),s.onloadeddata=()=>{if(s.muted=V,B!==void 0&&Number.isFinite(s.duration)&&s.duration>0){const ue=Math.max(0,Math.min(.999,B));s.currentTime=ue*s.duration}else s.currentTime=0;s.playbackRate=y,s.classList.remove("fade-out"),M.autoplay&&s.play().catch(()=>{})}},120)}function L(I){s.muted=I}async function k(){await s.play()}function g(){s.pause()}function v(){s.classList.add("is-empty")}function N(){s.classList.remove("is-empty")}function E(I){if(!Number.isFinite(s.duration)||s.duration<=0)return;const M=Math.max(0,Math.min(1,I));s.currentTime=M*s.duration}function T(){s.currentTime=0,i==null||i(0)}function R(I=8e3){return s.readyState>=HTMLMediaElement.HAVE_CURRENT_DATA?Promise.resolve():new Promise(M=>{const U=()=>{B(),M()},V=window.setTimeout(()=>{B(),M()},Math.max(0,I));function B(){window.clearTimeout(V),s.removeEventListener("loadeddata",U)}s.addEventListener("loadeddata",U,{once:!0})})}function $(I,M=8e3){const U=Math.max(0,I);return U===0||F(U)?Promise.resolve():new Promise(V=>{const B=()=>{F(U)&&(D(),V())},ue=window.setTimeout(()=>{D(),V()},Math.max(0,M));function D(){window.clearTimeout(ue),s.removeEventListener("progress",B),s.removeEventListener("canplay",B),s.removeEventListener("loadeddata",B)}s.addEventListener("progress",B),s.addEventListener("canplay",B),s.addEventListener("loadeddata",B),B()})}function F(I){const M=s.currentTime;for(let U=0;U<s.buffered.length;U+=1){const V=s.buffered.start(U),B=s.buffered.end(U);if(!(M<V||M>B))return B-M>=I}return!1}function j(I){o=new Set(I.filter(Boolean).filter(M=>M!==s.currentSrc)),l||q()}function z(){l=!0,X(),be()}function Y(){if(!l){q();return}l=!1,q()}function q(){for(const[I,M]of c.entries())o.has(I)||(M.removeAttribute("src"),M.load(),c.delete(I));for(const[I,M]of d.entries())o.has(I)||(M.abort(),d.delete(I));for(const I of o){if(!c.has(I)){const M=document.createElement("video");M.preload="auto",M.muted=!0,M.playsInline=!0,M.src=Ue(I),M.load(),c.set(I,M)}u.has(I)||d.has(I)||Se(I)}}function X(){for(const I of c.values())I.removeAttribute("src"),I.load();c.clear()}function be(){for(const I of d.values())I.abort();d.clear()}function Se(I){const M=new AbortController;d.set(I,M);const U=Ii(I,"_",`${Date.now()}`);Ge(U,{signal:M.signal}).then(async V=>{if(!V.ok)return;const B=await V.blob();o.has(I)&&u.set(I,URL.createObjectURL(B))}).catch(V=>{V instanceof DOMException&&V.name}).finally(()=>{d.get(I)===M&&d.delete(I)})}function ce(){o.clear(),l=!1,X(),be();for(const I of u.values())URL.revokeObjectURL(I);u.clear()}function ie(I){return u.get(I)??null}function we(){!h||s.readyState<2||s.videoWidth===0||s.videoHeight===0||(b.width=s.videoWidth,b.height=s.videoHeight,h.drawImage(s,0,0,b.width,b.height),m=b.toDataURL("image/jpeg",.85))}function fe(){return we(),m}function ke(I){i=I}function J(I){a=I}return{setSource:w,setMuted:L,play:k,pause:g,hideMedia:v,showMedia:N,seekToFraction:E,resetPlayback:T,waitForLoadedData:R,waitForBufferedAhead:$,onTimeUpdate:ke,onEnded:J,getDurationSeconds:()=>Number.isFinite(s.duration)?s.duration:0,getPlaybackFraction:()=>!Number.isFinite(s.duration)||s.duration<=0?0:s.currentTime/s.duration,isPaused:()=>s.paused,setPlaybackRate:I=>{y=I,s.playbackRate=I},getPlaybackRate:()=>y,onPlayStateChange:I=>{r=I},getElement:()=>t,prewarmSources:j,suspendPrewarming:z,resumePrewarming:Y,clearPrewarmedSources:ce,getPrewarmedBlobUrl:ie,captureFrame:fe}}const Wr=[.25,.5,1,2];function Yr(n,e={}){const{onChange:t,onTogglePlay:s,onSpeedChange:i,onSummaryClick:a,onAudioToggle:r,onScrubStart:o,onScrubEnd:l,initialSpeed:c=1}=e,u=document.createElement("div");u.className="timeline";const d=document.createElement("div");d.className="timeline__bar-row";const p=document.createElement("div");p.className="timeline__audio is-hidden";const m=document.createElement("button");m.className="timeline__audio-btn",m.type="button",m.setAttribute("aria-label","Toggle audio mute"),m.innerHTML=Gr(),m.addEventListener("click",()=>r==null?void 0:r()),p.appendChild(m);const b=document.createElement("button");b.className="timeline__play-btn",b.type="button",b.setAttribute("aria-label","Toggle playback"),b.addEventListener("click",()=>s==null?void 0:s());const h=document.createElement("input");h.className="timeline__slider",h.type="range",h.min="0",h.max="1000",h.step="1",h.value="0",h.style.setProperty("--fill","0%"),h.setAttribute("aria-label","Simulation time");const y=document.createElement("div");y.className="timeline__speed";const S=document.createElement("button");S.className="timeline__speed-btn",S.type="button",S.setAttribute("aria-label","Playback speed"),S.addEventListener("click",()=>{y.classList.toggle("open")});const w=document.createElement("div");w.className="timeline__speed-menu";for(const g of Wr){const v=document.createElement("button");v.className="timeline__speed-option",v.type="button",v.textContent=Pn(g),v.addEventListener("click",()=>{y.classList.remove("open"),i==null||i(g)}),w.appendChild(v)}y.appendChild(S),y.appendChild(w);const L=document.createElement("button");return L.className="timeline__summary-btn",L.type="button",L.setAttribute("aria-label","View run summary"),L.textContent="ⓘ",L.addEventListener("click",()=>a==null?void 0:a()),d.appendChild(p),d.appendChild(b),d.appendChild(h),d.appendChild(y),d.appendChild(L),h.addEventListener("input",()=>{const g=parseInt(h.value,10)/1e3;h.style.setProperty("--fill",`${g*100}%`),t==null||t(g)}),h.addEventListener("pointerdown",()=>o==null?void 0:o()),h.addEventListener("pointerup",()=>l==null?void 0:l()),h.addEventListener("change",()=>l==null?void 0:l()),document.addEventListener("click",g=>{y.contains(g.target)||y.classList.remove("open")}),u.appendChild(d),n.appendChild(u),k(c),{setPosition(g){const v=Math.max(0,Math.min(1,g));h.value=String(Math.round(v*1e3)),h.style.setProperty("--fill",`${v*100}%`)},setPlaying(g){b.textContent=g?"⏸":"▶",b.classList.toggle("is-paused",!g),b.setAttribute("aria-label",g?"Pause":"Play")},setSpeed(g){k(g)},setAudioVisible(g){p.hidden=!g,p.classList.toggle("is-hidden",!g)},setMuted(g){m.classList.toggle("is-muted",g),m.setAttribute("aria-label",g?"Unmute audio":"Mute audio")}};function k(g){S.textContent=Pn(g);for(const v of w.children)v.classList.toggle("is-active",v.textContent===Pn(g))}}function Pn(n){return`x${n}`}function Gr(){return`
    ...
    </svg>`}function zr(n,e){const t=Math.min(Mi(e),2);return n.toFixed(t)}function Fe(n,e){return e?`${n} ${e}`:n}function $t(n){const e=Math.abs(n),t=n<0?"−":"";return Number.isFinite(n)?e<1e3?It(n):e<1e6?`${t}${It(n/1e3)}k`:e<1e9?`${t}${It(n/1e6)}M`:e<1e12?`${t}${It(n/1e9)}B`:`${t}${It(n/1e12)}T`:String(n)}function It(n){return n.toFixed(1).replace(new RegExp("\\.0+$|(?<=\\..*?)0+$","g"),"").replace(/\.$/,"")}function Jr(n,e={}){const t=n.trim();if(t.length===0)return n;const s=Number(t);if(!Number.isFinite(s))return n;const i=s*(e.scale??1);return e.integer?Math.max(0,Math.round(i)).toLocaleString(void 0):i.toFixed(2).replace(new RegExp("\\.0+$|(?<=\\..*?)0+$","g"),"").replace(/\.$/,"")}function sn(n,e={}){const t=n.trim();if(t.length===0)return n;const s=Number(t);if(!Number.isFinite(s))return n;const i=e.mode??"float",a=s*(e.scale??1);if(i==="integer")return Math.round(a).toLocaleString(void 0);if(i==="scientific"||i==="compact")return $t(a);const r=Math.max(0,e.precision??2);return a.toFixed(r).replace(new RegExp("\\.0+$|(?<=\\..*?)0+$","g"),"").replace(/\.$/,"")}function ht(n,e,t={}){const s=t.scale??1,i=n*s,a=e*s;return t.format==="qualitative"?String(Math.round(n)):t.format==="compact"||t.format==="scientific"?$t(i):zr(i,a)}function Mi(n){const e=String(n),t=e.indexOf(".");return t===-1?0:e.length-t-1}function Qr(n){const e=document.createElement("aside");e.className="data-panel";const t=document.createElement("div");return t.className="data-panel__metrics",e.appendChild(t),n.appendChild(e),{update(s,i,a={}){t.innerHTML="";const r=Xr(s,i,a);for(const o of s.metadata.liveStats){const l=eo(o,r),c=document.createElement("div");c.className="data-panel__metric",c.innerHTML=`
          <span class="data-panel__metric-label">${l.label}</span>
          <span class="data-panel__metric-value">${l.value}</span>
        `,t.appendChild(c)}}}}function Xr(n,e,t){const s=Object.fromEntries(n.parameters.map(a=>[a.id,{label:a.label,value:a.displayFormat==="qualitative"&&a.qualiLabels?a.qualiLabels[Math.round(e[a.id]??a.fallbackValue)]??"--":ht(e[a.id]??a.fallbackValue,a.step,{scale:a.valueScale,format:a.displayFormat,significantFigures:a.displaySignificantFigures})}])),i={scale:{label:"Scale",value:n.label},parameters:{label:"Parameters",value:String(n.parameters.length)}};return{...s,...i,...Object.fromEntries(Object.entries(t).map(([a,r])=>[a,{label:Zr(a),value:r}]))}}function Zr(n){return n.replace(/_/g," ").replace(/([a-z0-9])([A-Z])/g,"$1 $2")}function eo(n,e){const t=e[n.id]??{label:n.id,value:"--"},s=n.liveKey??n.id,i=e[s],a=to((i==null?void 0:i.value)??t.value??"--",n,!!i);return{label:n.label??(i==null?void 0:i.label)??t.label,value:Fe(a,n.unit)}}function to(n,e,t){if(n==="--")return n;const s=Number(n);if(!Number.isFinite(s))return n;const i=e.valueScale??1,a=s*i;return t?e.integer?$t(Math.round(a)):$t(a):e.integer?Math.max(0,Math.round(a)).toLocaleString(void 0):Jr(n,{integer:e.integer})}function no(){const n=Z("assets/2-McAlpine.webp"),e=document.createElement("div"),t=document.createElement("button");t.className="view-switcher__info entry-overlay__info-button",t.type="button",t.setAttribute("aria-label","About this experience"),t.appendChild(io()),e.className="sci-modal is-hidden",e.innerHTML=`
  ...
  `;const o=document.createElement("div");o.className="entry-overlay__actions";function l(p){o.innerHTML="";for(const m of p){const b=document.createElement("button");b.className="entry-overlay__button",b.type="button";const h=ao[m.id]??"Explore this simulation scale.";b.innerHTML=`
        <span class="entry-overlay__button-label">${m.label}</span>
        <span class="entry-overlay__button-description">${h}</span>
      `,b.addEventListener("click",()=>t(m)),o.appendChild(b)}}l(e);const{infoButton:c,infoModal:u,close:d}=no();return r.appendChild(o),a.appendChild(r),a.appendChild(c),a.appendChild(u),n.appendChild(a),{show(){a.hidden=!1,a.classList.remove("is-hidden")},hide(){d(),a.hidden=!0,a.classList.add("is-hidden")},setSimulationClasses(p){l(p)}}}function oo(n,e,t,s){const i=Object.fromEntries(n.metadata.results.map(k=>[k.id,k.target])),a=n.metadata.results.map(k=>{const g=$n(n,e,s,k.id);return g===null?null:{id:k.id,value:g,target:k.target}}).filter(k=>k!==null),r=n.parameters.filter(k=>i[k.id]!==void 0).map(k=>{const g=e[k.id]??k.fallbackValue,v=i[k.id]??k.fallbackValue;return Math.abs(g-v)/Math.max(k.max-k.min,1e-9)}),o=r.reduce((k,g)=>k+g,0)/Math.max(r.length,1),l=uo(a),c=((s==null?void 0:s.carbonBurnt)??.8+o*4.2).toFixed(2),u=(s==null?void 0:s.computeUsed)??18+o*46,d=(s==null?void 0:s.memoryUsed)??12+o*84,p=`${xn(u,1)} CPU-hrs
${xn(d,1)} GB`,m=String(n.parameters.length),b=`${(o*100).toFixed(1)}%`,h=String(n.parameters.length+6),y="Present",S=co((s==null?void 0:s.wallclockSeconds)??t),w=$s(Rs($n(n,e,s,"moon_iron"))),L=$s(Rs($n(n,e,s,"proto_earth_in_moon")));return{scale:{label:"Scale",value:n.label},parameters:{label:"Parameters",value:m},runtime:{label:"Total Runtime",value:S},similarityScore:{label:"Similarity Score",value:`${l}/100`},bestFitDelta:{label:"Best-Fit Delta",value:b},carbonBurnt:{label:"Carbon Burnt",value:c},computeUsed:{label:"Compute Used",value:p},memoryUsed:{label:"Memory Used",value:xn(d,1)},particlesUpdated:{label:"Particle updates",value:s?lo(s.particlesUpdated):"--"},moon_iron_percent:{label:"Iron in Moon",value:w},proto_earth_in_moon_percent:{label:"Proto-Earth in Moon",value:L},audioTrack:{label:"Audio Track",value:y},terminalLines:{label:"Terminal Lines",value:h},...Object.fromEntries(Object.entries((s==null?void 0:s.summaryMetrics)??{}).map(([k,g])=>[k,{label:g.label,value:g.value}]))}}function lo(n){return String(Math.max(0,n))}function co(n){return(Math.max(0,n)/3600).toFixed(2).replace(new RegExp("\\.0+$|(?<=\\..*?)0+$","g"),"").replace(/\.$/,"")}function xn(n,e){return n.toFixed(e).replace(new RegExp("\\.0+$|(?<=\\..*?)0+$","g"),"").replace(/\.$/,"")}function $n(n,e,t,s){var o;const i=n.parameters.find(l=>l.id===s);if(i)return e[s]??i.fallbackValue;const a=(o=t==null?void 0:t.summaryMetrics[s])==null?void 0:o.value;if(a!==void 0){const l=Number(a);if(Number.isFinite(l))return l}const r=t==null?void 0:t.parameterValues[s];return typeof r=="number"&&Number.isFinite(r)?r:null}function $s(n){return n===null?"--":n.toFixed(1)}function Rs(n){return n===null?null:Math.max(0,(1-Math.abs(n-1))*100)}function uo(n){if(n.length===0)return 0;const e=n.reduce((t,s)=>t+Math.max(0,1-Math.abs(s.value/Math.max(s.target,1e-9)-1)),0);return Math.round(e/n.length*100)}const zn={TYPING_MS_PER_CHAR:3.5,MIN_TERMINAL_TIME_MS:3e3,FINAL_PAUSE_MS:500},fo={HIDE_AFTER_MS:980},Oi="https://media.universemakers.org/engine/run-manifest.json",Rn="https://pub-e00201311979473b8a30e279dcc56838.r2.dev/engine/run-manifest.json",ho="https://universe-engine.universe-engine.workers.dev/api/track-run",mo=`# Target messages for scientific bar detail popups, shown when a bar is tapped.
...
`,Fs=(()=>{const n=Ke(mo),e={};for(const t of Object.values(n))for(const[s,i]of Object.entries(t))e[s]=i;return e})(),an="#4CD98A",Jn="#E8951C",Pi="#D7372A",xi=.2,$i=.5,Bs=2;function Ri(n){const e=Math.abs(n-1);return e<=xi?{word:"On target",colour:an}:e<=$i?{word:n>1?"Too high":"Too low",colour:Jn}:{word:n>1?"Way too high":"Way too low",colour:Pi}}function po(n){const e=Math.abs(n-1),t=n>=1;return e<=xi?t?"greenHigh":"greenLow":e<=$i?t?"amberHigh":"amberLow":t?"redHigh":"redLow"}function go(n){return Math.min(Math.max(n,0),Bs)/Bs*100}function yo(n){return n>=85?{word:"Almost perfect",colour:an}:n>=65?{word:"Really close",colour:an}:n>=45?{word:"Getting there",colour:Jn}:n>=25?{word:"Not quite",colour:Jn}:{word:"Way off - try again",colour:Pi}}function bo(n,e,t){var r,o;const s=po(t),i=((r=Fs[n])==null?void 0:r[s])??((o=Fs[e])==null?void 0:o[s]);return i||(Ri(t).colour===an?`${e} is very close to the target value for this simulation.`:t<1?`${e} is below the target value for this simulation.`:`${e} is above the target value for this simulation.`)}function wo(n,e,t){return n.metadata.results.map(s=>{const i=vo(s,n,e,t);if(i===null)return null;const a=i/Math.max(s.target,1e-9),r=_o(s,n,t),o=bo(s.id,r,a),l=Fe(Fi(String(i),s),s.unit);return{id:s.id,label:r,value:a,rawValue:i,formattedValue:l,detail:o}}).filter(s=>s!==null)}function vo(n,e,t,s){var l;const i=n.id,a=e.parameters.find(c=>c.id===i);if(a)return t[i]??a.fallbackValue;const r=So((l=s==null?void 0:s.summaryMetrics[i])==null?void 0:l.value);if(r!==null)return r;const o=s==null?void 0:s.parameterValues[i];return typeof o=="number"&&Number.isFinite(o)?o:null}function _o(n,e,t){var i,a;const s=n.id;return n.label??((i=e.parameters.find(r=>r.id===s))==null?void 0:i.label)??((a=t==null?void 0:t.summaryMetrics[s])==null?void 0:a.label)??s}function So(n){if(n===void 0)return null;const e=Number(n);return Number.isFinite(e)?e:null}function ko(n){if(n.length===0)return 0;const e=n.reduce((t,s)=>t+Math.max(0,1-Math.abs(s.value-1)),0);return Math.round(e/n.length*100)}function Eo(n,e){const t=document.createElement("section");t.className="overlay overlay--summary",t.hidden=!0,t.classList.add("is-hidden");let s;const i=document.createElement("div");i.className="summary-overlay";const a=document.createElement("div"),r=document.createElement("div");a.className="summary-overlay__header",r.className="summary-overlay__content";const o=document.createElement("p");o.className="summary-overlay__title",o.textContent="Run Summary";const l=document.createElement("p");l.className="summary-overlay__hint",l.textContent="Select any card for more details",a.appendChild(o),a.appendChild(l);const c=document.createElement("div");c.className="summary-overlay__actions";const u=document.createElement("button");u.className="summary-overlay__button",u.type="button",u.textContent="Continue Visualising";const d=document.createElement("button"),p=document.createElement("button");d.className="summary-overlay__button summary-overlay__button--primary",d.type="button",d.textContent="New Parameters",p.className="summary-overlay__button",p.type="button",p.textContent="Home",p.hidden=!e.showHome,u.addEventListener("click",e.onReplay),d.addEventListener("click",e.onParameters),p.addEventListener("click",e.onHome),c.appendChild(d),c.appendChild(u),c.appendChild(p),i.appendChild(a),i.appendChild(r),i.appendChild(c),t.appendChild(i);const m=document.createElement("div");m.className="sci-modal is-hidden",m.innerHTML=`
  ...
  `,t.appendChild(m),n.appendChild(t);const b=m.querySelector(".sci-modal__title"),h=m.querySelector(".sci-modal__verdict"),y=m.querySelector(".sci-modal__body"),S=m.querySelector(".sci-modal__close"),w=new Set;let L=!1;function k(E){const T=Ri(E.value);b.textContent=E.label,h.textContent=T.word,h.style.color=T.colour,h.hidden=!1,y.textContent=E.detail,m.classList.remove("is-hidden")}function g(E,T){b.textContent=E,h.hidden=!0,y.textContent=T,m.classList.remove("is-hidden")}function v(){m.classList.add("is-hidden")}S.addEventListener("click",v),m.addEventListener("click",E=>{E.target===m&&v()}),t.addEventListener("click",E=>{E.target===t&&e.onReplay()});function N(E,T){const R=document.createElement("div");R.className=`${E.className} panel`,R.innerHTML=`<p class="sci-section__title">${E.title}</p>`;const $=document.createElement("div"),F=E.singleRow?Math.max(1,E.stats.length):Math.max(1,Math.min(E.stats.length,E.maxColumns));$.className="metric-grid",E.singleRow&&$.classList.add("metric-grid--single-row"),$.style.setProperty("--summary-grid-columns",String(F)),$.style.setProperty("--summary-grid-max-width",`${E.maxWidthRem}rem`);for(const j of E.stats){const z=Lo(j,T),Y=document.createElement("div"),q=document.createElement("span"),X=document.createElement("span");Y.className="res-card",q.className="res-card__label",q.textContent=z.label,X.className="res-card__value",X.textContent=z.value,Y.appendChild(q),Y.appendChild(X),j.description&&(Y.classList.add("res-card--has-info"),Y.addEventListener("click",()=>{g(z.label,j.description)})),$.appendChild(Y)}return R.appendChild($),R}return{show(){s&&(window.clearTimeout(s),s=void 0),t.hidden=!1,t.classList.remove("is-hidden"),t.classList.remove("is-visible"),t.offsetWidth,requestAnimationFrame(()=>{t.classList.add("is-visible")})},hide(){t.classList.remove("is-visible"),s=window.setTimeout(()=>{t.hidden=!0,t.classList.add("is-hidden"),s=void 0,L&&(w.clear(),L=!1)},fo.HIDE_AFTER_MS)},setHomeVisible(E){p.hidden=!E},update(E,T,R,$,F){var I,M,U,V,B,ue;r.innerHTML="",v();const j=oo(E,T,R,$),z=E.metadata.summaryStats,Y=wo(E,T,$),q=new Set(Y.map(D=>D.id));let X;if(Y.length>0)X=ko(Y);else{const D=((I=j.similarityScore)==null?void 0:I.value)??"0/100";X=parseInt(D,10)||0}const be=yo(X),Se=document.createElement("div"),ce=document.createElement("div"),ie=document.createElement("div");Se.className="sci-top",ce.className="summary-main-column",ie.className="summary-side-column";const we=document.createElement("div");we.className="sci-hero panel",F?(we.classList.add("sci-hero--thumbnail"),we.innerHTML=`<img class="sci-hero__thumbnail" src="${F}" alt="Final frame of simulation" />`):we.innerHTML=`
        ...
        `,ce.appendChild(we);const fe=z.filter(D=>(D.section??"resources")==="resources"&&!Y.some(ae=>ae.id===String(D.id))&&D.id!=="similarityScore"),ke=z.filter(D=>D.section==="simulationStats"&&!q.has(String(D.id)));fe.length>0&&ie.appendChild(N({title:"Resources Used",className:"res-section",stats:fe,maxColumns:3,maxWidthRem:48},j)),ke.length>0&&ie.appendChild(N({title:"Simulation Stats",className:"res-section",stats:ke,maxColumns:ke.length,maxWidthRem:48,singleRow:!0},j)),Se.appendChild(ce),ie.childElementCount>0&&Se.appendChild(ie),r.appendChild(Se);const J=E.metadata.morphologyChecklist;if(J&&J.length>0){const D=((U=(M=$==null?void 0:$.summaryMetrics)==null?void 0:M.morphology)==null?void 0:U.value)??null,ae=(D==null?void 0:D.toLowerCase())??null,re=new Set(J.map(O=>O.id));ae&&re.has(ae)&&w.add(ae);const H=document.createElement("div");H.className="sci-bottom-row";const Ee=document.createElement("div");Ee.style.cssText="display:flex; flex-direction:column; gap:1.25rem;",Ee.appendChild(Vs(E,T,g));const Le=((V=J.find(O=>O.id===ae))==null?void 0:V.label)??D;if(Le){const O=document.createElement("div");O.className="sci-section panel param-section";const ee=document.createElement("p");ee.className="sci-section__title",ee.textContent="Galaxy Morphology";const C=document.createElement("div");C.className="res-card res-card--has-info";const K=document.createElement("span");K.className="res-card__value",K.textContent=Le,C.appendChild(K),C.addEventListener("click",()=>{var Q;return g("Galaxy Morphology",((Q=J.find(W=>W.id===(D??"").toLowerCase()))==null?void 0:Q.description)??`This galaxy is classified as "${Le}".`)}),O.appendChild(ee),O.appendChild(C),Ee.appendChild(O)}H.appendChild(Ee);const ve=document.createElement("div");ve.style.cssText="flex:1; display:flex; flex-direction:column; gap:1.25rem; min-width:0; min-height:0;";const me=((ue=(B=$==null?void 0:$.summaryMetrics)==null?void 0:B.description)==null?void 0:ue.value)??null;if(me){const O=document.createElement("div");O.className="sci-section panel",O.style.cssText="flex:0 1 auto; min-width:0;";const ee=document.createElement("p");ee.className="sci-section__title",ee.textContent="About This Galaxy";const C=document.createElement("p");C.className="galaxy-summary__desc-text",C.textContent=me,O.appendChild(ee),O.appendChild(C),ve.appendChild(O)}const he=document.createElement("div");he.className="sci-section panel",he.style.cssText="flex:1; min-height:0;";const We=document.createElement("p");We.className="sci-section__title",We.textContent="Morphology Scavenger Hunt";const Pe=document.createElement("div");Pe.className="galaxy-summary__checklist",Pe.style.cssText="flex:1; align-items:center;";const Ce=J.every(O=>w.has(O.id));for(const O of J){const ee=document.createElement("div");ee.className="galaxy-summary__check",w.has(O.id)&&ee.classList.add("is-found"),ee.innerHTML=`
            <span class="galaxy-summary__check-box">
              ${w.has(O.id)?"✓":""}
            </span>
            <span class="galaxy-summary__check-label">${O.label}</span>
          `,O.hint&&(ee.classList.add("res-card--has-info"),ee.addEventListener("click",()=>g(O.label,O.hint))),Pe.appendChild(ee)}if(he.appendChild(We),he.appendChild(Pe),Ce){L=!0;const O=document.createElement("div");O.className="galaxy-summary__done",O.textContent="★ You've discovered all of the galaxy types. Well done! ★",he.appendChild(O)}ve.appendChild(he),H.appendChild(ve),r.appendChild(H)}else if(Y.length>0){const D=document.createElement("div");D.className="sci-bottom-row",D.appendChild(Vs(E,T,g));const ae=document.createElement("div"),re=document.createElement("div"),H=document.createElement("p"),Ee=document.createElement("p");ae.className="sci-section panel",re.className="sci-section__header",H.className="sci-section__title",H.textContent="Similarity Results",Ee.className="sci-section__hint",Ee.textContent="Select any bar for details",re.appendChild(H),re.appendChild(Ee);const Le=document.createElement("div");Le.className="sci-bars";for(const ve of Y){const me=document.createElement("div");me.className="sci-bar",me.innerHTML=`
            <div class="sci-bar__name">${ve.label}</div>
            <div class="sci-track">
              <div class="sci-pointer" style="left:${go(ve.value)}%">
                <div class="sci-pointer__needle"></div>
                <div class="sci-pointer__node"></div>
              </div>
            </div>
            <div class="sci-bar__value">${ve.formattedValue}</div>
          `,me.addEventListener("click",()=>k(ve)),Le.appendChild(me)}ae.appendChild(re),ae.appendChild(Le),D.appendChild(ae),r.appendChild(D)}}}}function Lo(n,e){const t=e[n.id]??{label:n.id,value:"--"},s=t.value!=="--"?t.value:"--",i=No(s,n);if(i)return{label:n.label??t.label,value:i};const a=Fi(s,n);return{label:n.label??t.label,value:Fe(a,n.unit)}}function Vs(n,e,t){const s=document.createElement("div");s.className="sci-section panel param-section",s.innerHTML='<p class="sci-section__title">Input Parameters</p>';const i=document.createElement("div");i.className="param-cards";for(const a of n.parameters){const r=e[a.id]??a.fallbackValue,o=a.displayUnit??a.unit,l=document.createElement("div"),c=document.createElement("span"),u=document.createElement("span");l.className="res-card",a.description&&t&&(l.classList.add("res-card--has-info"),l.addEventListener("click",()=>t(a.label,a.description))),c.className="res-card__label",c.textContent=a.label,u.className="res-card__value";const d=a.displayFormat==="qualitative"&&a.qualiLabels?a.qualiLabels[Math.round(r)]??"--":ht(r,a.step,{scale:a.valueScale,format:a.displayFormat,significantFigures:a.displaySignificantFigures});u.textContent=Fe(d,o),l.appendChild(c),l.appendChild(u),i.appendChild(l)}return s.appendChild(i),s}function No(n,e){if(e.id!=="carbonBurnt"||n==="--")return null;const t=Number(n);return Number.isFinite(t)?Math.abs(t)<1?Fe(sn(n,{scale:(e.valueScale??1)*1e3,mode:"float",precision:1}),"g CO2"):Fe(sn(n,{scale:e.valueScale,mode:"float",precision:e.precision??2}),e.unit):Fe(n,e.unit)}function Fi(n,e){if(n==="--")return n;if(e.displayFormat==="scientific"||e.displayFormat==="compact"||e.displayFormat==="float")return sn(n,{scale:e.valueScale,mode:e.displayFormat,precision:e.precision});if(e.displayFormat==="integer")return sn(n,{scale:e.valueScale,mode:"integer"});const t=Number(n);if(!Number.isFinite(t))return n;const s=e.valueScale??1,i=t*s;return $t(i)}function Io(n,e){const t=document.createElement("div");return t.className="view-switcher is-hidden",n.appendChild(t),{update(s,i){if(t.innerHTML="",s.length<=1){t.classList.add("is-hidden");return}t.classList.remove("is-hidden");for(const a of s){const r=document.createElement("div");r.className="view-switcher__row";const o=document.createElement("button");o.className="view-switcher__button",o.type="button",o.dataset.viewId=a.id,o.classList.toggle("is-active",a.id===i),o.setAttribute("aria-pressed",String(a.id===i)),o.setAttribute("aria-label",a.label??a.id);const l=Co(a.icon);if(l){const u=document.createElement("span");u.className="view-switcher__icon",u.setAttribute("aria-hidden","true"),u.appendChild(l),o.appendChild(u)}const c=document.createElement("span");if(c.className="view-switcher__label",c.textContent=a.label??a.id,o.appendChild(c),o.addEventListener("click",()=>e.onSelect(a.id)),r.appendChild(o),a.description){const u=document.createElement("button");u.className="view-switcher__info",u.type="button",u.setAttribute("aria-label",`Info about ${a.label??a.id}`),u.appendChild(Ao()),u.addEventListener("click",d=>{d.stopPropagation(),e.onInfo(a.id,a.label??a.id,a.description??"")}),r.appendChild(u)}t.appendChild(r)}},hide(){t.innerHTML="",t.classList.add("is-hidden")}}}function Co(n){switch(n){case"icon_houdini":return Ie(`
...
`;function Mo(){const n=Ke(To);if(!Array.isArray(n))return[];const e=[];for(const t of n){if(!t||typeof t!="object")continue;const s=t.text;if(typeof s!="string"||s.trim().length===0)continue;const i={text:s},a=t.url;typeof a=="string"&&a.trim().length>0&&(i.url=a);const r=t.logo;typeof r=="string"&&r.trim().length>0&&(i.logo=r),t.header===!0&&(i.header=!0),e.push(i)}return e}function Oo(n,e,t,s){const i=document.createElement("div");i.className="parameter-editor",n.appendChild(i);let a=e,r={...t};function o(u,d){a=u,r=d?{...d}:Po(u),i.innerHTML="";const p=document.createElement("div");p.className="parameter-editor__heading",p.innerHTML=`
    ...
    `,i.appendChild(m);const b=m.querySelector(".sci-modal__title"),h=m.querySelector(".sci-modal__body"),y=m.querySelector(".sci-modal__close");function S(k,g){b.textContent=k,h.textContent=g,m.classList.remove("is-hidden")}function w(){m.classList.add("is-hidden")}y.addEventListener("click",w),m.addEventListener("click",k=>{k.target===m&&w()});const L=document.createElement("div");L.className="parameter-editor__list";for(const k of u.parameters)L.appendChild(l(k,S));i.appendChild(L),c()}function l(u,d){const p=document.createElement("div");p.className="res-card param-card";const m=document.createElement("div");m.className="param-card__header";const b=document.createElement("span");b.className="res-card__label",b.textContent=u.label;const h=u.displayUnit??u.unit,y=u.displayFormat==="qualitative"&&u.qualiLabels&&u.qualiLabels.length>0,S=document.createElement("span");if(S.className="param-card__range",y){const v=u.qualiLabels;S.textContent=`${v[0]} – ${v[v.length-1]}`}else S.textContent=`${Fe(ht(u.min,u.step,{scale:u.valueScale,format:u.displayFormat,significantFigures:u.displaySignificantFigures}),h)} – ${Fe(ht(u.max,u.step,{scale:u.valueScale,format:u.displayFormat,significantFigures:u.displaySignificantFigures}),h)}`;m.appendChild(b),m.appendChild(S);const w=document.createElement("input");w.className="param-card__slider",w.type="range";const L=r[u.id]??u.fallbackValue;if(y){const v=u.qualiLabels.length;w.min="0",w.max=String(v-1),w.step="any",w.value=String(Math.round(L))}else{const v=u.logScale?Math.log10(u.min):u.min,N=u.logScale?Math.log10(u.max):u.max;w.min=String(v),w.max=String(N),w.step=u.logScale?"0.001":String(u.step),w.value=String(u.logScale?Math.log10(Math.max(L,Number.MIN_VALUE)):L)}w.setAttribute("aria-label",u.label);const k=document.createElement("span");k.className="res-card__value";function g(v){if(y){const N=Math.round(v),E=u.qualiLabels;r[u.id]=N,w.style.setProperty("--fill",`${zt(v,0,E.length-1)}%`),k.textContent=E[N]??String(N)}else{const N=u.logScale?10**v:v;r[u.id]=N,w.value=String(v),w.style.setProperty("--fill",`${zt(v,parseFloat(w.min),parseFloat(w.max))}%`),k.textContent=Fe(ht(N,u.step,{scale:u.valueScale,format:u.displayFormat,significantFigures:u.displaySignificantFigures}),h)}c()}if(w.addEventListener("input",()=>{g(parseFloat(w.value))}),w.addEventListener("pointerdown",v=>v.stopPropagation()),w.addEventListener("click",v=>v.stopPropagation()),y){const v=Math.round(L),N=u.qualiLabels;w.style.setProperty("--fill",`${zt(v,0,N.length-1)}%`),k.textContent=N[v]??String(v)}else{const v=u.logScale?Math.log10(Math.max(L,Number.MIN_VALUE)):L;w.style.setProperty("--fill",`${zt(v,parseFloat(w.min),parseFloat(w.max))}%`),k.textContent=Fe(ht(L,u.step,{scale:u.valueScale,format:u.displayFormat,significantFigures:u.displaySignificantFigures}),h)}if(u.description){p.classList.add("res-card--has-info"),p.setAttribute("title",u.description);const v=document.createElement("span");v.className="param-card__info-btn",v.setAttribute("aria-label","Parameter description"),v.textContent="ⓘ",m.appendChild(v),p.addEventListener("click",()=>{d(u.label,u.description)})}return p.appendChild(m),p.appendChild(w),p.appendChild(k),p}function c(){s({...r})}return o(e,t),{setSimClass(u,d){o(u,d)},setValues(u){o(a,u)},getValues(){return{...r}}}}function Po(n){return Object.fromEntries(n.parameters.map(e=>[e.id,e.fallbackValue]))}function zt(n,e,t){return t===e?0:(n-e)/(t-e)*100}const Bi="universe-engine-advanced-settings",xo="RSSSE26UM_Engine";function rn(){return{lockedScaleId:null,manifestSource:"online",verboseLogging:!1,hiddenScaleIds:[],audioMutedByDefault:!0,defaultAudioVolume:.75}}function $o(n){const e=localStorage.getItem(Bi);if(!e)return rn();try{const t=JSON.parse(e);return Vi(t,n)}catch{return rn()}}function Ro(n,e){const t=Vi(n,e);return localStorage.setItem(Bi,JSON.stringify({lockedScaleId:t.lockedScaleId,manifestSource:t.manifestSource,verboseLogging:t.verboseLogging,hiddenScaleIds:t.hiddenScaleIds,audioMutedByDefault:t.audioMutedByDefault,defaultAudioVolume:t.defaultAudioVolume})),t}function Vi(n,e){const t=rn(),s=new Set(e),i=n.manifestSource==="online"||n.manifestSource==="local"?n.manifestSource:t.manifestSource,a=typeof n.lockedScaleId=="string"&&s.has(n.lockedScaleId)?n.lockedScaleId:null,r=Array.isArray(n.hiddenScaleIds)?n.hiddenScaleIds.filter((l,c,u)=>typeof l=="string"&&s.has(l)&&u.indexOf(l)===c&&l!==a):t.hiddenScaleIds,o=Fo(typeof n.defaultAudioVolume=="number"?n.defaultAudioVolume:t.defaultAudioVolume);return!a&&r.length>=e.length&&e.length>0&&r.pop(),{lockedScaleId:a,manifestSource:i,verboseLogging:!!n.verboseLogging,hiddenScaleIds:r,audioMutedByDefault:!!n.audioMutedByDefault,defaultAudioVolume:o}}function Fo(n){return Number.isFinite(n)?Math.max(0,Math.min(1,n)):rn().defaultAudioVolume}function Bo(n,e){if(n.lockedScaleId)return[n.lockedScaleId];const t=new Set(n.hiddenScaleIds),s=e.filter(i=>!t.has(i));return s.length>0?s:e.slice(0,1)}function Vo(n,e){const t=document.createElement("section");t.className="overlay overlay--config",t.hidden=!0,t.classList.add("is-hidden");const s=document.createElement("div");s.className="config-overlay";const i=document.createElement("div");i.className="config-overlay__shell";const a=document.createElement("div");a.className="config-overlay__media",a.dataset.simClass=e.simClass.id;const r=document.createElement("img");r.className="config-overlay__media-image",r.src=e.simClass.placeholderImage,r.alt=`${e.simClass.label} preview`,a.innerHTML=`
 ...
 Engine</h1>
  ...
  `,L.appendChild(k),L.appendChild(g),w.appendChild(L);const v=document.createElement("label");v.className="advanced-settings__field",v.innerHTML=`
  ...
  `;const N=document.createElement("input"),E=document.createElement("span");N.type="range",N.min="0",N.max="100",N.step="1",N.className="audio-settings__slider",E.className="audio-settings__value",v.appendChild(N),v.appendChild(E),w.appendChild(v),y.appendChild(w);const T=document.createElement("section");T.className="advanced-settings",T.dataset.state="closed",T.innerHTML=`
  ...
  `;const X=document.createElement("select");X.className="advanced-settings__select",X.appendChild(new Option("None",""));for(const C of e.availableScales)X.appendChild(new Option(C.label,C.id));q.appendChild(X),Y.appendChild(q);const be=document.createElement("div");be.className="advanced-settings__field",be.innerHTML=`
  ...
  `;const U=document.createElement("div");U.className="advanced-settings__options";const V=new Map;for(const C of e.availableScales){const K=document.createElement("label"),Q=document.createElement("input");K.className="advanced-settings__choice",Q.type="checkbox",Q.value=C.id,V.set(C.id,Q),K.appendChild(Q),K.append(`Show ${C.label}`),U.appendChild(K)}M.appendChild(U),Y.appendChild(M),T.appendChild(Y),y.appendChild(T);const B=document.createElement("section");B.className="config-overlay__section config-overlay__section--grow",B.dataset.section="credits",B.innerHTML=`
    <div class="credits-list" data-credits></div>
  `;const ue=B.querySelector("[data-credits]"),D=Mo();if(ue.innerHTML="",D.length===0){const C=document.createElement("div");C.className="credits-list__entry",C.textContent="To be credited...",ue.appendChild(C)}else for(const C of D)if(C.header){const K=document.createElement("div");K.className="credits-list__heading",K.textContent=C.text,ue.appendChild(K)}else{const K=document.createElement("div");K.className="credits-list__entry";const Q=document.createElement("span");if(Q.className="credits-list__text",C.url){const W=document.createElement("a");W.className="credits-list__link",W.href=C.url,W.target="_blank",W.rel="noopener noreferrer",W.textContent=C.text,Q.appendChild(W)}else Q.textContent=C.text;K.appendChild(Q),ue.appendChild(K)}const ae=document.createElement("div");ae.className="config-overlay__footer";const re=document.createElement("button");re.className="run-button",re.type="button",re.textContent="Run",ae.appendChild(re),o.appendChild(l),o.appendChild(b),o.appendChild(y),o.appendChild(B),o.appendChild(ae),i.appendChild(a),i.appendChild(o),s.appendChild(i),t.appendChild(s),n.appendChild(t);let H=Ct(e.advancedSettings),Ee="closed";const Le=Oo(h,e.simClass,e.values,e.onValuesChange),ve=Vr(S,e.theme,e.onThemeChange);m.addEventListener("click",e.onClose),R.addEventListener("click",()=>{if(Ee==="open"){Pe("closed");return}Pe("auth"),F.focus()}),j.addEventListener("click",We),F.addEventListener("keydown",C=>{C.key==="Enter"&&We()}),X.addEventListener("change",()=>{H.lockedScaleId=X.value||null,he()}),ie.addEventListener("change",()=>{ie.checked&&(H.manifestSource="local")}),fe.addEventListener("change",()=>{fe.checked&&(H.manifestSource="online")}),J.addEventListener("change",()=>{H.verboseLogging=J.checked}),k.addEventListener("change",()=>{H.audioMutedByDefault=k.checked}),N.addEventListener("input",()=>{H.defaultAudioVolume=Number(N.value)/100,ee()});for(const[C,K]of V.entries())K.addEventListener("change",()=>{if(Array.from(V.entries()).filter(([,W])=>W.checked).map(([W])=>W).length===0&&!H.lockedScaleId){K.checked=!0;return}H.hiddenScaleIds=Array.from(V.keys()).filter(W=>{var Ve;return!((Ve=V.get(W))!=null&&Ve.checked)&&W!==H.lockedScaleId}),he()}),C===H.lockedScaleId&&(K.disabled=!0);me(e.initialView??"parameters"),he();function me(C){o.dataset.view=C,C==="parameters"?(u.textContent=e.simClass.label,d.textContent="Shape Your Simulation",p.textContent=e.simClass.parameterSubtitle??"Adjust the parameters, inspect the setup, and press 'Run' when you're ready.",r.src=e.simClass.placeholderImage,r.alt=`${e.simClass.label} preview`):C==="settings"?(u.textContent="Interface",d.textContent="Adjust The Control Room",p.textContent="Change the interface theme and manage exhibit-level options for this installation.",r.src=Z("assets/Cluster_Stuart.webp"),r.alt="Galaxy cluster simulation preview"):(u.textContent="References",d.textContent="Project Sources And Attribution",p.textContent="Review the datasets, imagery, and supporting materials behind this experience.",r.src=Z("assets/synthetic_hst_pretty_galaxy.webp"),r.alt="Synthetic galaxy image preview"),C==="settings"?re.textContent="Apply":C==="credits"?re.textContent="Close":re.textContent="Run Simulation"}function he(){X.value=H.lockedScaleId??"",ie.checked=H.manifestSource==="local",fe.checked=H.manifestSource==="online",J.checked=H.verboseLogging,k.checked=H.audioMutedByDefault,N.value=String(Math.round(H.defaultAudioVolume*100)),ee();for(const[C,K]of V.entries()){const Q=H.lockedScaleId===C;K.checked=Q||!H.hiddenScaleIds.includes(C),K.disabled=Q}}function We(){if(F.value!==xo){z.textContent="Incorrect password";return}F.value="",z.textContent="",Pe("open")}function Pe(C){Ee=C,T.dataset.state=C,R.textContent=C==="open"?"Hide Advanced Settings":"Advanced Settings",C!=="auth"&&(z.textContent="")}function Ce(){F.value="",z.textContent="",Pe("closed")}function O(){H=Ct(e.advancedSettings),he()}function ee(){E.textContent=`${Math.round(Number(N.value))}%`}return re.addEventListener("click",()=>{const C=o.dataset.view;if(C==="settings"){e.onApplySettings(Ct(H));return}if(C==="credits"){e.onClose();return}e.onRun()}),{show(){t.hidden=!1,t.classList.remove("is-hidden")},hide(){t.hidden=!0,t.classList.add("is-hidden"),O(),Ce()},setSimulation(C,K){e.simClass=C,a.dataset.simClass=C.id,Le.setSimClass(C,K),o.dataset.view==="parameters"&&(r.src=C.placeholderImage,r.alt=`${C.label} preview`,me("parameters"))},setTheme(C){ve.setActive(C)},setView(C){me(C),C!=="settings"&&Ce()},setAdvancedSettings(C){e.advancedSettings=Ct(C),H=Ct(C),he(),Ce()}}}function Ct(n){return{lockedScaleId:n.lockedScaleId,manifestSource:n.manifestSource,verboseLogging:n.verboseLogging,hiddenScaleIds:[...n.hiddenScaleIds],audioMutedByDefault:n.audioMutedByDefault,defaultAudioVolume:n.defaultAudioVolume}}function Uo(n){const{TYPING_MS_PER_CHAR:e,MIN_TERMINAL_TIME_MS:t,FINAL_PAUSE_MS:s}=zn,i=document.createElement("section");i.className="overlay overlay--initializing",i.hidden=!0,i.classList.add("is-hidden");const a=document.createElement("div");a.className="terminal";const r=document.createElement("div");r.className="terminal__header",r.innerHTML=`
    <div class="terminal__header-left">
      <span class="terminal__dot"></span>
      <span class="terminal__header-label">UNIVERSE_ENGINE_v9.5.1</span>
    </div>
  `;const o=document.createElement("div");o.className="terminal__log",a.appendChild(r),a.appendChild(o),i.appendChild(a),n.appendChild(i);let l=[],c=0;function u(){for(const b of l)window.clearTimeout(b);l=[]}function d(b,h){return new Promise(y=>{const S=window.setTimeout(()=>{h===c&&y()},Math.max(0,b));l.push(S)})}async function p(b,h){const y=document.createElement("div");y.className="terminal__line";const S=m();y.appendChild(S),o.appendChild(y);for(let w=0;w<b.length;w+=1){if(h!==c)return;const L=b[w];y.insertBefore(document.createTextNode(L),S),o.scrollTop=o.scrollHeight,await d(e,h)}S.remove()}function m(){const b=document.createElement("span");return b.className="terminal__cursor",b.textContent="█",b}return{async show(b,h,y,S){u(),c+=1;const w=c;i.hidden=!1,i.classList.remove("is-hidden");const L=performance.now(),k=(S==null?void 0:S.minTerminalTimeMs)??t;let g=!y,v=[...b];y&&y.then(()=>{g=!0});let N=0;for(;w===c;){v.length===0&&(v=[...b]);const T=Math.floor(Math.random()*v.length),[R]=v.splice(T,1),$=`${Us(N)} ${R.text}`;if(N+=1,await p($,w),w!==c)return;if(performance.now()-L>=k&&g)break}if(w!==c)return;const E=document.createElement("div");E.className="terminal__line terminal__line--syncing",E.textContent=`${Us(N)} STARTING SIMULATION...`,o.appendChild(E),o.scrollTop=o.scrollHeight,await d(s,w),w===c&&h()},hide(){u(),c+=1,i.hidden=!0,i.classList.add("is-hidden"),o.innerHTML=""}}}function Us(n){const e=Math.max(0,Math.floor(n)),t=Math.floor(e/3600),s=Math.floor(e%3600/60),i=e%60;return`[${Fn(t)}:${Fn(s)}:${Fn(i)}]`}function Fn(n){return String(n).padStart(2,"0")}function Do(n,e){const t=document.createElement("button");t.className="display-button",t.type="button",t.innerHTML="<span></span><span></span><span></span>",t.setAttribute("aria-label","Open configuration overlay"),n.appendChild(t);const s=document.createElement("div");s.className="display-menu";const i=document.createElement("div");i.className="display-menu__header",i.textContent="Menu",s.appendChild(i);const a=l("Home",()=>{c(),e.onHome()});s.appendChild(a),s.appendChild(l("Settings",()=>{c(),e.onViewSelected("settings")})),s.appendChild(l("Credits",()=>{c(),e.onViewSelected("credits")}));const r=l("Fullscreen",()=>{var d;c(),document.fullscreenElement?document.exitFullscreen():(d=document.getElementById("app"))==null||d.requestFullscreen()});s.appendChild(r),n.appendChild(s);function o(){const d=r.querySelector(".display-menu__item-label");d&&(d.textContent=document.fullscreenElement?"Exit Fullscreen":"Fullscreen");const p=document.getElementById("app");p&&p.classList.toggle("is-fullscreen",!!document.fullscreenElement)}return document.addEventListener("fullscreenchange",o),t.addEventListener("click",()=>{n.classList.toggle("open")}),document.addEventListener("click",d=>{n.contains(d.target)||c()}),u(e.showHome??!0),{close:c,setHomeVisible:u};function l(d,p){const m=document.createElement("button");return m.className="display-menu__item",m.type="button",m.innerHTML=`
      <span class="display-menu__item-mark"></span>
      <span class="display-menu__item-label">${d}</span>
    `,m.addEventListener("click",p),m}function c(){n.classList.remove("open")}function u(d){a.hidden=!d,a.classList.toggle("is-hidden",!d)}}const Ui="universe-engine-playback-speed",Ho=new Set([.25,.5,1,2]);function jo(){const n=localStorage.getItem(Ui),e=n?Number(n):NaN;return Ho.has(e)?e:1}function qo(n){localStorage.setItem(Ui,String(n))}async function Bn(n){try{await n.play()}catch{n.setMuted(!0);try{await n.play()}catch{}}}function Ko(){let n=0;return{start(){return n+=1,n},invalidate(){n+=1},isCurrent(e){return e===n}}}const Wo=`# Initialization terminal script for the Planetary simulation family.
#
...
`,Go=`# Initialization terminal script for the Cosmos simulation family.
#
# Each entry is a single line that may be selected randomly at runtime.
...
`,zo={planetary:Wo,galaxy:Yo,cosmos:Go};function Jo(n){return Ke(zo[n.id]).map(t=>({text:t}))}function Rt(n,e,t,s){if(e.length===0)return 0;const i=s?e.filter(r=>s.has(r.id)):e;return i.length===0?0:i.reduce((r,o)=>{var d;const l=t[o.id]??o.fallbackValue,c=((d=n.parameters)==null?void 0:d[o.id])??o.fallbackValue,u=Math.max(o.max-o.min,1e-9);return r+Math.abs(l-c)/u},0)/i.length}function Qo(n,e,t){if(n.length===0)return null;const s=new Set(e.filter(u=>u.primary!==!1).map(u=>u.id)),i=new Set(e.filter(u=>u.primary===!1).map(u=>u.id));if(!e.some(u=>u.primary===!1))return Vn(n,e,t);const r=Vn(n,e,t,s);if(!r)return null;const o=Rt(r,e,t,s),l=1e-6,c=n.filter(u=>{const d=Rt(u,e,t,s);return Math.abs(d-o)<=l});return Vn(c,e,t,i)}function Vn(n,e,t,s){if(n.length===0)return null;let i=n[0],a=Rt(i,e,t,s);for(const r of n.slice(1)){const o=Rt(r,e,t,s);o<a&&(i=r,a=o)}return i}function Xo(n){return n.replace(/\.mp4($|\?)/,".yaml$1")}async function Zo(n){try{const e=await Ge(n);if(!e.ok)return null;const t=await e.text(),s=Ke(t),i=ct(s.wallclockSeconds),a=ct(s.computeUsed),r=ct(s.memoryUsed),o=ct(s.carbonBurnt),l=ct(s.particlesUpdated),c=await el(n),u=nl(s.summaryMetrics);return i===null||a===null||r===null||o===null||l===null?null:{wallclockSeconds:i,computeUsed:a,memoryUsed:r,carbonBurnt:o,particlesUpdated:l,parameterValues:c,summaryMetrics:u}}catch{return null}}async function el(n){try{const e=await Ge(tl(n));if(!e.ok)return{};const t=await e.text(),s=Ke(t);return sl(s)}catch{return{}}}function tl(n){return n.replace(/run_summary\.yaml($|\?)/,"parameters.yaml$1")}function ct(n){const e=typeof n=="number"?n:Number(n);return Number.isFinite(e)?e:null}function nl(n){if(!n||typeof n!="object")return{};const e=n,t={};for(const[s,i]of Object.entries(e)){if(!i||typeof i!="object")continue;const a=i,r=typeof a.label=="string"?a.label:s,o=a.value;o!=null&&(t[s]={label:r,value:String(o)})}return t}function sl(n){if(!n||typeof n!="object")return{};const e={};for(const[t,s]of Object.entries(n)){const i=ct(s);i!==null&&(e[t]=i)}return e}const Di="[UniverseEngine]";let Hi=!1;function Ds(n){Hi=n}function ji(){return Hi}function le(n,e){ji()&&console.info(Di,n,e??"")}function je(n,e){ji()&&console.warn(Di,n,e??"")}const il={local:"assets/local-manifest.json",online:Oi};function al(n="local"){let e=n;const t=new Map,s=new Map;return{getSource(){return e},setSource(i){t.delete(i),s.delete(i),Hr(),e=i,le("Manifest source updated",{source:i})},async preloadActiveManifest(){await Ki(e,t,s)},async findNearestVideo(i,a,r){const o=await ll(e,t,s,i,a,r);if(o)return o;const l=qi(i);return je("Falling back to placeholder assets",{simClassId:i,source:e,fallbackUrl:l}),{url:l,liveDataUrl:rl(i),summaryUrl:Xo(l)}}}}function qi(n){switch(n){case"planetary":return Z("assets/planet_test.mp4");case"galaxy":return Z("assets/galaxy_test.mp4");case"cosmos":return Z("assets/cosmo_test.mp4");default:return Z("assets/galaxy_test.mp4")}}function rl(n){switch(n){case"planetary":return Z("assets/planet_test_planetary_stats.csv");case"galaxy":return Z("assets/galaxy_test_galaxy_stats.csv");case"cosmos":return Z("assets/cosmo_test_cosmos_stats.csv");default:return Z("assets/galaxy_test_galaxy_stats.csv")}}async function Ki(n,e,t){const s=e.get(n);if(s)return s;const i=il[n],a=(n==="online"?ol(i):fetch(Z(i),{cache:"no-store"}).then(async r=>{if(!r.ok)throw new Error(`Failed to load manifest: ${i}`);return le("Loaded manifest",{source:n,manifestPath:i}),await r.json()})).then(r=>(t.set(n,cl()),r)).catch(r=>(t.delete(n),je("Manifest unavailable",{source:n,manifestPath:i,error:r instanceof Error?r.message:String(r)}),{version:1,runs:[]}));return e.set(n,a),a}async function ol(n){const e=[n,Rn];for(const t of e)try{const s=await fetch(t,{cache:"no-store"});if(!s.ok)continue;const i=await s.json(),a=i.primaryBase??Hs(Oi),r=i.backupBase??Hs(Rn);return Dr(a,r),t===Rn&&jr("backup"),le("Loaded manifest",{source:"online",manifestPath:t,primaryBase:a,backupBase:r}),i}catch{continue}throw new Error(`Failed to load manifest: ${n}`)}async function ll(n,e,t,s,i,a){const o=(await Ki(n,e,t)).runs.filter(p=>p.simulationId===s);if(o.length===0)return je("No manifest runs found for simulation",{simClassId:s,source:n}),null;const l=Qo(o,i,a);if(!l)return null;const c=Rt(l,i,a),u=l.defaultView??Object.keys(l.views)[0],d=l.views[u];return d?(le("Selected manifest-backed run",{simClassId:s,source:n,runId:l.runId,selectedValues:a,distance:c,viewId:u}),{url:Jt(n,d,t),liveDataUrl:Jt(n,l.liveDataPath,t),summaryUrl:Jt(n,l.summaryPath,t),viewId:u,runId:l.runId,views:Object.fromEntries(Object.entries(l.views).map(([p,m])=>[p,Jt(n,m,t)]))}):null}function Jt(n,e,t){const s=n==="local"?Z(e):Ue(e),i=t.get(n);return i?Ii(s,"_manifest",i):s}function cl(){return`${Date.now()}`}function Hs(n){const e=new URL(n);return`${e.protocol}//${e.host}`}const en={mode:"time",frames:[]};async function ul(n){const e=await Ge(n);if(!e.ok)throw new Error(`Failed to load live stats CSV: ${n}`);const t=await e.text();return hl(t)}function dl(n,e,t=0){if(n.mode==="row")return ml(n.frames,e,t);const s=n.frames;if(s.length===0)return{};if(e<=s[0].t)return{...s[0].values};const i=s[s.length-1];if(e>=i.t)return{...i.values};const a=fl(s,e),r=s[Math.max(0,a-1)],o=s[Math.min(s.length-1,a)],l=(e-r.t)/Math.max(o.t-r.t,1e-9);return pl(r.values,o.values,l)}function fl(n,e){let t=1,s=n.length-1;for(;t<s;){const i=Math.floor((t+s)/2);n[i].t<=e?t=i+1:s=i}return t}function hl(n){const e=n.split(/\r?\n/).map(s=>s.trim()).filter(Boolean);if(e.length<2)return en;const t=Un(e[0]);return t[0]==="t"?{mode:"time",frames:e.slice(1).map(s=>{const i=Un(s),a={};for(let r=1;r<t.length;r+=1)a[t[r]]=i[r]??"";return{t:parseFloat(i[0]??"0")||0,values:a}})}:{mode:"row",frames:e.slice(1).map((s,i)=>{const a=Un(s),r={};for(let o=0;o<t.length;o+=1)r[t[o]]=a[o]??"";return{t:i,values:r}})}}function ml(n,e,t){if(n.length===0)return{};if(!Number.isFinite(t)||t<=0)return{...n[0].values};const s=Math.max(0,Math.min(1,e/t)),i=Math.round(s*(n.length-1));return{...n[i].values}}function Un(n){const e=[];let t="",s=!1;for(let i=0;i<n.length;i+=1){const a=n[i];if(a==='"'){s=!s;continue}if(a===","&&!s){e.push(t),t="";continue}t+=a}return e.push(t),e}function pl(n,e,t){const s=new Set([...Object.keys(n),...Object.keys(e)]),i={};for(const a of s){const r=n[a]??"",o=e[a]??r,l=parseFloat(r),c=parseFloat(o);if(Number.isFinite(l)&&Number.isFinite(c)){const u=l+(c-l)*t;i[a]=gl(u);continue}i[a]=t<.5?r:o}return i}function gl(n){return n.toFixed(2).replace(new RegExp("\\.0+$|(?<=\\..*?)0+$","g"),"").replace(/\.$/,"")}function yl(n){bl(ho,n)}function bl(n,e){if(navigator.sendBeacon){const t=new Blob([JSON.stringify(e)],{type:"application/json"});if(navigator.sendBeacon(n,t)){le("Run selection tracking dispatched",{simulationId:e.simulationId});return}}fetch(n,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),keepalive:!0}).then(t=>{t.ok?le("Run selection tracked",{simulationId:e.simulationId}):je("Run selection tracking rejected",{simulationId:e.simulationId,status:t.status})}).catch(t=>{je("Run selection tracking failed",{simulationId:e.simulationId,error:t instanceof Error?t.message:String(t)})})}const js=50*1024*1024,wl=8,vl=6e3,_l=8e3,Sl=5e3,kl=1200,El=100,Dn={galaxy:"tron",planetary:"matrix",cosmos:"hal"};function Ll(n){const e=lt.map(f=>f.id);let t=$o(e),s=ws(t);const i=al(t.manifestSource),a=Ko();Ds(t.verboseLogging),t.manifestSource==="online"&&i.preloadActiveManifest();let r=vs(t.lockedScaleId)??s[0]??lt[0],o=t.lockedScaleId?Dn[r.id]:Br(),l=!1,c=null,u=null,d=!1,p=t.audioMutedByDefault,m=t.defaultAudioVolume,b=0,h=null,y=0,S=en,w=!1;const L=Object.fromEntries(lt.map(f=>[f.id,ia(f)]));On(o);const k=qi(r.id),g=Kr(n,k),v=document.createElement("audio");v.preload="auto",v.hidden=!0,v.setAttribute("playsinline","true"),v.muted=p,v.volume=m,n.appendChild(v);const N=document.createElement("div");N.className="display-chrome",N.classList.add("is-hidden"),n.appendChild(N);const E=document.createElement("div");E.className="orientation-overlay",E.innerHTML=`
  ...
  `,n.appendChild(E);const T=document.createElement("div");T.className="swift-logo",T.innerHTML=`
    <img
      ...
      src="${Z("assets/credits/swift-logo.webp")}"
      alt="SWIFT"
      width="478"
      height="169"
      decoding="async"
    ...
    <img
      ...
      src="${Z("assets/credits/swift-logo-compact.webp")}"
      alt="SWIFT"
      width="478"
      height="169"
      decoding="async"
  ...
  `,n.appendChild(T);const R=document.createElement("div");R.className="synth-logo is-hidden",R.innerHTML=`
    ...
    <img
      ...
      src="${Z("assets/credits/synthesizer_banner_compact.webp")}"
      alt="Synthesizer"
      decoding="async"
    />
  `,n.appendChild(R);const $=document.createElement("img");$.className="app-partner-logo",$.src=Z("assets/dirac-hpc-white.webp"),$.alt="DIRAC HPC",$.decoding="async",n.appendChild($);const F=document.createElement("div");F.className="display-chrome__top-left is-hidden",n.appendChild(F);const j=Do(F,{onHome(){vn()},onViewSelected(f){if(f==="credits"){Ht("credits");return}Ht(f)},showHome:!t.lockedScaleId}),z=document.createElement("div");z.className="display-chrome__left-center",N.appendChild(z);const Y=Io(z,{onSelect(f){gs(f)},onInfo(f,_,A){X.textContent=_,be.textContent=A,q.classList.add("is-visible")}}),q=document.createElement("div");q.className="view-info-overlay",q.innerHTML=`
  ...
  `,n.appendChild(q);const X=q.querySelector(".view-info-overlay__title"),be=q.querySelector(".view-info-overlay__text"),Se=q.querySelector(".view-info-overlay__close");q.addEventListener("click",f=>{f.target===q&&q.classList.remove("is-visible")}),Se.addEventListener("click",()=>{q.classList.remove("is-visible")});const ce=document.createElement("div");ce.className="display-chrome__top-center is-hidden",N.appendChild(ce);const ie=document.createElement("div");ie.className="display-chrome__top-right",N.appendChild(ie);const we=Qr(ie),fe=document.createElement("div");fe.className="display-chrome__center-status",fe.innerHTML=`
  ...
  `,N.appendChild(fe);const ke=jo();g.setPlaybackRate(ke);const J=document.createElement("div");J.className="display-chrome__bottom",N.appendChild(J);const I=Yr(J,{onChange(f){H(f)},onTogglePlay:ps,onAudioToggle:Qi,onSpeedChange:Xi,onSummaryClick:Ji,onScrubStart(){We(),re()},onScrubEnd(){Pe(),g.isPaused()||ae()},initialSpeed:ke});I.setPlaying(!g.isPaused()),I.setAudioVisible(!1),I.setMuted(p),v.addEventListener("loadedmetadata",()=>{at(!0),Ne()});let M=null,U=null,V=null,B=!1,ue=null,D=0;function ae(){if(M!==null)return;function f(){const _=g.getPlaybackFraction();I.setPosition(_),g.isPaused()?M=null:M=requestAnimationFrame(f)}M=requestAnimationFrame(f)}function re(){M!==null&&(cancelAnimationFrame(M),M=null)}function H(f){U=f,V===null&&(V=requestAnimationFrame(()=>{if(V=null,U===null)return;const _=U;U=null,g.seekToFraction(_),at(!0)}))}function Ee(){if(U===null)return;V!==null&&(cancelAnimationFrame(V),V=null);const f=U;U=null,g.seekToFraction(f),at(!0)}function Le(){ue!==null&&(window.clearTimeout(ue),ue=null)}function ve(){if(!(h!=null&&h.views))return[];const f=it(r,h);return Object.entries(h.views).filter(([_])=>_!==f).map(([,_])=>Ue(_)).filter(Boolean)}function me(){Le(),g.suspendPrewarming()}function he(f=kl){Le(),!(B||g.isPaused())&&(ue=window.setTimeout(()=>{ue=null,!(B||g.isPaused())&&(g.resumePrewarming(),g.prewarmSources(ve()))},Math.max(0,f)))}function We(){B=!0,D=0,me(),Ne()}function Pe(){B=!1,D=0,Ee(),y=g.getPlaybackFraction()*g.getDurationSeconds(),Qe(y),he(),Ne()}g.onPlayStateChange(f=>{I.setPlaying(!f),f?(re(),me()):(ae(),he(0)),Ne()}),g.onTimeUpdate(f=>{if(y=f*g.getDurationSeconds(),B){const _=performance.now();if(_-D<El)return;D=_}Qe(y),at()});const Ce=document.createElement("div");Ce.className="overlay-layer",n.appendChild(Ce);const O=Eo(Ce,{onReplay:zi,onParameters:()=>Ht("parameters"),onHome:vn,showHome:!t.lockedScaleId});g.onEnded(()=>{l=!0;const f=g.captureFrame();O.update(r,Ae(),g.getDurationSeconds(),c,f),O.show(),Ne()});const ee=ro(Ce,s,f=>{ms(f),Ht("parameters")}),C=Vo(Ce,{simClass:r,values:Ae(),theme:o,advancedSettings:t,availableScales:lt,onValuesChange:Wi,onThemeChange:wn,onRun:()=>{le("Parameters submitted — starting run",{simClassId:r.id}),Zi().catch(f=>{je("Run failed to start",{simClassId:r.id,error:f instanceof Error?f.message:String(f)})})},onApplySettings:Yi,onClose:Gi,initialView:"parameters"}),K=Uo(Ce);I.setPosition(0),Qe(),O.hide();const Q=new WeakMap,W=f=>{const _=Q.get(f);_&&(clearTimeout(_),Q.delete(f)),f.classList.remove("side-collapsed")},Ve=f=>{const _=Q.get(f);_&&clearTimeout(_),Q.set(f,setTimeout(()=>{f.classList.add("side-collapsed"),Q.delete(f)},2500))},yn=f=>{const _=Q.get(f);_&&(clearTimeout(_),Q.delete(f)),f.classList.add("side-collapsed")},bn=(f,_)=>{const A=_.isCollapsible??(()=>!0);f.addEventListener("mouseenter",()=>W(f)),f.addEventListener("mouseleave",()=>{if(!A()){W(f);return}Ve(f)}),f.addEventListener("focusin",()=>W(f)),f.addEventListener("focusout",P=>{if(!f.contains(P.relatedTarget)){if(!A()){W(f);return}Ve(f)}}),f.addEventListener("click",()=>{if(!A()){W(f);return}if(f.classList.contains("side-collapsed")){W(f),Ve(f);return}_.toggleOnClick?yn(f):Ve(f)}),A()?yn(f):W(f)};bn(F,{toggleOnClick:!0,isCollapsible:()=>n.dataset.mode!=="entry"}),bn(z,{toggleOnClick:!0}),bn(J,{toggleOnClick:!1});let St=0,st=null,Dt=0;const fs=()=>{st!==null&&(cancelAnimationFrame(st),st=null)},hs=()=>{if(st!==null)return;Dt=g.getPlaybackFraction();const f=()=>{if(St===0){fs();return}const A=12*(1/60)/Math.max(g.getDurationSeconds(),1);Dt=Math.max(0,Math.min(1,Dt+St*A)),g.seekToFraction(Dt),st=requestAnimationFrame(f)};st=requestAnimationFrame(f)};document.addEventListener("keydown",f=>{if(n.dataset.mode==="display"&&!(f.target instanceof HTMLInputElement||f.target instanceof HTMLTextAreaElement))switch(f.key){case"Escape":f.preventDefault(),q.classList.contains("is-visible")?q.classList.remove("is-visible"):vn();break;case" ":f.preventDefault(),ps();break;case"ArrowLeft":f.preventDefault(),W(J),Ve(J),St=-1,hs();break;case"ArrowRight":f.preventDefault(),W(J),Ve(J),St=1,hs();break;case"ArrowUp":case"ArrowDown":{if(f.preventDefault(),W(z),Ve(z),!(h!=null&&h.views)||Object.keys(h.views).length<=1)break;const _=r.views.filter(pe=>{var _e;return((_e=h==null?void 0:h.views)==null?void 0:_e[pe.id])!==void 0});if(_.length<=1)break;const A=h.viewId??it(r,h),P=_.findIndex(pe=>pe.id===A),oe=f.key==="ArrowUp"?(P-1+_.length)%_.length:(P+1)%_.length;gs(_[oe].id);break}}}),document.addEventListener("keyup",f=>{(f.key==="ArrowLeft"||f.key==="ArrowRight")&&(St=0,fs())}),g.hideMedia(),g.pause(),Je(t.lockedScaleId?"config":"entry");function ms(f){f.id===r.id&&w||(r=f,kn(),wn(Dn[f.id]),C.setSimulation(r,Ae()),I.setPosition(0),Qe(),Sn(),_n())}function Wi(f){L[r.id]={...f},le("Parameter values updated",{simClassId:r.id,values:L[r.id]}),Qe()}function wn(f){o=f,On(f),C.setTheme(f)}function Ht(f){f==="parameters"&&C.setSimulation(r,Ae()),C.setView(f),Je("config")}function Yi(f){if(ga(f),w){O.hide(),Je("display");return}C.setSimulation(r,Ae()),C.setView("parameters")}function Gi(){if(O.hide(),!w&&t.lockedScaleId){C.setSimulation(r,Ae()),C.setView("parameters");return}Je(w?"display":"entry")}function vn(){t.lockedScaleId||(le("Returning to home screen",{simClassId:r.id}),kn(),w=!1,g.hideMedia(),Je("entry"))}function zi(){l=!1,O.hide(),g.getPlaybackFraction()>=.999&&(g.resetPlayback(),at(!0)),Bn(g),Ne()}function Ji(){l=!0,g.pause();const f=c?g.captureFrame():null;O.update(r,Ae(),g.getDurationSeconds(),c,f),O.show(),Ne()}function ps(){g.isPaused()?Bn(g):g.pause()}function Qi(){p=!p,Ne()}function Xi(f){g.setPlaybackRate(f),qo(f),I.setSpeed(f)}async function Zi(){const f=Ae(),_=a.start();le("Run requested",{simClassId:r.id,values:f,manifestSource:i.getSource()});const A=await i.findNearestVideo(r.id,r.parameters,f);if(!a.isCurrent(_))return;kn({preserveRunRequest:!0}),h=A;const P=it(r,A),oe=qr(i.getSource());yl({simulationId:r.id,parameters:f,manifestSource:i.getSource(),matchedRunId:A.runId,assetHostMode:oe.mode,assetHostBase:oe.base});const pe=ca(A,P)??A.url,_e=Object.entries(A.views??{}).filter(([xe])=>xe!==P).map(([,xe])=>xe);ra(A.liveDataUrl,_),oa(A.summaryUrl,_),da(A.summaryUrl,_),g.setMuted(!0),Sn(P),Et(),Je("initializing");const jt=ea(pe);g.resumePrewarming(),g.prewarmSources(_e);const Lt=(async()=>{const xe=await jt;a.isCurrent(_)&&(le(`Prepared active video source: ${xe.ownedObjectUrl?"FULL-FETCH":"PROGRESSIVE"}`,{selectedViewUrl:pe,waitsForBuffer:xe.shouldWaitForBuffer}),g.setSource(xe.src,{ownedObjectUrl:xe.ownedObjectUrl}),g.pause(),await g.waitForLoadedData(_l),a.isCurrent(_)&&xe.shouldWaitForBuffer&&await g.waitForBufferedAhead(wl,vl))})();await new Promise(xe=>{K.show(Jo(r),xe,Lt,{minTerminalTimeMs:ma()})}),a.isCurrent(_)&&(w=!0,g.showMedia(),Bn(g),Je("display"),Ne())}async function ea(f){const _=Ue(f),A=await ta(f);if(A!==null&&A>0&&A<=js){le("Downloading active video behind loading overlay",{videoUrl:_,contentLength:A});try{const P=await Ge(f);if(!P.ok)throw new Error(`Failed to download active video: ${_}`);const oe=await P.blob();return le(`Active video full fetch complete: ${oe.size} bytes`,{videoUrl:Ue(f),blobType:oe.type}),{src:URL.createObjectURL(oe),ownedObjectUrl:!0,shouldWaitForBuffer:!1}}catch(P){je(`Full-fetch FAILED; falling back to progressive: ${P instanceof Error?P.message:String(P)}`,{videoUrl:f})}}return A!==null?le("Active video exceeds full-fetch threshold; using progressive load",{videoUrl:f,contentLength:A,fullFetchMaxBytes:js}):le("Could not determine active video size; using progressive load",{videoUrl:f}),le("Using progressive active video load",{videoUrl:f}),{src:Ue(f),ownedObjectUrl:!1,shouldWaitForBuffer:!0}}async function ta(f){try{const _=await Ge(f,{headers:{Range:"bytes=0-0"}});le("Probed active video size with range request",{videoUrl:f,ok:_.ok,status:_.status,contentLength:_.headers.get("Content-Length"),contentRange:_.headers.get("Content-Range")});const A=sa(_.headers.get("Content-Length"));if(A!==null)return A;const P=na(_.headers.get("Content-Range"));return P!==null?P:null}catch(_){return je("Could not probe active video size",{videoUrl:f,error:_ instanceof Error?_.message:String(_)}),null}}function na(f){if(!f)return null;const _=f.match(/bytes\s+\d+-\d+\/(\d+)/i);if(!_)return null;const A=Number(_[1]);return Number.isFinite(A)&&A>0?A:null}function sa(f){if(!f)return null;const _=Number(f);return Number.isFinite(_)?_:null}function Je(f){if(n.dataset.mode=f,f==="entry"?document.documentElement.setAttribute("data-theme","glass"):f==="display"&&On(o),kt(N,f==="display"||f==="config"),kt(T,f==="display"||f==="entry"),kt(F,!t.lockedScaleId&&(f==="entry"||f==="config"||f==="display")),f==="entry"?W(F):yn(F),f==="entry"&&!t.lockedScaleId?ee.show():ee.hide(),f==="config"?(K.hide(),C.setSimulation(r,Ae()),C.show()):C.hide(),f!=="display")O.hide();else if(l){const A=g.captureFrame();O.update(r,Ae(),g.getDurationSeconds(),c,A),O.show()}!w||f==="initializing"?(g.hideMedia(),f==="initializing"&&g.pause()):g.showMedia(),f!=="initializing"&&K.hide(),_n(),Ne()}function _n(){if(n.dataset.mode==="entry"){kt(R,!0);return}const f=n.dataset.mode==="display",_=r.id==="galaxy";kt(R,f&&_)}function Qe(f=0){const _=dl(S,f,g.getDurationSeconds()),A=la(r,c,f,g.getDurationSeconds());we.update(r,Ae(),{..._,...A})}function Sn(f){const _=r.views.filter(oe=>{var pe;return((pe=h==null?void 0:h.views)==null?void 0:pe[oe.id])!==void 0});if(_.length<=1){Y.hide(),ce.classList.add("is-hidden");return}const A=f??it(r,h),P=_.find(oe=>oe.id===A);Y.update(_,A),P?(ce.classList.remove("is-hidden"),ce.innerHTML=`<span class="viewport-title">${P.label??P.id}</span>`):ce.classList.add("is-hidden")}function kn(f={}){f.preserveRunRequest||a.invalidate(),S=en,l=!1,c=null,h=null,y=0,B=!1,U=null,Le(),V!==null&&(cancelAnimationFrame(V),V=null),O.hide(),Y.hide(),g.pause(),v.pause(),g.clearPrewarmedSources(),g.resetPlayback(),I.setPosition(0),bs()}function gs(f){if(!(h!=null&&h.views)||f===it(r,h))return;const _=Ue(h.views[f]);if(!_)return;h.viewId=f;const A=!g.isPaused()&&!l,P=l?0:g.getPlaybackFraction();l=!1,O.hide(),g.setSource(_,{seekFraction:P,autoplay:A}),g.prewarmSources(ve()),A&&!B?he():me(),Sn(f),Et(),Ne(),q.classList.remove("is-visible"),_n()}function Ae(){return{...L[r.id]}}function ia(f){return Object.fromEntries(f.parameters.map(_=>[_.id,aa(_)]))}function aa(f){if(f.logScale){const pe=Math.log10(f.min),_e=Math.log10(f.max);return 10**(pe+Math.random()*(_e-pe))}const _=Math.max(0,Math.round((f.max-f.min)/f.step)),A=Math.floor(Math.random()*(_+1)),P=f.min+A*f.step,oe=Mi(f.step);return Number(P.toFixed(oe))}async function ra(f,_){let A=en;try{A=await ul(f)}catch(P){je("Failed to load live stats",{url:f,error:P instanceof Error?P.message:String(P)})}a.isCurrent(_)&&(S=A,Qe())}async function oa(f,_){const A=await Zo(f);a.isCurrent(_)&&(c=A,Qe(y))}function la(f,_,A,P){if(!_||!Number.isFinite(P)||P<=0)return{};const oe=Math.max(0,Math.min(1,A/P)),pe={};for(const _e of f.metadata.liveStats){if(!_e.live||!_e.fromVideo||!_e.scaleWithTime)continue;const jt=_e.videoKey??_e.id,Lt=_[jt];if(typeof Lt!="number"||!Number.isFinite(Lt))continue;const En=Lt*oe;pe[_e.id]=_e.integer?String(Math.floor(En)):String(En)}return pe}function kt(f,_){f.hidden=!_,f.classList.toggle("is-hidden",!_)}function it(f,_){return _!=null&&_.views?_.viewId??Object.keys(_.views)[0]:_==null?void 0:_.viewId}function ca(f,_){return!_||!f.views?null:f.views[_]??null}function ys(){const f=it(r,h);return f?r.views.some(_=>_.id===f&&_.audio):!1}function ua(f){return f.replace(/run_summary\.yaml($|\?)/,"audio_track.wav$1")}async function da(f,_){const A=ua(f),P=++b,oe=await fa(A);if(!(!a.isCurrent(_)||P!==b)){if(!oe){bs();return}u=Ue(A),d=!0,v.src!==u&&(v.pause(),v.src=u,v.load()),Et(),Ne()}}async function fa(f){try{if((await Ge(f,{method:"HEAD"})).ok)return!0}catch{}try{return(await Ge(f,{headers:{Range:"bytes=0-0"}})).ok}catch{return!1}}function bs(){b+=1,u=null,d=!1,v.pause(),v.removeAttribute("src"),v.load(),Et()}function ha(){p=t.audioMutedByDefault,m=t.defaultAudioVolume,v.muted=p,v.volume=m,I.setMuted(p)}function Et(){I.setAudioVisible(ys()&&d&&!!u),I.setMuted(p)}function at(f=!1){if(!d||!Number.isFinite(v.duration)||v.duration<=0)return;const _=Math.max(0,Math.min(v.duration,g.getPlaybackFraction()*v.duration));(f||Math.abs(v.currentTime-_)>.35)&&(v.currentTime=_)}function Ne(){const f=ys()&&d&&!!u;if(Et(),v.muted=p,v.volume=m,!f){v.pause();return}if(at(),n.dataset.mode!=="display"||g.isPaused()||l||B){v.pause();return}v.play().catch(()=>{p=!0,v.muted=!0,I.setMuted(!0)})}function ws(f){const _=new Set(Bo(f,e));return lt.filter(A=>_.has(A.id))}function vs(f){return f?lt.find(_=>_.id===f)??null:null}function ma(){return i.getSource()!=="local"?zn.MIN_TERMINAL_TIME_MS:pa(zn.MIN_TERMINAL_TIME_MS,Sl)}function pa(f,_){const A=Math.ceil(Math.min(f,_)),P=Math.floor(Math.max(f,_));return Math.floor(Math.random()*(P-A+1))+A}function ga(f){const _=r.id,A=t.manifestSource;t=Ro(f,e),Ds(t.verboseLogging),s=ws(t),i.setSource(t.manifestSource),t.manifestSource==="online"&&i.preloadActiveManifest(),j.setHomeVisible(!t.lockedScaleId),O.setHomeVisible(!t.lockedScaleId),ee.setSimulationClasses(s),C.setAdvancedSettings(t),le("Advanced settings updated",t),ha(),Ne(),A!==t.manifestSource&&(h=null);const P=vs(t.lockedScaleId);P&&(ms(P),P.id!==_&&(w=!1,g.hideMedia(),C.setView("parameters")),w||(wn(Dn[P.id]),C.setSimulation(r,Ae())))}}function Nl(){const n=document.getElementById("app");if(!n)throw new Error("App mount element not found.");Ll(n)}Nl();
//# sourceMappingURL=main-CrG_Ovbl.js.map
