...
`,zo={planetary:Wo,galaxy:Yo,cosmos:Go};function Jo(n){return Ke(zo[n.id]).map(t=>({text:t}))}function Rt(n,e,t,s){if(e.length===0)return 0;const i=s?e.filter(r=>s.has(r.id)):e;return i.length===0?0:i.reduce((r,o)=>{var d;const l=t[o.id]??o.fallbackValue,c=((d=n.parameters)==null?void 0:d[o.id])??o.fallbackValue,u=Math.max(o.max-o.min,1e-9);return r+Math.abs(l-c)/u},0)/i.length}function Qo(n,e,t){if(n.length===0)return null;const s=new Set(e.filter(u=>u.primary!==!1).map(u=>u.id)),i=new Set(e.filter(u=>u.primary===!1).map(u=>u.id));if(!e.some(u=>u.primary===!1))return Vn(n,e,t);const r=Vn(n,e,t,s);if(!r)return null;const o=Rt(r,e,t,s),l=1e-6,c=n.filter(u=>{const d=Rt(u,e,t,s);return Math.abs(d-o)<=l});return Vn(c,e,t,i)}function Vn(n,e,t,s){if(n.length===0)return null;let i=n[0],a=Rt(i,e,t,s);for(const r of n.slice(1)){const o=Rt(r,e,t,s);o<a&&(i=r,a=o)}return i}function Xo(n){return n.replace(/\.mp4($|\?)/,".yaml$1")}async function Zo(n){try{const e=await Ge(n);if(!e.ok)return null;const t=await e.text(),s=Ke(t),i=ct(s.wallclockSeconds),a=ct(s.computeUsed),r=ct(s.memoryUsed),o=ct(s.carbonBurnt),l=ct(s.particlesUpdated),c=await el(n),u=nl(s.summaryMetrics);return i===null||a===null||r===null||o===null||l===null?null:{wallclockSeconds:i,computeUsed:a,memoryUsed:r,carbonBurnt:o,particlesUpdated:l,parameterValues:c,summaryMetrics:u}}catch{return null}}async function el(n){try{const e=await Ge(tl(n));if(!e.ok)return{};const t=await e.text(),s=Ke(t);return sl(s)}catch{return{}}}function tl(n){return n.replace(/run_summary\.yaml($|\?)/,"parameters.yaml$1")}function ct(n){const e=typeof n=="number"?n:Number(n);return Number.isFinite(e)?e:null}function nl(n){if(!n||typeof n!="object")return{};const e=n,t={};for(const[s,i]of Object.entries(e)){if(!i||typeof i!="object")continue;const a=i,r=typeof a.label=="string"?a.label:s,o=a.value;o!=null&&(t[s]={label:r,value:String(o)})}return t}function sl(n){if(!n||typeof n!="object")return{};const e={};for(const[t,s]of Object.entries(n)){const i=ct(s);i!==null&&(e[t]=i)}return e}const Di="[UniverseEngine]";let Hi=!1;function Ds(n){Hi=n}function ji(){return Hi}function le(n,e){ji()&&console.info(Di,n,e??"")}function je(n,e){ji()&&console.warn(Di,n,e??"")}const il={local:"assets/local-manifest.json",online:Oi};function al(n="local"){let e=n;const t=new Map,s=new Map;return{getSource(){return e},setSource(i){t.delete(i),s.delete(i),Hr(),e=i,le("Manifest source updated",{source:i})},resetCache(){t.clear(),s.clear()},async preloadActiveManifest(){await Ki(e,t,s)},async findNearestVideo(i,a,r){const o=await ll(e,t,s,i,a,r);if(o)return o;const l=qi(i);return je("Falling back to placeholder assets",{simClassId:i,source:e,fallbackUrl:l}),{url:l,liveDataUrl:rl(i),summaryUrl:Xo(l)}}}}function qi(n){switch(n){case"planetary":return Z("assets/planet_test.mp4");case"galaxy":return Z("assets/galaxy_test.mp4");case"cosmos":return Z("assets/cosmo_test.mp4");default:return Z("assets/galaxy_test.mp4")}}function rl(n){switch(n){case"planetary":return Z("assets/planet_test_planetary_stats.csv");case"galaxy":return Z("assets/galaxy_test_galaxy_stats.csv");case"cosmos":return Z("assets/cosmo_test_cosmos_stats.csv");default:return Z("assets/galaxy_test_galaxy_stats.csv")}}async function Ki(n,e,t){const s=e.get(n);if(s)return s;const i=il[n],a=(n==="online"?ol(i):fetch(Z(i),{cache:"no-store"}).then(async r=>{if(!r.ok)throw new Error(`Failed to load manifest: ${i}`);return le("Loaded manifest",{source:n,manifestPath:i}),await r.json()})).then(r=>(t.set(n,cl()),r)).catch(r=>(t.delete(n),je("Manifest unavailable",{source:n,manifestPath:i,error:r instanceof Error?r.message:String(r)}),{version:1,runs:[]}));return e.set(n,a),a}async function ol(n){const e=[n,Rn];for(const t of e)try{const s=await fetch(t,{cache:"no-store"});if(!s.ok)continue;const i=await s.json(),a=i.primaryBase??Hs(Oi),r=i.backupBase??Hs(Rn);return Dr(a,r),t===Rn&&jr("backup"),le("Loaded manifest",{source:"online",manifestPath:t,primaryBase:a,backupBase:r}),i}catch{continue}throw new Error(`Failed to load manifest: ${n}`)}async function ll(n,e,t,s,i,a){const o=(await Ki(n,e,t)).runs.filter(p=>p.simulationId===s);if(o.length===0)return je("No manifest runs found for simulation",{simClassId:s,source:n}),null;const l=Qo(o,i,a);if(!l)return null;const c=Rt(l,i,a),u=l.defaultView??Object.keys(l.views)[0],d=l.views[u];return d?(le("Selected manifest-backed run",{simClassId:s,source:n,runId:l.runId,selectedValues:a,distance:c,viewId:u}),{url:Jt(n,d,t),liveDataUrl:Jt(n,l.liveDataPath,t),summaryUrl:Jt(n,l.summaryPath,t),viewId:u,runId:l.runId,views:Object.fromEntries(Object.entries(l.views).map(([p,m])=>[p,Jt(n,m,t)]))}):null}function Jt(n,e,t){const s=n==="local"?Z(e):Ve(e),i=t.get(n);return i?Ii(s,"_manifest",i):s}function cl(){return`${Date.now()}`}function Hs(n){const e=new URL(n);return`${e.protocol}//${e.host}`}const en={mode:"time",frames:[]};async function ul(n){const e=await Ge(n);if(!e.ok)throw new Error(`Failed to load live stats CSV: ${n}`);const t=await e.text();return hl(t)}function dl(n,e,t=0){if(n.mode==="row")return ml(n.frames,e,t);const s=n.frames;if(s.length===0)return{};if(e<=s[0].t)return{...s[0].values};const i=s[s.length-1];if(e>=i.t)return{...i.values};const a=fl(s,e),r=s[Math.max(0,a-1)],o=s[Math.min(s.length-1,a)],l=(e-r.t)/Math.max(o.t-r.t,1e-9);return pl(r.values,o.values,l)}function fl(n,e){let t=1,s=n.length-1;for(;t<s;){const i=Math.floor((t+s)/2);n[i].t<=e?t=i+1:s=i}return t}function hl(n){const e=n.split(/\r?\n/).map(s=>s.trim()).filter(Boolean);if(e.length<2)return en;const t=Un(e[0]);return t[0]==="t"?{mode:"time",frames:e.slice(1).map(s=>{const i=Un(s),a={};for(let r=1;r<t.length;r+=1)a[t[r]]=i[r]??"";return{t:parseFloat(i[0]??"0")||0,values:a}})}:{mode:"row",frames:e.slice(1).map((s,i)=>{const a=Un(s),r={};for(let o=0;o<t.length;o+=1)r[t[o]]=a[o]??"";return{t:i,values:r}})}}function ml(n,e,t){if(n.length===0)return{};if(!Number.isFinite(t)||t<=0)return{...n[0].values};const s=Math.max(0,Math.min(1,e/t)),i=Math.round(s*(n.length-1));return{...n[i].values}}function Un(n){const e=[];let t="",s=!1;for(let i=0;i<n.length;i+=1){const a=n[i];if(a==='"'){s=!s;continue}if(a===","&&!s){e.push(t),t="";continue}t+=a}return e.push(t),e}function pl(n,e,t){const s=new Set([...Object.keys(n),...Object.keys(e)]),i={};for(const a of s){const r=n[a]??"",o=e[a]??r,l=parseFloat(r),c=parseFloat(o);if(Number.isFinite(l)&&Number.isFinite(c)){const u=l+(c-l)*t;i[a]=gl(u);continue}i[a]=t<.5?r:o}return i}function gl(n){return n.toFixed(2).replace(new RegExp("\\.0+$|(?<=\\..*?)0+$","g"),"").replace(/\.$/,"")}function yl(n){bl(ho,n)}function bl(n,e){if(navigator.sendBeacon){const t=new Blob([JSON.stringify(e)],{type:"application/json"});if(navigator.sendBeacon(n,t)){le("Run selection tracking dispatched",{simulationId:e.simulationId});return}}fetch(n,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),keepalive:!0}).then(t=>{t.ok?le("Run selection tracked",{simulationId:e.simulationId}):je("Run selection tracking rejected",{simulationId:e.simulationId,status:t.status})}).catch(t=>{je("Run selection tracking failed",{simulationId:e.simulationId,error:t instanceof Error?t.message:String(t)})})}const js=50*1024*1024,vl=8,wl=6e3,_l=8e3,Sl=5e3,kl=1200,El=100,Dn={galaxy:"tron",planetary:"matrix",cosmos:"hal"};function Ll(n){const e=lt.map(f=>f.id);let t=$o(e),s=vs(t);const i=al(t.manifestSource),a=Ko();Ds(t.verboseLogging),t.manifestSource==="online"&&i.preloadActiveManifest();let r=ws(t.lockedScaleId)??s[0]??lt[0],o=t.lockedScaleId?Dn[r.id]:Br(),l=!1,c=null,u=null,d=!1,p=t.audioMutedByDefault,m=t.defaultAudioVolume,b=0,h=null,y=0,S=en,v=!1;const L=Object.fromEntries(lt.map(f=>[f.id,ia(f)]));On(o);const k=qi(r.id),g=Kr(n,k),w=document.createElement("audio");w.preload="auto",w.hidden=!0,w.setAttribute("playsinline","true"),w.muted=p,w.volume=m,n.appendChild(w);const N=document.createElement("div");N.className="display-chrome",N.classList.add("is-hidden"),n.appendChild(N);const E=document.createElement("div");E.className="orientation-overlay",E.innerHTML=`
  ...
  `,n.appendChild(E);const T=document.createElement("div");T.className="swift-logo",T.innerHTML=`
    ...
    <img
      ...
      decoding="async"
    />
  `,n.appendChild(T),document.createElement("div");const R=document.createElement("div");R.className="synth-logo is-hidden",R.innerHTML=`
    <img
    ...
    <img
      ...
      decoding="async"
    />
  `,n.appendChild(R);const $=document.createElement("img");$.className="app-partner-logo",$.src=Z("assets/dirac-hpc-white.webp"),$.alt="DIRAC HPC",$.decoding="async",n.appendChild($);const F=document.createElement("div");F.className="display-chrome__top-left is-hidden",n.appendChild(F);const j=Do(F,{onHome(){wn()},onViewSelected(f){if(f==="credits"){Ht("credits");return}Ht(f)},showHome:!t.lockedScaleId}),z=document.createElement("div");z.className="display-chrome__left-center",N.appendChild(z);const Y=Io(z,{onSelect(f){gs(f)},onInfo(f,_,A){X.textContent=_,be.textContent=A,q.classList.add("is-visible")}}),q=document.createElement("div");q.className="view-info-overlay",q.innerHTML=`
  ...
  `,n.appendChild(q);const X=q.querySelector(".view-info-overlay__title"),be=q.querySelector(".view-info-overlay__text"),Se=q.querySelector(".view-info-overlay__close");q.addEventListener("click",f=>{f.target===q&&q.classList.remove("is-visible")}),Se.addEventListener("click",()=>{q.classList.remove("is-visible")});const ce=document.createElement("div");ce.className="display-chrome__top-center is-hidden",N.appendChild(ce);const ie=document.createElement("div");ie.className="display-chrome__top-right",N.appendChild(ie);const ve=Qr(ie),fe=document.createElement("div");fe.className="display-chrome__center-status",fe.innerHTML=`
