...
\r	`),An=n=>!n||wo.has(n);class _o{constructor(){this.atEnd=!1,this.blockScalarIndent=-1,this.blockScalarKeep=!1,this.buffer="",this.flowKey=!1,this.flowLevel=0,this.indentNext=0,this.indentValue=0,this.lineEndPos=null,this.next=null,this.pos=0}*lex(e,t=!1){if(e){if(typeof e!="string")throw TypeError("source is not a string");this.buffer=this.buffer?this.buffer+e:e,this.lineEndPos=null}this.atEnd=!t;let s=this.next??"stream";for(;s&&(t||this.hasChars(1));)s=yield*this.parseNext(s)}atLineEnd(){let e=this.pos,t=this.buffer[e];for(;t===" "||t==="	";)t=this.buffer[++e];return!t||t==="#"||t===`
...
cosmos:
  ...
  similarityScore:
    value: '--'
`,Ao=`# Live telemetry HUD display configuration for each simulation family.
#
...
`;function Cr(){const n=Ke(Ir);if(!Array.isArray(n))return[];const e=[];for(const t of n){if(!t||typeof t!="object")continue;const s=t.text;if(typeof s!="string"||s.trim().length===0)continue;const i={text:s},a=t.url;typeof a=="string"&&a.trim().length>0&&(i.url=a);const o=t.logo;typeof o=="string"&&o.trim().length>0&&(i.logo=o),t.header===!0&&(i.header=!0),e.push(i)}return e}function Ar(n,e,t,s){const i=document.createElement("div");i.className="parameter-editor",n.appendChild(i);let a=e,o={...t};function r(u,d){a=u,o=d?{...d}:Tr(u),i.innerHTML="";const p=document.createElement("div");p.className="parameter-editor__heading",p.innerHTML=`
 ...
 Engine</h1>
  ...
  `;const ue=B.querySelector("[data-credits]"),D=Cr();if(ue.innerHTML="",D.length===0){const C=document.createElement("div");C.className="credits-list__entry",C.textContent="To be credited...",ue.appendChild(C)}else for(const C of D)if(C.header){const q=document.createElement("div");q.className="credits-list__heading",q.textContent=C.text,ue.appendChild(q)}else{const q=document.createElement("div");q.className="credits-list__entry";const Q=document.createElement("span");if(Q.className="credits-list__text",C.url){const W=document.createElement("a");W.className="credits-list__link",W.href=C.url,W.target="_blank",W.rel="noopener noreferrer",W.textContent=C.text,Q.appendChild(W)}else Q.textContent=C.text;q.appendChild(Q),ue.appendChild(q)}const ae=document.createElement("div");ae.className="config-overlay__footer";const oe=document.createElement("button");oe.className="run-button",oe.type="button",oe.textContent="Run",ae.appendChild(oe),r.appendChild(l),r.appendChild(b),r.appendChild(y),r.appendChild(B),r.appendChild(ae),i.appendChild(a),i.appendChild(r),s.appendChild(i),t.appendChild(s),n.appendChild(t);let H=Ct(e.advancedSettings),Ee="closed";const Le=Ar(h,e.simClass,e.values,e.onValuesChange),we=Bo(S,e.theme,e.onThemeChange);m.addEventListener("click",e.onClose),$.addEventListener("click",()=>{if(Ee==="open"){Oe("closed");return}Oe("auth"),F.focus()}),j.addEventListener("click",qe),F.addEventListener("keydown",C=>{C.key==="Enter"&&qe()}),X.addEventListener("change",()=>{H.lockedScaleId=X.value||null,he()}),se.addEventListener("change",()=>{se.checked&&(H.manifestSource="local")}),fe.addEventListener("change",()=>{fe.checked&&(H.manifestSource="online")}),J.addEventListener("change",()=>{H.verboseLogging=J.checked}),k.addEventListener("change",()=>{H.audioMutedByDefault=k.checked}),N.addEventListener("input",()=>{H.defaultAudioVolume=Number(N.value)/100,ie()});for(const[C,q]of V.entries())q.addEventListener("change",()=>{if(Array.from(V.entries()).filter(([,W])=>W.checked).map(([W])=>W).length===0&&!H.lockedScaleId){q.checked=!0;return}H.hiddenScaleIds=Array.from(V.keys()).filter(W=>{var Be;return!((Be=V.get(W))!=null&&Be.checked)&&W!==H.lockedScaleId}),he()}),C===H.lockedScaleId&&(q.disabled=!0);me(e.initialView??"parameters"),he();function me(C){r.dataset.view=C,C==="parameters"?(u.textContent=e.simClass.label,d.textContent="Shape Your Simulation",p.textContent=e.simClass.parameterSubtitle??"Adjust the parameters, inspect the setup, and press 'Run' when you're ready.",o.src=e.simClass.placeholderImage,o.alt=`${e.simClass.label} preview`):C==="settings"?(u.textContent="Interface",d.textContent="Adjust The Control Room",p.textContent="Change the interface theme and manage exhibit-level options for this installation.",o.src=ne("assets/Cluster_Stuart.webp"),o.alt="Galaxy cluster simulation preview"):(u.textContent="References",d.textContent="Project Sources And Attribution",p.textContent="Review the datasets, imagery, and supporting materials behind this experience.",o.src=ne("assets/synthetic_hst_pretty_galaxy.webp"),o.alt="Synthetic galaxy image preview"),C==="settings"?oe.textContent="Apply":C==="credits"?oe.textContent="Close":oe.textContent="Run Simulation"}function he(){X.value=H.lockedScaleId??"",se.checked=H.manifestSource==="local",fe.checked=H.manifestSource==="online",J.checked=H.verboseLogging,k.checked=H.audioMutedByDefault,N.value=String(Math.round(H.defaultAudioVolume*100)),ie();for(const[C,q]of V.entries()){const Q=H.lockedScaleId===C;q.checked=Q||!H.hiddenScaleIds.includes(C),q.disabled=Q}}function qe(){if(F.value!==Mr){z.textContent="Incorrect password";return}F.value="",z.textContent="",Oe("open")}function Oe(C){Ee=C,T.dataset.state=C,$.textContent=C==="open"?"Hide Advanced Settings":"Advanced Settings",C!=="auth"&&(z.textContent="")}function Ie(){F.value="",z.textContent="",Oe("closed")}function R(){H=Ct(e.advancedSettings),he()}function ie(){E.textContent=`${Math.round(Number(N.value))}%`}return oe.addEventListener("click",()=>{const C=r.dataset.view;if(C==="settings"){e.onApplySettings(Ct(H));return}if(C==="credits"){e.onClose();return}e.onRun()}),{show(){t.hidden=!1,t.classList.remove("is-hidden")},hide(){t.hidden=!0,t.classList.add("is-hidden"),R(),Ie()},setSimulation(C,q){e.simClass=C,a.dataset.simClass=C.id,Le.setSimClass(C,q),r.dataset.view==="parameters"&&(o.src=C.placeholderImage,o.alt=`${C.label} preview`,me("parameters"))},setTheme(C){we.setActive(C)},setView(C){me(C),C!=="settings"&&Ie()},setAdvancedSettings(C){e.advancedSettings=Ct(C),H=Ct(C),he(),Ie()}}}function Ct(n){return{lockedScaleId:n.lockedScaleId,manifestSource:n.manifestSource,verboseLogging:n.verboseLogging,hiddenScaleIds:[...n.hiddenScaleIds],audioMutedByDefault:n.audioMutedByDefault,defaultAudioVolume:n.defaultAudioVolume}}function Fr(n){const{TYPING_MS_PER_CHAR:e,MIN_TERMINAL_TIME_MS:t,FINAL_PAUSE_MS:s}=Yn,i=document.createElement("section");i.className="overlay overlay--initializing",i.hidden=!0,i.classList.add("is-hidden");const a=document.createElement("div");a.className="terminal";const o=document.createElement("div");o.className="terminal__header",o.innerHTML=`
...
`,Wr={planetary:jr,galaxy:Kr,cosmos:qr};function Yr(n){return Ke(Wr[n.id]).map(t=>({text:t}))}function Gr(n){return n.replace(/\.mp4($|\?)/,".yaml$1")}async function zr(n){try{const e=await Ge(n);if(!e.ok)return null;const t=await e.text(),s=Ke(t),i=ct(s.wallclockSeconds),a=ct(s.computeUsed),o=ct(s.memoryUsed),r=ct(s.carbonBurnt),l=ct(s.particlesUpdated),c=await Jr(n),u=Xr(s.summaryMetrics);return i===null||a===null||o===null||r===null||l===null?null:{wallclockSeconds:i,computeUsed:a,memoryUsed:o,carbonBurnt:r,particlesUpdated:l,parameterValues:c,summaryMetrics:u}}catch{return null}}async function Jr(n){try{const e=await Ge(Qr(n));if(!e.ok)return{};const t=await e.text(),s=Ke(t);return Zr(s)}catch{return{}}}function Qr(n){return n.replace(/run_summary\.yaml($|\?)/,"parameters.yaml$1")}function ct(n){const e=typeof n=="number"?n:Number(n);return Number.isFinite(e)?e:null}function Xr(n){if(!n||typeof n!="object")return{};const e=n,t={};for(const[s,i]of Object.entries(e)){if(!i||typeof i!="object")continue;const a=i,o=typeof a.label=="string"?a.label:s,r=a.value;r!=null&&(t[s]={label:o,value:String(r)})}return t}function Zr(n){if(!n||typeof n!="object")return{};const e={};for(const[t,s]of Object.entries(n)){const i=ct(s);i!==null&&(e[t]=i)}return e}const Ui="[UniverseEngine]";let Di=!1;function Us(n){Di=n}function Hi(){return Di}function le(n,e){Hi()&&console.info(Ui,n,e??"")}function He(n,e){Hi()&&console.warn(Ui,n,e??"")}const el={local:"assets/local-manifest.json",online:Mi};function tl(n="local"){let e=n;const t=new Map;return{getSource(){return e},setSource(s){s==="online"&&t.delete("online"),Ts(),e=s,le("Manifest source updated",{source:s})},resetCache(){t.clear()},async preloadActiveManifest(){await Ki(e,t)},async findNearestVideo(s,i,a){const o=await il(e,t,s,i,a);if(o)return o;const r=ji(s);return He("Falling back to placeholder assets",{simClassId:s,source:e,fallbackUrl:r}),{url:r,liveDataUrl:nl(s),summaryUrl:Gr(r)}}}}function ji(n){switch(n){case"planetary":return ne("assets/planet_test.mp4");case"galaxy":return ne("assets/galaxy_test.mp4");case"cosmos":return ne("assets/cosmo_test.mp4");default:return ne("assets/galaxy_test.mp4")}}function nl(n){switch(n){case"planetary":return ne("assets/planet_test_planetary_stats.csv");case"galaxy":return ne("assets/galaxy_test_galaxy_stats.csv");case"cosmos":return ne("assets/cosmo_test_cosmos_stats.csv");default:return ne("assets/galaxy_test_galaxy_stats.csv")}}async function Ki(n,e){const t=e.get(n);if(t)return t;const s=el[n],i=(n==="online"?sl(s):fetch(ne(s)).then(async a=>{if(!a.ok)throw new Error(`Failed to load manifest: ${s}`);return le("Loaded manifest",{source:n,manifestPath:s}),await a.json()})).catch(a=>(He("Manifest unavailable",{source:n,manifestPath:s,error:a instanceof Error?a.message:String(a)}),{version:1,runs:[]}));return e.set(n,i),i}async function sl(n){const e=[n,Rn];for(const t of e)try{const s=await fetch(t);if(!s.ok)continue;const i=await s.json(),a=i.primaryBase??Ds(Mi),o=i.backupBase??Ds(Rn);return Uo(a,o),t===Rn&&Do("backup"),le("Loaded manifest",{source:"online",manifestPath:t,primaryBase:a,backupBase:o}),i}catch{continue}throw new Error(`Failed to load manifest: ${n}`)}async function il(n,e,t,s,i){const o=(await Ki(n,e)).runs.filter(d=>d.simulationId===t);if(o.length===0)return He("No manifest runs found for simulation",{simClassId:t,source:n}),null;let r=o[0],l=Hs(r,s,i);for(const d of o.slice(1)){const p=Hs(d,s,i);p<l&&(r=d,l=p)}const c=r.defaultView??Object.keys(r.views)[0],u=r.views[c];return u?(le("Selected manifest-backed run",{simClassId:t,source:n,runId:r.runId,selectedValues:i,distance:l,viewId:c}),{url:zt(n,u),liveDataUrl:zt(n,r.liveDataPath),summaryUrl:zt(n,r.summaryPath),viewId:c,runId:r.runId,views:Object.fromEntries(Object.entries(r.views).map(([d,p])=>[d,zt(n,p)]))}):null}function zt(n,e){return n==="local"?ne(e):Ve(e)}function Ds(n){const e=new URL(n);return`${e.protocol}//${e.host}`}function Hs(n,e,t){return e.length===0?0:e.reduce((i,a)=>{var c;const o=t[a.id]??a.fallbackValue,r=((c=n.parameters)==null?void 0:c[a.id])??a.fallbackValue,l=Math.max(a.max-a.min,1e-9);return i+Math.abs(o-r)/l},0)/e.length}const Zt={mode:"time",frames:[]};async function al(n){const e=await Ge(n);if(!e.ok)throw new Error(`Failed to load live stats CSV: ${n}`);const t=await e.text();return ll(t)}function ol(n,e,t=0){if(n.mode==="row")return cl(n.frames,e,t);const s=n.frames;if(s.length===0)return{};if(e<=s[0].t)return{...s[0].values};const i=s[s.length-1];if(e>=i.t)return{...i.values};const a=rl(s,e),o=s[Math.max(0,a-1)],r=s[Math.min(s.length-1,a)],l=(e-o.t)/Math.max(r.t-o.t,1e-9);return ul(o.values,r.values,l)}function rl(n,e){let t=1,s=n.length-1;for(;t<s;){const i=Math.floor((t+s)/2);n[i].t<=e?t=i+1:s=i}return t}function ll(n){const e=n.split(/\r?\n/).map(s=>s.trim()).filter(Boolean);if(e.length<2)return Zt;const t=Bn(e[0]);return t[0]==="t"?{mode:"time",frames:e.slice(1).map(s=>{const i=Bn(s),a={};for(let o=1;o<t.length;o+=1)a[t[o]]=i[o]??"";return{t:parseFloat(i[0]??"0")||0,values:a}})}:{mode:"row",frames:e.slice(1).map((s,i)=>{const a=Bn(s),o={};for(let r=0;r<t.length;r+=1)o[t[r]]=a[r]??"";return{t:i,values:o}})}}function cl(n,e,t){if(n.length===0)return{};if(!Number.isFinite(t)||t<=0)return{...n[0].values};const s=Math.max(0,Math.min(1,e/t)),i=Math.round(s*(n.length-1));return{...n[i].values}}function Bn(n){const e=[];let t="",s=!1;for(let i=0;i<n.length;i+=1){const a=n[i];if(a==='"'){s=!s;continue}if(a===","&&!s){e.push(t),t="";continue}t+=a}return e.push(t),e}function ul(n,e,t){const s=new Set([...Object.keys(n),...Object.keys(e)]),i={};for(const a of s){const o=n[a]??"",r=e[a]??o,l=parseFloat(o),c=parseFloat(r);if(Number.isFinite(l)&&Number.isFinite(c)){const u=l+(c-l)*t;i[a]=dl(u);continue}i[a]=t<.5?o:r}return i}function dl(n){return n.toFixed(2).replace(new RegExp("\\.0+$|(?<=\\..*?)0+$","g"),"").replace(/\.$/,"")}function fl(n){hl(ur,n)}function hl(n,e){if(navigator.sendBeacon){const t=new Blob([JSON.stringify(e)],{type:"application/json"});if(navigator.sendBeacon(n,t)){le("Run selection tracking dispatched",{simulationId:e.simulationId});return}}fetch(n,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),keepalive:!0}).then(t=>{t.ok?le("Run selection tracked",{simulationId:e.simulationId}):He("Run selection tracking rejected",{simulationId:e.simulationId,status:t.status})}).catch(t=>{He("Run selection tracking failed",{simulationId:e.simulationId,error:t instanceof Error?t.message:String(t)})})}const js=50*1024*1024,ml=8,pl=6e3,gl=8e3,yl=5e3,bl=1200,vl=100,Vn={galaxy:"tron",planetary:"matrix",cosmos:"hal"};function wl(n){const e=lt.map(f=>f.id);let t=Or(e),s=ys(t);const i=tl(t.manifestSource),a=Hr();Us(t.verboseLogging),t.manifestSource==="online"&&i.preloadActiveManifest();let o=bs(t.lockedScaleId)??s[0]??lt[0],r=t.lockedScaleId?Vn[o.id]:Fo(),l=!1,c=null,u=null,d=!1,p=t.audioMutedByDefault,m=t.defaultAudioVolume,b=0,h=null,y=0,S=Zt,v=!1;const L=Object.fromEntries(lt.map(f=>[f.id,sa(f)]));Mn(r);const k=ji(o.id),g=jo(n,k),w=document.createElement("audio");w.preload="auto",w.hidden=!0,w.setAttribute("playsinline","true"),w.muted=p,w.volume=m,n.appendChild(w);const N=document.createElement("div");N.className="display-chrome",N.classList.add("is-hidden"),n.appendChild(N);const E=document.createElement("div");E.className="orientation-overlay",E.innerHTML=`
  ...
  `,N.appendChild(fe);const ke=Ur();g.setPlaybackRate(ke);const J=document.createElement("div");J.className="display-chrome__bottom",N.appendChild(J);const I=qo(J,{onChange(f){H(f)},onTogglePlay:hs,onAudioToggle:Ji,onSpeedChange:Qi,onSummaryClick:zi,onScrubStart(){qe(),oe()},onScrubEnd(){Oe(),g.isPaused()||ae()},initialSpeed:ke});I.setPlaying(!g.isPaused()),I.setAudioVisible(!1),I.setMuted(p),w.addEventListener("loadedmetadata",()=>{at(!0),Ne()});let M=null,U=null,V=null,B=!1,ue=null,D=0;function ae(){if(M!==null)return;function f(){const _=g.getPlaybackFraction();I.setPosition(_),g.isPaused()?M=null:M=requestAnimationFrame(f)}M=requestAnimationFrame(f)}function oe(){M!==null&&(cancelAnimationFrame(M),M=null)}function H(f){U=f,V===null&&(V=requestAnimationFrame(()=>{if(V=null,U===null)return;const _=U;U=null,g.seekToFraction(_),at(!0)}))}function Ee(){if(U===null)return;V!==null&&(cancelAnimationFrame(V),V=null);const f=U;U=null,g.seekToFraction(f),at(!0)}function Le(){ue!==null&&(window.clearTimeout(ue),ue=null)}function we(){if(!(h!=null&&h.views))return[];const f=Xe(o,h);return Object.entries(h.views).filter(([_])=>_!==f).map(([,_])=>Ve(_)).filter(Boolean)}function me(){Le(),g.suspendPrewarming()}function he(f=bl){Le(),!(B||g.isPaused())&&(ue=window.setTimeout(()=>{ue=null,!(B||g.isPaused())&&(g.resumePrewarming(),g.prewarmSources(we()))},Math.max(0,f)))}function qe(){B=!0,D=0,me(),Ne()}function Oe(){B=!1,D=0,Ee(),y=g.getPlaybackFraction()*g.getDurationSeconds(),Qe(y),he(),Ne()}g.onPlayStateChange(f=>{I.setPlaying(!f),f?(oe(),me()):(ae(),he(0)),Ne()}),g.onTimeUpdate(f=>{if(y=f*g.getDurationSeconds(),B){const _=performance.now();if(_-D<vl)return;D=_}Qe(y),at()});const Ie=document.createElement("div");Ie.className="overlay-layer",n.appendChild(Ie);const R=_r(Ie,{onReplay:Gi,onParameters:()=>Dt("parameters"),onHome:vn,showHome:!t.lockedScaleId});g.onEnded(()=>{l=!0;const f=g.captureFrame();R.update(o,Ce(),g.getDurationSeconds(),c,f),R.show(),Ne()});const ie=ir(Ie,s,f=>{fs(f),Dt("parameters")}),C=$r(Ie,{simClass:o,values:Ce(),theme:r,advancedSettings:t,availableScales:lt,onValuesChange:qi,onThemeChange:bn,onRun:()=>{le("Parameters submitted — starting run",{simClassId:o.id}),Xi().catch(f=>{He("Run failed to start",{simClassId:o.id,error:f instanceof Error?f.message:String(f)})})},onApplySettings:Wi,onClose:Yi,initialView:"parameters"}),q=Fr(Ie);I.setPosition(0),Qe(),R.hide();const Q=new WeakMap,W=f=>{const _=Q.get(f);_&&(clearTimeout(_),Q.delete(f)),f.classList.remove("side-collapsed")},Be=f=>{const _=Q.get(f);_&&clearTimeout(_),Q.set(f,setTimeout(()=>{f.classList.add("side-collapsed"),Q.delete(f)},2500))},gn=f=>{const _=Q.get(f);_&&(clearTimeout(_),Q.delete(f)),f.classList.add("side-collapsed")},yn=(f,_)=>{const A=_.isCollapsible??(()=>!0);f.addEventListener("mouseenter",()=>W(f)),f.addEventListener("mouseleave",()=>{if(!A()){W(f);return}Be(f)}),f.addEventListener("focusin",()=>W(f)),f.addEventListener("focusout",O=>{if(!f.contains(O.relatedTarget)){if(!A()){W(f);return}Be(f)}}),f.addEventListener("click",()=>{if(!A()){W(f);return}if(f.classList.contains("side-collapsed")){W(f),Be(f);return}_.toggleOnClick?gn(f):Be(f)}),A()?gn(f):W(f)};yn(F,{toggleOnClick:!0,isCollapsible:()=>n.dataset.mode!=="entry"}),yn(z,{toggleOnClick:!0}),yn(J,{toggleOnClick:!1});let St=0,it=null,Ut=0;const us=()=>{it!==null&&(cancelAnimationFrame(it),it=null)},ds=()=>{if(it!==null)return;Ut=g.getPlaybackFraction();const f=()=>{if(St===0){us();return}const A=12*(1/60)/Math.max(g.getDurationSeconds(),1);Ut=Math.max(0,Math.min(1,Ut+St*A)),g.seekToFraction(Ut),it=requestAnimationFrame(f)};it=requestAnimationFrame(f)};document.addEventListener("keydown",f=>{if(n.dataset.mode==="display"&&!(f.target instanceof HTMLInputElement||f.target instanceof HTMLTextAreaElement))switch(f.key){case"Escape":f.preventDefault(),K.classList.contains("is-visible")?K.classList.remove("is-visible"):vn();break;case" ":f.preventDefault(),hs();break;case"ArrowLeft":f.preventDefault(),W(J),Be(J),St=-1,ds();break;case"ArrowRight":f.preventDefault(),W(J),Be(J),St=1,ds();break;case"ArrowUp":case"ArrowDown":{if(f.preventDefault(),W(z),Be(z),!(h!=null&&h.views)||Object.keys(h.views).length<=1)break;const _=o.views.filter(pe=>{var _e;return((_e=h==null?void 0:h.views)==null?void 0:_e[pe.id])!==void 0});if(_.length<=1)break;const A=h.viewId??Xe(o,h),O=_.findIndex(pe=>pe.id===A),re=f.key==="ArrowUp"?(O-1+_.length)%_.length:(O+1)%_.length;ms(_[re].id);break}}}),document.addEventListener("keyup",f=>{(f.key==="ArrowLeft"||f.key==="ArrowRight")&&(St=0,us())}),g.hideMedia(),g.pause(),Je(t.lockedScaleId?"config":"entry");function fs(f){f.id===o.id&&v||(o=f,Sn(),bn(Vn[f.id]),C.setSimulation(o,Ce()),I.setPosition(0),Qe(),_n(),wn())}function qi(f){L[o.id]={...f},le("Parameter values updated",{simClassId:o.id,values:L[o.id]}),Qe()}function bn(f){r=f,Mn(f),C.setTheme(f)}function Dt(f){f==="parameters"&&C.setSimulation(o,Ce()),C.setView(f),Je("config")}function Wi(f){if(pa(f),v){R.hide(),Je("display");return}C.setSimulation(o,Ce()),C.setView("parameters")}function Yi(){if(R.hide(),!v&&t.lockedScaleId){C.setSimulation(o,Ce()),C.setView("parameters");return}Je(v?"display":"entry")}function vn(){t.lockedScaleId||(le("Returning to home screen",{simClassId:o.id}),Sn(),v=!1,g.hideMedia(),Je("entry"))}function Gi(){l=!1,R.hide(),g.getPlaybackFraction()>=.999&&(g.resetPlayback(),at(!0)),Fn(g),Ne()}function zi(){l=!0,g.pause();const f=c?g.captureFrame():null;R.update(o,Ce(),g.getDurationSeconds(),c,f),R.show(),Ne()}function hs(){g.isPaused()?Fn(g):g.pause()}function Ji(){p=!p,Ne()}function Qi(f){g.setPlaybackRate(f),Dr(f),I.setSpeed(f)}async function Xi(){const f=Ce(),_=a.start();le("Run requested",{simClassId:o.id,values:f,manifestSource:i.getSource()});const A=await i.findNearestVideo(o.id,o.parameters,f);if(!a.isCurrent(_))return;Sn({preserveRunRequest:!0}),h=A;const O=Xe(o,A),re=Ho(i.getSource());fl({simulationId:o.id,parameters:f,manifestSource:i.getSource(),matchedRunId:A.runId,assetHostMode:re.mode,assetHostBase:re.base});const pe=la(A,O)??A.url,_e=Object.entries(A.views??{}).filter(([Pe])=>Pe!==O).map(([,Pe])=>Pe);aa(A.liveDataUrl,_),oa(A.summaryUrl,_),ua(A.summaryUrl,_),g.setMuted(!0),_n(O),Et(),Je("initializing");const Ht=Zi(pe);g.resumePrewarming(),g.prewarmSources(_e);const Lt=(async()=>{const Pe=await Ht;a.isCurrent(_)&&(le(`Prepared active video source: ${Pe.ownedObjectUrl?"FULL-FETCH":"PROGRESSIVE"}`,{selectedViewUrl:pe,waitsForBuffer:Pe.shouldWaitForBuffer}),g.setSource(Pe.src,{ownedObjectUrl:Pe.ownedObjectUrl}),g.pause(),await g.waitForLoadedData(gl),a.isCurrent(_)&&Pe.shouldWaitForBuffer&&await g.waitForBufferedAhead(ml,pl))})();await new Promise(Pe=>{q.show(Yr(o),Pe,Lt,{minTerminalTimeMs:ha()})}),a.isCurrent(_)&&(v=!0,g.showMedia(),Fn(g),Je("display"),Ne())}async function Zi(f){const _=Ve(f),A=await ea(f);if(A!==null&&A>0&&A<=js){le("Downloading active video behind loading overlay",{videoUrl:_,contentLength:A});try{const O=await Ge(f);if(!O.ok)throw new Error(`Failed to download active video: ${_}`);const re=await O.blob();return le(`Active video full fetch complete: ${re.size} bytes`,{videoUrl:Ve(f),blobType:re.type}),{src:URL.createObjectURL(re),ownedObjectUrl:!0,shouldWaitForBuffer:!1}}catch(O){He(`Full-fetch FAILED; falling back to progressive: ${O instanceof Error?O.message:String(O)}`,{videoUrl:f})}}return A!==null?le("Active video exceeds full-fetch threshold; using progressive load",{videoUrl:f,contentLength:A,fullFetchMaxBytes:js}):le("Could not determine active video size; using progressive load",{videoUrl:f}),le("Using progressive active video load",{videoUrl:f}),{src:Ve(f),ownedObjectUrl:!1,shouldWaitForBuffer:!0}}async function ea(f){try{const _=await Ge(f,{headers:{Range:"bytes=0-0"}});le("Probed active video size with range request",{videoUrl:f,ok:_.ok,status:_.status,contentLength:_.headers.get("Content-Length"),contentRange:_.headers.get("Content-Range")});const A=na(_.headers.get("Content-Length"));if(A!==null)return A;const O=ta(_.headers.get("Content-Range"));return O!==null?O:null}catch(_){return He("Could not probe active video size",{videoUrl:f,error:_ instanceof Error?_.message:String(_)}),null}}function ta(f){if(!f)return null;const _=f.match(/bytes\s+\d+-\d+\/(\d+)/i);if(!_)return null;const A=Number(_[1]);return Number.isFinite(A)&&A>0?A:null}function na(f){if(!f)return null;const _=Number(f);return Number.isFinite(_)?_:null}function Je(f){if(n.dataset.mode=f,f==="entry"?document.documentElement.setAttribute("data-theme","glass"):f==="display"&&Mn(r),kt(N,f==="display"||f==="config"),kt(T,f==="display"||f==="entry"),kt(F,!t.lockedScaleId&&(f==="entry"||f==="config"||f==="display")),f==="entry"?W(F):gn(F),f==="entry"&&!t.lockedScaleId?ie.show():ie.hide(),f==="config"?(q.hide(),C.setSimulation(o,Ce()),C.show()):C.hide(),f!=="display")R.hide();else if(l){const A=g.captureFrame();R.update(o,Ce(),g.getDurationSeconds(),c,A),R.show()}!v||f==="initializing"?(g.hideMedia(),f==="initializing"&&g.pause()):g.showMedia(),f!=="initializing"&&q.hide(),wn(),Ne()}function wn(){if(n.dataset.mode==="entry"){kt($,!0);return}const f=n.dataset.mode==="display",_=o.id==="galaxy",O=Xe(o,h)==="hst";kt($,f&&_&&O)}function Qe(f=0){const _=ol(S,f,g.getDurationSeconds()),A=ra(o,c,f,g.getDurationSeconds());ve.update(o,Ce(),{..._,...A})}function _n(f){const _=o.views.filter(re=>{var pe;return((pe=h==null?void 0:h.views)==null?void 0:pe[re.id])!==void 0});if(_.length<=1){Y.hide(),ce.classList.add("is-hidden");return}const A=f??Xe(o,h),O=_.find(re=>re.id===A);Y.update(_,A),O?(ce.classList.remove("is-hidden"),ce.innerHTML=`<span class="viewport-title">${O.label??O.id}</span>`):ce.classList.add("is-hidden")}function Sn(f={}){f.preserveRunRequest||a.invalidate(),S=Zt,l=!1,c=null,h=null,y=0,B=!1,U=null,Le(),V!==null&&(cancelAnimationFrame(V),V=null),R.hide(),Y.hide(),g.pause(),w.pause(),g.clearPrewarmedSources(),g.resetPlayback(),I.setPosition(0),gs()}function ms(f){if(!(h!=null&&h.views)||f===Xe(o,h))return;const _=Ve(h.views[f]);if(!_)return;h.viewId=f;const A=!g.isPaused()&&!l,O=l?0:g.getPlaybackFraction();l=!1,R.hide(),g.setSource(_,{seekFraction:O,autoplay:A}),g.prewarmSources(we()),A&&!B?he():me(),_n(f),Et(),Ne(),K.classList.remove("is-visible"),wn()}function Ce(){return{...L[o.id]}}function sa(f){return Object.fromEntries(f.parameters.map(_=>[_.id,ia(_)]))}function ia(f){if(f.logScale){const pe=Math.log10(f.min),_e=Math.log10(f.max);return 10**(pe+Math.random()*(_e-pe))}const _=Math.max(0,Math.round((f.max-f.min)/f.step)),A=Math.floor(Math.random()*(_+1)),O=f.min+A*f.step,re=Ti(f.step);return Number(O.toFixed(re))}async function aa(f,_){let A=Zt;try{A=await al(f)}catch(O){He("Failed to load live stats",{url:f,error:O instanceof Error?O.message:String(O)})}a.isCurrent(_)&&(S=A,Qe())}async function oa(f,_){const A=await zr(f);a.isCurrent(_)&&(c=A,Qe(y))}function ra(f,_,A,O){if(!_||!Number.isFinite(O)||O<=0)return{};const re=Math.max(0,Math.min(1,A/O)),pe={};for(const _e of f.metadata.liveStats){if(!_e.live||!_e.fromVideo||!_e.scaleWithTime)continue;const Ht=_e.videoKey??_e.id,Lt=_[Ht];if(typeof Lt!="number"||!Number.isFinite(Lt))continue;const kn=Lt*re;pe[_e.id]=_e.integer?String(Math.floor(kn)):String(kn)}return pe}function kt(f,_){f.hidden=!_,f.classList.toggle("is-hidden",!_)}function Xe(f,_){return _!=null&&_.views?_.viewId??Object.keys(_.views)[0]:_==null?void 0:_.viewId}function la(f,_){return!_||!f.views?null:f.views[_]??null}function ps(){const f=Xe(o,h);return f?o.views.some(_=>_.id===f&&_.audio):!1}function ca(f){return f.replace(/run_summary\.yaml($|\?)/,"audio_track.wav$1")}async function ua(f,_){const A=ca(f),O=++b,re=await da(A);if(!(!a.isCurrent(_)||O!==b)){if(!re){gs();return}u=Ve(A),d=!0,w.src!==u&&(w.pause(),w.src=u,w.load()),Et(),Ne()}}async function da(f){try{if((await Ge(f,{method:"HEAD"})).ok)return!0}catch{}try{return(await Ge(f,{headers:{Range:"bytes=0-0"}})).ok}catch{return!1}}function gs(){b+=1,u=null,d=!1,w.pause(),w.removeAttribute("src"),w.load(),Et()}function fa(){p=t.audioMutedByDefault,m=t.defaultAudioVolume,w.muted=p,w.volume=m,I.setMuted(p)}function Et(){I.setAudioVisible(ps()&&d&&!!u),I.setMuted(p)}function at(f=!1){if(!d||!Number.isFinite(w.duration)||w.duration<=0)return;const _=Math.max(0,Math.min(w.duration,g.getPlaybackFraction()*w.duration));(f||Math.abs(w.currentTime-_)>.35)&&(w.currentTime=_)}function Ne(){const f=ps()&&d&&!!u;if(Et(),w.muted=p,w.volume=m,!f){w.pause();return}if(at(),n.dataset.mode!=="display"||g.isPaused()||l||B){w.pause();return}w.play().catch(()=>{p=!0,w.muted=!0,I.setMuted(!0)})}function ys(f){const _=new Set(Rr(f,e));return lt.filter(A=>_.has(A.id))}function bs(f){return f?lt.find(_=>_.id===f)??null:null}function ha(){return i.getSource()!=="local"?Yn.MIN_TERMINAL_TIME_MS:ma(Yn.MIN_TERMINAL_TIME_MS,yl)}function ma(f,_){const A=Math.ceil(Math.min(f,_)),O=Math.floor(Math.max(f,_));return Math.floor(Math.random()*(O-A+1))+A}function pa(f){const _=o.id,A=t.manifestSource;t=Pr(f,e),Us(t.verboseLogging),s=ys(t),i.setSource(t.manifestSource),t.manifestSource==="online"&&i.preloadActiveManifest(),j.setHomeVisible(!t.lockedScaleId),R.setHomeVisible(!t.lockedScaleId),ie.setSimulationClasses(s),C.setAdvancedSettings(t),le("Advanced settings updated",t),fa(),Ne(),A!==t.manifestSource&&(h=null);const O=bs(t.lockedScaleId);O&&(fs(O),O.id!==_&&(v=!1,g.hideMedia(),C.setView("parameters")),v||(bn(Vn[O.id]),C.setSimulation(o,Ce())))}}function _l(){const n=document.getElementById("app");if(!n)throw new Error("App mount element not found.");wl(n)}_l();
//# sourceMappingURL=main-Do14M8DF.js.map
