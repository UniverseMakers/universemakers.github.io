...
${c}${v}${t}${m}`}function Aa(n,e,t,s){const{type:i,value:a}=n,{actualString:o,implicitKey:r,indent:l,indentStep:c,inFlow:u}=e;if(r&&a.includes(`
...
${l}`);if(o){const p=h=>{var y;return h.default&&h.tag!=="tag:yaml.org,2002:str"&&((y=h.test)==null?void 0:y.test(d))},{compat:m,tags:b}=e.doc.schema;if(b.some(p)||m!=null&&m.some(p))return ft(a,e)}return r?d:rn(d,l,Qs,ln(e,!1))}function Xn(n,e,t,s){const{implicitKey:i,inFlow:a}=e,o=typeof n.value=="string"?n:Object.assign({},n,{value:String(n.value)});let{type:r}=n;r!==P.QUOTE_DOUBLE&&/[\x00-\x08\x0b-\x1f\x7f-\x9f\u{D800}-\u{DFFF}]/u.test(o.value)&&(r=P.QUOTE_DOUBLE);const l=u=>{switch(u){case P.BLOCK_FOLDED:case P.BLOCK_LITERAL:return i||a?ft(o.value,e):Xt(o,e,t,s);case P.QUOTE_DOUBLE:return Ot(o.value,e);case P.QUOTE_SINGLE:return Hn(o.value,e);case P.PLAIN:return Aa(o,e,t,s);default:return null}};let c=l(r);if(c===null){const{defaultKeyType:u,defaultStringType:d}=e.options,p=i&&u||d;if(c=l(p),c===null)throw new Error(`Unsupported default string type ${p}`)}return c}function Xs(n,e){const t=Object.assign({blockQuote:!0,commentString:La,defaultKeyType:null,defaultStringType:"PLAIN",directives:null,doubleQuotedAsJSON:!1,doubleQuotedMinMultiLineLength:40,falseStr:"false",flowCollectionPadding:!0,indentSeq:!0,lineWidth:80,minContentWidth:20,nullStr:"null",simpleKeys:!1,singleQuote:null,trailingComma:!1,trueStr:"true",verifyAliasOrder:!0},n.schema.toStringOptions,e);let s;switch(t.collectionStyle){case"block":s=!1;break;case"flow":s=!0;break;default:s=null}return{anchors:new Set,doc:n,flowCollectionPadding:t.flowCollectionPadding?" ":"",indent:"",indentStep:typeof t.indent=="number"?" ".repeat(t.indent):"  ",inFlow:s,options:t}}function Ca(n,e){var i;if(e.tag){const a=n.filter(o=>o.tag===e.tag);if(a.length>0)return a.find(o=>o.format===e.format)??a[0]}let t,s;if(G(e)){s=e.value;let a=n.filter(o=>{var r;return(r=o.identify)==null?void 0:r.call(o,s)});if(a.length>1){const o=a.filter(r=>r.test);o.length>0&&(a=o)}t=a.find(o=>o.format===e.format)??a.find(o=>!o.format)}else s=e,t=n.find(a=>a.nodeClass&&s instanceof a.nodeClass);if(!t){const a=((i=s==null?void 0:s.constructor)==null?void 0:i.name)??(s===null?"null":typeof s);throw new Error(`Tag not resolved for ${a} value`)}return t}function Ia(n,e,{anchors:t,doc:s}){if(!s.directives)return"";const i=[],a=(G(n)||Z(n))&&n.anchor;a&&Ws(a)&&(t.add(a),i.push(`&${a}`));const o=n.tag??(e.default?null:e.tag);return o&&i.push(s.directives.tagString(o)),i.join(" ")}function gt(n,e,t,s){var l;if(te(n))return n.toString(e,t,s);if(nt(n)){if(e.doc.directives)return n.toString(e);if((l=e.resolvedAliases)!=null&&l.has(n))throw new TypeError("Cannot stringify circular structure without alias nodes");e.resolvedAliases?e.resolvedAliases.add(n):e.resolvedAliases=new Set([n]),n=n.resolve(e.doc)}let i;const a=ee(n)?n:e.doc.createNode(n,{onTagObj:c=>i=c});i??(i=Ca(e.doc.schema.tags,a));const o=Ia(a,i,e);o.length>0&&(e.indentAtStart=(e.indentAtStart??0)+o.length+1);const r=typeof i.stringify=="function"?i.stringify(a,e,t,s):G(a)?Xn(a,e,t,s):a.toString(e,t,s);return o?G(a)||r[0]==="{"||r[0]==="["?`${o} ${r}`:`${o}
...
`+E:T.comment=E,N.comment=N.comment.substring(E.length+1)}}if(!o&&!g&&!N.found){const E=w?n(t,w,N,i):e(t,N.end,g,null,N,i);c.items.push(E),d=E.range[2],An(w)&&i(E.range,"BLOCK_IN_FLOW",Nn)}else{t.atKey=!0;const E=N.end,T=k?n(t,k,N,i):e(t,E,L,null,N,i);An(k)&&i(T.range,"BLOCK_IN_FLOW",Nn),t.atKey=!1;const $=yt(g??[],{flow:r,indicator:"map-value-ind",next:w,offset:T.range[2],onError:i,parentIndent:s.indent,startOnNewline:!1});if($.found){if(!o&&!N.found&&t.options.strict){if(g)for(const j of g){if(j===$.found)break;if(j.type==="newline"){i(j,"MULTILINE_IMPLICIT_KEY","Implicit keys of flow sequence pairs need to be on a single line");break}}N.start<$.found.offset-1024&&i($.found,"KEY_OVER_1024_CHARS","The : indicator must be at most 1024 chars after the start of an implicit flow sequence key")}}else w&&("source"in w&&((y=w.source)==null?void 0:y[0])===":"?i(w,"MISSING_CHAR",`Missing space after : in ${r}`):i($.start,"MISSING_CHAR",`Missing , or : between ${r} items`));const x=w?n(t,w,$,i):$.found?e(t,$.end,g,null,$,i):null;x?An(w)&&i(x.range,"BLOCK_IN_FLOW",Nn):$.comment&&(T.comment?T.comment+=`
`+$.comment:T.comment=$.comment);const F=new ye(T,x);if(t.options.keepSourceTokens&&(F.srcToken=v),o){const j=c;vi(t,j.items,T)&&i(E,"DUPLICATE_KEY","Map keys must be unique"),j.items.push(F)}else{const j=new Ie(t.schema);j.flow=!0,j.items.push(F);const z=(x??T).range;j.range=[T.range[0],z[1],z[2]],c.items.push(j)}d=x?x.range[2]:$.end}}const p=o?"}":"]",[m,...b]=s.end;let h=d;if((m==null?void 0:m.source)===p)h=m.offset+m.source.length;else{const S=r[0].toUpperCase()+r.substring(1),v=u?`${S} must end with a ${p}`:`${S} in block collection must be sufficiently indented and end with a ${p}`;i(d,u?"MISSING_CHAR":"BAD_INDENT",v),m&&m.source.length!==1&&b.unshift(m)}if(b.length>0){const S=Vt(b,h,t.options.strict,i);S.comment&&(c.comment?c.comment+=`
`+S.comment:c.comment=S.comment),c.range=[s.offset,h,S.offset]}else c.range=[s.offset,h,h];return c}function Cn(n,e,t,s,i,a){const o=t.type==="block-map"?Ja(n,e,t,s,a):t.type==="block-seq"?Qa(n,e,t,s,a):Xa(n,e,t,s,a),r=o.constructor;return i==="!"||i===r.tagName?(o.tag=r.tagName,o):(i&&(o.tag=i),o)}function Za(n,e,t,s,i){var p;const a=s.tag,o=a?e.directives.tagName(a.source,m=>i(a,"TAG_RESOLVE_FAILED",m)):null;if(t.type==="block-seq"){const{anchor:m,newlineAfterProp:b}=s,h=m&&a?m.offset>a.offset?m:a:m??a;h&&(!b||b.offset<h.offset)&&i(h,"MISSING_CHAR","Missing newline after block sequence props")}const r=t.type==="block-map"?"map":t.type==="block-seq"?"seq":t.start.source==="{"?"map":"seq";if(!a||!o||o==="!"||o===Ie.tagName&&r==="map"||o===tt.tagName&&r==="seq")return Cn(n,e,t,i,o);let l=e.schema.tags.find(m=>m.tag===o&&m.collection===r);if(!l){const m=e.schema.knownTags[o];if((m==null?void 0:m.collection)===r)e.schema.tags.push(Object.assign({},m,{default:!1})),l=m;else return m?i(a,"BAD_COLLECTION_TYPE",`${m.tag} used for ${r} collection, but expects ${m.collection??"scalar"}`,!0):i(a,"TAG_RESOLVE_FAILED",`Unresolved tag: ${o}`,!0),Cn(n,e,t,i,o)}const c=Cn(n,e,t,i,o,l),u=((p=l.resolve)==null?void 0:p.call(l,c,m=>i(a,"TAG_RESOLVE_FAILED",m),e.options))??c,d=ee(u)?u:new P(u);return d.range=c.range,d.tag=o,l!=null&&l.format&&(d.format=l.format),d}function eo(n,e,t){const s=e.offset,i=to(e,n.options.strict,t);if(!i)return{value:"",type:null,comment:"",range:[s,s,s]};const a=i.mode===">"?P.BLOCK_FOLDED:P.BLOCK_LITERAL,o=e.source?no(e.source):[];let r=o.length;for(let h=o.length-1;h>=0;--h){const y=o[h][1];if(y===""||y==="\r")r=h;else break}if(r===0){const h=i.chomp==="+"&&o.length>0?`
...
`:case"\r":case"	":return!0;default:return!1}}const As=new Set("0123456789ABCDEFabcdef"),vo=new Set("0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-#;/?:@&=+$_.!~*'()"),Wt=new Set(",[]{}"),wo=new Set(` ,[]{}
\r	`),In=n=>!n||wo.has(n);class _o{constructor(){this.atEnd=!1,this.blockScalarIndent=-1,this.blockScalarKeep=!1,this.buffer="",this.flowKey=!1,this.flowLevel=0,this.indentNext=0,this.indentValue=0,this.lineEndPos=null,this.next=null,this.pos=0}*lex(e,t=!1){if(e){if(typeof e!="string")throw TypeError("source is not a string");this.buffer=this.buffer?this.buffer+e:e,this.lineEndPos=null}this.atEnd=!t;let s=this.next??"stream";for(;s&&(t||this.hasChars(1));)s=yield*this.parseNext(s)}atLineEnd(){let e=this.pos,t=this.buffer[e];for(;t===" "||t==="	";)t=this.buffer[++e];return!t||t==="#"||t===`
...
`,Ao=`# Parameter definitions for each simulation family.
#
...
cosmos:
  ...
  gravity_strength:
    ...
    log_scale: true
`,Co=`# Summary overlay display configuration for each simulation family.
#
...
cosmos:
  ...
  similarityScore:
    value: '--'
`,Io=`# Live telemetry HUD display configuration for each simulation family.
#
...
`,$s=(()=>{const n=qe(dr),e={};for(const t of Object.values(n))for(const[s,i]of Object.entries(t))e[s]=i;return e})(),sn="#4CD98A",Gn="#E8951C",Oi="#D7372A",Pi=.2,xi=.5,Fs=2;function Ri(n){const e=Math.abs(n-1);return e<=Pi?{word:"On target",colour:sn}:e<=xi?{word:n>1?"Too high":"Too low",colour:Gn}:{word:n>1?"Way too high":"Way too low",colour:Oi}}function fr(n){const e=Math.abs(n-1),t=n>=1;return e<=Pi?t?"greenHigh":"greenLow":e<=xi?t?"amberHigh":"amberLow":t?"redHigh":"redLow"}function hr(n){return Math.min(Math.max(n,0),Fs)/Fs*100}function mr(n){return n>=85?{word:"Almost perfect",colour:sn}:n>=65?{word:"Really close",colour:sn}:n>=45?{word:"Getting there",colour:Gn}:n>=25?{word:"Not quite",colour:Gn}:{word:"Way off - try again",colour:Oi}}function pr(n,e,t){var o,r;const s=fr(t),i=((o=$s[n])==null?void 0:o[s])??((r=$s[e])==null?void 0:r[s]);return i||(Ri(t).colour===sn?`${e} is very close to the target value for this simulation.`:t<1?`${e} is below the target value for this simulation.`:`${e} is above the target value for this simulation.`)}function gr(n,e,t){return n.metadata.results.map(s=>{const i=yr(s,n,e,t);if(i===null)return null;const a=i/Math.max(s.target,1e-9),o=br(s,n,t),r=pr(s.id,o,a),l=$e($i(String(i),s),s.unit);return{id:s.id,label:o,value:a,rawValue:i,formattedValue:l,detail:r}}).filter(s=>s!==null)}function yr(n,e,t,s){var l;const i=n.id,a=e.parameters.find(c=>c.id===i);if(a)return t[i]??a.fallbackValue;const o=vr((l=s==null?void 0:s.summaryMetrics[i])==null?void 0:l.value);if(o!==null)return o;const r=s==null?void 0:s.parameterValues[i];return typeof r=="number"&&Number.isFinite(r)?r:null}function br(n,e,t){var i,a;const s=n.id;return n.label??((i=e.parameters.find(o=>o.id===s))==null?void 0:i.label)??((a=t==null?void 0:t.summaryMetrics[s])==null?void 0:a.label)??s}function vr(n){if(n===void 0)return null;const e=Number(n);return Number.isFinite(e)?e:null}function wr(n){if(n.length===0)return 0;const e=n.reduce((t,s)=>t+Math.max(0,1-Math.abs(s.value-1)),0);return Math.round(e/n.length*100)}function _r(n,e){const t=document.createElement("section");t.className="overlay overlay--summary",t.hidden=!0,t.classList.add("is-hidden");let s;const i=document.createElement("div");i.className="summary-overlay";const a=document.createElement("div"),o=document.createElement("div");a.className="summary-overlay__header",o.className="summary-overlay__content";const r=document.createElement("p");r.className="summary-overlay__title",r.textContent="Run Summary";const l=document.createElement("p");l.className="summary-overlay__hint",l.textContent="Select any card for more details",a.appendChild(r),a.appendChild(l);const c=document.createElement("div");c.className="summary-overlay__actions";const u=document.createElement("button");u.className="summary-overlay__button",u.type="button",u.textContent="Continue Visualising";const d=document.createElement("button"),p=document.createElement("button");d.className="summary-overlay__button summary-overlay__button--primary",d.type="button",d.textContent="New Parameters",p.className="summary-overlay__button",p.type="button",p.textContent="Home",p.hidden=!e.showHome,u.addEventListener("click",e.onReplay),d.addEventListener("click",e.onParameters),p.addEventListener("click",e.onHome),c.appendChild(d),c.appendChild(u),c.appendChild(p),i.appendChild(a),i.appendChild(o),i.appendChild(c),t.appendChild(i);const m=document.createElement("div");m.className="sci-modal is-hidden",m.innerHTML=`
  ...
  `,t.appendChild(m),n.appendChild(t);const b=m.querySelector(".sci-modal__title"),h=m.querySelector(".sci-modal__verdict"),y=m.querySelector(".sci-modal__body"),S=m.querySelector(".sci-modal__close"),v=new Set;let L=!1;function k(E){const T=Ri(E.value);b.textContent=E.label,h.textContent=T.word,h.style.color=T.colour,h.hidden=!1,y.textContent=E.detail,m.classList.remove("is-hidden")}function g(E,T){b.textContent=E,h.hidden=!0,y.textContent=T,m.classList.remove("is-hidden")}function w(){m.classList.add("is-hidden")}S.addEventListener("click",w),m.addEventListener("click",E=>{E.target===m&&w()}),t.addEventListener("click",E=>{E.target===t&&e.onReplay()});function N(E,T){const $=document.createElement("div");$.className=`${E.className} panel`,$.innerHTML=`<p class="sci-section__title">${E.title}</p>`;const x=document.createElement("div"),F=E.singleRow?Math.max(1,E.stats.length):Math.max(1,Math.min(E.stats.length,E.maxColumns));x.className="metric-grid",E.singleRow&&x.classList.add("metric-grid--single-row"),x.style.setProperty("--summary-grid-columns",String(F)),x.style.setProperty("--summary-grid-max-width",`${E.maxWidthRem}rem`);for(const j of E.stats){const z=Sr(j,T),Y=document.createElement("div"),K=document.createElement("span"),X=document.createElement("span");Y.className="res-card",K.className="res-card__label",K.textContent=z.label,X.className="res-card__value",X.textContent=z.value,Y.appendChild(K),Y.appendChild(X),j.description&&(Y.classList.add("res-card--has-info"),Y.addEventListener("click",()=>{g(z.label,j.description)})),x.appendChild(Y)}return $.appendChild(x),$}return{show(){s&&(window.clearTimeout(s),s=void 0),t.hidden=!1,t.classList.remove("is-hidden"),t.classList.remove("is-visible"),t.offsetWidth,requestAnimationFrame(()=>{t.classList.add("is-visible")})},hide(){t.classList.remove("is-visible"),s=window.setTimeout(()=>{t.hidden=!0,t.classList.add("is-hidden"),s=void 0,L&&(v.clear(),L=!1)},cr.HIDE_AFTER_MS)},setHomeVisible(E){p.hidden=!E},update(E,T,$,x,F){var A,M,U,V,B,ue;o.innerHTML="",w();const j=ar(E,T,$,x),z=E.metadata.summaryStats,Y=gr(E,T,x),K=new Set(Y.map(D=>D.id));let X;if(Y.length>0)X=wr(Y);else{const D=((A=j.similarityScore)==null?void 0:A.value)??"0/100";X=parseInt(D,10)||0}const be=mr(X),Se=document.createElement("div"),ce=document.createElement("div"),se=document.createElement("div");Se.className="sci-top",ce.className="summary-main-column",se.className="summary-side-column";const ve=document.createElement("div");ve.className="sci-hero panel",F?(ve.classList.add("sci-hero--thumbnail"),ve.innerHTML=`<img class="sci-hero__thumbnail" src="${F}" alt="Final frame of simulation" />`):ve.innerHTML=`
        ...
        `,ce.appendChild(ve);const fe=z.filter(D=>(D.section??"resources")==="resources"&&!Y.some(ae=>ae.id===String(D.id))&&D.id!=="similarityScore"),ke=z.filter(D=>D.section==="simulationStats"&&!K.has(String(D.id)));fe.length>0&&se.appendChild(N({title:"Resources Used",className:"res-section",stats:fe,maxColumns:3,maxWidthRem:48},j)),ke.length>0&&se.appendChild(N({title:"Simulation Stats",className:"res-section",stats:ke,maxColumns:ke.length,maxWidthRem:48,singleRow:!0},j)),Se.appendChild(ce),se.childElementCount>0&&Se.appendChild(se),o.appendChild(Se);const J=E.metadata.morphologyChecklist;if(J&&J.length>0){const D=((U=(M=x==null?void 0:x.summaryMetrics)==null?void 0:M.morphology)==null?void 0:U.value)??null,ae=(D==null?void 0:D.toLowerCase())??null,oe=new Set(J.map(R=>R.id));ae&&oe.has(ae)&&v.add(ae);const H=document.createElement("div");H.className="sci-bottom-row";const Ee=document.createElement("div");Ee.style.cssText="display:flex; flex-direction:column; gap:1.25rem;",Ee.appendChild(Bs(E,T,g));const Le=((V=J.find(R=>R.id===ae))==null?void 0:V.label)??D;if(Le){const R=document.createElement("div");R.className="sci-section panel param-section";const ie=document.createElement("p");ie.className="sci-section__title",ie.textContent="Galaxy Morphology";const C=document.createElement("div");C.className="res-card res-card--has-info";const q=document.createElement("span");q.className="res-card__value",q.textContent=Le,C.appendChild(q),C.addEventListener("click",()=>{var Q;return g("Galaxy Morphology",((Q=J.find(W=>W.id===(D??"").toLowerCase()))==null?void 0:Q.description)??`This galaxy is classified as "${Le}".`)}),R.appendChild(ie),R.appendChild(C),Ee.appendChild(R)}H.appendChild(Ee);const we=document.createElement("div");we.style.cssText="flex:1; display:flex; flex-direction:column; gap:1.25rem; min-width:0; min-height:0;";const me=((ue=(B=x==null?void 0:x.summaryMetrics)==null?void 0:B.description)==null?void 0:ue.value)??null;if(me){const R=document.createElement("div");R.className="sci-section panel",R.style.cssText="flex:0 1 auto; min-height:0; overflow-y:auto;";const ie=document.createElement("p");ie.className="sci-section__title",ie.textContent="About This Galaxy";const C=document.createElement("p");C.className="galaxy-summary__desc-text",C.textContent=me,R.appendChild(ie),R.appendChild(C),we.appendChild(R)}const he=document.createElement("div");he.className="sci-section panel",he.style.cssText="flex:1; min-height:0;";const We=document.createElement("p");We.className="sci-section__title",We.textContent="Morphology Scavenger Hunt";const Oe=document.createElement("div");Oe.className="galaxy-summary__checklist",Oe.style.cssText="flex:1; align-items:center;";const Ae=J.every(R=>v.has(R.id));for(const R of J){const ie=document.createElement("div");ie.className="galaxy-summary__check",v.has(R.id)&&ie.classList.add("is-found"),ie.innerHTML=`
            <span class="galaxy-summary__check-box">
              ${v.has(R.id)?"✓":""}
            </span>
            <span class="galaxy-summary__check-label">${R.label}</span>
          `,Oe.appendChild(ie)}if(he.appendChild(We),he.appendChild(Oe),Ae){L=!0;const R=document.createElement("div");R.className="galaxy-summary__done",R.textContent="★ Well done! You've discovered all the galaxy types! ★",he.appendChild(R)}we.appendChild(he),H.appendChild(we),o.appendChild(H)}else if(Y.length>0){const D=document.createElement("div");D.className="sci-bottom-row",D.appendChild(Bs(E,T,g));const ae=document.createElement("div"),oe=document.createElement("div"),H=document.createElement("p"),Ee=document.createElement("p");ae.className="sci-section panel",oe.className="sci-section__header",H.className="sci-section__title",H.textContent="Similarity Results",Ee.className="sci-section__hint",Ee.textContent="Select any bar for details",oe.appendChild(H),oe.appendChild(Ee);const Le=document.createElement("div");Le.className="sci-bars";for(const we of Y){const me=document.createElement("div");me.className="sci-bar",me.innerHTML=`
...
`;function Cr(){const n=qe(Ar);if(!Array.isArray(n))return[];const e=[];for(const t of n){if(!t||typeof t!="object")continue;const s=t.text;if(typeof s!="string"||s.trim().length===0)continue;const i={text:s},a=t.url;typeof a=="string"&&a.trim().length>0&&(i.url=a);const o=t.logo;typeof o=="string"&&o.trim().length>0&&(i.logo=o),t.header===!0&&(i.header=!0),e.push(i)}return e}function Ir(n,e,t,s){const i=document.createElement("div");i.className="parameter-editor",n.appendChild(i);let a=e,o={...t};function r(u,d){a=u,o=d?{...d}:Tr(u),i.innerHTML="";const p=document.createElement("div");p.className="parameter-editor__heading",p.innerHTML=`
 ...
 Engine</h1>
  ...
  `;const X=document.createElement("select");X.className="advanced-settings__select",X.appendChild(new Option("None",""));for(const C of e.availableScales)X.appendChild(new Option(C.label,C.id));K.appendChild(X),Y.appendChild(K);const be=document.createElement("div");be.className="advanced-settings__field",be.innerHTML=`
  ...
  `,ke.appendChild(J),ke.appendChild(A),Y.appendChild(ke);const M=document.createElement("div");M.className="advanced-settings__field",M.innerHTML=`
  ...
  `;const U=document.createElement("div");U.className="advanced-settings__options";const V=new Map;for(const C of e.availableScales){const q=document.createElement("label"),Q=document.createElement("input");q.className="advanced-settings__choice",Q.type="checkbox",Q.value=C.id,V.set(C.id,Q),q.appendChild(Q),q.append(`Show ${C.label}`),U.appendChild(q)}M.appendChild(U),Y.appendChild(M),T.appendChild(Y),y.appendChild(T);const B=document.createElement("section");B.className="config-overlay__section config-overlay__section--grow",B.dataset.section="credits",B.innerHTML=`
    <div class="credits-list" data-credits></div>
  `;const ue=B.querySelector("[data-credits]"),D=Cr();if(ue.innerHTML="",D.length===0){const C=document.createElement("div");C.className="credits-list__entry",C.textContent="To be credited...",ue.appendChild(C)}else for(const C of D)if(C.header){const q=document.createElement("div");q.className="credits-list__heading",q.textContent=C.text,ue.appendChild(q)}else{const q=document.createElement("div");q.className="credits-list__entry";const Q=document.createElement("span");if(Q.className="credits-list__text",C.url){const W=document.createElement("a");W.className="credits-list__link",W.href=C.url,W.target="_blank",W.rel="noopener noreferrer",W.textContent=C.text,Q.appendChild(W)}else Q.textContent=C.text;q.appendChild(Q),ue.appendChild(q)}const ae=document.createElement("div");ae.className="config-overlay__footer";const oe=document.createElement("button");oe.className="run-button",oe.type="button",oe.textContent="Run",ae.appendChild(oe),r.appendChild(l),r.appendChild(b),r.appendChild(y),r.appendChild(B),r.appendChild(ae),i.appendChild(a),i.appendChild(r),s.appendChild(i),t.appendChild(s),n.appendChild(t);let H=Ct(e.advancedSettings),Ee="closed";const Le=Ir(h,e.simClass,e.values,e.onValuesChange),we=Bo(S,e.theme,e.onThemeChange);m.addEventListener("click",e.onClose),$.addEventListener("click",()=>{if(Ee==="open"){Oe("closed");return}Oe("auth"),F.focus()}),j.addEventListener("click",We),F.addEventListener("keydown",C=>{C.key==="Enter"&&We()}),X.addEventListener("change",()=>{H.lockedScaleId=X.value||null,he()}),se.addEventListener("change",()=>{se.checked&&(H.manifestSource="local")}),fe.addEventListener("change",()=>{fe.checked&&(H.manifestSource="online")}),J.addEventListener("change",()=>{H.verboseLogging=J.checked}),k.addEventListener("change",()=>{H.audioMutedByDefault=k.checked}),N.addEventListener("input",()=>{H.defaultAudioVolume=Number(N.value)/100,ie()});for(const[C,q]of V.entries())q.addEventListener("change",()=>{if(Array.from(V.entries()).filter(([,W])=>W.checked).map(([W])=>W).length===0&&!H.lockedScaleId){q.checked=!0;return}H.hiddenScaleIds=Array.from(V.keys()).filter(W=>{var Be;return!((Be=V.get(W))!=null&&Be.checked)&&W!==H.lockedScaleId}),he()}),C===H.lockedScaleId&&(q.disabled=!0);me(e.initialView??"parameters"),he();function me(C){r.dataset.view=C,C==="parameters"?(u.textContent=e.simClass.label,d.textContent="Shape Your Simulation",p.textContent=e.simClass.parameterSubtitle??"Adjust the parameters, inspect the setup, and press 'Run' when you're ready.",o.src=e.simClass.placeholderImage,o.alt=`${e.simClass.label} preview`):C==="settings"?(u.textContent="Interface",d.textContent="Adjust The Control Room",p.textContent="Change the interface theme and manage exhibit-level options for this installation.",o.src=ne("assets/Cluster_Stuart.webp"),o.alt="Galaxy cluster simulation preview"):(u.textContent="References",d.textContent="Project Sources And Attribution",p.textContent="Review the datasets, imagery, and supporting materials behind this experience.",o.src=ne("assets/synthetic_hst_pretty_galaxy.webp"),o.alt="Synthetic galaxy image preview"),C==="settings"?oe.textContent="Apply":C==="credits"?oe.textContent="Close":oe.textContent="Run Simulation"}function he(){X.value=H.lockedScaleId??"",se.checked=H.manifestSource==="local",fe.checked=H.manifestSource==="online",J.checked=H.verboseLogging,k.checked=H.audioMutedByDefault,N.value=String(Math.round(H.defaultAudioVolume*100)),ie();for(const[C,q]of V.entries()){const Q=H.lockedScaleId===C;q.checked=Q||!H.hiddenScaleIds.includes(C),q.disabled=Q}}function We(){if(F.value!==Mr){z.textContent="Incorrect password";return}F.value="",z.textContent="",Oe("open")}function Oe(C){Ee=C,T.dataset.state=C,$.textContent=C==="open"?"Hide Advanced Settings":"Advanced Settings",C!=="auth"&&(z.textContent="")}function Ae(){F.value="",z.textContent="",Oe("closed")}function R(){H=Ct(e.advancedSettings),he()}function ie(){E.textContent=`${Math.round(Number(N.value))}%`}return oe.addEventListener("click",()=>{const C=r.dataset.view;if(C==="settings"){e.onApplySettings(Ct(H));return}if(C==="credits"){e.onClose();return}e.onRun()}),{show(){t.hidden=!1,t.classList.remove("is-hidden")},hide(){t.hidden=!0,t.classList.add("is-hidden"),R(),Ae()},setSimulation(C,q){e.simClass=C,a.dataset.simClass=C.id,Le.setSimClass(C,q),r.dataset.view==="parameters"&&(o.src=C.placeholderImage,o.alt=`${C.label} preview`,me("parameters"))},setTheme(C){we.setActive(C)},setView(C){me(C),C!=="settings"&&Ae()},setAdvancedSettings(C){e.advancedSettings=Ct(C),H=Ct(C),he(),Ae()}}}function Ct(n){return{lockedScaleId:n.lockedScaleId,manifestSource:n.manifestSource,verboseLogging:n.verboseLogging,hiddenScaleIds:[...n.hiddenScaleIds],audioMutedByDefault:n.audioMutedByDefault,defaultAudioVolume:n.defaultAudioVolume}}function Fr(n){const{TYPING_MS_PER_CHAR:e,MIN_TERMINAL_TIME_MS:t,FINAL_PAUSE_MS:s}=Yn,i=document.createElement("section");i.className="overlay overlay--initializing",i.hidden=!0,i.classList.add("is-hidden");const a=document.createElement("div");a.className="terminal";const o=document.createElement("div");o.className="terminal__header",o.innerHTML=`
...
`,Wr={planetary:jr,galaxy:Kr,cosmos:qr};function Yr(n){return qe(Wr[n.id]).map(t=>({text:t}))}function Gr(n){return n.replace(/\.mp4($|\?)/,".yaml$1")}async function zr(n){try{const e=await Ge(n);if(!e.ok)return null;const t=await e.text(),s=qe(t),i=ct(s.wallclockSeconds),a=ct(s.computeUsed),o=ct(s.memoryUsed),r=ct(s.carbonBurnt),l=ct(s.particlesUpdated),c=await Jr(n),u=Xr(s.summaryMetrics);return i===null||a===null||o===null||r===null||l===null?null:{wallclockSeconds:i,computeUsed:a,memoryUsed:o,carbonBurnt:r,particlesUpdated:l,parameterValues:c,summaryMetrics:u}}catch{return null}}async function Jr(n){try{const e=await Ge(Qr(n));if(!e.ok)return{};const t=await e.text(),s=qe(t);return Zr(s)}catch{return{}}}function Qr(n){return n.replace(/run_summary\.yaml($|\?)/,"parameters.yaml$1")}function ct(n){const e=typeof n=="number"?n:Number(n);return Number.isFinite(e)?e:null}function Xr(n){if(!n||typeof n!="object")return{};const e=n,t={};for(const[s,i]of Object.entries(e)){if(!i||typeof i!="object")continue;const a=i,o=typeof a.label=="string"?a.label:s,r=a.value;r!=null&&(t[s]={label:o,value:String(r)})}return t}function Zr(n){if(!n||typeof n!="object")return{};const e={};for(const[t,s]of Object.entries(n)){const i=ct(s);i!==null&&(e[t]=i)}return e}const Ui="[UniverseEngine]";let Di=!1;function Us(n){Di=n}function Hi(){return Di}function le(n,e){Hi()&&console.info(Ui,n,e??"")}function je(n,e){Hi()&&console.warn(Ui,n,e??"")}const el={local:"assets/local-manifest.json",online:Mi};function tl(n="local"){let e=n;const t=new Map;return{getSource(){return e},setSource(s){s==="online"&&t.delete("online"),Ts(),e=s,le("Manifest source updated",{source:s})},resetCache(){t.clear()},async preloadActiveManifest(){await Ki(e,t)},async findNearestVideo(s,i,a){const o=await il(e,t,s,i,a);if(o)return o;const r=ji(s);return je("Falling back to placeholder assets",{simClassId:s,source:e,fallbackUrl:r}),{url:r,liveDataUrl:nl(s),summaryUrl:Gr(r)}}}}function ji(n){switch(n){case"planetary":return ne("assets/planet_test.mp4");case"galaxy":return ne("assets/galaxy_test.mp4");case"cosmos":return ne("assets/cosmo_test.mp4");default:return ne("assets/galaxy_test.mp4")}}function nl(n){switch(n){case"planetary":return ne("assets/planet_test_planetary_stats.csv");case"galaxy":return ne("assets/galaxy_test_galaxy_stats.csv");case"cosmos":return ne("assets/cosmo_test_cosmos_stats.csv");default:return ne("assets/galaxy_test_galaxy_stats.csv")}}async function Ki(n,e){const t=e.get(n);if(t)return t;const s=el[n],i=(n==="online"?sl(s):fetch(ne(s)).then(async a=>{if(!a.ok)throw new Error(`Failed to load manifest: ${s}`);return le("Loaded manifest",{source:n,manifestPath:s}),await a.json()})).catch(a=>(je("Manifest unavailable",{source:n,manifestPath:s,error:a instanceof Error?a.message:String(a)}),{version:1,runs:[]}));return e.set(n,i),i}async function sl(n){const e=[n,Rn];for(const t of e)try{const s=await fetch(t);if(!s.ok)continue;const i=await s.json(),a=i.primaryBase??Ds(Mi),o=i.backupBase??Ds(Rn);return Uo(a,o),t===Rn&&Do("backup"),le("Loaded manifest",{source:"online",manifestPath:t,primaryBase:a,backupBase:o}),i}catch{continue}throw new Error(`Failed to load manifest: ${n}`)}async function il(n,e,t,s,i){const o=(await Ki(n,e)).runs.filter(d=>d.simulationId===t);if(o.length===0)return je("No manifest runs found for simulation",{simClassId:t,source:n}),null;let r=o[0],l=Hs(r,s,i);for(const d of o.slice(1)){const p=Hs(d,s,i);p<l&&(r=d,l=p)}const c=r.defaultView??Object.keys(r.views)[0],u=r.views[c];return u?(le("Selected manifest-backed run",{simClassId:t,source:n,runId:r.runId,selectedValues:i,distance:l,viewId:c}),{url:zt(n,u),liveDataUrl:zt(n,r.liveDataPath),summaryUrl:zt(n,r.summaryPath),viewId:c,runId:r.runId,views:Object.fromEntries(Object.entries(r.views).map(([d,p])=>[d,zt(n,p)]))}):null}function zt(n,e){return n==="local"?ne(e):Ve(e)}function Ds(n){const e=new URL(n);return`${e.protocol}//${e.host}`}function Hs(n,e,t){return e.length===0?0:e.reduce((i,a)=>{var c;const o=t[a.id]??a.fallbackValue,r=((c=n.parameters)==null?void 0:c[a.id])??a.fallbackValue,l=Math.max(a.max-a.min,1e-9);return i+Math.abs(o-r)/l},0)/e.length}const Zt={mode:"time",frames:[]};async function al(n){const e=await Ge(n);if(!e.ok)throw new Error(`Failed to load live stats CSV: ${n}`);const t=await e.text();return ll(t)}function ol(n,e,t=0){if(n.mode==="row")return cl(n.frames,e,t);const s=n.frames;if(s.length===0)return{};if(e<=s[0].t)return{...s[0].values};const i=s[s.length-1];if(e>=i.t)return{...i.values};const a=rl(s,e),o=s[Math.max(0,a-1)],r=s[Math.min(s.length-1,a)],l=(e-o.t)/Math.max(r.t-o.t,1e-9);return ul(o.values,r.values,l)}function rl(n,e){let t=1,s=n.length-1;for(;t<s;){const i=Math.floor((t+s)/2);n[i].t<=e?t=i+1:s=i}return t}function ll(n){const e=n.split(/\r?\n/).map(s=>s.trim()).filter(Boolean);if(e.length<2)return Zt;const t=Bn(e[0]);return t[0]==="t"?{mode:"time",frames:e.slice(1).map(s=>{const i=Bn(s),a={};for(let o=1;o<t.length;o+=1)a[t[o]]=i[o]??"";return{t:parseFloat(i[0]??"0")||0,values:a}})}:{mode:"row",frames:e.slice(1).map((s,i)=>{const a=Bn(s),o={};for(let r=0;r<t.length;r+=1)o[t[r]]=a[r]??"";return{t:i,values:o}})}}function cl(n,e,t){if(n.length===0)return{};if(!Number.isFinite(t)||t<=0)return{...n[0].values};const s=Math.max(0,Math.min(1,e/t)),i=Math.round(s*(n.length-1));return{...n[i].values}}function Bn(n){const e=[];let t="",s=!1;for(let i=0;i<n.length;i+=1){const a=n[i];if(a==='"'){s=!s;continue}if(a===","&&!s){e.push(t),t="";continue}t+=a}return e.push(t),e}function ul(n,e,t){const s=new Set([...Object.keys(n),...Object.keys(e)]),i={};for(const a of s){const o=n[a]??"",r=e[a]??o,l=parseFloat(o),c=parseFloat(r);if(Number.isFinite(l)&&Number.isFinite(c)){const u=l+(c-l)*t;i[a]=dl(u);continue}i[a]=t<.5?o:r}return i}function dl(n){return n.toFixed(2).replace(new RegExp("\\.0+$|(?<=\\..*?)0+$","g"),"").replace(/\.$/,"")}function fl(n){hl(ur,n)}function hl(n,e){if(navigator.sendBeacon){const t=new Blob([JSON.stringify(e)],{type:"application/json"});if(navigator.sendBeacon(n,t)){le("Run selection tracking dispatched",{simulationId:e.simulationId});return}}fetch(n,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e),keepalive:!0}).then(t=>{t.ok?le("Run selection tracked",{simulationId:e.simulationId}):je("Run selection tracking rejected",{simulationId:e.simulationId,status:t.status})}).catch(t=>{je("Run selection tracking failed",{simulationId:e.simulationId,error:t instanceof Error?t.message:String(t)})})}const js=50*1024*1024,ml=8,pl=6e3,gl=8e3,yl=5e3,bl=1200,vl=100,Vn={galaxy:"tron",planetary:"matrix",cosmos:"hal"};function wl(n){const e=lt.map(f=>f.id);let t=Or(e),s=ys(t);const i=tl(t.manifestSource),a=Hr();Us(t.verboseLogging),t.manifestSource==="online"&&i.preloadActiveManifest();let o=bs(t.lockedScaleId)??s[0]??lt[0],r=t.lockedScaleId?Vn[o.id]:Fo(),l=!1,c=null,u=null,d=!1,p=t.audioMutedByDefault,m=t.defaultAudioVolume,b=0,h=null,y=0,S=Zt,v=!1;const L=Object.fromEntries(lt.map(f=>[f.id,sa(f)]));Mn(r);const k=ji(o.id),g=jo(n,k),w=document.createElement("audio");w.preload="auto",w.hidden=!0,w.setAttribute("playsinline","true"),w.muted=p,w.volume=m,n.appendChild(w);const N=document.createElement("div");N.className="display-chrome",N.classList.add("is-hidden"),n.appendChild(N);const E=document.createElement("div");E.className="orientation-overlay",E.innerHTML=`
  ...
  `,N.appendChild(fe);const ke=Ur();g.setPlaybackRate(ke);const J=document.createElement("div");J.className="display-chrome__bottom",N.appendChild(J);const A=qo(J,{onChange(f){H(f)},onTogglePlay:hs,onAudioToggle:Ji,onSpeedChange:Qi,onSummaryClick:zi,onScrubStart(){We(),oe()},onScrubEnd(){Oe(),g.isPaused()||ae()},initialSpeed:ke});A.setPlaying(!g.isPaused()),A.setAudioVisible(!1),A.setMuted(p),w.addEventListener("loadedmetadata",()=>{at(!0),Ne()});let M=null,U=null,V=null,B=!1,ue=null,D=0;function ae(){if(M!==null)return;function f(){const _=g.getPlaybackFraction();A.setPosition(_),g.isPaused()?M=null:M=requestAnimationFrame(f)}M=requestAnimationFrame(f)}function oe(){M!==null&&(cancelAnimationFrame(M),M=null)}function H(f){U=f,V===null&&(V=requestAnimationFrame(()=>{if(V=null,U===null)return;const _=U;U=null,g.seekToFraction(_),at(!0)}))}function Ee(){if(U===null)return;V!==null&&(cancelAnimationFrame(V),V=null);const f=U;U=null,g.seekToFraction(f),at(!0)}function Le(){ue!==null&&(window.clearTimeout(ue),ue=null)}function we(){if(!(h!=null&&h.views))return[];const f=it(o,h);return Object.entries(h.views).filter(([_])=>_!==f).map(([,_])=>Ve(_)).filter(Boolean)}function me(){Le(),g.suspendPrewarming()}function he(f=bl){Le(),!(B||g.isPaused())&&(ue=window.setTimeout(()=>{ue=null,!(B||g.isPaused())&&(g.resumePrewarming(),g.prewarmSources(we()))},Math.max(0,f)))}function We(){B=!0,D=0,me(),Ne()}function Oe(){B=!1,D=0,Ee(),y=g.getPlaybackFraction()*g.getDurationSeconds(),Qe(y),he(),Ne()}g.onPlayStateChange(f=>{A.setPlaying(!f),f?(oe(),me()):(ae(),he(0)),Ne()}),g.onTimeUpdate(f=>{if(y=f*g.getDurationSeconds(),B){const _=performance.now();if(_-D<vl)return;D=_}Qe(y),at()});const Ae=document.createElement("div");Ae.className="overlay-layer",n.appendChild(Ae);const R=_r(Ae,{onReplay:Gi,onParameters:()=>Dt("parameters"),onHome:vn,showHome:!t.lockedScaleId});g.onEnded(()=>{l=!0;const f=g.captureFrame();R.update(o,Ce(),g.getDurationSeconds(),c,f),R.show(),Ne()});const ie=ir(Ae,s,f=>{fs(f),Dt("parameters")}),C=$r(Ae,{simClass:o,values:Ce(),theme:r,advancedSettings:t,availableScales:lt,onValuesChange:qi,onThemeChange:bn,onRun:()=>{le("Parameters submitted — starting run",{simClassId:o.id}),Xi().catch(f=>{je("Run failed to start",{simClassId:o.id,error:f instanceof Error?f.message:String(f)})})},onApplySettings:Wi,onClose:Yi,initialView:"parameters"}),q=Fr(Ae);A.setPosition(0),Qe(),R.hide();const Q=new WeakMap,W=f=>{const _=Q.get(f);_&&(clearTimeout(_),Q.delete(f)),f.classList.remove("side-collapsed")},Be=f=>{const _=Q.get(f);_&&clearTimeout(_),Q.set(f,setTimeout(()=>{f.classList.add("side-collapsed"),Q.delete(f)},2500))},gn=f=>{const _=Q.get(f);_&&(clearTimeout(_),Q.delete(f)),f.classList.add("side-collapsed")},yn=(f,_)=>{const I=_.isCollapsible??(()=>!0);f.addEventListener("mouseenter",()=>W(f)),f.addEventListener("mouseleave",()=>{if(!I()){W(f);return}Be(f)}),f.addEventListener("focusin",()=>W(f)),f.addEventListener("focusout",O=>{if(!f.contains(O.relatedTarget)){if(!I()){W(f);return}Be(f)}}),f.addEventListener("click",()=>{if(!I()){W(f);return}if(f.classList.contains("side-collapsed")){W(f),Be(f);return}_.toggleOnClick?gn(f):Be(f)}),I()?gn(f):W(f)};yn(F,{toggleOnClick:!0,isCollapsible:()=>n.dataset.mode!=="entry"}),yn(z,{toggleOnClick:!0}),yn(J,{toggleOnClick:!1});let St=0,st=null,Ut=0;const us=()=>{st!==null&&(cancelAnimationFrame(st),st=null)},ds=()=>{if(st!==null)return;Ut=g.getPlaybackFraction();const f=()=>{if(St===0){us();return}const I=12*(1/60)/Math.max(g.getDurationSeconds(),1);Ut=Math.max(0,Math.min(1,Ut+St*I)),g.seekToFraction(Ut),st=requestAnimationFrame(f)};st=requestAnimationFrame(f)};document.addEventListener("keydown",f=>{if(n.dataset.mode==="display"&&!(f.target instanceof HTMLInputElement||f.target instanceof HTMLTextAreaElement))switch(f.key){case"Escape":f.preventDefault(),K.classList.contains("is-visible")?K.classList.remove("is-visible"):vn();break;case" ":f.preventDefault(),hs();break;case"ArrowLeft":f.preventDefault(),W(J),Be(J),St=-1,ds();break;case"ArrowRight":f.preventDefault(),W(J),Be(J),St=1,ds();break;case"ArrowUp":case"ArrowDown":{if(f.preventDefault(),W(z),Be(z),!(h!=null&&h.views)||Object.keys(h.views).length<=1)break;const _=o.views.filter(pe=>{var _e;return((_e=h==null?void 0:h.views)==null?void 0:_e[pe.id])!==void 0});if(_.length<=1)break;const I=h.viewId??it(o,h),O=_.findIndex(pe=>pe.id===I),re=f.key==="ArrowUp"?(O-1+_.length)%_.length:(O+1)%_.length;ms(_[re].id);break}}}),document.addEventListener("keyup",f=>{(f.key==="ArrowLeft"||f.key==="ArrowRight")&&(St=0,us())}),g.hideMedia(),g.pause(),Je(t.lockedScaleId?"config":"entry");function fs(f){f.id===o.id&&v||(o=f,Sn(),bn(Vn[f.id]),C.setSimulation(o,Ce()),A.setPosition(0),Qe(),_n(),wn())}function qi(f){L[o.id]={...f},le("Parameter values updated",{simClassId:o.id,values:L[o.id]}),Qe()}function bn(f){r=f,Mn(f),C.setTheme(f)}function Dt(f){f==="parameters"&&C.setSimulation(o,Ce()),C.setView(f),Je("config")}function Wi(f){if(pa(f),v){R.hide(),Je("display");return}C.setSimulation(o,Ce()),C.setView("parameters")}function Yi(){if(R.hide(),!v&&t.lockedScaleId){C.setSimulation(o,Ce()),C.setView("parameters");return}Je(v?"display":"entry")}function vn(){t.lockedScaleId||(le("Returning to home screen",{simClassId:o.id}),Sn(),v=!1,g.hideMedia(),Je("entry"))}function Gi(){l=!1,R.hide(),g.getPlaybackFraction()>=.999&&(g.resetPlayback(),at(!0)),Fn(g),Ne()}function zi(){l=!0,g.pause();const f=c?g.captureFrame():null;R.update(o,Ce(),g.getDurationSeconds(),c,f),R.show(),Ne()}function hs(){g.isPaused()?Fn(g):g.pause()}function Ji(){p=!p,Ne()}function Qi(f){g.setPlaybackRate(f),Dr(f),A.setSpeed(f)}async function Xi(){const f=Ce(),_=a.start();le("Run requested",{simClassId:o.id,values:f,manifestSource:i.getSource()});const I=await i.findNearestVideo(o.id,o.parameters,f);if(!a.isCurrent(_))return;Sn({preserveRunRequest:!0}),h=I;const O=it(o,I),re=Ho(i.getSource());fl({simulationId:o.id,parameters:f,manifestSource:i.getSource(),matchedRunId:I.runId,assetHostMode:re.mode,assetHostBase:re.base});const pe=la(I,O)??I.url,_e=Object.entries(I.views??{}).filter(([Pe])=>Pe!==O).map(([,Pe])=>Pe);aa(I.liveDataUrl,_),oa(I.summaryUrl,_),ua(I.summaryUrl,_),g.setMuted(!0),_n(O),Et(),Je("initializing");const Ht=Zi(pe);g.resumePrewarming(),g.prewarmSources(_e);const Lt=(async()=>{const Pe=await Ht;a.isCurrent(_)&&(le(`Prepared active video source: ${Pe.ownedObjectUrl?"FULL-FETCH":"PROGRESSIVE"}`,{selectedViewUrl:pe,waitsForBuffer:Pe.shouldWaitForBuffer}),g.setSource(Pe.src,{ownedObjectUrl:Pe.ownedObjectUrl}),g.pause(),await g.waitForLoadedData(gl),a.isCurrent(_)&&Pe.shouldWaitForBuffer&&await g.waitForBufferedAhead(ml,pl))})();await new Promise(Pe=>{q.show(Yr(o),Pe,Lt,{minTerminalTimeMs:ha()})}),a.isCurrent(_)&&(v=!0,g.showMedia(),Fn(g),Je("display"),Ne())}async function Zi(f){const _=Ve(f),I=await ea(f);if(I!==null&&I>0&&I<=js){le("Downloading active video behind loading overlay",{videoUrl:_,contentLength:I});try{const O=await Ge(f);if(!O.ok)throw new Error(`Failed to download active video: ${_}`);const re=await O.blob();return le(`Active video full fetch complete: ${re.size} bytes`,{videoUrl:Ve(f),blobType:re.type}),{src:URL.createObjectURL(re),ownedObjectUrl:!0,shouldWaitForBuffer:!1}}catch(O){je(`Full-fetch FAILED; falling back to progressive: ${O instanceof Error?O.message:String(O)}`,{videoUrl:f})}}return I!==null?le("Active video exceeds full-fetch threshold; using progressive load",{videoUrl:f,contentLength:I,fullFetchMaxBytes:js}):le("Could not determine active video size; using progressive load",{videoUrl:f}),le("Using progressive active video load",{videoUrl:f}),{src:Ve(f),ownedObjectUrl:!1,shouldWaitForBuffer:!0}}async function ea(f){try{const _=await Ge(f,{headers:{Range:"bytes=0-0"}});le("Probed active video size with range request",{videoUrl:f,ok:_.ok,status:_.status,contentLength:_.headers.get("Content-Length"),contentRange:_.headers.get("Content-Range")});const I=na(_.headers.get("Content-Length"));if(I!==null)return I;const O=ta(_.headers.get("Content-Range"));return O!==null?O:null}catch(_){return je("Could not probe active video size",{videoUrl:f,error:_ instanceof Error?_.message:String(_)}),null}}function ta(f){if(!f)return null;const _=f.match(/bytes\s+\d+-\d+\/(\d+)/i);if(!_)return null;const I=Number(_[1]);return Number.isFinite(I)&&I>0?I:null}function na(f){if(!f)return null;const _=Number(f);return Number.isFinite(_)?_:null}function Je(f){if(n.dataset.mode=f,f==="entry"?document.documentElement.setAttribute("data-theme","glass"):f==="display"&&Mn(r),kt(N,f==="display"||f==="config"),kt(T,f==="display"||f==="entry"),kt(F,!t.lockedScaleId&&(f==="entry"||f==="config"||f==="display")),f==="entry"?W(F):gn(F),f==="entry"&&!t.lockedScaleId?ie.show():ie.hide(),f==="config"?(q.hide(),C.setSimulation(o,Ce()),C.show()):C.hide(),f!=="display")R.hide();else if(l){const I=g.captureFrame();R.update(o,Ce(),g.getDurationSeconds(),c,I),R.show()}!v||f==="initializing"?(g.hideMedia(),f==="initializing"&&g.pause()):g.showMedia(),f!=="initializing"&&q.hide(),wn(),Ne()}function wn(){if(n.dataset.mode==="entry"){kt($,!0);return}const f=n.dataset.mode==="display",_=o.id==="galaxy";kt($,f&&_)}function Qe(f=0){const _=ol(S,f,g.getDurationSeconds()),I=ra(o,c,f,g.getDurationSeconds());ve.update(o,Ce(),{..._,...I})}function _n(f){const _=o.views.filter(re=>{var pe;return((pe=h==null?void 0:h.views)==null?void 0:pe[re.id])!==void 0});if(_.length<=1){Y.hide(),ce.classList.add("is-hidden");return}const I=f??it(o,h),O=_.find(re=>re.id===I);Y.update(_,I),O?(ce.classList.remove("is-hidden"),ce.innerHTML=`<span class="viewport-title">${O.label??O.id}</span>`):ce.classList.add("is-hidden")}function Sn(f={}){f.preserveRunRequest||a.invalidate(),S=Zt,l=!1,c=null,h=null,y=0,B=!1,U=null,Le(),V!==null&&(cancelAnimationFrame(V),V=null),R.hide(),Y.hide(),g.pause(),w.pause(),g.clearPrewarmedSources(),g.resetPlayback(),A.setPosition(0),gs()}function ms(f){if(!(h!=null&&h.views)||f===it(o,h))return;const _=Ve(h.views[f]);if(!_)return;h.viewId=f;const I=!g.isPaused()&&!l,O=l?0:g.getPlaybackFraction();l=!1,R.hide(),g.setSource(_,{seekFraction:O,autoplay:I}),g.prewarmSources(we()),I&&!B?he():me(),_n(f),Et(),Ne(),K.classList.remove("is-visible"),wn()}function Ce(){return{...L[o.id]}}function sa(f){return Object.fromEntries(f.parameters.map(_=>[_.id,ia(_)]))}function ia(f){if(f.logScale){const pe=Math.log10(f.min),_e=Math.log10(f.max);return 10**(pe+Math.random()*(_e-pe))}const _=Math.max(0,Math.round((f.max-f.min)/f.step)),I=Math.floor(Math.random()*(_+1)),O=f.min+I*f.step,re=Ti(f.step);return Number(O.toFixed(re))}async function aa(f,_){let I=Zt;try{I=await al(f)}catch(O){je("Failed to load live stats",{url:f,error:O instanceof Error?O.message:String(O)})}a.isCurrent(_)&&(S=I,Qe())}async function oa(f,_){const I=await zr(f);a.isCurrent(_)&&(c=I,Qe(y))}function ra(f,_,I,O){if(!_||!Number.isFinite(O)||O<=0)return{};const re=Math.max(0,Math.min(1,I/O)),pe={};for(const _e of f.metadata.liveStats){if(!_e.live||!_e.fromVideo||!_e.scaleWithTime)continue;const Ht=_e.videoKey??_e.id,Lt=_[Ht];if(typeof Lt!="number"||!Number.isFinite(Lt))continue;const kn=Lt*re;pe[_e.id]=_e.integer?String(Math.floor(kn)):String(kn)}return pe}function kt(f,_){f.hidden=!_,f.classList.toggle("is-hidden",!_)}function it(f,_){return _!=null&&_.views?_.viewId??Object.keys(_.views)[0]:_==null?void 0:_.viewId}function la(f,_){return!_||!f.views?null:f.views[_]??null}function ps(){const f=it(o,h);return f?o.views.some(_=>_.id===f&&_.audio):!1}function ca(f){return f.replace(/run_summary\.yaml($|\?)/,"audio_track.wav$1")}async function ua(f,_){const I=ca(f),O=++b,re=await da(I);if(!(!a.isCurrent(_)||O!==b)){if(!re){gs();return}u=Ve(I),d=!0,w.src!==u&&(w.pause(),w.src=u,w.load()),Et(),Ne()}}async function da(f){try{if((await Ge(f,{method:"HEAD"})).ok)return!0}catch{}try{return(await Ge(f,{headers:{Range:"bytes=0-0"}})).ok}catch{return!1}}function gs(){b+=1,u=null,d=!1,w.pause(),w.removeAttribute("src"),w.load(),Et()}function fa(){p=t.audioMutedByDefault,m=t.defaultAudioVolume,w.muted=p,w.volume=m,A.setMuted(p)}function Et(){A.setAudioVisible(ps()&&d&&!!u),A.setMuted(p)}function at(f=!1){if(!d||!Number.isFinite(w.duration)||w.duration<=0)return;const _=Math.max(0,Math.min(w.duration,g.getPlaybackFraction()*w.duration));(f||Math.abs(w.currentTime-_)>.35)&&(w.currentTime=_)}function Ne(){const f=ps()&&d&&!!u;if(Et(),w.muted=p,w.volume=m,!f){w.pause();return}if(at(),n.dataset.mode!=="display"||g.isPaused()||l||B){w.pause();return}w.play().catch(()=>{p=!0,w.muted=!0,A.setMuted(!0)})}function ys(f){const _=new Set(Rr(f,e));return lt.filter(I=>_.has(I.id))}function bs(f){return f?lt.find(_=>_.id===f)??null:null}function ha(){return i.getSource()!=="local"?Yn.MIN_TERMINAL_TIME_MS:ma(Yn.MIN_TERMINAL_TIME_MS,yl)}function ma(f,_){const I=Math.ceil(Math.min(f,_)),O=Math.floor(Math.max(f,_));return Math.floor(Math.random()*(O-I+1))+I}function pa(f){const _=o.id,I=t.manifestSource;t=Pr(f,e),Us(t.verboseLogging),s=ys(t),i.setSource(t.manifestSource),t.manifestSource==="online"&&i.preloadActiveManifest(),j.setHomeVisible(!t.lockedScaleId),R.setHomeVisible(!t.lockedScaleId),ie.setSimulationClasses(s),C.setAdvancedSettings(t),le("Advanced settings updated",t),fa(),Ne(),I!==t.manifestSource&&(h=null);const O=bs(t.lockedScaleId);O&&(fs(O),O.id!==_&&(v=!1,g.hideMedia(),C.setView("parameters")),v||(bn(Vn[O.id]),C.setSimulation(o,Ce())))}}function _l(){const n=document.getElementById("app");if(!n)throw new Error("App mount element not found.");wl(n)}_l();
//# sourceMappingURL=main-CpPvYz1e.js.map
